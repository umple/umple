...
- `tumple` — unit tests (read the script to run a specific test class)
- `bumple` — full build + all tests (includes testbed and example tests)
...
- Rebase onto `master` instead of merging `master` into your branch
