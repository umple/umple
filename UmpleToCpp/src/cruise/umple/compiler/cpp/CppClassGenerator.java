...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_1543 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1544 = ".begin(),";
  protected final String TEXT_1545 = ".end(),";
  protected final String TEXT_1546 = ")!= ";
  protected final String TEXT_1547 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1548 = NL + "      ";
  protected final String TEXT_1549 = "push_back(";
  protected final String TEXT_1550 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1551 = ".size() != ";
  protected final String TEXT_1552 = ".length || ";
  ...
  protected final String TEXT_1569 = ");" + NL + "      if (find(";
  protected final String TEXT_1570 = ".begin(),";
  protected final String TEXT_1571 = ".end(),";
  protected final String TEXT_1572 = ")!= ";
  protected final String TEXT_1573 = ".end())" + NL + "      {";
  protected final String TEXT_1574 = NL + "        ";
  protected final String TEXT_1575 = ".erase(find(";
  protected final String TEXT_1576 = ".begin(),";
  protected final String TEXT_1577 = ".end(),";
  protected final String TEXT_1578 = "));" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1579 = NL + "        ";
  protected final String TEXT_1580 = "->";
  protected final String TEXT_1581 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1587 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1594 = NL + "    vector<";
  protected final String TEXT_1595 = "*> ";
  protected final String TEXT_1596 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_1597 = " ";
  protected final String TEXT_1598 = " : ";
  protected final String TEXT_1599 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1600 = ".begin(),";
  protected final String TEXT_1601 = ".end(),";
  protected final String TEXT_1602 = ") != ";
  protected final String TEXT_1603 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1604 = NL + "      ";
  protected final String TEXT_1605 = ".push_back(";
  ...
  protected final String TEXT_1611 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1612 = "*> ";
  protected final String TEXT_1613 = ";";
  protected final String TEXT_1614 = NL + "    ";
  protected final String TEXT_1615 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1620 = ".push_back(";
  protected final String TEXT_1621 = ");" + NL + "      if (find(";
  protected final String TEXT_1622 = ".begin(),";
  protected final String TEXT_1623 = ".end(),";
  protected final String TEXT_1624 = ")) != ";
  protected final String TEXT_1625 = ".end())" + NL + "      {";
  protected final String TEXT_1626 = NL + "        ";
  protected final String TEXT_1627 = ".erase(";
  protected final String TEXT_1628 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1629 = NL + "        ";
  protected final String TEXT_1630 = "->";
  protected final String TEXT_1631 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1637 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1649 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1650 = ".begin(),";
  protected final String TEXT_1651 = ".end(),";
  protected final String TEXT_1652 = ") != ";
  protected final String TEXT_1653 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1663 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1664 = NL + "    ";
  protected final String TEXT_1665 = ".clear();" + NL + "\tfor (int i=0; i<";
  protected final String TEXT_1666 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1667 = ".push_back(";
  protected final String TEXT_1668 = "[i]);" + NL + "\t}" + NL + "    " + NL + "    wasSet = true;";
  protected final String TEXT_1669 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1670 = NL + "  bool ";
  protected final String TEXT_1671 = "::";
  protected final String TEXT_1672 = "(";
  protected final String TEXT_1673 = "... ";
  protected final String TEXT_1674 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1675 = NL + "    if (";
  protected final String TEXT_1676 = ".length < ";
  protected final String TEXT_1677 = "()";
  protected final String TEXT_1678 = ")" + NL + "    {";
  protected final String TEXT_1679 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1680 = "*> ";
  protected final String TEXT_1681 = ";" + NL + "\t" + NL + "    map<";
  protected final String TEXT_1682 = ",int> ";
  ...
  protected final String TEXT_1690 = ".end())" + NL + "      {";
  protected final String TEXT_1691 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1692 = "->";
  protected final String TEXT_1693 = "() != NULL && this!=";
  ...
  protected final String TEXT_1704 = ".insert(";
  protected final String TEXT_1705 = ", new int(";
  protected final String TEXT_1706 = "->";
  protected final String TEXT_1707 = "()));" + NL + "        }" + NL + "        int currentCount = ";
  protected final String TEXT_1708 = ".find(";
  protected final String TEXT_1709 = ")->firtst;" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  ...
  protected final String TEXT_1713 = ".insert(";
  protected final String TEXT_1714 = ", new int(nextCount));" + NL + "      }";
  protected final String TEXT_1715 = NL + "      ";
  protected final String TEXT_1716 = ".push_back(";
  protected final String TEXT_1717 = ");" + NL + "    }" + NL;
  protected final String TEXT_1718 = NL + "    ";
  protected final String TEXT_1719 = ".removeAll(";
  protected final String TEXT_1720 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1721 = " orphan : ";
  protected final String TEXT_1722 = ")" + NL + "    {";
  protected final String TEXT_1723 = NL + "      ";
  protected final String TEXT_1724 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1725 = NL + "    ";
  protected final String TEXT_1726 = ".clear();" + NL + "    for (";
  protected final String TEXT_1727 = " ";
  protected final String TEXT_1728 = " : ";
  protected final String TEXT_1729 = ")" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1735 = ".erase(";
  ...
  protected final String TEXT_1741 = ".push_back(";
  protected final String TEXT_1742 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1743 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1744 = NL + "  void ";
  ...
  protected final String TEXT_1750 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1751 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1752 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1753 = ", ";
  protected final String TEXT_1754 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1755 = " to ";
  protected final String TEXT_1756 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1762 = NL + "    vector<";
  protected final String TEXT_1763 = "*> ";
  protected final String TEXT_1764 = ";" + NL + "    for (";
  protected final String TEXT_1765 = " ";
  protected final String TEXT_1766 = " : ";
  protected final String TEXT_1767 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1768 = ".begin(),";
  protected final String TEXT_1769 = ".end(),(";
  protected final String TEXT_1770 = ")) - ";
  protected final String TEXT_1771 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1772 = NL + "      ";
  protected final String TEXT_1773 = ".push_back(";
  protected final String TEXT_1774 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1775 = ".size() != ";
  protected final String TEXT_1776 = ".size() || ";
  protected final String TEXT_1777 = ".size() > ";
  protected final String TEXT_1778 = "())" + NL + "    {";
  protected final String TEXT_1779 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1780 = NL + "    ";
  protected final String TEXT_1781 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1782 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1783 = ".push_back(";
  protected final String TEXT_1784 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1785 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1786 = NL + "  bool ";
  protected final String TEXT_1787 = "::";
  protected final String TEXT_1788 = "(";
  protected final String TEXT_1789 = "... ";
  protected final String TEXT_1790 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1791 = NL + "    vector<";
  protected final String TEXT_1792 = "*> ";
  protected final String TEXT_1793 = ";" + NL + "    for (";
  protected final String TEXT_1794 = " ";
  protected final String TEXT_1795 = " : ";
  protected final String TEXT_1796 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1797 = ".begin(),";
  protected final String TEXT_1798 = ".end(),";
  protected final String TEXT_1799 = ") != ";
  protected final String TEXT_1800 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1815 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1816 = NL + "    ";
  protected final String TEXT_1817 = " == (";
  protected final String TEXT_1818 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1819 = NL + "    ";
  protected final String TEXT_1820 = NL;
  protected final String TEXT_1821 = NL + "    ";
  protected final String TEXT_1822 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1823 = NL + "   void ";
  protected final String TEXT_1824 = "::";
  protected final String TEXT_1825 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1826 = NL + "       ";
  protected final String TEXT_1827 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1828 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1829 = NL + "    ";
  protected final String TEXT_1830 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1831 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1832 = NL + "      ";
  protected final String TEXT_1833 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1834 = NL + "  void ";
  protected final String TEXT_1835 = "();" + NL + "  void ";
