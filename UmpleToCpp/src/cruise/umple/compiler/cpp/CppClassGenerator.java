...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_813 = " != NULL && this!=";
  ...
  protected final String TEXT_820 = "->push_back(";
  ...
  protected final String TEXT_829 = NL + "    if (this!=";
  protected final String TEXT_830 = "->";
  protected final String TEXT_831 = "())" + NL + "    {";
  protected final String TEXT_832 = NL + "      ";
  protected final String TEXT_833 = "->erase(find(";
  protected final String TEXT_834 = ".begin(),";
  protected final String TEXT_835 = ".end(),";
  protected final String TEXT_836 = "));" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_863 = ".equals(";
  ...
  protected final String TEXT_875 = "();" + NL + "" + NL + "    if (!equals(";
  ...
  protected final String TEXT_885 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_886 = NL + "    if (!";
  protected final String TEXT_887 = ".contains(";
  protected final String TEXT_888 = "))" + NL + "    {";
  protected final String TEXT_889 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_890 = "() <= ";
  protected final String TEXT_891 = "())" + NL + "    {";
  protected final String TEXT_892 = NL + "      return wasRemoved;" + NL + "    }" + NL + "\t" + NL + "    int oldIndex = std::find(";
  protected final String TEXT_893 = ".begin(), ";
  protected final String TEXT_894 = ".end(), ";
  protected final String TEXT_895 = ") - ";
  protected final String TEXT_896 = ".begin();";
  protected final String TEXT_897 = NL + "    ";
  protected final String TEXT_898 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_899 = ".";
  protected final String TEXT_900 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_901 = ".";
  protected final String TEXT_902 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_903 = NL + "        ";
  protected final String TEXT_904 = ".add(oldIndex,";
  protected final String TEXT_905 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_906 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_907 = NL + "  bool ";
  protected final String TEXT_908 = "::";
  protected final String TEXT_909 = "(";
  protected final String TEXT_910 = " ";
  protected final String TEXT_911 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_912 = NL + "    if (!";
  protected final String TEXT_913 = ".contains(";
  protected final String TEXT_914 = "))" + NL + "    {";
  protected final String TEXT_915 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_916 = "() <= ";
  protected final String TEXT_917 = "())" + NL + "    {";
  protected final String TEXT_918 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = std::find(";
  ...
  protected final String TEXT_924 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_925 = ".";
  protected final String TEXT_926 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_927 = ".";
  protected final String TEXT_928 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_929 = NL + "        ";
  protected final String TEXT_930 = ".add(oldIndex,";
  protected final String TEXT_931 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_932 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_933 = NL + "  bool ";
  protected final String TEXT_934 = "::";
  protected final String TEXT_935 = "(";
  protected final String TEXT_936 = "* ";
  protected final String TEXT_937 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_957 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_958 = " != null)" + NL + "    {";
  protected final String TEXT_959 = NL + "      ";
  protected final String TEXT_960 = ".";
  protected final String TEXT_961 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_962 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_963 = NL + "  bool ";
  protected final String TEXT_964 = "::";
  protected final String TEXT_965 = "(";
  protected final String TEXT_966 = "* ";
  protected final String TEXT_967 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_983 = "(this);" + NL + "    }";
  ...
  protected final String TEXT_997 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_998 = " already at maximum (";
  ...
  protected final String TEXT_1014 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1015 = ".";
  protected final String TEXT_1016 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1023 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1024 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1025 = NL + "  bool ";
  protected final String TEXT_1026 = "::";
  protected final String TEXT_1027 = "(";
  protected final String TEXT_1028 = "* ";
  protected final String TEXT_1029 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1030 = NL + "    //Must provide ";
  protected final String TEXT_1031 = " to ";
  protected final String TEXT_1032 = NL + "    if (";
  protected final String TEXT_1033 = " == null)" + NL + "    {";
  protected final String TEXT_1034 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1050 = ")" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1051 = ".";
  protected final String TEXT_1052 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1059 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1060 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1061 = NL + "  bool ";
  protected final String TEXT_1062 = "::";
  protected final String TEXT_1063 = "(";
  protected final String TEXT_1064 = " ";
  protected final String TEXT_1065 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1074 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1082 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1083 = NL + "      ";
  protected final String TEXT_1084 = ".add(";
  protected final String TEXT_1085 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1086 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1087 = "::";
  protected final String TEXT_1088 = "(";
  protected final String TEXT_1089 = " ";
  protected final String TEXT_1090 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1091 = NL + "    if (";
  protected final String TEXT_1092 = ".contains(";
  protected final String TEXT_1093 = "))" + NL + "    {";
  protected final String TEXT_1094 = NL + "      ";
  protected final String TEXT_1095 = ".remove(";
  protected final String TEXT_1096 = ");";
  protected final String TEXT_1097 = NL + "      ";
  protected final String TEXT_1098 = ".";
  protected final String TEXT_1099 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1100 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1101 = NL + "  bool ";
  protected final String TEXT_1102 = "::";
  protected final String TEXT_1103 = "(";
  protected final String TEXT_1104 = "* ";
  protected final String TEXT_1105 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1122 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1123 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1124 = NL + "  bool ";
  protected final String TEXT_1125 = "::";
  protected final String TEXT_1126 = "(";
  protected final String TEXT_1127 = " ";
  protected final String TEXT_1128 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1129 = NL + "    if (";
  protected final String TEXT_1130 = "() >= ";
  protected final String TEXT_1131 = "())" + NL + "    {";
  protected final String TEXT_1132 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1152 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1153 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1154 = "::";
  protected final String TEXT_1155 = "(";
  protected final String TEXT_1156 = " ";
  protected final String TEXT_1157 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1166 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1167 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1168 = NL + "  bool ";
  protected final String TEXT_1169 = "::";
  protected final String TEXT_1170 = "(";
  protected final String TEXT_1171 = " ";
  protected final String TEXT_1172 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1178 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1179 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1180 = "::";
  protected final String TEXT_1181 = "(";
  protected final String TEXT_1182 = " ";
  protected final String TEXT_1183 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1184 = NL + "    if (!";
  protected final String TEXT_1185 = ".contains(";
  protected final String TEXT_1186 = "))" + NL + "    {";
  protected final String TEXT_1187 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1193 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1194 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1195 = NL + "  bool ";
  protected final String TEXT_1196 = "::";
  protected final String TEXT_1197 = "(";
  protected final String TEXT_1198 = " ";
  protected final String TEXT_1199 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1225 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1226 = "::";
  protected final String TEXT_1227 = "(";
  protected final String TEXT_1228 = " ";
  protected final String TEXT_1229 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1236 = ".remove(";
  protected final String TEXT_1237 = ");";
  protected final String TEXT_1238 = NL + "      ";
  protected final String TEXT_1239 = "(";
  protected final String TEXT_1240 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1241 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1247 = NL + "    vector<";
  protected final String TEXT_1248 = "*> ";
  protected final String TEXT_1249 = " = new vector<";
  ...
  protected final String TEXT_1256 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1257 = ".";
  protected final String TEXT_1258 = "() != null && !this.equals(";
  protected final String TEXT_1259 = ".";
  protected final String TEXT_1260 = "()))" + NL + "      {";
  protected final String TEXT_1261 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1262 = NL + "      ";
  protected final String TEXT_1263 = ".add(";
  protected final String TEXT_1264 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1269 = ".removeAll(";
  protected final String TEXT_1270 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1271 = " orphan : ";
  protected final String TEXT_1272 = ")" + NL + "    {";
  protected final String TEXT_1273 = NL + "      ";
  protected final String TEXT_1274 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1275 = NL + "    ";
  protected final String TEXT_1276 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1282 = ", this);";
  protected final String TEXT_1283 = NL + "      ";
  protected final String TEXT_1284 = ".add(";
  protected final String TEXT_1285 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1286 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1287 = NL + "  void ";
  ...
  protected final String TEXT_1293 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1294 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1295 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1296 = ", ";
  protected final String TEXT_1297 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1298 = " to ";
  protected final String TEXT_1299 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1318 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1319 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1324 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1330 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_1341 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1342 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1343 = NL + "  bool ";
  protected final String TEXT_1344 = "::";
  protected final String TEXT_1345 = "(";
  protected final String TEXT_1346 = " ";
  protected final String TEXT_1347 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1348 = NL + "    ";
  protected final String TEXT_1349 = ".add(";
  protected final String TEXT_1350 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1351 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1352 = "::";
  protected final String TEXT_1353 = "(";
  protected final String TEXT_1354 = " ";
  protected final String TEXT_1355 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1356 = NL + "    if (!";
  protected final String TEXT_1357 = ".contains(";
  protected final String TEXT_1358 = "))" + NL + "    {";
  protected final String TEXT_1359 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1360 = "() <= ";
  protected final String TEXT_1361 = "())" + NL + "    {";
  protected final String TEXT_1362 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1363 = NL + "    ";
  protected final String TEXT_1364 = ".remove(";
  protected final String TEXT_1365 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1366 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1367 = NL + "  bool ";
  ...
  protected final String TEXT_1372 = NL + "    vector<";
  protected final String TEXT_1373 = "*> ";
  protected final String TEXT_1374 = " = new vector<";
  ...
  protected final String TEXT_1396 = " bool ";
  ...
  protected final String TEXT_1402 = ";" + NL + "    for (int i=0 ; i<";
  protected final String TEXT_1403 = ".size() ; i++)" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1404 = ".begin(),";
  protected final String TEXT_1405 = ".end(),(";
  protected final String TEXT_1406 = ") - ";
  protected final String TEXT_1407 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1412 = ".length)" + NL + "    {";
  protected final String TEXT_1413 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1414 = NL + "    ";
  protected final String TEXT_1415 = ".clear();";
  protected final String TEXT_1416 = NL + "    ";
  protected final String TEXT_1417 = ".addAll(";
  protected final String TEXT_1418 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1419 = NL + "    return wasSet;" + NL + "  }" + NL;
  ...
  protected final String TEXT_1424 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1425 = NL + "    vector<";
  protected final String TEXT_1426 = "*> ";
  protected final String TEXT_1427 = " = new vector<";
  protected final String TEXT_1428 = "*>();" + NL + "    for (";
  protected final String TEXT_1429 = " ";
  protected final String TEXT_1430 = " : ";
  protected final String TEXT_1431 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1432 = ".contains(";
  protected final String TEXT_1433 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1434 = NL + "      ";
  protected final String TEXT_1435 = ".add(";
  protected final String TEXT_1436 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1437 = ".size() != ";
  protected final String TEXT_1438 = ".length || ";
  protected final String TEXT_1439 = ".size() < ";
  protected final String TEXT_1440 = "() || ";
  protected final String TEXT_1441 = ".size() > ";
  protected final String TEXT_1442 = "())" + NL + "    {";
  protected final String TEXT_1443 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1444 = "*> ";
  protected final String TEXT_1445 = " = new vector<";
  protected final String TEXT_1446 = "*>(";
  protected final String TEXT_1447 = ");";
  protected final String TEXT_1448 = NL + "    ";
  protected final String TEXT_1449 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1460 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1461 = NL + "        ";
  protected final String TEXT_1462 = ".";
  protected final String TEXT_1463 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1469 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1470 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1471 = NL + "  bool ";
  protected final String TEXT_1472 = "::";
  protected final String TEXT_1473 = "(";
  protected final String TEXT_1474 = "... ";
  protected final String TEXT_1475 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1476 = NL + "    vector<";
  protected final String TEXT_1477 = "*> ";
  protected final String TEXT_1478 = " = new vector<";
  protected final String TEXT_1479 = "*>();" + NL + "    for (";
  protected final String TEXT_1480 = " ";
  protected final String TEXT_1481 = " : ";
  protected final String TEXT_1482 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1483 = ".contains(";
  protected final String TEXT_1484 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1485 = NL + "      ";
  protected final String TEXT_1486 = ".add(";
  protected final String TEXT_1487 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1488 = ".size() != ";
  protected final String TEXT_1489 = ".length || ";
  protected final String TEXT_1490 = ".size() < ";
  protected final String TEXT_1491 = "())" + NL + "    {";
  protected final String TEXT_1492 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1493 = "*> ";
  protected final String TEXT_1494 = " = new vector<";
  protected final String TEXT_1495 = "*>(";
  protected final String TEXT_1496 = ");";
  protected final String TEXT_1497 = NL + "    ";
  protected final String TEXT_1498 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1508 = ".remove(";
  protected final String TEXT_1509 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1510 = NL + "        ";
  protected final String TEXT_1511 = ".";
  protected final String TEXT_1512 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1518 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1519 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1520 = NL + "  bool ";
  protected final String TEXT_1521 = "::";
  protected final String TEXT_1522 = "(";
  protected final String TEXT_1523 = "... ";
  protected final String TEXT_1524 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1525 = NL + "    vector<";
  protected final String TEXT_1526 = "*> ";
  protected final String TEXT_1527 = " = new vector<";
  protected final String TEXT_1528 = "*>();" + NL + "    for (";
  protected final String TEXT_1529 = " ";
  protected final String TEXT_1530 = " : ";
  protected final String TEXT_1531 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1532 = ".contains(";
  protected final String TEXT_1533 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1534 = NL + "      ";
  protected final String TEXT_1535 = ".add(";
  protected final String TEXT_1536 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1537 = ".size() != ";
  protected final String TEXT_1538 = ".length || ";
  ...
  protected final String TEXT_1545 = ".clear();";
  protected final String TEXT_1546 = NL + "    ";
  protected final String TEXT_1547 = ".addAll(";
  protected final String TEXT_1548 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1549 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1550 = NL + "  bool ";
  protected final String TEXT_1551 = "::";
  protected final String TEXT_1552 = "(";
  protected final String TEXT_1553 = "... ";
  protected final String TEXT_1554 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1559 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1560 = "*> ";
  protected final String TEXT_1561 = " = new vector<";
  protected final String TEXT_1562 = "*>();" + NL + "    HashMap<";
  protected final String TEXT_1563 = ",Integer> ";
  protected final String TEXT_1564 = " = new HashMap<";
  protected final String TEXT_1565 = ",Integer>();" + NL + "    for (";
  protected final String TEXT_1566 = " ";
  protected final String TEXT_1567 = " : ";
  protected final String TEXT_1568 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1569 = ".contains(";
  protected final String TEXT_1570 = "))" + NL + "      {";
  protected final String TEXT_1571 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1572 = ".";
  protected final String TEXT_1573 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1581 = ".containsKey(";
  protected final String TEXT_1582 = "))" + NL + "        {";
  protected final String TEXT_1583 = NL + "          ";
  protected final String TEXT_1584 = ".put(";
  protected final String TEXT_1585 = ", new Integer(";
  protected final String TEXT_1586 = ".";
  protected final String TEXT_1587 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1588 = ".get(";
  protected final String TEXT_1589 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1590 = ")" + NL + "        {";
  protected final String TEXT_1591 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1592 = NL + "        ";
  protected final String TEXT_1593 = ".put(";
  protected final String TEXT_1594 = ", new Integer(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1599 = ".removeAll(";
  protected final String TEXT_1600 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1601 = " orphan : ";
  protected final String TEXT_1602 = ")" + NL + "    {";
  protected final String TEXT_1603 = NL + "      ";
  protected final String TEXT_1604 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1605 = NL + "    ";
  protected final String TEXT_1606 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1615 = ".remove(";
  ...
  protected final String TEXT_1622 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1623 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1624 = NL + "  void ";
  ...
  protected final String TEXT_1630 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1631 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1632 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1633 = ", ";
  protected final String TEXT_1634 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1635 = " to ";
  protected final String TEXT_1636 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1648 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1649 = ".begin(),";
  protected final String TEXT_1650 = ".end(),(";
  protected final String TEXT_1651 = ")) - ";
  protected final String TEXT_1652 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1667 = NL + "  bool ";
  protected final String TEXT_1668 = "::";
  protected final String TEXT_1669 = "(";
  protected final String TEXT_1670 = "... ";
  protected final String TEXT_1671 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1672 = NL + "    vector<";
  protected final String TEXT_1673 = "*> ";
  protected final String TEXT_1674 = " = new vector<";
  protected final String TEXT_1675 = "*>();" + NL + "    for (";
  protected final String TEXT_1676 = " ";
  protected final String TEXT_1677 = " : ";
  protected final String TEXT_1678 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1679 = ".contains(";
  protected final String TEXT_1680 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1681 = NL + "      ";
  protected final String TEXT_1682 = ".add(";
  protected final String TEXT_1683 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1684 = ".size() != ";
  protected final String TEXT_1685 = ".length || ";
  protected final String TEXT_1686 = ".size() < ";
  protected final String TEXT_1687 = "())" + NL + "    {";
  protected final String TEXT_1688 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1689 = NL + "    ";
  protected final String TEXT_1690 = ".clear();";
  protected final String TEXT_1691 = NL + "    ";
  protected final String TEXT_1692 = ".addAll(";
  protected final String TEXT_1693 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1694 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1695 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1696 = NL + "    ";
  protected final String TEXT_1697 = " == (";
  protected final String TEXT_1698 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1699 = NL + "    ";
  protected final String TEXT_1700 = NL;
  protected final String TEXT_1701 = NL + "    ";
  protected final String TEXT_1702 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1703 = NL + "   void ";
  protected final String TEXT_1704 = "::";
  protected final String TEXT_1705 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1706 = NL + "       ";
  protected final String TEXT_1707 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1708 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1709 = NL + "    ";
  protected final String TEXT_1710 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1711 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1712 = NL + "      ";
  protected final String TEXT_1713 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1714 = NL + "  void ";
  protected final String TEXT_1715 = "::";
  protected final String TEXT_1716 = "()" + NL + "  {";
  protected final String TEXT_1717 = NL + "    ";
  protected final String TEXT_1718 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1719 = "\",";
  protected final String TEXT_1720 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1721 = "::";
  protected final String TEXT_1722 = "()" + NL + "  {";
  protected final String TEXT_1723 = NL + "    ";
  protected final String TEXT_1724 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1725 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1726 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1727 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1728 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1729 = "::run ()" + NL + "    {";
  protected final String TEXT_1730 = NL + "      if (\"";
  protected final String TEXT_1731 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1732 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1733 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1734 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1735 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1736 = NL + "    ";
  protected final String TEXT_1737 = " = NULL;" + NL + "    delete ";
  ...
  protected final String TEXT_1746 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1747 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1748 = ";" + NL + "    }";
  protected final String TEXT_1749 = NL + "    if (";
  protected final String TEXT_1750 = " != NULL)" + NL + "    {";
  ...
  protected final String TEXT_1760 = " != NULL)" + NL + "    {";
  ...
  protected final String TEXT_1769 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1770 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1786 = " != NULL)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1787 = ".";
  protected final String TEXT_1788 = "() <= ";
  protected final String TEXT_1789 = ")" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1790 = ";" + NL + "      }" + NL + "      else" + NL + "      {";
  ...
  protected final String TEXT_1837 = ");i++)" + NL + "    {";
  protected final String TEXT_1838 = NL + "      ";
  protected final String TEXT_1839 = "[i].";
  protected final String TEXT_1840 = "(this);" + NL + "    }";
  protected final String TEXT_1841 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1842 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1843 = "[i];" + NL + "    }";
  protected final String TEXT_1844 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1845 = "); i++)" + NL + "    {";
  protected final String TEXT_1846 = NL + "      ";
  protected final String TEXT_1847 = "[i].";
  protected final String TEXT_1848 = "(NULL);" + NL + "    }";
  protected final String TEXT_1849 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
