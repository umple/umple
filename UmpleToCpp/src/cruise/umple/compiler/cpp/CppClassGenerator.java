...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_792 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1152 = ".erase(find(";
  ...
  protected final String TEXT_1158 = "(NULL);" + NL + "\t  delete ";
  protected final String TEXT_1159 = "[index]" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1160 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1161 = NL + "  bool ";
  protected final String TEXT_1162 = "::";
  protected final String TEXT_1163 = "(";
  protected final String TEXT_1164 = "* ";
  protected final String TEXT_1165 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1198 = " == NULL)" + NL + "    {";
  protected final String TEXT_1199 = NL + "      ";
  protected final String TEXT_1200 = "->";
  protected final String TEXT_1201 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1209 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1210 = NL + "      ";
  protected final String TEXT_1211 = ".push_back(";
  protected final String TEXT_1212 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1213 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1214 = "::";
  protected final String TEXT_1215 = "(";
  protected final String TEXT_1216 = "* ";
  protected final String TEXT_1217 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  ...
  protected final String TEXT_1222 = NL + "    if (find(";
  protected final String TEXT_1223 = ".begin(),";
  protected final String TEXT_1224 = ".end(),";
  protected final String TEXT_1225 = ") != ";
  protected final String TEXT_1226 = ".end())" + NL + "    {";
  ...
  protected final String TEXT_1232 = "(NULL);" + NL + "\t  delete ";
  protected final String TEXT_1233 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1234 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1235 = NL + "  bool ";
  protected final String TEXT_1236 = "::";
  protected final String TEXT_1237 = "(";
  protected final String TEXT_1238 = " ";
  protected final String TEXT_1239 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1244 = ".push_back(";
  protected final String TEXT_1245 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1246 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1247 = "::";
  protected final String TEXT_1248 = "(";
  protected final String TEXT_1249 = "* ";
  protected final String TEXT_1250 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  ...
  protected final String TEXT_1255 = NL + "    if (!find(";
  protected final String TEXT_1256 = ".begin(),";
  protected final String TEXT_1257 = ".end(),";
  protected final String TEXT_1258 = ") != ";
  protected final String TEXT_1259 = ".end())" + NL + "    {";
  protected final String TEXT_1260 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1265 = ".erase(find(";
  protected final String TEXT_1266 = ".begin(),";
  protected final String TEXT_1267 = ".end(),";
  protected final String TEXT_1268 = "));" + NL + "\tdelete ";
  protected final String TEXT_1269 = "[index];" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_1279 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1289 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1290 = " != null)" + NL + "    {";
  protected final String TEXT_1291 = NL + "      ";
  protected final String TEXT_1292 = ".";
  protected final String TEXT_1293 = ".erase(find(";
  protected final String TEXT_1294 = ".begin(),";
  protected final String TEXT_1295 = ".end(),";
  protected final String TEXT_1296 = "));" + NL + "    }";
  protected final String TEXT_1297 = NL + "    ";
  protected final String TEXT_1298 = ".push_back(";
  protected final String TEXT_1299 = ");";
  protected final String TEXT_1300 = NL + "    ";
  protected final String TEXT_1301 = "(";
  protected final String TEXT_1302 = ",this);" + NL + "    wasAdded = true;";
  ...
  protected final String TEXT_1320 = ".erase(find(";
  protected final String TEXT_1321 = ".begin(),";
  ...
  protected final String TEXT_1326 = ",NULL);" + NL + "\t  delete ";
  protected final String TEXT_1327 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1333 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1334 = NL + "    vector<";
  protected final String TEXT_1335 = "*> ";
  protected final String TEXT_1336 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_1337 = " ";
  protected final String TEXT_1338 = " : ";
  protected final String TEXT_1339 = ")" + NL + "    {" + NL + "      if (find(";
  ...
  protected final String TEXT_1502 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1503 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1504 = ".push_back(";
  protected final String TEXT_1505 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1506 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1507 = NL + "  ";
  protected final String TEXT_1508 = " bool ";
  protected final String TEXT_1509 = "(";
  protected final String TEXT_1510 = "... ";
  protected final String TEXT_1511 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1512 = NL + "    vector<";
  protected final String TEXT_1513 = "*> ";
  protected final String TEXT_1514 = ";" + NL + "    for (int i=0 ; i<";
  protected final String TEXT_1515 = ".size() ; i++)" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1516 = ".begin(),";
  protected final String TEXT_1517 = ".end(),(";
  protected final String TEXT_1518 = ") - ";
  protected final String TEXT_1519 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1524 = ".length)" + NL + "    {";
  protected final String TEXT_1525 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1526 = NL + "    ";
  protected final String TEXT_1527 = ".clear();";
  protected final String TEXT_1528 = NL + "    ";
  protected final String TEXT_1529 = ".addAll(";
  protected final String TEXT_1530 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1531 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1532 = NL + "  bool ";
  protected final String TEXT_1533 = "::";
  protected final String TEXT_1534 = "(";
  protected final String TEXT_1535 = "... ";
  protected final String TEXT_1536 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1537 = NL + "    vector<";
  protected final String TEXT_1538 = "*> ";
  protected final String TEXT_1539 = ";" + NL + "    for (";
  protected final String TEXT_1540 = " ";
  protected final String TEXT_1541 = " : ";
  protected final String TEXT_1542 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1543 = ".begin(),";
  protected final String TEXT_1544 = ".end(),";
  protected final String TEXT_1545 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1546 = NL + "      ";
  protected final String TEXT_1547 = "push_back(";
  protected final String TEXT_1548 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1549 = ".size() != ";
  protected final String TEXT_1550 = ".length || ";
  protected final String TEXT_1551 = ".size() < ";
  protected final String TEXT_1552 = "() || ";
  protected final String TEXT_1553 = ".size() > ";
  protected final String TEXT_1554 = "())" + NL + "    {";
  protected final String TEXT_1555 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1556 = "*> ";
  protected final String TEXT_1557 = " = new vector<";
  ...
  protected final String TEXT_1567 = ");" + NL + "      if (find(";
  protected final String TEXT_1568 = ".begin(),";
  protected final String TEXT_1569 = ".end(),";
  protected final String TEXT_1570 = "))" + NL + "      {";
  protected final String TEXT_1571 = NL + "        ";
  protected final String TEXT_1572 = ".erase(find(";
  protected final String TEXT_1573 = ".begin(),";
  protected final String TEXT_1574 = ".end(),";
  protected final String TEXT_1575 = "));" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1576 = NL + "        ";
  protected final String TEXT_1577 = "->";
  protected final String TEXT_1578 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1584 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1585 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1593 = ";" + NL + "\t" + NL + "    for (";
  ...
  protected final String TEXT_1599 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1600 = NL + "      ";
  protected final String TEXT_1601 = ".push_back(";
  protected final String TEXT_1602 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1603 = ".size() != ";
  protected final String TEXT_1604 = ".length || ";
  protected final String TEXT_1605 = ".size() < ";
  protected final String TEXT_1606 = "())" + NL + "    {";
  protected final String TEXT_1607 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1608 = "*> ";
  protected final String TEXT_1609 = ";";
  protected final String TEXT_1610 = NL + "    ";
  protected final String TEXT_1611 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1616 = ".push_back(";
  protected final String TEXT_1617 = ");" + NL + "      if (find(";
  protected final String TEXT_1618 = ".begin(),";
  protected final String TEXT_1619 = ".end(),";
  protected final String TEXT_1620 = ")))" + NL + "      {";
  protected final String TEXT_1621 = NL + "        ";
  protected final String TEXT_1622 = ".erase(";
  protected final String TEXT_1623 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1624 = NL + "        ";
  protected final String TEXT_1625 = "->";
  protected final String TEXT_1626 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1632 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1633 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1634 = NL + "  bool ";
  protected final String TEXT_1635 = "::";
  protected final String TEXT_1636 = "(";
  protected final String TEXT_1637 = "... ";
  protected final String TEXT_1638 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1639 = NL + "    vector<";
  protected final String TEXT_1640 = "*> ";
  protected final String TEXT_1641 = ";" + NL + "    for (";
  protected final String TEXT_1642 = " ";
  protected final String TEXT_1643 = " : ";
  protected final String TEXT_1644 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1645 = ".begin(),";
  protected final String TEXT_1646 = ".end(),";
  protected final String TEXT_1647 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1648 = NL + "      ";
  protected final String TEXT_1649 = "->add(";
  protected final String TEXT_1650 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1651 = ".size() != ";
  protected final String TEXT_1652 = ".size() || ";
  ...
  protected final String TEXT_1657 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1658 = NL + "    ";
  protected final String TEXT_1659 = ".clear();" + NL + "\tfor (int i=0; i<";
  protected final String TEXT_1660 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1661 = ".push_back(";
  protected final String TEXT_1662 = "[i]);" + NL + "\t}" + NL + "    " + NL + "    wasSet = true;";
  protected final String TEXT_1663 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1664 = NL + "  bool ";
  protected final String TEXT_1665 = "::";
  protected final String TEXT_1666 = "(";
  protected final String TEXT_1667 = "... ";
  protected final String TEXT_1668 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1673 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1674 = "*> ";
  protected final String TEXT_1675 = ";" + NL + "\t" + NL + "    map<";
  protected final String TEXT_1676 = ",int> ";
  protected final String TEXT_1677 = ";" + NL + "    for (";
  protected final String TEXT_1678 = " ";
  protected final String TEXT_1679 = " : ";
  protected final String TEXT_1680 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1681 = ".begin(),";
  protected final String TEXT_1682 = ".end(),";
  protected final String TEXT_1683 = "))" + NL + "      {";
  protected final String TEXT_1684 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1685 = "->";
  protected final String TEXT_1686 = "() != NULL && this!=";
  ...
  protected final String TEXT_1697 = ".insert(";
  protected final String TEXT_1698 = ", new int(";
  protected final String TEXT_1699 = "->";
  protected final String TEXT_1700 = "()));" + NL + "        }" + NL + "        int currentCount = ";
  protected final String TEXT_1701 = ".find(";
  protected final String TEXT_1702 = ")->firtst;" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1703 = ")" + NL + "        {";
  protected final String TEXT_1704 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1705 = NL + "        ";
  protected final String TEXT_1706 = ".insert(";
  protected final String TEXT_1707 = ", new int(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1712 = ".removeAll(";
  protected final String TEXT_1713 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1714 = " orphan : ";
  protected final String TEXT_1715 = ")" + NL + "    {";
  protected final String TEXT_1716 = NL + "      ";
  protected final String TEXT_1717 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1718 = NL + "    ";
  protected final String TEXT_1719 = ".clear();" + NL + "    for (";
  protected final String TEXT_1720 = " ";
  protected final String TEXT_1721 = " : ";
  protected final String TEXT_1722 = ")" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1728 = ".erase(";
  ...
  protected final String TEXT_1734 = ".push_back(";
  protected final String TEXT_1735 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1736 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1737 = NL + "  void ";
  ...
  protected final String TEXT_1743 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1744 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1745 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1746 = ", ";
  protected final String TEXT_1747 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1748 = " to ";
  protected final String TEXT_1749 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1750 = NL + "  bool ";
  protected final String TEXT_1751 = "::";
  protected final String TEXT_1752 = "(";
  protected final String TEXT_1753 = "... ";
  protected final String TEXT_1754 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1755 = NL + "    vector<";
  protected final String TEXT_1756 = "*> ";
  protected final String TEXT_1757 = ";" + NL + "    for (";
  protected final String TEXT_1758 = " ";
  protected final String TEXT_1759 = " : ";
  protected final String TEXT_1760 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1761 = ".begin(),";
  protected final String TEXT_1762 = ".end(),(";
  protected final String TEXT_1763 = ")) - ";
  protected final String TEXT_1764 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1765 = NL + "      ";
  protected final String TEXT_1766 = ".push_back(";
  protected final String TEXT_1767 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1768 = ".size() != ";
  protected final String TEXT_1769 = ".size() || ";
  protected final String TEXT_1770 = ".size() > ";
  protected final String TEXT_1771 = "())" + NL + "    {";
  protected final String TEXT_1772 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1773 = NL + "    ";
  protected final String TEXT_1774 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1775 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1776 = ".push_back(";
  protected final String TEXT_1777 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1778 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1779 = NL + "  bool ";
  protected final String TEXT_1780 = "::";
  protected final String TEXT_1781 = "(";
  protected final String TEXT_1782 = "... ";
  protected final String TEXT_1783 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1784 = NL + "    vector<";
  protected final String TEXT_1785 = "*> ";
  protected final String TEXT_1786 = ";" + NL + "    for (";
  protected final String TEXT_1787 = " ";
  protected final String TEXT_1788 = " : ";
  protected final String TEXT_1789 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1790 = ".begin(),";
  protected final String TEXT_1791 = ".end(),";
  protected final String TEXT_1792 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1793 = NL + "      ";
  protected final String TEXT_1794 = "->add(";
  protected final String TEXT_1795 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1796 = ".size() != ";
  protected final String TEXT_1797 = ".size() || ";
  protected final String TEXT_1798 = ".size() < ";
  protected final String TEXT_1799 = "())" + NL + "    {";
  protected final String TEXT_1800 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1801 = NL + "    ";
  protected final String TEXT_1802 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1803 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1804 = ".push_back(";
  protected final String TEXT_1805 = "[i]);" + NL + "\t}" + NL + "\t" + NL + "    wasSet = true;";
  protected final String TEXT_1806 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1807 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1808 = NL + "    ";
  protected final String TEXT_1809 = " == (";
  protected final String TEXT_1810 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1811 = NL + "    ";
  protected final String TEXT_1812 = NL;
  protected final String TEXT_1813 = NL + "    ";
  protected final String TEXT_1814 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1815 = NL + "   void ";
  protected final String TEXT_1816 = "::";
  protected final String TEXT_1817 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1818 = NL + "       ";
  protected final String TEXT_1819 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1820 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1821 = NL + "    ";
  protected final String TEXT_1822 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1823 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1824 = NL + "      ";
  protected final String TEXT_1825 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1826 = NL + "  void ";
  protected final String TEXT_1827 = "::";
  protected final String TEXT_1828 = "()" + NL + "  {";
  protected final String TEXT_1829 = NL + "    ";
  protected final String TEXT_1830 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1831 = "\",";
  protected final String TEXT_1832 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1833 = "::";
  protected final String TEXT_1834 = "()" + NL + "  {";
  protected final String TEXT_1835 = NL + "    ";
  protected final String TEXT_1836 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1837 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1838 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1839 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1840 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1841 = "::run ()" + NL + "    {";
  protected final String TEXT_1842 = NL + "      if (\"";
  protected final String TEXT_1843 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1844 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1845 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1846 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1847 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1848 = NL + "    ";
  protected final String TEXT_1849 = " = NULL;" + NL + "    delete ";
  ...
  protected final String TEXT_1858 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1859 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1919 = NL + "    for(i =0; sizeof(";
  protected final String TEXT_1920 = "); i++)" + NL + "    {";
  protected final String TEXT_1921 = NL + "      ";
  protected final String TEXT_1922 = "(";
  protected final String TEXT_1923 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1924 = NL + "    ";
  protected final String TEXT_1925 = ".clear();";
  protected final String TEXT_1926 = NL + "    vector<";
  ...
  protected final String TEXT_1931 = ".clear();" + NL + "    for(i =0; sizeof(";
  protected final String TEXT_1932 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_1933 = ".";
  protected final String TEXT_1934 = "() <= ";
  protected final String TEXT_1935 = "->";
  protected final String TEXT_1936 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1937 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1938 = NL + "        ";
  protected final String TEXT_1939 = "->";
  protected final String TEXT_1940 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1941 = NL + "    vector<";
  ...
  protected final String TEXT_1946 = ".clear();" + NL + "    for(i=0;sizeof(";
  protected final String TEXT_1947 = ");i++)" + NL + "    {";
  protected final String TEXT_1948 = NL + "      ";
  protected final String TEXT_1949 = "[i]->";
  protected final String TEXT_1950 = "(this);" + NL + "    }";
  protected final String TEXT_1951 = NL + "    for(i =0; sizeof(";
  protected final String TEXT_1952 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1953 = "[i];" + NL + "    }";
  protected final String TEXT_1954 = NL + "    for(i =0; sizeof(";
  protected final String TEXT_1955 = "); i++)" + NL + "    {";
  protected final String TEXT_1956 = NL + "      ";
  protected final String TEXT_1957 = "[i]->";
  protected final String TEXT_1958 = "(NULL);" + NL + "    }";
  protected final String TEXT_1959 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
