...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_308 = NL + "  bool ";
  protected final String TEXT_309 = "::";
  protected final String TEXT_310 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;" + NL;
  protected final String TEXT_311 = NL + "    ";
  protected final String TEXT_312 = NL + NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  ...
  protected final String TEXT_320 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_321 = NL + "  private void ";
  protected final String TEXT_322 = "::";
  protected final String TEXT_323 = "()" + NL + "  {" + NL + "    switch(";
  protected final String TEXT_324 = ")" + NL + "    {";
  protected final String TEXT_325 = NL + "      ";
  protected final String TEXT_326 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_327 = NL + "  private void ";
  ...
  protected final String TEXT_345 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_353 = "() const" + NL + "  {";
  ...
  protected final String TEXT_366 = "(int index) const" + NL + "  {";
  protected final String TEXT_367 = NL + "    ";
  protected final String TEXT_368 = " ";
  protected final String TEXT_369 = " = ";
  protected final String TEXT_370 = ".get(index);";
  protected final String TEXT_371 = NL + "    return ";
  protected final String TEXT_372 = ";" + NL + "  }" + NL + "" + NL + "  vector<";
  protected final String TEXT_373 = "*> ";
  protected final String TEXT_374 = "::";
  protected final String TEXT_375 = "() const" + NL + "  {";
  protected final String TEXT_376 = NL + "    vector<";
  protected final String TEXT_377 = "*> ";
  protected final String TEXT_378 = " = ";
  protected final String TEXT_379 = ";";
  protected final String TEXT_380 = NL + "    return ";
  protected final String TEXT_381 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_382 = "::";
  protected final String TEXT_383 = "()" + NL + "  {";
  protected final String TEXT_384 = NL + "    int number = ";
  protected final String TEXT_385 = ".size();";
  protected final String TEXT_386 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_387 = "::";
  protected final String TEXT_388 = "()" + NL + "  {";
  protected final String TEXT_389 = NL + "    bool has = ";
  protected final String TEXT_390 = ".size() > 0;";
  protected final String TEXT_391 = NL + "    return has;" + NL + "  }" + NL + "  " + NL + "  int ";
  protected final String TEXT_392 = "::";
  protected final String TEXT_393 = "(";
  protected final String TEXT_394 = " ";
  protected final String TEXT_395 = ")" + NL + "  {";
  protected final String TEXT_396 = NL + "    int index = std::find(";
  protected final String TEXT_397 = ".begin(), ";
  protected final String TEXT_398 = ".end(), ";
  protected final String TEXT_399 = ") - ";
  protected final String TEXT_400 = ".begin();";
  protected final String TEXT_401 = NL + "    return index;" + NL + "  }" + NL + "  ";
  protected final String TEXT_402 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_403 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_404 = " : ";
  protected final String TEXT_405 = NL + "  bool ";
  protected final String TEXT_406 = "::";
  protected final String TEXT_407 = "()" + NL + "  {";
  protected final String TEXT_408 = NL + "    bool isValid = ";
  ...
  protected final String TEXT_421 = NL + "  static int ";
  protected final String TEXT_422 = "::";
  protected final String TEXT_423 = "()" + NL + "  {";
  protected final String TEXT_424 = NL + "    int required = ";
  protected final String TEXT_425 = ";";
  protected final String TEXT_426 = NL + "    return required;" + NL + "  }";
  protected final String TEXT_427 = NL + "  static int ";
  ...
  protected final String TEXT_433 = NL + "    int minimum = ";
  protected final String TEXT_434 = ";";
  protected final String TEXT_435 = NL + "    return minimum;" + NL + "  }";
  ...
  protected final String TEXT_443 = NL + "    int maximum = ";
  protected final String TEXT_444 = ";";
  protected final String TEXT_445 = NL + "    return maximum;" + NL + "  }";
  protected final String TEXT_446 = NL + "  bool ";
  protected final String TEXT_447 = "::";
  protected final String TEXT_448 = "(";
  protected final String TEXT_449 = " ";
  protected final String TEXT_450 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_451 = NL + "    if (";
  protected final String TEXT_452 = "() >= ";
  protected final String TEXT_453 = "())" + NL + "    {";
  protected final String TEXT_454 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_455 = NL + "    ";
  protected final String TEXT_456 = ".add(";
  protected final String TEXT_457 = ");" + NL + "    if (";
  protected final String TEXT_458 = ".";
  protected final String TEXT_459 = "(this) != -1)" + NL + "    {" + NL + "      wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasAdded = ";
  protected final String TEXT_460 = ".";
  protected final String TEXT_461 = "(this);" + NL + "      if (!wasAdded)" + NL + "      {";
  protected final String TEXT_462 = NL + "        ";
  protected final String TEXT_463 = ".remove(";
  protected final String TEXT_464 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_465 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_466 = NL + "  bool ";
  protected final String TEXT_467 = "::";
  protected final String TEXT_468 = "(";
  protected final String TEXT_469 = " ";
  protected final String TEXT_470 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_471 = NL + "    if (!";
  protected final String TEXT_472 = ".contains(";
  protected final String TEXT_473 = "))" + NL + "    {";
  protected final String TEXT_474 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_475 = ".indexOf(";
  protected final String TEXT_476 = ");";
  protected final String TEXT_477 = NL + "    ";
  protected final String TEXT_478 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_479 = ".";
  protected final String TEXT_480 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_481 = ".";
  protected final String TEXT_482 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_483 = NL + "        ";
  protected final String TEXT_484 = ".add(oldIndex,";
  protected final String TEXT_485 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_486 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_487 = NL + "  bool ";
  protected final String TEXT_488 = "::";
  protected final String TEXT_489 = "(";
  protected final String TEXT_490 = "* ";
  protected final String TEXT_491 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_492 = NL + "    ";
  protected final String TEXT_493 = " = ";
  protected final String TEXT_494 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_495 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_496 = NL + "  bool ";
  protected final String TEXT_497 = "::";
  protected final String TEXT_498 = "(";
  protected final String TEXT_499 = "* ";
  protected final String TEXT_500 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_506 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_514 = ".equals(";
  protected final String TEXT_515 = ") && equals(";
  protected final String TEXT_516 = ".";
  protected final String TEXT_517 = "()))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_518 = ", as existing ";
  protected final String TEXT_519 = " would become an orphan";
  protected final String TEXT_520 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_529 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  ...
  protected final String TEXT_538 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_539 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_540 = NL + "  bool ";
  protected final String TEXT_541 = "::";
  protected final String TEXT_542 = "(";
  protected final String TEXT_543 = " ";
  protected final String TEXT_544 = ")" + NL + "  {" + NL + "    bool";
  protected final String TEXT_545 = NL + "    if (";
  protected final String TEXT_546 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_547 = " to null, as ";
  protected final String TEXT_548 = " must always be associated to a ";
  protected final String TEXT_549 = NL + "      return wasSet;" + NL + "    }" + NL + "    ";
  protected final String TEXT_550 = NL + "    ";
  protected final String TEXT_551 = " ";
  protected final String TEXT_552 = " = ";
  protected final String TEXT_553 = ".";
  protected final String TEXT_554 = "();" + NL + "    if (";
  protected final String TEXT_555 = " != null && !equals(";
  protected final String TEXT_556 = "))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_557 = ", the current ";
  protected final String TEXT_558 = " already has a ";
  protected final String TEXT_559 = ", which would be orphaned if it were re-assigned";
  ...
  protected final String TEXT_570 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_571 = " != null)" + NL + "    {";
  protected final String TEXT_572 = NL + "      ";
  protected final String TEXT_573 = ".";
  protected final String TEXT_574 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_582 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_583 = "::";
  protected final String TEXT_584 = "(";
  protected final String TEXT_585 = " ";
  protected final String TEXT_586 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_587 = NL + "    ";
  protected final String TEXT_588 = " ";
  protected final String TEXT_589 = " = ";
  protected final String TEXT_590 = ".";
  protected final String TEXT_591 = "();" + NL + "    bool ";
  ...
  protected final String TEXT_606 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_607 = "::";
  protected final String TEXT_608 = "(";
  protected final String TEXT_609 = " ";
  protected final String TEXT_610 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_611 = NL + "    //Unable to remove ";
  protected final String TEXT_612 = ", as it must always have a ";
  protected final String TEXT_613 = NL + "    if (this.equals(";
  protected final String TEXT_614 = ".";
  protected final String TEXT_615 = "()))" + NL + "    {";
  protected final String TEXT_616 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_617 = " already at minimum (";
  protected final String TEXT_618 = ")" + NL + "    if (";
  protected final String TEXT_619 = "() <= ";
  protected final String TEXT_620 = "())" + NL + "    {";
  protected final String TEXT_621 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_622 = NL + "    ";
  protected final String TEXT_623 = ".remove(";
  protected final String TEXT_624 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_625 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_632 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_633 = "(";
  protected final String TEXT_634 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_635 = "::";
  protected final String TEXT_636 = "(";
  protected final String TEXT_637 = " ";
  protected final String TEXT_638 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_647 = "();" + NL + "    bool ";
  ...
  protected final String TEXT_663 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_664 = "::";
  protected final String TEXT_665 = "(";
  protected final String TEXT_666 = " ";
  protected final String TEXT_667 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_682 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_689 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_690 = "(";
  protected final String TEXT_691 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_692 = "::";
  protected final String TEXT_693 = "(";
  protected final String TEXT_694 = " ";
  protected final String TEXT_695 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_696 = NL + "    if (";
  protected final String TEXT_697 = "() >= ";
  protected final String TEXT_698 = "())" + NL + "    {";
  protected final String TEXT_699 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_711 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_712 = NL + "      ";
  protected final String TEXT_713 = ".add(";
  protected final String TEXT_714 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_715 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_716 = "::";
  protected final String TEXT_717 = "(";
  protected final String TEXT_718 = " ";
  protected final String TEXT_719 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_720 = NL + "    //Unable to remove ";
  protected final String TEXT_721 = ", as it must always have a ";
  protected final String TEXT_722 = NL + "    if (!this.equals(";
  protected final String TEXT_723 = ".";
  protected final String TEXT_724 = "()))" + NL + "    {";
  protected final String TEXT_725 = NL + "      ";
  protected final String TEXT_726 = ".remove(";
  protected final String TEXT_727 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_728 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_729 = NL + "  bool ";
  protected final String TEXT_730 = "::";
  protected final String TEXT_731 = "(";
  protected final String TEXT_732 = "... ";
  protected final String TEXT_733 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_734 = NL + "    vector<";
  protected final String TEXT_735 = "*> ";
  protected final String TEXT_736 = " = new vector<";
  protected final String TEXT_737 = "*>();" + NL + "    for (";
  protected final String TEXT_738 = " ";
  protected final String TEXT_739 = " : ";
  protected final String TEXT_740 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_741 = ".contains(";
  protected final String TEXT_742 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_743 = NL + "      ";
  protected final String TEXT_744 = ".add(";
  protected final String TEXT_745 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_746 = ".size() != ";
  protected final String TEXT_747 = ".length || ";
  protected final String TEXT_748 = ".size() > ";
  protected final String TEXT_749 = "())" + NL + "    {";
  protected final String TEXT_750 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_751 = "*> ";
  protected final String TEXT_752 = " = new vector<";
  protected final String TEXT_753 = "*>(";
  protected final String TEXT_754 = ");";
  protected final String TEXT_755 = NL + "    ";
  protected final String TEXT_756 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_763 = ".contains(";
  protected final String TEXT_764 = "))" + NL + "      {";
  protected final String TEXT_765 = NL + "        ";
  protected final String TEXT_766 = ".remove(";
  protected final String TEXT_767 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_768 = NL + "        ";
  protected final String TEXT_769 = ".";
  protected final String TEXT_770 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_771 = " ";
  protected final String TEXT_772 = " : ";
  protected final String TEXT_773 = ")" + NL + "    {";
  protected final String TEXT_774 = NL + "      ";
  protected final String TEXT_775 = ".";
  protected final String TEXT_776 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_777 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_778 = NL + "  ";
  protected final String TEXT_779 = " ";
  protected final String TEXT_780 = "::";
  protected final String TEXT_781 = "(";
  protected final String TEXT_782 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_783 = "(";
  protected final String TEXT_784 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_785 = "::";
  protected final String TEXT_786 = "(";
  protected final String TEXT_787 = " ";
  protected final String TEXT_788 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_795 = " != null && !this.equals(";
  protected final String TEXT_796 = ");" + NL + "    if (";
  protected final String TEXT_797 = ")" + NL + "    {";
  protected final String TEXT_798 = NL + "      ";
  protected final String TEXT_799 = ".";
  protected final String TEXT_800 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_801 = NL + "      ";
  protected final String TEXT_802 = ".add(";
  protected final String TEXT_803 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_804 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_805 = "::";
  protected final String TEXT_806 = "(";
  protected final String TEXT_807 = " ";
  protected final String TEXT_808 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_809 = NL + "    //Unable to remove ";
  protected final String TEXT_810 = ", as it must always have a ";
  protected final String TEXT_811 = NL + "    if (!this.equals(";
  protected final String TEXT_812 = ".";
  protected final String TEXT_813 = "()))" + NL + "    {";
  protected final String TEXT_814 = NL + "      ";
  protected final String TEXT_815 = ".remove(";
  protected final String TEXT_816 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_817 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_818 = NL + "  bool ";
  protected final String TEXT_819 = "::";
  protected final String TEXT_820 = "(";
  protected final String TEXT_821 = "* ";
  protected final String TEXT_822 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_830 = " = null;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_836 = "(null);" + NL + "      }" + NL + "      wasSet = true;";
  ...
  protected final String TEXT_843 = ".equals(";
  protected final String TEXT_844 = "))" + NL + "    {";
  protected final String TEXT_845 = NL + "      ";
  protected final String TEXT_846 = ".";
  protected final String TEXT_847 = "(null);" + NL + "    }" + NL;
  ...
  protected final String TEXT_855 = "();" + NL + "" + NL + "    if (!equals(";
  ...
  protected final String TEXT_860 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_861 = NL + "  bool ";
  protected final String TEXT_862 = "::";
  protected final String TEXT_863 = "(";
  protected final String TEXT_864 = " ";
  protected final String TEXT_865 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_872 = NL + "      return wasRemoved;" + NL + "    }" + NL + "\t" + NL + "    int oldIndex = std::find(";
  protected final String TEXT_873 = ".begin(), ";
  protected final String TEXT_874 = ".end(), ";
  protected final String TEXT_875 = ") - ";
  protected final String TEXT_876 = ".begin();";
  protected final String TEXT_877 = NL + "    ";
  protected final String TEXT_878 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_879 = ".";
  protected final String TEXT_880 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_881 = ".";
  protected final String TEXT_882 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_883 = NL + "        ";
  protected final String TEXT_884 = ".add(oldIndex,";
  protected final String TEXT_885 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_886 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_887 = NL + "  bool ";
  protected final String TEXT_888 = "::";
  protected final String TEXT_889 = "(";
  protected final String TEXT_890 = " ";
  protected final String TEXT_891 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_892 = NL + "    if (!";
  protected final String TEXT_893 = ".contains(";
  protected final String TEXT_894 = "))" + NL + "    {";
  protected final String TEXT_895 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_896 = "() <= ";
  protected final String TEXT_897 = "())" + NL + "    {";
  protected final String TEXT_898 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = std::find(";
  ...
  protected final String TEXT_904 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_905 = ".";
  protected final String TEXT_906 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_907 = ".";
  protected final String TEXT_908 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_909 = NL + "        ";
  protected final String TEXT_910 = ".add(oldIndex,";
  protected final String TEXT_911 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_912 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_924 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_933 = ".equals(";
  protected final String TEXT_934 = "))" + NL + "    {";
  protected final String TEXT_935 = NL + "      ";
  protected final String TEXT_936 = ".";
  protected final String TEXT_937 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_938 = " != null)" + NL + "    {";
  protected final String TEXT_939 = NL + "      ";
  protected final String TEXT_940 = ".";
  protected final String TEXT_941 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_942 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_943 = NL + "  bool ";
  protected final String TEXT_944 = "::";
  protected final String TEXT_945 = "(";
  protected final String TEXT_946 = " ";
  protected final String TEXT_947 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_963 = "(this);" + NL + "    }";
  protected final String TEXT_964 = NL + "    ";
  protected final String TEXT_965 = ".";
  protected final String TEXT_966 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_967 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_968 = NL + "  bool ";
  protected final String TEXT_969 = "::";
  protected final String TEXT_970 = "(";
  protected final String TEXT_971 = " ";
  protected final String TEXT_972 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_973 = NL + "    //Must provide ";
  protected final String TEXT_974 = " to ";
  protected final String TEXT_975 = NL + "    if (";
  protected final String TEXT_976 = " == null)" + NL + "    {";
  protected final String TEXT_977 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_978 = " already at maximum (";
  ...
  protected final String TEXT_993 = ".equals(";
  protected final String TEXT_994 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_995 = ".";
  protected final String TEXT_996 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1003 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1004 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1005 = NL + "  bool ";
  protected final String TEXT_1006 = "::";
  protected final String TEXT_1007 = "(";
  protected final String TEXT_1008 = " ";
  protected final String TEXT_1009 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1010 = NL + "    //Must provide ";
  protected final String TEXT_1011 = " to ";
  protected final String TEXT_1012 = NL + "    if (";
  protected final String TEXT_1013 = " == null)" + NL + "    {";
  protected final String TEXT_1014 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1045 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1054 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1062 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1063 = NL + "      ";
  protected final String TEXT_1064 = ".add(";
  protected final String TEXT_1065 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1066 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1067 = "::";
  protected final String TEXT_1068 = "(";
  protected final String TEXT_1069 = " ";
  protected final String TEXT_1070 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1075 = ".remove(";
  protected final String TEXT_1076 = ");";
  protected final String TEXT_1077 = NL + "      ";
  protected final String TEXT_1078 = ".";
  protected final String TEXT_1079 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1080 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1081 = NL + "  bool ";
  protected final String TEXT_1082 = "::";
  protected final String TEXT_1083 = "(";
  protected final String TEXT_1084 = "* ";
  protected final String TEXT_1085 = ")" + NL + "  {" + NL + "    boolwasSet = false;";
  ...
  protected final String TEXT_1094 = ".equals(";
  protected final String TEXT_1095 = "))" + NL + "    {";
  protected final String TEXT_1096 = NL + "      ";
  protected final String TEXT_1097 = ".";
  protected final String TEXT_1098 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1099 = " != null)" + NL + "    {";
  protected final String TEXT_1100 = NL + "      ";
  protected final String TEXT_1101 = ".";
  protected final String TEXT_1102 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1103 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1104 = NL + "  bool ";
  protected final String TEXT_1105 = "::";
  protected final String TEXT_1106 = "(";
  protected final String TEXT_1107 = " ";
  protected final String TEXT_1108 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1109 = NL + "    if (";
  protected final String TEXT_1110 = "() >= ";
  protected final String TEXT_1111 = "())" + NL + "    {";
  protected final String TEXT_1112 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1121 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1131 = ".add(";
  ...
  protected final String TEXT_1137 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1146 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1147 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1148 = NL + "  bool ";
  protected final String TEXT_1149 = "::";
  protected final String TEXT_1150 = "(";
  protected final String TEXT_1151 = " ";
  protected final String TEXT_1152 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1165 = ".contains(";
  protected final String TEXT_1166 = "))" + NL + "    {";
  protected final String TEXT_1167 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1172 = ".remove(";
  protected final String TEXT_1173 = ");" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_1183 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1193 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1194 = " != null)" + NL + "    {";
  protected final String TEXT_1195 = NL + "      ";
  protected final String TEXT_1196 = ".";
  protected final String TEXT_1197 = ".remove(";
  ...
  protected final String TEXT_1204 = ",this);" + NL + "    wasAdded = true;";
  ...
  protected final String TEXT_1209 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1220 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1221 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1222 = NL + "  bool ";
  protected final String TEXT_1223 = "::";
  protected final String TEXT_1224 = "(";
  protected final String TEXT_1225 = "... ";
  protected final String TEXT_1226 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1227 = NL + "    vector<";
  protected final String TEXT_1228 = "*> ";
  protected final String TEXT_1229 = " = new vector<";
  protected final String TEXT_1230 = "*>();" + NL + "    for (";
  ...
  protected final String TEXT_1236 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1237 = ".";
  protected final String TEXT_1238 = "() != null && !this.equals(";
  protected final String TEXT_1239 = ".";
  protected final String TEXT_1240 = "()))" + NL + "      {";
  protected final String TEXT_1241 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1242 = NL + "      ";
  protected final String TEXT_1243 = ".add(";
  protected final String TEXT_1244 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1245 = ".size() != ";
  protected final String TEXT_1246 = "())" + NL + "    {";
  protected final String TEXT_1247 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1248 = NL + "    ";
  protected final String TEXT_1249 = ".removeAll(";
  protected final String TEXT_1250 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1251 = " orphan : ";
  protected final String TEXT_1252 = ")" + NL + "    {";
  protected final String TEXT_1253 = NL + "      ";
  protected final String TEXT_1254 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1255 = NL + "    ";
  protected final String TEXT_1256 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1265 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1266 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1267 = NL + "  void ";
  ...
  protected final String TEXT_1273 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1274 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1275 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1276 = ", ";
  protected final String TEXT_1277 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1278 = " to ";
  protected final String TEXT_1279 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1280 = NL + "  bool ";
  protected final String TEXT_1281 = "::";
  protected final String TEXT_1282 = "(";
  protected final String TEXT_1283 = " ";
  protected final String TEXT_1284 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1285 = NL + "    ";
  protected final String TEXT_1286 = ".add(";
  protected final String TEXT_1287 = ");" + NL + "    wasAdded = true;";
  ...
  protected final String TEXT_1309 = ".add(";
  protected final String TEXT_1310 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1311 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1312 = "::";
  protected final String TEXT_1313 = "(";
  protected final String TEXT_1314 = " ";
  protected final String TEXT_1315 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1316 = NL + "    if (";
  protected final String TEXT_1317 = ".contains(";
  protected final String TEXT_1318 = "))" + NL + "    {";
  protected final String TEXT_1319 = NL + "      ";
  protected final String TEXT_1320 = ".remove(";
  protected final String TEXT_1321 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1322 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1323 = NL + "  bool ";
  protected final String TEXT_1324 = "::";
  protected final String TEXT_1325 = "(";
  protected final String TEXT_1326 = " ";
  protected final String TEXT_1327 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1328 = NL + "    ";
  protected final String TEXT_1329 = ".add(";
  protected final String TEXT_1330 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1331 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1332 = "::";
  protected final String TEXT_1333 = "(";
  protected final String TEXT_1334 = " ";
  protected final String TEXT_1335 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1336 = NL + "    if (!";
  protected final String TEXT_1337 = ".contains(";
  protected final String TEXT_1338 = "))" + NL + "    {";
  protected final String TEXT_1339 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1340 = "() <= ";
  protected final String TEXT_1341 = "())" + NL + "    {";
  protected final String TEXT_1342 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1343 = NL + "    ";
  protected final String TEXT_1344 = ".remove(";
  protected final String TEXT_1345 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1346 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1347 = NL + "  bool ";
  ...
  protected final String TEXT_1359 = ".contains(";
  protected final String TEXT_1360 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1361 = NL + "      ";
  protected final String TEXT_1362 = ".add(";
  protected final String TEXT_1363 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1364 = ".size() != ";
  protected final String TEXT_1365 = ".length || ";
  ...
  protected final String TEXT_1370 = ".clear();";
  protected final String TEXT_1371 = NL + "    ";
  protected final String TEXT_1372 = ".addAll(";
  protected final String TEXT_1373 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1374 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1375 = NL + "  bool ";
  protected final String TEXT_1376 = "::";
  protected final String TEXT_1377 = "(";
  protected final String TEXT_1378 = "... ";
  protected final String TEXT_1379 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1380 = NL + "    vector<";
  protected final String TEXT_1381 = "*> ";
  protected final String TEXT_1382 = " = new vector<";
  protected final String TEXT_1383 = "*>();" + NL + "    for (";
  protected final String TEXT_1384 = " ";
  protected final String TEXT_1385 = " : ";
  protected final String TEXT_1386 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1387 = ".contains(";
  protected final String TEXT_1388 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1389 = NL + "      ";
  protected final String TEXT_1390 = ".add(";
  protected final String TEXT_1391 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1392 = ".size() != ";
  protected final String TEXT_1393 = ".length || ";
  ...
  protected final String TEXT_1398 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  ...
  protected final String TEXT_1404 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1424 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1425 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1426 = NL + "  bool ";
  protected final String TEXT_1427 = "::";
  protected final String TEXT_1428 = "(";
  protected final String TEXT_1429 = "... ";
  protected final String TEXT_1430 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1431 = NL + "    vector<";
  protected final String TEXT_1432 = "*> ";
  protected final String TEXT_1433 = " = new vector<";
  protected final String TEXT_1434 = "*>();" + NL + "    for (";
  protected final String TEXT_1435 = " ";
  protected final String TEXT_1436 = " : ";
  protected final String TEXT_1437 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1438 = ".contains(";
  protected final String TEXT_1439 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1440 = NL + "      ";
  protected final String TEXT_1441 = ".add(";
  protected final String TEXT_1442 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1443 = ".size() != ";
  protected final String TEXT_1444 = ".length || ";
  protected final String TEXT_1445 = ".size() < ";
  protected final String TEXT_1446 = "())" + NL + "    {";
  protected final String TEXT_1447 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1448 = "*> ";
  protected final String TEXT_1449 = " = new vector<";
  ...
  protected final String TEXT_1473 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1480 = NL + "    vector<";
  protected final String TEXT_1481 = "*> ";
  protected final String TEXT_1482 = " = new vector<";
  protected final String TEXT_1483 = "*>();" + NL + "    for (";
  protected final String TEXT_1484 = " ";
  protected final String TEXT_1485 = " : ";
  protected final String TEXT_1486 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1487 = ".contains(";
  protected final String TEXT_1488 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1489 = NL + "      ";
  protected final String TEXT_1490 = ".add(";
  protected final String TEXT_1491 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1492 = ".size() != ";
  protected final String TEXT_1493 = ".length || ";
  ...
  protected final String TEXT_1502 = ".addAll(";
  protected final String TEXT_1503 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1504 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1505 = NL + "  bool ";
  protected final String TEXT_1506 = "::";
  protected final String TEXT_1507 = "(";
  protected final String TEXT_1508 = "... ";
  protected final String TEXT_1509 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1514 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1515 = "*> ";
  protected final String TEXT_1516 = " = new vector<";
  protected final String TEXT_1517 = "*>();" + NL + "    HashMap<";
  protected final String TEXT_1518 = ",Integer> ";
  protected final String TEXT_1519 = " = new HashMap<";
  protected final String TEXT_1520 = ",Integer>();" + NL + "    for (";
  ...
  protected final String TEXT_1526 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1527 = ".";
  protected final String TEXT_1528 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1536 = ".containsKey(";
  protected final String TEXT_1537 = "))" + NL + "        {";
  protected final String TEXT_1538 = NL + "          ";
  protected final String TEXT_1539 = ".put(";
  protected final String TEXT_1540 = ", new Integer(";
  protected final String TEXT_1541 = ".";
  protected final String TEXT_1542 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1543 = ".get(";
  protected final String TEXT_1544 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1545 = ")" + NL + "        {";
  protected final String TEXT_1546 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1547 = NL + "        ";
  protected final String TEXT_1548 = ".put(";
  protected final String TEXT_1549 = ", new Integer(nextCount));" + NL + "      }";
  protected final String TEXT_1550 = NL + "      ";
  protected final String TEXT_1551 = ".add(";
  protected final String TEXT_1552 = ");" + NL + "    }" + NL;
  protected final String TEXT_1553 = NL + "    ";
  protected final String TEXT_1554 = ".removeAll(";
  protected final String TEXT_1555 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1556 = " orphan : ";
  protected final String TEXT_1557 = ")" + NL + "    {";
  protected final String TEXT_1558 = NL + "      ";
  protected final String TEXT_1559 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1560 = NL + "    ";
  protected final String TEXT_1561 = ".clear();" + NL + "    for (";
  protected final String TEXT_1562 = " ";
  protected final String TEXT_1563 = " : ";
  protected final String TEXT_1564 = ")" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1570 = ".remove(";
  ...
  protected final String TEXT_1577 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1578 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1579 = NL + "  void ";
  ...
  protected final String TEXT_1585 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1586 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1587 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1588 = ", ";
  protected final String TEXT_1589 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1590 = " to ";
  protected final String TEXT_1591 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1592 = NL + "  bool ";
  ...
  protected final String TEXT_1627 = " = new vector<";
  protected final String TEXT_1628 = "*>();" + NL + "    for (";
  protected final String TEXT_1629 = " ";
  protected final String TEXT_1630 = " : ";
  protected final String TEXT_1631 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1632 = ".contains(";
  protected final String TEXT_1633 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1634 = NL + "      ";
  protected final String TEXT_1635 = ".add(";
  protected final String TEXT_1636 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1637 = ".size() != ";
  protected final String TEXT_1638 = ".length || ";
  ...
  protected final String TEXT_1643 = ".clear();";
  protected final String TEXT_1644 = NL + "    ";
  protected final String TEXT_1645 = ".addAll(";
  protected final String TEXT_1646 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1647 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1648 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1649 = NL + "    ";
  protected final String TEXT_1650 = " == (";
  protected final String TEXT_1651 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1652 = NL + "    ";
  protected final String TEXT_1653 = NL;
  protected final String TEXT_1654 = NL + "    ";
  protected final String TEXT_1655 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1656 = NL + "   void ";
  protected final String TEXT_1657 = "::";
  protected final String TEXT_1658 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1659 = NL + "       ";
  protected final String TEXT_1660 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1661 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1662 = NL + "    ";
  protected final String TEXT_1663 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1664 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1665 = NL + "      ";
  protected final String TEXT_1666 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1667 = NL + "  void ";
  protected final String TEXT_1668 = "::";
  protected final String TEXT_1669 = "()" + NL + "  {";
  protected final String TEXT_1670 = NL + "    ";
  protected final String TEXT_1671 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1672 = "\",";
  protected final String TEXT_1673 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1674 = "::";
  protected final String TEXT_1675 = "()" + NL + "  {";
  protected final String TEXT_1676 = NL + "    ";
  protected final String TEXT_1677 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1678 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1679 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1680 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1681 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1682 = "::run ()" + NL + "    {";
  protected final String TEXT_1683 = NL + "      if (\"";
  protected final String TEXT_1684 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1685 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1686 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1687 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1688 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1689 = NL + "    ";
  protected final String TEXT_1690 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1691 = ";";
  protected final String TEXT_1692 = NL + "    ";
  protected final String TEXT_1693 = ".clear();";
  ...
  protected final String TEXT_1699 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1700 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1712 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1713 = " != NULL)" + NL + "    {";
  ...
  protected final String TEXT_1722 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1723 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1730 = ";" + NL + "      this.";
  protected final String TEXT_1731 = " = NULL;";
  protected final String TEXT_1732 = NL + "      ";
  protected final String TEXT_1733 = ".";
  protected final String TEXT_1734 = "(this);" + NL + "    }";
  protected final String TEXT_1735 = NL + "    if (";
  protected final String TEXT_1736 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1737 = ";" + NL + "    }";
  protected final String TEXT_1738 = NL + "    if (";
  protected final String TEXT_1739 = " != NULL)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1740 = ".";
  protected final String TEXT_1741 = "() <= ";
  protected final String TEXT_1742 = ")" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1743 = ";" + NL + "      }" + NL + "      else" + NL + "      {";
  ...
  protected final String TEXT_1751 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1752 = NL + "    ";
  protected final String TEXT_1753 = " ";
  protected final String TEXT_1754 = " = ";
  protected final String TEXT_1755 = ";" + NL + "    this.";
  protected final String TEXT_1756 = " = NULL;";
  protected final String TEXT_1757 = NL + "    ";
  protected final String TEXT_1758 = ".";
  protected final String TEXT_1759 = "(this);";
  protected final String TEXT_1760 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1761 = "); i++)" + NL + "    {";
  protected final String TEXT_1762 = NL + "      ";
  protected final String TEXT_1763 = "(";
  protected final String TEXT_1764 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1765 = NL + "    ";
  protected final String TEXT_1766 = ".clear();";
  protected final String TEXT_1767 = NL + "    vector<";
  protected final String TEXT_1768 = "> ";
  protected final String TEXT_1769 = " = vector<";
  protected final String TEXT_1770 = ">(";
  protected final String TEXT_1771 = ");";
  protected final String TEXT_1772 = NL + "    ";
  protected final String TEXT_1773 = ".clear();" + NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1774 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_1775 = ".";
  protected final String TEXT_1776 = "() <= ";
  protected final String TEXT_1777 = ".";
  protected final String TEXT_1778 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1779 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1780 = NL + "        ";
  protected final String TEXT_1781 = ".";
  protected final String TEXT_1782 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1783 = NL + "    vector<";
  protected final String TEXT_1784 = "> ";
  protected final String TEXT_1785 = " = new vector<";
  protected final String TEXT_1786 = ">(";
  protected final String TEXT_1787 = ");";
  protected final String TEXT_1788 = NL + "    ";
  protected final String TEXT_1789 = ".clear();" + NL + "    for(int i=0;sizeof(";
  protected final String TEXT_1790 = ");i++)" + NL + "    {";
  protected final String TEXT_1791 = NL + "      ";
  protected final String TEXT_1792 = "[i].";
  protected final String TEXT_1793 = "(this);" + NL + "    }";
  protected final String TEXT_1794 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1795 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1796 = "[i];" + NL + "    }";
  ...
  protected final String TEXT_1800 = "[i].";
  protected final String TEXT_1801 = "(NULL);" + NL + "    }";
  protected final String TEXT_1802 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
