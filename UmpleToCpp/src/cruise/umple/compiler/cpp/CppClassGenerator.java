...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_1071 = NL + "  bool ";
  protected final String TEXT_1072 = "::";
  protected final String TEXT_1073 = "(";
  protected final String TEXT_1074 = "* ";
  protected final String TEXT_1075 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1113 = NL + "    //Must provide ";
  protected final String TEXT_1114 = " to ";
  protected final String TEXT_1115 = NL + "    if (";
  protected final String TEXT_1116 = " == NULL)" + NL + "    {";
  protected final String TEXT_1117 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1133 = ")" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1134 = "->";
  protected final String TEXT_1135 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  protected final String TEXT_1136 = NL + "        ";
  protected final String TEXT_1137 = " = ";
  protected final String TEXT_1138 = ";";
  protected final String TEXT_1139 = NL + "        return wasSet;" + NL + "      }" + NL + "    }";
  protected final String TEXT_1140 = NL + "    ";
  protected final String TEXT_1141 = "->";
  protected final String TEXT_1142 = "(this);" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1157 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1165 = ");" + NL + "    } " + NL + "    else" + NL + "    {";
  protected final String TEXT_1166 = NL + "      ";
  protected final String TEXT_1167 = ".push_back(";
  protected final String TEXT_1168 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1169 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1170 = "::";
  protected final String TEXT_1171 = "(";
  protected final String TEXT_1172 = "* ";
  protected final String TEXT_1173 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1174 = ".begin(), ";
  protected final String TEXT_1175 = ".end(), ";
  protected final String TEXT_1176 = ") - ";
  protected final String TEXT_1177 = ".begin();";
  protected final String TEXT_1178 = NL + "    if (find(";
  protected final String TEXT_1179 = ".begin(),";
  protected final String TEXT_1180 = ".end(),";
  protected final String TEXT_1181 = ")!= ";
  protected final String TEXT_1182 = ".end())" + NL + "    {";
  protected final String TEXT_1183 = NL + "      ";
  protected final String TEXT_1184 = ".erase(find(";
  protected final String TEXT_1185 = ".begin(),";
  protected final String TEXT_1186 = ".end(),";
  protected final String TEXT_1187 = "));";
  protected final String TEXT_1188 = NL + "      ";
  protected final String TEXT_1189 = "->";
  protected final String TEXT_1190 = "(NULL);" + NL + "\t  delete ";
  protected final String TEXT_1191 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1210 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1211 = " != NULL)" + NL + "    {";
  protected final String TEXT_1212 = NL + "      ";
  protected final String TEXT_1213 = "->";
  protected final String TEXT_1214 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1215 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1216 = NL + "  bool ";
  protected final String TEXT_1217 = "::";
  protected final String TEXT_1218 = "(";
  protected final String TEXT_1219 = "* ";
  protected final String TEXT_1220 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1230 = " == NULL)" + NL + "    {";
  protected final String TEXT_1231 = NL + "      ";
  protected final String TEXT_1232 = "->";
  protected final String TEXT_1233 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1241 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1242 = NL + "      ";
  protected final String TEXT_1243 = ".push_back(";
  protected final String TEXT_1244 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  ...
  protected final String TEXT_1264 = "(NULL);" + NL + "\t  delete ";
  protected final String TEXT_1265 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1266 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1267 = NL + "  bool ";
  protected final String TEXT_1268 = "::";
  protected final String TEXT_1269 = "(";
  protected final String TEXT_1270 = " ";
  protected final String TEXT_1271 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1276 = ".push_back(";
  protected final String TEXT_1277 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1278 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1279 = "::";
  protected final String TEXT_1280 = "(";
  protected final String TEXT_1281 = "* ";
  protected final String TEXT_1282 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1283 = ".begin(), ";
  protected final String TEXT_1284 = ".end(), ";
  protected final String TEXT_1285 = ") - ";
  protected final String TEXT_1286 = ".begin();";
  protected final String TEXT_1287 = NL + "    if (!find(";
  protected final String TEXT_1288 = ".begin(),";
  protected final String TEXT_1289 = ".end(),";
  protected final String TEXT_1290 = ") != ";
  protected final String TEXT_1291 = ".end())" + NL + "    {";
  protected final String TEXT_1292 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1293 = "() <= ";
  protected final String TEXT_1294 = "())" + NL + "    {";
  protected final String TEXT_1295 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1300 = "));" + NL + "\tdelete ";
  protected final String TEXT_1301 = "[index];" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_1311 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1321 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1322 = " != null)" + NL + "    {";
  protected final String TEXT_1323 = NL + "      ";
  protected final String TEXT_1324 = ".";
  protected final String TEXT_1325 = ".erase(find(";
  protected final String TEXT_1326 = ".begin(),";
  protected final String TEXT_1327 = ".end(),";
  protected final String TEXT_1328 = "));" + NL + "    }";
  protected final String TEXT_1329 = NL + "    ";
  protected final String TEXT_1330 = ".push_back(";
  ...
  protected final String TEXT_1335 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1336 = "::";
  protected final String TEXT_1337 = "(";
  protected final String TEXT_1338 = "* ";
  protected final String TEXT_1339 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1340 = ".begin(), ";
  protected final String TEXT_1341 = ".end(), ";
  protected final String TEXT_1342 = ") - ";
  protected final String TEXT_1343 = ".begin();";
  protected final String TEXT_1344 = NL + "    if ((find(";
  protected final String TEXT_1345 = ".begin(),";
  protected final String TEXT_1346 = ".end(),";
  protected final String TEXT_1347 = ") !=";
  protected final String TEXT_1348 = ".end()) && ";
  protected final String TEXT_1349 = "() > ";
  protected final String TEXT_1350 = "())" + NL + "    {";
  protected final String TEXT_1351 = NL + "      ";
  protected final String TEXT_1352 = ".erase(find(";
  protected final String TEXT_1353 = ".begin(),";
  protected final String TEXT_1354 = ".end(),";
  protected final String TEXT_1355 = "));";
  protected final String TEXT_1356 = NL + "      ";
  protected final String TEXT_1357 = "(";
  protected final String TEXT_1358 = ",NULL);" + NL + "\t  delete ";
  protected final String TEXT_1359 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1360 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1361 = NL + "  bool ";
  protected final String TEXT_1362 = "::";
  protected final String TEXT_1363 = "(";
  protected final String TEXT_1364 = "... ";
  protected final String TEXT_1365 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1366 = NL + "    vector<";
  protected final String TEXT_1367 = "*> ";
  protected final String TEXT_1368 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_1369 = " ";
  protected final String TEXT_1370 = " : ";
  protected final String TEXT_1371 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1372 = ".begin(),";
  protected final String TEXT_1373 = ".end(),";
  protected final String TEXT_1374 = ") != ";
  protected final String TEXT_1375 = ".end())" + NL + "      {";
  protected final String TEXT_1376 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1377 = ".";
  protected final String TEXT_1378 = "() != NULL && this!=(";
  protected final String TEXT_1379 = "->";
  protected final String TEXT_1380 = "()))" + NL + "      {";
  protected final String TEXT_1381 = NL + "        return wasSet;" + NL + "      }";
  ...
  protected final String TEXT_1389 = ".removeAll(";
  protected final String TEXT_1390 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1391 = " orphan : ";
  protected final String TEXT_1392 = ")" + NL + "    {";
  protected final String TEXT_1393 = NL + "      ";
  protected final String TEXT_1394 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1395 = NL + "    ";
  protected final String TEXT_1396 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1405 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1406 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1407 = NL + "  void ";
  ...
  protected final String TEXT_1428 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1429 = "::";
  protected final String TEXT_1430 = "(";
  protected final String TEXT_1431 = "* ";
  protected final String TEXT_1432 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1433 = ".begin(), ";
  protected final String TEXT_1434 = ".end(), ";
  protected final String TEXT_1435 = ") - ";
  protected final String TEXT_1436 = ".begin();";
  protected final String TEXT_1437 = NL + "    if (find(";
  protected final String TEXT_1438 = ".begin(),";
  protected final String TEXT_1439 = ".end(),";
  protected final String TEXT_1440 = ") != ";
  protected final String TEXT_1441 = ".end())" + NL + "    {";
  protected final String TEXT_1442 = NL + "      ";
  protected final String TEXT_1443 = ".erase(find(";
  ...
  protected final String TEXT_1458 = ".push_back(";
  protected final String TEXT_1459 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1460 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1461 = "::";
  protected final String TEXT_1462 = "(";
  protected final String TEXT_1463 = "* ";
  protected final String TEXT_1464 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1465 = ".begin(), ";
  protected final String TEXT_1466 = ".end(), ";
  protected final String TEXT_1467 = ") - ";
  protected final String TEXT_1468 = ".begin();";
  protected final String TEXT_1469 = NL + "    if (find(";
  protected final String TEXT_1470 = ".begin(),";
  protected final String TEXT_1471 = ".end(),";
  protected final String TEXT_1472 = ") != ";
  protected final String TEXT_1473 = ".end())" + NL + "    {";
  protected final String TEXT_1474 = NL + "      ";
  protected final String TEXT_1475 = ".erase(";
  protected final String TEXT_1476 = ");" + NL + "\t  delete ";
  protected final String TEXT_1477 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1483 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1484 = NL + "    ";
  protected final String TEXT_1485 = ".push_back(";
  protected final String TEXT_1486 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1487 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1488 = "::";
  protected final String TEXT_1489 = "(";
  protected final String TEXT_1490 = "* ";
  protected final String TEXT_1491 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  ...
  protected final String TEXT_1496 = NL + "    if (!find(";
  protected final String TEXT_1497 = ".begin(),";
  protected final String TEXT_1498 = ".end(),";
  protected final String TEXT_1499 = ") != ";
  protected final String TEXT_1500 = ".end())" + NL + "    {";
  protected final String TEXT_1501 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1506 = ".erase(find(";
  protected final String TEXT_1507 = ".begin(),";
  protected final String TEXT_1508 = ".end(),";
  protected final String TEXT_1509 = "));" + NL + "    delete ";
  protected final String TEXT_1510 = "[index];" + NL + "\twasRemoved = true;";
  protected final String TEXT_1511 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1512 = NL + "  bool ";
  ...
  protected final String TEXT_1522 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1523 = ".begin(),";
  protected final String TEXT_1524 = ".end(),";
  protected final String TEXT_1525 = ") != ";
  protected final String TEXT_1526 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1527 = NL + "      ";
  protected final String TEXT_1528 = ".push_back(";
  ...
  protected final String TEXT_1536 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1537 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1538 = ".push_back(";
  protected final String TEXT_1539 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1540 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1541 = NL + "  ";
  protected final String TEXT_1542 = " bool ";
  protected final String TEXT_1543 = "(";
  protected final String TEXT_1544 = "... ";
  protected final String TEXT_1545 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1546 = NL + "    vector<";
  protected final String TEXT_1547 = "*> ";
  protected final String TEXT_1548 = ";" + NL + "    for (int i=0 ; i<";
  protected final String TEXT_1549 = ".size() ; i++)" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1550 = ".begin(),";
  protected final String TEXT_1551 = ".end(),(";
  protected final String TEXT_1552 = ") != ";
  protected final String TEXT_1553 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1554 = NL + "      ";
  protected final String TEXT_1555 = ".push_back(";
  protected final String TEXT_1556 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1557 = ".size() != ";
  protected final String TEXT_1558 = ".length)" + NL + "    {";
  ...
  protected final String TEXT_1575 = " == NULL)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1576 = " != NULL)" + NL + "      {" + NL + "        if (";
  ...
  protected final String TEXT_1581 = ";" + NL + "          wasSet = true;" + NL + "        }" + NL + "      }" + NL + "    } " + NL + "    else if (";
  protected final String TEXT_1582 = " != NULL)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1583 = " == NULL)" + NL + "      {" + NL + "        if (";
  ...
  protected final String TEXT_1594 = " == NULL" + NL + "          wasSet = true;" + NL + "        }" + NL + "      } " + NL + "      else" + NL + "      {" + NL + "        if (";
  ...
  protected final String TEXT_1607 = ";" + NL + "          wasSet = true;" + NL + "        }" + NL + "      }" + NL + "    }" + NL + "    if (wasSet)" + NL + "    {";
  protected final String TEXT_1608 = NL + "      ";
  protected final String TEXT_1609 = " = ";
  protected final String TEXT_1610 = ";" + NL + "    }" + NL + "    return wasSet;" + NL + "  }" + NL + "  ";
  ...
  protected final String TEXT_1615 = ")" + NL + "//  {" + NL + "//    //" + NL + "//    // The source of the code generation is association_SetOptionalOneToMN.jet" + NL + "//    // (this) set file assumes the generation of a maximumNumberOfXXX " + NL + "//    //   method ";
  protected final String TEXT_1616 = NL + "//    // Currently this will not compile due to Issue351 - the template code is fine." + NL + "//    //" + NL + "//    // THIS TEMPLATE IS EXPERIMENTAL" + NL + "//    //   I cut/Paste from UmpleToJava/templates/association_SetOptionalOneToMandatoryMany.jet" + NL + "//    //   and then converted to cpp. " + NL + "//    //" + NL + "//" + NL + "//    bool wasSet = false;" + NL + "//    ";
  protected final String TEXT_1617 = " *";
  protected final String TEXT_1618 = " = ";
  protected final String TEXT_1619 = ";" + NL + "//\t" + NL + "//    if (";
  protected final String TEXT_1620 = " == null)" + NL + "//    {  " + NL + "//      if (";
  protected final String TEXT_1621 = " != null)" + NL + "//      { " + NL + "//        if (";
  protected final String TEXT_1622 = "->";
  protected final String TEXT_1623 = "(this))" + NL + "//          ";
  protected final String TEXT_1624 = " = ";
  protected final String TEXT_1625 = ";" + NL + "//          wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//    }" + NL + "//    else" + NL + "//    {" + NL + "//      if (";
  ...
  protected final String TEXT_1636 = " == null;" + NL + "//            wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//      else" + NL + "//      {" + NL + "//        if (   ";
  ...
  protected final String TEXT_1646 = "(this);" + NL + "//          ";
  protected final String TEXT_1647 = "->";
  protected final String TEXT_1648 = "(this);" + NL + "//          ";
  protected final String TEXT_1649 = " = ";
  protected final String TEXT_1650 = ";" + NL + "//          wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//    }" + NL + "//    " + NL + "//    if (wasSet)" + NL + "//    {" + NL + "//      ";
  protected final String TEXT_1651 = " = ";
  protected final String TEXT_1652 = ";" + NL + "//    }" + NL + "//    " + NL + "//    return wasSet;" + NL + "//  }";
  protected final String TEXT_1653 = NL + "  bool ";
  protected final String TEXT_1654 = "::";
  protected final String TEXT_1655 = "(";
  protected final String TEXT_1656 = "... ";
  protected final String TEXT_1657 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1658 = NL + "    vector<";
  protected final String TEXT_1659 = "*> ";
  protected final String TEXT_1660 = ";" + NL + "    for (";
  protected final String TEXT_1661 = " ";
  protected final String TEXT_1662 = " : ";
  protected final String TEXT_1663 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1664 = ".begin(),";
  protected final String TEXT_1665 = ".end(),";
  protected final String TEXT_1666 = ")!= ";
  protected final String TEXT_1667 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1668 = NL + "      ";
  protected final String TEXT_1669 = "push_back(";
  protected final String TEXT_1670 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1671 = ".size() != ";
  protected final String TEXT_1672 = ".length || ";
  ...
  protected final String TEXT_1677 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1678 = "*> ";
  protected final String TEXT_1679 = " = new vector<";
  ...
  protected final String TEXT_1688 = ".push_back(";
  protected final String TEXT_1689 = ");" + NL + "      if (find(";
  protected final String TEXT_1690 = ".begin(),";
  protected final String TEXT_1691 = ".end(),";
  protected final String TEXT_1692 = ")!= ";
  protected final String TEXT_1693 = ".end())" + NL + "      {";
  protected final String TEXT_1694 = NL + "        ";
  protected final String TEXT_1695 = ".erase(find(";
  protected final String TEXT_1696 = ".begin(),";
  protected final String TEXT_1697 = ".end(),";
  protected final String TEXT_1698 = "));" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1699 = NL + "        ";
  protected final String TEXT_1700 = "->";
  protected final String TEXT_1701 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1707 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1708 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1709 = NL + "  bool ";
  protected final String TEXT_1710 = "::";
  protected final String TEXT_1711 = "(";
  protected final String TEXT_1712 = "... ";
  protected final String TEXT_1713 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1714 = NL + "    vector<";
  protected final String TEXT_1715 = "*> ";
  protected final String TEXT_1716 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_1717 = " ";
  protected final String TEXT_1718 = " : ";
  protected final String TEXT_1719 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1720 = ".begin(),";
  protected final String TEXT_1721 = ".end(),";
  protected final String TEXT_1722 = ") != ";
  protected final String TEXT_1723 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1724 = NL + "      ";
  protected final String TEXT_1725 = ".push_back(";
  ...
  protected final String TEXT_1731 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1732 = "*> ";
  protected final String TEXT_1733 = ";";
  protected final String TEXT_1734 = NL + "    ";
  protected final String TEXT_1735 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1740 = ".push_back(";
  protected final String TEXT_1741 = ");" + NL + "      if (find(";
  protected final String TEXT_1742 = ".begin(),";
  protected final String TEXT_1743 = ".end(),";
  protected final String TEXT_1744 = ")) != ";
  protected final String TEXT_1745 = ".end())" + NL + "      {";
  protected final String TEXT_1746 = NL + "        ";
  protected final String TEXT_1747 = ".erase(";
  protected final String TEXT_1748 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1749 = NL + "        ";
  protected final String TEXT_1750 = "->";
  protected final String TEXT_1751 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1757 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1764 = NL + "    vector<";
  protected final String TEXT_1765 = "*> ";
  protected final String TEXT_1766 = ";" + NL + "    for (";
  protected final String TEXT_1767 = " ";
  protected final String TEXT_1768 = " : ";
  protected final String TEXT_1769 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1770 = ".begin(),";
  protected final String TEXT_1771 = ".end(),";
  protected final String TEXT_1772 = ") != ";
  protected final String TEXT_1773 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1774 = NL + "      ";
  protected final String TEXT_1775 = "->add(";
  protected final String TEXT_1776 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1777 = ".size() != ";
  ...
  protected final String TEXT_1788 = "[i]);" + NL + "\t}" + NL + "    " + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1796 = ".length < ";
  protected final String TEXT_1797 = "()";
  protected final String TEXT_1798 = ")" + NL + "    {";
  protected final String TEXT_1799 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1800 = "*> ";
  protected final String TEXT_1801 = ";" + NL + "\t" + NL + "    map<";
  protected final String TEXT_1802 = ",int> ";
  protected final String TEXT_1803 = ";" + NL + "    for (";
  protected final String TEXT_1804 = " ";
  protected final String TEXT_1805 = " : ";
  protected final String TEXT_1806 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1807 = ".begin(),";
  protected final String TEXT_1808 = ".end(),";
  protected final String TEXT_1809 = ") != ";
  protected final String TEXT_1810 = ".end())" + NL + "      {";
  protected final String TEXT_1811 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1812 = "->";
  protected final String TEXT_1813 = "() != NULL && this!=";
  ...
  protected final String TEXT_1821 = ".find(";
  protected final String TEXT_1822 = "))" + NL + "        {";
  protected final String TEXT_1823 = NL + "          ";
  protected final String TEXT_1824 = ".insert(";
  protected final String TEXT_1825 = ", new int(";
  protected final String TEXT_1826 = "->";
  protected final String TEXT_1827 = "()));" + NL + "        }" + NL + "        int currentCount = ";
  protected final String TEXT_1828 = ".find(";
  protected final String TEXT_1829 = ")->firtst;" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1830 = ")" + NL + "        {";
  protected final String TEXT_1831 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1832 = NL + "        ";
  protected final String TEXT_1833 = ".insert(";
  protected final String TEXT_1834 = ", new int(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1839 = ".removeAll(";
  protected final String TEXT_1840 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1841 = " orphan : ";
  protected final String TEXT_1842 = ")" + NL + "    {";
  protected final String TEXT_1843 = NL + "      ";
  protected final String TEXT_1844 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1845 = NL + "    ";
  protected final String TEXT_1846 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1870 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1871 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1872 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1873 = ", ";
  protected final String TEXT_1874 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1875 = " to ";
  protected final String TEXT_1876 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1877 = NL + "  bool ";
  protected final String TEXT_1878 = "::";
  protected final String TEXT_1879 = "(";
  protected final String TEXT_1880 = "... ";
  protected final String TEXT_1881 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1882 = NL + "    vector<";
  protected final String TEXT_1883 = "*> ";
  protected final String TEXT_1884 = ";" + NL + "    for (";
  protected final String TEXT_1885 = " ";
  protected final String TEXT_1886 = " : ";
  protected final String TEXT_1887 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1888 = ".begin(),";
  protected final String TEXT_1889 = ".end(),(";
  protected final String TEXT_1890 = ")) - ";
  protected final String TEXT_1891 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1892 = NL + "      ";
  protected final String TEXT_1893 = ".push_back(";
  protected final String TEXT_1894 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1899 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1900 = NL + "    ";
  protected final String TEXT_1901 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1902 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1903 = ".push_back(";
  protected final String TEXT_1904 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1905 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1906 = NL + "  bool ";
  protected final String TEXT_1907 = "::";
  protected final String TEXT_1908 = "(";
  protected final String TEXT_1909 = "... ";
  protected final String TEXT_1910 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1911 = NL + "    vector<";
  ...
  protected final String TEXT_1916 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1917 = ".begin(),";
  protected final String TEXT_1918 = ".end(),";
  protected final String TEXT_1919 = ") != ";
  protected final String TEXT_1920 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1921 = NL + "      ";
  protected final String TEXT_1922 = "->add(";
  protected final String TEXT_1923 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1924 = ".size() != ";
  protected final String TEXT_1925 = ".size() || ";
  protected final String TEXT_1926 = ".size() < ";
  protected final String TEXT_1927 = "())" + NL + "    {";
  protected final String TEXT_1928 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1929 = NL + "    ";
  protected final String TEXT_1930 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1931 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1932 = ".push_back(";
  protected final String TEXT_1933 = "[i]);" + NL + "\t}" + NL + "\t" + NL + "    wasSet = true;";
  protected final String TEXT_1934 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1935 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1936 = NL + "    ";
  protected final String TEXT_1937 = " == (";
  protected final String TEXT_1938 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  ...
  protected final String TEXT_1943 = NL + "   void ";
  ...
  protected final String TEXT_1954 = NL + "  void ";
  protected final String TEXT_1955 = "();" + NL + "  void ";
  protected final String TEXT_1956 = "();" + NL + "  " + NL + NL;
  protected final String TEXT_1957 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1958 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1959 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1960 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1961 = "::run ()" + NL + "    {";
  protected final String TEXT_1962 = NL + "      if (\"";
  protected final String TEXT_1963 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  ...
  protected final String TEXT_1967 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1968 = NL + "    ";
  protected final String TEXT_1969 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1970 = ";";
  protected final String TEXT_1971 = NL + "    ";
  protected final String TEXT_1972 = ".clear();";
  ...
  protected final String TEXT_1979 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1991 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1992 = " != NULL)" + NL + "    {";
  ...
  protected final String TEXT_2001 = " = NULL;" + NL + "    if (";
  protected final String TEXT_2002 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_2013 = "(this);" + NL + "    }" + NL;
  protected final String TEXT_2014 = NL + "    if (";
  protected final String TEXT_2015 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_2021 = ")" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_2022 = ";" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_2023 = NL + "        ";
  protected final String TEXT_2024 = "* ";
  protected final String TEXT_2025 = " = ";
  protected final String TEXT_2026 = ";" + NL + "        this.";
  ...
  protected final String TEXT_2039 = NL + "    for(i =0; sizeof(";
  protected final String TEXT_2040 = "); i++)" + NL + "    {";
  protected final String TEXT_2041 = NL + "      ";
  protected final String TEXT_2042 = "(";
  protected final String TEXT_2043 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_2044 = NL + "    ";
  protected final String TEXT_2045 = ".clear();";
  protected final String TEXT_2046 = NL + "    vector<";
  ...
  protected final String TEXT_2051 = ".clear();" + NL + "    for(i =0; sizeof(";
  protected final String TEXT_2052 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_2053 = ".";
  protected final String TEXT_2054 = "() <= ";
  protected final String TEXT_2055 = "->";
  protected final String TEXT_2056 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_2057 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_2058 = NL + "        ";
  protected final String TEXT_2059 = "->";
  protected final String TEXT_2060 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_2061 = NL + "    vector<";
  ...
  protected final String TEXT_2066 = ".clear();" + NL + "    for(i=0;sizeof(";
  protected final String TEXT_2067 = ");i++)" + NL + "    {";
  protected final String TEXT_2068 = NL + "      ";
  protected final String TEXT_2069 = "[i]->";
  protected final String TEXT_2070 = "(this);" + NL + "    }";
  protected final String TEXT_2071 = NL + "    for(i =0; sizeof(";
  protected final String TEXT_2072 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_2073 = "[i];" + NL + "    }";
  protected final String TEXT_2074 = NL + "    for(i =0; sizeof(";
  protected final String TEXT_2075 = "); i++)" + NL + "    {";
  protected final String TEXT_2076 = NL + "      ";
  protected final String TEXT_2077 = "[i]->";
  protected final String TEXT_2078 = "(NULL);" + NL + "    }";
  protected final String TEXT_2079 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
