...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_1327 = ".end()))" + NL + "    {";
  protected final String TEXT_1328 = NL + "      ";
  protected final String TEXT_1329 = ".erase(find(";
  protected final String TEXT_1330 = ".begin(),";
  protected final String TEXT_1331 = ".end(),";
  protected final String TEXT_1332 = "));" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1333 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1334 = NL + "  bool ";
  protected final String TEXT_1335 = "::";
  protected final String TEXT_1336 = "(";
  protected final String TEXT_1337 = "* ";
  protected final String TEXT_1338 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1344 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1345 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1346 = "::";
  protected final String TEXT_1347 = "(";
  protected final String TEXT_1348 = "* ";
  protected final String TEXT_1349 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1350 = NL + "    if (find(";
  ...
  protected final String TEXT_1355 = "erase(";
  protected final String TEXT_1356 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1357 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1362 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1363 = NL + "    ";
  protected final String TEXT_1364 = ".push_back(";
  protected final String TEXT_1365 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1366 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1367 = "::";
  protected final String TEXT_1368 = "(";
  protected final String TEXT_1369 = "* ";
  protected final String TEXT_1370 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1371 = NL + "    if (!find(";
  protected final String TEXT_1372 = ".begin(),";
  protected final String TEXT_1373 = ".end(),";
  protected final String TEXT_1374 = ")))" + NL + "    {";
  protected final String TEXT_1375 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1376 = "() <= ";
  protected final String TEXT_1377 = "())" + NL + "    {";
  protected final String TEXT_1378 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1379 = NL + "    ";
  protected final String TEXT_1380 = ".erase(find(";
  protected final String TEXT_1381 = ".begin(),";
  protected final String TEXT_1382 = ".end(),";
  protected final String TEXT_1383 = "));" + NL + "    wasRemoved = true;";
  protected final String TEXT_1384 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1385 = NL + "  bool ";
  protected final String TEXT_1386 = "::";
  protected final String TEXT_1387 = "(";
  protected final String TEXT_1388 = "... ";
  protected final String TEXT_1389 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1390 = NL + "    vector<";
  protected final String TEXT_1391 = "*> ";
  protected final String TEXT_1392 = ";" + NL + "    for (";
  protected final String TEXT_1393 = " ";
  protected final String TEXT_1394 = " : ";
  protected final String TEXT_1395 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1396 = ".begin(),";
  protected final String TEXT_1397 = ".end(),";
  protected final String TEXT_1398 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1399 = NL + "      ";
  protected final String TEXT_1400 = ".push_back(";
  protected final String TEXT_1401 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1408 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1409 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1410 = ".push_back(";
  protected final String TEXT_1411 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1412 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1413 = NL + "  ";
  protected final String TEXT_1414 = " bool ";
  protected final String TEXT_1415 = "(";
  protected final String TEXT_1416 = "... ";
  protected final String TEXT_1417 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1418 = NL + "    vector<";
  protected final String TEXT_1419 = "*> ";
  protected final String TEXT_1420 = ";" + NL + "    for (int i=0 ; i<";
  protected final String TEXT_1421 = ".size() ; i++)" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1422 = ".begin(),";
  protected final String TEXT_1423 = ".end(),(";
  protected final String TEXT_1424 = ") - ";
  protected final String TEXT_1425 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1426 = NL + "      ";
  protected final String TEXT_1427 = ".push_back(";
  protected final String TEXT_1428 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1429 = ".size() != ";
  protected final String TEXT_1430 = ".length)" + NL + "    {";
  protected final String TEXT_1431 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1432 = NL + "    ";
  protected final String TEXT_1433 = ".clear();";
  protected final String TEXT_1434 = NL + "    ";
  protected final String TEXT_1435 = ".addAll(";
  protected final String TEXT_1436 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1437 = NL + "    return wasSet;" + NL + "  }" + NL;
  ...
  protected final String TEXT_1443 = NL + "    vector<";
  ...
  protected final String TEXT_1448 = ")" + NL + "    {" + NL + "      if (find(";
  ...
  protected final String TEXT_1453 = "push_back(";
  ...
  protected final String TEXT_1461 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1462 = "*> ";
  protected final String TEXT_1463 = " = new vector<";
  protected final String TEXT_1464 = "*>(";
  protected final String TEXT_1465 = ");";
  protected final String TEXT_1466 = NL + "    ";
  protected final String TEXT_1467 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1472 = ".push_back(";
  protected final String TEXT_1473 = ");" + NL + "      if (find(";
  ...
  protected final String TEXT_1482 = ".end());" + NL + "      }" + NL + "      else" + NL + "      {";
  ...
  protected final String TEXT_1500 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_1501 = " ";
  protected final String TEXT_1502 = " : ";
  protected final String TEXT_1503 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1504 = ".begin(),";
  protected final String TEXT_1505 = ".end(),";
  ...
  protected final String TEXT_1518 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1523 = ".push_back(";
  protected final String TEXT_1524 = ");" + NL + "      if (find(";
  protected final String TEXT_1525 = ".begin(),";
  protected final String TEXT_1526 = ".end(),";
  protected final String TEXT_1527 = ")))" + NL + "      {";
  protected final String TEXT_1528 = NL + "        ";
  protected final String TEXT_1529 = ".erase(";
  protected final String TEXT_1530 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1531 = NL + "        ";
  protected final String TEXT_1532 = "->";
  protected final String TEXT_1533 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1539 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1540 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1541 = NL + "  bool ";
  ...
  protected final String TEXT_1551 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1552 = ".begin(),";
  protected final String TEXT_1553 = ".end(),";
  ...
  protected final String TEXT_1566 = ".clear();" + NL + "\tfor (int i=0; i<";
  protected final String TEXT_1567 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1568 = ".push_back(";
  protected final String TEXT_1569 = "[i]);" + NL + "\t}" + NL + "    " + NL + "    wasSet = true;";
  protected final String TEXT_1570 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1571 = NL + "  bool ";
  protected final String TEXT_1572 = "::";
  protected final String TEXT_1573 = "(";
  protected final String TEXT_1574 = "... ";
  protected final String TEXT_1575 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1576 = NL + "    if (";
  protected final String TEXT_1577 = ".length < ";
  protected final String TEXT_1578 = "()";
  protected final String TEXT_1579 = ")" + NL + "    {";
  protected final String TEXT_1580 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1581 = "*> ";
  protected final String TEXT_1582 = ";" + NL + "\t" + NL + "    map<";
  protected final String TEXT_1583 = ",int> ";
  protected final String TEXT_1584 = ";" + NL + "    for (";
  protected final String TEXT_1585 = " ";
  protected final String TEXT_1586 = " : ";
  protected final String TEXT_1587 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1588 = ".begin(),";
  protected final String TEXT_1589 = ".end(),";
  protected final String TEXT_1590 = "))" + NL + "      {";
  protected final String TEXT_1591 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1592 = "->";
  protected final String TEXT_1593 = "() != NULL && this!=";
  ...
  protected final String TEXT_1601 = ".find(";
  protected final String TEXT_1602 = "))" + NL + "        {";
  protected final String TEXT_1603 = NL + "          ";
  protected final String TEXT_1604 = ".insert(";
  protected final String TEXT_1605 = ", new int(";
  protected final String TEXT_1606 = "->";
  protected final String TEXT_1607 = "()));" + NL + "        }" + NL + "        int currentCount = ";
  protected final String TEXT_1608 = ".find(";
  protected final String TEXT_1609 = ")->firtst;" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1610 = ")" + NL + "        {";
  protected final String TEXT_1611 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1612 = NL + "        ";
  protected final String TEXT_1613 = ".insert(";
  protected final String TEXT_1614 = ", new int(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1619 = ".removeAll(";
  protected final String TEXT_1620 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1621 = " orphan : ";
  protected final String TEXT_1622 = ")" + NL + "    {";
  protected final String TEXT_1623 = NL + "      ";
  protected final String TEXT_1624 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1625 = NL + "    ";
  protected final String TEXT_1626 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1635 = ".erase(";
  ...
  protected final String TEXT_1642 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1643 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1644 = NL + "  void ";
  ...
  protected final String TEXT_1650 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1651 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1652 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1653 = ", ";
  protected final String TEXT_1654 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1655 = " to ";
  protected final String TEXT_1656 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1662 = NL + "    vector<";
  ...
  protected final String TEXT_1676 = ".size() || ";
  ...
  protected final String TEXT_1681 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1682 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1683 = ".push_back(";
  protected final String TEXT_1684 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1696 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1697 = ".begin(),";
  protected final String TEXT_1698 = ".end(),";
  ...
  protected final String TEXT_1709 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1710 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1711 = ".push_back(";
  protected final String TEXT_1712 = "[i]);" + NL + "\t}" + NL + "\t" + NL + "    wasSet = true;";
