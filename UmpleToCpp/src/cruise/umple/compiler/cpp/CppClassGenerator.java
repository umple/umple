...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_492 = ".contains(";
  ...
  protected final String TEXT_535 = ") && equals(";
  ...
  protected final String TEXT_549 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  ...
  protected final String TEXT_575 = " != null && !equals(";
  ...
  protected final String TEXT_756 = " = new vector<";
  protected final String TEXT_757 = "*>();" + NL + "    for (";
  protected final String TEXT_758 = " ";
  protected final String TEXT_759 = " : ";
  protected final String TEXT_760 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_761 = ".contains(";
  ...
  protected final String TEXT_772 = " = new vector<";
  protected final String TEXT_773 = "*>(";
  protected final String TEXT_774 = ");";
  protected final String TEXT_775 = NL + "    ";
  protected final String TEXT_776 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_786 = ".remove(";
  ...
  protected final String TEXT_865 = ".equals(";
  ...
  protected final String TEXT_877 = "();" + NL + "" + NL + "    if (!equals(";
  ...
  protected final String TEXT_915 = ".contains(";
  protected final String TEXT_916 = "))" + NL + "    {";
  protected final String TEXT_917 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_918 = "() <= ";
  protected final String TEXT_919 = "())" + NL + "    {";
  protected final String TEXT_920 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = std::find(";
  ...
  protected final String TEXT_926 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_927 = ".";
  protected final String TEXT_928 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_929 = ".";
  protected final String TEXT_930 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_931 = NL + "        ";
  protected final String TEXT_932 = ".add(oldIndex,";
  protected final String TEXT_933 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_934 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_935 = NL + "  bool ";
  protected final String TEXT_936 = "::";
  protected final String TEXT_937 = "(";
  protected final String TEXT_938 = "* ";
  protected final String TEXT_939 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_959 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_960 = " != null)" + NL + "    {";
  protected final String TEXT_961 = NL + "      ";
  protected final String TEXT_962 = ".";
  protected final String TEXT_963 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_964 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_965 = NL + "  bool ";
  protected final String TEXT_966 = "::";
  protected final String TEXT_967 = "(";
  protected final String TEXT_968 = "* ";
  protected final String TEXT_969 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_985 = "(this);" + NL + "    }";
  protected final String TEXT_986 = NL + "    ";
  protected final String TEXT_987 = "->";
  protected final String TEXT_988 = "(this);" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_995 = NL + "    //Must provide ";
  protected final String TEXT_996 = " to ";
  protected final String TEXT_997 = NL + "    if (";
  protected final String TEXT_998 = " == null)" + NL + "    {";
  protected final String TEXT_999 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_1000 = " already at maximum (";
  ...
  protected final String TEXT_1016 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1017 = ".";
  protected final String TEXT_1018 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1025 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1026 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1027 = NL + "  bool ";
  protected final String TEXT_1028 = "::";
  protected final String TEXT_1029 = "(";
  protected final String TEXT_1030 = "* ";
  protected final String TEXT_1031 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1032 = NL + "    //Must provide ";
  protected final String TEXT_1033 = " to ";
  protected final String TEXT_1034 = NL + "    if (";
  protected final String TEXT_1035 = " == null)" + NL + "    {";
  protected final String TEXT_1036 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1052 = ")" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1053 = ".";
  protected final String TEXT_1054 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1061 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1062 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1063 = NL + "  bool ";
  protected final String TEXT_1064 = "::";
  protected final String TEXT_1065 = "(";
  protected final String TEXT_1066 = "* ";
  protected final String TEXT_1067 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1076 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1084 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1085 = NL + "      ";
  protected final String TEXT_1086 = ".push_back(";
  protected final String TEXT_1087 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1088 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1089 = "::";
  protected final String TEXT_1090 = "(";
  protected final String TEXT_1091 = "* ";
  protected final String TEXT_1092 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1093 = NL + "    if (";
  protected final String TEXT_1094 = ".contains(";
  protected final String TEXT_1095 = "))" + NL + "    {";
  protected final String TEXT_1096 = NL + "      ";
  protected final String TEXT_1097 = ".erase(find(";
  protected final String TEXT_1098 = ".begin(),";
  protected final String TEXT_1099 = ".end(),";
  protected final String TEXT_1100 = "));";
  protected final String TEXT_1101 = NL + "      ";
  protected final String TEXT_1102 = "->";
  protected final String TEXT_1103 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1104 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1105 = NL + "  bool ";
  protected final String TEXT_1106 = "::";
  protected final String TEXT_1107 = "(";
  protected final String TEXT_1108 = "* ";
  protected final String TEXT_1109 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1122 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1123 = " != NULL)" + NL + "    {";
  protected final String TEXT_1124 = NL + "      ";
  protected final String TEXT_1125 = "->";
  protected final String TEXT_1126 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1127 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1128 = NL + "  bool ";
  protected final String TEXT_1129 = "::";
  protected final String TEXT_1130 = "(";
  protected final String TEXT_1131 = " ";
  protected final String TEXT_1132 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1157 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1158 = "::";
  protected final String TEXT_1159 = "(";
  protected final String TEXT_1160 = " ";
  protected final String TEXT_1161 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1162 = NL + "    if (";
  protected final String TEXT_1163 = ".contains(";
  ...
  protected final String TEXT_1170 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1171 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1172 = NL + "  bool ";
  protected final String TEXT_1173 = "::";
  protected final String TEXT_1174 = "(";
  protected final String TEXT_1175 = " ";
  protected final String TEXT_1176 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1177 = NL + "    if (";
  protected final String TEXT_1178 = "() < ";
  protected final String TEXT_1179 = "())" + NL + "    {";
  protected final String TEXT_1180 = NL + "      ";
  protected final String TEXT_1181 = ".push_back(";
  protected final String TEXT_1182 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1183 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1184 = "::";
  protected final String TEXT_1185 = "(";
  protected final String TEXT_1186 = "* ";
  protected final String TEXT_1187 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1188 = NL + "    if (!find(";
  protected final String TEXT_1189 = ".begin(),";
  protected final String TEXT_1190 = ".end(),(";
  protected final String TEXT_1191 = ")))" + NL + "    {";
  protected final String TEXT_1192 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1197 = "erase(";
  protected final String TEXT_1198 = ");" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_1208 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1218 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1219 = " != null)" + NL + "    {";
  protected final String TEXT_1220 = NL + "      ";
  protected final String TEXT_1221 = ".";
  protected final String TEXT_1222 = ".remove(";
  ...
  protected final String TEXT_1229 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1230 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1231 = "::";
  protected final String TEXT_1232 = "(";
  protected final String TEXT_1233 = " ";
  protected final String TEXT_1234 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1245 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1246 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1247 = NL + "  bool ";
  protected final String TEXT_1248 = "::";
  protected final String TEXT_1249 = "(";
  protected final String TEXT_1250 = "... ";
  protected final String TEXT_1251 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1252 = NL + "    vector<";
  protected final String TEXT_1253 = "*> ";
  protected final String TEXT_1254 = " = new vector<";
  protected final String TEXT_1255 = "*>();" + NL + "    for (";
  protected final String TEXT_1256 = " ";
  protected final String TEXT_1257 = " : ";
  protected final String TEXT_1258 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1259 = ".contains(";
  protected final String TEXT_1260 = "))" + NL + "      {";
  protected final String TEXT_1261 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1262 = ".";
  protected final String TEXT_1263 = "() != null && !this.equals(";
  protected final String TEXT_1264 = ".";
  protected final String TEXT_1265 = "()))" + NL + "      {";
  protected final String TEXT_1266 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1267 = NL + "      ";
  protected final String TEXT_1268 = ".add(";
  protected final String TEXT_1269 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1270 = ".size() != ";
  ...
  protected final String TEXT_1274 = ".removeAll(";
  protected final String TEXT_1275 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1276 = " orphan : ";
  protected final String TEXT_1277 = ")" + NL + "    {";
  protected final String TEXT_1278 = NL + "      ";
  protected final String TEXT_1279 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1280 = NL + "    ";
  protected final String TEXT_1281 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1287 = ", this);";
  protected final String TEXT_1288 = NL + "      ";
  protected final String TEXT_1289 = ".add(";
  protected final String TEXT_1290 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1291 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1292 = NL + "  void ";
  ...
  protected final String TEXT_1298 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1299 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1300 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1301 = ", ";
  protected final String TEXT_1302 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1303 = " to ";
  protected final String TEXT_1304 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1305 = NL + "  bool ";
  protected final String TEXT_1306 = "::";
  protected final String TEXT_1307 = "(";
  protected final String TEXT_1308 = " ";
  protected final String TEXT_1309 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1310 = NL + "    ";
  protected final String TEXT_1311 = "push_back(";
  protected final String TEXT_1312 = ");" + NL + "    wasAdded = true;";
  ...
  protected final String TEXT_1322 = ".end()))" + NL + "    {";
  ...
  protected final String TEXT_1327 = "));" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1328 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1329 = NL + "  bool ";
  protected final String TEXT_1330 = "::";
  protected final String TEXT_1331 = "(";
  protected final String TEXT_1332 = "* ";
  protected final String TEXT_1333 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1338 = ".push_back(";
  protected final String TEXT_1339 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1340 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1341 = "::";
  protected final String TEXT_1342 = "(";
  protected final String TEXT_1343 = "* ";
  protected final String TEXT_1344 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1345 = NL + "    if (find(";
  ...
  protected final String TEXT_1350 = "erase(";
  protected final String TEXT_1351 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1352 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1365 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1366 = NL + "    if (!find(";
  protected final String TEXT_1367 = ".begin(),";
  protected final String TEXT_1368 = ".end(),(";
  protected final String TEXT_1369 = ")))" + NL + "    {";
  protected final String TEXT_1370 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1371 = "() <= ";
  protected final String TEXT_1372 = "())" + NL + "    {";
  protected final String TEXT_1373 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1374 = NL + "    ";
  protected final String TEXT_1375 = ".erase(find(";
  protected final String TEXT_1376 = ".begin(),";
  protected final String TEXT_1377 = ".end(),";
  protected final String TEXT_1378 = "));" + NL + "    wasRemoved = true;";
  protected final String TEXT_1379 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1384 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1385 = NL + "    vector<";
  protected final String TEXT_1386 = "*> ";
  protected final String TEXT_1387 = " = new vector<";
  protected final String TEXT_1388 = "*>();" + NL + "    for (";
  protected final String TEXT_1389 = " ";
  protected final String TEXT_1390 = " : ";
  protected final String TEXT_1391 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1392 = ".contains(";
  protected final String TEXT_1393 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1394 = NL + "      ";
  protected final String TEXT_1395 = ".add(";
  protected final String TEXT_1396 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1397 = ".size() != ";
  protected final String TEXT_1398 = ".length || ";
  ...
  protected final String TEXT_1403 = ".clear();";
  protected final String TEXT_1404 = NL + "    ";
  protected final String TEXT_1405 = ".addAll(";
  protected final String TEXT_1406 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1407 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1408 = NL + "  ";
  protected final String TEXT_1409 = " bool ";
  protected final String TEXT_1410 = "(";
  protected final String TEXT_1411 = "... ";
  protected final String TEXT_1412 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1413 = NL + "    vector<";
  protected final String TEXT_1414 = "*> ";
  protected final String TEXT_1415 = ";" + NL + "    for (int i=0 ; i<";
  protected final String TEXT_1416 = ".size() ; i++)" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1417 = ".begin(),";
  protected final String TEXT_1418 = ".end(),(";
  protected final String TEXT_1419 = ") - ";
  protected final String TEXT_1420 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1421 = NL + "      ";
  protected final String TEXT_1422 = ".push_back(";
  protected final String TEXT_1423 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1424 = ".size() != ";
  protected final String TEXT_1425 = ".length)" + NL + "    {";
  protected final String TEXT_1426 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1427 = NL + "    ";
  protected final String TEXT_1428 = ".clear();";
  protected final String TEXT_1429 = NL + "    ";
  protected final String TEXT_1430 = ".addAll(";
  protected final String TEXT_1431 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1432 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1433 = NL + "  bool ";
  protected final String TEXT_1434 = "::";
  protected final String TEXT_1435 = "(";
  protected final String TEXT_1436 = "... ";
  protected final String TEXT_1437 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1438 = NL + "    vector<";
  protected final String TEXT_1439 = "*> ";
  protected final String TEXT_1440 = " = new vector<";
  protected final String TEXT_1441 = "*>();" + NL + "    for (";
  ...
  protected final String TEXT_1446 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1447 = NL + "      ";
  protected final String TEXT_1448 = ".add(";
  protected final String TEXT_1449 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1450 = ".size() != ";
  protected final String TEXT_1451 = ".length || ";
  ...
  protected final String TEXT_1456 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1457 = "*> ";
  protected final String TEXT_1458 = " = new vector<";
  protected final String TEXT_1459 = "*>(";
  protected final String TEXT_1460 = ");";
  protected final String TEXT_1461 = NL + "    ";
  protected final String TEXT_1462 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1482 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1483 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1491 = " = new vector<";
  ...
  protected final String TEXT_1505 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1506 = "*> ";
  protected final String TEXT_1507 = " = new vector<";
  protected final String TEXT_1508 = "*>(";
  protected final String TEXT_1509 = ");";
  protected final String TEXT_1510 = NL + "    ";
  protected final String TEXT_1511 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1516 = ".add(";
  ...
  protected final String TEXT_1522 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1523 = NL + "        ";
  protected final String TEXT_1524 = ".";
  protected final String TEXT_1525 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1531 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1532 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1537 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1538 = NL + "    vector<";
  protected final String TEXT_1539 = "*> ";
  protected final String TEXT_1540 = " = new vector<";
  protected final String TEXT_1541 = "*>();" + NL + "    for (";
  protected final String TEXT_1542 = " ";
  protected final String TEXT_1543 = " : ";
  protected final String TEXT_1544 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1545 = ".contains(";
  protected final String TEXT_1546 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1547 = NL + "      ";
  protected final String TEXT_1548 = ".add(";
  protected final String TEXT_1549 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1550 = ".size() != ";
  protected final String TEXT_1551 = ".length || ";
  protected final String TEXT_1552 = ".size() < ";
  protected final String TEXT_1553 = "() || ";
  protected final String TEXT_1554 = ".size() > ";
  protected final String TEXT_1555 = "())" + NL + "    {";
  protected final String TEXT_1556 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1557 = NL + "    ";
  protected final String TEXT_1558 = ".clear();";
  protected final String TEXT_1559 = NL + "    ";
  protected final String TEXT_1560 = ".addAll(";
  protected final String TEXT_1561 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1562 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1569 = ".length < ";
  protected final String TEXT_1570 = "()";
  protected final String TEXT_1571 = ")" + NL + "    {";
  protected final String TEXT_1572 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1573 = "*> ";
  protected final String TEXT_1574 = " = new vector<";
  protected final String TEXT_1575 = "*>();" + NL + "    HashMap<";
  protected final String TEXT_1576 = ",Integer> ";
  protected final String TEXT_1577 = " = new HashMap<";
  protected final String TEXT_1578 = ",Integer>();" + NL + "    for (";
  ...
  protected final String TEXT_1584 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1585 = ".";
  protected final String TEXT_1586 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1593 = "();" + NL + "        if (!";
  protected final String TEXT_1594 = ".containsKey(";
  protected final String TEXT_1595 = "))" + NL + "        {";
  protected final String TEXT_1596 = NL + "          ";
  protected final String TEXT_1597 = ".put(";
  protected final String TEXT_1598 = ", new Integer(";
  protected final String TEXT_1599 = ".";
  protected final String TEXT_1600 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1601 = ".get(";
  protected final String TEXT_1602 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1603 = ")" + NL + "        {";
  protected final String TEXT_1604 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1605 = NL + "        ";
  protected final String TEXT_1606 = ".put(";
  protected final String TEXT_1607 = ", new Integer(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1612 = ".removeAll(";
  protected final String TEXT_1613 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1614 = " orphan : ";
  protected final String TEXT_1615 = ")" + NL + "    {";
  protected final String TEXT_1616 = NL + "      ";
  protected final String TEXT_1617 = "(orphan, null);" + NL + "    }";
  ...
  protected final String TEXT_1628 = ".remove(";
  protected final String TEXT_1629 = ");" + NL + "      }";
  protected final String TEXT_1630 = NL + "      ";
  protected final String TEXT_1631 = "(";
  protected final String TEXT_1632 = ", this);";
  protected final String TEXT_1633 = NL + "      ";
  protected final String TEXT_1634 = ".add(";
  protected final String TEXT_1635 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1636 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1637 = NL + "  void ";
  ...
  protected final String TEXT_1643 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1644 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1645 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1646 = ", ";
  protected final String TEXT_1647 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1648 = " to ";
  protected final String TEXT_1649 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1650 = NL + "  bool ";
  protected final String TEXT_1651 = "::";
  protected final String TEXT_1652 = "(";
  protected final String TEXT_1653 = "... ";
  protected final String TEXT_1654 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1655 = NL + "    vector<";
  protected final String TEXT_1656 = "*> ";
  protected final String TEXT_1657 = " = new vector<";
  protected final String TEXT_1658 = "*>();" + NL + "    for (";
  protected final String TEXT_1659 = " ";
  protected final String TEXT_1660 = " : ";
  protected final String TEXT_1661 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1662 = ".begin(),";
  protected final String TEXT_1663 = ".end(),(";
  protected final String TEXT_1664 = ")) - ";
  protected final String TEXT_1665 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1666 = NL + "      ";
  protected final String TEXT_1667 = ".add(";
  protected final String TEXT_1668 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1669 = ".size() != ";
  protected final String TEXT_1670 = ".length || ";
  protected final String TEXT_1671 = ".size() > ";
  ...
  protected final String TEXT_1677 = ".addAll(";
  protected final String TEXT_1678 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1679 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1680 = NL + "  bool ";
  protected final String TEXT_1681 = "::";
  protected final String TEXT_1682 = "(";
  protected final String TEXT_1683 = "... ";
  protected final String TEXT_1684 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1685 = NL + "    vector<";
  protected final String TEXT_1686 = "*> ";
  protected final String TEXT_1687 = " = new vector<";
  ...
  protected final String TEXT_1693 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1701 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1702 = NL + "    ";
  protected final String TEXT_1703 = ".clear();";
  protected final String TEXT_1704 = NL + "    ";
  protected final String TEXT_1705 = ".addAll(";
  protected final String TEXT_1706 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1707 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1708 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1709 = NL + "    ";
  protected final String TEXT_1710 = " == (";
  protected final String TEXT_1711 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1712 = NL + "    ";
  protected final String TEXT_1713 = NL;
  protected final String TEXT_1714 = NL + "    ";
  protected final String TEXT_1715 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1716 = NL + "   void ";
  protected final String TEXT_1717 = "::";
  protected final String TEXT_1718 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1719 = NL + "       ";
  protected final String TEXT_1720 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1721 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1722 = NL + "    ";
  protected final String TEXT_1723 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1724 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1725 = NL + "      ";
  protected final String TEXT_1726 = NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1731 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1732 = "\",";
  protected final String TEXT_1733 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1734 = "::";
  protected final String TEXT_1735 = "()" + NL + "  {";
  protected final String TEXT_1736 = NL + "    ";
  protected final String TEXT_1737 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1738 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1739 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1740 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1741 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1742 = "::run ()" + NL + "    {";
  protected final String TEXT_1743 = NL + "      if (\"";
  protected final String TEXT_1744 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1745 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1746 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1747 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1748 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1749 = NL + "    ";
  protected final String TEXT_1750 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1751 = ";";
  protected final String TEXT_1752 = NL + "    ";
  protected final String TEXT_1753 = ".clear();";
  ...
  protected final String TEXT_1759 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1760 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1772 = " = NULL;" + NL + "    if (";
  ...
  protected final String TEXT_1782 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1783 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1820 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1821 = "); i++)" + NL + "    {";
  protected final String TEXT_1822 = NL + "      ";
  protected final String TEXT_1823 = "(";
  protected final String TEXT_1824 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1825 = NL + "    ";
  protected final String TEXT_1826 = ".clear();";
  protected final String TEXT_1827 = NL + "    vector<";
  protected final String TEXT_1828 = "> ";
  protected final String TEXT_1829 = " = vector<";
  protected final String TEXT_1830 = ">(";
  protected final String TEXT_1831 = ");";
  protected final String TEXT_1832 = NL + "    ";
  protected final String TEXT_1833 = ".clear();" + NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1834 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_1835 = ".";
  protected final String TEXT_1836 = "() <= ";
  protected final String TEXT_1837 = ".";
  protected final String TEXT_1838 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1839 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1840 = NL + "        ";
  protected final String TEXT_1841 = ".";
  protected final String TEXT_1842 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1843 = NL + "    vector<";
  protected final String TEXT_1844 = "> ";
  protected final String TEXT_1845 = " = new vector<";
  protected final String TEXT_1846 = ">(";
  protected final String TEXT_1847 = ");";
  protected final String TEXT_1848 = NL + "    ";
  protected final String TEXT_1849 = ".clear();" + NL + "    for(int i=0;sizeof(";
  protected final String TEXT_1850 = ");i++)" + NL + "    {";
  protected final String TEXT_1851 = NL + "      ";
  protected final String TEXT_1852 = "[i].";
  protected final String TEXT_1853 = "(this);" + NL + "    }";
  protected final String TEXT_1854 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1855 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1856 = "[i];" + NL + "    }";
  protected final String TEXT_1857 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1858 = "); i++)" + NL + "    {";
  protected final String TEXT_1859 = NL + "      ";
  protected final String TEXT_1860 = "[i].";
  protected final String TEXT_1861 = "(NULL);" + NL + "    }";
  protected final String TEXT_1862 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
