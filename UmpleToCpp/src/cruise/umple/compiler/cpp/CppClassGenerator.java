...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_1103 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1394 = " bool ";
  ...
  protected final String TEXT_1422 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1423 = NL + "    vector<";
  protected final String TEXT_1424 = "*> ";
  protected final String TEXT_1425 = " = new vector<";
  protected final String TEXT_1426 = "*>();" + NL + "    for (";
  protected final String TEXT_1427 = " ";
  protected final String TEXT_1428 = " : ";
  protected final String TEXT_1429 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1430 = ".contains(";
  protected final String TEXT_1431 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1432 = NL + "      ";
  protected final String TEXT_1433 = ".add(";
  protected final String TEXT_1434 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1435 = ".size() != ";
  protected final String TEXT_1436 = ".length || ";
  ...
  protected final String TEXT_1441 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1442 = "*> ";
  protected final String TEXT_1443 = " = new vector<";
  protected final String TEXT_1444 = "*>(";
  protected final String TEXT_1445 = ");";
  protected final String TEXT_1446 = NL + "    ";
  protected final String TEXT_1447 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1453 = ");" + NL + "      if (";
  protected final String TEXT_1454 = ".contains(";
  protected final String TEXT_1455 = "))" + NL + "      {";
  protected final String TEXT_1456 = NL + "        ";
  protected final String TEXT_1457 = ".remove(";
  protected final String TEXT_1458 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1459 = NL + "        ";
  protected final String TEXT_1460 = ".";
  protected final String TEXT_1461 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1467 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1476 = " = new vector<";
  protected final String TEXT_1477 = "*>();" + NL + "    for (";
  protected final String TEXT_1478 = " ";
  protected final String TEXT_1479 = " : ";
  protected final String TEXT_1480 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1481 = ".contains(";
  ...
  protected final String TEXT_1503 = ".contains(";
  protected final String TEXT_1504 = "))" + NL + "      {";
  protected final String TEXT_1505 = NL + "        ";
  protected final String TEXT_1506 = ".remove(";
  protected final String TEXT_1507 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1508 = NL + "        ";
  protected final String TEXT_1509 = ".";
  protected final String TEXT_1510 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1516 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1517 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1518 = NL + "  bool ";
  protected final String TEXT_1519 = "::";
  protected final String TEXT_1520 = "(";
  protected final String TEXT_1521 = "... ";
  protected final String TEXT_1522 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1523 = NL + "    vector<";
  protected final String TEXT_1524 = "*> ";
  protected final String TEXT_1525 = " = new vector<";
  protected final String TEXT_1526 = "*>();" + NL + "    for (";
  protected final String TEXT_1527 = " ";
  protected final String TEXT_1528 = " : ";
  protected final String TEXT_1529 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1530 = ".contains(";
  protected final String TEXT_1531 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1532 = NL + "      ";
  protected final String TEXT_1533 = ".add(";
  protected final String TEXT_1534 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1535 = ".size() != ";
  protected final String TEXT_1536 = ".length || ";
  ...
  protected final String TEXT_1548 = NL + "  bool ";
  protected final String TEXT_1549 = "::";
  protected final String TEXT_1550 = "(";
  protected final String TEXT_1551 = "... ";
  protected final String TEXT_1552 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1553 = NL + "    if (";
  protected final String TEXT_1554 = ".length < ";
  protected final String TEXT_1555 = "()";
  protected final String TEXT_1556 = ")" + NL + "    {";
  protected final String TEXT_1557 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1558 = "*> ";
  protected final String TEXT_1559 = " = new vector<";
  protected final String TEXT_1560 = "*>();" + NL + "    HashMap<";
  protected final String TEXT_1561 = ",Integer> ";
  protected final String TEXT_1562 = " = new HashMap<";
  protected final String TEXT_1563 = ",Integer>();" + NL + "    for (";
  ...
  protected final String TEXT_1569 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1570 = ".";
  protected final String TEXT_1571 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1579 = ".containsKey(";
  protected final String TEXT_1580 = "))" + NL + "        {";
  protected final String TEXT_1581 = NL + "          ";
  protected final String TEXT_1582 = ".put(";
  protected final String TEXT_1583 = ", new Integer(";
  protected final String TEXT_1584 = ".";
  protected final String TEXT_1585 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1586 = ".get(";
  protected final String TEXT_1587 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  ...
  protected final String TEXT_1591 = ".put(";
  protected final String TEXT_1592 = ", new Integer(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1597 = ".removeAll(";
  protected final String TEXT_1598 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1599 = " orphan : ";
  protected final String TEXT_1600 = ")" + NL + "    {";
  protected final String TEXT_1601 = NL + "      ";
  protected final String TEXT_1602 = "(orphan, null);" + NL + "    }";
  ...
  protected final String TEXT_1619 = ".add(";
  protected final String TEXT_1620 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1621 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1622 = NL + "  void ";
  ...
  protected final String TEXT_1628 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1629 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1630 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1631 = ", ";
  protected final String TEXT_1632 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1633 = " to ";
  protected final String TEXT_1634 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1635 = NL + "  bool ";
  protected final String TEXT_1636 = "::";
  protected final String TEXT_1637 = "(";
  protected final String TEXT_1638 = "... ";
  protected final String TEXT_1639 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1640 = NL + "    vector<";
  protected final String TEXT_1641 = "*> ";
  protected final String TEXT_1642 = " = new vector<";
  protected final String TEXT_1643 = "*>();" + NL + "    for (";
  protected final String TEXT_1644 = " ";
  protected final String TEXT_1645 = " : ";
  protected final String TEXT_1646 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1647 = ".begin(),";
  protected final String TEXT_1648 = ".end(),(";
  protected final String TEXT_1649 = ")) - ";
  protected final String TEXT_1650 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1665 = NL + "  bool ";
  protected final String TEXT_1666 = "::";
  protected final String TEXT_1667 = "(";
  protected final String TEXT_1668 = "... ";
  protected final String TEXT_1669 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1670 = NL + "    vector<";
  protected final String TEXT_1671 = "*> ";
  protected final String TEXT_1672 = " = new vector<";
  protected final String TEXT_1673 = "*>();" + NL + "    for (";
  protected final String TEXT_1674 = " ";
  protected final String TEXT_1675 = " : ";
  protected final String TEXT_1676 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1677 = ".contains(";
  protected final String TEXT_1678 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1679 = NL + "      ";
  protected final String TEXT_1680 = ".add(";
  protected final String TEXT_1681 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1682 = ".size() != ";
  protected final String TEXT_1683 = ".length || ";
  protected final String TEXT_1684 = ".size() < ";
  protected final String TEXT_1685 = "())" + NL + "    {";
  protected final String TEXT_1686 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1691 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1692 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1693 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1694 = NL + "    ";
  protected final String TEXT_1695 = " == (";
  protected final String TEXT_1696 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1697 = NL + "    ";
  protected final String TEXT_1698 = NL;
  protected final String TEXT_1699 = NL + "    ";
  protected final String TEXT_1700 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1701 = NL + "   void ";
  protected final String TEXT_1702 = "::";
  protected final String TEXT_1703 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1704 = NL + "       ";
  protected final String TEXT_1705 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1706 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1707 = NL + "    ";
  protected final String TEXT_1708 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1709 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1710 = NL + "      ";
  protected final String TEXT_1711 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1712 = NL + "  void ";
  protected final String TEXT_1713 = "::";
  protected final String TEXT_1714 = "()" + NL + "  {";
  protected final String TEXT_1715 = NL + "    ";
  protected final String TEXT_1716 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1717 = "\",";
  protected final String TEXT_1718 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1719 = "::";
  protected final String TEXT_1720 = "()" + NL + "  {";
  protected final String TEXT_1721 = NL + "    ";
  protected final String TEXT_1722 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1723 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1724 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1725 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1726 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1727 = "::run ()" + NL + "    {";
  protected final String TEXT_1728 = NL + "      if (\"";
  protected final String TEXT_1729 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1730 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1731 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1732 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1733 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1734 = NL + "    ";
  protected final String TEXT_1735 = " = NULL;" + NL + "    delete ";
  ...
  protected final String TEXT_1744 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1745 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1746 = ";" + NL + "    }";
  protected final String TEXT_1747 = NL + "    if (";
  protected final String TEXT_1748 = " != NULL)" + NL + "    {";
  protected final String TEXT_1749 = NL + "      ";
  protected final String TEXT_1750 = ".";
  protected final String TEXT_1751 = "(NULL);" + NL + "    }";
  ...
  protected final String TEXT_1757 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1758 = " != NULL)" + NL + "    {";
  ...
  protected final String TEXT_1767 = " = NULL;" + NL + "    if (";
  ...
  protected final String TEXT_1784 = " != NULL)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1785 = ".";
  protected final String TEXT_1786 = "() <= ";
  protected final String TEXT_1787 = ")" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1788 = ";" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1789 = NL + "        ";
  protected final String TEXT_1790 = " ";
  protected final String TEXT_1791 = " = ";
  protected final String TEXT_1792 = ";" + NL + "        this.";
  protected final String TEXT_1793 = " = NULL;";
  protected final String TEXT_1794 = NL + "        ";
  protected final String TEXT_1795 = ".";
  protected final String TEXT_1796 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1797 = NL + "    ";
  protected final String TEXT_1798 = " ";
  protected final String TEXT_1799 = " = ";
  protected final String TEXT_1800 = ";" + NL + "    this.";
  protected final String TEXT_1801 = " = NULL;";
  protected final String TEXT_1802 = NL + "    ";
  protected final String TEXT_1803 = ".";
  protected final String TEXT_1804 = "(this);";
  protected final String TEXT_1805 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1806 = "); i++)" + NL + "    {";
  protected final String TEXT_1807 = NL + "      ";
  protected final String TEXT_1808 = "(";
  protected final String TEXT_1809 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1810 = NL + "    ";
  protected final String TEXT_1811 = ".clear();";
  protected final String TEXT_1812 = NL + "    vector<";
  protected final String TEXT_1813 = "> ";
  protected final String TEXT_1814 = " = vector<";
  protected final String TEXT_1815 = ">(";
  protected final String TEXT_1816 = ");";
  protected final String TEXT_1817 = NL + "    ";
  protected final String TEXT_1818 = ".clear();" + NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1819 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_1820 = ".";
  protected final String TEXT_1821 = "() <= ";
  protected final String TEXT_1822 = ".";
  protected final String TEXT_1823 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1824 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1825 = NL + "        ";
  protected final String TEXT_1826 = ".";
  protected final String TEXT_1827 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1828 = NL + "    vector<";
  protected final String TEXT_1829 = "> ";
  protected final String TEXT_1830 = " = new vector<";
  protected final String TEXT_1831 = ">(";
  protected final String TEXT_1832 = ");";
  protected final String TEXT_1833 = NL + "    ";
  protected final String TEXT_1834 = ".clear();" + NL + "    for(int i=0;sizeof(";
  protected final String TEXT_1835 = ");i++)" + NL + "    {";
  protected final String TEXT_1836 = NL + "      ";
  protected final String TEXT_1837 = "[i].";
  protected final String TEXT_1838 = "(this);" + NL + "    }";
  protected final String TEXT_1839 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1840 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1841 = "[i];" + NL + "    }";
  protected final String TEXT_1842 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1843 = "); i++)" + NL + "    {";
  protected final String TEXT_1844 = NL + "      ";
  protected final String TEXT_1845 = "[i].";
  protected final String TEXT_1846 = "(NULL);" + NL + "    }";
  protected final String TEXT_1847 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
