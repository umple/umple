...
public class CppHeaderGenerator implements ILang 
{
  ...
  protected final String TEXT_18 = NL + "  \t  \t" + NL + "  //------------------------" + NL + "  // INTERFACE" + NL + "  //------------------------" + NL;
  protected final String TEXT_19 = NL + "  bool ";
  ...
  protected final String TEXT_41 = "(int index);";
  protected final String TEXT_42 = NL + "  ";
  protected final String TEXT_43 = "[] ";
  protected final String TEXT_44 = "();" + NL + "  int ";
  ...
  protected final String TEXT_77 = "()" + NL + "  {" + NL + "    String answer = ";
  protected final String TEXT_78 = ".toString();";
  protected final String TEXT_79 = NL + "    return answer;" + NL + "  }" + NL;
  protected final String TEXT_80 = NL + "  ";
  protected final String TEXT_81 = " ";
  protected final String TEXT_82 = "::";
  protected final String TEXT_83 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_84 = ";" + NL + "  }" + NL;
  protected final String TEXT_85 = NL + "  ";
  protected final String TEXT_86 = "bool ";
  protected final String TEXT_87 = "::";
  protected final String TEXT_88 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;" + NL;
  protected final String TEXT_89 = NL + "    ";
  protected final String TEXT_90 = NL + NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_91 = NL + "  bool ";
  ...
  protected final String TEXT_98 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_99 = NL + "  private void ";
  protected final String TEXT_100 = "::";
  protected final String TEXT_101 = "()" + NL + "  {" + NL + "    switch(";
  protected final String TEXT_102 = ")" + NL + "    {";
  protected final String TEXT_103 = NL + "      ";
  protected final String TEXT_104 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_105 = NL + "  private void ";
  ...
  protected final String TEXT_123 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_133 = "(int index);" + NL + "  vector<";
  protected final String TEXT_134 = "> ";
  protected final String TEXT_135 = "();" + NL + "  int ";
  protected final String TEXT_136 = "();" + NL + "  bool ";
  protected final String TEXT_137 = "();" + NL + "  int ";
  protected final String TEXT_138 = "(";
  protected final String TEXT_139 = " ";
  protected final String TEXT_140 = ");";
  protected final String TEXT_141 = "UNABLE TO UNDERSAND association variable (see header_association_Get_All.jet)";
  protected final String TEXT_142 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_143 = " : ";
  protected final String TEXT_144 = NL + "  bool ";
  protected final String TEXT_145 = "();";
  protected final String TEXT_146 = NL + "  static int ";
  ...
  protected final String TEXT_172 = NL + "  bool ";
  ...
  protected final String TEXT_196 = ");" + NL + "  bool ";
  protected final String TEXT_197 = "(";
  protected final String TEXT_198 = " ";
  protected final String TEXT_199 = ");";
  protected final String TEXT_200 = NL + "  bool ";
  protected final String TEXT_201 = "( vector<";
  ...
  protected final String TEXT_222 = NL + "  bool ";
  protected final String TEXT_223 = "(";
  protected final String TEXT_224 = " ";
  protected final String TEXT_225 = ");";
  protected final String TEXT_226 = NL + "  bool ";
  protected final String TEXT_227 = "( vector<";
  protected final String TEXT_228 = "*>& ";
  protected final String TEXT_229 = ");";
  protected final String TEXT_230 = NL + "  void ";
  protected final String TEXT_231 = "::";
  protected final String TEXT_232 = "(";
  protected final String TEXT_233 = " ";
  protected final String TEXT_234 = ", ";
  protected final String TEXT_235 = " ";
  protected final String TEXT_236 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_237 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_238 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_239 = ", ";
  protected final String TEXT_240 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_241 = " to ";
  protected final String TEXT_242 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_262 = NL + "  bool ";
  protected final String TEXT_263 = "(";
  protected final String TEXT_264 = "* ";
  protected final String TEXT_265 = ");";
  protected final String TEXT_266 = NL + "  bool ";
  protected final String TEXT_267 = "(";
  protected final String TEXT_268 = " ";
  protected final String TEXT_269 = ");" + NL + "  bool ";
  ...
  protected final String TEXT_288 = "( vector<";
  protected final String TEXT_289 = "*>& ";
  protected final String TEXT_290 = ");";
  protected final String TEXT_291 = NL + "  void ";
  protected final String TEXT_292 = "::";
  protected final String TEXT_293 = "(";
  protected final String TEXT_294 = " ";
  protected final String TEXT_295 = ", ";
  protected final String TEXT_296 = " ";
  protected final String TEXT_297 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_298 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_299 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_300 = ", ";
  protected final String TEXT_301 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_302 = " to ";
  protected final String TEXT_303 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_311 = NL + "  bool ";
  ...
  protected final String TEXT_326 = "( vector<";
  protected final String TEXT_327 = "*>& ";
  protected final String TEXT_328 = ");";
  protected final String TEXT_329 = NL + "  bool ";
  protected final String TEXT_330 = "( vector<";
  protected final String TEXT_331 = "*>& ";
  protected final String TEXT_332 = ");";
  protected final String TEXT_333 = NL + "  bool ";
  protected final String TEXT_334 = "( vector<";
  protected final String TEXT_335 = "*>& ";
  protected final String TEXT_336 = ");";
  protected final String TEXT_337 = NL + "  bool ";
  protected final String TEXT_338 = "( vector<";
  protected final String TEXT_339 = "*>& ";
  protected final String TEXT_340 = ");";
  protected final String TEXT_341 = NL + "  bool ";
  protected final String TEXT_342 = "( vector<";
  protected final String TEXT_343 = "*>& ";
  protected final String TEXT_344 = ");";
  protected final String TEXT_345 = NL + "  bool ";
  protected final String TEXT_346 = "( vector<";
  protected final String TEXT_347 = "*>&  ";
  protected final String TEXT_348 = ");";
  protected final String TEXT_349 = NL + "  bool ";
  protected final String TEXT_350 = "( vector<";
  protected final String TEXT_351 = "*>& ";
  protected final String TEXT_352 = ");";
  protected final String TEXT_353 = NL + "  ";
  protected final String TEXT_354 = " ";
  protected final String TEXT_355 = NL + " bool equals(Object obj);" + NL + " int hashCode();" + NL;
  protected final String TEXT_356 = NL + "   void ";
  protected final String TEXT_357 = "::";
  protected final String TEXT_358 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_359 = NL + "       ";
  protected final String TEXT_360 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_361 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_362 = NL + "    ";
  protected final String TEXT_363 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_364 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_365 = NL + "      ";
  protected final String TEXT_366 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_367 = NL + "  void ";
  protected final String TEXT_368 = "::";
  protected final String TEXT_369 = "()" + NL + "  {";
  protected final String TEXT_370 = NL + "    ";
  protected final String TEXT_371 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_372 = "\",";
  protected final String TEXT_373 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_374 = "::";
  protected final String TEXT_375 = "()" + NL + "  {";
  protected final String TEXT_376 = NL + "    ";
  protected final String TEXT_377 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_378 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_379 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_380 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_381 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_382 = "::run ()" + NL + "    {";
  protected final String TEXT_383 = NL + "      if (\"";
  protected final String TEXT_384 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_385 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_386 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_387 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_388 = NL + "  //------------------------" + NL + "  // Destructor" + NL + "  //------------------------";
  protected final String TEXT_389 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_390 = NL + "  ";
  protected final String TEXT_391 = NL + "};" + NL + "" + NL + "#endif";
