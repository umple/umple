...
public class CppHeaderGenerator implements ILang 
{
  ...
  protected final String TEXT_7 = NL + "{" + NL + "   //------------------------" + NL + "  // Attributes for header file" + NL + "  //------------------------" + NL + "  private:" + NL;
  protected final String TEXT_8 = NL + NL + "  //------------------------" + NL + "  // Constructor" + NL + "  //------------------------" + NL + "  public:" + NL;
  protected final String TEXT_9 = NL + "  ";
  protected final String TEXT_10 = "* ";
  protected final String TEXT_11 = "::getInstance()" + NL + "  {" + NL + "    if(!theInstance)" + NL + "    {" + NL + "      theInstance = new ";
  protected final String TEXT_12 = ";" + NL + "    }" + NL + "    return theInstance;" + NL + "  }";
  ...
  protected final String TEXT_20 = NL + "  \t  \t" + NL + "  //------------------------" + NL + "  // INTERFACE" + NL + "  //------------------------" + NL;
  protected final String TEXT_21 = NL + "  bool ";
  protected final String TEXT_22 = "(";
  protected final String TEXT_23 = " ";
  protected final String TEXT_24 = ");";
  protected final String TEXT_25 = NL + "  bool ";
  protected final String TEXT_26 = "(const ";
  protected final String TEXT_27 = " & ";
  protected final String TEXT_28 = ");" + NL + "  bool ";
  protected final String TEXT_29 = "();";
  protected final String TEXT_30 = NL + "  bool ";
  protected final String TEXT_31 = "(const ";
  ...
  protected final String TEXT_38 = "(const ";
  ...
  protected final String TEXT_46 = "();" + NL + "  int ";
  ...
  protected final String TEXT_79 = "()" + NL + "  {" + NL + "    String answer = ";
  protected final String TEXT_80 = ".toString();";
  protected final String TEXT_81 = NL + "    return answer;" + NL + "  }" + NL;
  ...
  protected final String TEXT_88 = "bool ";
  protected final String TEXT_89 = "::";
  protected final String TEXT_90 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;" + NL;
  protected final String TEXT_91 = NL + "    ";
  protected final String TEXT_92 = NL + NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  ...
  protected final String TEXT_100 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_101 = NL + "  private void ";
  protected final String TEXT_102 = "::";
  protected final String TEXT_103 = "()" + NL + "  {" + NL + "    switch(";
  protected final String TEXT_104 = ")" + NL + "    {";
  protected final String TEXT_105 = NL + "      ";
  protected final String TEXT_106 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_107 = NL + "  private void ";
  ...
  protected final String TEXT_125 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_143 = "UNABLE TO UNDERSAND association variable (see header_association_Get_All.jet)";
  protected final String TEXT_144 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_145 = " : ";
  protected final String TEXT_146 = NL + "  bool ";
  protected final String TEXT_147 = "();";
  protected final String TEXT_148 = NL + "  static int ";
  protected final String TEXT_149 = "();";
  protected final String TEXT_150 = NL + "  static int ";
  protected final String TEXT_151 = "();";
  protected final String TEXT_152 = NL + "static int ";
  ...
  protected final String TEXT_174 = NL + "  bool ";
  ...
  protected final String TEXT_203 = "( vector<";
  ...
  protected final String TEXT_228 = NL + "  bool ";
  protected final String TEXT_229 = "( vector<";
  protected final String TEXT_230 = "*>& ";
  protected final String TEXT_231 = ");";
  protected final String TEXT_232 = NL + "  void ";
  protected final String TEXT_233 = "::";
  protected final String TEXT_234 = "(";
  protected final String TEXT_235 = " ";
  protected final String TEXT_236 = ", ";
  protected final String TEXT_237 = " ";
  protected final String TEXT_238 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_239 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_240 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_241 = ", ";
  protected final String TEXT_242 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_243 = " to ";
  protected final String TEXT_244 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_253 = NL + "  bool ";
  ...
  protected final String TEXT_278 = ");" + NL + "  bool ";
  ...
  protected final String TEXT_290 = "( vector<";
  protected final String TEXT_291 = "*>& ";
  protected final String TEXT_292 = ");";
  protected final String TEXT_293 = NL + "  void ";
  protected final String TEXT_294 = "::";
  protected final String TEXT_295 = "(";
  protected final String TEXT_296 = " ";
  protected final String TEXT_297 = ", ";
  protected final String TEXT_298 = " ";
  protected final String TEXT_299 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_300 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_301 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_302 = ", ";
  protected final String TEXT_303 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_304 = " to ";
  ...
  protected final String TEXT_323 = ");" + NL + "  bool ";
  protected final String TEXT_324 = "(";
  protected final String TEXT_325 = " ";
  protected final String TEXT_326 = ");";
  protected final String TEXT_327 = NL + "  bool ";
  protected final String TEXT_328 = "( vector<";
  protected final String TEXT_329 = "*>& ";
  protected final String TEXT_330 = ");";
  protected final String TEXT_331 = NL + "  bool ";
  protected final String TEXT_332 = "( vector<";
  protected final String TEXT_333 = "*>& ";
  protected final String TEXT_334 = ");";
  protected final String TEXT_335 = NL + "  bool ";
  protected final String TEXT_336 = "( vector<";
  protected final String TEXT_337 = "*>& ";
  protected final String TEXT_338 = ");";
  protected final String TEXT_339 = NL + "  bool ";
  protected final String TEXT_340 = "( vector<";
  protected final String TEXT_341 = "*>& ";
  protected final String TEXT_342 = ");";
  protected final String TEXT_343 = NL + "  bool ";
  protected final String TEXT_344 = "( vector<";
  protected final String TEXT_345 = "*>& ";
  protected final String TEXT_346 = ");";
  protected final String TEXT_347 = NL + "  bool ";
  protected final String TEXT_348 = "( vector<";
  protected final String TEXT_349 = "*>&  ";
  protected final String TEXT_350 = ");";
  protected final String TEXT_351 = NL + "  bool ";
  protected final String TEXT_352 = "( vector<";
  protected final String TEXT_353 = "*>& ";
  protected final String TEXT_354 = ");";
  protected final String TEXT_355 = NL + "  ";
  protected final String TEXT_356 = " ";
  protected final String TEXT_357 = NL + " bool equals(Object obj);" + NL + " int hashCode();" + NL;
  protected final String TEXT_358 = NL + "   void ";
  protected final String TEXT_359 = "::";
  protected final String TEXT_360 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_361 = NL + "       ";
  protected final String TEXT_362 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_363 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_364 = NL + "    ";
  protected final String TEXT_365 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_366 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_367 = NL + "      ";
  protected final String TEXT_368 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_369 = NL + "  void ";
  protected final String TEXT_370 = "::";
  protected final String TEXT_371 = "()" + NL + "  {";
  protected final String TEXT_372 = NL + "    ";
  protected final String TEXT_373 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_374 = "\",";
  protected final String TEXT_375 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_376 = "::";
  protected final String TEXT_377 = "()" + NL + "  {";
  protected final String TEXT_378 = NL + "    ";
  protected final String TEXT_379 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_380 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_381 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_382 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_383 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_384 = "::run ()" + NL + "    {";
  protected final String TEXT_385 = NL + "      if (\"";
  protected final String TEXT_386 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_387 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_388 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_389 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_390 = NL + "  //------------------------" + NL + "  // Destructor" + NL + "  //------------------------";
  protected final String TEXT_391 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_392 = NL + "  ";
  protected final String TEXT_393 = NL + "};" + NL + "" + NL + "#endif";
