...
public class BckBean implements IGenerator {
  ...
  protected final String TEXT_29 = "s() {" + NL + "\t\tBeanLinker bLinker = new BeanLinker();" + NL + "\t\tbLinker.setRoleName(\"";
  ...
  protected final String TEXT_65 = "s() {" + NL + "\t\tBeanLinker bLinker = new BeanLinker();" + NL + "\t\tbLinker.setRoleName(\"";
  ...
  protected final String TEXT_93 = "s() {" + NL + "\t\tBeanLinker bLinker = new BeanLinker();" + NL + "\t\tbLinker.setRoleName(\"";
  ...
  protected final String TEXT_122 = "s() {" + NL + "\t\tBeanLinker bLinker = new BeanLinker();" + NL + "\t\tbLinker.setRoleName(\"";
  ...
  protected final String TEXT_137 = "s();" + NL + "\t\treturn null;" + NL + "\t}" + NL + NL;
  ...
  protected final String TEXT_281 = "s()!=null){" + NL + "\t\t\t\t \tArrayList<";
  ...
  protected final String TEXT_286 = "s()){" + NL + "\t\t\t\t \t\tif(getSelected";
  ...
  protected final String TEXT_302 = "s()!=null){" + NL + "\t\t\t\t \tArrayList<";
  ...
  protected final String TEXT_307 = "s()){" + NL + "\t\t\t\t \t\tif(getSelected";
  ...
  protected final String TEXT_329 = "s()));" + NL + "\t   ";
  ...
  protected final String TEXT_334 = "s()));" + NL + "\t   ";
