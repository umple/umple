...
class MentorK
  ...
  #MentorK Attributes - for documentation purposes
  #attr_reader :name

  #MentorK Associations - for documentation purposes
  ...
  def is_number_of_students_valid
    is_valid = number_of_students >= MentorK.minimum_number_of_students and number_of_students <= MentorK.maximum_number_of_students
    is_valid
  end
  ...
  def add_student(a_student)
    ...
    if number_of_students >= MentorK.maximum_number_of_students
      return was_added
    end
    ...
    if is_new_mentor and existing_mentor.number_of_students <= MentorK.minimum_number_of_students
      return was_added
    end
  ...
  def remove_student(a_student)
    ...
    if number_of_students <= MentorK.minimum_number_of_students
      return was_removed
    end
