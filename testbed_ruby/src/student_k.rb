...
class StudentK
  ...
  #StudentK Attributes - for documentation purposes
  #attr_reader :number

  #StudentK Associations - for documentation purposes
  ...
  def set_mentor(a_mentor)
    ...
    if a_mentor.number_of_students >= MentorK.maximum_number_of_students
      return was_set
    end
