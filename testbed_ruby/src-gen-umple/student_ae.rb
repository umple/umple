...
class StudentAE
  ...
  #StudentAE Attributes - for documentation purposes
  #attr_reader :number

  #StudentAE Associations - for documentation purposes
  ...
  def add_mentor(a_mentor)
    ...
    if number_of_mentors >= StudentAE.maximum_number_of_mentors
      return was_added
    end
