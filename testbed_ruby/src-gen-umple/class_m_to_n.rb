...
class ClassMToN
  ...
  #ClassMToN Associations - for documentation purposes
  ...
  def initialize(all_classOtherclasses)
    ...
    raise "Unable to create ClassMToN, must have 2 to 3 @classOtherclasses" unless did_add_classOtherclasses 
    @initialized = true
  end
  ...
  def set_classOtherclasses(new_classOtherclasses)
    ...
    if verified_classOtherclasses.size != new_classOtherclasses.size or verified_classOtherclasses.size < ClassMToN.minimum_number_of_classOtherclasses or verified_classOtherclasses.size > ClassMToN.maximum_number_of_classOtherclasses
      return was_set
    end
