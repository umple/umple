...
class MentorAD
  ...
  #MentorAD Attributes - for documentation purposes
  #attr_reader :name

  #MentorAD Associations - for documentation purposes
  ...
  def add_student(a_student)
    ...
    if number_of_students >= MentorAD.maximum_number_of_students
      return was_added
    end
  ...
  def delete
    ...
    copy_of_students.each do |a_student|
      if a_student.number_of_mentors <= StudentAD.minimum_number_of_mentors
        a_student.delete
      else
