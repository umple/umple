...
class ClassNAssociation
  ...
  #ClassNAssociation Associations - for documentation purposes
  ...
  def initialize(all_otherclasses)
    ...
    raise "Unable to create ClassNAssociation, must have 2 @otherclasses" unless did_add_otherclasses 
    @initialized = true
  end
  ...
  def self.required_number_of_otherclasses
    2
  end
  ...
  def set_otherclasses(new_otherclasses)
    ...
    if verified_otherclasses.size != new_otherclasses.size or verified_otherclasses.size() != ClassNAssociation.required_number_of_otherclasses
      return was_set
    end
