...
class StudentM
  ...
  #StudentM Attributes - for documentation purposes
  #attr_reader :number

  #StudentM Associations - for documentation purposes
  ...
  def set_mentor(a_mentor)
    ...
    if !@mentor.nil? and @mentor.number_of_students <= MentorM.minimum_number_of_students
      return was_set
    end
