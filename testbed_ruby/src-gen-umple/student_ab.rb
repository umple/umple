...
class StudentAB
  ...
  #StudentAB Attributes - for documentation purposes
  #attr_reader :number

  #StudentAB Associations - for documentation purposes
  ...
  def is_number_of_mentors_valid
    is_valid = number_of_mentors >= StudentAB.minimum_number_of_mentors and number_of_mentors <= StudentAB.maximum_number_of_mentors
    is_valid
  end
  ...
  def add_mentor(a_mentor)
    ...
    if number_of_mentors >= StudentAB.maximum_number_of_mentors
      return was_added
    end
  ...
  def remove_mentor(a_mentor)
    ...
    if number_of_mentors <= StudentAB.minimum_number_of_mentors
      return was_removed
    end
