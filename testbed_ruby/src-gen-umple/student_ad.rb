...
class StudentAD
  ...
  #StudentAD Attributes - for documentation purposes
  #attr_reader :number

  #StudentAD Associations - for documentation purposes
  ...
  def is_number_of_mentors_valid
    is_valid = number_of_mentors >= StudentAD.minimum_number_of_mentors
    is_valid
  end
  ...
  def remove_mentor(a_mentor)
    ...
    if number_of_mentors <= StudentAD.minimum_number_of_mentors
      return was_removed
    end
  ...
  def set_mentors(new_mentors)
    ...
    if verified_mentors.size != new_mentors.size or verified_mentors.size < StudentAD.minimum_number_of_mentors
      return was_set
    end
