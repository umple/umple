...
class StudentR
  ...
  #StudentR Attributes - for documentation purposes
  #attr_reader :number

  #StudentR Associations - for documentation purposes
  ...
  def delete
    ...
    copy_of_mentors.each do |a_mentor|
      if a_mentor.number_of_students <= MentorR.minimum_number_of_students
        a_mentor.delete
      else
