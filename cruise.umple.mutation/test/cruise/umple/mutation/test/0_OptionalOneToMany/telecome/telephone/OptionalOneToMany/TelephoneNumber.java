...
// line 15 "../../../OptionalOneToManyMutation_uModel.ump"
public class TelephoneNumber
{
  ...
  public TelephoneNumber(String aDigits, PhoneCall aCall, PhoneCall aPhoneCall, VoiceMailBox aVoiceMailBox)
  {
    digits = aDigits;
    ...
    boolean didAddPhoneCall = setPhoneCall(aPhoneCall);
    if (!didAddPhoneCall)
    {
      throw new RuntimeException("Unable to create party due to phoneCall. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
