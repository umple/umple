...
// line 15 "../../../directionMutation_uModel.ump"
public class TelephoneNumber
{
  ...
  public TelephoneNumber(String aDigits, PhoneCall aCall)
  {
    digits = aDigits;
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "  " + "phoneCall = "+(getPhoneCall()!=null?Integer.toHexString(System.identityHashCode(getPhoneCall())):"null");
  }
}