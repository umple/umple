...
// line 33 "../../DoubleMutation_uModel_telephone.ump"
public class PhoneLine
{
  ...
  public PhoneLine(int aLocation, int aPoCode, int aDigOrAnalog)
  {
    location = aLocation;
    poCode = aPoCode;
  ...
  public boolean setLocation(int aLocation)
  {
  ...
  public boolean setPoCode(int aPoCode)
  {
    boolean wasSet = false;
    poCode = aPoCode;
    wasSet = true;
