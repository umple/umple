...
public class WorkflowFactoryImpl extends EFactoryImpl implements WorkflowFactory {
	...
	public static WorkflowFactory init() {
		try {
			WorkflowFactory theWorkflowFactory = (WorkflowFactory)EPackage.Registry.INSTANCE.getEFactory("cruise.umple.umplificator.model.workflow.workflow"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case WorkflowPackage.REFACTORING_SUB_TASK: return createRefactoringSubTask();
			case WorkflowPackage.REFACTORING_TASK: return createRefactoringTask();
	 ...
	 * @generated
	 */
	public RefactoringSubTask createRefactoringSubTask() {
		RefactoringSubTaskImpl refactoringSubTask = new RefactoringSubTaskImpl();
	 ...
	 * @generated
	 */
	public RefactoringTask createRefactoringTask() {
		RefactoringTaskImpl refactoringTask = new RefactoringTaskImpl();
