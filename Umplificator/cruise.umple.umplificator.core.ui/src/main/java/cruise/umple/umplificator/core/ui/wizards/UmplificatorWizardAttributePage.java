...
public class UmplificatorWizardAttributePage extends UmplificatorWizardPage {
     ...
     * @param pageName
     */
    public UmplificatorWizardAttributePage(ISelection selection) {
        super(selection, "Attribute Refactoring");
    }
    ...
    public void createControl(Composite parent) {
        ...
        this.classText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
            	UmplificatorWizardAttributePage.this.dialogChanged();
            }
       });        
