...
public class UmpleInternalParserTest extends UmpleParserTest
{
  ...
  static {
    ...
    fileToOutputs.put("014_interfaceMultipleImplements.ump", "[interfaceDefinition][name:ISomething][interfaceMemberDeclaration][extendsName:ISuper][extendsName:IOtherSuper][interfaceDefinition][name:ISuper][interfaceDefinition][name:IOtherSuper]");
