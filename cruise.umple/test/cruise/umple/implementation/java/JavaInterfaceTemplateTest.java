...
public class JavaInterfaceTemplateTest extends InterfaceTemplateTest
{
	...
	{
		assertUmpleTemplateFor("InterfaceTemplateTest2.ump",languagePath + "/InterfaceTemplateTest_implementsMultipleInterface."+ languagePath +".txt","A");
	}
	
	@Test
	public void extendsImplementsMultipleInterface()
	{
		assertUmpleTemplateFor("InterfaceTemplateTest.ump",languagePath + "/InterfaceTemplateTest_extendsImplementsMultipleInterface."+ languagePath +".txt","B");
	}
}
