...
public class CppHeader extends CppGenerationTemplate{
  ...
  protected final String TEXT_37 = NL + "#define ";
  protected final String TEXT_38 = "_BODY" + NL + "" + NL + "#if defined( PRAGMA ) && ! defined( PRAGMA_IMPLEMENTED )" + NL + "#pragma implementation <";
  protected final String TEXT_39 = ".h>" + NL + "#endif";
