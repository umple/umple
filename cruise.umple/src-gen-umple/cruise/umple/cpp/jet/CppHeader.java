...
public class CppHeader extends CppGenerationTemplate{
  ...
  protected final String TEXT_48 = " &other){" + NL + "    internalCopy(other);" + NL + "    return *this;" + NL + "}";
  protected final String TEXT_49 = "void ";
  protected final String TEXT_50 = "::internalCopy(";
  protected final String TEXT_51 = "& other){";
  protected final String TEXT_52 = NL + "}";
  protected final String TEXT_53 = NL;
  protected final String TEXT_54 = NL;
  protected final String TEXT_55 = "void internalCopy(";
  protected final String TEXT_56 = "& other);";
  protected final String TEXT_57 = NL + "#define ";
  protected final String TEXT_58 = "_BODY" + NL + "" + NL + "#if defined( PRAGMA ) && ! defined( PRAGMA_IMPLEMENTED )" + NL + "#pragma implementation <";
  protected final String TEXT_59 = ".h>" + NL + "#endif";
