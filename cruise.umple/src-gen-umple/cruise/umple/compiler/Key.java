...
public class Key
{
  ...
  @umplesourcefile(line={398},file={"Umple_Code.ump"},javaline={110},length={3})
   public boolean isProvided(){
    return isDefault || members.size() > 0;
  }

  @umplesourcefile(line={403},file={"Umple_Code.ump"},javaline={115},length={7})
