...
public class UmpleClass extends UmpleClassifier
{
  ...
  @umplesourcefile(line={425, 720},file={"Umple.ump", "Umple_Code.ump"},javaline={906, 919},length={1, 25})
  ...
  @umplesourcefile(line={423},file={"Umple.ump"},javaline={1175},length={2})
  ...
  @umplesourcefile(line={427},file={"Umple.ump"},javaline={1447},length={2})
  ...
  @umplesourcefile(line={750},file={"Umple_Code.ump"},javaline={1639},length={3})
   public  UmpleClass(String name){
    this(name, null);
  }

  @umplesourcefile(line={755},file={"Umple_Code.ump"},javaline={1644},length={9})
  ...
  @umplesourcefile(line={766},file={"Umple_Code.ump"},javaline={1655},length={59})
  ...
  @umplesourcefile(line={827},file={"Umple_Code.ump"},javaline={1716},length={12})
  ...
  @umplesourcefile(line={841},file={"Umple_Code.ump"},javaline={1730},length={17})
  ...
  @umplesourcefile(line={860},file={"Umple_Code.ump"},javaline={1749},length={18})
  ...
  @umplesourcefile(line={880},file={"Umple_Code.ump"},javaline={1769},length={10})
  ...
  @umplesourcefile(line={892},file={"Umple_Code.ump"},javaline={1781},length={6})
  ...
  @umplesourcefile(line={900},file={"Umple_Code.ump"},javaline={1789},length={10})
  ...
  @umplesourcefile(line={912},file={"Umple_Code.ump"},javaline={1801},length={10})
  ...
  @umplesourcefile(line={924},file={"Umple_Code.ump"},javaline={1813},length={27})
  ...
  @umplesourcefile(line={952},file={"Umple_Code.ump"},javaline={1842},length={27})
  ...
  @umplesourcefile(line={981},file={"Umple_Code.ump"},javaline={1871},length={10})
  ...
  @umplesourcefile(line={993},file={"Umple_Code.ump"},javaline={1883},length={3})
   public boolean isRoot(){
    return extendsClass == null;
  }

  @umplesourcefile(line={999},file={"Umple_Code.ump"},javaline={1888},length={3})
   public GeneratedClass getGeneratedClass(){
    return gClass;
  }

  @umplesourcefile(line={1004},file={"Umple_Code.ump"},javaline={1893},length={8})
  ...
  @umplesourcefile(line={1016},file={"Umple_Code.ump"},javaline={1903},length={3})
   public boolean hasUniqueIdentifier(){
    return getUniqueIdentifier() != null;
  }

  @umplesourcefile(line={1021},file={"Umple_Code.ump"},javaline={1908},length={10})
   ...
   */
  @umplesourcefile(line={1037},file={"Umple_Code.ump"},javaline={1920},length={3})
   public boolean isImmutable(){
    return (iAmImmutable || ancestorIsImmutable);
  }

  @umplesourcefile(line={1042},file={"Umple_Code.ump"},javaline={1931},length={11})
  ...
  @umplesourcefile(line={1055},file={"Umple_Code.ump"},javaline={1944},length={13})
  ...
  @umplesourcefile(line={1070},file={"Umple_Code.ump"},javaline={1959},length={17})
  ...
  @umplesourcefile(line={1089},file={"Umple_Code.ump"},javaline={1978},length={13})
  ...
  @umplesourcefile(line={1104},file={"Umple_Code.ump"},javaline={1993},length={6})
  ...
  @umplesourcefile(line={1113},file={"Umple_Code.ump"},javaline={2001},length={44})
  ...
  @umplesourcefile(line={1159},file={"Umple_Code.ump"},javaline={2047},length={7})
  ...
  //------------------------
  //  @umplesourcefile(line={995},file={"Umple_Code.ump"},javaline={2070},length={2})
