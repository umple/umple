 ...
 * @umplesource Umple_Code.ump 706
 * @umplesource Trace.ump 158
 */
// line 360 "../../../../src/Umple.ump"
// line 706 "../../../../src/Umple_Code.ump"
...
public class UmpleClass extends UmpleClassifier
{
  ...
  @umplesourcefile(line={420, 710},file={"Umple.ump", "Umple_Code.ump"},javaline={874, 887},length={1, 25})
  ...
  @umplesourcefile(line={740},file={"Umple_Code.ump"},javaline={1519},length={3})
   public  UmpleClass(String name){
    this(name, null);
  }

  @umplesourcefile(line={745},file={"Umple_Code.ump"},javaline={1524},length={9})
  ...
  @umplesourcefile(line={756},file={"Umple_Code.ump"},javaline={1535},length={59})
  ...
  @umplesourcefile(line={817},file={"Umple_Code.ump"},javaline={1596},length={12})
  ...
  @umplesourcefile(line={831},file={"Umple_Code.ump"},javaline={1610},length={17})
  ...
  @umplesourcefile(line={850},file={"Umple_Code.ump"},javaline={1629},length={18})
  ...
  @umplesourcefile(line={870},file={"Umple_Code.ump"},javaline={1649},length={10})
  ...
  @umplesourcefile(line={882},file={"Umple_Code.ump"},javaline={1661},length={6})
  ...
  @umplesourcefile(line={890},file={"Umple_Code.ump"},javaline={1669},length={10})
  ...
  @umplesourcefile(line={902},file={"Umple_Code.ump"},javaline={1681},length={10})
  ...
  @umplesourcefile(line={914},file={"Umple_Code.ump"},javaline={1693},length={27})
  ...
  @umplesourcefile(line={942},file={"Umple_Code.ump"},javaline={1722},length={27})
  ...
  @umplesourcefile(line={971},file={"Umple_Code.ump"},javaline={1751},length={10})
  ...
  @umplesourcefile(line={983},file={"Umple_Code.ump"},javaline={1763},length={3})
   public boolean isRoot(){
    return extendsClass == null;
  }

  @umplesourcefile(line={989},file={"Umple_Code.ump"},javaline={1768},length={3})
   public GeneratedClass getGeneratedClass(){
    return gClass;
  }

  @umplesourcefile(line={994},file={"Umple_Code.ump"},javaline={1773},length={8})
  ...
  @umplesourcefile(line={1006},file={"Umple_Code.ump"},javaline={1783},length={3})
   public boolean hasUniqueIdentifier(){
    return getUniqueIdentifier() != null;
  }

  @umplesourcefile(line={1011},file={"Umple_Code.ump"},javaline={1788},length={10})
   ...
   */
  @umplesourcefile(line={1027},file={"Umple_Code.ump"},javaline={1800},length={3})
   public boolean isImmutable(){
    return (iAmImmutable || ancestorIsImmutable);
  }

  @umplesourcefile(line={1032},file={"Umple_Code.ump"},javaline={1811},length={11})
  ...
  @umplesourcefile(line={1045},file={"Umple_Code.ump"},javaline={1824},length={13})
  ...
  @umplesourcefile(line={1060},file={"Umple_Code.ump"},javaline={1839},length={17})
  ...
  @umplesourcefile(line={1079},file={"Umple_Code.ump"},javaline={1858},length={13})
  ...
  @umplesourcefile(line={1094},file={"Umple_Code.ump"},javaline={1873},length={6})
  ...
  @umplesourcefile(line={1103},file={"Umple_Code.ump"},javaline={1881},length={44})
  ...
  @umplesourcefile(line={1149},file={"Umple_Code.ump"},javaline={1927},length={7})
  ...
  //------------------------
  //  @umplesourcefile(line={985},file={"Umple_Code.ump"},javaline={1950},length={2})
