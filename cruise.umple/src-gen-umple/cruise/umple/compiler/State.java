...
public class State
{
   ...
   */
  @umplesourcefile(line={70},file={"Trace_Code.ump"},javaline={772},length={120})
  ...
  @umplesourcefile(line={318},file={"StateMachine_Code.ump"},javaline={937},length={15})
  ...
  @umplesourcefile(line={334},file={"StateMachine_Code.ump"},javaline={954},length={7})
  ...
  @umplesourcefile(line={342},file={"StateMachine_Code.ump"},javaline={963},length={6})
  ...
  @umplesourcefile(line={349},file={"StateMachine_Code.ump"},javaline={971},length={4})
  public String getType()
  {
    return numberOfTransitions() == 0 && numberOfNestedStateMachines() == 0 ? "Simple" : "Complex";
  }
  
  @umplesourcefile(line={354},file={"StateMachine_Code.ump"},javaline={977},length={21})
  ...
  @umplesourcefile(line={376},file={"StateMachine_Code.ump"},javaline={1000},length={12})
  ...
  @umplesourcefile(line={389},file={"StateMachine_Code.ump"},javaline={1014},length={4})
  public boolean getHasExitAction()
  {
    return getHasAction("exit");
  }
  
  @umplesourcefile(line={394},file={"StateMachine_Code.ump"},javaline={1020},length={4})
  public boolean getHasEntryAction()
  {
    return getHasAction("entry");
  }
  
  @umplesourcefile(line={399},file={"StateMachine_Code.ump"},javaline={1026},length={11})
  ...
  @umplesourcefile(line={411},file={"StateMachine_Code.ump"},javaline={1039},length={21})
