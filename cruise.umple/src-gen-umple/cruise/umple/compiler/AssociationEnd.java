...
public class AssociationEnd
{
  ...
  @umplesourcefile(line={1507},file={"Umple_Code.ump"},javaline={318},length={3})
   public boolean isNavigable(){
    return !getModifier().toLowerCase().equals("nonnavigable");
  }

  @umplesourcefile(line={1512},file={"Umple_Code.ump"},javaline={323},length={3})
   public String getLowerBoundString(){
    return getMultiplicity().getLowerBound() == -1 ? "*" : getMultiplicity().getLowerBound() + "";
  }

  @umplesourcefile(line={1517},file={"Umple_Code.ump"},javaline={328},length={3})
   public String getUpperBoundString(){
    return getMultiplicity().getUpperBound() == -1 ? "*" : getMultiplicity().getUpperBound() + "";
  }

  @umplesourcefile(line={1522},file={"Umple_Code.ump"},javaline={333},length={3})
   public String getDisplayRoleName(){
    return isDefaultRoleName ? "" : getRoleName();
  }

  @umplesourcefile(line={1527},file={"Umple_Code.ump"},javaline={338},length={18})
  ...
  @umplesourcefile(line={1547},file={"Umple_Code.ump"},javaline={358},length={22})
  ...
  @umplesourcefile(line={1571},file={"Umple_Code.ump"},javaline={382},length={26})
  ...
  @umplesourcefile(line={1599},file={"Umple_Code.ump"},javaline={410},length={3})
   private String formatEnd(int aValue){
    return aValue == MULT_MANY ? "*" : aValue + "";
  }

  @umplesourcefile(line={1605},file={"Umple_Code.ump"},javaline={415},length={14})
  ...
  //------------------------
  //  @umplesourcefile(line={1502},file={"Umple_Code.ump"},javaline={433},length={2})
