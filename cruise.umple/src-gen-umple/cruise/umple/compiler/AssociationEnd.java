 ...
 * @umplesource Umple_Code.ump 1233
 */
// line 519 "../../../../src/Umple.ump"
// line 1233 "../../../../src/Umple_Code.ump"
public class AssociationEnd
{
  ...
  //------------------------
  //  @umplesourcefile(line={1235},file={"Umple_Code.ump"},javaline={320},length={116})
  private static int MULT_MANY = -1;

  @umplesourcefile(line={1238},file={"Umple_Code.ump"},javaline={323},length={4})
  public boolean isNavigable()
  {
    return !getModifier().toLowerCase().equals("nonnavigable");
  }  

  @umplesourcefile(line={1243},file={"Umple_Code.ump"},javaline={329},length={4})
  public String getLowerBoundString()
  {
    return getMultiplicity().getLowerBound() == -1 ? "*" : getMultiplicity().getLowerBound() + "";
  }

  @umplesourcefile(line={1248},file={"Umple_Code.ump"},javaline={335},length={4})
  public String getUpperBoundString()
  {
    return getMultiplicity().getUpperBound() == -1 ? "*" : getMultiplicity().getUpperBound() + "";
  }

  @umplesourcefile(line={1253},file={"Umple_Code.ump"},javaline={341},length={4})
  public String getDisplayRoleName()
  {
    return isDefaultRoleName ? "" : getRoleName();
  }

  @umplesourcefile(line={1258},file={"Umple_Code.ump"},javaline={347},length={19})
  ...
  @umplesourcefile(line={1278},file={"Umple_Code.ump"},javaline={368},length={23})
  ...
  @umplesourcefile(line={1302},file={"Umple_Code.ump"},javaline={393},length={27})
  ...
  @umplesourcefile(line={1330},file={"Umple_Code.ump"},javaline={422},length={4})
  private String formatEnd(int aValue)
  {
    return aValue == MULT_MANY ? "*" : aValue + "";
  }

  @umplesourcefile(line={1335},file={"Umple_Code.ump"},javaline={428},length={16})
