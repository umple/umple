...
public class StateMachineTraceItem implements TraceItem
{
  ...
  @umplesourcefile(line={294},file={"Trace_Code.ump"},javaline={373},length={3})
   public Boolean getIsPre(){
    return conditionallyWhere;
  }

  @umplesourcefile(line={297},file={"Trace_Code.ump"},javaline={378},length={3})
   ...
   */
  @umplesourcefile(line={309},file={"Trace_Code.ump"},javaline={383},length={59})
   ...
   */
  @umplesourcefile(line={372},file={"Trace_Code.ump"},javaline={453},length={3})
