 ...
 * @umplesource Trace_Code.ump 277
 */
// line 122 "../../../../src/Trace.ump"
// line 277 "../../../../src/Trace_Code.ump"
public class StateMachineTraceItem implements TraceItem
{
  ...
  //------------------------
  //  @umplesourcefile(line={284},file={"Trace_Code.ump"},javaline={400},length={82})
  @umplesourcefile(line={285},file={"Trace_Code.ump"},javaline={401},length={3})
  public Boolean getIsPre(){
  	return conditionallyWhere;
  }
  @umplesourcefile(line={288},file={"Trace_Code.ump"},javaline={405},length={3})
   ...
   */
  @umplesourcefile(line={299},file={"Trace_Code.ump"},javaline={417},length={60})
   ...
   */
  @umplesourcefile(line={362},file={"Trace_Code.ump"},javaline={481},length={4})
