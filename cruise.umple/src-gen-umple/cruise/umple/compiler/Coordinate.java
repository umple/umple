...
public class Coordinate
{
  ...
  @umplesourcefile(line={640},file={"Umple.ump"},javaline={58},length={1})
  ...
  @umplesourcefile(line={641},file={"Umple.ump"},javaline={73},length={1})
  ...
  @umplesourcefile(line={642},file={"Umple.ump"},javaline={84},length={1})
  ...
  @umplesourcefile(line={643},file={"Umple.ump"},javaline={95},length={1})
  ...
  @umplesourcefile(line={644},file={"Umple.ump"},javaline={106},length={1})
  ...
  @umplesourcefile(line={1777},file={"Umple_Code.ump"},javaline={206},length={3})
   public Point getTopLeft(){
    return new Point(x,y);
  }

  @umplesourcefile(line={1782},file={"Umple_Code.ump"},javaline={211},length={3})
   public Point getTopRight(){
    return new Point(x+width,y);
  }

  @umplesourcefile(line={1787},file={"Umple_Code.ump"},javaline={216},length={3})
   public Point getBottomLeft(){
    return new Point(x,y+height);
  }

  @umplesourcefile(line={1792},file={"Umple_Code.ump"},javaline={221},length={3})
   public Point getBottomRight(){
    return new Point(x+width,y+height);
  }

  @umplesourcefile(line={1797},file={"Umple_Code.ump"},javaline={226},length={3})
   public Point getTopMiddle(){
    return new Point(x+width/2,y);
  }

  @umplesourcefile(line={1802},file={"Umple_Code.ump"},javaline={231},length={3})
   public Point getBottomMiddle(){
    return new Point(x+width/2,y+height);
  }

  @umplesourcefile(line={1807},file={"Umple_Code.ump"},javaline={236},length={3})
   public Point getRightMiddle(){
    return new Point(x+width,y+height/2);
  }

  @umplesourcefile(line={1812},file={"Umple_Code.ump"},javaline={241},length={3})
   public Point getLeftMiddle(){
    return new Point(x,y+height/2);
  }

  @umplesourcefile(line={1817},file={"Umple_Code.ump"},javaline={246},length={24})
  ...
  @umplesourcefile(line={1843},file={"Umple_Code.ump"},javaline={272},length={6})
  ...
  @umplesourcefile(line={1851},file={"Umple_Code.ump"},javaline={280},length={3})
   public String toString(){
    return "(" + getX() + "," + getY() + "," + getWidth() + "," + getHeight() + ")";
  }

  @umplesourcefile(line={1856},file={"Umple_Code.ump"},javaline={285},length={10})
