 ...
 * 
 * @umplesource Umple.ump 730
 * @umplesource Umple_Code.ump 2037
 */
// line 730 "../../../../src/Umple.ump"
// line 2037 "../../../../src/Umple_Code.ump"
public class Coordinate
{
  ...
  @umplesourcefile(line={739},file={"Umple.ump"},javaline={59},length={1})
  ...
  @umplesourcefile(line={740},file={"Umple.ump"},javaline={74},length={1})
  ...
  @umplesourcefile(line={741},file={"Umple.ump"},javaline={85},length={1})
  ...
  @umplesourcefile(line={742},file={"Umple.ump"},javaline={96},length={1})
  ...
  @umplesourcefile(line={743},file={"Umple.ump"},javaline={107},length={1})
  ...
  @umplesourcefile(line={2043},file={"Umple_Code.ump"},javaline={208},length={3})
   public Point getTopLeft(){
    return new Point(x,y);
  }

  @umplesourcefile(line={2048},file={"Umple_Code.ump"},javaline={213},length={3})
   public Point getTopRight(){
    return new Point(x+width,y);
  }

  @umplesourcefile(line={2053},file={"Umple_Code.ump"},javaline={218},length={3})
   public Point getBottomLeft(){
    return new Point(x,y+height);
  }

  @umplesourcefile(line={2058},file={"Umple_Code.ump"},javaline={223},length={3})
   public Point getBottomRight(){
    return new Point(x+width,y+height);
  }

  @umplesourcefile(line={2063},file={"Umple_Code.ump"},javaline={228},length={3})
   public Point getTopMiddle(){
    return new Point(x+width/2,y);
  }

  @umplesourcefile(line={2068},file={"Umple_Code.ump"},javaline={233},length={3})
   public Point getBottomMiddle(){
    return new Point(x+width/2,y+height);
  }

  @umplesourcefile(line={2073},file={"Umple_Code.ump"},javaline={238},length={3})
   public Point getRightMiddle(){
    return new Point(x+width,y+height/2);
  }

  @umplesourcefile(line={2078},file={"Umple_Code.ump"},javaline={243},length={3})
   public Point getLeftMiddle(){
    return new Point(x,y+height/2);
  }

  @umplesourcefile(line={2083},file={"Umple_Code.ump"},javaline={248},length={24})
  ...
  @umplesourcefile(line={2109},file={"Umple_Code.ump"},javaline={274},length={6})
  ...
  @umplesourcefile(line={2117},file={"Umple_Code.ump"},javaline={282},length={3})
   public String toString(){
    return "(" + getX() + "," + getY() + "," + getWidth() + "," + getHeight() + ")";
  }

  @umplesourcefile(line={2122},file={"Umple_Code.ump"},javaline={287},length={10})
