 ...
 * @umplesource Umple_Code.ump 2019
 */
// line 655 "../../../../src/Umple.ump"
// line 2019 "../../../../src/Umple_Code.ump"
public class Coordinate
{
  ...
  @umplesourcefile(line={2025},file={"Umple_Code.ump"},javaline={208},length={3})
   public Point getTopLeft(){
    return new Point(x,y);
  }

  @umplesourcefile(line={2030},file={"Umple_Code.ump"},javaline={213},length={3})
   public Point getTopRight(){
    return new Point(x+width,y);
  }

  @umplesourcefile(line={2035},file={"Umple_Code.ump"},javaline={218},length={3})
   public Point getBottomLeft(){
    return new Point(x,y+height);
  }

  @umplesourcefile(line={2040},file={"Umple_Code.ump"},javaline={223},length={3})
   public Point getBottomRight(){
    return new Point(x+width,y+height);
  }

  @umplesourcefile(line={2045},file={"Umple_Code.ump"},javaline={228},length={3})
   public Point getTopMiddle(){
    return new Point(x+width/2,y);
  }

  @umplesourcefile(line={2050},file={"Umple_Code.ump"},javaline={233},length={3})
   public Point getBottomMiddle(){
    return new Point(x+width/2,y+height);
  }

  @umplesourcefile(line={2055},file={"Umple_Code.ump"},javaline={238},length={3})
   public Point getRightMiddle(){
    return new Point(x+width,y+height/2);
  }

  @umplesourcefile(line={2060},file={"Umple_Code.ump"},javaline={243},length={3})
   public Point getLeftMiddle(){
    return new Point(x,y+height/2);
  }

  @umplesourcefile(line={2065},file={"Umple_Code.ump"},javaline={248},length={24})
  ...
  @umplesourcefile(line={2091},file={"Umple_Code.ump"},javaline={274},length={6})
  ...
  @umplesourcefile(line={2099},file={"Umple_Code.ump"},javaline={282},length={3})
   public String toString(){
    return "(" + getX() + "," + getY() + "," + getWidth() + "," + getHeight() + ")";
  }

  @umplesourcefile(line={2104},file={"Umple_Code.ump"},javaline={287},length={10})
