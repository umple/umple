 ...
 * 
 * @umplesource Umple.ump 655
 * @umplesource Umple_Code.ump 2020
 */
// line 655 "../../../../src/Umple.ump"
// line 2020 "../../../../src/Umple_Code.ump"
public class Coordinate
{
  ...
  @umplesourcefile(line={664},file={"Umple.ump"},javaline={59},length={1})
  ...
  @umplesourcefile(line={665},file={"Umple.ump"},javaline={74},length={1})
  ...
  @umplesourcefile(line={666},file={"Umple.ump"},javaline={85},length={1})
  ...
  @umplesourcefile(line={667},file={"Umple.ump"},javaline={96},length={1})
  ...
  @umplesourcefile(line={668},file={"Umple.ump"},javaline={107},length={1})
  ...
  @umplesourcefile(line={2026},file={"Umple_Code.ump"},javaline={208},length={3})
   public Point getTopLeft(){
    return new Point(x,y);
  }

  @umplesourcefile(line={2031},file={"Umple_Code.ump"},javaline={213},length={3})
   public Point getTopRight(){
    return new Point(x+width,y);
  }

  @umplesourcefile(line={2036},file={"Umple_Code.ump"},javaline={218},length={3})
   public Point getBottomLeft(){
    return new Point(x,y+height);
  }

  @umplesourcefile(line={2041},file={"Umple_Code.ump"},javaline={223},length={3})
   public Point getBottomRight(){
    return new Point(x+width,y+height);
  }

  @umplesourcefile(line={2046},file={"Umple_Code.ump"},javaline={228},length={3})
   public Point getTopMiddle(){
    return new Point(x+width/2,y);
  }

  @umplesourcefile(line={2051},file={"Umple_Code.ump"},javaline={233},length={3})
   public Point getBottomMiddle(){
    return new Point(x+width/2,y+height);
  }

  @umplesourcefile(line={2056},file={"Umple_Code.ump"},javaline={238},length={3})
   public Point getRightMiddle(){
    return new Point(x+width,y+height/2);
  }

  @umplesourcefile(line={2061},file={"Umple_Code.ump"},javaline={243},length={3})
   public Point getLeftMiddle(){
    return new Point(x,y+height/2);
  }

  @umplesourcefile(line={2066},file={"Umple_Code.ump"},javaline={248},length={24})
  ...
  @umplesourcefile(line={2092},file={"Umple_Code.ump"},javaline={274},length={6})
  ...
  @umplesourcefile(line={2100},file={"Umple_Code.ump"},javaline={282},length={3})
   public String toString(){
    return "(" + getX() + "," + getY() + "," + getWidth() + "," + getHeight() + ")";
  }

  @umplesourcefile(line={2105},file={"Umple_Code.ump"},javaline={287},length={10})
