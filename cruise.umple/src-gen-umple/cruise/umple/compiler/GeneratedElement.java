 ...
 * @umplesource Umple_Code.ump 1935
 */
// line 612 "../../../../src/Umple.ump"
// line 1935 "../../../../src/Umple_Code.ump"
public class GeneratedElement
{
  ...
  @umplesourcefile(line={1944},file={"Umple_Code.ump"},javaline={42},length={3})
   public void setLookup(String aKey, String aValue){
    lookups.put(aKey, aValue);
  }

  @umplesourcefile(line={1949},file={"Umple_Code.ump"},javaline={47},length={10})
  ...
  @umplesourcefile(line={1961},file={"Umple_Code.ump"},javaline={59},length={20})
  ...
  @umplesourcefile(line={1983},file={"Umple_Code.ump"},javaline={81},length={12})
  ...
  @umplesourcefile(line={1997},file={"Umple_Code.ump"},javaline={95},length={9})
  ...
  //------------------------
  //  @umplesourcefile(line={1938},file={"Umple_Code.ump"},javaline={108},length={4})
  @umplesourcefile(line={1939},file={"Umple_Code.ump"},javaline={109},length={3})
  private Map<String, String> lookups = new HashMap<String, String>() ;
//  @umplesourcefile(line={1939},file={"Umple_Code.ump"},javaline={111},length={2})
  @umplesourcefile(line={1940},file={"Umple_Code.ump"},javaline={112},length={1})
