 ...
 * @umplesource Umple_Code.ump 1675
 */
// line 585 "../../../../src/Umple.ump"
// line 1675 "../../../../src/Umple_Code.ump"
public class GeneratedElement
{
  ...
  //------------------------
  //  @umplesourcefile(line={1677},file={"Umple_Code.ump"},javaline={43},length={67})
  @umplesourcefile(line={1678},file={"Umple_Code.ump"},javaline={44},length={7})
  private Map<String, String> lookups = new HashMap<String, String>();
  @umplesourcefile(line={1679},file={"Umple_Code.ump"},javaline={46},length={6})
  private Map<String, List<String>> multiLookups = new HashMap<String,List<String>>();

  @umplesourcefile(line={1681},file={"Umple_Code.ump"},javaline={49},length={4})
  public void setLookup(String aKey, String aValue)
  {
    lookups.put(aKey, aValue);
  }

  @umplesourcefile(line={1686},file={"Umple_Code.ump"},javaline={55},length={11})
  ...
  @umplesourcefile(line={1698},file={"Umple_Code.ump"},javaline={68},length={21})
  ...
  @umplesourcefile(line={1720},file={"Umple_Code.ump"},javaline={91},length={13})
  ...
  @umplesourcefile(line={1734},file={"Umple_Code.ump"},javaline={106},length={10})
