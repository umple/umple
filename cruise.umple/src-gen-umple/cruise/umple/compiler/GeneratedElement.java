...
public class GeneratedElement
{
  ...
  @umplesourcefile(line={1942},file={"Umple_Code.ump"},javaline={46},length={3})
   public void setLookup(String aKey, String aValue){
    lookups.put(aKey, aValue);
  }

  @umplesourcefile(line={1947},file={"Umple_Code.ump"},javaline={51},length={10})
  ...
  @umplesourcefile(line={1959},file={"Umple_Code.ump"},javaline={63},length={20})
  ...
  @umplesourcefile(line={1981},file={"Umple_Code.ump"},javaline={85},length={12})
  ...
  @umplesourcefile(line={1995},file={"Umple_Code.ump"},javaline={99},length={9})
  ...
  //------------------------
  //  @umplesourcefile(line={1936},file={"Umple_Code.ump"},javaline={112},length={4})
  @umplesourcefile(line={1937},file={"Umple_Code.ump"},javaline={113},length={3})
  private Map<String, String> lookups = new HashMap<String, String>() ;
//  @umplesourcefile(line={1937},file={"Umple_Code.ump"},javaline={115},length={2})
  @umplesourcefile(line={1938},file={"Umple_Code.ump"},javaline={116},length={1})
