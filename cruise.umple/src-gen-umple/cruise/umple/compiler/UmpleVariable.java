...
public class UmpleVariable
{
  ...
  @umplesourcefile(line={541},file={"Umple.ump"},javaline={63},length={1})
   ...
   */
  @umplesourcefile(line={543},file={"Umple.ump"},javaline={116},length={1})
  ...
  @umplesourcefile(line={1174},file={"Umple_Code.ump"},javaline={253},length={14})
  ...
  @umplesourcefile(line={1190},file={"Umple_Code.ump"},javaline={269},length={3})
   ...
   */
  @umplesourcefile(line={26},file={"Trace_Code.ump"},javaline={274},length={36})
