...
public class UmpleVariable
{
  ...
  @umplesourcefile(line={540},file={"Umple.ump"},javaline={59},length={1})
   ...
   */
  @umplesourcefile(line={542},file={"Umple.ump"},javaline={112},length={1})
  ...
  @umplesourcefile(line={1181},file={"Umple_Code.ump"},javaline={249},length={14})
  ...
  @umplesourcefile(line={1197},file={"Umple_Code.ump"},javaline={265},length={3})
   ...
   */
  @umplesourcefile(line={26},file={"Trace_Code.ump"},javaline={270},length={36})
