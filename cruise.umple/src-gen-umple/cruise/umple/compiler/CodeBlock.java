...
//  @umplesourcefile(line={496},file={"Umple_Code.ump"},javaline={56},length={33})
  @umplesourcefile(line={497},file={"Umple_Code.ump"},javaline={57},length={7})
  ...
  @umplesourcefile(line={504},file={"Umple_Code.ump"},javaline={65},length={7})
  ...
  @umplesourcefile(line={511},file={"Umple_Code.ump"},javaline={73},length={4})
  public String getCode()
  {
    return !code.containsKey(languageUsed) ? "".equals(languageUsed) ? null : code.get("") : code.get(languageUsed);
  }
  @umplesourcefile(line={515},file={"Umple_Code.ump"},javaline={78},length={4})
  public String getCode(String lang)
  {
    return code.containsKey(lang)? code.get(lang) : code.get("");
  }
  @umplesourcefile(line={519},file={"Umple_Code.ump"},javaline={83},length={10})
