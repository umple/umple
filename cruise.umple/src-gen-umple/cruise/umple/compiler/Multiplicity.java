 ...
 * @umplesource Umple.ump 594
 * @umplesource Umple_Code.ump 1780
 */
// line 594 "../../../../src/Umple.ump"
// line 1780 "../../../../src/Umple_Code.ump"
public class Multiplicity
{
  ...
  @umplesourcefile(line={1786},file={"Umple_Code.ump"},javaline={184},length={4})
   public void setRange(String lowerBound, String upperBound){
    minimum = lowerBound;
    maximum = upperBound;
  }

  @umplesourcefile(line={1792},file={"Umple_Code.ump"},javaline={190},length={5})
  ...
  @umplesourcefile(line={1799},file={"Umple_Code.ump"},javaline={197},length={5})
  ...
  @umplesourcefile(line={1806},file={"Umple_Code.ump"},javaline={204},length={30})
  ...
  @umplesourcefile(line={1838},file={"Umple_Code.ump"},javaline={236},length={10})
  ...
  @umplesourcefile(line={1850},file={"Umple_Code.ump"},javaline={248},length={10})
  ...
  @umplesourcefile(line={1862},file={"Umple_Code.ump"},javaline={260},length={10})
  ...
  @umplesourcefile(line={1874},file={"Umple_Code.ump"},javaline={272},length={3})
   public boolean isLowerBoundMany(){
    return getLowerBound() == -1;
  }

  @umplesourcefile(line={1879},file={"Umple_Code.ump"},javaline={277},length={3})
   public boolean isUpperBoundMany(){
    return getUpperBound() == -1;
  }

  @umplesourcefile(line={1884},file={"Umple_Code.ump"},javaline={282},length={3})
   public boolean isLowerBoundNumeric(){
    return getLowerBound() >= -1;
  }

  @umplesourcefile(line={1889},file={"Umple_Code.ump"},javaline={287},length={3})
   public boolean isUpperBoundNumeric(){
    return getUpperBound() >= -1;
  }

  @umplesourcefile(line={1894},file={"Umple_Code.ump"},javaline={292},length={3})
   public boolean isMany(){
    return getUpperBound() > 1 || getUpperBound() == -1;
  }

  @umplesourcefile(line={1899},file={"Umple_Code.ump"},javaline={297},length={3})
   public boolean isOne(){
    return getUpperBound() == 1;
  }

  @umplesourcefile(line={1904},file={"Umple_Code.ump"},javaline={302},length={17})
