 ...
 * @umplesource Umple_Code.ump 1531
 */
// line 570 "../../../../src/Umple.ump"
// line 1531 "../../../../src/Umple_Code.ump"
public class Multiplicity
{
  ...
  //------------------------
  //  @umplesourcefile(line={1533},file={"Umple_Code.ump"},javaline={196},length={137})
  @umplesourcefile(line={1534},file={"Umple_Code.ump"},javaline={197},length={5})
  ...
  @umplesourcefile(line={1540},file={"Umple_Code.ump"},javaline={204},length={6})
  ...
  @umplesourcefile(line={1547},file={"Umple_Code.ump"},javaline={212},length={6})
  ...
  @umplesourcefile(line={1554},file={"Umple_Code.ump"},javaline={220},length={31})
  ...
  @umplesourcefile(line={1586},file={"Umple_Code.ump"},javaline={253},length={11})
  ...
  @umplesourcefile(line={1598},file={"Umple_Code.ump"},javaline={266},length={11})
  ...
  @umplesourcefile(line={1610},file={"Umple_Code.ump"},javaline={279},length={11})
  ...
  @umplesourcefile(line={1622},file={"Umple_Code.ump"},javaline={292},length={4})
  public boolean isLowerBoundMany()
  {
    return getLowerBound() == -1;
  }

  @umplesourcefile(line={1627},file={"Umple_Code.ump"},javaline={298},length={4})
  public boolean isUpperBoundMany()
  {
    return getUpperBound() == -1;
  }

  @umplesourcefile(line={1632},file={"Umple_Code.ump"},javaline={304},length={4})
  public boolean isLowerBoundNumeric()
  {
    return getLowerBound() >= -1;
  }

  @umplesourcefile(line={1637},file={"Umple_Code.ump"},javaline={310},length={4})
  public boolean isUpperBoundNumeric()
  {
    return getUpperBound() >= -1;
  }

  @umplesourcefile(line={1642},file={"Umple_Code.ump"},javaline={316},length={4})
  public boolean isMany()
  {
    return getUpperBound() > 1 || getUpperBound() == -1;
  }

  @umplesourcefile(line={1647},file={"Umple_Code.ump"},javaline={322},length={4})
  public boolean isOne()
  {
    return getUpperBound() == 1;
  }

  @umplesourcefile(line={1652},file={"Umple_Code.ump"},javaline={328},length={18})
