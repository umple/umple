 ...
 * @umplesource Umple_Code.ump 1792
 */
// line 595 "../../../../src/Umple.ump"
// line 1792 "../../../../src/Umple_Code.ump"
public class Multiplicity
{
  ...
  @umplesourcefile(line={1798},file={"Umple_Code.ump"},javaline={190},length={4})
   public void setRange(String lowerBound, String upperBound){
    minimum = lowerBound;
    maximum = upperBound;
  }

  @umplesourcefile(line={1804},file={"Umple_Code.ump"},javaline={196},length={5})
  ...
  @umplesourcefile(line={1811},file={"Umple_Code.ump"},javaline={203},length={5})
  ...
  @umplesourcefile(line={1818},file={"Umple_Code.ump"},javaline={210},length={30})
  ...
  @umplesourcefile(line={1850},file={"Umple_Code.ump"},javaline={242},length={10})
  ...
  @umplesourcefile(line={1862},file={"Umple_Code.ump"},javaline={254},length={10})
  ...
  @umplesourcefile(line={1874},file={"Umple_Code.ump"},javaline={266},length={10})
  ...
  @umplesourcefile(line={1886},file={"Umple_Code.ump"},javaline={278},length={3})
   public boolean isLowerBoundMany(){
    return getLowerBound() == -1;
  }

  @umplesourcefile(line={1891},file={"Umple_Code.ump"},javaline={283},length={3})
   public boolean isUpperBoundMany(){
    return getUpperBound() == -1;
  }

  @umplesourcefile(line={1896},file={"Umple_Code.ump"},javaline={288},length={3})
   public boolean isLowerBoundNumeric(){
    return getLowerBound() >= -1;
  }

  @umplesourcefile(line={1901},file={"Umple_Code.ump"},javaline={293},length={3})
   public boolean isUpperBoundNumeric(){
    return getUpperBound() >= -1;
  }

  @umplesourcefile(line={1906},file={"Umple_Code.ump"},javaline={298},length={3})
   public boolean isMany(){
    return getUpperBound() > 1 || getUpperBound() == -1;
  }

  @umplesourcefile(line={1911},file={"Umple_Code.ump"},javaline={303},length={3})
   public boolean isOne(){
    return getUpperBound() == 1;
  }

  @umplesourcefile(line={1916},file={"Umple_Code.ump"},javaline={308},length={17})
