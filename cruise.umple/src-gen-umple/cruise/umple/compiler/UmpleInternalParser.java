 ...
 * @umplesource UmpleInternalParser_CodeTrait.ump 2
...
// line 2 "../../../../src/UmpleInternalParser_CodeTrait.ump"
...
public class UmpleInternalParser extends Parser implements UmpleParser
{
  ...
  @umplesourcefile(line={41},file={"UmpleInternalParser_Code.ump"},javaline={147},length={1})
  ...
  @umplesourcefile(line={75},file={"UmpleInternalParser.ump"},javaline={185},length={1})
  ...
  @umplesourcefile(line={20},file={"UmpleInternalParser_CodeTrace.ump"},javaline={438},length={1})
  ...
  @umplesourcefile(line={48,54,60}, file={"UmpleInternalParser.ump","UmpleInternalParser.ump","UmpleInternalParser.ump"}, javaline={509,515,521}, length={1,1,1})
  ...
  @umplesourcefile(line={49,55,61}, file={"UmpleInternalParser.ump","UmpleInternalParser.ump","UmpleInternalParser.ump"}, javaline={542,548,554}, length={1,1,1})
  ...
  @umplesourcefile(line={50,56,62}, file={"UmpleInternalParser.ump","UmpleInternalParser.ump","UmpleInternalParser.ump"}, javaline={575,581,587}, length={1,1,1})
  ...
  @umplesourcefile(line={51,57,63}, file={"UmpleInternalParser.ump","UmpleInternalParser.ump","UmpleInternalParser.ump"}, javaline={608,614,620}, length={1,1,1})
  ...
  @umplesourcefile(line={45},file={"UmpleInternalParser_Code.ump"},javaline={828},length={3})
   public  UmpleInternalParser(){
    this("UmpleInternalParser", new UmpleModel(null), new RuleBasedParser());
  }

  @umplesourcefile(line={50},file={"UmpleInternalParser_Code.ump"},javaline={833},length={3})
   public  UmpleInternalParser(UmpleModel aModel){
    this("UmpleInternalParser", aModel, new RuleBasedParser());
  }

  @umplesourcefile(line={55},file={"UmpleInternalParser_Code.ump"},javaline={838},length={26})
   private void init(){
  ...
  @umplesourcefile(line={82},file={"UmpleInternalParser_Code.ump"},javaline={866},length={6})
  ...
  @umplesourcefile(line={90},file={"UmpleInternalParser_Code.ump"},javaline={874},length={12})
   ...
   */
  @umplesourcefile(line={109},file={"UmpleInternalParser_Code.ump"},javaline={888},length={5})
   ...
   */
  @umplesourcefile(line={119},file={"UmpleInternalParser_Code.ump"},javaline={902},length={18})
   ...
   */
  @umplesourcefile(line={143},file={"UmpleInternalParser_Code.ump"},javaline={928},length={18})
   ...
   */
  @umplesourcefile(line={164},file={"UmpleInternalParser_Code.ump"},javaline={955},length={8})
   ...
   */
  @umplesourcefile(line={175},file={"UmpleInternalParser_Code.ump"},javaline={969},length={6})
   ...
   */
  @umplesourcefile(line={186},file={"UmpleInternalParser_Code.ump"},javaline={981},length={24})
   ...
   */
  @umplesourcefile(line={215},file={"UmpleInternalParser_Code.ump"},javaline={1012},length={35})
   ...
   */
  @umplesourcefile(line={255},file={"UmpleInternalParser_Code.ump"},javaline={1055},length={3})
   ...
   */
  @umplesourcefile(line={260},file={"UmpleInternalParser_Code.ump"},javaline={1064},length={16})
  ...
  @umplesourcefile(line={278},file={"UmpleInternalParser_Code.ump"},javaline={1086},length={81})
   ...
   */
  @umplesourcefile(line={23},file={"UmpleInternalParser_CodeCore.ump"},javaline={1169},length={19})
   ...
   */
  @umplesourcefile(line={47},file={"UmpleInternalParser_CodeCore.ump"},javaline={1194},length={3})
   ...
   */
  @umplesourcefile(line={52},file={"UmpleInternalParser_CodeCore.ump"},javaline={1204},length={50})
   ...
   */
  @umplesourcefile(line={106},file={"UmpleInternalParser_CodeCore.ump"},javaline={1260},length={11})
  ...
  @umplesourcefile(line={119},file={"UmpleInternalParser_CodeCore.ump"},javaline={1277},length={20})
   ...
   */
  @umplesourcefile(line={46},file={"UmpleInternalParser_CodeClass.ump"},javaline={1299},length={95})
   ...
   */
  @umplesourcefile(line={149},file={"UmpleInternalParser_CodeClass.ump"},javaline={1403},length={36})
   ...
   * @param analysisStep Used to determine whether or not things should be analyzed more than once (multi-pass).
   */
  @umplesourcefile(line={196},file={"UmpleInternalParser_CodeClass.ump"},javaline={1447},length={82})
   ...
   */
  @umplesourcefile(line={288},file={"UmpleInternalParser_CodeClass.ump"},javaline={1541},length={14})
   ...
   * @param token The current token which has been flagged to be a comment to analyze, containing its value.
   */
  @umplesourcefile(line={313},file={"UmpleInternalParser_CodeClass.ump"},javaline={1567},length={18})
   ...
   */
  @umplesourcefile(line={335},file={"UmpleInternalParser_CodeClass.ump"},javaline={1598},length={15})
  ...
  @umplesourcefile(line={352},file={"UmpleInternalParser_CodeClass.ump"},javaline={1619},length={4})
   private void postTokenInterfaceAnalysis(){
    addUnlinkedInterfaceExtends();
    checkExtendsForCyclesInterface();
  }

  @umplesourcefile(line={387},file={"UmpleInternalParser_CodeClass.ump"},javaline={1625},length={16})
  ...
  @umplesourcefile(line={405},file={"UmpleInternalParser_CodeClass.ump"},javaline={1643},length={17})
  ...
  @umplesourcefile(line={424},file={"UmpleInternalParser_CodeClass.ump"},javaline={1662},length={17})
   ...
   */
  @umplesourcefile(line={443},file={"UmpleInternalParser_CodeClass.ump"},javaline={1681},length={20})
   ...
   */
  @umplesourcefile(line={470},file={"UmpleInternalParser_CodeClass.ump"},javaline={1707},length={23})
   ...
   */
  @umplesourcefile(line={495},file={"UmpleInternalParser_CodeClass.ump"},javaline={1739},length={27})
   ...
   */
  @umplesourcefile(line={530},file={"UmpleInternalParser_CodeClass.ump"},javaline={1772},length={23})
   ...
   */
  @umplesourcefile(line={564},file={"UmpleInternalParser_CodeClass.ump"},javaline={1804},length={91})
   ...
   */
  @umplesourcefile(line={689},file={"UmpleInternalParser_CodeClass.ump"},javaline={1907},length={9})
   ...
   */
  @umplesourcefile(line={701},file={"UmpleInternalParser_CodeClass.ump"},javaline={1922},length={12})
  ...
  @umplesourcefile(line={714},file={"UmpleInternalParser_CodeClass.ump"},javaline={1940},length={9})
  ...
  @umplesourcefile(line={725},file={"UmpleInternalParser_CodeClass.ump"},javaline={1951},length={5})
  ...
  @umplesourcefile(line={732},file={"UmpleInternalParser_CodeClass.ump"},javaline={1958},length={23})
  ...
  @umplesourcefile(line={757},file={"UmpleInternalParser_CodeClass.ump"},javaline={1983},length={26})
  ...
  @umplesourcefile(line={785},file={"UmpleInternalParser_CodeClass.ump"},javaline={2011},length={46})
  ...
  @umplesourcefile(line={833},file={"UmpleInternalParser_CodeClass.ump"},javaline={2059},length={23})
  ...
  @umplesourcefile(line={858},file={"UmpleInternalParser_CodeClass.ump"},javaline={2084},length={19})
  ...
  @umplesourcefile(line={879},file={"UmpleInternalParser_CodeClass.ump"},javaline={2105},length={17})
  ...
  @umplesourcefile(line={897},file={"UmpleInternalParser_CodeClass.ump"},javaline={2124},length={13})
  ...
  @umplesourcefile(line={915},file={"UmpleInternalParser_CodeClass.ump"},javaline={2139},length={38})
  ...
  @umplesourcefile(line={955},file={"UmpleInternalParser_CodeClass.ump"},javaline={2179},length={3})
   private boolean isUmpleClass(String elementName){
    return (model.getUmpleInterface(elementName) != null) ? false: true;
  }

  @umplesourcefile(line={960},file={"UmpleInternalParser_CodeClass.ump"},javaline={2184},length={78})
  ...
  @umplesourcefile(line={1040},file={"UmpleInternalParser_CodeClass.ump"},javaline={2264},length={18})
   ...
   */
  @umplesourcefile(line={1068},file={"UmpleInternalParser_CodeClass.ump"},javaline={2284},length={33})
  ...
  @umplesourcefile(line={1103},file={"UmpleInternalParser_CodeClass.ump"},javaline={2328},length={110})
  ...
  @umplesourcefile(line={1215},file={"UmpleInternalParser_CodeClass.ump"},javaline={2440},length={36})
  ...
  @umplesourcefile(line={1253},file={"UmpleInternalParser_CodeClass.ump"},javaline={2478},length={59})
  ...
  @umplesourcefile(line={1314},file={"UmpleInternalParser_CodeClass.ump"},javaline={2539},length={94})
  ...
  @umplesourcefile(line={1409},file={"UmpleInternalParser_CodeClass.ump"},javaline={2635},length={10})
   ...
   */
  @umplesourcefile(line={1428},file={"UmpleInternalParser_CodeClass.ump"},javaline={2647},length={155})
   ...
   */
  @umplesourcefile(line={1592},file={"UmpleInternalParser_CodeClass.ump"},javaline={2812},length={38})
   ...
   */
  @umplesourcefile(line={1638},file={"UmpleInternalParser_CodeClass.ump"},javaline={2860},length={93})
  ...
  @umplesourcefile(line={1733},file={"UmpleInternalParser_CodeClass.ump"},javaline={2962},length={59})
  ...
  @umplesourcefile(line={1794},file={"UmpleInternalParser_CodeClass.ump"},javaline={3023},length={8})
  ...
  @umplesourcefile(line={1804},file={"UmpleInternalParser_CodeClass.ump"},javaline={3033},length={30})
  ...
  @umplesourcefile(line={1837},file={"UmpleInternalParser_CodeClass.ump"},javaline={3065},length={93})
  ...
  @umplesourcefile(line={1932},file={"UmpleInternalParser_CodeClass.ump"},javaline={3160},length={22})
  ...
  @umplesourcefile(line={1956},file={"UmpleInternalParser_CodeClass.ump"},javaline={3184},length={12})
  ...
  @umplesourcefile(line={1970},file={"UmpleInternalParser_CodeClass.ump"},javaline={3198},length={103})
   ...
   */
  @umplesourcefile(line={2081},file={"UmpleInternalParser_CodeClass.ump"},javaline={3303},length={47})
  ...
  @umplesourcefile(line={2131},file={"UmpleInternalParser_CodeClass.ump"},javaline={3360},length={17})
   ...
   */
  @umplesourcefile(line={2156},file={"UmpleInternalParser_CodeClass.ump"},javaline={3379},length={56})
   ...
   */
  @umplesourcefile(line={2221},file={"UmpleInternalParser_CodeClass.ump"},javaline={3444},length={44})
   ...
   */
  @umplesourcefile(line={2273},file={"UmpleInternalParser_CodeClass.ump"},javaline={3498},length={177})
  ...
  @umplesourcefile(line={2454},file={"UmpleInternalParser_CodeClass.ump"},javaline={3684},length={51})
  ...
  @umplesourcefile(line={2507},file={"UmpleInternalParser_CodeClass.ump"},javaline={3737},length={29})
  ...
  @umplesourcefile(line={2538},file={"UmpleInternalParser_CodeClass.ump"},javaline={3768},length={3})
   private Boolean isLazyRedundant(Boolean isLazy, String value){
    return (isLazy && value != null);
  }

  @umplesourcefile(line={2543},file={"UmpleInternalParser_CodeClass.ump"},javaline={3773},length={98})
  ...
  @umplesourcefile(line={2643},file={"UmpleInternalParser_CodeClass.ump"},javaline={3873},length={25})
  ...
  @umplesourcefile(line={6},file={"UmpleInternalParser_CodeTrait.ump"},javaline={3900},length={3})
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={13},file={"UmpleInternalParser_CodeTrait.ump"},javaline={3905},length={11})
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={28},file={"UmpleInternalParser_CodeTrait.ump"},javaline={3924},length={85})
...
//TODO 3 I should change the code of error    
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={117},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4017},length={18})
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={140},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4043},length={6})
...
//    analyzeDependentTokens(t,aTrait,analysisStep);
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={151},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4057},length={3})
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={157},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4068},length={84})
...
//TODO 5 I should change the code of error    
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={245},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4160},length={180})
...
//TODO 8 I should change the code of error    
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={429},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4348},length={26})
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={459},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4382},length={58})
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={521},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4448},length={24})
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={550},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4480},length={98})
   ...
   * ----------------------------------------------------------------------------
   */
  @umplesourcefile(line={651},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4586},length={53})
    ...
    for (UmpleClass uClass : getModel().getUmpleClasses()) {
			if (uClass.hasExtendsTraits()) {
				for (UmpleTrait uTrait : uClass.getExtendsTraits()) {
					...
					if (! uClass.getIsSingleton()) uClass.setIsSingleton(uTrait.getIsSingleton());
					
					//set abstract keyword
					if (! uClass.getIsAbstract())	uClass.setIsAbstract(uTrait.getIsAbstract());
					
					//set the comments
					for(Comment aComment : uTrait.getComments()) {
						uClass.addComment(aComment);
					}		
					
					//set the dependens
					for(Depend aDepend : uTrait.getDepends()) {
						uClass.addDepend(aDepend);
					}		
					
										
					// copy methods
					for(Method aMethod : uTrait.getMethods()) {
						uClass.addMethod(aMethod);
					}
										
					// copy Precondition
					for(Precondition aPrecondition : uTrait.getPreconditions()) {
						uClass.addPrecondition(aPrecondition);
					}	
					
					// copy Postcondition
					for(Postcondition aPostcondition : uTrait.getPostconditions()) {
						uClass.addPostcondition(aPostcondition);
					}						

					//copy attributes
					for(Attribute aAttribute : uTrait.getAttributes()) {
						//check for attributes which have already existed.
						uClass.addAttribute(aAttribute);
					}
					
					// copy Constraint
					for(Constraint aConstraint : uTrait.getConstraints()) {
						uClass.addConstraint(aConstraint);
					}						
  ...
  @umplesourcefile(line={705},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4647},length={7})
   private void postTokenTraitAnalysis(){
    addUnlinkedExtendTraits();
		if ( getParseResult().getWasSuccess() ) {
			checkTraitsNames();
			checkTheSameAttributes();
		}
  }

  @umplesourcefile(line={714},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4656},length={58})
      ...
      for (int i=0; i < extendsNames.size();i++){
        ...
        if (isUmpleTrait(extendName) ) {
		    ...
		    */     
			...
			setFailedPosition(pos, 2502, child.getName());
			return;
		}
      }
    }
   ...
   */
  @umplesourcefile(line={774},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4716},length={10})
   private void checkTraitsNames(){
  ...
  @umplesourcefile(line={784},file={"UmpleInternalParser_CodeTrait.ump"},javaline={4732},length={17})
   private void checkTheSameAttributes(){
    for(UmpleClass uClass : getModel().getUmpleClasses()) {
		  if (uClass.hasExtendsTraits()) {
			  for(UmpleTrait uTrait : uClass.getExtendsTraits())  {
				  for (Attribute utAtt : uTrait.getAttributes() ) {
					  for(Attribute ucAtt : uClass.getAttributes()) {
						  if (utAtt.getName().equals(ucAtt.getName())) {
							getParseResult().addErrorMessage(new ErrorMessage(2552,utAtt.getPosition(),utAtt.getName(),uClass.getName(),uTrait.getName()));
			          		return;
						  }
					  }
				  }
  ...
  @umplesourcefile(line={22},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4751},length={10})
  ...
  @umplesourcefile(line={34},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4763},length={11})
   ...
   */
  @umplesourcefile(line={53},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4776},length={10})
   ...
   */
  @umplesourcefile(line={66},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4795},length={56})
  ...
  @umplesourcefile(line={123},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4857},length={21})
  ...
  @umplesourcefile(line={146},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4880},length={19})
  ...
  @umplesourcefile(line={167},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4901},length={29})
  ...
  @umplesourcefile(line={198},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4932},length={29})
   ...
   * !cardinal && !all : for each number or name have a contains() ||, not currently implemented for a list of lists
   */
  @umplesourcefile(line={235},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4963},length={62})
  ...
  @umplesourcefile(line={299},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={5034},length={81})
  ...
  @umplesourcefile(line={382},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={5117},length={43})
   private List<ConstraintVariable> analyzeStringConstraintExpression(Token stringExpressionToken, UmpleClass aClass){
  	...
  	for(Token sub : stringExpressionSubtokens)
    {
      ...
      {
        rawLine.add(analyzeConstraintName(sub,aClass,true,mustBeTypes));
      }
  ...
  @umplesourcefile(line={427},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={5162},length={51})
   private List<ConstraintVariable> analyzeNumberConstraintExpression(Token numberExpressionToken, UmpleClass aClass){
    ...
    for(Token sub : numberExpressionSubtokens)
    {
      ...
      {
        rawLine.addAll(analyzeArithmeticCall(sub,aClass));
      }
      else if(sub.is("number"))
      {
        rawLine.add(analyzeConstraintNumber(sub));
  ...
  @umplesourcefile(line={480},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={5215},length={29})
   private List<ConstraintVariable> analyzeArithmeticCall(Token numberExpressionToken, UmpleClass aClass){
    List<ConstraintVariable> rawLine = new ArrayList<ConstraintVariable>();
	List<Token> numberExpressionSubtokens = numberExpressionToken.getSubTokens();
    for(Token sub : numberExpressionSubtokens)
    {
  ...
  @umplesourcefile(line={512},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={5246},length={167})
  ...
  @umplesourcefile(line={680},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={5415},length={3})
  ...
  @umplesourcefile(line={684},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={5420},length={16})
   ...
   */
  @umplesourcefile(line={29},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5438},length={7})
   ...
   */
  @umplesourcefile(line={39},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5451},length={11})
  ...
  @umplesourcefile(line={52},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5468},length={9})
  ...
  @umplesourcefile(line={63},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5479},length={5})
  ...
  @umplesourcefile(line={70},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5486},length={11})
  ...
  @umplesourcefile(line={83},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5499},length={9})
  ...
  @umplesourcefile(line={94},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5510},length={10})
  ...
  @umplesourcefile(line={106},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5522},length={10})
  ...
  @umplesourcefile(line={118},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5534},length={10})
   ...
   */
  @umplesourcefile(line={132},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5546},length={31})
  ...
  @umplesourcefile(line={165},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5583},length={20})
  ...
  @umplesourcefile(line={187},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5605},length={14})
   ...
   */
  @umplesourcefile(line={207},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5621},length={75})
  ...
  @umplesourcefile(line={285},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5703},length={4})
  ...
  @umplesourcefile(line={291},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5709},length={30})
  ...
  @umplesourcefile(line={324},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5741},length={31})
  ...
  @umplesourcefile(line={357},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5774},length={28})
  ...
  @umplesourcefile(line={387},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5804},length={20})
  ...
  @umplesourcefile(line={409},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5826},length={49})
  ...
  @umplesourcefile(line={460},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5877},length={78})
  ...
  @umplesourcefile(line={540},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5957},length={27})
  ...
  @umplesourcefile(line={568},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5986},length={28})
  ...
  @umplesourcefile(line={598},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={6016},length={143})
   ...
   * 
   */
  @umplesourcefile(line={29},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6161},length={27})
   ...
   */
  @umplesourcefile(line={60},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6196},length={11})
   ...
   */
  @umplesourcefile(line={75},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6213},length={150})
   ...
   */
  @umplesourcefile(line={228},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6369},length={14})
   ...
   */
  @umplesourcefile(line={245},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6389},length={64})
  ...
  @umplesourcefile(line={311},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6459},length={134})
  ...
  @umplesourcefile(line={447},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6595},length={12})
   ...
   */
  @umplesourcefile(line={463},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6609},length={16})
   ...
   */
  @umplesourcefile(line={482},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6632},length={25})
   ...
   */
  @umplesourcefile(line={511},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6663},length={43})
   ...
   */
  @umplesourcefile(line={557},file={"UmpleInternalParser_CodeTrace.ump"},javaline={6713},length={3})
   ...
   */
  @umplesourcefile(line={23},file={"UmpleInternalParser_CodeLayout.ump"},javaline={6722},length={3})
   ...
   * This method is available if needed
   */
  @umplesourcefile(line={29},file={"UmpleInternalParser_CodeLayout.ump"},javaline={6731},length={38})
   ...
   * Perform post token analysis on core elements of the Umple language
   */
  @umplesourcefile(line={70},file={"UmpleInternalParser_CodeLayout.ump"},javaline={6776},length={3})
   ...
   */
  @umplesourcefile(line={76},file={"UmpleInternalParser_CodeLayout.ump"},javaline={6785},length={53})
  ...
  //------------------------
  //  @umplesourcefile(line={355},file={"UmpleInternalParser_CodeClass.ump"},javaline={6846},length={56})
  @umplesourcefile(line={356},file={"UmpleInternalParser_CodeClass.ump"},javaline={6847},length={27})
...
//  @umplesourcefile(line={660},file={"UmpleInternalParser_CodeClass.ump"},javaline={6876},length={27})
  @umplesourcefile(line={661},file={"UmpleInternalParser_CodeClass.ump"},javaline={6877},length={24})
...
//  @umplesourcefile(line={24},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={6902},length={2})
