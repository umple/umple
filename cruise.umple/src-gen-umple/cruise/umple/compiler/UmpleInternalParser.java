...
public class UmpleInternalParser extends Parser implements UmpleParser
{
  ...
  @umplesourcefile(line={41},file={"UmpleInternalParser_Code.ump"},javaline={142},length={1})
  ...
  @umplesourcefile(line={72},file={"UmpleInternalParser.ump"},javaline={180},length={1})
  ...
  @umplesourcefile(line={20},file={"UmpleInternalParser_CodeTrace.ump"},javaline={420},length={1})
  ...
  @umplesourcefile(line={45,51,57}, file={"UmpleInternalParser.ump","UmpleInternalParser.ump","UmpleInternalParser.ump"}, javaline={491,497,503}, length={1,1,1})
  ...
  @umplesourcefile(line={46,52,58}, file={"UmpleInternalParser.ump","UmpleInternalParser.ump","UmpleInternalParser.ump"}, javaline={524,530,536}, length={1,1,1})
  ...
  @umplesourcefile(line={47,53,59}, file={"UmpleInternalParser.ump","UmpleInternalParser.ump","UmpleInternalParser.ump"}, javaline={557,563,569}, length={1,1,1})
  ...
  @umplesourcefile(line={48,54,60}, file={"UmpleInternalParser.ump","UmpleInternalParser.ump","UmpleInternalParser.ump"}, javaline={590,596,602}, length={1,1,1})
  ...
  @umplesourcefile(line={43},file={"UmpleInternalParser_Code.ump"},javaline={809},length={3})
   public  UmpleInternalParser(){
    this("UmpleInternalParser", new UmpleModel(null));
  }

  @umplesourcefile(line={48},file={"UmpleInternalParser_Code.ump"},javaline={814},length={3})
   public  UmpleInternalParser(UmpleModel aModel){
    this("UmpleInternalParser", aModel);
  }

  @umplesourcefile(line={53},file={"UmpleInternalParser_Code.ump"},javaline={819},length={25})
   private void init(){
  ...
  @umplesourcefile(line={80},file={"UmpleInternalParser_Code.ump"},javaline={846},length={3})
   public ParseResult parse(String ruleName, String input){
    return super.parse(ruleName,input);
  }

  @umplesourcefile(line={85},file={"UmpleInternalParser_Code.ump"},javaline={851},length={10})
   ...
   */
  @umplesourcefile(line={102},file={"UmpleInternalParser_Code.ump"},javaline={863},length={5})
   ...
   */
  @umplesourcefile(line={112},file={"UmpleInternalParser_Code.ump"},javaline={877},length={18})
   ...
   */
  @umplesourcefile(line={136},file={"UmpleInternalParser_Code.ump"},javaline={903},length={18})
   ...
   */
  @umplesourcefile(line={157},file={"UmpleInternalParser_Code.ump"},javaline={930},length={7})
   ...
   */
  @umplesourcefile(line={167},file={"UmpleInternalParser_Code.ump"},javaline={943},length={6})
   ...
   */
  @umplesourcefile(line={178},file={"UmpleInternalParser_Code.ump"},javaline={955},length={24})
   ...
   */
  @umplesourcefile(line={207},file={"UmpleInternalParser_Code.ump"},javaline={986},length={30})
   ...
   */
  @umplesourcefile(line={242},file={"UmpleInternalParser_Code.ump"},javaline={1024},length={47})
   ...
   */
  @umplesourcefile(line={292},file={"UmpleInternalParser_Code.ump"},javaline={1077},length={16})
  ...
  @umplesourcefile(line={310},file={"UmpleInternalParser_Code.ump"},javaline={1099},length={81})
   ...
   */
  @umplesourcefile(line={21},file={"UmpleInternalParser_CodeCore.ump"},javaline={1182},length={19})
   ...
   */
  @umplesourcefile(line={44},file={"UmpleInternalParser_CodeCore.ump"},javaline={1207},length={3})
   ...
   */
  @umplesourcefile(line={50},file={"UmpleInternalParser_CodeCore.ump"},javaline={1217},length={50})
   ...
   */
  @umplesourcefile(line={104},file={"UmpleInternalParser_CodeCore.ump"},javaline={1273},length={11})
  ...
  @umplesourcefile(line={117},file={"UmpleInternalParser_CodeCore.ump"},javaline={1290},length={20})
   ...
   */
  @umplesourcefile(line={44},file={"UmpleInternalParser_CodeClass.ump"},javaline={1312},length={91})
   ...
   */
  @umplesourcefile(line={143},file={"UmpleInternalParser_CodeClass.ump"},javaline={1412},length={36})
   ...
   * @param analysisStep Used to determine whether or not things should be analyzed more than once (multi-pass).
   */
  @umplesourcefile(line={190},file={"UmpleInternalParser_CodeClass.ump"},javaline={1456},length={83})
   ...
   */
  @umplesourcefile(line={283},file={"UmpleInternalParser_CodeClass.ump"},javaline={1551},length={14})
   ...
   * @param token The current token which has been flagged to be a comment to analyze, containing its value.
   */
  @umplesourcefile(line={308},file={"UmpleInternalParser_CodeClass.ump"},javaline={1577},length={18})
   ...
   */
  @umplesourcefile(line={329},file={"UmpleInternalParser_CodeClass.ump"},javaline={1608},length={15})
  ...
  @umplesourcefile(line={346},file={"UmpleInternalParser_CodeClass.ump"},javaline={1629},length={4})
   private void postTokenInterfaceAnalysis(){
    addUnlinkedInterfaceExtends();
    checkExtendsForCyclesInterface();
  }

  @umplesourcefile(line={381},file={"UmpleInternalParser_CodeClass.ump"},javaline={1635},length={16})
  ...
  @umplesourcefile(line={399},file={"UmpleInternalParser_CodeClass.ump"},javaline={1653},length={17})
  ...
  @umplesourcefile(line={418},file={"UmpleInternalParser_CodeClass.ump"},javaline={1672},length={17})
   ...
   */
  @umplesourcefile(line={438},file={"UmpleInternalParser_CodeClass.ump"},javaline={1691},length={20})
   ...
   */
  @umplesourcefile(line={465},file={"UmpleInternalParser_CodeClass.ump"},javaline={1717},length={23})
   ...
   */
  @umplesourcefile(line={490},file={"UmpleInternalParser_CodeClass.ump"},javaline={1749},length={27})
   ...
   */
  @umplesourcefile(line={524},file={"UmpleInternalParser_CodeClass.ump"},javaline={1782},length={23})
   ...
   */
  @umplesourcefile(line={558},file={"UmpleInternalParser_CodeClass.ump"},javaline={1814},length={91})
   ...
   */
  @umplesourcefile(line={683},file={"UmpleInternalParser_CodeClass.ump"},javaline={1917},length={9})
   ...
   */
  @umplesourcefile(line={695},file={"UmpleInternalParser_CodeClass.ump"},javaline={1932},length={12})
  ...
  @umplesourcefile(line={708},file={"UmpleInternalParser_CodeClass.ump"},javaline={1950},length={9})
  ...
  @umplesourcefile(line={719},file={"UmpleInternalParser_CodeClass.ump"},javaline={1961},length={5})
  ...
  @umplesourcefile(line={726},file={"UmpleInternalParser_CodeClass.ump"},javaline={1968},length={23})
  ...
  @umplesourcefile(line={751},file={"UmpleInternalParser_CodeClass.ump"},javaline={1993},length={26})
  ...
  @umplesourcefile(line={779},file={"UmpleInternalParser_CodeClass.ump"},javaline={2021},length={46})
  ...
  @umplesourcefile(line={827},file={"UmpleInternalParser_CodeClass.ump"},javaline={2069},length={23})
  ...
  @umplesourcefile(line={852},file={"UmpleInternalParser_CodeClass.ump"},javaline={2094},length={19})
  ...
  @umplesourcefile(line={873},file={"UmpleInternalParser_CodeClass.ump"},javaline={2115},length={17})
  ...
  @umplesourcefile(line={892},file={"UmpleInternalParser_CodeClass.ump"},javaline={2134},length={13})
  ...
  @umplesourcefile(line={909},file={"UmpleInternalParser_CodeClass.ump"},javaline={2149},length={38})
  ...
  @umplesourcefile(line={949},file={"UmpleInternalParser_CodeClass.ump"},javaline={2189},length={3})
   private boolean isUmpleClass(String elementName){
    return (model.getUmpleInterface(elementName) != null) ? false: true;
  }

  @umplesourcefile(line={954},file={"UmpleInternalParser_CodeClass.ump"},javaline={2194},length={50})
  ...
  @umplesourcefile(line={1006},file={"UmpleInternalParser_CodeClass.ump"},javaline={2246},length={18})
   ...
   */
  @umplesourcefile(line={1034},file={"UmpleInternalParser_CodeClass.ump"},javaline={2266},length={33})
  ...
  @umplesourcefile(line={1069},file={"UmpleInternalParser_CodeClass.ump"},javaline={2310},length={110})
  ...
  @umplesourcefile(line={1181},file={"UmpleInternalParser_CodeClass.ump"},javaline={2422},length={36})
  ...
  @umplesourcefile(line={1219},file={"UmpleInternalParser_CodeClass.ump"},javaline={2460},length={59})
  ...
  @umplesourcefile(line={1280},file={"UmpleInternalParser_CodeClass.ump"},javaline={2521},length={94})
  ...
  @umplesourcefile(line={1376},file={"UmpleInternalParser_CodeClass.ump"},javaline={2617},length={10})
   ...
   */
  @umplesourcefile(line={1394},file={"UmpleInternalParser_CodeClass.ump"},javaline={2629},length={119})
   ...
   */
  @umplesourcefile(line={1522},file={"UmpleInternalParser_CodeClass.ump"},javaline={2758},length={38})
   ...
   */
  @umplesourcefile(line={1568},file={"UmpleInternalParser_CodeClass.ump"},javaline={2806},length={37})
  ...
  @umplesourcefile(line={1607},file={"UmpleInternalParser_CodeClass.ump"},javaline={2852},length={8})
  ...
  @umplesourcefile(line={1617},file={"UmpleInternalParser_CodeClass.ump"},javaline={2862},length={30})
  ...
  @umplesourcefile(line={1650},file={"UmpleInternalParser_CodeClass.ump"},javaline={2894},length={89})
  ...
  @umplesourcefile(line={1741},file={"UmpleInternalParser_CodeClass.ump"},javaline={2985},length={22})
  ...
  @umplesourcefile(line={1765},file={"UmpleInternalParser_CodeClass.ump"},javaline={3009},length={12})
  ...
  @umplesourcefile(line={1779},file={"UmpleInternalParser_CodeClass.ump"},javaline={3023},length={98})
   ...
   */
  @umplesourcefile(line={1886},file={"UmpleInternalParser_CodeClass.ump"},javaline={3123},length={47})
  ...
  @umplesourcefile(line={1934},file={"UmpleInternalParser_CodeClass.ump"},javaline={3180},length={17})
   ...
   */
  @umplesourcefile(line={1960},file={"UmpleInternalParser_CodeClass.ump"},javaline={3199},length={56})
   ...
   */
  @umplesourcefile(line={2024},file={"UmpleInternalParser_CodeClass.ump"},javaline={3264},length={157})
  ...
  @umplesourcefile(line={2185},file={"UmpleInternalParser_CodeClass.ump"},javaline={3430},length={51})
  ...
  @umplesourcefile(line={2238},file={"UmpleInternalParser_CodeClass.ump"},javaline={3483},length={29})
  ...
  @umplesourcefile(line={2269},file={"UmpleInternalParser_CodeClass.ump"},javaline={3514},length={3})
   private Boolean isLazyRedundant(Boolean isLazy, String value){
    return (isLazy && value != null);
  }

  @umplesourcefile(line={2274},file={"UmpleInternalParser_CodeClass.ump"},javaline={3519},length={85})
  ...
  @umplesourcefile(line={2361},file={"UmpleInternalParser_CodeClass.ump"},javaline={3606},length={25})
  ...
  @umplesourcefile(line={20},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3633},length={10})
   ...
   */
  @umplesourcefile(line={38},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3645},length={10})
   ...
   */
  @umplesourcefile(line={51},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3664},length={53})
  ...
  @umplesourcefile(line={106},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3723},length={23})
  ...
  @umplesourcefile(line={130},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3748},length={23})
  ...
  @umplesourcefile(line={155},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3773},length={29})
  ...
  @umplesourcefile(line={186},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3804},length={33})
   ...
   * !cardinal && !all : for each number or name have a contains() ||, not currently implemented for a list of lists
   */
  @umplesourcefile(line={227},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3839},length={62})
  ...
  @umplesourcefile(line={291},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3910},length={81})
  ...
  @umplesourcefile(line={374},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3993},length={33})
  ...
  @umplesourcefile(line={409},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4028},length={47})
  ...
  @umplesourcefile(line={459},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4077},length={154})
  ...
  @umplesourcefile(line={614},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4233},length={3})
  ...
  @umplesourcefile(line={618},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4238},length={16})
   ...
   */
  @umplesourcefile(line={28},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4256},length={7})
   ...
   */
  @umplesourcefile(line={37},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4269},length={11})
  ...
  @umplesourcefile(line={50},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4286},length={9})
  ...
  @umplesourcefile(line={61},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4297},length={5})
  ...
  @umplesourcefile(line={68},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4304},length={11})
  ...
  @umplesourcefile(line={81},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4317},length={9})
  ...
  @umplesourcefile(line={92},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4328},length={10})
  ...
  @umplesourcefile(line={104},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4340},length={10})
  ...
  @umplesourcefile(line={116},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4352},length={10})
   ...
   */
  @umplesourcefile(line={130},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4364},length={31})
  ...
  @umplesourcefile(line={163},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4401},length={20})
  ...
  @umplesourcefile(line={185},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4423},length={14})
   ...
   */
  @umplesourcefile(line={205},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4439},length={75})
  ...
  @umplesourcefile(line={283},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4521},length={4})
  ...
  @umplesourcefile(line={289},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4527},length={30})
  ...
  @umplesourcefile(line={322},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4559},length={31})
  ...
  @umplesourcefile(line={355},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4592},length={28})
  ...
  @umplesourcefile(line={385},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4622},length={20})
  ...
  @umplesourcefile(line={407},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4644},length={49})
  ...
  @umplesourcefile(line={458},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4695},length={70})
  ...
  @umplesourcefile(line={530},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4767},length={27})
  ...
  @umplesourcefile(line={559},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4796},length={28})
  ...
  @umplesourcefile(line={588},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4826},length={143})
   ...
   * 
   */
  @umplesourcefile(line={26},file={"UmpleInternalParser_CodeTrace.ump"},javaline={4971},length={27})
   ...
   */
  @umplesourcefile(line={58},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5006},length={11})
   ...
   */
  @umplesourcefile(line={72},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5023},length={150})
   ...
   */
  @umplesourcefile(line={226},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5179},length={14})
   ...
   */
  @umplesourcefile(line={243},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5199},length={64})
  ...
  @umplesourcefile(line={309},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5269},length={134})
  ...
  @umplesourcefile(line={445},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5405},length={12})
   ...
   */
  @umplesourcefile(line={461},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5419},length={16})
   ...
   */
  @umplesourcefile(line={480},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5442},length={25})
   ...
   */
  @umplesourcefile(line={509},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5473},length={43})
   ...
   */
  @umplesourcefile(line={555},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5523},length={3})
   ...
   */
  @umplesourcefile(line={21},file={"UmpleInternalParser_CodeLayout.ump"},javaline={5532},length={3})
   ...
   * This method is available if needed
   */
  @umplesourcefile(line={27},file={"UmpleInternalParser_CodeLayout.ump"},javaline={5541},length={38})
   ...
   * Perform post token analysis on core elements of the Umple language
   */
  @umplesourcefile(line={68},file={"UmpleInternalParser_CodeLayout.ump"},javaline={5586},length={3})
   ...
   */
  @umplesourcefile(line={74},file={"UmpleInternalParser_CodeLayout.ump"},javaline={5595},length={53})
  ...
  //------------------------
  //  @umplesourcefile(line={351},file={"UmpleInternalParser_CodeClass.ump"},javaline={5657},length={56})
  @umplesourcefile(line={352},file={"UmpleInternalParser_CodeClass.ump"},javaline={5658},length={27})
...
//  @umplesourcefile(line={656},file={"UmpleInternalParser_CodeClass.ump"},javaline={5687},length={27})
  @umplesourcefile(line={657},file={"UmpleInternalParser_CodeClass.ump"},javaline={5688},length={23})
...
//  @umplesourcefile(line={24},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5713},length={2})
