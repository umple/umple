...
public class UmpleInternalParser extends Parser implements UmpleParser
{
   ...
   */
  @umplesourcefile(line={167},file={"UmpleInternalParser_Code.ump"},javaline={916},length={6})
   ...
   */
  @umplesourcefile(line={178},file={"UmpleInternalParser_Code.ump"},javaline={928},length={24})
   ...
   */
  @umplesourcefile(line={207},file={"UmpleInternalParser_Code.ump"},javaline={959},length={30})
   ...
   */
  @umplesourcefile(line={242},file={"UmpleInternalParser_Code.ump"},javaline={997},length={47})
   ...
   */
  @umplesourcefile(line={292},file={"UmpleInternalParser_Code.ump"},javaline={1050},length={16})
  ...
  @umplesourcefile(line={310},file={"UmpleInternalParser_Code.ump"},javaline={1072},length={81})
   ...
   */
  @umplesourcefile(line={21},file={"UmpleInternalParser_CodeCore.ump"},javaline={1155},length={19})
   ...
   */
  @umplesourcefile(line={44},file={"UmpleInternalParser_CodeCore.ump"},javaline={1180},length={3})
   ...
   */
  @umplesourcefile(line={50},file={"UmpleInternalParser_CodeCore.ump"},javaline={1190},length={50})
   ...
   */
  @umplesourcefile(line={104},file={"UmpleInternalParser_CodeCore.ump"},javaline={1246},length={11})
  ...
  @umplesourcefile(line={117},file={"UmpleInternalParser_CodeCore.ump"},javaline={1263},length={20})
   ...
   */
  @umplesourcefile(line={38},file={"UmpleInternalParser_CodeClass.ump"},javaline={1285},length={91})
   ...
   * @param analysisStep Used to determine whether or not things should be analyzed more than once (multi-pass).
   */
  @umplesourcefile(line={141},file={"UmpleInternalParser_CodeClass.ump"},javaline={1385},length={83})
   ...
   */
  @umplesourcefile(line={234},file={"UmpleInternalParser_CodeClass.ump"},javaline={1480},length={14})
   ...
   * @param token The current token which has been flagged to be a comment to analyze, containing its value.
   */
  @umplesourcefile(line={259},file={"UmpleInternalParser_CodeClass.ump"},javaline={1506},length={18})
   ...
   */
  @umplesourcefile(line={280},file={"UmpleInternalParser_CodeClass.ump"},javaline={1537},length={14})
  ...
  @umplesourcefile(line={296},file={"UmpleInternalParser_CodeClass.ump"},javaline={1557},length={4})
   private void postTokenInterfaceAnalysis(){
    addUnlinkedInterfaceExtends();
    checkExtendsForCyclesInterface();
  }

  @umplesourcefile(line={331},file={"UmpleInternalParser_CodeClass.ump"},javaline={1563},length={16})
  ...
  @umplesourcefile(line={349},file={"UmpleInternalParser_CodeClass.ump"},javaline={1581},length={17})
  ...
  @umplesourcefile(line={368},file={"UmpleInternalParser_CodeClass.ump"},javaline={1600},length={17})
   ...
   */
  @umplesourcefile(line={388},file={"UmpleInternalParser_CodeClass.ump"},javaline={1619},length={27})
   ...
   */
  @umplesourcefile(line={422},file={"UmpleInternalParser_CodeClass.ump"},javaline={1652},length={23})
   ...
   */
  @umplesourcefile(line={456},file={"UmpleInternalParser_CodeClass.ump"},javaline={1684},length={91})
   ...
   */
  @umplesourcefile(line={581},file={"UmpleInternalParser_CodeClass.ump"},javaline={1787},length={9})
   ...
   */
  @umplesourcefile(line={593},file={"UmpleInternalParser_CodeClass.ump"},javaline={1802},length={12})
  ...
  @umplesourcefile(line={606},file={"UmpleInternalParser_CodeClass.ump"},javaline={1820},length={9})
  ...
  @umplesourcefile(line={617},file={"UmpleInternalParser_CodeClass.ump"},javaline={1831},length={5})
  ...
  @umplesourcefile(line={624},file={"UmpleInternalParser_CodeClass.ump"},javaline={1838},length={23})
  ...
  @umplesourcefile(line={649},file={"UmpleInternalParser_CodeClass.ump"},javaline={1863},length={26})
  ...
  @umplesourcefile(line={677},file={"UmpleInternalParser_CodeClass.ump"},javaline={1891},length={46})
  ...
  @umplesourcefile(line={725},file={"UmpleInternalParser_CodeClass.ump"},javaline={1939},length={23})
  ...
  @umplesourcefile(line={750},file={"UmpleInternalParser_CodeClass.ump"},javaline={1964},length={19})
  ...
  @umplesourcefile(line={771},file={"UmpleInternalParser_CodeClass.ump"},javaline={1985},length={17})
  ...
  @umplesourcefile(line={790},file={"UmpleInternalParser_CodeClass.ump"},javaline={2004},length={13})
  ...
  @umplesourcefile(line={807},file={"UmpleInternalParser_CodeClass.ump"},javaline={2019},length={38})
  ...
  @umplesourcefile(line={847},file={"UmpleInternalParser_CodeClass.ump"},javaline={2059},length={3})
   private boolean isUmpleClass(String elementName){
    return (model.getUmpleInterface(elementName) != null) ? false: true;
  }

  @umplesourcefile(line={852},file={"UmpleInternalParser_CodeClass.ump"},javaline={2064},length={50})
  ...
  @umplesourcefile(line={904},file={"UmpleInternalParser_CodeClass.ump"},javaline={2116},length={18})
   ...
   */
  @umplesourcefile(line={932},file={"UmpleInternalParser_CodeClass.ump"},javaline={2136},length={33})
  ...
  @umplesourcefile(line={967},file={"UmpleInternalParser_CodeClass.ump"},javaline={2180},length={110})
  ...
  @umplesourcefile(line={1079},file={"UmpleInternalParser_CodeClass.ump"},javaline={2292},length={36})
  ...
  @umplesourcefile(line={1117},file={"UmpleInternalParser_CodeClass.ump"},javaline={2330},length={59})
  ...
  @umplesourcefile(line={1178},file={"UmpleInternalParser_CodeClass.ump"},javaline={2391},length={94})
  ...
  @umplesourcefile(line={1274},file={"UmpleInternalParser_CodeClass.ump"},javaline={2487},length={10})
   ...
   */
  @umplesourcefile(line={1292},file={"UmpleInternalParser_CodeClass.ump"},javaline={2499},length={104})
   ...
   */
  @umplesourcefile(line={1405},file={"UmpleInternalParser_CodeClass.ump"},javaline={2613},length={38})
   ...
   */
  @umplesourcefile(line={1451},file={"UmpleInternalParser_CodeClass.ump"},javaline={2661},length={37})
  ...
  @umplesourcefile(line={1490},file={"UmpleInternalParser_CodeClass.ump"},javaline={2707},length={8})
  ...
  @umplesourcefile(line={1500},file={"UmpleInternalParser_CodeClass.ump"},javaline={2717},length={30})
  ...
  @umplesourcefile(line={1533},file={"UmpleInternalParser_CodeClass.ump"},javaline={2749},length={89})
  ...
  @umplesourcefile(line={1624},file={"UmpleInternalParser_CodeClass.ump"},javaline={2840},length={22})
  ...
  @umplesourcefile(line={1648},file={"UmpleInternalParser_CodeClass.ump"},javaline={2864},length={12})
  ...
  @umplesourcefile(line={1662},file={"UmpleInternalParser_CodeClass.ump"},javaline={2878},length={98})
   ...
   */
  @umplesourcefile(line={1769},file={"UmpleInternalParser_CodeClass.ump"},javaline={2978},length={47})
  ...
  @umplesourcefile(line={1817},file={"UmpleInternalParser_CodeClass.ump"},javaline={3035},length={17})
   ...
   */
  @umplesourcefile(line={1843},file={"UmpleInternalParser_CodeClass.ump"},javaline={3054},length={50})
   ...
   */
  @umplesourcefile(line={1901},file={"UmpleInternalParser_CodeClass.ump"},javaline={3113},length={153})
  ...
  @umplesourcefile(line={2057},file={"UmpleInternalParser_CodeClass.ump"},javaline={3275},length={51})
  ...
  @umplesourcefile(line={2110},file={"UmpleInternalParser_CodeClass.ump"},javaline={3328},length={29})
  ...
  @umplesourcefile(line={2141},file={"UmpleInternalParser_CodeClass.ump"},javaline={3359},length={3})
   private Boolean isLazyRedundant(Boolean isLazy, String value){
    return (isLazy && value != null);
  }

  @umplesourcefile(line={2146},file={"UmpleInternalParser_CodeClass.ump"},javaline={3364},length={85})
  ...
  @umplesourcefile(line={2233},file={"UmpleInternalParser_CodeClass.ump"},javaline={3451},length={25})
  ...
  @umplesourcefile(line={20},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3478},length={10})
   ...
   */
  @umplesourcefile(line={38},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3490},length={10})
   ...
   */
  @umplesourcefile(line={51},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3509},length={53})
  ...
  @umplesourcefile(line={106},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3568},length={23})
  ...
  @umplesourcefile(line={130},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3593},length={23})
  ...
  @umplesourcefile(line={155},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3618},length={29})
  ...
  @umplesourcefile(line={186},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3649},length={33})
   ...
   * !cardinal && !all : for each number or name have a contains() ||, not currently implemented for a list of lists
   */
  @umplesourcefile(line={227},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3684},length={62})
  ...
  @umplesourcefile(line={291},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3755},length={81})
  ...
  @umplesourcefile(line={374},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3838},length={33})
  ...
  @umplesourcefile(line={409},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3873},length={47})
  ...
  @umplesourcefile(line={459},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={3922},length={154})
  ...
  @umplesourcefile(line={614},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4078},length={3})
  ...
  @umplesourcefile(line={618},file={"UmpleInternalParser_CodeConstraints.ump"},javaline={4083},length={16})
   ...
   */
  @umplesourcefile(line={28},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4101},length={7})
   ...
   */
  @umplesourcefile(line={37},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4114},length={11})
  ...
  @umplesourcefile(line={50},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4131},length={9})
  ...
  @umplesourcefile(line={61},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4142},length={5})
  ...
  @umplesourcefile(line={68},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4149},length={11})
  ...
  @umplesourcefile(line={81},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4162},length={9})
  ...
  @umplesourcefile(line={92},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4173},length={10})
  ...
  @umplesourcefile(line={104},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4185},length={10})
  ...
  @umplesourcefile(line={116},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4197},length={10})
   ...
   */
  @umplesourcefile(line={130},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4209},length={31})
  ...
  @umplesourcefile(line={163},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4246},length={20})
  ...
  @umplesourcefile(line={185},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4268},length={14})
   ...
   */
  @umplesourcefile(line={205},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4284},length={75})
  ...
  @umplesourcefile(line={283},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4366},length={4})
  ...
  @umplesourcefile(line={289},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4372},length={30})
  ...
  @umplesourcefile(line={322},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4404},length={31})
  ...
  @umplesourcefile(line={355},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4437},length={28})
  ...
  @umplesourcefile(line={385},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4467},length={20})
  ...
  @umplesourcefile(line={407},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4489},length={49})
  ...
  @umplesourcefile(line={458},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4540},length={70})
  ...
  @umplesourcefile(line={530},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4612},length={27})
  ...
  @umplesourcefile(line={559},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4641},length={28})
  ...
  @umplesourcefile(line={588},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={4671},length={143})
   ...
   * 
   */
  @umplesourcefile(line={26},file={"UmpleInternalParser_CodeTrace.ump"},javaline={4816},length={27})
   ...
   */
  @umplesourcefile(line={58},file={"UmpleInternalParser_CodeTrace.ump"},javaline={4851},length={11})
   ...
   */
  @umplesourcefile(line={72},file={"UmpleInternalParser_CodeTrace.ump"},javaline={4868},length={150})
   ...
   */
  @umplesourcefile(line={226},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5024},length={14})
   ...
   */
  @umplesourcefile(line={243},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5044},length={64})
  ...
  @umplesourcefile(line={309},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5114},length={134})
  ...
  @umplesourcefile(line={445},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5250},length={12})
   ...
   */
  @umplesourcefile(line={461},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5264},length={16})
   ...
   */
  @umplesourcefile(line={480},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5287},length={25})
   ...
   */
  @umplesourcefile(line={509},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5318},length={43})
   ...
   */
  @umplesourcefile(line={555},file={"UmpleInternalParser_CodeTrace.ump"},javaline={5368},length={3})
   ...
   */
  @umplesourcefile(line={21},file={"UmpleInternalParser_CodeLayout.ump"},javaline={5377},length={3})
   ...
   * This method is available if needed
   */
  @umplesourcefile(line={27},file={"UmpleInternalParser_CodeLayout.ump"},javaline={5386},length={38})
   ...
   * Perform post token analysis on core elements of the Umple language
   */
  @umplesourcefile(line={68},file={"UmpleInternalParser_CodeLayout.ump"},javaline={5431},length={3})
   ...
   */
  @umplesourcefile(line={74},file={"UmpleInternalParser_CodeLayout.ump"},javaline={5440},length={53})
  ...
  //------------------------
  //  @umplesourcefile(line={301},file={"UmpleInternalParser_CodeClass.ump"},javaline={5502},length={56})
  @umplesourcefile(line={302},file={"UmpleInternalParser_CodeClass.ump"},javaline={5503},length={27})
...
//  @umplesourcefile(line={554},file={"UmpleInternalParser_CodeClass.ump"},javaline={5532},length={27})
  @umplesourcefile(line={555},file={"UmpleInternalParser_CodeClass.ump"},javaline={5533},length={23})
...
//  @umplesourcefile(line={24},file={"UmpleInternalParser_CodeStateMachine.ump"},javaline={5558},length={2})
