...
public class UmpleModel implements Runnable
{
  ...
  @umplesourcefile(line={20},file={"Umple_Code.ump"},javaline={671},length={6})
  ...
  @umplesourcefile(line={28},file={"Umple_Code.ump"},javaline={679},length={9})
  ...
  @umplesourcefile(line={39},file={"Umple_Code.ump"},javaline={690},length={9})
  ...
  @umplesourcefile(line={50},file={"Umple_Code.ump"},javaline={701},length={10})
  ...
  @umplesourcefile(line={62},file={"Umple_Code.ump"},javaline={713},length={9})
  ...
  @umplesourcefile(line={73},file={"Umple_Code.ump"},javaline={724},length={3})
   public void addGenerate(String lang){
    addGenerate(new GenerateTarget(lang, null));
  }

  @umplesourcefile(line={83},file={"Umple_Code.ump"},javaline={729},length={12})
  ...
  @umplesourcefile(line={97},file={"Umple_Code.ump"},javaline={743},length={10})
  ...
  @umplesourcefile(line={109},file={"Umple_Code.ump"},javaline={755},length={3})
   public void clearGenerates(){
    generates.clear();
  }

  @umplesourcefile(line={114},file={"Umple_Code.ump"},javaline={760},length={10})
  ...
  @umplesourcefile(line={126},file={"Umple_Code.ump"},javaline={772},length={10})
  ...
  @umplesourcefile(line={139},file={"Umple_Code.ump"},javaline={784},length={10})
   ...
   */
  @umplesourcefile(line={154},file={"Umple_Code.ump"},javaline={796},length={24})
   public void run(){
   ...
   */
  @umplesourcefile(line={182},file={"Umple_Code.ump"},javaline={826},length={36})
  ...
  @umplesourcefile(line={221},file={"Umple_Code.ump"},javaline={868},length={13})
  ...
  @umplesourcefile(line={236},file={"Umple_Code.ump"},javaline={883},length={91})
  ...
  @umplesourcefile(line={329},file={"Umple_Code.ump"},javaline={976},length={59})
  ...
  //------------------------
  //  @umplesourcefile(line={77},file={"Umple_Code.ump"},javaline={1058},length={5})
  @umplesourcefile(line={78},file={"Umple_Code.ump"},javaline={1059},length={4})
