...
public class UmpleModel implements Runnable
{
  ...
  @umplesourcefile(line={22},file={"Umple_Code.ump"},javaline={779},length={6})
  ...
  @umplesourcefile(line={30},file={"Umple_Code.ump"},javaline={787},length={9})
  ...
  @umplesourcefile(line={41},file={"Umple_Code.ump"},javaline={798},length={9})
  ...
  @umplesourcefile(line={52},file={"Umple_Code.ump"},javaline={809},length={10})
  ...
  @umplesourcefile(line={64},file={"Umple_Code.ump"},javaline={821},length={9})
  ...
  @umplesourcefile(line={75},file={"Umple_Code.ump"},javaline={832},length={3})
   public void addGenerate(String lang){
    addGenerate(new GenerateTarget(lang, null));
  }

  @umplesourcefile(line={85},file={"Umple_Code.ump"},javaline={837},length={12})
  ...
  @umplesourcefile(line={99},file={"Umple_Code.ump"},javaline={851},length={10})
  ...
  @umplesourcefile(line={111},file={"Umple_Code.ump"},javaline={863},length={3})
   public void clearGenerates(){
    generates.clear();
  }

  @umplesourcefile(line={116},file={"Umple_Code.ump"},javaline={868},length={10})
  ...
  @umplesourcefile(line={128},file={"Umple_Code.ump"},javaline={880},length={10})
  ...
  @umplesourcefile(line={141},file={"Umple_Code.ump"},javaline={892},length={10})
   ...
   */
  @umplesourcefile(line={156},file={"Umple_Code.ump"},javaline={904},length={18})
   public void run(){
   ...
   */
  @umplesourcefile(line={179},file={"Umple_Code.ump"},javaline={928},length={17})
   ...
   */
  @umplesourcefile(line={202},file={"Umple_Code.ump"},javaline={951},length={19})
  ...
  @umplesourcefile(line={224},file={"Umple_Code.ump"},javaline={976},length={13})
  ...
  @umplesourcefile(line={239},file={"Umple_Code.ump"},javaline={991},length={91})
  ...
  @umplesourcefile(line={332},file={"Umple_Code.ump"},javaline={1084},length={59})
  ...
  @umplesourcefile(line={7},file={"Umple_Code_Trait.ump"},javaline={1145},length={10})
  ...
  @umplesourcefile(line={19},file={"Umple_Code_Trait.ump"},javaline={1157},length={9})
  ...
  //------------------------
  //  @umplesourcefile(line={77},file={"Umple_Code.ump"},javaline={1188},length={5})
  @umplesourcefile(line={78},file={"Umple_Code.ump"},javaline={1189},length={4})
