...
public class UmpleModel implements Runnable
{
  ...
  @umplesourcefile(line={20},file={"Umple_Code.ump"},javaline={663},length={6})
  ...
  @umplesourcefile(line={28},file={"Umple_Code.ump"},javaline={671},length={9})
  ...
  @umplesourcefile(line={39},file={"Umple_Code.ump"},javaline={682},length={9})
  ...
  @umplesourcefile(line={50},file={"Umple_Code.ump"},javaline={693},length={10})
  ...
  @umplesourcefile(line={62},file={"Umple_Code.ump"},javaline={705},length={9})
  ...
  @umplesourcefile(line={73},file={"Umple_Code.ump"},javaline={716},length={3})
   public void addGenerate(String lang){
    addGenerate(new GenerateTarget(lang, null));
  }

  @umplesourcefile(line={83},file={"Umple_Code.ump"},javaline={721},length={12})
  ...
  @umplesourcefile(line={97},file={"Umple_Code.ump"},javaline={735},length={10})
  ...
  @umplesourcefile(line={109},file={"Umple_Code.ump"},javaline={747},length={3})
   public void clearGenerates(){
    generates.clear();
  }

  @umplesourcefile(line={114},file={"Umple_Code.ump"},javaline={752},length={10})
  ...
  @umplesourcefile(line={126},file={"Umple_Code.ump"},javaline={764},length={10})
  ...
  @umplesourcefile(line={139},file={"Umple_Code.ump"},javaline={776},length={10})
   ...
   */
  @umplesourcefile(line={154},file={"Umple_Code.ump"},javaline={788},length={24})
   public void run(){
   ...
   */
  @umplesourcefile(line={182},file={"Umple_Code.ump"},javaline={818},length={36})
  ...
  @umplesourcefile(line={221},file={"Umple_Code.ump"},javaline={860},length={13})
  ...
  @umplesourcefile(line={236},file={"Umple_Code.ump"},javaline={875},length={91})
  ...
  @umplesourcefile(line={329},file={"Umple_Code.ump"},javaline={968},length={59})
