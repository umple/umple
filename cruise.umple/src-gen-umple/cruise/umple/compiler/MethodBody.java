 ...
 * @umplesource Umple_Code.ump 460
 */
// line 154 "../../../../src/Umple.ump"
// line 460 "../../../../src/Umple_Code.ump"
public class MethodBody
{
  ...
  @umplesourcefile(line={463},file={"Umple_Code.ump"},javaline={66},length={3})
   public  MethodBody(String aValue){
    this(new CodeBlock(aValue!=null ? aValue : ""));
  }

  @umplesourcefile(line={467},file={"Umple_Code.ump"},javaline={71},length={3})
   public String getExtraCode(String lang){
    return codeblock.getCode(lang);
  }

  @umplesourcefile(line={471},file={"Umple_Code.ump"},javaline={76},length={3})
   public void setExtraCode(String code){
    codeblock.setCode(code);
  }

  @umplesourcefile(line={475},file={"Umple_Code.ump"},javaline={81},length={3})
