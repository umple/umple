 ...
 * @umplesource Umple_Code.ump 1196
 * @umplesource Umple_Code_Trait.ump 75
 */
// line 554 "../../../../src/Umple.ump"
// line 1196 "../../../../src/Umple_Code.ump"
// line 75 "../../../../src/Umple_Code_Trait.ump"
public class Attribute extends UmpleVariable
{
  ...
  @umplesourcefile(line={573},file={"Umple.ump"},javaline={69},length={1})
  ...
  @umplesourcefile(line={1201},file={"Umple_Code.ump"},javaline={494},length={3})
   public boolean isConstant(){
    return "const".equals(getModifier());
  }

  @umplesourcefile(line={1206},file={"Umple_Code.ump"},javaline={499},length={3})
  ...
  @umplesourcefile(line={1212},file={"Umple_Code.ump"},javaline={504},length={6})
  ...
  @umplesourcefile(line={1220},file={"Umple_Code.ump"},javaline={512},length={3})
   public String getValue(){
    return codeblock.getCode()!=null ? codeblock.getCode() : super.getValue();
  }

  @umplesourcefile(line={1224},file={"Umple_Code.ump"},javaline={517},length={3})
   public void setValue(String lang, String code){
    codeblock.setCode(lang,code);
  }

  @umplesourcefile(line={1229},file={"Umple_Code.ump"},javaline={522},length={3})
   public String getFullType(){
    return this.getType() + (this.getIsList() ? "[]" : "");
  }

  @umplesourcefile(line={80},file={"Umple_Code_Trait.ump"},javaline={527},length={18})
