 ...
 * @umplesource Umple_Code.ump 1087
 */
...
public class Attribute extends UmpleVariable
{
  ...
  //------------------------
  //  @umplesourcefile(line={1088},file={"Umple_Code.ump"},javaline={455},length={28})
  @umplesourcefile(line={1089},file={"Umple_Code.ump"},javaline={456},length={4})
  public boolean isConstant()
  {
    return "const".equals(getModifier());
  }  

  @umplesourcefile(line={1094},file={"Umple_Code.ump"},javaline={462},length={4})
  ...
  @umplesourcefile(line={1100},file={"Umple_Code.ump"},javaline={469},length={7})
  ...
  @umplesourcefile(line={1108},file={"Umple_Code.ump"},javaline={478},length={4})
  public String getValue()
  {
    return codeblock.getCode()!=null ? codeblock.getCode() : super.getValue();
  }
  @umplesourcefile(line={1112},file={"Umple_Code.ump"},javaline={483},length={4})
