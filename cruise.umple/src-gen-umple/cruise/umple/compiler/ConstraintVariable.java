...
public class ConstraintVariable
{
  ...
  @umplesourcefile(line={1356},file={"Umple_Code.ump"},javaline={170},length={4})
  public ConstraintVariable isNotPrimitive(){
    isPrimitive = false;
    return this;
  }

  @umplesourcefile(line={1360},file={"Umple_Code.ump"},javaline={176},length={19})
  ...
  @umplesourcefile(line={1381},file={"Umple_Code.ump"},javaline={197},length={15})
