...
public class ConstraintVariable
{
  ...
  @umplesourcefile(line={239},file={"Umple.ump"},javaline={117},length={2})
  public boolean getIsAttribute()
  {
    return !"SYNTAX".equals(type)&&!"OPERATOR".equals(type);
  }

  @umplesourcefile(line={240},file={"Umple.ump"},javaline={122},length={2})
  ...
  @umplesourcefile(line={244},file={"Umple.ump"},javaline={144},length={6})
