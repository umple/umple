 ...
 * @umplesource Umple_Code.ump 1396
 */
// line 249 "../../../../src/Umple.ump"
// line 1396 "../../../../src/Umple_Code.ump"
public class Constraint extends CodeBlock
{
  ...
  @umplesourcefile(line={1401},file={"Umple_Code.ump"},javaline={152},length={42})
  ...
  @umplesourcefile(line={1444},file={"Umple_Code.ump"},javaline={196},length={23})
  ...
  @umplesourcefile(line={1468},file={"Umple_Code.ump"},javaline={221},length={3})
  public String getCode(){
    return StringFormatter.format(gen.translate((getNegated()?"Not":"")+format,this),inject);
  }

  @umplesourcefile(line={1473},file={"Umple_Code.ump"},javaline={226},length={23})
