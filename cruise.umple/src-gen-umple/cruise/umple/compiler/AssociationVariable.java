...
public class AssociationVariable extends UmpleVariable
{
  ...
  @umplesourcefile(line={1459},file={"Umple_Code.ump"},javaline={313},length={3})
   public boolean isReflexive(){
    return getRelatedAssociation() != null && getType().equals(getRelatedAssociation().getType());
  }

  @umplesourcefile(line={1464},file={"Umple_Code.ump"},javaline={318},length={3})
   public boolean isSymmetricReflexive(){
    return getRelatedAssociation() != null && "symmetricreflexive".equals(getModifier());
  }

  @umplesourcefile(line={1469},file={"Umple_Code.ump"},javaline={323},length={11})
  ...
  @umplesourcefile(line={1482},file={"Umple_Code.ump"},javaline={336},length={3})
   public static  int min(int first, int second){
    return first == -1 ? second : second == -1 ? first : Math.min(first, second);
  }

  @umplesourcefile(line={1487},file={"Umple_Code.ump"},javaline={341},length={3})
   public static  int max(int first, int second){
    return first == -1 ? first : second == -1 ? second : Math.max(first, second);
  }

  @umplesourcefile(line={1492},file={"Umple_Code.ump"},javaline={346},length={3})
   public boolean isMany(){
    return multiplicity.getUpperBound() == -1 || multiplicity.getUpperBound() > 1;
  }

  @umplesourcefile(line={1497},file={"Umple_Code.ump"},javaline={351},length={3})
   public boolean isOptionalN(){
    return multiplicity.getLowerBound() == 0 && multiplicity.getUpperBound() > 1;
  }

  @umplesourcefile(line={1502},file={"Umple_Code.ump"},javaline={356},length={3})
   public boolean isOne(){
    return multiplicity.getUpperBound() == 1;
  }

  @umplesourcefile(line={1507},file={"Umple_Code.ump"},javaline={361},length={3})
   public boolean isOnlyOne(){
    return multiplicity.getUpperBound() == 1 && multiplicity.getLowerBound() == 1;
  }

  @umplesourcefile(line={1512},file={"Umple_Code.ump"},javaline={366},length={3})
   public boolean isOptionalOne(){
    return multiplicity.getUpperBound() == 1 && multiplicity.getLowerBound() == 0;
  }

  @umplesourcefile(line={1517},file={"Umple_Code.ump"},javaline={371},length={3})
   public boolean isOptionalMany(){
    return multiplicity.getLowerBound() == 0 && isMany();
  }

  @umplesourcefile(line={1522},file={"Umple_Code.ump"},javaline={376},length={3})
   public boolean isUpperBounded(){
    return multiplicity.getUpperBound() >= 0;
  }

  @umplesourcefile(line={1527},file={"Umple_Code.ump"},javaline={381},length={3})
   public boolean isN(){
    return multiplicity.getLowerBound() > 1 && multiplicity.getLowerBound() == multiplicity.getUpperBound();
  }

  @umplesourcefile(line={1532},file={"Umple_Code.ump"},javaline={386},length={3})
   public boolean isMN(){
    return multiplicity.getLowerBound() > 0 && (multiplicity.getUpperBound() > multiplicity.getLowerBound() || multiplicity.getUpperBound() == -1);
  }

  @umplesourcefile(line={1537},file={"Umple_Code.ump"},javaline={391},length={3})
   public boolean isMStar(){
    return multiplicity.getLowerBound() > 0 && multiplicity.getUpperBound() == -1;
  }

  @umplesourcefile(line={1542},file={"Umple_Code.ump"},javaline={396},length={3})
   public boolean isStar(){
    return multiplicity.getUpperBound() == -1;
  }

  @umplesourcefile(line={1547},file={"Umple_Code.ump"},javaline={401},length={3})
   public boolean isMandatory(){
    return multiplicity.getLowerBound() > 0;
  }

  @umplesourcefile(line={1552},file={"Umple_Code.ump"},javaline={406},length={3})
   public boolean isMandatoryOne(){
    return multiplicity.getLowerBound() == 1 && multiplicity.getUpperBound() == 1;
  }

  @umplesourcefile(line={1557},file={"Umple_Code.ump"},javaline={411},length={3})
   public boolean isMandatoryMany(){
    return multiplicity.getLowerBound() > 0 && isMany();
  }

  @umplesourcefile(line={1562},file={"Umple_Code.ump"},javaline={416},length={12})
  ...
  @umplesourcefile(line={1576},file={"Umple_Code.ump"},javaline={430},length={9})
  ...
  @umplesourcefile(line={1587},file={"Umple_Code.ump"},javaline={441},length={3})
   public boolean isSorted(){
    return !priority.equals("");
  }

  @umplesourcefile(line={1592},file={"Umple_Code.ump"},javaline={446},length={19})
  ...
  @umplesourcefile(line={1613},file={"Umple_Code.ump"},javaline={467},length={11})
