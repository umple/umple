 ...
 * @umplesource Umple_Code.ump 1618
 */
// line 572 "../../../../src/Umple.ump"
// line 1618 "../../../../src/Umple_Code.ump"
public class AssociationVariable extends UmpleVariable
{
  ...
  @umplesourcefile(line={1623},file={"Umple_Code.ump"},javaline={314},length={3})
   public boolean isReflexive(){
    return getRelatedAssociation() != null && getType().equals(getRelatedAssociation().getType());
  }

  @umplesourcefile(line={1628},file={"Umple_Code.ump"},javaline={319},length={3})
   public boolean isSymmetricReflexive(){
    return getRelatedAssociation() != null && "symmetricreflexive".equals(getModifier());
  }

  @umplesourcefile(line={1633},file={"Umple_Code.ump"},javaline={324},length={11})
  ...
  @umplesourcefile(line={1646},file={"Umple_Code.ump"},javaline={337},length={3})
   public static  int min(int first, int second){
    return first == -1 ? second : second == -1 ? first : Math.min(first, second);
  }

  @umplesourcefile(line={1651},file={"Umple_Code.ump"},javaline={342},length={3})
   public static  int max(int first, int second){
    return first == -1 ? first : second == -1 ? second : Math.max(first, second);
  }

  @umplesourcefile(line={1656},file={"Umple_Code.ump"},javaline={347},length={3})
   public boolean isMany(){
    return multiplicity.getUpperBound() == -1 || multiplicity.getUpperBound() > 1;
  }

  @umplesourcefile(line={1661},file={"Umple_Code.ump"},javaline={352},length={3})
   public boolean isOptionalN(){
    return multiplicity.getLowerBound() == 0 && multiplicity.getUpperBound() > 1;
  }

  @umplesourcefile(line={1666},file={"Umple_Code.ump"},javaline={357},length={3})
   public boolean isOne(){
    return multiplicity.getUpperBound() == 1;
  }

  @umplesourcefile(line={1671},file={"Umple_Code.ump"},javaline={362},length={3})
   public boolean isOnlyOne(){
    return multiplicity.getUpperBound() == 1 && multiplicity.getLowerBound() == 1;
  }

  @umplesourcefile(line={1676},file={"Umple_Code.ump"},javaline={367},length={3})
   public boolean isOptionalOne(){
    return multiplicity.getUpperBound() == 1 && multiplicity.getLowerBound() == 0;
  }

  @umplesourcefile(line={1681},file={"Umple_Code.ump"},javaline={372},length={3})
   public boolean isOptionalMany(){
    return multiplicity.getLowerBound() == 0 && isMany();
  }

  @umplesourcefile(line={1686},file={"Umple_Code.ump"},javaline={377},length={3})
   public boolean isUpperBounded(){
    return multiplicity.getUpperBound() >= 0;
  }

  @umplesourcefile(line={1691},file={"Umple_Code.ump"},javaline={382},length={3})
   public boolean isN(){
    return multiplicity.getLowerBound() > 1 && multiplicity.getLowerBound() == multiplicity.getUpperBound();
  }

  @umplesourcefile(line={1696},file={"Umple_Code.ump"},javaline={387},length={3})
   public boolean isMN(){
    return multiplicity.getLowerBound() > 0 && (multiplicity.getUpperBound() > multiplicity.getLowerBound() || multiplicity.getUpperBound() == -1);
  }

  @umplesourcefile(line={1701},file={"Umple_Code.ump"},javaline={392},length={3})
   public boolean isMStar(){
    return multiplicity.getLowerBound() > 0 && multiplicity.getUpperBound() == -1;
  }

  @umplesourcefile(line={1706},file={"Umple_Code.ump"},javaline={397},length={3})
   public boolean isStar(){
    return multiplicity.getUpperBound() == -1;
  }

  @umplesourcefile(line={1711},file={"Umple_Code.ump"},javaline={402},length={3})
   public boolean isMandatory(){
    return multiplicity.getLowerBound() > 0;
  }

  @umplesourcefile(line={1716},file={"Umple_Code.ump"},javaline={407},length={3})
   public boolean isMandatoryOne(){
    return multiplicity.getLowerBound() == 1 && multiplicity.getUpperBound() == 1;
  }

  @umplesourcefile(line={1721},file={"Umple_Code.ump"},javaline={412},length={3})
   public boolean isMandatoryMany(){
    return multiplicity.getLowerBound() > 0 && isMany();
  }

  @umplesourcefile(line={1726},file={"Umple_Code.ump"},javaline={417},length={12})
  ...
  @umplesourcefile(line={1740},file={"Umple_Code.ump"},javaline={431},length={9})
  ...
  @umplesourcefile(line={1751},file={"Umple_Code.ump"},javaline={442},length={3})
   public boolean isSorted(){
    return !priority.equals("");
  }

  @umplesourcefile(line={1756},file={"Umple_Code.ump"},javaline={447},length={19})
  ...
  @umplesourcefile(line={1777},file={"Umple_Code.ump"},javaline={468},length={11})
