 ...
 * In Umple_Code.ump: Methods for testing various complex properties
 * @umplesource Umple.ump 645
 * @umplesource Umple_Code.ump 1616
 */
// line 645 "../../../../src/Umple.ump"
// line 1616 "../../../../src/Umple_Code.ump"
public class AssociationVariable extends UmpleVariable
{
  ...
  @umplesourcefile(line={660},file={"Umple.ump"},javaline={167},length={1})
  ...
  @umplesourcefile(line={658},file={"Umple.ump"},javaline={259},length={1})
  ...
  @umplesourcefile(line={1621},file={"Umple_Code.ump"},javaline={351},length={3})
   public boolean isReflexive(){
    return getRelatedAssociation() != null && getType().equals(getRelatedAssociation().getType());
  }

  @umplesourcefile(line={1626},file={"Umple_Code.ump"},javaline={356},length={3})
   public boolean isSymmetricReflexive(){
    return getRelatedAssociation() != null && "symmetricreflexive".equals(getModifier());
  }

  @umplesourcefile(line={1631},file={"Umple_Code.ump"},javaline={361},length={11})
  ...
  @umplesourcefile(line={1644},file={"Umple_Code.ump"},javaline={374},length={3})
   public static  int min(int first, int second){
    return first == -1 ? second : second == -1 ? first : Math.min(first, second);
  }

  @umplesourcefile(line={1649},file={"Umple_Code.ump"},javaline={379},length={3})
   public static  int max(int first, int second){
    return first == -1 ? first : second == -1 ? second : Math.max(first, second);
  }

  @umplesourcefile(line={1654},file={"Umple_Code.ump"},javaline={384},length={3})
   public boolean isMany(){
    return multiplicity.getUpperBound() == -1 || multiplicity.getUpperBound() > 1;
  }

  @umplesourcefile(line={1659},file={"Umple_Code.ump"},javaline={389},length={3})
   public boolean isOptionalN(){
    return multiplicity.getLowerBound() == 0 && multiplicity.getUpperBound() > 1;
  }

  @umplesourcefile(line={1664},file={"Umple_Code.ump"},javaline={394},length={3})
   public boolean isOne(){
    return multiplicity.getUpperBound() == 1;
  }

  @umplesourcefile(line={1669},file={"Umple_Code.ump"},javaline={399},length={3})
   public boolean isOnlyOne(){
    return multiplicity.getUpperBound() == 1 && multiplicity.getLowerBound() == 1;
  }

  @umplesourcefile(line={1674},file={"Umple_Code.ump"},javaline={404},length={3})
   public boolean isOptionalOne(){
    return multiplicity.getUpperBound() == 1 && multiplicity.getLowerBound() == 0;
  }

  @umplesourcefile(line={1679},file={"Umple_Code.ump"},javaline={409},length={3})
   public boolean isOptionalMany(){
    return multiplicity.getLowerBound() == 0 && isMany();
  }

  @umplesourcefile(line={1684},file={"Umple_Code.ump"},javaline={414},length={3})
   public boolean isUpperBounded(){
    return multiplicity.getUpperBound() >= 0;
  }

  @umplesourcefile(line={1689},file={"Umple_Code.ump"},javaline={419},length={3})
   public boolean isN(){
    return multiplicity.getLowerBound() > 1 && multiplicity.getLowerBound() == multiplicity.getUpperBound();
  }

  @umplesourcefile(line={1694},file={"Umple_Code.ump"},javaline={424},length={3})
   public boolean isMN(){
    return multiplicity.getLowerBound() > 0 && (multiplicity.getUpperBound() > multiplicity.getLowerBound() || multiplicity.getUpperBound() == -1);
  }

  @umplesourcefile(line={1699},file={"Umple_Code.ump"},javaline={429},length={3})
   public boolean isMStar(){
    return multiplicity.getLowerBound() > 0 && multiplicity.getUpperBound() == -1;
  }

  @umplesourcefile(line={1704},file={"Umple_Code.ump"},javaline={434},length={3})
   public boolean isStar(){
    return multiplicity.getUpperBound() == -1;
  }

  @umplesourcefile(line={1709},file={"Umple_Code.ump"},javaline={439},length={3})
   public boolean isMandatory(){
    return multiplicity.getLowerBound() > 0;
  }

  @umplesourcefile(line={1714},file={"Umple_Code.ump"},javaline={444},length={3})
   public boolean isMandatoryOne(){
    return multiplicity.getLowerBound() == 1 && multiplicity.getUpperBound() == 1;
  }

  @umplesourcefile(line={1719},file={"Umple_Code.ump"},javaline={449},length={3})
   public boolean isMandatoryMany(){
    return multiplicity.getLowerBound() > 0 && isMany();
  }

  @umplesourcefile(line={1724},file={"Umple_Code.ump"},javaline={454},length={12})
  ...
  @umplesourcefile(line={1738},file={"Umple_Code.ump"},javaline={468},length={9})
  ...
  @umplesourcefile(line={1749},file={"Umple_Code.ump"},javaline={479},length={3})
   public boolean isSorted(){
    return !priority.equals("");
  }

  @umplesourcefile(line={1754},file={"Umple_Code.ump"},javaline={484},length={19})
  ...
  @umplesourcefile(line={1775},file={"Umple_Code.ump"},javaline={505},length={11})
