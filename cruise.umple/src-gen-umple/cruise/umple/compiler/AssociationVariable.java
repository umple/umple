 ...
 * @umplesource Umple.ump 554
 * @umplesource Umple_Code.ump 1598
 */
// line 554 "../../../../src/Umple.ump"
// line 1598 "../../../../src/Umple_Code.ump"
public class AssociationVariable extends UmpleVariable
{
  ...
  @umplesourcefile(line={568},file={"Umple.ump"},javaline={153},length={1})
  public boolean setRelatedAssociation(AssociationVariable aNewRelatedAssociation)
  {
    boolean wasSet = false;
    // line 568 "../../../../src/Umple.ump"
  ...
  @umplesourcefile(line={566},file={"Umple.ump"},javaline={245},length={1})
  public boolean setUmpleClass(UmpleClass aUmpleClass)
  {
    boolean wasSet = false;
    // line 566 "../../../../src/Umple.ump"
  ...
  @umplesourcefile(line={1600},file={"Umple_Code.ump"},javaline={313},length={3})
   public boolean isReflexive(){
    return getRelatedAssociation() != null && getType().equals(getRelatedAssociation().getType());
  }

  @umplesourcefile(line={1605},file={"Umple_Code.ump"},javaline={318},length={3})
   public boolean isSymmetricReflexive(){
    return getRelatedAssociation() != null && "symmetricreflexive".equals(getModifier());
  }

  @umplesourcefile(line={1610},file={"Umple_Code.ump"},javaline={323},length={11})
  ...
  @umplesourcefile(line={1623},file={"Umple_Code.ump"},javaline={336},length={3})
   public static  int min(int first, int second){
    return first == -1 ? second : second == -1 ? first : Math.min(first, second);
  }

  @umplesourcefile(line={1628},file={"Umple_Code.ump"},javaline={341},length={3})
   public static  int max(int first, int second){
    return first == -1 ? first : second == -1 ? second : Math.max(first, second);
  }

  @umplesourcefile(line={1633},file={"Umple_Code.ump"},javaline={346},length={3})
   public boolean isMany(){
    return multiplicity.getUpperBound() == -1 || multiplicity.getUpperBound() > 1;
  }

  @umplesourcefile(line={1638},file={"Umple_Code.ump"},javaline={351},length={3})
   public boolean isOptionalN(){
    return multiplicity.getLowerBound() == 0 && multiplicity.getUpperBound() > 1;
  }

  @umplesourcefile(line={1643},file={"Umple_Code.ump"},javaline={356},length={3})
   public boolean isOne(){
    return multiplicity.getUpperBound() == 1;
  }

  @umplesourcefile(line={1648},file={"Umple_Code.ump"},javaline={361},length={3})
   public boolean isOnlyOne(){
    return multiplicity.getUpperBound() == 1 && multiplicity.getLowerBound() == 1;
  }

  @umplesourcefile(line={1653},file={"Umple_Code.ump"},javaline={366},length={3})
   public boolean isOptionalOne(){
    return multiplicity.getUpperBound() == 1 && multiplicity.getLowerBound() == 0;
  }

  @umplesourcefile(line={1658},file={"Umple_Code.ump"},javaline={371},length={3})
   public boolean isOptionalMany(){
    return multiplicity.getLowerBound() == 0 && isMany();
  }

  @umplesourcefile(line={1663},file={"Umple_Code.ump"},javaline={376},length={3})
   public boolean isUpperBounded(){
    return multiplicity.getUpperBound() >= 0;
  }

  @umplesourcefile(line={1668},file={"Umple_Code.ump"},javaline={381},length={3})
   public boolean isN(){
    return multiplicity.getLowerBound() > 1 && multiplicity.getLowerBound() == multiplicity.getUpperBound();
  }

  @umplesourcefile(line={1673},file={"Umple_Code.ump"},javaline={386},length={3})
   public boolean isMN(){
    return multiplicity.getLowerBound() > 0 && (multiplicity.getUpperBound() > multiplicity.getLowerBound() || multiplicity.getUpperBound() == -1);
  }

  @umplesourcefile(line={1678},file={"Umple_Code.ump"},javaline={391},length={3})
   public boolean isMStar(){
    return multiplicity.getLowerBound() > 0 && multiplicity.getUpperBound() == -1;
  }

  @umplesourcefile(line={1683},file={"Umple_Code.ump"},javaline={396},length={3})
   public boolean isStar(){
    return multiplicity.getUpperBound() == -1;
  }

  @umplesourcefile(line={1688},file={"Umple_Code.ump"},javaline={401},length={3})
   public boolean isMandatory(){
    return multiplicity.getLowerBound() > 0;
  }

  @umplesourcefile(line={1693},file={"Umple_Code.ump"},javaline={406},length={3})
   public boolean isMandatoryOne(){
    return multiplicity.getLowerBound() == 1 && multiplicity.getUpperBound() == 1;
  }

  @umplesourcefile(line={1698},file={"Umple_Code.ump"},javaline={411},length={3})
   public boolean isMandatoryMany(){
    return multiplicity.getLowerBound() > 0 && isMany();
  }

  @umplesourcefile(line={1703},file={"Umple_Code.ump"},javaline={416},length={12})
  ...
  @umplesourcefile(line={1717},file={"Umple_Code.ump"},javaline={430},length={9})
  ...
  @umplesourcefile(line={1728},file={"Umple_Code.ump"},javaline={441},length={3})
   public boolean isSorted(){
    return !priority.equals("");
  }

  @umplesourcefile(line={1733},file={"Umple_Code.ump"},javaline={446},length={19})
  ...
  @umplesourcefile(line={1754},file={"Umple_Code.ump"},javaline={467},length={11})
