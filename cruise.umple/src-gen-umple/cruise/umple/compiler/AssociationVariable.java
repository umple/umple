 ...
 * @umplesource Umple_Code.ump 1601
 */
// line 554 "../../../../src/Umple.ump"
// line 1601 "../../../../src/Umple_Code.ump"
public class AssociationVariable extends UmpleVariable
{
  ...
  @umplesourcefile(line={1603},file={"Umple_Code.ump"},javaline={313},length={3})
   public boolean isReflexive(){
    return getRelatedAssociation() != null && getType().equals(getRelatedAssociation().getType());
  }

  @umplesourcefile(line={1608},file={"Umple_Code.ump"},javaline={318},length={3})
   public boolean isSymmetricReflexive(){
    return getRelatedAssociation() != null && "symmetricreflexive".equals(getModifier());
  }

  @umplesourcefile(line={1613},file={"Umple_Code.ump"},javaline={323},length={11})
  ...
  @umplesourcefile(line={1626},file={"Umple_Code.ump"},javaline={336},length={3})
   public static  int min(int first, int second){
    return first == -1 ? second : second == -1 ? first : Math.min(first, second);
  }

  @umplesourcefile(line={1631},file={"Umple_Code.ump"},javaline={341},length={3})
   public static  int max(int first, int second){
    return first == -1 ? first : second == -1 ? second : Math.max(first, second);
  }

  @umplesourcefile(line={1636},file={"Umple_Code.ump"},javaline={346},length={3})
   public boolean isMany(){
    return multiplicity.getUpperBound() == -1 || multiplicity.getUpperBound() > 1;
  }

  @umplesourcefile(line={1641},file={"Umple_Code.ump"},javaline={351},length={3})
   public boolean isOptionalN(){
    return multiplicity.getLowerBound() == 0 && multiplicity.getUpperBound() > 1;
  }

  @umplesourcefile(line={1646},file={"Umple_Code.ump"},javaline={356},length={3})
   public boolean isOne(){
    return multiplicity.getUpperBound() == 1;
  }

  @umplesourcefile(line={1651},file={"Umple_Code.ump"},javaline={361},length={3})
   public boolean isOnlyOne(){
    return multiplicity.getUpperBound() == 1 && multiplicity.getLowerBound() == 1;
  }

  @umplesourcefile(line={1656},file={"Umple_Code.ump"},javaline={366},length={3})
   public boolean isOptionalOne(){
    return multiplicity.getUpperBound() == 1 && multiplicity.getLowerBound() == 0;
  }

  @umplesourcefile(line={1661},file={"Umple_Code.ump"},javaline={371},length={3})
   public boolean isOptionalMany(){
    return multiplicity.getLowerBound() == 0 && isMany();
  }

  @umplesourcefile(line={1666},file={"Umple_Code.ump"},javaline={376},length={3})
   public boolean isUpperBounded(){
    return multiplicity.getUpperBound() >= 0;
  }

  @umplesourcefile(line={1671},file={"Umple_Code.ump"},javaline={381},length={3})
   public boolean isN(){
    return multiplicity.getLowerBound() > 1 && multiplicity.getLowerBound() == multiplicity.getUpperBound();
  }

  @umplesourcefile(line={1676},file={"Umple_Code.ump"},javaline={386},length={3})
   public boolean isMN(){
    return multiplicity.getLowerBound() > 0 && (multiplicity.getUpperBound() > multiplicity.getLowerBound() || multiplicity.getUpperBound() == -1);
  }

  @umplesourcefile(line={1681},file={"Umple_Code.ump"},javaline={391},length={3})
   public boolean isMStar(){
    return multiplicity.getLowerBound() > 0 && multiplicity.getUpperBound() == -1;
  }

  @umplesourcefile(line={1686},file={"Umple_Code.ump"},javaline={396},length={3})
   public boolean isStar(){
    return multiplicity.getUpperBound() == -1;
  }

  @umplesourcefile(line={1691},file={"Umple_Code.ump"},javaline={401},length={3})
   public boolean isMandatory(){
    return multiplicity.getLowerBound() > 0;
  }

  @umplesourcefile(line={1696},file={"Umple_Code.ump"},javaline={406},length={3})
   public boolean isMandatoryOne(){
    return multiplicity.getLowerBound() == 1 && multiplicity.getUpperBound() == 1;
  }

  @umplesourcefile(line={1701},file={"Umple_Code.ump"},javaline={411},length={3})
   public boolean isMandatoryMany(){
    return multiplicity.getLowerBound() > 0 && isMany();
  }

  @umplesourcefile(line={1706},file={"Umple_Code.ump"},javaline={416},length={12})
  ...
  @umplesourcefile(line={1720},file={"Umple_Code.ump"},javaline={430},length={9})
  ...
  @umplesourcefile(line={1731},file={"Umple_Code.ump"},javaline={441},length={3})
   public boolean isSorted(){
    return !priority.equals("");
  }

  @umplesourcefile(line={1736},file={"Umple_Code.ump"},javaline={446},length={19})
  ...
  @umplesourcefile(line={1757},file={"Umple_Code.ump"},javaline={467},length={11})
