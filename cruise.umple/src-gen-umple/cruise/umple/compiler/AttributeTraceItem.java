...
public class AttributeTraceItem implements TraceItem
{
  ...
  @umplesourcefile(line={179},file={"Trace_Code.ump"},javaline={375},length={3})
  public Attribute getAttribute(int index){
    return (Attribute)getUmpleVariable(index);
  }

  @umplesourcefile(line={182},file={"Trace_Code.ump"},javaline={380},length={3})
  public Boolean addAttribute(Attribute attr){
    return addUmpleVariable(attr);
  }

  @umplesourcefile(line={185},file={"Trace_Code.ump"},javaline={385},length={3})
   public Boolean getIsPre(){
    return conditionallyWhere;
  }

  @umplesourcefile(line={188},file={"Trace_Code.ump"},javaline={390},length={3})
   ...
   */
  @umplesourcefile(line={200},file={"Trace_Code.ump"},javaline={395},length={77})
   ...
   */
  @umplesourcefile(line={282},file={"Trace_Code.ump"},javaline={483},length={3})
