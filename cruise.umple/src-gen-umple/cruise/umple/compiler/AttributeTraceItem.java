...
public class AttributeTraceItem implements TraceItem
{
  ...
  @umplesourcefile(line={179},file={"Trace_Code.ump"},javaline={376},length={3})
  public Attribute getAttribute(int index){
    return (Attribute)getUmpleVariable(index);
  }

  @umplesourcefile(line={182},file={"Trace_Code.ump"},javaline={381},length={3})
  public Boolean addAttribute(Attribute attr){
    return addUmpleVariable(attr);
  }

  @umplesourcefile(line={185},file={"Trace_Code.ump"},javaline={386},length={3})
   public Boolean getIsPre(){
    return conditionallyWhere;
  }

  @umplesourcefile(line={188},file={"Trace_Code.ump"},javaline={391},length={3})
   ...
   */
  @umplesourcefile(line={200},file={"Trace_Code.ump"},javaline={396},length={77})
   ...
   */
  @umplesourcefile(line={282},file={"Trace_Code.ump"},javaline={484},length={3})
