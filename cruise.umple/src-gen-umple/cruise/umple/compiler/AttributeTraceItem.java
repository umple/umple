...
public class AttributeTraceItem implements TraceItem
{
  ...
  @umplesourcefile(line={184},file={"Trace_Code.ump"},javaline={384},length={3})
   public Boolean getIsPre(){
    return conditionallyWhere;
  }

  @umplesourcefile(line={187},file={"Trace_Code.ump"},javaline={389},length={3})
   ...
   */
  @umplesourcefile(line={199},file={"Trace_Code.ump"},javaline={394},length={77})
   ...
   */
  @umplesourcefile(line={280},file={"Trace_Code.ump"},javaline={482},length={3})
