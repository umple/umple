...
public class McCabeMetricVisitor extends UmpleModelVisitor
{
  ...
  @umplesourcefile(line={376},file={"Generator_CodeAnalysis.ump"},javaline={52},length={4})
  ...
  @umplesourcefile(line={384},file={"Generator_CodeAnalysis.ump"},javaline={160},length={5})
  public void done(){
    addTableEntry(null);
  ...
  @umplesourcefile(line={390},file={"Generator_CodeAnalysis.ump"},javaline={167},length={11})
   ...
   * Umple Classifiers
   */
  @umplesourcefile(line={403},file={"Generator_CodeAnalysis.ump"},javaline={180},length={3})
  public void visit(UmpleClass umpleClass){
    addTableEntry(umpleClass);
  }

  @umplesourcefile(line={406},file={"Generator_CodeAnalysis.ump"},javaline={189},length={3})
  public void visit(UmpleInterface umpleInterface){
    addTableEntry(umpleInterface);
  }

  @umplesourcefile(line={409},file={"Generator_CodeAnalysis.ump"},javaline={194},length={3})
   ...
   * Attributes
   */
  @umplesourcefile(line={414},file={"Generator_CodeAnalysis.ump"},javaline={199},length={5})
  ...
  @umplesourcefile(line={419},file={"Generator_CodeAnalysis.ump"},javaline={210},length={3})
  public void visit(Key keyO){
    cur_conditions++;
  }

  @umplesourcefile(line={422},file={"Generator_CodeAnalysis.ump"},javaline={215},length={3})
  public void visit(ConstraintVariable cnstVar){
    cur_conditions++;
  }

  @umplesourcefile(line={425},file={"Generator_CodeAnalysis.ump"},javaline={220},length={3})
   ...
   * Logical
   */
  @umplesourcefile(line={430},file={"Generator_CodeAnalysis.ump"},javaline={225},length={3})
  public void visit(Condition cond){
    cur_conditions++;
  }

  @umplesourcefile(line={433},file={"Generator_CodeAnalysis.ump"},javaline={234},length={3})
  public void visit(Precondition pre){
    cur_conditions++;
  }

  @umplesourcefile(line={436},file={"Generator_CodeAnalysis.ump"},javaline={239},length={3})
   ...
   * Aspect
   */
  @umplesourcefile(line={441},file={"Generator_CodeAnalysis.ump"},javaline={244},length={3})
   ...
   * Association
   */
  @umplesourcefile(line={446},file={"Generator_CodeAnalysis.ump"},javaline={253},length={3})
   ...
   * Statemachine
   */
  @umplesourcefile(line={454},file={"Generator_CodeAnalysis.ump"},javaline={262},length={3})
  public void visit(StateMachine sm){
    cur_conditions++; // Default case
  }

  @umplesourcefile(line={457},file={"Generator_CodeAnalysis.ump"},javaline={274},length={3})
  public void visit(State state){
    cur_conditions++; // Each state is a case statement
  }

  @umplesourcefile(line={460},file={"Generator_CodeAnalysis.ump"},javaline={279},length={5})
  ...
  @umplesourcefile(line={465},file={"Generator_CodeAnalysis.ump"},javaline={286},length={3})
  public void visit(Guard guard){
    cur_conditions++;
  }

  @umplesourcefile(line={468},file={"Generator_CodeAnalysis.ump"},javaline={291},length={24})
  ...
  @umplesourcefile(line={492},file={"Generator_CodeAnalysis.ump"},javaline={317},length={3})
   ...
   * Trace
   */
  @umplesourcefile(line={497},file={"Generator_CodeAnalysis.ump"},javaline={322},length={11})
  ...
  @umplesourcefile(line={508},file={"Generator_CodeAnalysis.ump"},javaline={339},length={3})
  public void visit(TraceCase traceCase){
    cur_conditions++;
  }

  @umplesourcefile(line={511},file={"Generator_CodeAnalysis.ump"},javaline={344},length={3})
