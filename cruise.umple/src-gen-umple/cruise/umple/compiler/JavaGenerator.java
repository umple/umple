...
public class JavaGenerator extends SuperCodeGenerator implements CodeTranslator
{
  ...
  @umplesourcefile(line={102},file={"Generator_CodeJava.ump"},javaline={47},length={26})
  ...
  @umplesourcefile(line={131},file={"Generator_CodeJava.ump"},javaline={75},length={13})
  ...
  @umplesourcefile(line={146},file={"Generator_CodeJava.ump"},javaline={90},length={3})
   public boolean isNullable(UmpleVariable av){
    return !UmpleToPrimitiveMap.containsKey(av.getType());
  }

  @umplesourcefile(line={151},file={"Generator_CodeJava.ump"},javaline={95},length={3})
   public String relatedTranslate(String name, AssociationVariable av){
    return translate(name,av.getRelatedAssociation());
  }

  @umplesourcefile(line={156},file={"Generator_CodeJava.ump"},javaline={100},length={35})
  ...
  @umplesourcefile(line={193},file={"Generator_CodeJava.ump"},javaline={137},length={96})
      ...
      for (StateMachine nsm : sm.getNestedStateMachines())
      {
        for (Event event : nsm.getEvents())
        {
          for(int i=0; i<eveList.size(); i++){
            if(eveList.get(i)== event.getName()){
              sameEventName=true;
            }
          }
  ...
  @umplesourcefile(line={291},file={"Generator_CodeJava.ump"},javaline={235},length={23})
  ...
  @umplesourcefile(line={316},file={"Generator_CodeJava.ump"},javaline={260},length={11})
  ...
  @umplesourcefile(line={329},file={"Generator_CodeJava.ump"},javaline={273},length={19})
  ...
  @umplesourcefile(line={350},file={"Generator_CodeJava.ump"},javaline={294},length={24})
  ...
  @umplesourcefile(line={376},file={"Generator_CodeJava.ump"},javaline={320},length={15})
  ...
  @umplesourcefile(line={393},file={"Generator_CodeJava.ump"},javaline={337},length={9})
  ...
  @umplesourcefile(line={404},file={"Generator_CodeJava.ump"},javaline={348},length={10})
  ...
  @umplesourcefile(line={416},file={"Generator_CodeJava.ump"},javaline={360},length={15})
  ...
  @umplesourcefile(line={433},file={"Generator_CodeJava.ump"},javaline={377},length={3})
   public String translate(String keyName, Attribute av){
    return translate(keyName,av,av.getIsList());
  }

  @umplesourcefile(line={438},file={"Generator_CodeJava.ump"},javaline={382},length={3})
   ...
   */
  @umplesourcefile(line={444},file={"Generator_CodeJava.ump"},javaline={387},length={20})
   ...
   */
  @umplesourcefile(line={467},file={"Generator_CodeJava.ump"},javaline={413},length={3})
   public String translateInterfaceType(String type){
    return typeOf(type);
  }

  @umplesourcefile(line={472},file={"Generator_CodeJava.ump"},javaline={422},length={110})
  ...
  @umplesourcefile(line={584},file={"Generator_CodeJava.ump"},javaline={534},length={16})
   public void prepare(){
  ...
  @umplesourcefile(line={602},file={"Generator_CodeJava.ump"},javaline={552},length={26})
  ...
  @umplesourcefile(line={630},file={"Generator_CodeJava.ump"},javaline={580},length={16})
   ...
   * ------------------------
   */
  @umplesourcefile(line={653},file={"Generator_CodeJava.ump"},javaline={598},length={3})
   private String getUpperCaseName(String name){
    return StringFormatter.toPascalCase(name);
  }

  @umplesourcefile(line={658},file={"Generator_CodeJava.ump"},javaline={609},length={11})
  ...
  @umplesourcefile(line={671},file={"Generator_CodeJava.ump"},javaline={622},length={3})
  ...
  @umplesourcefile(line={676},file={"Generator_CodeJava.ump"},javaline={627},length={3})
  ...
  @umplesourcefile(line={681},file={"Generator_CodeJava.ump"},javaline={632},length={163})
...
//    prepareAllTraces(this,getModel(),aClass,lookups);
  ...
  @umplesourcefile(line={848},file={"Generator_CodeJava.ump"},javaline={797},length={24})
  ...
  @umplesourcefile(line={874},file={"Generator_CodeJava.ump"},javaline={823},length={13})
  ...
  @umplesourcefile(line={889},file={"Generator_CodeJava.ump"},javaline={838},length={9})
  ...
  @umplesourcefile(line={900},file={"Generator_CodeJava.ump"},javaline={849},length={38})
  ...
  @umplesourcefile(line={940},file={"Generator_CodeJava.ump"},javaline={889},length={141})
  ...
  @umplesourcefile(line={1084},file={"Generator_CodeJava.ump"},javaline={1032},length={21})
  ...
  @umplesourcefile(line={1107},file={"Generator_CodeJava.ump"},javaline={1055},length={36})
  ...
  @umplesourcefile(line={1145},file={"Generator_CodeJava.ump"},javaline={1093},length={41})
  ...
  @umplesourcefile(line={1188},file={"Generator_CodeJava.ump"},javaline={1136},length={23})
  ...
  @umplesourcefile(line={1213},file={"Generator_CodeJava.ump"},javaline={1161},length={33})
  ...
  @umplesourcefile(line={1248},file={"Generator_CodeJava.ump"},javaline={1196},length={3})
   private String nameOf(Attribute av){
    return nameOf(av.getName(),av.getIsList());
  }

  @umplesourcefile(line={1253},file={"Generator_CodeJava.ump"},javaline={1201},length={4})
   private String nameOf(AssociationVariable av){
    boolean hasMultiple = av.isMany();
    return nameOf(av.getName(),hasMultiple);
  }

  @umplesourcefile(line={1259},file={"Generator_CodeJava.ump"},javaline={1207},length={4})
   private static  String typeOf(UmpleVariable var){
    String aType = var.getType();
    return typeOf(aType);
  }

  @umplesourcefile(line={1291},file={"Generator_CodeJava.ump"},javaline={1213},length={35})
  ...
  @umplesourcefile(line={33},file={"Generator.ump"},javaline={1249},length={128})
  ...
  @umplesourcefile(line={34},file={"Generator.ump"},javaline={1379},length={10})
  ...
  //------------------------
  //  @umplesourcefile(line={15},file={"Generator_CodeJava.ump"},javaline={1394},length={117})
  private static Map<String,String> UpperCaseSingularLookupMap ;
//  @umplesourcefile(line={16},file={"Generator_CodeJava.ump"},javaline={1396},length={115})
  private static Map<String,String> UpperCasePluralLookupMap ;
//  @umplesourcefile(line={17},file={"Generator_CodeJava.ump"},javaline={1398},length={113})
  private static Map<String,String> AsIsSingularLookupMap ;
//  @umplesourcefile(line={18},file={"Generator_CodeJava.ump"},javaline={1400},length={111})
  private static Map<String,String> AsIsPluralLookupMap ;
//  @umplesourcefile(line={19},file={"Generator_CodeJava.ump"},javaline={1402},length={109})
  private static List<String> OneOrManyLookup ;

//  @umplesourcefile(line={21},file={"Generator_CodeJava.ump"},javaline={1405},length={106})
  static 
  {
...
//  @umplesourcefile(line={1262},file={"Generator_CodeJava.ump"},javaline={1484},length={27})
  @umplesourcefile(line={1263},file={"Generator_CodeJava.ump"},javaline={1485},length={26})
