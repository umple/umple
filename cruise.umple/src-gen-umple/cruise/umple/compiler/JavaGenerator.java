...
public class JavaGenerator implements CodeGenerator,CodeTranslator
{
  ...
  @umplesourcefile(line={119},file={"Generator_CodeJava.ump"},javaline={196},length={29})
  ...
  @umplesourcefile(line={150},file={"Generator_CodeJava.ump"},javaline={228},length={14})
  ...
  @umplesourcefile(line={165},file={"Generator_CodeJava.ump"},javaline={244},length={16})
  ...
  @umplesourcefile(line={182},file={"Generator_CodeJava.ump"},javaline={262},length={4})
  public boolean isNullable(UmpleVariable av)
  {
    return !UmpleToJavaPrimitiveMap.containsKey(av.getType());
  }
  
  @umplesourcefile(line={187},file={"Generator_CodeJava.ump"},javaline={268},length={4})
  public String relatedTranslate(String name, AssociationVariable av)
  {
    return translate(name,av.getRelatedAssociation());
  }
  
  @umplesourcefile(line={192},file={"Generator_CodeJava.ump"},javaline={274},length={71})
  ...
  @umplesourcefile(line={278},file={"Generator_CodeJava.ump"},javaline={361},length={36})
  ...
  @umplesourcefile(line={315},file={"Generator_CodeJava.ump"},javaline={399},length={59})
  ...
  @umplesourcefile(line={375},file={"Generator_CodeJava.ump"},javaline={460},length={24})
  ...
  @umplesourcefile(line={400},file={"Generator_CodeJava.ump"},javaline={486},length={12})
  ...
  @umplesourcefile(line={413},file={"Generator_CodeJava.ump"},javaline={500},length={16})
  ...
  @umplesourcefile(line={430},file={"Generator_CodeJava.ump"},javaline={518},length={9})
  ...
  @umplesourcefile(line={440},file={"Generator_CodeJava.ump"},javaline={529},length={25})
  ...
  @umplesourcefile(line={466},file={"Generator_CodeJava.ump"},javaline={556},length={16})
  ...
  @umplesourcefile(line={483},file={"Generator_CodeJava.ump"},javaline={574},length={10})
  ...
  @umplesourcefile(line={494},file={"Generator_CodeJava.ump"},javaline={586},length={11})
  ...
  @umplesourcefile(line={506},file={"Generator_CodeJava.ump"},javaline={599},length={16})
  ...
  @umplesourcefile(line={523},file={"Generator_CodeJava.ump"},javaline={617},length={4})
  public String translate(String keyName, Attribute av)
  {
    return translate(keyName,av,av.getIsList());
  }
  
  @umplesourcefile(line={528},file={"Generator_CodeJava.ump"},javaline={623},length={4})
  public String translate(String keyName, AssociationVariable av)
  {
    return translate(keyName,av,av.isMany());
  }
  
  @umplesourcefile(line={533},file={"Generator_CodeJava.ump"},javaline={629},length={99})
  ...
  @umplesourcefile(line={633},file={"Generator_CodeJava.ump"},javaline={730},length={17})
  public void prepare()
  {
  ...
  @umplesourcefile(line={651},file={"Generator_CodeJava.ump"},javaline={749},length={23})
  ...
  @umplesourcefile(line={675},file={"Generator_CodeJava.ump"},javaline={774},length={17})
  ...
  @umplesourcefile(line={698},file={"Generator_CodeJava.ump"},javaline={798},length={4})
  private String getUpperCaseName(String name)
  {
    return StringFormatter.toPascalCase(name);
  }  
  
  @umplesourcefile(line={703},file={"Generator_CodeJava.ump"},javaline={804},length={111})
...
//    prepareAllTraces(this,model,aClass,lookups);
  ...
  @umplesourcefile(line={884},file={"Generator_CodeJava.ump"},javaline={986},length={25})
  ...
  @umplesourcefile(line={910},file={"Generator_CodeJava.ump"},javaline={1013},length={14})
  ...
  @umplesourcefile(line={925},file={"Generator_CodeJava.ump"},javaline={1029},length={10})
  ...
  @umplesourcefile(line={936},file={"Generator_CodeJava.ump"},javaline={1041},length={39})
  ...
  @umplesourcefile(line={976},file={"Generator_CodeJava.ump"},javaline={1082},length={142})
  ...
  @umplesourcefile(line={1120},file={"Generator_CodeJava.ump"},javaline={1227},length={22})
  ...
  @umplesourcefile(line={1143},file={"Generator_CodeJava.ump"},javaline={1251},length={37})
  ...
  @umplesourcefile(line={1181},file={"Generator_CodeJava.ump"},javaline={1290},length={35})
  ...
  @umplesourcefile(line={1217},file={"Generator_CodeJava.ump"},javaline={1327},length={24})
  ...
  @umplesourcefile(line={1242},file={"Generator_CodeJava.ump"},javaline={1353},length={34})
  ...
  @umplesourcefile(line={1277},file={"Generator_CodeJava.ump"},javaline={1389},length={4})
  private String nameOf(Attribute av)
  {
    return nameOf(av.getName(),av.getIsList());
  }
  
  @umplesourcefile(line={1282},file={"Generator_CodeJava.ump"},javaline={1395},length={5})
  ...
  @umplesourcefile(line={1288},file={"Generator_CodeJava.ump"},javaline={1402},length={5})
  ...
  @umplesourcefile(line={1294},file={"Generator_CodeJava.ump"},javaline={1409},length={26})
