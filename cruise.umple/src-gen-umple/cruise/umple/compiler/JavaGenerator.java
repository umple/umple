...
//    prepareAllTraces(this,model,aClass,lookups);
  ...
  static void processPeriod(TraceDirective traceDirective, CodeTranslator t, String template, Attribute attr, String period) 
  {
  ...
  static void processOccurrences(TraceDirective traceDirective, CodeTranslator t, String template, Attribute attr) 
  {
