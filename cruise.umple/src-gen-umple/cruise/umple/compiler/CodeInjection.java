...
public class CodeInjection
{
  ...
  @umplesourcefile(line={543},file={"Umple_Code.ump"},javaline={164},length={3})
   public  CodeInjection(String a, String b, String c, UmpleClass d){
    this(a,b,new CodeBlock(c), d);
  }

  @umplesourcefile(line={547},file={"Umple_Code.ump"},javaline={169},length={3})
   public void setCode(String str){
    snippet.setCode(str);
  }

  @umplesourcefile(line={551},file={"Umple_Code.ump"},javaline={174},length={34})
  ...
  @umplesourcefile(line={586},file={"Umple_Code.ump"},javaline={210},length={3})
   public void setCode(String lang, String code){
    snippet.setCode(lang, code);
  }

  @umplesourcefile(line={590},file={"Umple_Code.ump"},javaline={215},length={3})
