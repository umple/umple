...
public class UmpleFile
{
  ...
  @umplesourcefile(line={17},file={"UmpleHelper_Code.ump"},javaline={97},length={3})
   public  UmpleFile(String aPath, String aFilename){
    this(new File(aPath,aFilename));
  }

  @umplesourcefile(line={22},file={"UmpleHelper_Code.ump"},javaline={102},length={3})
   public  UmpleFile(String aFullFilename){
    this(new File(aFullFilename));
  }

  @umplesourcefile(line={27},file={"UmpleHelper_Code.ump"},javaline={107},length={11})
  ...
  @umplesourcefile(line={41},file={"UmpleHelper_Code.ump"},javaline={120},length={11})
  ...
  @umplesourcefile(line={54},file={"UmpleHelper_Code.ump"},javaline={133},length={3})
   public String getFileContent(){
    return fileContent.toString();
  }

  @umplesourcefile(line={64},file={"UmpleHelper_Code.ump"},javaline={138},length={4})
   private boolean doesFileExist(String aFileName){
    File file = new File(aFileName);
    return file.exists();
  }

  @umplesourcefile(line={70},file={"UmpleHelper_Code.ump"},javaline={144},length={4})
   public boolean doesFileExist(){
    File file = new File(path,fileName);
    return file.exists();
  }

  @umplesourcefile(line={76},file={"UmpleHelper_Code.ump"},javaline={150},length={3})
   public String getParent(){
    return ((new File(path)).getParent().toString());
  }

  @umplesourcefile(line={81},file={"UmpleHelper_Code.ump"},javaline={155},length={25})
  ...
  @umplesourcefile(line={108},file={"UmpleHelper_Code.ump"},javaline={182},length={3})
   ...
   */
  @umplesourcefile(line={113},file={"UmpleHelper_Code.ump"},javaline={187},length={3})
   ...
   */
  @umplesourcefile(line={118},file={"UmpleHelper_Code.ump"},javaline={196},length={3})
  ...
  //------------------------
  //  @umplesourcefile(line={56},file={"UmpleHelper_Code.ump"},javaline={217},length={5})
  @umplesourcefile(line={57},file={"UmpleHelper_Code.ump"},javaline={218},length={4})
