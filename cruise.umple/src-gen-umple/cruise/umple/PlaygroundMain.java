 ...
 * @umplesource Main_Code.ump 338
 */
// line 338 "../../../src/Main_Code.ump"
public class PlaygroundMain
{
  ...
  @umplesourcefile(line={349},file={"Main_Code.ump"},javaline={45},length={103})
  ...
  @umplesourcefile(line={454},file={"Main_Code.ump"},javaline={152},length={4})
   private static  void print(String output){
    console += output;
        System.out.print(output);
  }

  @umplesourcefile(line={460},file={"Main_Code.ump"},javaline={158},length={54})
  ...
  //------------------------
  //  @umplesourcefile(line={513},file={"Main_Code.ump"},javaline={216},length={2})
