 ...
 * @umplesource Main_Code.ump 219
 */
// line 219 "../../../src/Main_Code.ump"
public class UmpleRunMain
{
  ...
  @umplesourcefile(line={232},file={"Main_Code.ump"},javaline={42},length={72})
  ...
  @umplesourcefile(line={306},file={"Main_Code.ump"},javaline={118},length={7})
  ...
  @umplesourcefile(line={316},file={"Main_Code.ump"},javaline={127},length={3})
   private static  void println(String output){
    print(output + "\n");
  }

  @umplesourcefile(line={321},file={"Main_Code.ump"},javaline={132},length={7})
  ...
  //------------------------
  //  @umplesourcefile(line={327},file={"Main_Code.ump"},javaline={143},length={4})
  public static String console ;
//  @umplesourcefile(line={328},file={"Main_Code.ump"},javaline={145},length={2})
