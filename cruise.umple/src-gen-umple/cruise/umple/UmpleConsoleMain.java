...
public class UmpleConsoleMain
{
  ...
  @umplesourcefile(line={182},file={"Main_Code.ump"},javaline={203},length={24})
   private static  OptionSet optParse(String [] args){
    ...
    optparser.acceptsAll(Arrays.asList("g", "generate"), "Specify the output language: Java,Cpp,RTCpp,SimpleCpp,Php,Ruby,SQL,Ruby,Json,Ecore,TextUml,GvStateDiagram,GvClassDiagram,Yuml,SimpleMetrics,Uigu2").withRequiredArg().ofType(String.class);
