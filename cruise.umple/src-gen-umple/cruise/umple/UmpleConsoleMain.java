...
public class UmpleConsoleMain
{
  ...
  //------------------------
  //  @umplesourcefile(line={29},file={"Main_Code.ump"},javaline={47},length={156})
  ...
  @umplesourcefile(line={161},file={"Main_Code.ump"},javaline={187},length={24})
    private static OptionSet optParse(String[] args)
    {
        ...
        optparser.acceptsAll(Arrays.asList("g", "generate"), "Specify the output language: Java,Cpp,RTCpp,Php,Ruby,SQL,Ruby,Json,Ecore,TextUml,GvStateDiagram,GvClassDiagram,Yuml,SimpleMetrics").withRequiredArg().ofType(String.class);
