...
public class GrammarAnalyzer extends Analyzer
{
   ...
   */
  @umplesourcefile(line={676},file={"GrammarParsing_Code.ump"},javaline={456},length={43})
   public void execute(){
   ...
   */
  @umplesourcefile(line={724},file={"GrammarParsing_Code.ump"},javaline={505},length={3})
   ...
   */
  @umplesourcefile(line={732},file={"GrammarParsing_Code.ump"},javaline={515},length={24})
   ...
   */
  @umplesourcefile(line={760},file={"GrammarParsing_Code.ump"},javaline={545},length={8})
   ...
   */
  @umplesourcefile(line={773},file={"GrammarParsing_Code.ump"},javaline={559},length={38})
   ...
   */
  @umplesourcefile(line={815},file={"GrammarParsing_Code.ump"},javaline={603},length={11})
   ...
   */
  @umplesourcefile(line={831},file={"GrammarParsing_Code.ump"},javaline={620},length={21})
   ...
   */
  @umplesourcefile(line={857},file={"GrammarParsing_Code.ump"},javaline={647},length={187})
   ...
   */
  @umplesourcefile(line={1049},file={"GrammarParsing_Code.ump"},javaline={840},length={34})
   ...
   */
  @umplesourcefile(line={1088},file={"GrammarParsing_Code.ump"},javaline={880},length={28})
   ...
   * will be tried.
   */
  @umplesourcefile(line={1122},file={"GrammarParsing_Code.ump"},javaline={914},length={7})
   ...
   */
  @umplesourcefile(line={1135},file={"GrammarParsing_Code.ump"},javaline={929},length={10})
   ...
   */
  @umplesourcefile(line={1151},file={"GrammarParsing_Code.ump"},javaline={946},length={51})
   ...
   */
  @umplesourcefile(line={1209},file={"GrammarParsing_Code.ump"},javaline={1005},length={102})
  ...
  @umplesourcefile(line={1313},file={"GrammarParsing_Code.ump"},javaline={1114},length={37})
