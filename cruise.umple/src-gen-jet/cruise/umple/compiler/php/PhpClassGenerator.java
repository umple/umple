...
public class PhpClassGenerator implements ILang
{
  ...
  protected final String TEXT_2 = NL + "/*PLEASE DO NOT EDIT THIS CODE*/" + NL + "/*This code was generated using the UMPLE 1.16.0.2388 modeling language!*/" + NL;
  ...
  protected final String TEXT_195 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_196 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_197 = NL + "  public function ";
  protected final String TEXT_198 = "($index)" + NL + "  {";
  protected final String TEXT_199 = NL + "    $";
  protected final String TEXT_200 = " = $this->";
  protected final String TEXT_201 = "[$index];";
  protected final String TEXT_202 = NL + "    return $";
  protected final String TEXT_203 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_204 = "()" + NL + "  {";
  protected final String TEXT_205 = NL + "    $";
  protected final String TEXT_206 = " = $this->";
  protected final String TEXT_207 = ";";
  protected final String TEXT_208 = NL + "    return $";
  protected final String TEXT_209 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_210 = "()" + NL + "  {";
  protected final String TEXT_211 = NL + "    $number = count($this->";
  protected final String TEXT_212 = ");";
  protected final String TEXT_213 = NL + "    return $number;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_214 = "()" + NL + "  {";
  protected final String TEXT_215 = NL + "    $has = ";
  protected final String TEXT_216 = ".size() > 0;";
  protected final String TEXT_217 = NL + "    return $has;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_218 = "($";
  protected final String TEXT_219 = ")" + NL + "  {";
  protected final String TEXT_220 = NL + "    $rawAnswer = array_search($";
  protected final String TEXT_221 = ",$this->";
  protected final String TEXT_222 = ");" + NL + "    $index = $rawAnswer == null && $rawAnswer !== 0 ? -1 : $rawAnswer;";
  protected final String TEXT_223 = NL + "    return $index;" + NL + "  }" + NL;
  protected final String TEXT_224 = NL + "  public function ";
  ...
  protected final String TEXT_244 = NL + "    return $this->";
  ...
  protected final String TEXT_266 = NL + "    return $this->";
  ...
  protected final String TEXT_290 = NL + "  public function ";
  protected final String TEXT_291 = "()" + NL + "  {";
  protected final String TEXT_292 = NL + "    return $this->";
  protected final String TEXT_293 = ";" + NL + "  }";
  protected final String TEXT_294 = NL + "  public function ";
  protected final String TEXT_295 = "()" + NL + "  {" + NL + "    $answer = $this->";
  protected final String TEXT_296 = "();";
  protected final String TEXT_297 = NL + "    return $answer;" + NL + "  }" + NL;
  protected final String TEXT_298 = NL + "  public function ";
  protected final String TEXT_299 = "()" + NL + "  {";
  protected final String TEXT_300 = NL + "    return null;" + NL + "  }" + NL;
  protected final String TEXT_301 = NL + "  ";
  protected final String TEXT_302 = " function ";
  protected final String TEXT_303 = "(";
  protected final String TEXT_304 = ")" + NL + "  {" + NL + "    $wasEventProcessed = false;";
  protected final String TEXT_305 = NL + "    ";
  protected final String TEXT_306 = NL + "    return $wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_307 = NL + "  public function ";
  protected final String TEXT_308 = "($";
  protected final String TEXT_309 = ")" + NL + "  {";
  protected final String TEXT_310 = NL + "    ";
  protected final String TEXT_311 = NL + "    else" + NL + "    {" + NL + "      return false;" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_312 = NL + "  private function ";
  protected final String TEXT_313 = "()" + NL + "  {";
  protected final String TEXT_314 = NL + "    ";
  protected final String TEXT_315 = NL + "  }" + NL;
  protected final String TEXT_316 = NL + "  private function ";
  protected final String TEXT_317 = "($";
  protected final String TEXT_318 = ")" + NL + "  {";
  protected final String TEXT_319 = NL + "    $this->";
  protected final String TEXT_320 = " = $";
  protected final String TEXT_321 = ";";
  protected final String TEXT_322 = NL + "    if ($this->";
  protected final String TEXT_323 = " != self::$";
  protected final String TEXT_324 = " && $";
  protected final String TEXT_325 = " != self::$";
  protected final String TEXT_326 = ") { $this->";
  protected final String TEXT_327 = "(self::$";
  protected final String TEXT_328 = "); }";
  protected final String TEXT_329 = NL + NL + "    // entry actions and do activities";
  protected final String TEXT_330 = NL + "    ";
  protected final String TEXT_331 = NL + "  }" + NL;
  protected final String TEXT_332 = NL + "  public function ";
  protected final String TEXT_333 = "()" + NL + "  {";
  protected final String TEXT_334 = NL + "    return $this->";
  ...
  protected final String TEXT_343 = "($index)" + NL + "  {";
  protected final String TEXT_344 = NL + "    $";
  protected final String TEXT_345 = " = $this->";
  protected final String TEXT_346 = "[$index];";
  protected final String TEXT_347 = NL + "    return $";
  protected final String TEXT_348 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_349 = "()" + NL + "  {";
  protected final String TEXT_350 = NL + "    $";
  protected final String TEXT_351 = " = $this->";
  protected final String TEXT_352 = ";";
  protected final String TEXT_353 = NL + "    return $";
  protected final String TEXT_354 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_355 = "()" + NL + "  {";
  protected final String TEXT_356 = NL + "    $number = count($this->";
  protected final String TEXT_357 = ");";
  protected final String TEXT_358 = NL + "    return $number;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_359 = "()" + NL + "  {";
  protected final String TEXT_360 = NL + "    $has = $this->";
  protected final String TEXT_361 = "() > 0;";
  protected final String TEXT_362 = NL + "    return $has;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_363 = "($";
  protected final String TEXT_364 = ")" + NL + "  {";
  protected final String TEXT_365 = NL + "    $wasFound = false;" + NL + "    $index = 0;" + NL + "    foreach($this->";
  protected final String TEXT_366 = " as $";
  protected final String TEXT_367 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_368 = "->equals($";
  protected final String TEXT_369 = "))" + NL + "      {" + NL + "        $wasFound = true;" + NL + "        break;" + NL + "      }" + NL + "      $index += 1;" + NL + "    }" + NL + "    $index = $wasFound ? $index : -1;";
  protected final String TEXT_370 = NL + "    return $index;" + NL + "  }" + NL;
  protected final String TEXT_371 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_372 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_373 = " : ";
  protected final String TEXT_374 = NL + "  public function ";
  protected final String TEXT_375 = "()" + NL + "  {";
  protected final String TEXT_376 = NL + "    $isValid = $this->";
  protected final String TEXT_377 = "() >= self::";
  ...
  protected final String TEXT_384 = NL + "    return $isValid;" + NL + "  }";
  protected final String TEXT_385 = NL + "  public static function ";
  protected final String TEXT_386 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_387 = ";" + NL + "  }";
  protected final String TEXT_388 = NL + "  public static function ";
  protected final String TEXT_389 = "()" + NL + "  {";
  protected final String TEXT_390 = NL + "    $minimum = ";
  protected final String TEXT_391 = ";";
  protected final String TEXT_392 = NL + "    return $minimum;" + NL + "  }";
  protected final String TEXT_393 = NL + "  public static function ";
  protected final String TEXT_394 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_395 = ";" + NL + "  }";
  protected final String TEXT_396 = NL + "  public static function ";
  protected final String TEXT_397 = "()" + NL + "  {";
  protected final String TEXT_398 = NL + "    $minimum = ";
  protected final String TEXT_399 = ";";
  protected final String TEXT_400 = NL + "    return $minimum;" + NL + "  }";
  protected final String TEXT_401 = NL + "  public static function ";
  ...
  protected final String TEXT_406 = NL + "    $maximum = ";
  protected final String TEXT_407 = ";";
  protected final String TEXT_408 = NL + "    return $maximum;" + NL + "  }";
  protected final String TEXT_409 = NL + "  public function ";
  protected final String TEXT_410 = "($";
  protected final String TEXT_411 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_412 = NL + "    if ($this->";
  protected final String TEXT_413 = "() >= self::";
  protected final String TEXT_414 = "())" + NL + "    {";
  protected final String TEXT_415 = NL + "      return $wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_416 = NL + "    $this->";
  protected final String TEXT_417 = "[] = $";
  protected final String TEXT_418 = ";" + NL + "    if ($";
  protected final String TEXT_419 = "->";
  protected final String TEXT_420 = "($this) != -1)" + NL + "    {" + NL + "      $wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasAdded = $";
  protected final String TEXT_421 = "->";
  protected final String TEXT_422 = "($this);" + NL + "      if (!$wasAdded)" + NL + "      {" + NL + "        array_pop($this->";
  protected final String TEXT_423 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_424 = NL + "    return $wasAdded;" + NL + "  }";
  protected final String TEXT_425 = NL + "  public function ";
  protected final String TEXT_426 = "($";
  protected final String TEXT_427 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_428 = NL + "    if ($this->";
  protected final String TEXT_429 = "($";
  protected final String TEXT_430 = ") == -1)" + NL + "    {";
  protected final String TEXT_431 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_432 = "($";
  protected final String TEXT_433 = ");" + NL + "    unset($this->";
  protected final String TEXT_434 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_435 = "->";
  protected final String TEXT_436 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_437 = "->";
  protected final String TEXT_438 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_439 = "[$oldIndex] = $";
  protected final String TEXT_440 = ";" + NL + "        ksort($this->";
  protected final String TEXT_441 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_442 = " = array_values($this->";
  protected final String TEXT_443 = ");";
  protected final String TEXT_444 = NL + "    return $wasRemoved;" + NL + "  }";
  protected final String TEXT_445 = NL + "  ";
  protected final String TEXT_446 = " function ";
  protected final String TEXT_447 = "($";
  protected final String TEXT_448 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_449 = NL + "    $this->";
  protected final String TEXT_450 = " = $";
  protected final String TEXT_451 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_452 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_453 = NL + "  ";
  protected final String TEXT_454 = " function ";
  protected final String TEXT_455 = "($";
  protected final String TEXT_456 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_457 = NL + "    if ($";
  protected final String TEXT_458 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_459 = " = $";
  protected final String TEXT_460 = ";" + NL + "      $wasSet = true;" + NL + "    }";
  protected final String TEXT_461 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_462 = NL + "  public function ";
  protected final String TEXT_463 = "($";
  protected final String TEXT_464 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_465 = NL + "    if ($this->";
  protected final String TEXT_466 = " != null && $this->";
  protected final String TEXT_467 = " != $";
  protected final String TEXT_468 = " && $this == $this->";
  protected final String TEXT_469 = "->";
  protected final String TEXT_470 = "())" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_471 = ", as existing ";
  protected final String TEXT_472 = " would become an orphan";
  protected final String TEXT_473 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $this->";
  protected final String TEXT_474 = " = $";
  protected final String TEXT_475 = ";" + NL + "    $";
  protected final String TEXT_476 = " = $";
  protected final String TEXT_477 = " != null ? $";
  protected final String TEXT_478 = "->";
  protected final String TEXT_479 = "() : null;" + NL + "    " + NL + "    if ($this != $";
  protected final String TEXT_480 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_481 = " != null)" + NL + "      {" + NL + "        $";
  protected final String TEXT_482 = "->";
  protected final String TEXT_483 = " = null;" + NL + "      }" + NL + "      if ($this->";
  protected final String TEXT_484 = " != null)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_485 = "->";
  protected final String TEXT_486 = "($this);" + NL + "      }" + NL + "    }" + NL + "    $wasSet = true;";
  ...
  protected final String TEXT_492 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_493 = " to null, as ";
  protected final String TEXT_494 = " must always be associated to a ";
  protected final String TEXT_495 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_496 = " = $";
  protected final String TEXT_497 = "->";
  protected final String TEXT_498 = "();" + NL + "    if ($";
  protected final String TEXT_499 = " != null && $this != $";
  protected final String TEXT_500 = ")" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_501 = ", the current ";
  protected final String TEXT_502 = " already has a ";
  protected final String TEXT_503 = ", which would be orphaned if it were re-assigned";
  protected final String TEXT_504 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_505 = " = $this->";
  protected final String TEXT_506 = ";" + NL + "    $this->";
  protected final String TEXT_507 = " = $";
  protected final String TEXT_508 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_515 = NL + "  public function ";
  protected final String TEXT_516 = "(";
  protected final String TEXT_517 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_518 = "(";
  protected final String TEXT_519 = ");" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_520 = "($";
  protected final String TEXT_521 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_522 = NL + "    $";
  protected final String TEXT_523 = " = $";
  protected final String TEXT_524 = "->";
  protected final String TEXT_525 = "();" + NL + "    $";
  protected final String TEXT_526 = " = $";
  protected final String TEXT_527 = " != null && $this !== $";
  ...
  protected final String TEXT_535 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_536 = "[] = $";
  protected final String TEXT_537 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_538 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_539 = "($";
  protected final String TEXT_540 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_541 = NL + "    //Unable to remove ";
  protected final String TEXT_542 = ", as it must always have a ";
  protected final String TEXT_543 = NL + "    if ($this === $";
  protected final String TEXT_544 = "->";
  protected final String TEXT_545 = "())" + NL + "    {";
  protected final String TEXT_546 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_547 = " already at minimum (";
  protected final String TEXT_548 = ")" + NL + "    if ($this->";
  protected final String TEXT_549 = "() <= self::";
  protected final String TEXT_550 = "())" + NL + "    {";
  protected final String TEXT_551 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_552 = "[$this->";
  protected final String TEXT_553 = "($";
  protected final String TEXT_554 = ")]);" + NL + "    $this->";
  protected final String TEXT_555 = " = array_values($this->";
  protected final String TEXT_556 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_557 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_558 = NL + "  public function ";
  protected final String TEXT_559 = "(";
  protected final String TEXT_560 = ")" + NL + "  {" + NL + "    if ($this->";
  protected final String TEXT_561 = "() >= self::";
  protected final String TEXT_562 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_563 = "(";
  protected final String TEXT_564 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_565 = "($";
  protected final String TEXT_566 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_567 = NL + "    if ($this->";
  protected final String TEXT_568 = "() >= self::";
  protected final String TEXT_569 = "())" + NL + "    {";
  protected final String TEXT_570 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  ...
  protected final String TEXT_581 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    if ($";
  ...
  protected final String TEXT_628 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_629 = "[] = $";
  protected final String TEXT_630 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_631 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_632 = "($";
  protected final String TEXT_633 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_634 = NL + "    //Unable to remove ";
  protected final String TEXT_635 = ", as it must always have a ";
  protected final String TEXT_636 = NL + "    if ($this !== $";
  protected final String TEXT_637 = "->";
  protected final String TEXT_638 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_639 = "[$this->";
  protected final String TEXT_640 = "($";
  protected final String TEXT_641 = ")]);" + NL + "      $this->";
  protected final String TEXT_642 = " = array_values($this->";
  protected final String TEXT_643 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_644 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_645 = NL + "  public function ";
  protected final String TEXT_646 = "($";
  protected final String TEXT_647 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_648 = NL + "    $";
  protected final String TEXT_649 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_650 = " as $";
  protected final String TEXT_651 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_652 = ",$";
  protected final String TEXT_653 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_654 = "[] = $";
  protected final String TEXT_655 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_656 = ") != count($";
  protected final String TEXT_657 = ") || count($";
  protected final String TEXT_658 = ") > self::";
  protected final String TEXT_659 = "())" + NL + "    {";
  protected final String TEXT_660 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_661 = " = $this->";
  protected final String TEXT_662 = ";" + NL + "    $this->";
  protected final String TEXT_663 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_664 = " as $";
  protected final String TEXT_665 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_666 = "[] = $";
  protected final String TEXT_667 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_668 = ",$";
  protected final String TEXT_669 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_670 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_671 = " = array_values($";
  protected final String TEXT_672 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_673 = "->";
  protected final String TEXT_674 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_675 = " as $";
  ...
  protected final String TEXT_682 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_683 = "(";
  protected final String TEXT_684 = ");" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_685 = "($";
  protected final String TEXT_686 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_687 = NL + "    $";
  protected final String TEXT_688 = " = $";
  protected final String TEXT_689 = "->";
  protected final String TEXT_690 = "();" + NL + "    $";
  protected final String TEXT_691 = " = $";
  protected final String TEXT_692 = " != null && $this !== $";
  protected final String TEXT_693 = ";" + NL + "    if ($";
  protected final String TEXT_694 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_695 = "->";
  protected final String TEXT_696 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_697 = "[] = $";
  protected final String TEXT_698 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_699 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  ...
  protected final String TEXT_704 = NL + "    if ($this !== $";
  protected final String TEXT_705 = "->";
  protected final String TEXT_706 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_707 = "[$this->";
  protected final String TEXT_708 = "($";
  protected final String TEXT_709 = ")]);" + NL + "      $this->";
  protected final String TEXT_710 = " = array_values($this->";
  protected final String TEXT_711 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_712 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_713 = NL + "  public function ";
  protected final String TEXT_714 = "($";
  protected final String TEXT_715 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_716 = NL + "    if ($";
  protected final String TEXT_717 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_718 = " = $this->";
  protected final String TEXT_719 = ";" + NL + "      $this->";
  protected final String TEXT_720 = " = null;" + NL + "      " + NL + "      if ($";
  protected final String TEXT_721 = " != null && $";
  protected final String TEXT_722 = "->";
  protected final String TEXT_723 = "() != null)" + NL + "      {" + NL + "        $";
  protected final String TEXT_724 = "->";
  protected final String TEXT_725 = "(null);" + NL + "      }" + NL + "      $wasSet = true;";
  protected final String TEXT_726 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  ...
  protected final String TEXT_733 = "(null);" + NL + "    }" + NL + "    " + NL + "    $this->";
  protected final String TEXT_734 = " = $";
  protected final String TEXT_735 = ";" + NL + "    $";
  protected final String TEXT_736 = " = $";
  protected final String TEXT_737 = "->";
  protected final String TEXT_738 = "();" + NL + "    " + NL + "    if ($this != $";
  ...
  protected final String TEXT_745 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_746 = NL + "    if ($this->";
  protected final String TEXT_747 = "($";
  protected final String TEXT_748 = ") == -1)" + NL + "    {";
  protected final String TEXT_749 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_750 = "() <= self::";
  protected final String TEXT_751 = "())" + NL + "    {";
  protected final String TEXT_752 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_753 = "($";
  protected final String TEXT_754 = ");" + NL + "    unset($this->";
  protected final String TEXT_755 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_756 = "->";
  protected final String TEXT_757 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_758 = "->";
  protected final String TEXT_759 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_760 = "[$oldIndex] = $";
  protected final String TEXT_761 = ";" + NL + "        ksort($this->";
  protected final String TEXT_762 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_763 = " = array_values($this->";
  protected final String TEXT_764 = ");";
  protected final String TEXT_765 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_766 = NL + "  public function ";
  protected final String TEXT_767 = "($";
  protected final String TEXT_768 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_769 = NL + "    if ($this->";
  protected final String TEXT_770 = "($";
  protected final String TEXT_771 = ") == -1)" + NL + "    {";
  protected final String TEXT_772 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_773 = "() <= self::";
  protected final String TEXT_774 = "())" + NL + "    {";
  protected final String TEXT_775 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_776 = "($";
  protected final String TEXT_777 = ");" + NL + "    unset($this->";
  protected final String TEXT_778 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_779 = "->";
  protected final String TEXT_780 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_781 = "->";
  protected final String TEXT_782 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_783 = "[$oldIndex] = $";
  protected final String TEXT_784 = ";" + NL + "        ksort($this->";
  protected final String TEXT_785 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_786 = " = array_values($this->";
  protected final String TEXT_787 = ");";
  protected final String TEXT_788 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_789 = NL + "  public function ";
  protected final String TEXT_790 = "($";
  protected final String TEXT_791 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  ...
  protected final String TEXT_798 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_799 = " = $this->";
  protected final String TEXT_800 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_807 = "($this);" + NL + "    }" + NL + "    if ($";
  protected final String TEXT_808 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_809 = "->";
  protected final String TEXT_810 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_811 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_812 = NL + "  public function ";
  protected final String TEXT_813 = "($";
  protected final String TEXT_814 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_815 = NL + "    if ($";
  protected final String TEXT_816 = " == null)" + NL + "    {";
  protected final String TEXT_817 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_818 = " = $this->";
  protected final String TEXT_819 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_826 = "($this);" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_827 = "->";
  protected final String TEXT_828 = "($this);" + NL + "    $wasSet = true;";
  ...
  protected final String TEXT_833 = NL + "    //Must provide ";
  protected final String TEXT_834 = " to ";
  protected final String TEXT_835 = NL + "    if ($";
  protected final String TEXT_836 = " == null)" + NL + "    {";
  protected final String TEXT_837 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_838 = " already at maximum (";
  protected final String TEXT_839 = ")" + NL + "    if ($";
  protected final String TEXT_840 = "->";
  protected final String TEXT_841 = "() >= ";
  protected final String TEXT_842 = "::";
  protected final String TEXT_843 = "())" + NL + "    {";
  protected final String TEXT_844 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_845 = " = $this->";
  protected final String TEXT_846 = ";" + NL + "    $this->";
  protected final String TEXT_847 = " = $";
  protected final String TEXT_848 = ";" + NL + "    if ($";
  protected final String TEXT_849 = " != null && $";
  protected final String TEXT_850 = " != $";
  protected final String TEXT_851 = ")" + NL + "    {" + NL + "      $didRemove = $";
  protected final String TEXT_852 = "->";
  protected final String TEXT_853 = "($this);" + NL + "      if (!$didRemove)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_854 = " = $";
  protected final String TEXT_855 = ";";
  protected final String TEXT_856 = NL + "        return $wasSet;" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_857 = "->";
  protected final String TEXT_858 = "($this);" + NL + "    $wasSet = true;";
  ...
  protected final String TEXT_863 = NL + "    //Must provide ";
  protected final String TEXT_864 = " to ";
  protected final String TEXT_865 = NL + "    if ($";
  protected final String TEXT_866 = " == null)" + NL + "    {";
  protected final String TEXT_867 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_868 = " != null && $this->";
  protected final String TEXT_869 = "->";
  protected final String TEXT_870 = "() <= ";
  protected final String TEXT_871 = "::";
  protected final String TEXT_872 = "())" + NL + "    {";
  protected final String TEXT_873 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_874 = " = $this->";
  protected final String TEXT_875 = ";" + NL + "    $this->";
  protected final String TEXT_876 = " = $";
  protected final String TEXT_877 = ";" + NL + "    if ($";
  protected final String TEXT_878 = " != null && $";
  protected final String TEXT_879 = " != $";
  protected final String TEXT_880 = ")" + NL + "    {" + NL + "      $didRemove = $";
  protected final String TEXT_881 = "->";
  protected final String TEXT_882 = "($this);" + NL + "      if (!$didRemove)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_883 = " = $";
  protected final String TEXT_884 = ";";
  protected final String TEXT_885 = NL + "        return $wasSet;" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_886 = "->";
  protected final String TEXT_887 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_888 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_889 = NL + "  public function ";
  protected final String TEXT_890 = "($";
  protected final String TEXT_891 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_892 = NL + "    $";
  protected final String TEXT_893 = " = $";
  protected final String TEXT_894 = "->";
  protected final String TEXT_895 = "();" + NL + "    if ($";
  protected final String TEXT_896 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_897 = "->";
  protected final String TEXT_898 = "($this);" + NL + "    }" + NL + "    elseif ($this !== $";
  protected final String TEXT_899 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_900 = "->";
  protected final String TEXT_901 = "($";
  protected final String TEXT_902 = ");" + NL + "      $this->";
  protected final String TEXT_903 = "($";
  protected final String TEXT_904 = ");" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_905 = "[] = $";
  protected final String TEXT_906 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_907 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_908 = "($";
  protected final String TEXT_909 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_910 = NL + "    if ($this->";
  protected final String TEXT_911 = "($";
  protected final String TEXT_912 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_913 = "[$this->";
  protected final String TEXT_914 = "($";
  protected final String TEXT_915 = ")]);" + NL + "      $this->";
  protected final String TEXT_916 = " = array_values($this->";
  protected final String TEXT_917 = ");" + NL + "      if ($this === $";
  protected final String TEXT_918 = "->";
  protected final String TEXT_919 = "())" + NL + "      {" + NL + "        $";
  protected final String TEXT_920 = "->";
  protected final String TEXT_921 = "(null);" + NL + "      }" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_922 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_923 = NL + "  public function ";
  protected final String TEXT_924 = "($";
  protected final String TEXT_925 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_926 = NL + "    $";
  protected final String TEXT_927 = " = $this->";
  protected final String TEXT_928 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_935 = "($this);" + NL + "    }" + NL + "    if ($";
  protected final String TEXT_936 = " != null && $";
  protected final String TEXT_937 = " !== $";
  protected final String TEXT_938 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_939 = "->";
  protected final String TEXT_940 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_941 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_942 = NL + "  public function ";
  protected final String TEXT_943 = "($";
  protected final String TEXT_944 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_945 = NL + "    if ($this->";
  protected final String TEXT_946 = "() >= self::";
  protected final String TEXT_947 = "())" + NL + "    {";
  protected final String TEXT_948 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_949 = " = $";
  protected final String TEXT_950 = "->";
  protected final String TEXT_951 = "();" + NL + "    if ($";
  protected final String TEXT_952 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_953 = "->";
  protected final String TEXT_954 = "($this);" + NL + "    }" + NL + "    else if ($this !== $";
  protected final String TEXT_955 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_956 = "->";
  protected final String TEXT_957 = "($";
  protected final String TEXT_958 = ");" + NL + "      $this->";
  protected final String TEXT_959 = "($";
  protected final String TEXT_960 = ");" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_961 = "[] = $";
  protected final String TEXT_962 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_963 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_964 = "($";
  protected final String TEXT_965 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_966 = NL + "    if ($this->";
  protected final String TEXT_967 = "($";
  protected final String TEXT_968 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_969 = "[$this->";
  protected final String TEXT_970 = "($";
  protected final String TEXT_971 = ")]);" + NL + "      $this->";
  protected final String TEXT_972 = " = array_values($this->";
  protected final String TEXT_973 = ");" + NL + "      $";
  protected final String TEXT_974 = "->";
  protected final String TEXT_975 = "(null);" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_976 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_977 = NL + "  public function ";
  protected final String TEXT_978 = "($";
  protected final String TEXT_979 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_980 = NL + "    if ($this->";
  protected final String TEXT_981 = "() < self::";
  protected final String TEXT_982 = "())" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_983 = "[] = $";
  protected final String TEXT_984 = ";" + NL + "      $wasAdded = true;" + NL + "    }";
  protected final String TEXT_985 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_986 = "($";
  protected final String TEXT_987 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_988 = NL + "    if ($this->";
  protected final String TEXT_989 = "($";
  protected final String TEXT_990 = ") == -1)" + NL + "    {";
  protected final String TEXT_991 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_992 = "() <= self::";
  protected final String TEXT_993 = "())" + NL + "    {";
  protected final String TEXT_994 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_995 = "[$this->";
  protected final String TEXT_996 = "($";
  protected final String TEXT_997 = ")]);" + NL + "    $this->";
  protected final String TEXT_998 = " = array_values($this->";
  protected final String TEXT_999 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_1000 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1001 = NL + "  public function ";
  protected final String TEXT_1002 = "($";
  protected final String TEXT_1003 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1004 = NL + "    if ($this->";
  protected final String TEXT_1005 = "() >= self::";
  protected final String TEXT_1006 = "())" + NL + "    {";
  protected final String TEXT_1007 = NL + "      return $wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1014 = "() <= self::";
  protected final String TEXT_1015 = "())" + NL + "    {";
  protected final String TEXT_1016 = NL + "      return $wasAdded;" + NL + "    }" + NL + "    else if ($";
  protected final String TEXT_1017 = " != null)" + NL + "    {" + NL + "      unset($";
  ...
  protected final String TEXT_1024 = " = array_values($";
  protected final String TEXT_1025 = "->";
  protected final String TEXT_1026 = ");" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_1027 = "[] = $";
  protected final String TEXT_1028 = ";" + NL + "    $this->";
  protected final String TEXT_1029 = "($";
  protected final String TEXT_1030 = ",$this);" + NL + "    $wasAdded = true;";
  ...
  protected final String TEXT_1036 = ") != -1 && $this->";
  protected final String TEXT_1037 = "() > self::";
  protected final String TEXT_1038 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1039 = "[$this->";
  protected final String TEXT_1040 = "($";
  protected final String TEXT_1041 = ")]);" + NL + "      $this->";
  protected final String TEXT_1042 = " = array_values($this->";
  protected final String TEXT_1043 = ");" + NL + "      $this->";
  ...
  protected final String TEXT_1047 = NL + "  public function ";
  protected final String TEXT_1048 = "($";
  protected final String TEXT_1049 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1050 = NL + "    $";
  protected final String TEXT_1051 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1052 = " as $";
  protected final String TEXT_1053 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1054 = ",$";
  protected final String TEXT_1055 = ") !== false)" + NL + "      {";
  protected final String TEXT_1056 = NL + "        return $wasSet;" + NL + "      }" + NL + "      else if ($";
  protected final String TEXT_1057 = "->";
  protected final String TEXT_1058 = "() != null && $this !== $";
  protected final String TEXT_1059 = "->";
  protected final String TEXT_1060 = "())" + NL + "      {";
  protected final String TEXT_1061 = NL + "        return $wasSet;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1062 = "[] = $";
  protected final String TEXT_1063 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1064 = ") != self::";
  protected final String TEXT_1065 = "())" + NL + "    {";
  protected final String TEXT_1066 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    foreach ($this->";
  protected final String TEXT_1067 = " as $orphan) " + NL + "    {" + NL + "      $wasFound = false;" + NL + "      foreach ($";
  protected final String TEXT_1068 = " as $fosterCare)" + NL + "      {" + NL + "        if ($orphan == $fosterCare)" + NL + "        {" + NL + "          $wasFound = true;" + NL + "          break;" + NL + "        }" + NL + "      }" + NL + "" + NL + "      if (!$wasFound)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1069 = "($orphan, null);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1070 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1071 = " as $";
  protected final String TEXT_1072 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1073 = "($";
  protected final String TEXT_1074 = ", $this);" + NL + "      $this->";
  protected final String TEXT_1075 = "[] = $";
  protected final String TEXT_1076 = ";" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1077 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1078 = NL + "  private function ";
  protected final String TEXT_1079 = "($";
  protected final String TEXT_1080 = ", $";
  protected final String TEXT_1081 = ")" + NL + "  {" + NL + "    $";
  protected final String TEXT_1082 = "->mentor = $";
  protected final String TEXT_1083 = ";" + NL + "    //$prop = new ReflectionProperty($";
  protected final String TEXT_1084 = ", '";
  protected final String TEXT_1085 = "');" + NL + "    //$prop->setAccessible(true);" + NL + "    //$prop->setValue($";
  protected final String TEXT_1086 = ",$";
  protected final String TEXT_1087 = ");" + NL + "    //$prop->setAccessible(false);" + NL + "  }" + NL;
  protected final String TEXT_1088 = NL + "  public function ";
  protected final String TEXT_1089 = "($";
  protected final String TEXT_1090 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1091 = NL + "    $this->";
  protected final String TEXT_1092 = "[] = $";
  protected final String TEXT_1093 = ";" + NL + "    $wasAdded = true;";
  protected final String TEXT_1094 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1095 = "($";
  protected final String TEXT_1096 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1097 = NL + "    if ($this->";
  protected final String TEXT_1098 = "($";
  protected final String TEXT_1099 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1100 = "[$this->";
  protected final String TEXT_1101 = "($";
  protected final String TEXT_1102 = ")]);" + NL + "      $this->";
  protected final String TEXT_1103 = " = array_values($this->";
  protected final String TEXT_1104 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1105 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1106 = NL + "  public function ";
  protected final String TEXT_1107 = "($";
  protected final String TEXT_1108 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1109 = NL + "    if ($this->";
  protected final String TEXT_1110 = "() < self::";
  protected final String TEXT_1111 = "())" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1112 = "[] = $";
  protected final String TEXT_1113 = ";" + NL + "      $wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_1119 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1120 = "[$this->";
  protected final String TEXT_1121 = "($";
  protected final String TEXT_1122 = ")]);" + NL + "      $this->";
  protected final String TEXT_1123 = " = array_values($this->";
  protected final String TEXT_1124 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1125 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1126 = NL + "  public function ";
  protected final String TEXT_1127 = "($";
  protected final String TEXT_1128 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1129 = NL + "    $this->";
  protected final String TEXT_1130 = "[] = $";
  protected final String TEXT_1131 = ";" + NL + "    $wasAdded = true;";
  protected final String TEXT_1132 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1133 = "($";
  protected final String TEXT_1134 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1135 = NL + "    if ($this->";
  protected final String TEXT_1136 = "($";
  protected final String TEXT_1137 = ") == -1)" + NL + "    {";
  protected final String TEXT_1138 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_1139 = "() <= self::";
  protected final String TEXT_1140 = "())" + NL + "    {";
  protected final String TEXT_1141 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  ...
  protected final String TEXT_1146 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_1147 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1148 = NL + "  ";
  protected final String TEXT_1149 = " function ";
  protected final String TEXT_1150 = "($";
  protected final String TEXT_1151 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1152 = NL + "    $";
  protected final String TEXT_1153 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1154 = " as $";
  protected final String TEXT_1155 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1156 = ",$";
  protected final String TEXT_1157 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1158 = "[] = $";
  protected final String TEXT_1159 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1160 = ") != count($";
  protected final String TEXT_1161 = ") || count($";
  protected final String TEXT_1162 = ") != self::";
  protected final String TEXT_1163 = "())" + NL + "    {";
  protected final String TEXT_1164 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1165 = " = $";
  protected final String TEXT_1166 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1167 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1168 = NL + "  ";
  protected final String TEXT_1169 = " function ";
  protected final String TEXT_1170 = "($";
  protected final String TEXT_1171 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1172 = NL + "    $";
  protected final String TEXT_1173 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1174 = " as $";
  protected final String TEXT_1175 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1176 = ",$";
  protected final String TEXT_1177 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1178 = "[] = $";
  protected final String TEXT_1179 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1180 = ") != count($";
  protected final String TEXT_1181 = "))" + NL + "    {";
  protected final String TEXT_1182 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1183 = "->";
  protected final String TEXT_1184 = " = $";
  protected final String TEXT_1185 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1186 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1187 = NL + "  public function ";
  protected final String TEXT_1188 = "($";
  protected final String TEXT_1189 = ")" + NL + "  {" + NL + "    //" + NL + "    // This source of this source generation is association_SetOptionalOneToMandatoryMany.jet" + NL + "    // This set file assumes the generation of a maximumNumberOfXXX method does not exist because " + NL + "    // it's not required (No upper bound)" + NL + "    //   " + NL + "" + NL + "    $wasSet = false;" + NL + "    " + NL + "    $";
  protected final String TEXT_1190 = " = $this->";
  protected final String TEXT_1191 = ";" + NL + "\t" + NL + "    if ($";
  protected final String TEXT_1192 = " == null)" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_1193 = " != null)" + NL + "      {" + NL + "        if ($";
  protected final String TEXT_1194 = "->";
  protected final String TEXT_1195 = "($this))" + NL + "        {" + NL + "          $";
  protected final String TEXT_1196 = " = $";
  protected final String TEXT_1197 = ";" + NL + "          $wasSet = true;" + NL + "        }" + NL + "      }" + NL + "    } " + NL + "    else if ($";
  protected final String TEXT_1198 = " != null)" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_1199 = " == null)" + NL + "      {" + NL + "        if ($";
  ...
  protected final String TEXT_1208 = " == null" + NL + "          $wasSet = true;" + NL + "        }" + NL + "      } " + NL + "      else" + NL + "      {" + NL + "        if ($";
  ...
  protected final String TEXT_1216 = "($this);" + NL + "          $";
  protected final String TEXT_1217 = " = $";
  protected final String TEXT_1218 = ";" + NL + "          $wasSet = true;" + NL + "        }" + NL + "      }" + NL + "    }" + NL + "    if ($wasSet)" + NL + "    {" + NL + "      $";
  protected final String TEXT_1219 = " = $";
  protected final String TEXT_1220 = ";" + NL + "    }" + NL + "    return $wasSet;" + NL + "  }" + NL + "  ";
  protected final String TEXT_1221 = NL + "//  public function ";
  protected final String TEXT_1222 = "($";
  protected final String TEXT_1223 = ")" + NL + "//  {" + NL + "//    //" + NL + "//    // The source of the code generation is association_SetOptionalOneToMN.jet" + NL + "//    // (this) set file assumes the generation of a maximumNumberOfXXX " + NL + "//    //   method ";
  protected final String TEXT_1224 = NL + "//    // Currently this will not compile due to Issue351 - the template code is fine." + NL + "//    //" + NL + "//    $wasSet = false;" + NL + "//" + NL + "//    $";
  protected final String TEXT_1225 = " = $";
  protected final String TEXT_1226 = ";" + NL + "//\t" + NL + "//\tif ($";
  protected final String TEXT_1227 = " == null)" + NL + "//    {" + NL + "//      if ($";
  protected final String TEXT_1228 = " != null)" + NL + "//      {" + NL + "//        if ($";
  protected final String TEXT_1229 = "->";
  protected final String TEXT_1230 = "(this))" + NL + "//        {" + NL + "//          $";
  protected final String TEXT_1231 = " = $";
  protected final String TEXT_1232 = ";" + NL + "//          $wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//    } " + NL + "//    else if ($";
  ...
  protected final String TEXT_1240 = "(this);" + NL + "//          $";
  protected final String TEXT_1241 = " = $";
  protected final String TEXT_1242 = ";  // $";
  protected final String TEXT_1243 = " == null" + NL + "//          $wasSet = true;" + NL + "//        }" + NL + "//      } " + NL + "//      else" + NL + "//      {" + NL + "//        if (   $";
  ...
  protected final String TEXT_1251 = "()" + NL + "//           )" + NL + "//        {" + NL + "//          $";
  ...
  protected final String TEXT_1257 = ";" + NL + "//          $wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//    }" + NL + "//    if ($wasSet)" + NL + "//    {" + NL + "//      $";
  protected final String TEXT_1258 = " = $";
  protected final String TEXT_1259 = ";" + NL + "//    }" + NL + "//    " + NL + "//    return $wasSet;" + NL + "//  }";
  protected final String TEXT_1260 = NL + "  public function ";
  protected final String TEXT_1261 = "($";
  protected final String TEXT_1262 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1263 = NL + "    $";
  protected final String TEXT_1264 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1265 = " as $";
  protected final String TEXT_1266 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1267 = ",$";
  protected final String TEXT_1268 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1269 = "[] = $";
  protected final String TEXT_1270 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1271 = ") != count($";
  protected final String TEXT_1272 = ") || count($";
  protected final String TEXT_1273 = ") < self::";
  protected final String TEXT_1274 = "() || count($";
  protected final String TEXT_1275 = ") > self::";
  protected final String TEXT_1276 = "())" + NL + "    {";
  protected final String TEXT_1277 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1278 = " = $this->";
  protected final String TEXT_1279 = ";" + NL + "    $this->";
  protected final String TEXT_1280 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1281 = " as $";
  protected final String TEXT_1282 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1283 = "[] = $";
  protected final String TEXT_1284 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_1285 = ",$";
  protected final String TEXT_1286 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_1287 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_1288 = " = array_values($";
  protected final String TEXT_1289 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1290 = "->";
  protected final String TEXT_1291 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_1292 = " as $";
  protected final String TEXT_1293 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1294 = "->";
  protected final String TEXT_1295 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1296 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1297 = NL + "  public function ";
  protected final String TEXT_1298 = "($";
  protected final String TEXT_1299 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1300 = NL + "    $";
  protected final String TEXT_1301 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1302 = " as $";
  protected final String TEXT_1303 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1304 = ",$";
  protected final String TEXT_1305 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1306 = "[] = $";
  protected final String TEXT_1307 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1308 = ") != count($";
  protected final String TEXT_1309 = ") || count($";
  protected final String TEXT_1310 = ") < self::";
  protected final String TEXT_1311 = "())" + NL + "    {";
  protected final String TEXT_1312 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1313 = " = $this->";
  protected final String TEXT_1314 = ";" + NL + "    $this->";
  protected final String TEXT_1315 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1316 = " as $";
  protected final String TEXT_1317 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1318 = "[] = $";
  protected final String TEXT_1319 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_1320 = ",$";
  protected final String TEXT_1321 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_1322 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_1323 = " = array_values($";
  protected final String TEXT_1324 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1325 = "->";
  protected final String TEXT_1326 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_1327 = " as $";
  protected final String TEXT_1328 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1329 = "->";
  protected final String TEXT_1330 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1331 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1332 = NL + "  ";
  protected final String TEXT_1333 = " function ";
  protected final String TEXT_1334 = "($";
  protected final String TEXT_1335 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1336 = NL + "    $";
  protected final String TEXT_1337 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1338 = " as $";
  protected final String TEXT_1339 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1340 = ",$";
  protected final String TEXT_1341 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1342 = "[] = $";
  protected final String TEXT_1343 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1344 = ") != count($";
  protected final String TEXT_1345 = ") || count($";
  protected final String TEXT_1346 = ") < self::";
  protected final String TEXT_1347 = "()  || count($";
  protected final String TEXT_1348 = ") > self::";
  protected final String TEXT_1349 = "())" + NL + "    {";
  protected final String TEXT_1350 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1351 = " = $";
  protected final String TEXT_1352 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1353 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1354 = NL + "  public function ";
  protected final String TEXT_1355 = "($";
  protected final String TEXT_1356 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1357 = NL + "    if (count($";
  ...
  protected final String TEXT_1362 = " = array();" + NL + "    $";
  protected final String TEXT_1363 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1364 = " as $";
  protected final String TEXT_1365 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1366 = ",$";
  protected final String TEXT_1367 = ") !== false)" + NL + "      {";
  protected final String TEXT_1368 = NL + "        return $wasSet;" + NL + "      }" + NL + "      else if ($";
  protected final String TEXT_1369 = "->";
  protected final String TEXT_1370 = "() != null && $this !== $";
  protected final String TEXT_1371 = "->";
  protected final String TEXT_1372 = "())" + NL + "      {" + NL + "        $";
  protected final String TEXT_1373 = " = $";
  protected final String TEXT_1374 = "->";
  protected final String TEXT_1375 = "();" + NL + "        $";
  protected final String TEXT_1376 = " = serialize($";
  protected final String TEXT_1377 = ");" + NL + "        if (!array_key_exists($";
  protected final String TEXT_1378 = ", $";
  protected final String TEXT_1379 = "))" + NL + "        {" + NL + "          $";
  protected final String TEXT_1380 = "[$";
  protected final String TEXT_1381 = "] = $";
  protected final String TEXT_1382 = "->";
  protected final String TEXT_1383 = "();" + NL + "        }" + NL + "        $nextCount = $";
  protected final String TEXT_1384 = "[$";
  protected final String TEXT_1385 = "] - 1;" + NL + "        if ($nextCount < self::minimum";
  protected final String TEXT_1386 = "())" + NL + "        {";
  protected final String TEXT_1387 = NL + "          return $wasSet;" + NL + "        }" + NL + "        $";
  protected final String TEXT_1388 = "[$";
  protected final String TEXT_1389 = "] = $nextCount;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1390 = "[] = $";
  protected final String TEXT_1391 = ";" + NL + "    }" + NL + "" + NL + "    foreach ($this->";
  protected final String TEXT_1392 = " as $orphan) " + NL + "    {" + NL + "      $wasFound = false;" + NL + "      foreach ($";
  protected final String TEXT_1393 = " as $fosterCare)" + NL + "      {" + NL + "        if ($orphan == $fosterCare)" + NL + "        {" + NL + "          $wasFound = true;" + NL + "          break;" + NL + "        }" + NL + "      }" + NL + "      " + NL + "      if (!$wasFound)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1394 = "($orphan, null);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1395 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1396 = " as $";
  protected final String TEXT_1397 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_1398 = "->";
  protected final String TEXT_1399 = "() != null)" + NL + "      {" + NL + "        unset($";
  ...
  protected final String TEXT_1409 = " = array_values($";
  protected final String TEXT_1410 = "->";
  protected final String TEXT_1411 = "()->";
  protected final String TEXT_1412 = ");" + NL + "      }" + NL + "      $this->";
  protected final String TEXT_1413 = "($";
  protected final String TEXT_1414 = ", $this);" + NL + "      $this->";
  protected final String TEXT_1415 = "[] = $";
  protected final String TEXT_1416 = ";" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1417 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1418 = NL + "  private function ";
  protected final String TEXT_1419 = "($";
  protected final String TEXT_1420 = ", $";
  protected final String TEXT_1421 = ")" + NL + "  {" + NL + "    $";
  protected final String TEXT_1422 = "->mentor = $";
  protected final String TEXT_1423 = ";" + NL + "    //$prop = new ReflectionProperty($";
  protected final String TEXT_1424 = ", '";
  protected final String TEXT_1425 = "');" + NL + "    //$prop->setAccessible(true);" + NL + "    //$prop->setValue($";
  protected final String TEXT_1426 = ",$";
  protected final String TEXT_1427 = ");" + NL + "    //$prop->setAccessible(false);" + NL + "  }" + NL;
  protected final String TEXT_1428 = NL + "  ";
  protected final String TEXT_1429 = " function ";
  protected final String TEXT_1430 = "($";
  protected final String TEXT_1431 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1432 = NL + "    $";
  protected final String TEXT_1433 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1434 = " as $";
  protected final String TEXT_1435 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1436 = ",$";
  protected final String TEXT_1437 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1438 = "[] = $";
  protected final String TEXT_1439 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1440 = ") != count($";
  protected final String TEXT_1441 = ") || count($";
  protected final String TEXT_1442 = ") > self::";
  protected final String TEXT_1443 = "())" + NL + "    {";
  protected final String TEXT_1444 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1445 = " = $";
  protected final String TEXT_1446 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1447 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1448 = NL + "  ";
  protected final String TEXT_1449 = " function ";
  protected final String TEXT_1450 = "($";
  protected final String TEXT_1451 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1452 = NL + "    $";
  protected final String TEXT_1453 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1454 = " as $";
  protected final String TEXT_1455 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1456 = ",$";
  protected final String TEXT_1457 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1458 = "[] = $";
  protected final String TEXT_1459 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1460 = ") != count($";
  protected final String TEXT_1461 = ") || count($";
  protected final String TEXT_1462 = ") < self::";
  protected final String TEXT_1463 = "())" + NL + "    {";
  protected final String TEXT_1464 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1465 = " = $";
  protected final String TEXT_1466 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1467 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1468 = NL + "  public function sort(&$toSort, $thePriority)" + NL + "  {" + NL + "    if(count($toSort) > 0)" + NL + "    {" + NL + "      $methodName = \"get\".ucfirst($thePriority);" + NL + "      usort($toSort, function($x, $y) use ($methodName)" + NL + "      {" + NL + "        $var1 = call_user_func(array($x, $methodName));" + NL + "        $var2 = call_user_func(array($y, $methodName));" + NL + "        return $var1 - $var2;" + NL + "      });" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1469 = NL + "  public function ";
  protected final String TEXT_1470 = "($";
  protected final String TEXT_1471 = ", $index)" + NL + "  {  " + NL + "    $wasAdded = false;" + NL + "    if($this->";
  protected final String TEXT_1472 = "($";
  protected final String TEXT_1473 = "))" + NL + "    {" + NL + "      if($index < 0 ) { $index = 0; }" + NL + "      if($index > $this->";
  protected final String TEXT_1474 = "()) { $index = $this->";
  protected final String TEXT_1475 = "() - 1; }" + NL + "      array_splice($this->";
  protected final String TEXT_1476 = ", $this->";
  protected final String TEXT_1477 = "($";
  protected final String TEXT_1478 = "), 1);" + NL + "      array_splice($this->";
  protected final String TEXT_1479 = ", $index, 0, array($";
  protected final String TEXT_1480 = "));" + NL + "      $wasAdded = true;" + NL + "    }" + NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1481 = "($";
  protected final String TEXT_1482 = ", $index)" + NL + "  {" + NL + "    $wasAdded = false;" + NL + "    if($this->";
  protected final String TEXT_1483 = "($";
  protected final String TEXT_1484 = ") !== -1)" + NL + "    {" + NL + "      if($index < 0 ) { $index = 0; }" + NL + "      if($index > $this->";
  protected final String TEXT_1485 = "()) { $index = $this->";
  protected final String TEXT_1486 = "() - 1; }" + NL + "      array_splice($this->";
  protected final String TEXT_1487 = ", $this->";
  protected final String TEXT_1488 = "($";
  protected final String TEXT_1489 = "), 1);" + NL + "      array_splice($this->";
  protected final String TEXT_1490 = ", $index, 0, array($";
  protected final String TEXT_1491 = "));" + NL + "      $wasAdded = true;" + NL + "    } " + NL + "    else " + NL + "    {" + NL + "      $wasAdded = $this->";
  protected final String TEXT_1492 = "($";
  protected final String TEXT_1493 = ", $index);" + NL + "    }" + NL + "    return $wasAdded;" + NL + "  }" + NL;
  protected final String TEXT_1494 = NL + "  public function equals($compareTo)" + NL + "  {" + NL + "    if ($compareTo == null) { return false; }" + NL + "    if (get_class($this) != get_class($compareTo)) { return false; }" + NL;
  protected final String TEXT_1495 = NL + "    ";
  protected final String TEXT_1496 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public function hashCode()" + NL + "  {" + NL + "    if ($this->cachedHashCode != -1)" + NL + "    {" + NL + "      return $this->cachedHashCode;" + NL + "    }" + NL + "    $this->cachedHashCode = 17;";
  protected final String TEXT_1497 = NL + "    ";
  protected final String TEXT_1498 = NL;
  protected final String TEXT_1499 = NL + "    ";
  protected final String TEXT_1500 = NL + "    return $this->cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1501 = NL + "  public function equals($compareTo)" + NL + "  {" + NL + "    return $this == $compareTo;" + NL + "  }" + NL;
  protected final String TEXT_1502 = NL + "    $this->";
  protected final String TEXT_1503 = " = null;";
  protected final String TEXT_1504 = NL + "    $this->";
  protected final String TEXT_1505 = " = array();";
  protected final String TEXT_1506 = NL + "    $";
  protected final String TEXT_1507 = " = $this->";
  protected final String TEXT_1508 = ";" + NL + "    $this->";
  protected final String TEXT_1509 = " = null;" + NL + "    if ($";
  protected final String TEXT_1510 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_1511 = "->delete();" + NL + "    }";
  protected final String TEXT_1512 = NL + "    if ($this->";
  protected final String TEXT_1513 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1514 = "->";
  protected final String TEXT_1515 = "(null);" + NL + "    }";
  protected final String TEXT_1516 = NL + "    $";
  protected final String TEXT_1517 = " = $this->";
  protected final String TEXT_1518 = ";" + NL + "    $this->";
  protected final String TEXT_1519 = " = null;" + NL + "    if ($";
  protected final String TEXT_1520 = " != null)" + NL + "    {" + NL + "      $";
  ...
  protected final String TEXT_1525 = ";" + NL + "    $this->";
  protected final String TEXT_1526 = " = null;" + NL + "    if ($";
  protected final String TEXT_1527 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_1528 = "->delete();" + NL + "    }";
  protected final String TEXT_1529 = NL + "    if ($this->";
  protected final String TEXT_1530 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1531 = "->";
  protected final String TEXT_1532 = "($this);" + NL + "    }";
  protected final String TEXT_1533 = NL + "    if ($this->";
  protected final String TEXT_1534 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1535 = "->delete();" + NL + "    }";
  protected final String TEXT_1536 = NL + "    if ($this->";
  protected final String TEXT_1537 = " != null)" + NL + "    {" + NL + "      if ($this->";
  protected final String TEXT_1538 = "->";
  protected final String TEXT_1539 = "() <= ";
  protected final String TEXT_1540 = ")" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1541 = "->delete();" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1542 = "->";
  protected final String TEXT_1543 = "($this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1544 = NL + "    $";
  protected final String TEXT_1545 = " = $this->";
  protected final String TEXT_1546 = ";" + NL + "    $this->";
  protected final String TEXT_1547 = " = null;" + NL + "    $";
  protected final String TEXT_1548 = "->";
  protected final String TEXT_1549 = "($this);";
  protected final String TEXT_1550 = NL + "    foreach ($this->";
  protected final String TEXT_1551 = " as $";
  protected final String TEXT_1552 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1553 = "($";
  protected final String TEXT_1554 = ",null);" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_1555 = " = array();";
  protected final String TEXT_1556 = NL + "    $";
  protected final String TEXT_1557 = " = $this->";
  protected final String TEXT_1558 = ";" + NL + "    $this->";
  protected final String TEXT_1559 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1560 = " as $";
  protected final String TEXT_1561 = ")" + NL + "    {" + NL + "      if ($";
  ...
  protected final String TEXT_1566 = "->delete();" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1567 = "->";
  protected final String TEXT_1568 = "($this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1569 = NL + "    $";
  protected final String TEXT_1570 = " = $this->";
  protected final String TEXT_1571 = ";" + NL + "    $this->";
  protected final String TEXT_1572 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1573 = " as $";
  protected final String TEXT_1574 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1575 = "->";
  protected final String TEXT_1576 = "($this);" + NL + "    }";
  protected final String TEXT_1577 = NL + "    foreach ($this->";
  protected final String TEXT_1578 = " as $";
  protected final String TEXT_1579 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1580 = "->delete();" + NL + "    }";
  protected final String TEXT_1581 = NL + "    foreach ($this->";
  protected final String TEXT_1582 = " as $";
  protected final String TEXT_1583 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1584 = "->";
  protected final String TEXT_1585 = "(null);" + NL + "    }";
  protected final String TEXT_1586 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1587 = NL + "  ";
  protected final String TEXT_1588 = NL + "}" + NL + "?>";
