...
public class PhpClassGenerator implements ILang
{
  ...
  protected final String TEXT_275 = "()" + NL + "  {" + NL + "    $answer = $this->";
  protected final String TEXT_276 = "();";
  protected final String TEXT_277 = NL + "    return $answer;" + NL + "  }" + NL;
  protected final String TEXT_278 = NL + "  public function ";
  protected final String TEXT_279 = "()" + NL + "  {";
  protected final String TEXT_280 = NL + "    return null;" + NL + "  }" + NL;
  protected final String TEXT_281 = NL + "  public function ";
  protected final String TEXT_282 = "()" + NL + "  {" + NL + "    $wasEventProcessed = false;";
  protected final String TEXT_283 = NL + "    ";
  protected final String TEXT_284 = NL + "    return $wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_285 = NL + "  public function ";
  protected final String TEXT_286 = "($";
  protected final String TEXT_287 = ")" + NL + "  {";
  protected final String TEXT_288 = NL + "    ";
  protected final String TEXT_289 = NL + "    else" + NL + "    {" + NL + "      return false;" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_290 = NL + "  private function ";
  protected final String TEXT_291 = "()" + NL + "  {";
  protected final String TEXT_292 = NL + "    ";
  protected final String TEXT_293 = NL + "  }" + NL;
  protected final String TEXT_294 = NL + "  private function ";
  protected final String TEXT_295 = "($";
  protected final String TEXT_296 = ")" + NL + "  {";
  protected final String TEXT_297 = NL + "    $this->";
  protected final String TEXT_298 = " = $";
  protected final String TEXT_299 = ";";
  protected final String TEXT_300 = NL + "    if ($this->";
  protected final String TEXT_301 = " != self::$";
  protected final String TEXT_302 = " && $";
  protected final String TEXT_303 = " != self::$";
  protected final String TEXT_304 = ") { $this->";
  protected final String TEXT_305 = "(self::$";
  protected final String TEXT_306 = "); }";
  protected final String TEXT_307 = NL + NL + "    // entry actions and do activities";
  protected final String TEXT_308 = NL + "    ";
  protected final String TEXT_309 = NL + "  }" + NL;
  protected final String TEXT_310 = NL + "  public function ";
  protected final String TEXT_311 = "()" + NL + "  {";
  protected final String TEXT_312 = NL + "    return $this->";
  ...
  protected final String TEXT_320 = NL + "  public function ";
  protected final String TEXT_321 = "($index)" + NL + "  {";
  protected final String TEXT_322 = NL + "    $";
  protected final String TEXT_323 = " = $this->";
  protected final String TEXT_324 = "[$index];";
  protected final String TEXT_325 = NL + "    return $";
  protected final String TEXT_326 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_327 = "()" + NL + "  {";
  protected final String TEXT_328 = NL + "    $";
  protected final String TEXT_329 = " = $this->";
  protected final String TEXT_330 = ";";
  protected final String TEXT_331 = NL + "    return $";
  protected final String TEXT_332 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_333 = "()" + NL + "  {";
  protected final String TEXT_334 = NL + "    $number = count($this->";
  protected final String TEXT_335 = ");";
  protected final String TEXT_336 = NL + "    return $number;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_337 = "()" + NL + "  {";
  protected final String TEXT_338 = NL + "    $has = $this->";
  protected final String TEXT_339 = "() > 0;";
  protected final String TEXT_340 = NL + "    return $has;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_341 = "($";
  protected final String TEXT_342 = ")" + NL + "  {";
  protected final String TEXT_343 = NL + "    $wasFound = false;" + NL + "    $index = 0;" + NL + "    foreach($this->";
  protected final String TEXT_344 = " as $";
  protected final String TEXT_345 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_346 = "->equals($";
  protected final String TEXT_347 = "))" + NL + "      {" + NL + "        $wasFound = true;" + NL + "        break;" + NL + "      }" + NL + "      $index += 1;" + NL + "    }" + NL + "    $index = $wasFound ? $index : -1;";
  ...
  protected final String TEXT_354 = NL + "    $isValid = $this->";
  protected final String TEXT_355 = "() >= self::";
  protected final String TEXT_356 = "();";
  protected final String TEXT_357 = NL + "    $isValid = $this->";
  protected final String TEXT_358 = "() >= self::";
  protected final String TEXT_359 = "() && $this->";
  protected final String TEXT_360 = "() <= self::";
  ...
  protected final String TEXT_368 = NL + "    $minimum = ";
  protected final String TEXT_369 = ";";
  protected final String TEXT_370 = NL + "    return $minimum;" + NL + "  }";
  ...
  protected final String TEXT_376 = NL + "    $minimum = ";
  protected final String TEXT_377 = ";";
  protected final String TEXT_378 = NL + "    return $minimum;" + NL + "  }";
  protected final String TEXT_379 = NL + "  public static function ";
  protected final String TEXT_380 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_381 = ";" + NL + "  }";
  protected final String TEXT_382 = NL + "  public static function ";
  protected final String TEXT_383 = "()" + NL + "  {";
  protected final String TEXT_384 = NL + "    $maximum = ";
  protected final String TEXT_385 = ";";
  protected final String TEXT_386 = NL + "    return $maximum;" + NL + "  }";
  protected final String TEXT_387 = NL + "  public function ";
  protected final String TEXT_388 = "($";
  protected final String TEXT_389 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_390 = NL + "    if ($this->";
  protected final String TEXT_391 = "() >= self::";
  protected final String TEXT_392 = "())" + NL + "    {";
  protected final String TEXT_393 = NL + "      return $wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_394 = NL + "    $this->";
  protected final String TEXT_395 = "[] = $";
  protected final String TEXT_396 = ";" + NL + "    if ($";
  protected final String TEXT_397 = "->";
  protected final String TEXT_398 = "($this) != -1)" + NL + "    {" + NL + "      $wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasAdded = $";
  protected final String TEXT_399 = "->";
  protected final String TEXT_400 = "($this);" + NL + "      if (!$wasAdded)" + NL + "      {" + NL + "        array_pop($this->";
  protected final String TEXT_401 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_402 = NL + "    return $wasAdded;" + NL + "  }";
  protected final String TEXT_403 = NL + "  public function ";
  protected final String TEXT_404 = "($";
  protected final String TEXT_405 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_406 = NL + "    if ($this->";
  protected final String TEXT_407 = "($";
  protected final String TEXT_408 = ") == -1)" + NL + "    {";
  protected final String TEXT_409 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_410 = "($";
  protected final String TEXT_411 = ");" + NL + "    unset($this->";
  protected final String TEXT_412 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_413 = "->";
  protected final String TEXT_414 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_415 = "->";
  protected final String TEXT_416 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_417 = "[$oldIndex] = $";
  protected final String TEXT_418 = ";" + NL + "        ksort($this->";
  protected final String TEXT_419 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_420 = " = array_values($this->";
  protected final String TEXT_421 = ");";
  protected final String TEXT_422 = NL + "    return $wasRemoved;" + NL + "  }";
  protected final String TEXT_423 = NL + "  public function ";
  protected final String TEXT_424 = "($";
  protected final String TEXT_425 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_426 = NL + "    $this->";
  protected final String TEXT_427 = " = $";
  protected final String TEXT_428 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_429 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_430 = NL + "  public function ";
  protected final String TEXT_431 = "($";
  protected final String TEXT_432 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_433 = NL + "    if ($";
  protected final String TEXT_434 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_435 = " = $";
  protected final String TEXT_436 = ";" + NL + "      $wasSet = true;" + NL + "    }";
  protected final String TEXT_437 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_438 = NL + "  public function ";
  protected final String TEXT_439 = "($";
  protected final String TEXT_440 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_441 = NL + "    if ($this->";
  protected final String TEXT_442 = " != null && $this->";
  protected final String TEXT_443 = " != $";
  protected final String TEXT_444 = " && $this == $this->";
  protected final String TEXT_445 = "->";
  protected final String TEXT_446 = "())" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_447 = ", as existing ";
  protected final String TEXT_448 = " would become an orphan";
  protected final String TEXT_449 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $this->";
  protected final String TEXT_450 = " = $";
  protected final String TEXT_451 = ";" + NL + "    $";
  protected final String TEXT_452 = " = $";
  protected final String TEXT_453 = " != null ? $";
  protected final String TEXT_454 = "->";
  protected final String TEXT_455 = "() : null;" + NL + "    " + NL + "    if ($this != $";
  protected final String TEXT_456 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_457 = " != null)" + NL + "      {" + NL + "        $";
  protected final String TEXT_458 = "->";
  protected final String TEXT_459 = " = null;" + NL + "      }" + NL + "      if ($this->";
  protected final String TEXT_460 = " != null)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_461 = "->";
  protected final String TEXT_462 = "($this);" + NL + "      }" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_463 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_464 = NL + "  public function ";
  protected final String TEXT_465 = "($";
  protected final String TEXT_466 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_467 = NL + "    if ($";
  protected final String TEXT_468 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_469 = " to null, as ";
  protected final String TEXT_470 = " must always be associated to a ";
  protected final String TEXT_471 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_472 = " = $";
  protected final String TEXT_473 = "->";
  protected final String TEXT_474 = "();" + NL + "    if ($";
  protected final String TEXT_475 = " != null && $this != $";
  protected final String TEXT_476 = ")" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_477 = ", the current ";
  protected final String TEXT_478 = " already has a ";
  protected final String TEXT_479 = ", which would be orphaned if it were re-assigned";
  protected final String TEXT_480 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_481 = " = $this->";
  protected final String TEXT_482 = ";" + NL + "    $this->";
  protected final String TEXT_483 = " = $";
  protected final String TEXT_484 = ";" + NL + "    $this->";
  protected final String TEXT_485 = "->";
  protected final String TEXT_486 = "($this);" + NL + "    " + NL + "    if ($";
  protected final String TEXT_487 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_488 = "->";
  protected final String TEXT_489 = "(null);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_490 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_491 = NL + "  public function ";
  protected final String TEXT_492 = "(";
  protected final String TEXT_493 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_494 = "(";
  protected final String TEXT_495 = ");" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_496 = "($";
  protected final String TEXT_497 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_498 = NL + "    $";
  protected final String TEXT_499 = " = $";
  protected final String TEXT_500 = "->";
  protected final String TEXT_501 = "();" + NL + "    $";
  protected final String TEXT_502 = " = $";
  protected final String TEXT_503 = " != null && $this !== $";
  protected final String TEXT_504 = ";" + NL + "" + NL + "    if ($";
  protected final String TEXT_505 = " && $";
  protected final String TEXT_506 = "->";
  protected final String TEXT_507 = "() <= self::";
  protected final String TEXT_508 = "())" + NL + "    {" + NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    if ($";
  protected final String TEXT_509 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_510 = "->";
  protected final String TEXT_511 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_512 = "[] = $";
  protected final String TEXT_513 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_514 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_515 = "($";
  protected final String TEXT_516 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_517 = NL + "    //Unable to remove ";
  protected final String TEXT_518 = ", as it must always have a ";
  protected final String TEXT_519 = NL + "    if ($this === $";
  protected final String TEXT_520 = "->";
  protected final String TEXT_521 = "())" + NL + "    {";
  protected final String TEXT_522 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_523 = " already at minimum (";
  protected final String TEXT_524 = ")" + NL + "    if ($this->";
  protected final String TEXT_525 = "() <= self::";
  protected final String TEXT_526 = "())" + NL + "    {";
  protected final String TEXT_527 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_528 = "[$this->";
  protected final String TEXT_529 = "($";
  protected final String TEXT_530 = ")]);" + NL + "    $this->";
  protected final String TEXT_531 = " = array_values($this->";
  protected final String TEXT_532 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_533 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_534 = NL + "  public function ";
  protected final String TEXT_535 = "(";
  protected final String TEXT_536 = ")" + NL + "  {" + NL + "    if ($this->";
  protected final String TEXT_537 = "() >= self::";
  protected final String TEXT_538 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_539 = "(";
  protected final String TEXT_540 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_541 = "($";
  protected final String TEXT_542 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_543 = NL + "    if ($this->";
  protected final String TEXT_544 = "() >= self::";
  protected final String TEXT_545 = "())" + NL + "    {";
  protected final String TEXT_546 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_547 = " = $";
  protected final String TEXT_548 = "->";
  protected final String TEXT_549 = "();" + NL + "    $";
  protected final String TEXT_550 = " = $";
  protected final String TEXT_551 = " != null && $this !== $";
  protected final String TEXT_552 = ";" + NL + "" + NL + "    if ($";
  protected final String TEXT_553 = " && $";
  protected final String TEXT_554 = "->";
  protected final String TEXT_555 = "() <= self::";
  protected final String TEXT_556 = "())" + NL + "    {";
  protected final String TEXT_557 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    if ($";
  protected final String TEXT_558 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_559 = "->";
  protected final String TEXT_560 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_561 = "[] = $";
  protected final String TEXT_562 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_563 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_564 = "($";
  protected final String TEXT_565 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_566 = NL + "    //Unable to remove ";
  protected final String TEXT_567 = ", as it must always have a ";
  protected final String TEXT_568 = NL + "    if ($this === $";
  protected final String TEXT_569 = "->";
  protected final String TEXT_570 = "())" + NL + "    {";
  protected final String TEXT_571 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_572 = " already at minimum (";
  protected final String TEXT_573 = ")" + NL + "    if ($this->";
  protected final String TEXT_574 = "() <= self::";
  protected final String TEXT_575 = "())" + NL + "    {";
  protected final String TEXT_576 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  ...
  protected final String TEXT_581 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_582 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_583 = NL + "  public function ";
  protected final String TEXT_584 = "(";
  protected final String TEXT_585 = ")" + NL + "  {" + NL + "    if ($this->";
  protected final String TEXT_586 = "() >= self::";
  protected final String TEXT_587 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_588 = "(";
  protected final String TEXT_589 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_590 = "($";
  protected final String TEXT_591 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_592 = NL + "    if ($this->";
  protected final String TEXT_593 = "() >= self::";
  protected final String TEXT_594 = "())" + NL + "    {";
  protected final String TEXT_595 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_596 = " = $";
  protected final String TEXT_597 = "->";
  protected final String TEXT_598 = "();" + NL + "    $";
  protected final String TEXT_599 = " = $";
  protected final String TEXT_600 = " != null && $this !== $";
  protected final String TEXT_601 = ";" + NL + "    if ($";
  protected final String TEXT_602 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_603 = "->";
  protected final String TEXT_604 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_605 = "[] = $";
  protected final String TEXT_606 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_607 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_608 = "($";
  protected final String TEXT_609 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  ...
  protected final String TEXT_614 = "())" + NL + "    {" + NL + "      unset($this->";
  ...
  protected final String TEXT_619 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_620 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_621 = NL + "  public function ";
  protected final String TEXT_622 = "($";
  protected final String TEXT_623 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_624 = NL + "    $";
  protected final String TEXT_625 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_626 = " as $";
  protected final String TEXT_627 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_628 = ",$";
  protected final String TEXT_629 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_630 = "[] = $";
  protected final String TEXT_631 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_632 = ") != count($";
  protected final String TEXT_633 = ") || count($";
  protected final String TEXT_634 = ") > self::";
  protected final String TEXT_635 = "())" + NL + "    {";
  protected final String TEXT_636 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_637 = " = $this->";
  protected final String TEXT_638 = ";" + NL + "    $this->";
  protected final String TEXT_639 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_640 = " as $";
  protected final String TEXT_641 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_642 = "[] = $";
  protected final String TEXT_643 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_644 = ",$";
  protected final String TEXT_645 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_646 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_647 = " = array_values($";
  protected final String TEXT_648 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_649 = "->";
  protected final String TEXT_650 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_651 = " as $";
  protected final String TEXT_652 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_653 = "->";
  protected final String TEXT_654 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_655 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_656 = NL + "  public function ";
  protected final String TEXT_657 = "(";
  protected final String TEXT_658 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_659 = "(";
  protected final String TEXT_660 = ");" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_661 = "($";
  protected final String TEXT_662 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_663 = NL + "    $";
  protected final String TEXT_664 = " = $";
  protected final String TEXT_665 = "->";
  protected final String TEXT_666 = "();" + NL + "    $";
  protected final String TEXT_667 = " = $";
  protected final String TEXT_668 = " != null && $this !== $";
  protected final String TEXT_669 = ";" + NL + "    if ($";
  protected final String TEXT_670 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_671 = "->";
  protected final String TEXT_672 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_673 = "[] = $";
  protected final String TEXT_674 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_675 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_676 = "($";
  protected final String TEXT_677 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_678 = NL + "    //Unable to remove ";
  protected final String TEXT_679 = ", as it must always have a ";
  protected final String TEXT_680 = NL + "    if ($this !== $";
  protected final String TEXT_681 = "->";
  protected final String TEXT_682 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_683 = "[$this->";
  protected final String TEXT_684 = "($";
  protected final String TEXT_685 = ")]);" + NL + "      $this->";
  protected final String TEXT_686 = " = array_values($this->";
  protected final String TEXT_687 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_688 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_689 = NL + "  public function ";
  protected final String TEXT_690 = "($";
  protected final String TEXT_691 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_692 = NL + "    if ($";
  protected final String TEXT_693 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_694 = " = $this->";
  protected final String TEXT_695 = ";" + NL + "      $this->";
  protected final String TEXT_696 = " = null;" + NL + "      " + NL + "      if ($";
  protected final String TEXT_697 = " != null && $";
  protected final String TEXT_698 = "->";
  protected final String TEXT_699 = "() != null)" + NL + "      {" + NL + "        $";
  protected final String TEXT_700 = "->";
  protected final String TEXT_701 = "(null);" + NL + "      }" + NL + "      $wasSet = true;";
  ...
  protected final String TEXT_709 = "(null);" + NL + "    }" + NL + "    " + NL + "    $this->";
  protected final String TEXT_710 = " = $";
  protected final String TEXT_711 = ";" + NL + "    $";
  protected final String TEXT_712 = " = $";
  protected final String TEXT_713 = "->";
  protected final String TEXT_714 = "();" + NL + "    " + NL + "    if ($this != $";
  protected final String TEXT_715 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_716 = "->";
  protected final String TEXT_717 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_718 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_719 = NL + "  public function ";
  protected final String TEXT_720 = "($";
  protected final String TEXT_721 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_722 = NL + "    if ($this->";
  protected final String TEXT_723 = "($";
  protected final String TEXT_724 = ") == -1)" + NL + "    {";
  protected final String TEXT_725 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_726 = "() <= self::";
  protected final String TEXT_727 = "())" + NL + "    {";
  protected final String TEXT_728 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_729 = "($";
  protected final String TEXT_730 = ");" + NL + "    unset($this->";
  protected final String TEXT_731 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_732 = "->";
  protected final String TEXT_733 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_734 = "->";
  protected final String TEXT_735 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_736 = "[$oldIndex] = $";
  protected final String TEXT_737 = ";" + NL + "        ksort($this->";
  protected final String TEXT_738 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_739 = " = array_values($this->";
  ...
  protected final String TEXT_767 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  ...
  protected final String TEXT_783 = "($this);" + NL + "    }" + NL + "    if ($";
  protected final String TEXT_784 = " != null)" + NL + "    {" + NL + "      $";
  ...
  protected final String TEXT_793 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  ...
  protected final String TEXT_802 = "($this);" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_803 = "->";
  protected final String TEXT_804 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_805 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_806 = NL + "  public function ";
  protected final String TEXT_807 = "($";
  protected final String TEXT_808 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_809 = NL + "    //Must provide ";
  protected final String TEXT_810 = " to ";
  protected final String TEXT_811 = NL + "    if ($";
  protected final String TEXT_812 = " == null)" + NL + "    {";
  protected final String TEXT_813 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_814 = " already at maximum (";
  ...
  protected final String TEXT_827 = ")" + NL + "    {" + NL + "      $didRemove = $";
  protected final String TEXT_828 = "->";
  protected final String TEXT_829 = "($this);" + NL + "      if (!$didRemove)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_830 = " = $";
  protected final String TEXT_831 = ";";
  protected final String TEXT_832 = NL + "        return $wasSet;" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_833 = "->";
  protected final String TEXT_834 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_835 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_836 = NL + "  public function ";
  protected final String TEXT_837 = "($";
  protected final String TEXT_838 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_839 = NL + "    //Must provide ";
  protected final String TEXT_840 = " to ";
  protected final String TEXT_841 = NL + "    if ($";
  protected final String TEXT_842 = " == null)" + NL + "    {";
  protected final String TEXT_843 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_844 = " != null && $this->";
  protected final String TEXT_845 = "->";
  protected final String TEXT_846 = "() <= ";
  protected final String TEXT_847 = "::";
  protected final String TEXT_848 = "())" + NL + "    {";
  protected final String TEXT_849 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_850 = " = $this->";
  protected final String TEXT_851 = ";" + NL + "    $this->";
  protected final String TEXT_852 = " = $";
  protected final String TEXT_853 = ";" + NL + "    if ($";
  protected final String TEXT_854 = " != null && $";
  protected final String TEXT_855 = " != $";
  protected final String TEXT_856 = ")" + NL + "    {" + NL + "      $didRemove = $";
  protected final String TEXT_857 = "->";
  protected final String TEXT_858 = "($this);" + NL + "      if (!$didRemove)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_859 = " = $";
  protected final String TEXT_860 = ";";
  protected final String TEXT_861 = NL + "        return $wasSet;" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_862 = "->";
  protected final String TEXT_863 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_864 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_865 = NL + "  public function ";
  protected final String TEXT_866 = "($";
  protected final String TEXT_867 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  ...
  protected final String TEXT_874 = "($this);" + NL + "    }" + NL + "    elseif ($this !== $";
  protected final String TEXT_875 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_876 = "->";
  protected final String TEXT_877 = "($";
  protected final String TEXT_878 = ");" + NL + "      $this->";
  protected final String TEXT_879 = "($";
  protected final String TEXT_880 = ");" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_881 = "[] = $";
  protected final String TEXT_882 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_883 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_884 = "($";
  protected final String TEXT_885 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_886 = NL + "    if ($this->";
  protected final String TEXT_887 = "($";
  protected final String TEXT_888 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_889 = "[$this->";
  protected final String TEXT_890 = "($";
  protected final String TEXT_891 = ")]);" + NL + "      $this->";
  protected final String TEXT_892 = " = array_values($this->";
  protected final String TEXT_893 = ");" + NL + "      if ($this === $";
  protected final String TEXT_894 = "->";
  protected final String TEXT_895 = "())" + NL + "      {" + NL + "        $";
  protected final String TEXT_896 = "->";
  protected final String TEXT_897 = "(null);" + NL + "      }" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_898 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_899 = NL + "  public function ";
  protected final String TEXT_900 = "($";
  protected final String TEXT_901 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  ...
  protected final String TEXT_911 = "($this);" + NL + "    }" + NL + "    if ($";
  ...
  protected final String TEXT_918 = NL + "  public function ";
  protected final String TEXT_919 = "($";
  protected final String TEXT_920 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_921 = NL + "    if ($this->";
  protected final String TEXT_922 = "() >= self::";
  protected final String TEXT_923 = "())" + NL + "    {";
  protected final String TEXT_924 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_925 = " = $";
  protected final String TEXT_926 = "->";
  protected final String TEXT_927 = "();" + NL + "    if ($";
  protected final String TEXT_928 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_929 = "->";
  protected final String TEXT_930 = "($this);" + NL + "    }" + NL + "    else if ($this !== $";
  protected final String TEXT_931 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_932 = "->";
  protected final String TEXT_933 = "($";
  protected final String TEXT_934 = ");" + NL + "      $this->";
  protected final String TEXT_935 = "($";
  protected final String TEXT_936 = ");" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_937 = "[] = $";
  protected final String TEXT_938 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_939 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_940 = "($";
  protected final String TEXT_941 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_942 = NL + "    if ($this->";
  protected final String TEXT_943 = "($";
  protected final String TEXT_944 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_945 = "[$this->";
  protected final String TEXT_946 = "($";
  protected final String TEXT_947 = ")]);" + NL + "      $this->";
  protected final String TEXT_948 = " = array_values($this->";
  protected final String TEXT_949 = ");" + NL + "      $";
  protected final String TEXT_950 = "->";
  protected final String TEXT_951 = "(null);" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_952 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_953 = NL + "  public function ";
  protected final String TEXT_954 = "($";
  protected final String TEXT_955 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_956 = NL + "    if ($this->";
  protected final String TEXT_957 = "() < self::";
  protected final String TEXT_958 = "())" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_959 = "[] = $";
  protected final String TEXT_960 = ";" + NL + "      $wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_966 = ") == -1)" + NL + "    {";
  protected final String TEXT_967 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_968 = "() <= self::";
  protected final String TEXT_969 = "())" + NL + "    {";
  protected final String TEXT_970 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_971 = "[$this->";
  protected final String TEXT_972 = "($";
  protected final String TEXT_973 = ")]);" + NL + "    $this->";
  protected final String TEXT_974 = " = array_values($this->";
  protected final String TEXT_975 = ");" + NL + "    $wasRemoved = true;";
  ...
  protected final String TEXT_983 = NL + "      return $wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_992 = NL + "      return $wasAdded;" + NL + "    }" + NL + "    else if ($";
  protected final String TEXT_993 = " != null)" + NL + "    {" + NL + "      unset($";
  ...
  protected final String TEXT_1000 = " = array_values($";
  protected final String TEXT_1001 = "->";
  protected final String TEXT_1002 = ");" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_1003 = "[] = $";
  protected final String TEXT_1004 = ";" + NL + "    $this->";
  protected final String TEXT_1005 = "($";
  protected final String TEXT_1006 = ",$this);" + NL + "    $wasAdded = true;";
  protected final String TEXT_1007 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1008 = "($";
  protected final String TEXT_1009 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1010 = NL + "    if ($this->";
  protected final String TEXT_1011 = "($";
  protected final String TEXT_1012 = ") != -1 && $this->";
  protected final String TEXT_1013 = "() > self::";
  protected final String TEXT_1014 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1015 = "[$this->";
  protected final String TEXT_1016 = "($";
  protected final String TEXT_1017 = ")]);" + NL + "      $this->";
  protected final String TEXT_1018 = " = array_values($this->";
  protected final String TEXT_1019 = ");" + NL + "      $this->";
  protected final String TEXT_1020 = "($";
  protected final String TEXT_1021 = ",null);" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1022 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1023 = NL + "  public function ";
  protected final String TEXT_1024 = "($";
  protected final String TEXT_1025 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1026 = NL + "    $";
  protected final String TEXT_1027 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1028 = " as $";
  protected final String TEXT_1029 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1030 = ",$";
  protected final String TEXT_1031 = ") !== false)" + NL + "      {";
  protected final String TEXT_1032 = NL + "        return $wasSet;" + NL + "      }" + NL + "      else if ($";
  protected final String TEXT_1033 = "->";
  protected final String TEXT_1034 = "() != null && $this !== $";
  protected final String TEXT_1035 = "->";
  protected final String TEXT_1036 = "())" + NL + "      {";
  protected final String TEXT_1037 = NL + "        return $wasSet;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1038 = "[] = $";
  protected final String TEXT_1039 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1040 = ") != self::";
  protected final String TEXT_1041 = "())" + NL + "    {";
  protected final String TEXT_1042 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    foreach ($this->";
  protected final String TEXT_1043 = " as $orphan) " + NL + "    {" + NL + "      $wasFound = false;" + NL + "      foreach ($";
  protected final String TEXT_1044 = " as $fosterCare)" + NL + "      {" + NL + "        if ($orphan == $fosterCare)" + NL + "        {" + NL + "          $wasFound = true;" + NL + "          break;" + NL + "        }" + NL + "      }" + NL + "" + NL + "      if (!$wasFound)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1045 = "($orphan, null);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1046 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1047 = " as $";
  protected final String TEXT_1048 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1049 = "($";
  protected final String TEXT_1050 = ", $this);" + NL + "      $this->";
  protected final String TEXT_1051 = "[] = $";
  protected final String TEXT_1052 = ";" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1053 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1054 = NL + "  private function ";
  protected final String TEXT_1055 = "($";
  protected final String TEXT_1056 = ", $";
  protected final String TEXT_1057 = ")" + NL + "  {" + NL + "    $";
  protected final String TEXT_1058 = "->mentor = $";
  protected final String TEXT_1059 = ";" + NL + "    //$prop = new ReflectionProperty($";
  protected final String TEXT_1060 = ", '";
  protected final String TEXT_1061 = "');" + NL + "    //$prop->setAccessible(true);" + NL + "    //$prop->setValue($";
  protected final String TEXT_1062 = ",$";
  protected final String TEXT_1063 = ");" + NL + "    //$prop->setAccessible(false);" + NL + "  }" + NL;
  ...
  protected final String TEXT_1075 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1076 = "[$this->";
  protected final String TEXT_1077 = "($";
  protected final String TEXT_1078 = ")]);" + NL + "      $this->";
  protected final String TEXT_1079 = " = array_values($this->";
  protected final String TEXT_1080 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1081 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1082 = NL + "  public function ";
  protected final String TEXT_1083 = "($";
  protected final String TEXT_1084 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1085 = NL + "    if ($this->";
  protected final String TEXT_1086 = "() < self::";
  protected final String TEXT_1087 = "())" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1088 = "[] = $";
  protected final String TEXT_1089 = ";" + NL + "      $wasAdded = true;" + NL + "    }";
  protected final String TEXT_1090 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1091 = "($";
  protected final String TEXT_1092 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1093 = NL + "    if ($this->";
  protected final String TEXT_1094 = "($";
  protected final String TEXT_1095 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1096 = "[$this->";
  protected final String TEXT_1097 = "($";
  protected final String TEXT_1098 = ")]);" + NL + "      $this->";
  protected final String TEXT_1099 = " = array_values($this->";
  protected final String TEXT_1100 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1101 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1102 = NL + "  public function ";
  protected final String TEXT_1103 = "($";
  protected final String TEXT_1104 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1105 = NL + "    $this->";
  protected final String TEXT_1106 = "[] = $";
  protected final String TEXT_1107 = ";" + NL + "    $wasAdded = true;";
  protected final String TEXT_1108 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1109 = "($";
  protected final String TEXT_1110 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1111 = NL + "    if ($this->";
  protected final String TEXT_1112 = "($";
  protected final String TEXT_1113 = ") == -1)" + NL + "    {";
  protected final String TEXT_1114 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_1115 = "() <= self::";
  protected final String TEXT_1116 = "())" + NL + "    {";
  protected final String TEXT_1117 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  ...
  protected final String TEXT_1122 = ");" + NL + "    $wasRemoved = true;";
  ...
  protected final String TEXT_1126 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1127 = NL + "    $";
  protected final String TEXT_1128 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1129 = " as $";
  protected final String TEXT_1130 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1131 = ",$";
  protected final String TEXT_1132 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1133 = "[] = $";
  protected final String TEXT_1134 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1135 = ") != count($";
  protected final String TEXT_1136 = ") || count($";
  protected final String TEXT_1137 = ") != self::";
  protected final String TEXT_1138 = "())" + NL + "    {";
  protected final String TEXT_1139 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1140 = " = $";
  protected final String TEXT_1141 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1142 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1143 = NL + "  public function ";
  protected final String TEXT_1144 = "($";
  protected final String TEXT_1145 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1146 = NL + "    $";
  protected final String TEXT_1147 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1148 = " as $";
  protected final String TEXT_1149 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1150 = ",$";
  protected final String TEXT_1151 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1152 = "[] = $";
  protected final String TEXT_1153 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1154 = ") != count($";
  protected final String TEXT_1155 = ") || count($";
  protected final String TEXT_1156 = ") < self::";
  protected final String TEXT_1157 = "() || count($";
  protected final String TEXT_1158 = ") > self::";
  protected final String TEXT_1159 = "())" + NL + "    {";
  protected final String TEXT_1160 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1161 = " = $this->";
  protected final String TEXT_1162 = ";" + NL + "    $this->";
  protected final String TEXT_1163 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1164 = " as $";
  protected final String TEXT_1165 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1166 = "[] = $";
  protected final String TEXT_1167 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_1168 = ",$";
  protected final String TEXT_1169 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_1170 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_1171 = " = array_values($";
  protected final String TEXT_1172 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1173 = "->";
  protected final String TEXT_1174 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_1175 = " as $";
  protected final String TEXT_1176 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1177 = "->";
  protected final String TEXT_1178 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1179 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1180 = NL + "  public function ";
  protected final String TEXT_1181 = "($";
  protected final String TEXT_1182 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1183 = NL + "    $";
  protected final String TEXT_1184 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1185 = " as $";
  protected final String TEXT_1186 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1187 = ",$";
  protected final String TEXT_1188 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1189 = "[] = $";
  protected final String TEXT_1190 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1191 = ") != count($";
  protected final String TEXT_1192 = ") || count($";
  protected final String TEXT_1193 = ") < self::";
  protected final String TEXT_1194 = "())" + NL + "    {";
  protected final String TEXT_1195 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1196 = " = $this->";
  protected final String TEXT_1197 = ";" + NL + "    $this->";
  protected final String TEXT_1198 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1199 = " as $";
  protected final String TEXT_1200 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1201 = "[] = $";
  protected final String TEXT_1202 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_1203 = ",$";
  protected final String TEXT_1204 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_1205 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_1206 = " = array_values($";
  protected final String TEXT_1207 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1208 = "->";
  protected final String TEXT_1209 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_1210 = " as $";
  protected final String TEXT_1211 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1212 = "->";
  protected final String TEXT_1213 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1214 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1215 = NL + "  public function ";
  protected final String TEXT_1216 = "($";
  protected final String TEXT_1217 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1218 = NL + "    $";
  protected final String TEXT_1219 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1220 = " as $";
  protected final String TEXT_1221 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1222 = ",$";
  protected final String TEXT_1223 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1224 = "[] = $";
  protected final String TEXT_1225 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1226 = ") != count($";
  protected final String TEXT_1227 = ") || count($";
  protected final String TEXT_1228 = ") < self::";
  protected final String TEXT_1229 = "()  || count($";
  protected final String TEXT_1230 = ") > self::";
  protected final String TEXT_1231 = "())" + NL + "    {";
  protected final String TEXT_1232 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  ...
  protected final String TEXT_1238 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1239 = NL + "    if (count($";
  protected final String TEXT_1240 = ") < self::";
  protected final String TEXT_1241 = "()";
  protected final String TEXT_1242 = ")" + NL + "    {";
  protected final String TEXT_1243 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1244 = " = array();" + NL + "    $";
  protected final String TEXT_1245 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1246 = " as $";
  protected final String TEXT_1247 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1248 = ",$";
  protected final String TEXT_1249 = ") !== false)" + NL + "      {";
  protected final String TEXT_1250 = NL + "        return $wasSet;" + NL + "      }" + NL + "      else if ($";
  protected final String TEXT_1251 = "->";
  protected final String TEXT_1252 = "() != null && $this !== $";
  ...
  protected final String TEXT_1258 = " = serialize($";
  protected final String TEXT_1259 = ");" + NL + "        if (!array_key_exists($";
  ...
  protected final String TEXT_1265 = "();" + NL + "        }" + NL + "        $nextCount = $";
  protected final String TEXT_1266 = "[$";
  protected final String TEXT_1267 = "] - 1;" + NL + "        if ($nextCount < self::minimum";
  ...
  protected final String TEXT_1271 = "] = $nextCount;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1272 = "[] = $";
  protected final String TEXT_1273 = ";" + NL + "    }" + NL + "" + NL + "    foreach ($this->";
  protected final String TEXT_1274 = " as $orphan) " + NL + "    {" + NL + "      $wasFound = false;" + NL + "      foreach ($";
  protected final String TEXT_1275 = " as $fosterCare)" + NL + "      {" + NL + "        if ($orphan == $fosterCare)" + NL + "        {" + NL + "          $wasFound = true;" + NL + "          break;" + NL + "        }" + NL + "      }" + NL + "      " + NL + "      if (!$wasFound)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1276 = "($orphan, null);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1277 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1278 = " as $";
  protected final String TEXT_1279 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_1280 = "->";
  protected final String TEXT_1281 = "() != null)" + NL + "      {" + NL + "        unset($";
  ...
  protected final String TEXT_1294 = ");" + NL + "      }" + NL + "      $this->";
  protected final String TEXT_1295 = "($";
  protected final String TEXT_1296 = ", $this);" + NL + "      $this->";
  protected final String TEXT_1297 = "[] = $";
  protected final String TEXT_1298 = ";" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1299 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1300 = NL + "  private function ";
  protected final String TEXT_1301 = "($";
  protected final String TEXT_1302 = ", $";
  protected final String TEXT_1303 = ")" + NL + "  {" + NL + "    $";
  protected final String TEXT_1304 = "->mentor = $";
  protected final String TEXT_1305 = ";" + NL + "    //$prop = new ReflectionProperty($";
  protected final String TEXT_1306 = ", '";
  protected final String TEXT_1307 = "');" + NL + "    //$prop->setAccessible(true);" + NL + "    //$prop->setValue($";
  protected final String TEXT_1308 = ",$";
  protected final String TEXT_1309 = ");" + NL + "    //$prop->setAccessible(false);" + NL + "  }" + NL;
  protected final String TEXT_1310 = NL + "  public function ";
  protected final String TEXT_1311 = "($";
  protected final String TEXT_1312 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1313 = NL + "    $";
  protected final String TEXT_1314 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1315 = " as $";
  protected final String TEXT_1316 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1317 = ",$";
  protected final String TEXT_1318 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1319 = "[] = $";
  protected final String TEXT_1320 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  ...
  protected final String TEXT_1325 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1326 = " = $";
  protected final String TEXT_1327 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1328 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1329 = NL + "  public function ";
  protected final String TEXT_1330 = "($";
  protected final String TEXT_1331 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1332 = NL + "    $";
  protected final String TEXT_1333 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1334 = " as $";
  protected final String TEXT_1335 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1336 = ",$";
  protected final String TEXT_1337 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1338 = "[] = $";
  protected final String TEXT_1339 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1340 = ") != count($";
  protected final String TEXT_1341 = ") || count($";
  protected final String TEXT_1342 = ") < self::";
  protected final String TEXT_1343 = "())" + NL + "    {";
  protected final String TEXT_1344 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1345 = " = $";
  protected final String TEXT_1346 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1347 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1348 = NL + "  public function equals($compareTo)" + NL + "  {" + NL + "    if ($compareTo == null) { return false; }" + NL + "    if (get_class($this) != get_class($compareTo)) { return false; }" + NL;
  protected final String TEXT_1349 = NL + "    ";
  protected final String TEXT_1350 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public function hashCode()" + NL + "  {" + NL + "    if ($this->cachedHashCode != -1)" + NL + "    {" + NL + "      return $this->cachedHashCode;" + NL + "    }" + NL + "    $this->cachedHashCode = 17;";
  protected final String TEXT_1351 = NL + "    ";
  protected final String TEXT_1352 = NL;
  protected final String TEXT_1353 = NL + "    ";
  protected final String TEXT_1354 = NL + "    return $this->cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1355 = NL + "  public function equals($compareTo)" + NL + "  {" + NL + "    return $this == $compareTo;" + NL + "  }" + NL;
  protected final String TEXT_1356 = NL + "    $this->";
  protected final String TEXT_1357 = " = null;";
  protected final String TEXT_1358 = NL + "    $this->";
  protected final String TEXT_1359 = " = array();";
  protected final String TEXT_1360 = NL + "    $";
  protected final String TEXT_1361 = " = $this->";
  protected final String TEXT_1362 = ";" + NL + "    $this->";
  protected final String TEXT_1363 = " = null;" + NL + "    if ($";
  protected final String TEXT_1364 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_1365 = "->delete();" + NL + "    }";
  protected final String TEXT_1366 = NL + "    if ($this->";
  protected final String TEXT_1367 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1368 = "->";
  protected final String TEXT_1369 = "(null);" + NL + "    }";
  protected final String TEXT_1370 = NL + "    $";
  protected final String TEXT_1371 = " = $this->";
  protected final String TEXT_1372 = ";" + NL + "    $this->";
  protected final String TEXT_1373 = " = null;" + NL + "    if ($";
  protected final String TEXT_1374 = " != null)" + NL + "    {" + NL + "      $";
  ...
  protected final String TEXT_1380 = " = null;" + NL + "    if ($";
  protected final String TEXT_1381 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_1382 = "->delete();" + NL + "    }";
  protected final String TEXT_1383 = NL + "    if ($this->";
  protected final String TEXT_1384 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1385 = "->";
  protected final String TEXT_1386 = "($this);" + NL + "    }";
  protected final String TEXT_1387 = NL + "    if ($this->";
  protected final String TEXT_1388 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1389 = "->delete();" + NL + "    }";
  protected final String TEXT_1390 = NL + "    if ($this->";
  protected final String TEXT_1391 = " != null)" + NL + "    {" + NL + "      if ($this->";
  protected final String TEXT_1392 = "->";
  protected final String TEXT_1393 = "() <= ";
  protected final String TEXT_1394 = ")" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1395 = "->delete();" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1396 = "->";
  protected final String TEXT_1397 = "($this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1398 = NL + "    $this->";
  protected final String TEXT_1399 = "->";
  protected final String TEXT_1400 = "($this);";
  protected final String TEXT_1401 = NL + "    foreach ($this->";
  protected final String TEXT_1402 = " as $";
  protected final String TEXT_1403 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1404 = "($";
  protected final String TEXT_1405 = ",null);" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_1406 = " = array();";
  protected final String TEXT_1407 = NL + "    $";
  protected final String TEXT_1408 = " = $this->";
  protected final String TEXT_1409 = ";" + NL + "    $this->";
  protected final String TEXT_1410 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1411 = " as $";
  ...
  protected final String TEXT_1417 = "->delete();" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1418 = "->";
  protected final String TEXT_1419 = "($this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1420 = NL + "    $";
  protected final String TEXT_1421 = " = $this->";
  protected final String TEXT_1422 = ";" + NL + "    $this->";
  protected final String TEXT_1423 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1424 = " as $";
  protected final String TEXT_1425 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1426 = "->";
  protected final String TEXT_1427 = "($this);" + NL + "    }";
  protected final String TEXT_1428 = NL + "    foreach ($this->";
  protected final String TEXT_1429 = " as $";
  protected final String TEXT_1430 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1431 = "->delete();" + NL + "    }";
  protected final String TEXT_1432 = NL + "    foreach ($this->";
  protected final String TEXT_1433 = " as $";
  protected final String TEXT_1434 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1435 = "->";
  protected final String TEXT_1436 = "(null);" + NL + "    }";
  protected final String TEXT_1437 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
