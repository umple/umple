...
public class PhpClassGenerator implements ILang
{
  ...
  protected final String TEXT_303 = "()" + NL + "  {" + NL + "    $wasEventProcessed = false;";
  protected final String TEXT_304 = NL + "    ";
  protected final String TEXT_305 = NL + "    return $wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_306 = NL + "  public function ";
  protected final String TEXT_307 = "($";
  protected final String TEXT_308 = ")" + NL + "  {";
  protected final String TEXT_309 = NL + "    ";
  protected final String TEXT_310 = NL + "    else" + NL + "    {" + NL + "      return false;" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_311 = NL + "  private function ";
  ...
  protected final String TEXT_318 = NL + "    $this->";
  protected final String TEXT_319 = " = $";
  protected final String TEXT_320 = ";";
  protected final String TEXT_321 = NL + "    if ($this->";
  protected final String TEXT_322 = " != self::$";
  protected final String TEXT_323 = " && $";
  protected final String TEXT_324 = " != self::$";
  protected final String TEXT_325 = ") { $this->";
  protected final String TEXT_326 = "(self::$";
  protected final String TEXT_327 = "); }";
  protected final String TEXT_328 = NL + NL + "    // entry actions and do activities";
  ...
  protected final String TEXT_341 = NL + "  public function ";
  protected final String TEXT_342 = "($index)" + NL + "  {";
  protected final String TEXT_343 = NL + "    $";
  protected final String TEXT_344 = " = $this->";
  protected final String TEXT_345 = "[$index];";
  protected final String TEXT_346 = NL + "    return $";
  protected final String TEXT_347 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_348 = "()" + NL + "  {";
  protected final String TEXT_349 = NL + "    $";
  protected final String TEXT_350 = " = $this->";
  protected final String TEXT_351 = ";";
  protected final String TEXT_352 = NL + "    return $";
  protected final String TEXT_353 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_354 = "()" + NL + "  {";
  protected final String TEXT_355 = NL + "    $number = count($this->";
  protected final String TEXT_356 = ");";
  protected final String TEXT_357 = NL + "    return $number;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_358 = "()" + NL + "  {";
  protected final String TEXT_359 = NL + "    $has = $this->";
  protected final String TEXT_360 = "() > 0;";
  protected final String TEXT_361 = NL + "    return $has;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_362 = "($";
  protected final String TEXT_363 = ")" + NL + "  {";
  protected final String TEXT_364 = NL + "    $wasFound = false;" + NL + "    $index = 0;" + NL + "    foreach($this->";
  protected final String TEXT_365 = " as $";
  protected final String TEXT_366 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_367 = "->equals($";
  protected final String TEXT_368 = "))" + NL + "      {" + NL + "        $wasFound = true;" + NL + "        break;" + NL + "      }" + NL + "      $index += 1;" + NL + "    }" + NL + "    $index = $wasFound ? $index : -1;";
  protected final String TEXT_369 = NL + "    return $index;" + NL + "  }" + NL;
  protected final String TEXT_370 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_371 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_372 = " : ";
  protected final String TEXT_373 = NL + "  public function ";
  protected final String TEXT_374 = "()" + NL + "  {";
  protected final String TEXT_375 = NL + "    $isValid = $this->";
  protected final String TEXT_376 = "() >= self::";
  protected final String TEXT_377 = "();";
  protected final String TEXT_378 = NL + "    $isValid = $this->";
  protected final String TEXT_379 = "() >= self::";
  protected final String TEXT_380 = "() && $this->";
  protected final String TEXT_381 = "() <= self::";
  protected final String TEXT_382 = "();";
  protected final String TEXT_383 = NL + "    return $isValid;" + NL + "  }";
  protected final String TEXT_384 = NL + "  public static function ";
  protected final String TEXT_385 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_386 = ";" + NL + "  }";
  protected final String TEXT_387 = NL + "  public static function ";
  protected final String TEXT_388 = "()" + NL + "  {";
  protected final String TEXT_389 = NL + "    $minimum = ";
  protected final String TEXT_390 = ";";
  protected final String TEXT_391 = NL + "    return $minimum;" + NL + "  }";
  protected final String TEXT_392 = NL + "  public static function ";
  protected final String TEXT_393 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_394 = ";" + NL + "  }";
  protected final String TEXT_395 = NL + "  public static function ";
  protected final String TEXT_396 = "()" + NL + "  {";
  protected final String TEXT_397 = NL + "    $minimum = ";
  protected final String TEXT_398 = ";";
  protected final String TEXT_399 = NL + "    return $minimum;" + NL + "  }";
  protected final String TEXT_400 = NL + "  public static function ";
  protected final String TEXT_401 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_402 = ";" + NL + "  }";
  protected final String TEXT_403 = NL + "  public static function ";
  protected final String TEXT_404 = "()" + NL + "  {";
  protected final String TEXT_405 = NL + "    $maximum = ";
  protected final String TEXT_406 = ";";
  protected final String TEXT_407 = NL + "    return $maximum;" + NL + "  }";
  protected final String TEXT_408 = NL + "  public function ";
  protected final String TEXT_409 = "($";
  protected final String TEXT_410 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_411 = NL + "    if ($this->";
  protected final String TEXT_412 = "() >= self::";
  protected final String TEXT_413 = "())" + NL + "    {";
  protected final String TEXT_414 = NL + "      return $wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_415 = NL + "    $this->";
  protected final String TEXT_416 = "[] = $";
  protected final String TEXT_417 = ";" + NL + "    if ($";
  protected final String TEXT_418 = "->";
  protected final String TEXT_419 = "($this) != -1)" + NL + "    {" + NL + "      $wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasAdded = $";
  protected final String TEXT_420 = "->";
  protected final String TEXT_421 = "($this);" + NL + "      if (!$wasAdded)" + NL + "      {" + NL + "        array_pop($this->";
  protected final String TEXT_422 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_423 = NL + "    return $wasAdded;" + NL + "  }";
  protected final String TEXT_424 = NL + "  public function ";
  protected final String TEXT_425 = "($";
  protected final String TEXT_426 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_427 = NL + "    if ($this->";
  protected final String TEXT_428 = "($";
  protected final String TEXT_429 = ") == -1)" + NL + "    {";
  protected final String TEXT_430 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_431 = "($";
  protected final String TEXT_432 = ");" + NL + "    unset($this->";
  protected final String TEXT_433 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_434 = "->";
  protected final String TEXT_435 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_436 = "->";
  protected final String TEXT_437 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_438 = "[$oldIndex] = $";
  protected final String TEXT_439 = ";" + NL + "        ksort($this->";
  protected final String TEXT_440 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_441 = " = array_values($this->";
  protected final String TEXT_442 = ");";
  protected final String TEXT_443 = NL + "    return $wasRemoved;" + NL + "  }";
  protected final String TEXT_444 = NL + "  ";
  protected final String TEXT_445 = " function ";
  protected final String TEXT_446 = "($";
  protected final String TEXT_447 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_448 = NL + "    $this->";
  protected final String TEXT_449 = " = $";
  protected final String TEXT_450 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_451 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_452 = NL + "  ";
  protected final String TEXT_453 = " function ";
  protected final String TEXT_454 = "($";
  protected final String TEXT_455 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_456 = NL + "    if ($";
  protected final String TEXT_457 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_458 = " = $";
  protected final String TEXT_459 = ";" + NL + "      $wasSet = true;" + NL + "    }";
  protected final String TEXT_460 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_461 = NL + "  public function ";
  protected final String TEXT_462 = "($";
  protected final String TEXT_463 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_464 = NL + "    if ($this->";
  protected final String TEXT_465 = " != null && $this->";
  protected final String TEXT_466 = " != $";
  protected final String TEXT_467 = " && $this == $this->";
  protected final String TEXT_468 = "->";
  protected final String TEXT_469 = "())" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_470 = ", as existing ";
  protected final String TEXT_471 = " would become an orphan";
  protected final String TEXT_472 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $this->";
  protected final String TEXT_473 = " = $";
  protected final String TEXT_474 = ";" + NL + "    $";
  protected final String TEXT_475 = " = $";
  protected final String TEXT_476 = " != null ? $";
  protected final String TEXT_477 = "->";
  protected final String TEXT_478 = "() : null;" + NL + "    " + NL + "    if ($this != $";
  protected final String TEXT_479 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_480 = " != null)" + NL + "      {" + NL + "        $";
  protected final String TEXT_481 = "->";
  protected final String TEXT_482 = " = null;" + NL + "      }" + NL + "      if ($this->";
  protected final String TEXT_483 = " != null)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_484 = "->";
  protected final String TEXT_485 = "($this);" + NL + "      }" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_486 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_487 = NL + "  public function ";
  protected final String TEXT_488 = "($";
  protected final String TEXT_489 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_490 = NL + "    if ($";
  protected final String TEXT_491 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_492 = " to null, as ";
  protected final String TEXT_493 = " must always be associated to a ";
  protected final String TEXT_494 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_495 = " = $";
  protected final String TEXT_496 = "->";
  protected final String TEXT_497 = "();" + NL + "    if ($";
  protected final String TEXT_498 = " != null && $this != $";
  protected final String TEXT_499 = ")" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_500 = ", the current ";
  protected final String TEXT_501 = " already has a ";
  protected final String TEXT_502 = ", which would be orphaned if it were re-assigned";
  protected final String TEXT_503 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_504 = " = $this->";
  protected final String TEXT_505 = ";" + NL + "    $this->";
  protected final String TEXT_506 = " = $";
  protected final String TEXT_507 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_514 = NL + "  public function ";
  protected final String TEXT_515 = "(";
  protected final String TEXT_516 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_517 = "(";
  protected final String TEXT_518 = ");" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_519 = "($";
  protected final String TEXT_520 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_521 = NL + "    $";
  protected final String TEXT_522 = " = $";
  protected final String TEXT_523 = "->";
  protected final String TEXT_524 = "();" + NL + "    $";
  protected final String TEXT_525 = " = $";
  protected final String TEXT_526 = " != null && $this !== $";
  protected final String TEXT_527 = ";" + NL + "" + NL + "    if ($";
  protected final String TEXT_528 = " && $";
  protected final String TEXT_529 = "->";
  protected final String TEXT_530 = "() <= self::";
  protected final String TEXT_531 = "())" + NL + "    {" + NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    if ($";
  protected final String TEXT_532 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_533 = "->";
  protected final String TEXT_534 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_535 = "[] = $";
  protected final String TEXT_536 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_537 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_538 = "($";
  protected final String TEXT_539 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_540 = NL + "    //Unable to remove ";
  protected final String TEXT_541 = ", as it must always have a ";
  protected final String TEXT_542 = NL + "    if ($this === $";
  protected final String TEXT_543 = "->";
  protected final String TEXT_544 = "())" + NL + "    {";
  protected final String TEXT_545 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_546 = " already at minimum (";
  protected final String TEXT_547 = ")" + NL + "    if ($this->";
  protected final String TEXT_548 = "() <= self::";
  protected final String TEXT_549 = "())" + NL + "    {";
  protected final String TEXT_550 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_551 = "[$this->";
  protected final String TEXT_552 = "($";
  protected final String TEXT_553 = ")]);" + NL + "    $this->";
  protected final String TEXT_554 = " = array_values($this->";
  protected final String TEXT_555 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_556 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_557 = NL + "  public function ";
  protected final String TEXT_558 = "(";
  protected final String TEXT_559 = ")" + NL + "  {" + NL + "    if ($this->";
  protected final String TEXT_560 = "() >= self::";
  protected final String TEXT_561 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_562 = "(";
  protected final String TEXT_563 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_564 = "($";
  protected final String TEXT_565 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_566 = NL + "    if ($this->";
  protected final String TEXT_567 = "() >= self::";
  protected final String TEXT_568 = "())" + NL + "    {";
  protected final String TEXT_569 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_570 = " = $";
  protected final String TEXT_571 = "->";
  protected final String TEXT_572 = "();" + NL + "    $";
  protected final String TEXT_573 = " = $";
  protected final String TEXT_574 = " != null && $this !== $";
  protected final String TEXT_575 = ";" + NL + "" + NL + "    if ($";
  protected final String TEXT_576 = " && $";
  protected final String TEXT_577 = "->";
  protected final String TEXT_578 = "() <= self::";
  protected final String TEXT_579 = "())" + NL + "    {";
  protected final String TEXT_580 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    if ($";
  ...
  protected final String TEXT_627 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_628 = "[] = $";
  protected final String TEXT_629 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_630 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_631 = "($";
  protected final String TEXT_632 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_633 = NL + "    //Unable to remove ";
  protected final String TEXT_634 = ", as it must always have a ";
  protected final String TEXT_635 = NL + "    if ($this !== $";
  protected final String TEXT_636 = "->";
  protected final String TEXT_637 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_638 = "[$this->";
  protected final String TEXT_639 = "($";
  protected final String TEXT_640 = ")]);" + NL + "      $this->";
  protected final String TEXT_641 = " = array_values($this->";
  protected final String TEXT_642 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_643 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_644 = NL + "  public function ";
  protected final String TEXT_645 = "($";
  protected final String TEXT_646 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_647 = NL + "    $";
  protected final String TEXT_648 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_649 = " as $";
  protected final String TEXT_650 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_651 = ",$";
  protected final String TEXT_652 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_653 = "[] = $";
  protected final String TEXT_654 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_655 = ") != count($";
  protected final String TEXT_656 = ") || count($";
  protected final String TEXT_657 = ") > self::";
  ...
  protected final String TEXT_661 = ";" + NL + "    $this->";
  protected final String TEXT_662 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_663 = " as $";
  protected final String TEXT_664 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_665 = "[] = $";
  protected final String TEXT_666 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_667 = ",$";
  protected final String TEXT_668 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_669 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_670 = " = array_values($";
  protected final String TEXT_671 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_672 = "->";
  protected final String TEXT_673 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_674 = " as $";
  protected final String TEXT_675 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_676 = "->";
  protected final String TEXT_677 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_678 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_679 = NL + "  public function ";
  protected final String TEXT_680 = "(";
  protected final String TEXT_681 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_682 = "(";
  protected final String TEXT_683 = ");" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_684 = "($";
  protected final String TEXT_685 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_686 = NL + "    $";
  protected final String TEXT_687 = " = $";
  protected final String TEXT_688 = "->";
  protected final String TEXT_689 = "();" + NL + "    $";
  protected final String TEXT_690 = " = $";
  protected final String TEXT_691 = " != null && $this !== $";
  protected final String TEXT_692 = ";" + NL + "    if ($";
  protected final String TEXT_693 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_694 = "->";
  protected final String TEXT_695 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_696 = "[] = $";
  protected final String TEXT_697 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_698 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_699 = "($";
  protected final String TEXT_700 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_701 = NL + "    //Unable to remove ";
  protected final String TEXT_702 = ", as it must always have a ";
  protected final String TEXT_703 = NL + "    if ($this !== $";
  protected final String TEXT_704 = "->";
  protected final String TEXT_705 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_706 = "[$this->";
  protected final String TEXT_707 = "($";
  protected final String TEXT_708 = ")]);" + NL + "      $this->";
  protected final String TEXT_709 = " = array_values($this->";
  protected final String TEXT_710 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_711 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_712 = NL + "  public function ";
  protected final String TEXT_713 = "($";
  protected final String TEXT_714 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_715 = NL + "    if ($";
  protected final String TEXT_716 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_717 = " = $this->";
  protected final String TEXT_718 = ";" + NL + "      $this->";
  protected final String TEXT_719 = " = null;" + NL + "      " + NL + "      if ($";
  protected final String TEXT_720 = " != null && $";
  protected final String TEXT_721 = "->";
  protected final String TEXT_722 = "() != null)" + NL + "      {" + NL + "        $";
  protected final String TEXT_723 = "->";
  protected final String TEXT_724 = "(null);" + NL + "      }" + NL + "      $wasSet = true;";
  protected final String TEXT_725 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  ...
  protected final String TEXT_732 = "(null);" + NL + "    }" + NL + "    " + NL + "    $this->";
  protected final String TEXT_733 = " = $";
  protected final String TEXT_734 = ";" + NL + "    $";
  protected final String TEXT_735 = " = $";
  protected final String TEXT_736 = "->";
  protected final String TEXT_737 = "();" + NL + "    " + NL + "    if ($this != $";
  protected final String TEXT_738 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_739 = "->";
  protected final String TEXT_740 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_741 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_742 = NL + "  public function ";
  protected final String TEXT_743 = "($";
  protected final String TEXT_744 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_745 = NL + "    if ($this->";
  protected final String TEXT_746 = "($";
  protected final String TEXT_747 = ") == -1)" + NL + "    {";
  protected final String TEXT_748 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_749 = "() <= self::";
  protected final String TEXT_750 = "())" + NL + "    {";
  protected final String TEXT_751 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_752 = "($";
  protected final String TEXT_753 = ");" + NL + "    unset($this->";
  protected final String TEXT_754 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_755 = "->";
  protected final String TEXT_756 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_757 = "->";
  protected final String TEXT_758 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_759 = "[$oldIndex] = $";
  protected final String TEXT_760 = ";" + NL + "        ksort($this->";
  protected final String TEXT_761 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_762 = " = array_values($this->";
  protected final String TEXT_763 = ");";
  protected final String TEXT_764 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_765 = NL + "  public function ";
  protected final String TEXT_766 = "($";
  protected final String TEXT_767 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_768 = NL + "    if ($this->";
  protected final String TEXT_769 = "($";
  protected final String TEXT_770 = ") == -1)" + NL + "    {";
  protected final String TEXT_771 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_772 = "() <= self::";
  protected final String TEXT_773 = "())" + NL + "    {";
  protected final String TEXT_774 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_775 = "($";
  protected final String TEXT_776 = ");" + NL + "    unset($this->";
  protected final String TEXT_777 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_778 = "->";
  protected final String TEXT_779 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_780 = "->";
  protected final String TEXT_781 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_782 = "[$oldIndex] = $";
  protected final String TEXT_783 = ";" + NL + "        ksort($this->";
  protected final String TEXT_784 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_785 = " = array_values($this->";
  protected final String TEXT_786 = ");";
  protected final String TEXT_787 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_788 = NL + "  public function ";
  protected final String TEXT_789 = "($";
  protected final String TEXT_790 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  ...
  protected final String TEXT_797 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  ...
  protected final String TEXT_818 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_825 = "($this);" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_826 = "->";
  protected final String TEXT_827 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_828 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_829 = NL + "  public function ";
  protected final String TEXT_830 = "($";
  protected final String TEXT_831 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_832 = NL + "    //Must provide ";
  protected final String TEXT_833 = " to ";
  protected final String TEXT_834 = NL + "    if ($";
  protected final String TEXT_835 = " == null)" + NL + "    {";
  protected final String TEXT_836 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_837 = " already at maximum (";
  ...
  protected final String TEXT_850 = ")" + NL + "    {" + NL + "      $didRemove = $";
  protected final String TEXT_851 = "->";
  protected final String TEXT_852 = "($this);" + NL + "      if (!$didRemove)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_853 = " = $";
  protected final String TEXT_854 = ";";
  protected final String TEXT_855 = NL + "        return $wasSet;" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_856 = "->";
  protected final String TEXT_857 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_858 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_859 = NL + "  public function ";
  protected final String TEXT_860 = "($";
  protected final String TEXT_861 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_862 = NL + "    //Must provide ";
  protected final String TEXT_863 = " to ";
  protected final String TEXT_864 = NL + "    if ($";
  protected final String TEXT_865 = " == null)" + NL + "    {";
  protected final String TEXT_866 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_867 = " != null && $this->";
  protected final String TEXT_868 = "->";
  protected final String TEXT_869 = "() <= ";
  protected final String TEXT_870 = "::";
  protected final String TEXT_871 = "())" + NL + "    {";
  protected final String TEXT_872 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_873 = " = $this->";
  protected final String TEXT_874 = ";" + NL + "    $this->";
  protected final String TEXT_875 = " = $";
  protected final String TEXT_876 = ";" + NL + "    if ($";
  protected final String TEXT_877 = " != null && $";
  protected final String TEXT_878 = " != $";
  protected final String TEXT_879 = ")" + NL + "    {" + NL + "      $didRemove = $";
  protected final String TEXT_880 = "->";
  protected final String TEXT_881 = "($this);" + NL + "      if (!$didRemove)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_882 = " = $";
  protected final String TEXT_883 = ";";
  protected final String TEXT_884 = NL + "        return $wasSet;" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_885 = "->";
  protected final String TEXT_886 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_887 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_888 = NL + "  public function ";
  protected final String TEXT_889 = "($";
  protected final String TEXT_890 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  ...
  protected final String TEXT_897 = "($this);" + NL + "    }" + NL + "    elseif ($this !== $";
  protected final String TEXT_898 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_899 = "->";
  protected final String TEXT_900 = "($";
  protected final String TEXT_901 = ");" + NL + "      $this->";
  protected final String TEXT_902 = "($";
  protected final String TEXT_903 = ");" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_904 = "[] = $";
  protected final String TEXT_905 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_906 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_907 = "($";
  protected final String TEXT_908 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_909 = NL + "    if ($this->";
  protected final String TEXT_910 = "($";
  protected final String TEXT_911 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_912 = "[$this->";
  protected final String TEXT_913 = "($";
  protected final String TEXT_914 = ")]);" + NL + "      $this->";
  protected final String TEXT_915 = " = array_values($this->";
  protected final String TEXT_916 = ");" + NL + "      if ($this === $";
  protected final String TEXT_917 = "->";
  protected final String TEXT_918 = "())" + NL + "      {" + NL + "        $";
  protected final String TEXT_919 = "->";
  protected final String TEXT_920 = "(null);" + NL + "      }" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_921 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_922 = NL + "  public function ";
  protected final String TEXT_923 = "($";
  protected final String TEXT_924 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_925 = NL + "    $";
  protected final String TEXT_926 = " = $this->";
  protected final String TEXT_927 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_934 = "($this);" + NL + "    }" + NL + "    if ($";
  protected final String TEXT_935 = " != null && $";
  protected final String TEXT_936 = " !== $";
  protected final String TEXT_937 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_938 = "->";
  protected final String TEXT_939 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_940 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_941 = NL + "  public function ";
  protected final String TEXT_942 = "($";
  protected final String TEXT_943 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_944 = NL + "    if ($this->";
  protected final String TEXT_945 = "() >= self::";
  protected final String TEXT_946 = "())" + NL + "    {";
  protected final String TEXT_947 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  ...
  protected final String TEXT_953 = "($this);" + NL + "    }" + NL + "    else if ($this !== $";
  protected final String TEXT_954 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_955 = "->";
  protected final String TEXT_956 = "($";
  protected final String TEXT_957 = ");" + NL + "      $this->";
  protected final String TEXT_958 = "($";
  protected final String TEXT_959 = ");" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_960 = "[] = $";
  protected final String TEXT_961 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_962 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_963 = "($";
  protected final String TEXT_964 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_965 = NL + "    if ($this->";
  protected final String TEXT_966 = "($";
  protected final String TEXT_967 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_968 = "[$this->";
  protected final String TEXT_969 = "($";
  protected final String TEXT_970 = ")]);" + NL + "      $this->";
  protected final String TEXT_971 = " = array_values($this->";
  protected final String TEXT_972 = ");" + NL + "      $";
  protected final String TEXT_973 = "->";
  protected final String TEXT_974 = "(null);" + NL + "      $wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_981 = "())" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_982 = "[] = $";
  protected final String TEXT_983 = ";" + NL + "      $wasAdded = true;" + NL + "    }";
  protected final String TEXT_984 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_985 = "($";
  protected final String TEXT_986 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_987 = NL + "    if ($this->";
  protected final String TEXT_988 = "($";
  protected final String TEXT_989 = ") == -1)" + NL + "    {";
  protected final String TEXT_990 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_991 = "() <= self::";
  protected final String TEXT_992 = "())" + NL + "    {";
  protected final String TEXT_993 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_994 = "[$this->";
  protected final String TEXT_995 = "($";
  protected final String TEXT_996 = ")]);" + NL + "    $this->";
  protected final String TEXT_997 = " = array_values($this->";
  protected final String TEXT_998 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_999 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1000 = NL + "  public function ";
  protected final String TEXT_1001 = "($";
  protected final String TEXT_1002 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1003 = NL + "    if ($this->";
  protected final String TEXT_1004 = "() >= self::";
  protected final String TEXT_1005 = "())" + NL + "    {";
  protected final String TEXT_1006 = NL + "      return $wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1013 = "() <= self::";
  protected final String TEXT_1014 = "())" + NL + "    {";
  protected final String TEXT_1015 = NL + "      return $wasAdded;" + NL + "    }" + NL + "    else if ($";
  protected final String TEXT_1016 = " != null)" + NL + "    {" + NL + "      unset($";
  ...
  protected final String TEXT_1023 = " = array_values($";
  protected final String TEXT_1024 = "->";
  protected final String TEXT_1025 = ");" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_1026 = "[] = $";
  protected final String TEXT_1027 = ";" + NL + "    $this->";
  protected final String TEXT_1028 = "($";
  protected final String TEXT_1029 = ",$this);" + NL + "    $wasAdded = true;";
  ...
  protected final String TEXT_1035 = ") != -1 && $this->";
  protected final String TEXT_1036 = "() > self::";
  protected final String TEXT_1037 = "())" + NL + "    {" + NL + "      unset($this->";
  ...
  protected final String TEXT_1048 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1049 = NL + "    $";
  protected final String TEXT_1050 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1051 = " as $";
  protected final String TEXT_1052 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1053 = ",$";
  protected final String TEXT_1054 = ") !== false)" + NL + "      {";
  protected final String TEXT_1055 = NL + "        return $wasSet;" + NL + "      }" + NL + "      else if ($";
  protected final String TEXT_1056 = "->";
  protected final String TEXT_1057 = "() != null && $this !== $";
  ...
  protected final String TEXT_1062 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1063 = ") != self::";
  protected final String TEXT_1064 = "())" + NL + "    {";
  protected final String TEXT_1065 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    foreach ($this->";
  protected final String TEXT_1066 = " as $orphan) " + NL + "    {" + NL + "      $wasFound = false;" + NL + "      foreach ($";
  protected final String TEXT_1067 = " as $fosterCare)" + NL + "      {" + NL + "        if ($orphan == $fosterCare)" + NL + "        {" + NL + "          $wasFound = true;" + NL + "          break;" + NL + "        }" + NL + "      }" + NL + "" + NL + "      if (!$wasFound)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1068 = "($orphan, null);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1069 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1070 = " as $";
  protected final String TEXT_1071 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1072 = "($";
  protected final String TEXT_1073 = ", $this);" + NL + "      $this->";
  protected final String TEXT_1074 = "[] = $";
  protected final String TEXT_1075 = ";" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1076 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1077 = NL + "  private function ";
  protected final String TEXT_1078 = "($";
  protected final String TEXT_1079 = ", $";
  protected final String TEXT_1080 = ")" + NL + "  {" + NL + "    $";
  protected final String TEXT_1081 = "->mentor = $";
  protected final String TEXT_1082 = ";" + NL + "    //$prop = new ReflectionProperty($";
  protected final String TEXT_1083 = ", '";
  protected final String TEXT_1084 = "');" + NL + "    //$prop->setAccessible(true);" + NL + "    //$prop->setValue($";
  protected final String TEXT_1085 = ",$";
  protected final String TEXT_1086 = ");" + NL + "    //$prop->setAccessible(false);" + NL + "  }" + NL;
  protected final String TEXT_1087 = NL + "  public function ";
  protected final String TEXT_1088 = "($";
  protected final String TEXT_1089 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1090 = NL + "    $this->";
  protected final String TEXT_1091 = "[] = $";
  protected final String TEXT_1092 = ";" + NL + "    $wasAdded = true;";
  ...
  protected final String TEXT_1108 = NL + "    if ($this->";
  protected final String TEXT_1109 = "() < self::";
  protected final String TEXT_1110 = "())" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1111 = "[] = $";
  protected final String TEXT_1112 = ";" + NL + "      $wasAdded = true;" + NL + "    }";
  protected final String TEXT_1113 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1114 = "($";
  protected final String TEXT_1115 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1116 = NL + "    if ($this->";
  protected final String TEXT_1117 = "($";
  protected final String TEXT_1118 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1119 = "[$this->";
  protected final String TEXT_1120 = "($";
  protected final String TEXT_1121 = ")]);" + NL + "      $this->";
  protected final String TEXT_1122 = " = array_values($this->";
  protected final String TEXT_1123 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1124 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1125 = NL + "  public function ";
  protected final String TEXT_1126 = "($";
  protected final String TEXT_1127 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1128 = NL + "    $this->";
  protected final String TEXT_1129 = "[] = $";
  protected final String TEXT_1130 = ";" + NL + "    $wasAdded = true;";
  protected final String TEXT_1131 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1132 = "($";
  protected final String TEXT_1133 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1134 = NL + "    if ($this->";
  protected final String TEXT_1135 = "($";
  protected final String TEXT_1136 = ") == -1)" + NL + "    {";
  protected final String TEXT_1137 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_1138 = "() <= self::";
  protected final String TEXT_1139 = "())" + NL + "    {";
  protected final String TEXT_1140 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  ...
  protected final String TEXT_1145 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_1146 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1147 = NL + "  ";
  protected final String TEXT_1148 = " function ";
  protected final String TEXT_1149 = "($";
  protected final String TEXT_1150 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1151 = NL + "    $";
  protected final String TEXT_1152 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1153 = " as $";
  protected final String TEXT_1154 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1155 = ",$";
  protected final String TEXT_1156 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1157 = "[] = $";
  protected final String TEXT_1158 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  ...
  protected final String TEXT_1163 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1164 = " = $";
  protected final String TEXT_1165 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1166 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1167 = NL + "  ";
  protected final String TEXT_1168 = " function ";
  protected final String TEXT_1169 = "($";
  protected final String TEXT_1170 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1171 = NL + "    $";
  protected final String TEXT_1172 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1173 = " as $";
  protected final String TEXT_1174 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1175 = ",$";
  protected final String TEXT_1176 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1177 = "[] = $";
  protected final String TEXT_1178 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1179 = ") != count($";
  protected final String TEXT_1180 = "))" + NL + "    {";
  protected final String TEXT_1181 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1182 = "->";
  protected final String TEXT_1183 = " = $";
  protected final String TEXT_1184 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1185 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1186 = NL + "  public function ";
  protected final String TEXT_1187 = "($";
  protected final String TEXT_1188 = ")" + NL + "  {" + NL + "    //" + NL + "    // This source of this source generation is association_SetOptionalOneToMandatoryMany.jet" + NL + "    // This set file assumes the generation of a maximumNumberOfXXX method does not exist because " + NL + "    // it's not required (No upper bound)" + NL + "    //   " + NL + "" + NL + "    $wasSet = false;" + NL + "    " + NL + "    $";
  protected final String TEXT_1189 = " = $this->";
  protected final String TEXT_1190 = ";" + NL + "\t" + NL + "    if ($";
  protected final String TEXT_1191 = " == null)" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_1192 = " != null)" + NL + "      {" + NL + "        if ($";
  protected final String TEXT_1193 = "->";
  protected final String TEXT_1194 = "($this))" + NL + "        {" + NL + "          $";
  protected final String TEXT_1195 = " = $";
  protected final String TEXT_1196 = ";" + NL + "          $wasSet = true;" + NL + "        }" + NL + "      }" + NL + "    } " + NL + "    else if ($";
  protected final String TEXT_1197 = " != null)" + NL + "    {" + NL + "      if ($";
  ...
  protected final String TEXT_1204 = "($this);" + NL + "          $";
  protected final String TEXT_1205 = " = $";
  protected final String TEXT_1206 = ";  // ";
  protected final String TEXT_1207 = " == null" + NL + "          $wasSet = true;" + NL + "        }" + NL + "      } " + NL + "      else" + NL + "      {" + NL + "        if ($";
  ...
  protected final String TEXT_1213 = "($this);" + NL + "          $";
  protected final String TEXT_1214 = "->";
  protected final String TEXT_1215 = "($this);" + NL + "          $";
  protected final String TEXT_1216 = " = $";
  protected final String TEXT_1217 = ";" + NL + "          $wasSet = true;" + NL + "        }" + NL + "      }" + NL + "    }" + NL + "    if ($wasSet)" + NL + "    {" + NL + "      $";
  protected final String TEXT_1218 = " = $";
  protected final String TEXT_1219 = ";" + NL + "    }" + NL + "    return $wasSet;" + NL + "  }" + NL + "  ";
  protected final String TEXT_1220 = NL + "//  public function ";
  protected final String TEXT_1221 = "($";
  protected final String TEXT_1222 = ")" + NL + "//  {" + NL + "//    //" + NL + "//    // The source of the code generation is association_SetOptionalOneToMN.jet" + NL + "//    // (this) set file assumes the generation of a maximumNumberOfXXX " + NL + "//    //   method ";
  protected final String TEXT_1223 = NL + "//    // Currently this will not compile due to Issue351 - the template code is fine." + NL + "//    //" + NL + "//    $wasSet = false;" + NL + "//" + NL + "//    $";
  protected final String TEXT_1224 = " = $";
  protected final String TEXT_1225 = ";" + NL + "//\t" + NL + "//\tif ($";
  protected final String TEXT_1226 = " == null)" + NL + "//    {" + NL + "//      if ($";
  protected final String TEXT_1227 = " != null)" + NL + "//      {" + NL + "//        if ($";
  protected final String TEXT_1228 = "->";
  protected final String TEXT_1229 = "(this))" + NL + "//        {" + NL + "//          $";
  protected final String TEXT_1230 = " = $";
  protected final String TEXT_1231 = ";" + NL + "//          $wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//    } " + NL + "//    else if ($";
  protected final String TEXT_1232 = " != null)" + NL + "//    { " + NL + "//      if ($";
  ...
  protected final String TEXT_1239 = "(this);" + NL + "//          $";
  protected final String TEXT_1240 = " = $";
  protected final String TEXT_1241 = ";  // $";
  protected final String TEXT_1242 = " == null" + NL + "//          $wasSet = true;" + NL + "//        }" + NL + "//      } " + NL + "//      else" + NL + "//      {" + NL + "//        if (   $";
  ...
  protected final String TEXT_1250 = "()" + NL + "//           )" + NL + "//        {" + NL + "//          $";
  protected final String TEXT_1251 = "->";
  protected final String TEXT_1252 = "(this);" + NL + "//          $";
  protected final String TEXT_1253 = "->";
  protected final String TEXT_1254 = "(this);" + NL + "//          $";
  protected final String TEXT_1255 = " = ";
  protected final String TEXT_1256 = ";" + NL + "//          $wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//    }" + NL + "//    if ($wasSet)" + NL + "//    {" + NL + "//      $";
  protected final String TEXT_1257 = " = $";
  protected final String TEXT_1258 = ";" + NL + "//    }" + NL + "//    " + NL + "//    return $wasSet;" + NL + "//  }";
  protected final String TEXT_1259 = NL + "  public function ";
  protected final String TEXT_1260 = "($";
  protected final String TEXT_1261 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1262 = NL + "    $";
  protected final String TEXT_1263 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1264 = " as $";
  protected final String TEXT_1265 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1266 = ",$";
  protected final String TEXT_1267 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1268 = "[] = $";
  protected final String TEXT_1269 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1270 = ") != count($";
  protected final String TEXT_1271 = ") || count($";
  protected final String TEXT_1272 = ") < self::";
  protected final String TEXT_1273 = "() || count($";
  protected final String TEXT_1274 = ") > self::";
  protected final String TEXT_1275 = "())" + NL + "    {";
  protected final String TEXT_1276 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1277 = " = $this->";
  protected final String TEXT_1278 = ";" + NL + "    $this->";
  protected final String TEXT_1279 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1280 = " as $";
  protected final String TEXT_1281 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1282 = "[] = $";
  protected final String TEXT_1283 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_1284 = ",$";
  protected final String TEXT_1285 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_1286 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_1287 = " = array_values($";
  protected final String TEXT_1288 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1289 = "->";
  protected final String TEXT_1290 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_1291 = " as $";
  protected final String TEXT_1292 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1293 = "->";
  protected final String TEXT_1294 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1295 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1296 = NL + "  public function ";
  protected final String TEXT_1297 = "($";
  protected final String TEXT_1298 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1299 = NL + "    $";
  protected final String TEXT_1300 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1301 = " as $";
  protected final String TEXT_1302 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1303 = ",$";
  protected final String TEXT_1304 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1305 = "[] = $";
  protected final String TEXT_1306 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1307 = ") != count($";
  protected final String TEXT_1308 = ") || count($";
  protected final String TEXT_1309 = ") < self::";
  protected final String TEXT_1310 = "())" + NL + "    {";
  protected final String TEXT_1311 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1312 = " = $this->";
  protected final String TEXT_1313 = ";" + NL + "    $this->";
  protected final String TEXT_1314 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1315 = " as $";
  protected final String TEXT_1316 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1317 = "[] = $";
  protected final String TEXT_1318 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_1319 = ",$";
  protected final String TEXT_1320 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_1321 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_1322 = " = array_values($";
  protected final String TEXT_1323 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1324 = "->";
  protected final String TEXT_1325 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_1326 = " as $";
  protected final String TEXT_1327 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1328 = "->";
  protected final String TEXT_1329 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1330 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1331 = NL + "  ";
  protected final String TEXT_1332 = " function ";
  ...
  protected final String TEXT_1346 = "()  || count($";
  protected final String TEXT_1347 = ") > self::";
  protected final String TEXT_1348 = "())" + NL + "    {";
  protected final String TEXT_1349 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1350 = " = $";
  protected final String TEXT_1351 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1352 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1353 = NL + "  public function ";
  protected final String TEXT_1354 = "($";
  protected final String TEXT_1355 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1356 = NL + "    if (count($";
  protected final String TEXT_1357 = ") < self::";
  ...
  protected final String TEXT_1361 = " = array();" + NL + "    $";
  protected final String TEXT_1362 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1363 = " as $";
  protected final String TEXT_1364 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1365 = ",$";
  protected final String TEXT_1366 = ") !== false)" + NL + "      {";
  protected final String TEXT_1367 = NL + "        return $wasSet;" + NL + "      }" + NL + "      else if ($";
  protected final String TEXT_1368 = "->";
  protected final String TEXT_1369 = "() != null && $this !== $";
  protected final String TEXT_1370 = "->";
  protected final String TEXT_1371 = "())" + NL + "      {" + NL + "        $";
  protected final String TEXT_1372 = " = $";
  protected final String TEXT_1373 = "->";
  protected final String TEXT_1374 = "();" + NL + "        $";
  protected final String TEXT_1375 = " = serialize($";
  protected final String TEXT_1376 = ");" + NL + "        if (!array_key_exists($";
  ...
  protected final String TEXT_1382 = "();" + NL + "        }" + NL + "        $nextCount = $";
  protected final String TEXT_1383 = "[$";
  protected final String TEXT_1384 = "] - 1;" + NL + "        if ($nextCount < self::minimum";
  ...
  protected final String TEXT_1388 = "] = $nextCount;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1389 = "[] = $";
  protected final String TEXT_1390 = ";" + NL + "    }" + NL + "" + NL + "    foreach ($this->";
  protected final String TEXT_1391 = " as $orphan) " + NL + "    {" + NL + "      $wasFound = false;" + NL + "      foreach ($";
  protected final String TEXT_1392 = " as $fosterCare)" + NL + "      {" + NL + "        if ($orphan == $fosterCare)" + NL + "        {" + NL + "          $wasFound = true;" + NL + "          break;" + NL + "        }" + NL + "      }" + NL + "      " + NL + "      if (!$wasFound)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1393 = "($orphan, null);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1394 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1395 = " as $";
  protected final String TEXT_1396 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_1397 = "->";
  protected final String TEXT_1398 = "() != null)" + NL + "      {" + NL + "        unset($";
  ...
  protected final String TEXT_1408 = " = array_values($";
  protected final String TEXT_1409 = "->";
  protected final String TEXT_1410 = "()->";
  protected final String TEXT_1411 = ");" + NL + "      }" + NL + "      $this->";
  protected final String TEXT_1412 = "($";
  protected final String TEXT_1413 = ", $this);" + NL + "      $this->";
  protected final String TEXT_1414 = "[] = $";
  protected final String TEXT_1415 = ";" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1416 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1417 = NL + "  private function ";
  protected final String TEXT_1418 = "($";
  protected final String TEXT_1419 = ", $";
  protected final String TEXT_1420 = ")" + NL + "  {" + NL + "    $";
  protected final String TEXT_1421 = "->mentor = $";
  protected final String TEXT_1422 = ";" + NL + "    //$prop = new ReflectionProperty($";
  protected final String TEXT_1423 = ", '";
  protected final String TEXT_1424 = "');" + NL + "    //$prop->setAccessible(true);" + NL + "    //$prop->setValue($";
  protected final String TEXT_1425 = ",$";
  protected final String TEXT_1426 = ");" + NL + "    //$prop->setAccessible(false);" + NL + "  }" + NL;
  protected final String TEXT_1427 = NL + "  ";
  protected final String TEXT_1428 = " function ";
  protected final String TEXT_1429 = "($";
  protected final String TEXT_1430 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1431 = NL + "    $";
  protected final String TEXT_1432 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1433 = " as $";
  protected final String TEXT_1434 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1435 = ",$";
  protected final String TEXT_1436 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1437 = "[] = $";
  protected final String TEXT_1438 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1439 = ") != count($";
  protected final String TEXT_1440 = ") || count($";
  protected final String TEXT_1441 = ") > self::";
  protected final String TEXT_1442 = "())" + NL + "    {";
  protected final String TEXT_1443 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1444 = " = $";
  protected final String TEXT_1445 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1446 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1447 = NL + "  ";
  protected final String TEXT_1448 = " function ";
  protected final String TEXT_1449 = "($";
  protected final String TEXT_1450 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1451 = NL + "    $";
  protected final String TEXT_1452 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1453 = " as $";
  protected final String TEXT_1454 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1455 = ",$";
  protected final String TEXT_1456 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1457 = "[] = $";
  protected final String TEXT_1458 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1459 = ") != count($";
  protected final String TEXT_1460 = ") || count($";
  protected final String TEXT_1461 = ") < self::";
  protected final String TEXT_1462 = "())" + NL + "    {";
  protected final String TEXT_1463 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1464 = " = $";
  protected final String TEXT_1465 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1466 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1467 = NL + "  public function sort(&$toSort, $thePriority)" + NL + "  {" + NL + "    if(count($toSort) > 0)" + NL + "    {" + NL + "      $methodName = \"get\".ucfirst($thePriority);" + NL + "      usort($toSort, function($x, $y) use ($methodName)" + NL + "      {" + NL + "        $var1 = call_user_func(array($x, $methodName));" + NL + "        $var2 = call_user_func(array($y, $methodName));" + NL + "        return $var1 - $var2;" + NL + "      });" + NL + "    }" + NL + "  }" + NL;
