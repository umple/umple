...
public class PhpClassGenerator implements ILang
{
  ...
  protected final String TEXT_270 = NL + "  public function ";
  protected final String TEXT_271 = "()" + NL + "  {";
  protected final String TEXT_272 = NL + "    return $this->";
  protected final String TEXT_273 = ";" + NL + "  }";
  protected final String TEXT_274 = NL + "  public function ";
  protected final String TEXT_275 = "()" + NL + "  {";
  protected final String TEXT_276 = NL + "    return null;" + NL + "  }" + NL;
  protected final String TEXT_277 = NL + "  public function ";
  protected final String TEXT_278 = "()" + NL + "  {" + NL + "    $wasEventProcessed = false;" + NL;
  protected final String TEXT_279 = NL + "    ";
  protected final String TEXT_280 = NL + NL + "    return $wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_281 = NL + "  public function ";
  protected final String TEXT_282 = "($";
  protected final String TEXT_283 = ")" + NL + "  {";
  protected final String TEXT_284 = NL + "    ";
  protected final String TEXT_285 = NL + "    else" + NL + "    {" + NL + "      return false;" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_286 = NL + "  private function ";
  protected final String TEXT_287 = "()" + NL + "  {";
  protected final String TEXT_288 = NL + "    ";
  protected final String TEXT_289 = NL + "  }" + NL;
  protected final String TEXT_290 = NL + "  private function ";
  protected final String TEXT_291 = "($";
  protected final String TEXT_292 = ")" + NL + "  {";
  protected final String TEXT_293 = NL + "    $this->";
  protected final String TEXT_294 = " = $";
  protected final String TEXT_295 = ";";
  protected final String TEXT_296 = NL + NL + "    // entry actions and do activities";
  protected final String TEXT_297 = NL + "    ";
  protected final String TEXT_298 = NL + "  }" + NL;
  protected final String TEXT_299 = NL + "  public function ";
  protected final String TEXT_300 = "()" + NL + "  {";
  protected final String TEXT_301 = NL + "    return $this->";
  ...
  protected final String TEXT_310 = "($index)" + NL + "  {";
  protected final String TEXT_311 = NL + "    $";
  protected final String TEXT_312 = " = $this->";
  protected final String TEXT_313 = "[$index];";
  protected final String TEXT_314 = NL + "    return $";
  protected final String TEXT_315 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_316 = "()" + NL + "  {";
  protected final String TEXT_317 = NL + "    $";
  protected final String TEXT_318 = " = $this->";
  protected final String TEXT_319 = ";";
  protected final String TEXT_320 = NL + "    return $";
  protected final String TEXT_321 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_322 = "()" + NL + "  {";
  protected final String TEXT_323 = NL + "    $number = count($this->";
  protected final String TEXT_324 = ");";
  protected final String TEXT_325 = NL + "    return $number;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_326 = "()" + NL + "  {";
  protected final String TEXT_327 = NL + "    $has = $this->";
  protected final String TEXT_328 = "() > 0;";
  protected final String TEXT_329 = NL + "    return $has;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_330 = "($";
  protected final String TEXT_331 = ")" + NL + "  {";
  protected final String TEXT_332 = NL + "    $wasFound = false;" + NL + "    $index = 0;" + NL + "    foreach($this->";
  protected final String TEXT_333 = " as $";
  protected final String TEXT_334 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_335 = "->equals($";
  protected final String TEXT_336 = "))" + NL + "      {" + NL + "        $wasFound = true;" + NL + "        break;" + NL + "      }" + NL + "      $index += 1;" + NL + "    }" + NL + "    $index = $wasFound ? $index : -1;";
  protected final String TEXT_337 = NL + "    return $index;" + NL + "  }" + NL;
  protected final String TEXT_338 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_339 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_340 = " : ";
  protected final String TEXT_341 = NL + "  public function ";
  protected final String TEXT_342 = "()" + NL + "  {";
  protected final String TEXT_343 = NL + "    $isValid = $this->";
  protected final String TEXT_344 = "() >= self::";
  protected final String TEXT_345 = "();";
  protected final String TEXT_346 = NL + "    $isValid = $this->";
  protected final String TEXT_347 = "() >= self::";
  protected final String TEXT_348 = "() && $this->";
  protected final String TEXT_349 = "() <= self::";
  protected final String TEXT_350 = "();";
  protected final String TEXT_351 = NL + "    return $isValid;" + NL + "  }";
  protected final String TEXT_352 = NL + "  public static function ";
  protected final String TEXT_353 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_354 = ";" + NL + "  }";
  protected final String TEXT_355 = NL + "  public static function ";
  protected final String TEXT_356 = "()" + NL + "  {";
  protected final String TEXT_357 = NL + "    $minimum = ";
  protected final String TEXT_358 = ";";
  protected final String TEXT_359 = NL + "    return $minimum;" + NL + "  }";
  protected final String TEXT_360 = NL + "  public static function ";
  protected final String TEXT_361 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_362 = ";" + NL + "  }";
  protected final String TEXT_363 = NL + "  public static function ";
  protected final String TEXT_364 = "()" + NL + "  {";
  protected final String TEXT_365 = NL + "    $minimum = ";
  protected final String TEXT_366 = ";";
  protected final String TEXT_367 = NL + "    return $minimum;" + NL + "  }";
  protected final String TEXT_368 = NL + "  public static function ";
  protected final String TEXT_369 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_370 = ";" + NL + "  }";
  protected final String TEXT_371 = NL + "  public static function ";
  protected final String TEXT_372 = "()" + NL + "  {";
  protected final String TEXT_373 = NL + "    $maximum = ";
  protected final String TEXT_374 = ";";
  protected final String TEXT_375 = NL + "    return $maximum;" + NL + "  }";
  protected final String TEXT_376 = NL + "  public function ";
  protected final String TEXT_377 = "($";
  protected final String TEXT_378 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_379 = NL + "    if ($this->";
  protected final String TEXT_380 = "() >= self::";
  protected final String TEXT_381 = "())" + NL + "    {";
  protected final String TEXT_382 = NL + "      return $wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_383 = NL + "    $this->";
  protected final String TEXT_384 = "[] = $";
  protected final String TEXT_385 = ";" + NL + "    if ($";
  protected final String TEXT_386 = "->";
  protected final String TEXT_387 = "($this) != -1)" + NL + "    {" + NL + "      $wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasAdded = $";
  protected final String TEXT_388 = "->";
  protected final String TEXT_389 = "($this);" + NL + "      if (!$wasAdded)" + NL + "      {" + NL + "        array_pop($this->";
  protected final String TEXT_390 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_391 = NL + "    return $wasAdded;" + NL + "  }";
  protected final String TEXT_392 = NL + "  public function ";
  protected final String TEXT_393 = "($";
  protected final String TEXT_394 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_395 = NL + "    if ($this->";
  protected final String TEXT_396 = "($";
  protected final String TEXT_397 = ") == -1)" + NL + "    {";
  protected final String TEXT_398 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_399 = "($";
  protected final String TEXT_400 = ");" + NL + "    unset($this->";
  protected final String TEXT_401 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_402 = "->";
  protected final String TEXT_403 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_404 = "->";
  protected final String TEXT_405 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_406 = "[$oldIndex] = $";
  protected final String TEXT_407 = ";" + NL + "        ksort($this->";
  protected final String TEXT_408 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_409 = " = array_values($this->";
  protected final String TEXT_410 = ");";
  protected final String TEXT_411 = NL + "    return $wasRemoved;" + NL + "  }";
  protected final String TEXT_412 = NL + "  public function ";
  protected final String TEXT_413 = "($";
  protected final String TEXT_414 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_415 = NL + "    $this->";
  protected final String TEXT_416 = " = $";
  protected final String TEXT_417 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_418 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_419 = NL + "  public function ";
  protected final String TEXT_420 = "($";
  protected final String TEXT_421 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_422 = NL + "    if ($";
  protected final String TEXT_423 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_424 = " = $";
  protected final String TEXT_425 = ";" + NL + "      $wasSet = true;" + NL + "    }";
  protected final String TEXT_426 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_427 = NL + "  public function ";
  protected final String TEXT_428 = "($";
  protected final String TEXT_429 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_430 = NL + "    if ($this->";
  protected final String TEXT_431 = " != null && $this->";
  protected final String TEXT_432 = " != $";
  protected final String TEXT_433 = " && $this == $this->";
  protected final String TEXT_434 = "->";
  protected final String TEXT_435 = "())" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_436 = ", as existing ";
  protected final String TEXT_437 = " would become an orphan";
  protected final String TEXT_438 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $this->";
  protected final String TEXT_439 = " = $";
  protected final String TEXT_440 = ";" + NL + "    $";
  protected final String TEXT_441 = " = $";
  protected final String TEXT_442 = " != null ? $";
  protected final String TEXT_443 = "->";
  protected final String TEXT_444 = "() : null;" + NL + "    " + NL + "    if ($this != $";
  protected final String TEXT_445 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_446 = " != null)" + NL + "      {" + NL + "        $";
  protected final String TEXT_447 = "->";
  protected final String TEXT_448 = " = null;" + NL + "      }" + NL + "      if ($this->";
  protected final String TEXT_449 = " != null)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_450 = "->";
  protected final String TEXT_451 = "($this);" + NL + "      }" + NL + "    }" + NL + "    $wasSet = true;";
  ...
  protected final String TEXT_457 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_458 = " to null, as ";
  protected final String TEXT_459 = " must always be associated to a ";
  protected final String TEXT_460 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_461 = " = $";
  protected final String TEXT_462 = "->";
  protected final String TEXT_463 = "();" + NL + "    if ($";
  protected final String TEXT_464 = " != null && $this != $";
  protected final String TEXT_465 = ")" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_466 = ", the current ";
  protected final String TEXT_467 = " already has a ";
  protected final String TEXT_468 = ", which would be orphaned if it were re-assigned";
  protected final String TEXT_469 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_470 = " = $this->";
  protected final String TEXT_471 = ";" + NL + "    $this->";
  protected final String TEXT_472 = " = $";
  protected final String TEXT_473 = ";" + NL + "    $this->";
  protected final String TEXT_474 = "->";
  protected final String TEXT_475 = "($this);" + NL + "    " + NL + "    if ($";
  protected final String TEXT_476 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_477 = "->";
  protected final String TEXT_478 = "(null);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_479 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_480 = NL + "  public function ";
  protected final String TEXT_481 = "(";
  protected final String TEXT_482 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_483 = "(";
  protected final String TEXT_484 = ");" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_485 = "($";
  protected final String TEXT_486 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_487 = NL + "    $";
  protected final String TEXT_488 = " = $";
  protected final String TEXT_489 = "->";
  protected final String TEXT_490 = "();" + NL + "    $";
  protected final String TEXT_491 = " = $";
  protected final String TEXT_492 = " != null && $this !== $";
  protected final String TEXT_493 = ";" + NL + "" + NL + "    if ($";
  protected final String TEXT_494 = " && $";
  protected final String TEXT_495 = "->";
  protected final String TEXT_496 = "() <= self::";
  protected final String TEXT_497 = "())" + NL + "    {" + NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    if ($";
  protected final String TEXT_498 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_499 = "->";
  protected final String TEXT_500 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_501 = "[] = $";
  protected final String TEXT_502 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_503 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_504 = "($";
  protected final String TEXT_505 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_506 = NL + "    //Unable to remove ";
  protected final String TEXT_507 = ", as it must always have a ";
  protected final String TEXT_508 = NL + "    if ($this === $";
  protected final String TEXT_509 = "->";
  protected final String TEXT_510 = "())" + NL + "    {";
  protected final String TEXT_511 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_512 = " already at minimum (";
  protected final String TEXT_513 = ")" + NL + "    if ($this->";
  protected final String TEXT_514 = "() <= self::";
  protected final String TEXT_515 = "())" + NL + "    {";
  protected final String TEXT_516 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_517 = "[$this->";
  protected final String TEXT_518 = "($";
  protected final String TEXT_519 = ")]);" + NL + "    $this->";
  protected final String TEXT_520 = " = array_values($this->";
  protected final String TEXT_521 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_522 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_523 = NL + "  public function ";
  protected final String TEXT_524 = "(";
  protected final String TEXT_525 = ")" + NL + "  {" + NL + "    if ($this->";
  protected final String TEXT_526 = "() >= self::";
  protected final String TEXT_527 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_528 = "(";
  protected final String TEXT_529 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_530 = "($";
  protected final String TEXT_531 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_532 = NL + "    if ($this->";
  protected final String TEXT_533 = "() >= self::";
  protected final String TEXT_534 = "())" + NL + "    {";
  protected final String TEXT_535 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_536 = " = $";
  protected final String TEXT_537 = "->";
  protected final String TEXT_538 = "();" + NL + "    $";
  protected final String TEXT_539 = " = $";
  protected final String TEXT_540 = " != null && $this !== $";
  protected final String TEXT_541 = ";" + NL + "" + NL + "    if ($";
  protected final String TEXT_542 = " && $";
  protected final String TEXT_543 = "->";
  protected final String TEXT_544 = "() <= self::";
  protected final String TEXT_545 = "())" + NL + "    {";
  protected final String TEXT_546 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    if ($";
  protected final String TEXT_547 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_548 = "->";
  protected final String TEXT_549 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_550 = "[] = $";
  protected final String TEXT_551 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_552 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_553 = "($";
  protected final String TEXT_554 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_555 = NL + "    //Unable to remove ";
  protected final String TEXT_556 = ", as it must always have a ";
  protected final String TEXT_557 = NL + "    if ($this === $";
  protected final String TEXT_558 = "->";
  protected final String TEXT_559 = "())" + NL + "    {";
  protected final String TEXT_560 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_561 = " already at minimum (";
  protected final String TEXT_562 = ")" + NL + "    if ($this->";
  protected final String TEXT_563 = "() <= self::";
  protected final String TEXT_564 = "())" + NL + "    {";
  protected final String TEXT_565 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_566 = "[$this->";
  protected final String TEXT_567 = "($";
  protected final String TEXT_568 = ")]);" + NL + "    $this->";
  protected final String TEXT_569 = " = array_values($this->";
  protected final String TEXT_570 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_571 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_572 = NL + "  public function ";
  protected final String TEXT_573 = "(";
  protected final String TEXT_574 = ")" + NL + "  {" + NL + "    if ($this->";
  protected final String TEXT_575 = "() >= self::";
  protected final String TEXT_576 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_577 = "(";
  protected final String TEXT_578 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_579 = "($";
  protected final String TEXT_580 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_581 = NL + "    if ($this->";
  protected final String TEXT_582 = "() >= self::";
  protected final String TEXT_583 = "())" + NL + "    {";
  protected final String TEXT_584 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_585 = " = $";
  protected final String TEXT_586 = "->";
  protected final String TEXT_587 = "();" + NL + "    $";
  protected final String TEXT_588 = " = $";
  protected final String TEXT_589 = " != null && $this !== $";
  protected final String TEXT_590 = ";" + NL + "    if ($";
  protected final String TEXT_591 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_592 = "->";
  protected final String TEXT_593 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_594 = "[] = $";
  protected final String TEXT_595 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_596 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_597 = "($";
  protected final String TEXT_598 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_599 = NL + "    //Unable to remove ";
  protected final String TEXT_600 = ", as it must always have a ";
  protected final String TEXT_601 = NL + "    if ($this !== $";
  protected final String TEXT_602 = "->";
  protected final String TEXT_603 = "())" + NL + "    {" + NL + "      unset($this->";
  ...
  protected final String TEXT_608 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_609 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_610 = NL + "  public function ";
  protected final String TEXT_611 = "($";
  protected final String TEXT_612 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_613 = NL + "    $";
  protected final String TEXT_614 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_615 = " as $";
  protected final String TEXT_616 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_617 = ",$";
  protected final String TEXT_618 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_619 = "[] = $";
  protected final String TEXT_620 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_621 = ") != count($";
  protected final String TEXT_622 = ") || count($";
  protected final String TEXT_623 = ") > self::";
  protected final String TEXT_624 = "())" + NL + "    {";
  protected final String TEXT_625 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_626 = " = $this->";
  protected final String TEXT_627 = ";" + NL + "    $this->";
  protected final String TEXT_628 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_629 = " as $";
  protected final String TEXT_630 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_631 = "[] = $";
  protected final String TEXT_632 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_633 = ",$";
  protected final String TEXT_634 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_635 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_636 = " = array_values($";
  protected final String TEXT_637 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_638 = "->";
  protected final String TEXT_639 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_640 = " as $";
  protected final String TEXT_641 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_642 = "->";
  protected final String TEXT_643 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_644 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_645 = NL + "  public function ";
  protected final String TEXT_646 = "(";
  protected final String TEXT_647 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_648 = "(";
  protected final String TEXT_649 = ");" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_650 = "($";
  protected final String TEXT_651 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  ...
  protected final String TEXT_661 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_662 = "[] = $";
  protected final String TEXT_663 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_664 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_665 = "($";
  protected final String TEXT_666 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_667 = NL + "    //Unable to remove ";
  protected final String TEXT_668 = ", as it must always have a ";
  protected final String TEXT_669 = NL + "    if ($this !== $";
  protected final String TEXT_670 = "->";
  protected final String TEXT_671 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_672 = "[$this->";
  protected final String TEXT_673 = "($";
  protected final String TEXT_674 = ")]);" + NL + "      $this->";
  protected final String TEXT_675 = " = array_values($this->";
  protected final String TEXT_676 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_677 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_678 = NL + "  public function ";
  protected final String TEXT_679 = "($";
  protected final String TEXT_680 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_681 = NL + "    if ($";
  protected final String TEXT_682 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_683 = " = $this->";
  protected final String TEXT_684 = ";" + NL + "      $this->";
  protected final String TEXT_685 = " = null;" + NL + "      " + NL + "      if ($";
  protected final String TEXT_686 = " != null && $";
  protected final String TEXT_687 = "->";
  protected final String TEXT_688 = "() != null)" + NL + "      {" + NL + "        $";
  protected final String TEXT_689 = "->";
  protected final String TEXT_690 = "(null);" + NL + "      }" + NL + "      $wasSet = true;";
  protected final String TEXT_691 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  ...
  protected final String TEXT_698 = "(null);" + NL + "    }" + NL + "    " + NL + "    $this->";
  protected final String TEXT_699 = " = $";
  protected final String TEXT_700 = ";" + NL + "    $";
  protected final String TEXT_701 = " = $";
  protected final String TEXT_702 = "->";
  protected final String TEXT_703 = "();" + NL + "    " + NL + "    if ($this != $";
  ...
  protected final String TEXT_710 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_711 = NL + "    if ($this->";
  protected final String TEXT_712 = "($";
  protected final String TEXT_713 = ") == -1)" + NL + "    {";
  protected final String TEXT_714 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_715 = "() <= self::";
  protected final String TEXT_716 = "())" + NL + "    {";
  protected final String TEXT_717 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_718 = "($";
  protected final String TEXT_719 = ");" + NL + "    unset($this->";
  protected final String TEXT_720 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_721 = "->";
  protected final String TEXT_722 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_723 = "->";
  protected final String TEXT_724 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_725 = "[$oldIndex] = $";
  protected final String TEXT_726 = ";" + NL + "        ksort($this->";
  protected final String TEXT_727 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_728 = " = array_values($this->";
  protected final String TEXT_729 = ");";
  protected final String TEXT_730 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_731 = NL + "  public function ";
  protected final String TEXT_732 = "($";
  protected final String TEXT_733 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_734 = NL + "    if ($this->";
  protected final String TEXT_735 = "($";
  protected final String TEXT_736 = ") == -1)" + NL + "    {";
  protected final String TEXT_737 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_738 = "() <= self::";
  protected final String TEXT_739 = "())" + NL + "    {";
  protected final String TEXT_740 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_741 = "($";
  protected final String TEXT_742 = ");" + NL + "    unset($this->";
  protected final String TEXT_743 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_744 = "->";
  protected final String TEXT_745 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_746 = "->";
  protected final String TEXT_747 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_748 = "[$oldIndex] = $";
  protected final String TEXT_749 = ";" + NL + "        ksort($this->";
  protected final String TEXT_750 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  ...
  protected final String TEXT_763 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_764 = " = $this->";
  protected final String TEXT_765 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_772 = "($this);" + NL + "    }" + NL + "    if ($";
  protected final String TEXT_773 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_774 = "->";
  protected final String TEXT_775 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_776 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_777 = NL + "  public function ";
  protected final String TEXT_778 = "($";
  protected final String TEXT_779 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_780 = NL + "    if ($";
  protected final String TEXT_781 = " == null)" + NL + "    {";
  ...
  protected final String TEXT_791 = "($this);" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_792 = "->";
  protected final String TEXT_793 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_794 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_795 = NL + "  public function ";
  protected final String TEXT_796 = "($";
  protected final String TEXT_797 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_798 = NL + "    //Must provide ";
  protected final String TEXT_799 = " to ";
  protected final String TEXT_800 = NL + "    if ($";
  protected final String TEXT_801 = " == null)" + NL + "    {";
  protected final String TEXT_802 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_803 = " already at maximum (";
  protected final String TEXT_804 = ")" + NL + "    if ($";
  protected final String TEXT_805 = "->";
  protected final String TEXT_806 = "() >= ";
  protected final String TEXT_807 = "::";
  protected final String TEXT_808 = "())" + NL + "    {";
  protected final String TEXT_809 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_810 = " = $this->";
  protected final String TEXT_811 = ";" + NL + "    $this->";
  protected final String TEXT_812 = " = $";
  protected final String TEXT_813 = ";" + NL + "    if ($";
  protected final String TEXT_814 = " != null && $";
  protected final String TEXT_815 = " != $";
  protected final String TEXT_816 = ")" + NL + "    {" + NL + "      $didRemove = $";
  protected final String TEXT_817 = "->";
  protected final String TEXT_818 = "($this);" + NL + "      if (!$didRemove)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_819 = " = $";
  protected final String TEXT_820 = ";";
  protected final String TEXT_821 = NL + "        return $wasSet;" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_822 = "->";
  protected final String TEXT_823 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_824 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_825 = NL + "  public function ";
  protected final String TEXT_826 = "($";
  protected final String TEXT_827 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_828 = NL + "    //Must provide ";
  protected final String TEXT_829 = " to ";
  protected final String TEXT_830 = NL + "    if ($";
  protected final String TEXT_831 = " == null)" + NL + "    {";
  protected final String TEXT_832 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_833 = " != null && $this->";
  protected final String TEXT_834 = "->";
  protected final String TEXT_835 = "() <= ";
  protected final String TEXT_836 = "::";
  protected final String TEXT_837 = "())" + NL + "    {";
  protected final String TEXT_838 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  ...
  protected final String TEXT_845 = ")" + NL + "    {" + NL + "      $didRemove = $";
  protected final String TEXT_846 = "->";
  protected final String TEXT_847 = "($this);" + NL + "      if (!$didRemove)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_848 = " = $";
  protected final String TEXT_849 = ";";
  protected final String TEXT_850 = NL + "        return $wasSet;" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_851 = "->";
  protected final String TEXT_852 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_853 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_854 = NL + "  public function ";
  protected final String TEXT_855 = "($";
  protected final String TEXT_856 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_857 = NL + "    $";
  protected final String TEXT_858 = " = $";
  protected final String TEXT_859 = "->";
  protected final String TEXT_860 = "();" + NL + "    if ($";
  protected final String TEXT_861 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_862 = "->";
  protected final String TEXT_863 = "($this);" + NL + "    }" + NL + "    elseif ($this !== $";
  protected final String TEXT_864 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_865 = "->";
  protected final String TEXT_866 = "($";
  protected final String TEXT_867 = ");" + NL + "      $this->";
  protected final String TEXT_868 = "($";
  protected final String TEXT_869 = ");" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_870 = "[] = $";
  protected final String TEXT_871 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_872 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_873 = "($";
  protected final String TEXT_874 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_875 = NL + "    if ($this->";
  protected final String TEXT_876 = "($";
  protected final String TEXT_877 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_878 = "[$this->";
  protected final String TEXT_879 = "($";
  protected final String TEXT_880 = ")]);" + NL + "      $this->";
  protected final String TEXT_881 = " = array_values($this->";
  protected final String TEXT_882 = ");" + NL + "      if ($this === $";
  protected final String TEXT_883 = "->";
  protected final String TEXT_884 = "())" + NL + "      {" + NL + "        $";
  protected final String TEXT_885 = "->";
  protected final String TEXT_886 = "(null);" + NL + "      }" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_887 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_888 = NL + "  public function ";
  protected final String TEXT_889 = "($";
  protected final String TEXT_890 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_891 = NL + "    $";
  protected final String TEXT_892 = " = $this->";
  protected final String TEXT_893 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_900 = "($this);" + NL + "    }" + NL + "    if ($";
  ...
  protected final String TEXT_907 = NL + "  public function ";
  protected final String TEXT_908 = "($";
  protected final String TEXT_909 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_910 = NL + "    if ($this->";
  protected final String TEXT_911 = "() >= self::";
  protected final String TEXT_912 = "())" + NL + "    {";
  protected final String TEXT_913 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  ...
  protected final String TEXT_919 = "($this);" + NL + "    }" + NL + "    else if ($this !== $";
  protected final String TEXT_920 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_921 = "->";
  protected final String TEXT_922 = "($";
  protected final String TEXT_923 = ");" + NL + "      $this->";
  protected final String TEXT_924 = "($";
  protected final String TEXT_925 = ");" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_926 = "[] = $";
  protected final String TEXT_927 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_928 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_929 = "($";
  protected final String TEXT_930 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_931 = NL + "    if ($this->";
  protected final String TEXT_932 = "($";
  protected final String TEXT_933 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_934 = "[$this->";
  protected final String TEXT_935 = "($";
  protected final String TEXT_936 = ")]);" + NL + "      $this->";
  protected final String TEXT_937 = " = array_values($this->";
  protected final String TEXT_938 = ");" + NL + "      $";
  protected final String TEXT_939 = "->";
  protected final String TEXT_940 = "(null);" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_941 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  ...
  protected final String TEXT_947 = "())" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_948 = "[] = $";
  protected final String TEXT_949 = ";" + NL + "      $wasAdded = true;" + NL + "    }";
  protected final String TEXT_950 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_951 = "($";
  protected final String TEXT_952 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_953 = NL + "    if ($this->";
  protected final String TEXT_954 = "($";
  protected final String TEXT_955 = ") == -1)" + NL + "    {";
  protected final String TEXT_956 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_957 = "() <= self::";
  protected final String TEXT_958 = "())" + NL + "    {";
  protected final String TEXT_959 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_960 = "[$this->";
  protected final String TEXT_961 = "($";
  protected final String TEXT_962 = ")]);" + NL + "    $this->";
  protected final String TEXT_963 = " = array_values($this->";
  protected final String TEXT_964 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_965 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_966 = NL + "  public function ";
  protected final String TEXT_967 = "($";
  protected final String TEXT_968 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_969 = NL + "    if ($this->";
  protected final String TEXT_970 = "() >= self::";
  protected final String TEXT_971 = "())" + NL + "    {";
  protected final String TEXT_972 = NL + "      return $wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_981 = NL + "      return $wasAdded;" + NL + "    }" + NL + "    else if ($";
  protected final String TEXT_982 = " != null)" + NL + "    {" + NL + "      unset($";
  ...
  protected final String TEXT_989 = " = array_values($";
  protected final String TEXT_990 = "->";
  protected final String TEXT_991 = ");" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_992 = "[] = $";
  protected final String TEXT_993 = ";" + NL + "    $this->";
  protected final String TEXT_994 = "($";
  protected final String TEXT_995 = ",$this);" + NL + "    $wasAdded = true;";
  protected final String TEXT_996 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_997 = "($";
  protected final String TEXT_998 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_999 = NL + "    if ($this->";
  protected final String TEXT_1000 = "($";
  protected final String TEXT_1001 = ") != -1 && $this->";
  protected final String TEXT_1002 = "() > self::";
  protected final String TEXT_1003 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1004 = "[$this->";
  protected final String TEXT_1005 = "($";
  protected final String TEXT_1006 = ")]);" + NL + "      $this->";
  protected final String TEXT_1007 = " = array_values($this->";
  protected final String TEXT_1008 = ");" + NL + "      $this->";
  protected final String TEXT_1009 = "($";
  protected final String TEXT_1010 = ",null);" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1011 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1012 = NL + "  public function ";
  protected final String TEXT_1013 = "($";
  protected final String TEXT_1014 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1015 = NL + "    $";
  protected final String TEXT_1016 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1017 = " as $";
  protected final String TEXT_1018 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1019 = ",$";
  protected final String TEXT_1020 = ") !== false)" + NL + "      {";
  protected final String TEXT_1021 = NL + "        return $wasSet;" + NL + "      }" + NL + "      else if ($";
  protected final String TEXT_1022 = "->";
  protected final String TEXT_1023 = "() != null && $this !== $";
  protected final String TEXT_1024 = "->";
  protected final String TEXT_1025 = "())" + NL + "      {";
  protected final String TEXT_1026 = NL + "        return $wasSet;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1027 = "[] = $";
  protected final String TEXT_1028 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1029 = ") != self::";
  protected final String TEXT_1030 = "())" + NL + "    {";
  protected final String TEXT_1031 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    foreach ($this->";
  protected final String TEXT_1032 = " as $orphan) " + NL + "    {" + NL + "      $wasFound = false;" + NL + "      foreach ($";
  protected final String TEXT_1033 = " as $fosterCare)" + NL + "      {" + NL + "        if ($orphan == $fosterCare)" + NL + "        {" + NL + "          $wasFound = true;" + NL + "          break;" + NL + "        }" + NL + "      }" + NL + "" + NL + "      if (!$wasFound)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1034 = "($orphan, null);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1035 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1036 = " as $";
  protected final String TEXT_1037 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1038 = "($";
  protected final String TEXT_1039 = ", $this);" + NL + "      $this->";
  protected final String TEXT_1040 = "[] = $";
  protected final String TEXT_1041 = ";" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1042 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1043 = NL + "  private function ";
  protected final String TEXT_1044 = "($";
  protected final String TEXT_1045 = ", $";
  protected final String TEXT_1046 = ")" + NL + "  {" + NL + "    $";
  protected final String TEXT_1047 = "->mentor = $";
  protected final String TEXT_1048 = ";" + NL + "    //$prop = new ReflectionProperty($";
  protected final String TEXT_1049 = ", '";
  protected final String TEXT_1050 = "');" + NL + "    //$prop->setAccessible(true);" + NL + "    //$prop->setValue($";
  protected final String TEXT_1051 = ",$";
  protected final String TEXT_1052 = ");" + NL + "    //$prop->setAccessible(false);" + NL + "  }" + NL;
  protected final String TEXT_1053 = NL + "  public function ";
  protected final String TEXT_1054 = "($";
  protected final String TEXT_1055 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1056 = NL + "    $this->";
  protected final String TEXT_1057 = "[] = $";
  protected final String TEXT_1058 = ";" + NL + "    $wasAdded = true;";
  protected final String TEXT_1059 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1060 = "($";
  protected final String TEXT_1061 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1062 = NL + "    if ($this->";
  protected final String TEXT_1063 = "($";
  protected final String TEXT_1064 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1065 = "[$this->";
  protected final String TEXT_1066 = "($";
  protected final String TEXT_1067 = ")]);" + NL + "      $this->";
  protected final String TEXT_1068 = " = array_values($this->";
  protected final String TEXT_1069 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1070 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1071 = NL + "  public function ";
  protected final String TEXT_1072 = "($";
  protected final String TEXT_1073 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1074 = NL + "    if ($this->";
  protected final String TEXT_1075 = "() < self::";
  protected final String TEXT_1076 = "())" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1077 = "[] = $";
  protected final String TEXT_1078 = ";" + NL + "      $wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_1084 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1085 = "[$this->";
  protected final String TEXT_1086 = "($";
  protected final String TEXT_1087 = ")]);" + NL + "      $this->";
  protected final String TEXT_1088 = " = array_values($this->";
  protected final String TEXT_1089 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1090 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  ...
  protected final String TEXT_1102 = ") == -1)" + NL + "    {";
  protected final String TEXT_1103 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_1104 = "() <= self::";
  protected final String TEXT_1105 = "())" + NL + "    {";
  protected final String TEXT_1106 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_1107 = "[$this->";
  protected final String TEXT_1108 = "($";
  protected final String TEXT_1109 = ")]);" + NL + "    $this->";
  protected final String TEXT_1110 = " = array_values($this->";
  protected final String TEXT_1111 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_1112 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1113 = NL + "  public function ";
  protected final String TEXT_1114 = "($";
  protected final String TEXT_1115 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1116 = NL + "    $";
  protected final String TEXT_1117 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1118 = " as $";
  protected final String TEXT_1119 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1120 = ",$";
  protected final String TEXT_1121 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1122 = "[] = $";
  protected final String TEXT_1123 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1124 = ") != count($";
  protected final String TEXT_1125 = ") || count($";
  protected final String TEXT_1126 = ") != self::";
  protected final String TEXT_1127 = "())" + NL + "    {";
  protected final String TEXT_1128 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1129 = " = $";
  protected final String TEXT_1130 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1131 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1132 = NL + "  public function ";
  protected final String TEXT_1133 = "($";
  protected final String TEXT_1134 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1135 = NL + "    $";
  protected final String TEXT_1136 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1137 = " as $";
  protected final String TEXT_1138 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1139 = ",$";
  protected final String TEXT_1140 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1141 = "[] = $";
  protected final String TEXT_1142 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1143 = ") != count($";
  protected final String TEXT_1144 = ") || count($";
  protected final String TEXT_1145 = ") < self::";
  protected final String TEXT_1146 = "() || count($";
  protected final String TEXT_1147 = ") > self::";
  protected final String TEXT_1148 = "())" + NL + "    {";
  protected final String TEXT_1149 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1150 = " = $this->";
  ...
  protected final String TEXT_1154 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1155 = "[] = $";
  protected final String TEXT_1156 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_1157 = ",$";
  protected final String TEXT_1158 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_1159 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_1160 = " = array_values($";
  protected final String TEXT_1161 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1162 = "->";
  protected final String TEXT_1163 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_1164 = " as $";
  protected final String TEXT_1165 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1166 = "->";
  protected final String TEXT_1167 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1168 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1169 = NL + "  public function ";
  ...
  protected final String TEXT_1181 = ") || count($";
  protected final String TEXT_1182 = ") < self::";
  protected final String TEXT_1183 = "())" + NL + "    {";
  protected final String TEXT_1184 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  ...
  protected final String TEXT_1189 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1190 = "[] = $";
  protected final String TEXT_1191 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_1192 = ",$";
  protected final String TEXT_1193 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_1194 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_1195 = " = array_values($";
  protected final String TEXT_1196 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1197 = "->";
  protected final String TEXT_1198 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_1199 = " as $";
  protected final String TEXT_1200 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1201 = "->";
  protected final String TEXT_1202 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1203 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1204 = NL + "  public function ";
  protected final String TEXT_1205 = "($";
  protected final String TEXT_1206 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1207 = NL + "    $";
  protected final String TEXT_1208 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1209 = " as $";
  protected final String TEXT_1210 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1211 = ",$";
  protected final String TEXT_1212 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1213 = "[] = $";
  protected final String TEXT_1214 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1215 = ") != count($";
  protected final String TEXT_1216 = ") || count($";
  protected final String TEXT_1217 = ") < self::";
  protected final String TEXT_1218 = "()  || count($";
  protected final String TEXT_1219 = ") > self::";
  protected final String TEXT_1220 = "())" + NL + "    {";
  protected final String TEXT_1221 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1222 = " = $";
  protected final String TEXT_1223 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1224 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1225 = NL + "  public function ";
  protected final String TEXT_1226 = "($";
  protected final String TEXT_1227 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1228 = NL + "    if (count($";
  protected final String TEXT_1229 = ") < self::";
  protected final String TEXT_1230 = "()";
  protected final String TEXT_1231 = ")" + NL + "    {";
  protected final String TEXT_1232 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1233 = " = array();" + NL + "    $";
  protected final String TEXT_1234 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1235 = " as $";
  protected final String TEXT_1236 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1237 = ",$";
  protected final String TEXT_1238 = ") !== false)" + NL + "      {";
  protected final String TEXT_1239 = NL + "        return $wasSet;" + NL + "      }" + NL + "      else if ($";
  protected final String TEXT_1240 = "->";
  protected final String TEXT_1241 = "() != null && $this !== $";
  protected final String TEXT_1242 = "->";
  protected final String TEXT_1243 = "())" + NL + "      {" + NL + "        $";
  protected final String TEXT_1244 = " = $";
  protected final String TEXT_1245 = "->";
  protected final String TEXT_1246 = "();" + NL + "        $";
  protected final String TEXT_1247 = " = serialize($";
  protected final String TEXT_1248 = ");" + NL + "        if (!array_key_exists($";
  ...
  protected final String TEXT_1254 = "();" + NL + "        }" + NL + "        $nextCount = $";
  protected final String TEXT_1255 = "[$";
  protected final String TEXT_1256 = "] - 1;" + NL + "        if ($nextCount < self::minimum";
  protected final String TEXT_1257 = "())" + NL + "        {";
  protected final String TEXT_1258 = NL + "          return $wasSet;" + NL + "        }" + NL + "        $";
  protected final String TEXT_1259 = "[$";
  protected final String TEXT_1260 = "] = $nextCount;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1261 = "[] = $";
  protected final String TEXT_1262 = ";" + NL + "    }" + NL + "" + NL + "    foreach ($this->";
  protected final String TEXT_1263 = " as $orphan) " + NL + "    {" + NL + "      $wasFound = false;" + NL + "      foreach ($";
  protected final String TEXT_1264 = " as $fosterCare)" + NL + "      {" + NL + "        if ($orphan == $fosterCare)" + NL + "        {" + NL + "          $wasFound = true;" + NL + "          break;" + NL + "        }" + NL + "      }" + NL + "      " + NL + "      if (!$wasFound)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1265 = "($orphan, null);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1266 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1267 = " as $";
  protected final String TEXT_1268 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_1269 = "->";
  protected final String TEXT_1270 = "() != null)" + NL + "      {" + NL + "        unset($";
  ...
  protected final String TEXT_1280 = " = array_values($";
  protected final String TEXT_1281 = "->";
  protected final String TEXT_1282 = "()->";
  protected final String TEXT_1283 = ");" + NL + "      }" + NL + "      $this->";
  protected final String TEXT_1284 = "($";
  protected final String TEXT_1285 = ", $this);" + NL + "      $this->";
  protected final String TEXT_1286 = "[] = $";
  protected final String TEXT_1287 = ";" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1288 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1289 = NL + "  private function ";
  protected final String TEXT_1290 = "($";
  protected final String TEXT_1291 = ", $";
  protected final String TEXT_1292 = ")" + NL + "  {" + NL + "    $";
  protected final String TEXT_1293 = "->mentor = $";
  protected final String TEXT_1294 = ";" + NL + "    //$prop = new ReflectionProperty($";
  protected final String TEXT_1295 = ", '";
  protected final String TEXT_1296 = "');" + NL + "    //$prop->setAccessible(true);" + NL + "    //$prop->setValue($";
  protected final String TEXT_1297 = ",$";
  protected final String TEXT_1298 = ");" + NL + "    //$prop->setAccessible(false);" + NL + "  }" + NL;
  protected final String TEXT_1299 = NL + "  public function ";
  protected final String TEXT_1300 = "($";
  protected final String TEXT_1301 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1302 = NL + "    $";
  protected final String TEXT_1303 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1304 = " as $";
  protected final String TEXT_1305 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1306 = ",$";
  protected final String TEXT_1307 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1308 = "[] = $";
  protected final String TEXT_1309 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1310 = ") != count($";
  protected final String TEXT_1311 = ") || count($";
  protected final String TEXT_1312 = ") > self::";
  protected final String TEXT_1313 = "())" + NL + "    {";
  protected final String TEXT_1314 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1315 = " = $";
  protected final String TEXT_1316 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1317 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1318 = NL + "  public function ";
  protected final String TEXT_1319 = "($";
  protected final String TEXT_1320 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1321 = NL + "    $";
  protected final String TEXT_1322 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1323 = " as $";
  protected final String TEXT_1324 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1325 = ",$";
  protected final String TEXT_1326 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1327 = "[] = $";
  protected final String TEXT_1328 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1329 = ") != count($";
  protected final String TEXT_1330 = ") || count($";
  protected final String TEXT_1331 = ") < self::";
  protected final String TEXT_1332 = "())" + NL + "    {";
  protected final String TEXT_1333 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1334 = " = $";
  protected final String TEXT_1335 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1336 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1337 = NL + "  public function equals($compareTo)" + NL + "  {" + NL + "    if ($compareTo == null) { return false; }" + NL + "    if (get_class($this) != get_class($compareTo)) { return false; }" + NL;
  protected final String TEXT_1338 = NL + "    ";
  protected final String TEXT_1339 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public function hashCode()" + NL + "  {" + NL + "    if ($this->cachedHashCode != -1)" + NL + "    {" + NL + "      return $this->cachedHashCode;" + NL + "    }" + NL + "    $this->cachedHashCode = 17;";
  protected final String TEXT_1340 = NL + "    ";
  protected final String TEXT_1341 = NL;
  protected final String TEXT_1342 = NL + "    ";
  protected final String TEXT_1343 = NL + "    return $this->cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1344 = NL + "  public function equals($compareTo)" + NL + "  {" + NL + "    return $this == $compareTo;" + NL + "  }" + NL;
  protected final String TEXT_1345 = NL + "    $this->";
  protected final String TEXT_1346 = " = null;";
  protected final String TEXT_1347 = NL + "    $this->";
  protected final String TEXT_1348 = " = array();";
  protected final String TEXT_1349 = NL + "    $";
  protected final String TEXT_1350 = " = $this->";
  protected final String TEXT_1351 = ";" + NL + "    $this->";
  protected final String TEXT_1352 = " = null;" + NL + "    if ($";
  protected final String TEXT_1353 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_1354 = "->delete();" + NL + "    }";
  protected final String TEXT_1355 = NL + "    if ($this->";
  protected final String TEXT_1356 = " != null)" + NL + "    {" + NL + "      $this->";
  ...
  protected final String TEXT_1365 = "(null);" + NL + "    }";
  protected final String TEXT_1366 = NL + "    $";
  protected final String TEXT_1367 = " = $this->";
  protected final String TEXT_1368 = ";" + NL + "    $this->";
  protected final String TEXT_1369 = " = null;" + NL + "    if ($";
  protected final String TEXT_1370 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_1371 = "->delete();" + NL + "    }";
  protected final String TEXT_1372 = NL + "    if ($this->";
  protected final String TEXT_1373 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1374 = "->";
  protected final String TEXT_1375 = "($this);" + NL + "    }";
  protected final String TEXT_1376 = NL + "    if ($this->";
  protected final String TEXT_1377 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1378 = "->delete();" + NL + "    }";
  protected final String TEXT_1379 = NL + "    if ($this->";
  protected final String TEXT_1380 = " != null)" + NL + "    {" + NL + "      if ($this->";
  protected final String TEXT_1381 = "->";
  protected final String TEXT_1382 = "() <= ";
  protected final String TEXT_1383 = ")" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1384 = "->delete();" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1385 = "->";
  protected final String TEXT_1386 = "($this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1387 = NL + "    $this->";
  ...
  protected final String TEXT_1392 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1393 = "($";
  protected final String TEXT_1394 = ",null);" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_1395 = " = array();";
  protected final String TEXT_1396 = NL + "    $";
  protected final String TEXT_1397 = " = $this->";
  protected final String TEXT_1398 = ";" + NL + "    $this->";
  protected final String TEXT_1399 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1400 = " as $";
  protected final String TEXT_1401 = ")" + NL + "    {" + NL + "      if ($";
  ...
  protected final String TEXT_1406 = "->delete();" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1407 = "->";
  protected final String TEXT_1408 = "($this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1409 = NL + "    $";
  protected final String TEXT_1410 = " = $this->";
  protected final String TEXT_1411 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_1416 = "($this);" + NL + "    }";
  protected final String TEXT_1417 = NL + "    foreach ($this->";
  protected final String TEXT_1418 = " as $";
  protected final String TEXT_1419 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1420 = "->delete();" + NL + "    }";
  protected final String TEXT_1421 = NL + "    foreach ($this->";
  protected final String TEXT_1422 = " as $";
  protected final String TEXT_1423 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1424 = "->";
  protected final String TEXT_1425 = "(null);" + NL + "    }";
  protected final String TEXT_1426 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
