...
public class PhpClassGenerator implements ILang
{
  ...
  protected final String TEXT_292 = ")" + NL + "  {" + NL + "    $this->";
  protected final String TEXT_293 = " = $";
  protected final String TEXT_294 = ";";
  protected final String TEXT_295 = NL + NL + "    // entry actions and do activities";
  protected final String TEXT_296 = NL + "    ";
  protected final String TEXT_297 = NL + "  }" + NL;
  protected final String TEXT_298 = NL + "  public function ";
  protected final String TEXT_299 = "()" + NL + "  {";
  protected final String TEXT_300 = NL + "    return $this->";
  ...
  protected final String TEXT_309 = "($index)" + NL + "  {";
  protected final String TEXT_310 = NL + "    $";
  protected final String TEXT_311 = " = $this->";
  protected final String TEXT_312 = "[$index];";
  protected final String TEXT_313 = NL + "    return $";
  protected final String TEXT_314 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_315 = "()" + NL + "  {";
  protected final String TEXT_316 = NL + "    $";
  protected final String TEXT_317 = " = $this->";
  protected final String TEXT_318 = ";";
  protected final String TEXT_319 = NL + "    return $";
  protected final String TEXT_320 = ";" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_321 = "()" + NL + "  {";
  protected final String TEXT_322 = NL + "    $number = count($this->";
  protected final String TEXT_323 = ");";
  protected final String TEXT_324 = NL + "    return $number;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_325 = "()" + NL + "  {";
  protected final String TEXT_326 = NL + "    $has = $this->";
  protected final String TEXT_327 = "() > 0;";
  protected final String TEXT_328 = NL + "    return $has;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_329 = "($";
  protected final String TEXT_330 = ")" + NL + "  {";
  protected final String TEXT_331 = NL + "    $wasFound = false;" + NL + "    $index = 0;" + NL + "    foreach($this->";
  protected final String TEXT_332 = " as $";
  protected final String TEXT_333 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_334 = "->equals($";
  protected final String TEXT_335 = "))" + NL + "      {" + NL + "        $wasFound = true;" + NL + "        break;" + NL + "      }" + NL + "      $index += 1;" + NL + "    }" + NL + "    $index = $wasFound ? $index : -1;";
  protected final String TEXT_336 = NL + "    return $index;" + NL + "  }" + NL;
  protected final String TEXT_337 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_338 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_339 = " : ";
  protected final String TEXT_340 = NL + "  public function ";
  protected final String TEXT_341 = "()" + NL + "  {";
  protected final String TEXT_342 = NL + "    $isValid = $this->";
  protected final String TEXT_343 = "() >= self::";
  protected final String TEXT_344 = "();";
  protected final String TEXT_345 = NL + "    $isValid = $this->";
  protected final String TEXT_346 = "() >= self::";
  protected final String TEXT_347 = "() && $this->";
  protected final String TEXT_348 = "() <= self::";
  protected final String TEXT_349 = "();";
  protected final String TEXT_350 = NL + "    return $isValid;" + NL + "  }";
  protected final String TEXT_351 = NL + "  public static function ";
  protected final String TEXT_352 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_353 = ";" + NL + "  }";
  protected final String TEXT_354 = NL + "  public static function ";
  protected final String TEXT_355 = "()" + NL + "  {";
  protected final String TEXT_356 = NL + "    $minimum = ";
  protected final String TEXT_357 = ";";
  protected final String TEXT_358 = NL + "    return $minimum;" + NL + "  }";
  protected final String TEXT_359 = NL + "  public static function ";
  protected final String TEXT_360 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_361 = ";" + NL + "  }";
  protected final String TEXT_362 = NL + "  public static function ";
  protected final String TEXT_363 = "()" + NL + "  {";
  protected final String TEXT_364 = NL + "    $minimum = ";
  protected final String TEXT_365 = ";";
  protected final String TEXT_366 = NL + "    return $minimum;" + NL + "  }";
  protected final String TEXT_367 = NL + "  public static function ";
  protected final String TEXT_368 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_369 = ";" + NL + "  }";
  protected final String TEXT_370 = NL + "  public static function ";
  protected final String TEXT_371 = "()" + NL + "  {";
  protected final String TEXT_372 = NL + "    $maximum = ";
  protected final String TEXT_373 = ";";
  protected final String TEXT_374 = NL + "    return $maximum;" + NL + "  }";
  protected final String TEXT_375 = NL + "  public function ";
  protected final String TEXT_376 = "($";
  protected final String TEXT_377 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_378 = NL + "    if ($this->";
  protected final String TEXT_379 = "() >= self::";
  protected final String TEXT_380 = "())" + NL + "    {";
  protected final String TEXT_381 = NL + "      return $wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_382 = NL + "    $this->";
  protected final String TEXT_383 = "[] = $";
  protected final String TEXT_384 = ";" + NL + "    if ($";
  protected final String TEXT_385 = "->";
  protected final String TEXT_386 = "($this) != -1)" + NL + "    {" + NL + "      $wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasAdded = $";
  protected final String TEXT_387 = "->";
  protected final String TEXT_388 = "($this);" + NL + "      if (!$wasAdded)" + NL + "      {" + NL + "        array_pop($this->";
  protected final String TEXT_389 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_390 = NL + "    return $wasAdded;" + NL + "  }";
  protected final String TEXT_391 = NL + "  public function ";
  protected final String TEXT_392 = "($";
  protected final String TEXT_393 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_394 = NL + "    if ($this->";
  protected final String TEXT_395 = "($";
  protected final String TEXT_396 = ") == -1)" + NL + "    {";
  protected final String TEXT_397 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_398 = "($";
  protected final String TEXT_399 = ");" + NL + "    unset($this->";
  protected final String TEXT_400 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_401 = "->";
  protected final String TEXT_402 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_403 = "->";
  protected final String TEXT_404 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_405 = "[$oldIndex] = $";
  protected final String TEXT_406 = ";" + NL + "        ksort($this->";
  protected final String TEXT_407 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_408 = " = array_values($this->";
  protected final String TEXT_409 = ");";
  protected final String TEXT_410 = NL + "    return $wasRemoved;" + NL + "  }";
  protected final String TEXT_411 = NL + "  public function ";
  protected final String TEXT_412 = "($";
  protected final String TEXT_413 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_414 = NL + "    $this->";
  protected final String TEXT_415 = " = $";
  protected final String TEXT_416 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_417 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_418 = NL + "  public function ";
  protected final String TEXT_419 = "($";
  protected final String TEXT_420 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_421 = NL + "    if ($";
  protected final String TEXT_422 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_423 = " = $";
  protected final String TEXT_424 = ";" + NL + "      $wasSet = true;" + NL + "    }";
  ...
  protected final String TEXT_429 = NL + "    if ($this->";
  protected final String TEXT_430 = " != null && $this->";
  protected final String TEXT_431 = " != $";
  protected final String TEXT_432 = " && $this == $this->";
  protected final String TEXT_433 = "->";
  protected final String TEXT_434 = "())" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_435 = ", as existing ";
  protected final String TEXT_436 = " would become an orphan";
  protected final String TEXT_437 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $this->";
  protected final String TEXT_438 = " = $";
  protected final String TEXT_439 = ";" + NL + "    $";
  protected final String TEXT_440 = " = $";
  protected final String TEXT_441 = " != null ? $";
  protected final String TEXT_442 = "->";
  protected final String TEXT_443 = "() : null;" + NL + "    " + NL + "    if ($this != $";
  protected final String TEXT_444 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_445 = " != null)" + NL + "      {" + NL + "        $";
  protected final String TEXT_446 = "->";
  protected final String TEXT_447 = " = null;" + NL + "      }" + NL + "      if ($this->";
  protected final String TEXT_448 = " != null)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_449 = "->";
  protected final String TEXT_450 = "($this);" + NL + "      }" + NL + "    }" + NL + "    $wasSet = true;";
  ...
  protected final String TEXT_456 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_457 = " to null, as ";
  protected final String TEXT_458 = " must always be associated to a ";
  protected final String TEXT_459 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_460 = " = $";
  protected final String TEXT_461 = "->";
  protected final String TEXT_462 = "();" + NL + "    if ($";
  protected final String TEXT_463 = " != null && $this != $";
  protected final String TEXT_464 = ")" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_465 = ", the current ";
  protected final String TEXT_466 = " already has a ";
  protected final String TEXT_467 = ", which would be orphaned if it were re-assigned";
  protected final String TEXT_468 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  protected final String TEXT_469 = " = $this->";
  protected final String TEXT_470 = ";" + NL + "    $this->";
  protected final String TEXT_471 = " = $";
  protected final String TEXT_472 = ";" + NL + "    $this->";
  protected final String TEXT_473 = "->";
  protected final String TEXT_474 = "($this);" + NL + "    " + NL + "    if ($";
  protected final String TEXT_475 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_476 = "->";
  protected final String TEXT_477 = "(null);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_478 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_479 = NL + "  public function ";
  protected final String TEXT_480 = "(";
  protected final String TEXT_481 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_482 = "(";
  protected final String TEXT_483 = ");" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_484 = "($";
  protected final String TEXT_485 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_486 = NL + "    $";
  protected final String TEXT_487 = " = $";
  protected final String TEXT_488 = "->";
  protected final String TEXT_489 = "();" + NL + "    $";
  protected final String TEXT_490 = " = $";
  protected final String TEXT_491 = " != null && $this !== $";
  protected final String TEXT_492 = ";" + NL + "" + NL + "    if ($";
  protected final String TEXT_493 = " && $";
  protected final String TEXT_494 = "->";
  protected final String TEXT_495 = "() <= self::";
  protected final String TEXT_496 = "())" + NL + "    {" + NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    if ($";
  protected final String TEXT_497 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_498 = "->";
  protected final String TEXT_499 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_500 = "[] = $";
  protected final String TEXT_501 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_502 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_503 = "($";
  protected final String TEXT_504 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_505 = NL + "    //Unable to remove ";
  protected final String TEXT_506 = ", as it must always have a ";
  protected final String TEXT_507 = NL + "    if ($this === $";
  protected final String TEXT_508 = "->";
  protected final String TEXT_509 = "())" + NL + "    {";
  protected final String TEXT_510 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_511 = " already at minimum (";
  protected final String TEXT_512 = ")" + NL + "    if ($this->";
  protected final String TEXT_513 = "() <= self::";
  protected final String TEXT_514 = "())" + NL + "    {";
  protected final String TEXT_515 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_516 = "[$this->";
  protected final String TEXT_517 = "($";
  protected final String TEXT_518 = ")]);" + NL + "    $this->";
  protected final String TEXT_519 = " = array_values($this->";
  protected final String TEXT_520 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_521 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_522 = NL + "  public function ";
  protected final String TEXT_523 = "(";
  protected final String TEXT_524 = ")" + NL + "  {" + NL + "    if ($this->";
  protected final String TEXT_525 = "() >= self::";
  protected final String TEXT_526 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_527 = "(";
  protected final String TEXT_528 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_529 = "($";
  protected final String TEXT_530 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_531 = NL + "    if ($this->";
  protected final String TEXT_532 = "() >= self::";
  protected final String TEXT_533 = "())" + NL + "    {";
  protected final String TEXT_534 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_535 = " = $";
  protected final String TEXT_536 = "->";
  protected final String TEXT_537 = "();" + NL + "    $";
  protected final String TEXT_538 = " = $";
  protected final String TEXT_539 = " != null && $this !== $";
  protected final String TEXT_540 = ";" + NL + "" + NL + "    if ($";
  protected final String TEXT_541 = " && $";
  protected final String TEXT_542 = "->";
  protected final String TEXT_543 = "() <= self::";
  protected final String TEXT_544 = "())" + NL + "    {";
  protected final String TEXT_545 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    if ($";
  protected final String TEXT_546 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_547 = "->";
  protected final String TEXT_548 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_549 = "[] = $";
  protected final String TEXT_550 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_551 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_552 = "($";
  protected final String TEXT_553 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_554 = NL + "    //Unable to remove ";
  protected final String TEXT_555 = ", as it must always have a ";
  protected final String TEXT_556 = NL + "    if ($this === $";
  protected final String TEXT_557 = "->";
  protected final String TEXT_558 = "())" + NL + "    {";
  protected final String TEXT_559 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_560 = " already at minimum (";
  protected final String TEXT_561 = ")" + NL + "    if ($this->";
  protected final String TEXT_562 = "() <= self::";
  protected final String TEXT_563 = "())" + NL + "    {";
  protected final String TEXT_564 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_565 = "[$this->";
  protected final String TEXT_566 = "($";
  protected final String TEXT_567 = ")]);" + NL + "    $this->";
  protected final String TEXT_568 = " = array_values($this->";
  protected final String TEXT_569 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_570 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_571 = NL + "  public function ";
  protected final String TEXT_572 = "(";
  protected final String TEXT_573 = ")" + NL + "  {" + NL + "    if ($this->";
  protected final String TEXT_574 = "() >= self::";
  protected final String TEXT_575 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_576 = "(";
  protected final String TEXT_577 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_578 = "($";
  protected final String TEXT_579 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_580 = NL + "    if ($this->";
  protected final String TEXT_581 = "() >= self::";
  protected final String TEXT_582 = "())" + NL + "    {";
  protected final String TEXT_583 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_584 = " = $";
  protected final String TEXT_585 = "->";
  protected final String TEXT_586 = "();" + NL + "    $";
  protected final String TEXT_587 = " = $";
  protected final String TEXT_588 = " != null && $this !== $";
  protected final String TEXT_589 = ";" + NL + "    if ($";
  protected final String TEXT_590 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_591 = "->";
  protected final String TEXT_592 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_593 = "[] = $";
  protected final String TEXT_594 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_595 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_596 = "($";
  protected final String TEXT_597 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  ...
  protected final String TEXT_602 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_603 = "[$this->";
  protected final String TEXT_604 = "($";
  protected final String TEXT_605 = ")]);" + NL + "      $this->";
  protected final String TEXT_606 = " = array_values($this->";
  protected final String TEXT_607 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_608 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_609 = NL + "  public function ";
  protected final String TEXT_610 = "($";
  protected final String TEXT_611 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_612 = NL + "    $";
  protected final String TEXT_613 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_614 = " as $";
  protected final String TEXT_615 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_616 = ",$";
  protected final String TEXT_617 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_618 = "[] = $";
  protected final String TEXT_619 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_620 = ") != count($";
  protected final String TEXT_621 = ") || count($";
  protected final String TEXT_622 = ") > self::";
  protected final String TEXT_623 = "())" + NL + "    {";
  protected final String TEXT_624 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_625 = " = $this->";
  protected final String TEXT_626 = ";" + NL + "    $this->";
  protected final String TEXT_627 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_628 = " as $";
  protected final String TEXT_629 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_630 = "[] = $";
  protected final String TEXT_631 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_632 = ",$";
  protected final String TEXT_633 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_634 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_635 = " = array_values($";
  protected final String TEXT_636 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_637 = "->";
  protected final String TEXT_638 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_639 = " as $";
  protected final String TEXT_640 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_641 = "->";
  protected final String TEXT_642 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_643 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_644 = NL + "  public function ";
  protected final String TEXT_645 = "(";
  protected final String TEXT_646 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_647 = "(";
  protected final String TEXT_648 = ");" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_649 = "($";
  protected final String TEXT_650 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_651 = NL + "    $";
  protected final String TEXT_652 = " = $";
  protected final String TEXT_653 = "->";
  protected final String TEXT_654 = "();" + NL + "    $";
  protected final String TEXT_655 = " = $";
  protected final String TEXT_656 = " != null && $this !== $";
  protected final String TEXT_657 = ";" + NL + "    if ($";
  protected final String TEXT_658 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_659 = "->";
  protected final String TEXT_660 = "($this);" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_661 = "[] = $";
  protected final String TEXT_662 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_663 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_664 = "($";
  protected final String TEXT_665 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_666 = NL + "    //Unable to remove ";
  protected final String TEXT_667 = ", as it must always have a ";
  protected final String TEXT_668 = NL + "    if ($this !== $";
  protected final String TEXT_669 = "->";
  protected final String TEXT_670 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_671 = "[$this->";
  protected final String TEXT_672 = "($";
  protected final String TEXT_673 = ")]);" + NL + "      $this->";
  protected final String TEXT_674 = " = array_values($this->";
  protected final String TEXT_675 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_676 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_677 = NL + "  public function ";
  protected final String TEXT_678 = "($";
  protected final String TEXT_679 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_680 = NL + "    if ($";
  protected final String TEXT_681 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_682 = " = $this->";
  protected final String TEXT_683 = ";" + NL + "      $this->";
  protected final String TEXT_684 = " = null;" + NL + "      " + NL + "      if ($";
  protected final String TEXT_685 = " != null && $";
  protected final String TEXT_686 = "->";
  protected final String TEXT_687 = "() != null)" + NL + "      {" + NL + "        $";
  protected final String TEXT_688 = "->";
  protected final String TEXT_689 = "(null);" + NL + "      }" + NL + "      $wasSet = true;";
  protected final String TEXT_690 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  ...
  protected final String TEXT_697 = "(null);" + NL + "    }" + NL + "    " + NL + "    $this->";
  protected final String TEXT_698 = " = $";
  protected final String TEXT_699 = ";" + NL + "    $";
  protected final String TEXT_700 = " = $";
  protected final String TEXT_701 = "->";
  protected final String TEXT_702 = "();" + NL + "    " + NL + "    if ($this != $";
  ...
  protected final String TEXT_707 = NL + "  public function ";
  protected final String TEXT_708 = "($";
  protected final String TEXT_709 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_710 = NL + "    if ($this->";
  protected final String TEXT_711 = "($";
  protected final String TEXT_712 = ") == -1)" + NL + "    {";
  protected final String TEXT_713 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_714 = "() <= self::";
  protected final String TEXT_715 = "())" + NL + "    {";
  protected final String TEXT_716 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_717 = "($";
  protected final String TEXT_718 = ");" + NL + "    unset($this->";
  protected final String TEXT_719 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_720 = "->";
  protected final String TEXT_721 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_722 = "->";
  protected final String TEXT_723 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_724 = "[$oldIndex] = $";
  protected final String TEXT_725 = ";" + NL + "        ksort($this->";
  protected final String TEXT_726 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_727 = " = array_values($this->";
  protected final String TEXT_728 = ");";
  protected final String TEXT_729 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_730 = NL + "  public function ";
  protected final String TEXT_731 = "($";
  protected final String TEXT_732 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_733 = NL + "    if ($this->";
  protected final String TEXT_734 = "($";
  protected final String TEXT_735 = ") == -1)" + NL + "    {";
  protected final String TEXT_736 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_737 = "() <= self::";
  protected final String TEXT_738 = "())" + NL + "    {";
  protected final String TEXT_739 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    $oldIndex = $this->";
  protected final String TEXT_740 = "($";
  protected final String TEXT_741 = ");" + NL + "    unset($this->";
  protected final String TEXT_742 = "[$oldIndex]);" + NL + "    if ($";
  protected final String TEXT_743 = "->";
  protected final String TEXT_744 = "($this) == -1)" + NL + "    {" + NL + "      $wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $wasRemoved = $";
  protected final String TEXT_745 = "->";
  protected final String TEXT_746 = "($this);" + NL + "      if (!$wasRemoved)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_747 = "[$oldIndex] = $";
  protected final String TEXT_748 = ";" + NL + "        ksort($this->";
  protected final String TEXT_749 = ");" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_750 = " = array_values($this->";
  protected final String TEXT_751 = ");";
  protected final String TEXT_752 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_753 = NL + "  public function ";
  protected final String TEXT_754 = "($";
  protected final String TEXT_755 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  ...
  protected final String TEXT_762 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  ...
  protected final String TEXT_771 = "($this);" + NL + "    }" + NL + "    if ($";
  protected final String TEXT_772 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_773 = "->";
  protected final String TEXT_774 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  ...
  protected final String TEXT_790 = "($this);" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_791 = "->";
  protected final String TEXT_792 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_793 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_794 = NL + "  public function ";
  protected final String TEXT_795 = "($";
  protected final String TEXT_796 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  ...
  protected final String TEXT_802 = " already at maximum (";
  protected final String TEXT_803 = ")" + NL + "    if ($";
  protected final String TEXT_804 = "->";
  protected final String TEXT_805 = "() >= ";
  protected final String TEXT_806 = "::";
  protected final String TEXT_807 = "())" + NL + "    {";
  protected final String TEXT_808 = NL + "      return $wasSet;" + NL + "    }" + NL + "    " + NL + "    $";
  ...
  protected final String TEXT_815 = ")" + NL + "    {" + NL + "      $didRemove = $";
  protected final String TEXT_816 = "->";
  protected final String TEXT_817 = "($this);" + NL + "      if (!$didRemove)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_818 = " = $";
  protected final String TEXT_819 = ";";
  protected final String TEXT_820 = NL + "        return $wasSet;" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_821 = "->";
  protected final String TEXT_822 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_823 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_824 = NL + "  public function ";
  protected final String TEXT_825 = "($";
  protected final String TEXT_826 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_827 = NL + "    //Must provide ";
  protected final String TEXT_828 = " to ";
  protected final String TEXT_829 = NL + "    if ($";
  protected final String TEXT_830 = " == null)" + NL + "    {";
  protected final String TEXT_831 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_832 = " != null && $this->";
  ...
  protected final String TEXT_844 = ")" + NL + "    {" + NL + "      $didRemove = $";
  protected final String TEXT_845 = "->";
  protected final String TEXT_846 = "($this);" + NL + "      if (!$didRemove)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_847 = " = $";
  protected final String TEXT_848 = ";";
  protected final String TEXT_849 = NL + "        return $wasSet;" + NL + "      }" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_850 = "->";
  protected final String TEXT_851 = "($this);" + NL + "    $wasSet = true;";
  protected final String TEXT_852 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_853 = NL + "  public function ";
  protected final String TEXT_854 = "($";
  protected final String TEXT_855 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_856 = NL + "    $";
  protected final String TEXT_857 = " = $";
  protected final String TEXT_858 = "->";
  protected final String TEXT_859 = "();" + NL + "    if ($";
  protected final String TEXT_860 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_861 = "->";
  protected final String TEXT_862 = "($this);" + NL + "    }" + NL + "    elseif ($this !== $";
  protected final String TEXT_863 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_864 = "->";
  protected final String TEXT_865 = "($";
  protected final String TEXT_866 = ");" + NL + "      $this->";
  protected final String TEXT_867 = "($";
  protected final String TEXT_868 = ");" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_869 = "[] = $";
  protected final String TEXT_870 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_871 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_872 = "($";
  protected final String TEXT_873 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_874 = NL + "    if ($this->";
  protected final String TEXT_875 = "($";
  protected final String TEXT_876 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_877 = "[$this->";
  protected final String TEXT_878 = "($";
  protected final String TEXT_879 = ")]);" + NL + "      $this->";
  protected final String TEXT_880 = " = array_values($this->";
  protected final String TEXT_881 = ");" + NL + "      if ($this === $";
  protected final String TEXT_882 = "->";
  protected final String TEXT_883 = "())" + NL + "      {" + NL + "        $";
  protected final String TEXT_884 = "->";
  protected final String TEXT_885 = "(null);" + NL + "      }" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_886 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_887 = NL + "  public function ";
  protected final String TEXT_888 = "($";
  protected final String TEXT_889 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_890 = NL + "    $";
  protected final String TEXT_891 = " = $this->";
  protected final String TEXT_892 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_899 = "($this);" + NL + "    }" + NL + "    if ($";
  protected final String TEXT_900 = " != null && $";
  protected final String TEXT_901 = " !== $";
  protected final String TEXT_902 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_903 = "->";
  protected final String TEXT_904 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_905 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_906 = NL + "  public function ";
  protected final String TEXT_907 = "($";
  protected final String TEXT_908 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_909 = NL + "    if ($this->";
  protected final String TEXT_910 = "() >= self::";
  protected final String TEXT_911 = "())" + NL + "    {";
  protected final String TEXT_912 = NL + "      return $wasAdded;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_913 = " = $";
  protected final String TEXT_914 = "->";
  protected final String TEXT_915 = "();" + NL + "    if ($";
  protected final String TEXT_916 = " == null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_917 = "->";
  protected final String TEXT_918 = "($this);" + NL + "    }" + NL + "    else if ($this !== $";
  protected final String TEXT_919 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_920 = "->";
  protected final String TEXT_921 = "($";
  protected final String TEXT_922 = ");" + NL + "      $this->";
  protected final String TEXT_923 = "($";
  protected final String TEXT_924 = ");" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_925 = "[] = $";
  protected final String TEXT_926 = ";" + NL + "    }" + NL + "    $wasAdded = true;";
  protected final String TEXT_927 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_928 = "($";
  protected final String TEXT_929 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_930 = NL + "    if ($this->";
  protected final String TEXT_931 = "($";
  protected final String TEXT_932 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  ...
  protected final String TEXT_939 = "(null);" + NL + "      $wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_946 = "())" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_947 = "[] = $";
  protected final String TEXT_948 = ";" + NL + "      $wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_954 = ") == -1)" + NL + "    {";
  protected final String TEXT_955 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_956 = "() <= self::";
  protected final String TEXT_957 = "())" + NL + "    {";
  protected final String TEXT_958 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_959 = "[$this->";
  protected final String TEXT_960 = "($";
  protected final String TEXT_961 = ")]);" + NL + "    $this->";
  protected final String TEXT_962 = " = array_values($this->";
  protected final String TEXT_963 = ");" + NL + "    $wasRemoved = true;";
  ...
  protected final String TEXT_967 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_968 = NL + "    if ($this->";
  protected final String TEXT_969 = "() >= self::";
  protected final String TEXT_970 = "())" + NL + "    {";
  protected final String TEXT_971 = NL + "      return $wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_978 = "() <= self::";
  protected final String TEXT_979 = "())" + NL + "    {";
  protected final String TEXT_980 = NL + "      return $wasAdded;" + NL + "    }" + NL + "    else if ($";
  protected final String TEXT_981 = " != null)" + NL + "    {" + NL + "      unset($";
  ...
  protected final String TEXT_988 = " = array_values($";
  protected final String TEXT_989 = "->";
  protected final String TEXT_990 = ");" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_991 = "[] = $";
  protected final String TEXT_992 = ";" + NL + "    $this->";
  protected final String TEXT_993 = "($";
  protected final String TEXT_994 = ",$this);" + NL + "    $wasAdded = true;";
  protected final String TEXT_995 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_996 = "($";
  protected final String TEXT_997 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_998 = NL + "    if ($this->";
  protected final String TEXT_999 = "($";
  protected final String TEXT_1000 = ") != -1 && $this->";
  protected final String TEXT_1001 = "() > self::";
  protected final String TEXT_1002 = "())" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1003 = "[$this->";
  protected final String TEXT_1004 = "($";
  protected final String TEXT_1005 = ")]);" + NL + "      $this->";
  protected final String TEXT_1006 = " = array_values($this->";
  protected final String TEXT_1007 = ");" + NL + "      $this->";
  protected final String TEXT_1008 = "($";
  protected final String TEXT_1009 = ",null);" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1010 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1011 = NL + "  public function ";
  protected final String TEXT_1012 = "($";
  protected final String TEXT_1013 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1014 = NL + "    $";
  protected final String TEXT_1015 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1016 = " as $";
  protected final String TEXT_1017 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1018 = ",$";
  protected final String TEXT_1019 = ") !== false)" + NL + "      {";
  protected final String TEXT_1020 = NL + "        return $wasSet;" + NL + "      }" + NL + "      else if ($";
  protected final String TEXT_1021 = "->";
  protected final String TEXT_1022 = "() != null && $this !== $";
  protected final String TEXT_1023 = "->";
  protected final String TEXT_1024 = "())" + NL + "      {";
  protected final String TEXT_1025 = NL + "        return $wasSet;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1026 = "[] = $";
  protected final String TEXT_1027 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1028 = ") != self::";
  protected final String TEXT_1029 = "())" + NL + "    {";
  protected final String TEXT_1030 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    foreach ($this->";
  protected final String TEXT_1031 = " as $orphan) " + NL + "    {" + NL + "      $wasFound = false;" + NL + "      foreach ($";
  protected final String TEXT_1032 = " as $fosterCare)" + NL + "      {" + NL + "        if ($orphan == $fosterCare)" + NL + "        {" + NL + "          $wasFound = true;" + NL + "          break;" + NL + "        }" + NL + "      }" + NL + "" + NL + "      if (!$wasFound)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1033 = "($orphan, null);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1034 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1035 = " as $";
  protected final String TEXT_1036 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1037 = "($";
  protected final String TEXT_1038 = ", $this);" + NL + "      $this->";
  protected final String TEXT_1039 = "[] = $";
  protected final String TEXT_1040 = ";" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1041 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1042 = NL + "  private function ";
  protected final String TEXT_1043 = "($";
  protected final String TEXT_1044 = ", $";
  protected final String TEXT_1045 = ")" + NL + "  {" + NL + "    $";
  protected final String TEXT_1046 = "->mentor = $";
  protected final String TEXT_1047 = ";" + NL + "    //$prop = new ReflectionProperty($";
  protected final String TEXT_1048 = ", '";
  protected final String TEXT_1049 = "');" + NL + "    //$prop->setAccessible(true);" + NL + "    //$prop->setValue($";
  protected final String TEXT_1050 = ",$";
  protected final String TEXT_1051 = ");" + NL + "    //$prop->setAccessible(false);" + NL + "  }" + NL;
  protected final String TEXT_1052 = NL + "  public function ";
  protected final String TEXT_1053 = "($";
  protected final String TEXT_1054 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1055 = NL + "    $this->";
  protected final String TEXT_1056 = "[] = $";
  protected final String TEXT_1057 = ";" + NL + "    $wasAdded = true;";
  protected final String TEXT_1058 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1059 = "($";
  protected final String TEXT_1060 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1061 = NL + "    if ($this->";
  protected final String TEXT_1062 = "($";
  protected final String TEXT_1063 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  protected final String TEXT_1064 = "[$this->";
  protected final String TEXT_1065 = "($";
  protected final String TEXT_1066 = ")]);" + NL + "      $this->";
  protected final String TEXT_1067 = " = array_values($this->";
  protected final String TEXT_1068 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1069 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1070 = NL + "  public function ";
  protected final String TEXT_1071 = "($";
  protected final String TEXT_1072 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  ...
  protected final String TEXT_1077 = ";" + NL + "      $wasAdded = true;" + NL + "    }";
  protected final String TEXT_1078 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1079 = "($";
  protected final String TEXT_1080 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1081 = NL + "    if ($this->";
  protected final String TEXT_1082 = "($";
  protected final String TEXT_1083 = ") != -1)" + NL + "    {" + NL + "      unset($this->";
  ...
  protected final String TEXT_1088 = ");" + NL + "      $wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1089 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1090 = NL + "  public function ";
  protected final String TEXT_1091 = "($";
  protected final String TEXT_1092 = ")" + NL + "  {" + NL + "    $wasAdded = false;";
  protected final String TEXT_1093 = NL + "    $this->";
  protected final String TEXT_1094 = "[] = $";
  protected final String TEXT_1095 = ";" + NL + "    $wasAdded = true;";
  protected final String TEXT_1096 = NL + "    return $wasAdded;" + NL + "  }" + NL + "" + NL + "  public function ";
  protected final String TEXT_1097 = "($";
  protected final String TEXT_1098 = ")" + NL + "  {" + NL + "    $wasRemoved = false;";
  protected final String TEXT_1099 = NL + "    if ($this->";
  protected final String TEXT_1100 = "($";
  protected final String TEXT_1101 = ") == -1)" + NL + "    {";
  protected final String TEXT_1102 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    if ($this->";
  protected final String TEXT_1103 = "() <= self::";
  protected final String TEXT_1104 = "())" + NL + "    {";
  protected final String TEXT_1105 = NL + "      return $wasRemoved;" + NL + "    }" + NL + "" + NL + "    unset($this->";
  protected final String TEXT_1106 = "[$this->";
  protected final String TEXT_1107 = "($";
  protected final String TEXT_1108 = ")]);" + NL + "    $this->";
  protected final String TEXT_1109 = " = array_values($this->";
  protected final String TEXT_1110 = ");" + NL + "    $wasRemoved = true;";
  protected final String TEXT_1111 = NL + "    return $wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1112 = NL + "  public function ";
  protected final String TEXT_1113 = "($";
  protected final String TEXT_1114 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1115 = NL + "    $";
  protected final String TEXT_1116 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1117 = " as $";
  protected final String TEXT_1118 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1119 = ",$";
  protected final String TEXT_1120 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1121 = "[] = $";
  protected final String TEXT_1122 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1123 = ") != count($";
  protected final String TEXT_1124 = ") || count($";
  protected final String TEXT_1125 = ") != self::";
  protected final String TEXT_1126 = "())" + NL + "    {";
  protected final String TEXT_1127 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1128 = " = $";
  protected final String TEXT_1129 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1130 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1131 = NL + "  public function ";
  protected final String TEXT_1132 = "($";
  protected final String TEXT_1133 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1134 = NL + "    $";
  protected final String TEXT_1135 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1136 = " as $";
  protected final String TEXT_1137 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1138 = ",$";
  protected final String TEXT_1139 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1140 = "[] = $";
  protected final String TEXT_1141 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1142 = ") != count($";
  protected final String TEXT_1143 = ") || count($";
  protected final String TEXT_1144 = ") < self::";
  protected final String TEXT_1145 = "() || count($";
  protected final String TEXT_1146 = ") > self::";
  protected final String TEXT_1147 = "())" + NL + "    {";
  protected final String TEXT_1148 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  ...
  protected final String TEXT_1155 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_1156 = ",$";
  protected final String TEXT_1157 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_1158 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_1159 = " = array_values($";
  protected final String TEXT_1160 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1161 = "->";
  protected final String TEXT_1162 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_1163 = " as $";
  protected final String TEXT_1164 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1165 = "->";
  protected final String TEXT_1166 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  ...
  protected final String TEXT_1183 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $";
  protected final String TEXT_1184 = " = $this->";
  protected final String TEXT_1185 = ";" + NL + "    $this->";
  protected final String TEXT_1186 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1187 = " as $";
  protected final String TEXT_1188 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1189 = "[] = $";
  protected final String TEXT_1190 = ";" + NL + "      $removeIndex = array_search($";
  protected final String TEXT_1191 = ",$";
  protected final String TEXT_1192 = ");" + NL + "      if ($removeIndex !== false)" + NL + "      {" + NL + "        unset($";
  protected final String TEXT_1193 = "[$removeIndex]);" + NL + "        $";
  protected final String TEXT_1194 = " = array_values($";
  protected final String TEXT_1195 = ");" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1196 = "->";
  protected final String TEXT_1197 = "($this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    foreach ($";
  protected final String TEXT_1198 = " as $";
  protected final String TEXT_1199 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1200 = "->";
  protected final String TEXT_1201 = "($this);" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1202 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1203 = NL + "  public function ";
  protected final String TEXT_1204 = "($";
  protected final String TEXT_1205 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  ...
  protected final String TEXT_1211 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1212 = "[] = $";
  protected final String TEXT_1213 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1214 = ") != count($";
  protected final String TEXT_1215 = ") || count($";
  protected final String TEXT_1216 = ") < self::";
  protected final String TEXT_1217 = "()  || count($";
  protected final String TEXT_1218 = ") > self::";
  protected final String TEXT_1219 = "())" + NL + "    {";
  protected final String TEXT_1220 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1221 = " = $";
  protected final String TEXT_1222 = ";" + NL + "    $wasSet = true;";
  ...
  protected final String TEXT_1226 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1227 = NL + "    if (count($";
  protected final String TEXT_1228 = ") < self::";
  ...
  protected final String TEXT_1232 = " = array();" + NL + "    $";
  protected final String TEXT_1233 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1234 = " as $";
  protected final String TEXT_1235 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1236 = ",$";
  protected final String TEXT_1237 = ") !== false)" + NL + "      {";
  protected final String TEXT_1238 = NL + "        return $wasSet;" + NL + "      }" + NL + "      else if ($";
  protected final String TEXT_1239 = "->";
  protected final String TEXT_1240 = "() != null && $this !== $";
  ...
  protected final String TEXT_1246 = " = serialize($";
  protected final String TEXT_1247 = ");" + NL + "        if (!array_key_exists($";
  ...
  protected final String TEXT_1253 = "();" + NL + "        }" + NL + "        $nextCount = $";
  protected final String TEXT_1254 = "[$";
  protected final String TEXT_1255 = "] - 1;" + NL + "        if ($nextCount < self::minimum";
  protected final String TEXT_1256 = "())" + NL + "        {";
  protected final String TEXT_1257 = NL + "          return $wasSet;" + NL + "        }" + NL + "        $";
  protected final String TEXT_1258 = "[$";
  protected final String TEXT_1259 = "] = $nextCount;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1260 = "[] = $";
  protected final String TEXT_1261 = ";" + NL + "    }" + NL + "" + NL + "    foreach ($this->";
  protected final String TEXT_1262 = " as $orphan) " + NL + "    {" + NL + "      $wasFound = false;" + NL + "      foreach ($";
  protected final String TEXT_1263 = " as $fosterCare)" + NL + "      {" + NL + "        if ($orphan == $fosterCare)" + NL + "        {" + NL + "          $wasFound = true;" + NL + "          break;" + NL + "        }" + NL + "      }" + NL + "      " + NL + "      if (!$wasFound)" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1264 = "($orphan, null);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1265 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1266 = " as $";
  protected final String TEXT_1267 = ")" + NL + "    {" + NL + "      if ($";
  protected final String TEXT_1268 = "->";
  protected final String TEXT_1269 = "() != null)" + NL + "      {" + NL + "        unset($";
  ...
  protected final String TEXT_1279 = " = array_values($";
  ...
  protected final String TEXT_1284 = ", $this);" + NL + "      $this->";
  protected final String TEXT_1285 = "[] = $";
  protected final String TEXT_1286 = ";" + NL + "    }" + NL + "    $wasSet = true;";
  protected final String TEXT_1287 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1288 = NL + "  private function ";
  protected final String TEXT_1289 = "($";
  protected final String TEXT_1290 = ", $";
  protected final String TEXT_1291 = ")" + NL + "  {" + NL + "    $";
  protected final String TEXT_1292 = "->mentor = $";
  protected final String TEXT_1293 = ";" + NL + "    //$prop = new ReflectionProperty($";
  protected final String TEXT_1294 = ", '";
  protected final String TEXT_1295 = "');" + NL + "    //$prop->setAccessible(true);" + NL + "    //$prop->setValue($";
  protected final String TEXT_1296 = ",$";
  protected final String TEXT_1297 = ");" + NL + "    //$prop->setAccessible(false);" + NL + "  }" + NL;
  protected final String TEXT_1298 = NL + "  public function ";
  protected final String TEXT_1299 = "($";
  protected final String TEXT_1300 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1301 = NL + "    $";
  protected final String TEXT_1302 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1303 = " as $";
  protected final String TEXT_1304 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1305 = ",$";
  protected final String TEXT_1306 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1307 = "[] = $";
  protected final String TEXT_1308 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1309 = ") != count($";
  protected final String TEXT_1310 = ") || count($";
  protected final String TEXT_1311 = ") > self::";
  protected final String TEXT_1312 = "())" + NL + "    {";
  protected final String TEXT_1313 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  protected final String TEXT_1314 = " = $";
  protected final String TEXT_1315 = ";" + NL + "    $wasSet = true;";
  protected final String TEXT_1316 = NL + "    return $wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1317 = NL + "  public function ";
  protected final String TEXT_1318 = "($";
  protected final String TEXT_1319 = ")" + NL + "  {" + NL + "    $wasSet = false;";
  protected final String TEXT_1320 = NL + "    $";
  protected final String TEXT_1321 = " = array();" + NL + "    foreach ($";
  protected final String TEXT_1322 = " as $";
  protected final String TEXT_1323 = ")" + NL + "    {" + NL + "      if (array_search($";
  protected final String TEXT_1324 = ",$";
  protected final String TEXT_1325 = ") !== false)" + NL + "      {" + NL + "        continue;" + NL + "      }" + NL + "      $";
  protected final String TEXT_1326 = "[] = $";
  protected final String TEXT_1327 = ";" + NL + "    }" + NL + "" + NL + "    if (count($";
  protected final String TEXT_1328 = ") != count($";
  protected final String TEXT_1329 = ") || count($";
  protected final String TEXT_1330 = ") < self::";
  protected final String TEXT_1331 = "())" + NL + "    {";
  protected final String TEXT_1332 = NL + "      return $wasSet;" + NL + "    }" + NL + "" + NL + "    $this->";
  ...
  protected final String TEXT_1336 = NL + "  public function equals($compareTo)" + NL + "  {" + NL + "    if ($compareTo == null) { return false; }" + NL + "    if (get_class($this) != get_class($compareTo)) { return false; }" + NL;
  protected final String TEXT_1337 = NL + "    ";
  protected final String TEXT_1338 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public function hashCode()" + NL + "  {" + NL + "    if ($this->cachedHashCode != -1)" + NL + "    {" + NL + "      return $this->cachedHashCode;" + NL + "    }" + NL + "    $this->cachedHashCode = 17;";
  protected final String TEXT_1339 = NL + "    ";
  protected final String TEXT_1340 = NL;
  protected final String TEXT_1341 = NL + "    ";
  protected final String TEXT_1342 = NL + "    return $this->cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1343 = NL + "  public function equals($compareTo)" + NL + "  {" + NL + "    return $this == $compareTo;" + NL + "  }" + NL;
  protected final String TEXT_1344 = NL + "    $this->";
  protected final String TEXT_1345 = " = null;";
  protected final String TEXT_1346 = NL + "    $this->";
  protected final String TEXT_1347 = " = array();";
  protected final String TEXT_1348 = NL + "    $";
  protected final String TEXT_1349 = " = $this->";
  protected final String TEXT_1350 = ";" + NL + "    $this->";
  protected final String TEXT_1351 = " = null;" + NL + "    if ($";
  protected final String TEXT_1352 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_1353 = "->delete();" + NL + "    }";
  protected final String TEXT_1354 = NL + "    if ($this->";
  protected final String TEXT_1355 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1356 = "->";
  protected final String TEXT_1357 = "(null);" + NL + "    }";
  protected final String TEXT_1358 = NL + "    $";
  protected final String TEXT_1359 = " = $this->";
  protected final String TEXT_1360 = ";" + NL + "    $this->";
  protected final String TEXT_1361 = " = null;" + NL + "    if ($";
  protected final String TEXT_1362 = " != null)" + NL + "    {" + NL + "      $";
  ...
  protected final String TEXT_1367 = ";" + NL + "    $this->";
  protected final String TEXT_1368 = " = null;" + NL + "    if ($";
  protected final String TEXT_1369 = " != null)" + NL + "    {" + NL + "      $";
  protected final String TEXT_1370 = "->delete();" + NL + "    }";
  protected final String TEXT_1371 = NL + "    if ($this->";
  protected final String TEXT_1372 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1373 = "->";
  protected final String TEXT_1374 = "($this);" + NL + "    }";
  protected final String TEXT_1375 = NL + "    if ($this->";
  protected final String TEXT_1376 = " != null)" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1377 = "->delete();" + NL + "    }";
  protected final String TEXT_1378 = NL + "    if ($this->";
  protected final String TEXT_1379 = " != null)" + NL + "    {" + NL + "      if ($this->";
  protected final String TEXT_1380 = "->";
  protected final String TEXT_1381 = "() <= ";
  protected final String TEXT_1382 = ")" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1383 = "->delete();" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $this->";
  protected final String TEXT_1384 = "->";
  protected final String TEXT_1385 = "($this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1386 = NL + "    $this->";
  ...
  protected final String TEXT_1391 = ")" + NL + "    {" + NL + "      $this->";
  protected final String TEXT_1392 = "($";
  protected final String TEXT_1393 = ",null);" + NL + "    }" + NL + "    $this->";
  protected final String TEXT_1394 = " = array();";
  ...
  protected final String TEXT_1405 = "->delete();" + NL + "      }" + NL + "      else" + NL + "      {" + NL + "        $";
  protected final String TEXT_1406 = "->";
  protected final String TEXT_1407 = "($this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1408 = NL + "    $";
  protected final String TEXT_1409 = " = $this->";
  protected final String TEXT_1410 = ";" + NL + "    $this->";
  ...
  protected final String TEXT_1416 = NL + "    foreach ($this->";
  protected final String TEXT_1417 = " as $";
  protected final String TEXT_1418 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1419 = "->delete();" + NL + "    }";
  protected final String TEXT_1420 = NL + "    foreach ($this->";
  protected final String TEXT_1421 = " as $";
  protected final String TEXT_1422 = ")" + NL + "    {" + NL + "      $";
  protected final String TEXT_1423 = "->";
  protected final String TEXT_1424 = "(null);" + NL + "    }";
  protected final String TEXT_1425 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
