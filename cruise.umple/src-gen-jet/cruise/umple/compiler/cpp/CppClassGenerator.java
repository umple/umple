...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_141 = NL + NL + "  //------------------------" + NL + "  // INTERFACE" + NL + "  //------------------------" + NL;
  protected final String TEXT_142 = NL + "  bool ";
  protected final String TEXT_143 = "::";
  protected final String TEXT_144 = "(";
  protected final String TEXT_145 = "& ";
  protected final String TEXT_146 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_147 = NL + "    ";
  protected final String TEXT_148 = " = false;";
  protected final String TEXT_149 = NL + "    ";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_152 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_153 = NL + "  bool ";
  protected final String TEXT_154 = "::";
  protected final String TEXT_155 = "(";
  protected final String TEXT_156 = "& ";
  protected final String TEXT_157 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_158 = NL + "    ";
  protected final String TEXT_159 = " = ";
  protected final String TEXT_160 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_161 = NL + "    return wasSet;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_162 = "::";
  protected final String TEXT_163 = "()" + NL + "  {" + NL + "    bool wasReset = false;";
  ...
  protected final String TEXT_172 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_173 = NL + "    wasAdded = ";
  protected final String TEXT_174 = ".add(";
  protected final String TEXT_175 = ");";
  protected final String TEXT_176 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_177 = "::";
  protected final String TEXT_178 = "(";
  protected final String TEXT_179 = "& ";
  protected final String TEXT_180 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_181 = NL + "    wasRemoved = ";
  protected final String TEXT_182 = ".remove(";
  protected final String TEXT_183 = ");";
  protected final String TEXT_184 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_185 = NL + "  bool ";
  protected final String TEXT_186 = "::";
  protected final String TEXT_187 = "(";
  protected final String TEXT_188 = "& ";
  protected final String TEXT_189 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_190 = NL + "    ";
  protected final String TEXT_191 = " = ";
  protected final String TEXT_192 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_193 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_194 = NL + "  ";
  protected final String TEXT_195 = " ";
  protected final String TEXT_196 = "::";
  protected final String TEXT_197 = "(int index)" + NL + "  {";
  protected final String TEXT_198 = NL + "    ";
  protected final String TEXT_199 = " ";
  protected final String TEXT_200 = " = ";
  protected final String TEXT_201 = ".get(index);";
  ...
  protected final String TEXT_211 = ".toArray(new ";
  protected final String TEXT_212 = "[";
  protected final String TEXT_213 = ".size()]);";
  protected final String TEXT_214 = NL + "    return ";
  protected final String TEXT_215 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_216 = "::";
  protected final String TEXT_217 = "()" + NL + "  {";
  protected final String TEXT_218 = NL + "    int number = ";
  protected final String TEXT_219 = ".size();";
  protected final String TEXT_220 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_221 = "::";
  protected final String TEXT_222 = "()" + NL + "  {";
  protected final String TEXT_223 = NL + "    bool has = ";
  protected final String TEXT_224 = ".size() > 0;";
  protected final String TEXT_225 = NL + "    return has;" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_226 = "::";
  protected final String TEXT_227 = "(";
  protected final String TEXT_228 = " ";
  protected final String TEXT_229 = ")" + NL + "  {";
  protected final String TEXT_230 = NL + "    int index = ";
  protected final String TEXT_231 = ".indexOf(";
  ...
  protected final String TEXT_300 = "()" + NL + "  {" + NL + "    String answer = ";
  protected final String TEXT_301 = ".toString();";
  protected final String TEXT_302 = NL + "    return answer;" + NL + "  }" + NL;
  protected final String TEXT_303 = NL + "  ";
  protected final String TEXT_304 = " ";
  protected final String TEXT_305 = "::";
  protected final String TEXT_306 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_307 = ";" + NL + "  }" + NL;
  protected final String TEXT_308 = NL + "  ";
  protected final String TEXT_309 = "bool ";
  protected final String TEXT_310 = "::";
  protected final String TEXT_311 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;" + NL;
  protected final String TEXT_312 = NL + "    ";
  protected final String TEXT_313 = NL + NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  ...
  protected final String TEXT_321 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_322 = NL + "  private void ";
  protected final String TEXT_323 = "::";
  protected final String TEXT_324 = "()" + NL + "  {" + NL + "    switch(";
  protected final String TEXT_325 = ")" + NL + "    {";
  protected final String TEXT_326 = NL + "      ";
  protected final String TEXT_327 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_328 = NL + "  private void ";
  ...
  protected final String TEXT_346 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_371 = ".get(index);";
  ...
  protected final String TEXT_382 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_383 = "::";
  protected final String TEXT_384 = "()" + NL + "  {";
  protected final String TEXT_385 = NL + "    int number = ";
  protected final String TEXT_386 = ".size();";
  protected final String TEXT_387 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_388 = "::";
  protected final String TEXT_389 = "()" + NL + "  {";
  protected final String TEXT_390 = NL + "    bool has = ";
  protected final String TEXT_391 = ".size() > 0;";
  protected final String TEXT_392 = NL + "    return has;" + NL + "  }" + NL + "  " + NL + "  int ";
  protected final String TEXT_393 = "::";
  protected final String TEXT_394 = "(";
  protected final String TEXT_395 = " ";
  protected final String TEXT_396 = ")" + NL + "  {";
  protected final String TEXT_397 = NL + "    int index = std::find(";
  protected final String TEXT_398 = ".begin(), ";
  protected final String TEXT_399 = ".end(), ";
  protected final String TEXT_400 = ") - ";
  protected final String TEXT_401 = ".begin();";
  ...
  protected final String TEXT_409 = NL + "    bool isValid = ";
  protected final String TEXT_410 = "() >= ";
  protected final String TEXT_411 = "();";
  protected final String TEXT_412 = NL + "    bool isValid = ";
  protected final String TEXT_413 = "() >= ";
  protected final String TEXT_414 = "() && ";
  protected final String TEXT_415 = "() <= ";
  protected final String TEXT_416 = "();";
  protected final String TEXT_417 = NL + "    return isValid;" + NL + "  }";
  protected final String TEXT_418 = NL + "  static int ";
  protected final String TEXT_419 = "::";
  protected final String TEXT_420 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_421 = ";" + NL + "  }";
  protected final String TEXT_422 = NL + "  static int ";
  protected final String TEXT_423 = "::";
  protected final String TEXT_424 = "()" + NL + "  {";
  protected final String TEXT_425 = NL + "    int required = ";
  protected final String TEXT_426 = ";";
  protected final String TEXT_427 = NL + "    return required;" + NL + "  }";
  protected final String TEXT_428 = NL + "  static int ";
  protected final String TEXT_429 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_430 = ";" + NL + "  }";
  protected final String TEXT_431 = NL + "  static int ";
  protected final String TEXT_432 = "::";
  protected final String TEXT_433 = "()" + NL + "  {";
  protected final String TEXT_434 = NL + "    int minimum = ";
  protected final String TEXT_435 = ";";
  protected final String TEXT_436 = NL + "    return minimum;" + NL + "  }";
  protected final String TEXT_437 = NL + "  static int ";
  ...
  protected final String TEXT_444 = NL + "    int maximum = ";
  protected final String TEXT_445 = ";";
  protected final String TEXT_446 = NL + "    return maximum;" + NL + "  }";
  protected final String TEXT_447 = NL + "  bool ";
  protected final String TEXT_448 = "::";
  protected final String TEXT_449 = "(";
  protected final String TEXT_450 = " ";
  protected final String TEXT_451 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_452 = NL + "    if (";
  protected final String TEXT_453 = "() >= ";
  protected final String TEXT_454 = "())" + NL + "    {";
  protected final String TEXT_455 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_456 = NL + "    ";
  protected final String TEXT_457 = ".add(";
  protected final String TEXT_458 = ");" + NL + "    if (";
  protected final String TEXT_459 = ".";
  protected final String TEXT_460 = "(this) != -1)" + NL + "    {" + NL + "      wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasAdded = ";
  protected final String TEXT_461 = ".";
  protected final String TEXT_462 = "(this);" + NL + "      if (!wasAdded)" + NL + "      {";
  protected final String TEXT_463 = NL + "        ";
  protected final String TEXT_464 = ".remove(";
  protected final String TEXT_465 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_466 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_467 = NL + "  bool ";
  protected final String TEXT_468 = "::";
  protected final String TEXT_469 = "(";
  protected final String TEXT_470 = " ";
  protected final String TEXT_471 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_472 = NL + "    if (!";
  protected final String TEXT_473 = ".contains(";
  protected final String TEXT_474 = "))" + NL + "    {";
  protected final String TEXT_475 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_476 = ".indexOf(";
  protected final String TEXT_477 = ");";
  protected final String TEXT_478 = NL + "    ";
  protected final String TEXT_479 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_480 = ".";
  protected final String TEXT_481 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_482 = ".";
  protected final String TEXT_483 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_484 = NL + "        ";
  protected final String TEXT_485 = ".add(oldIndex,";
  protected final String TEXT_486 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_487 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_488 = NL + "  bool ";
  protected final String TEXT_489 = "::";
  protected final String TEXT_490 = "(";
  protected final String TEXT_491 = "* ";
  protected final String TEXT_492 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_493 = NL + "    ";
  protected final String TEXT_494 = " = ";
  protected final String TEXT_495 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_496 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_497 = NL + "  bool ";
  protected final String TEXT_498 = "::";
  protected final String TEXT_499 = "(";
  protected final String TEXT_500 = "* ";
  protected final String TEXT_501 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_502 = NL + "    if (";
  protected final String TEXT_503 = " != null)" + NL + "    {";
  protected final String TEXT_504 = NL + "      ";
  protected final String TEXT_505 = " = ";
  protected final String TEXT_506 = ";" + NL + "      wasSet = true;" + NL + "    }";
  protected final String TEXT_507 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_515 = ".equals(";
  ...
  protected final String TEXT_521 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_530 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  protected final String TEXT_531 = "))" + NL + "    {" + NL + "      if (";
  protected final String TEXT_532 = " != null)" + NL + "      {";
  protected final String TEXT_533 = NL + "        ";
  protected final String TEXT_534 = ".";
  protected final String TEXT_535 = " = null;" + NL + "      }" + NL + "      if (";
  protected final String TEXT_536 = " != null)" + NL + "      {";
  protected final String TEXT_537 = NL + "        ";
  protected final String TEXT_538 = ".";
  protected final String TEXT_539 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_540 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_541 = NL + "  bool ";
  protected final String TEXT_542 = "::";
  protected final String TEXT_543 = "(";
  protected final String TEXT_544 = " ";
  protected final String TEXT_545 = ")" + NL + "  {" + NL + "    bool";
  protected final String TEXT_546 = NL + "    if (";
  protected final String TEXT_547 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_548 = " to null, as ";
  protected final String TEXT_549 = " must always be associated to a ";
  ...
  protected final String TEXT_557 = "))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_558 = ", the current ";
  protected final String TEXT_559 = " already has a ";
  protected final String TEXT_560 = ", which would be orphaned if it were re-assigned";
  protected final String TEXT_561 = NL + "      return wasSet;" + NL + "    }" + NL + "    ";
  ...
  protected final String TEXT_571 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_572 = " != null)" + NL + "    {";
  protected final String TEXT_573 = NL + "      ";
  protected final String TEXT_574 = ".";
  protected final String TEXT_575 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_583 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_584 = "::";
  protected final String TEXT_585 = "(";
  protected final String TEXT_586 = " ";
  protected final String TEXT_587 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_588 = NL + "    ";
  protected final String TEXT_589 = " ";
  protected final String TEXT_590 = " = ";
  protected final String TEXT_591 = ".";
  protected final String TEXT_592 = "();" + NL + "    bool ";
  protected final String TEXT_593 = " = ";
  protected final String TEXT_594 = " != null && !this.equals(";
  protected final String TEXT_595 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_596 = " && ";
  protected final String TEXT_597 = ".";
  protected final String TEXT_598 = "() <= ";
  protected final String TEXT_599 = "())" + NL + "    {" + NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_600 = ")" + NL + "    {";
  protected final String TEXT_601 = NL + "      ";
  protected final String TEXT_602 = ".";
  protected final String TEXT_603 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_604 = NL + "      ";
  protected final String TEXT_605 = ".add(";
  protected final String TEXT_606 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_607 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_608 = "::";
  protected final String TEXT_609 = "(";
  protected final String TEXT_610 = " ";
  protected final String TEXT_611 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_612 = NL + "    //Unable to remove ";
  protected final String TEXT_613 = ", as it must always have a ";
  protected final String TEXT_614 = NL + "    if (this.equals(";
  protected final String TEXT_615 = ".";
  protected final String TEXT_616 = "()))" + NL + "    {";
  protected final String TEXT_617 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_618 = " already at minimum (";
  protected final String TEXT_619 = ")" + NL + "    if (";
  protected final String TEXT_620 = "() <= ";
  protected final String TEXT_621 = "())" + NL + "    {";
  protected final String TEXT_622 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_623 = NL + "    ";
  protected final String TEXT_624 = ".remove(";
  protected final String TEXT_625 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_626 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_635 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_636 = "::";
  protected final String TEXT_637 = "(";
  protected final String TEXT_638 = " ";
  protected final String TEXT_639 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_648 = "();" + NL + "    bool ";
  ...
  protected final String TEXT_664 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_665 = "::";
  protected final String TEXT_666 = "(";
  protected final String TEXT_667 = " ";
  protected final String TEXT_668 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_669 = NL + "    //Unable to remove ";
  protected final String TEXT_670 = ", as it must always have a ";
  protected final String TEXT_671 = NL + "    if (this.equals(";
  protected final String TEXT_672 = ".";
  protected final String TEXT_673 = "()))" + NL + "    {";
  protected final String TEXT_674 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_675 = " already at minimum (";
  protected final String TEXT_676 = ")" + NL + "    if (";
  protected final String TEXT_677 = "() <= ";
  protected final String TEXT_678 = "())" + NL + "    {";
  protected final String TEXT_679 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_680 = NL + "    ";
  protected final String TEXT_681 = ".remove(";
  protected final String TEXT_682 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_683 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_690 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_691 = "(";
  protected final String TEXT_692 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_693 = "::";
  protected final String TEXT_694 = "(";
  protected final String TEXT_695 = " ";
  protected final String TEXT_696 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_697 = NL + "    if (";
  protected final String TEXT_698 = "() >= ";
  protected final String TEXT_699 = "())" + NL + "    {";
  protected final String TEXT_700 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_701 = NL + "    ";
  protected final String TEXT_702 = " ";
  protected final String TEXT_703 = " = ";
  protected final String TEXT_704 = ".";
  protected final String TEXT_705 = "();" + NL + "    bool ";
  ...
  protected final String TEXT_715 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_716 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_717 = "::";
  protected final String TEXT_718 = "(";
  protected final String TEXT_719 = " ";
  protected final String TEXT_720 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_727 = ".remove(";
  protected final String TEXT_728 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_729 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_730 = NL + "  bool ";
  protected final String TEXT_731 = "::";
  protected final String TEXT_732 = "(";
  protected final String TEXT_733 = "... ";
  protected final String TEXT_734 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_735 = NL + "    vector<";
  protected final String TEXT_736 = "*> ";
  protected final String TEXT_737 = " = new vector<";
  protected final String TEXT_738 = "*>();" + NL + "    for (";
  protected final String TEXT_739 = " ";
  protected final String TEXT_740 = " : ";
  protected final String TEXT_741 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_742 = ".contains(";
  protected final String TEXT_743 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_744 = NL + "      ";
  protected final String TEXT_745 = ".add(";
  protected final String TEXT_746 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_747 = ".size() != ";
  protected final String TEXT_748 = ".length || ";
  protected final String TEXT_749 = ".size() > ";
  protected final String TEXT_750 = "())" + NL + "    {";
  protected final String TEXT_751 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_752 = "*> ";
  protected final String TEXT_753 = " = new vector<";
  protected final String TEXT_754 = "*>(";
  protected final String TEXT_755 = ");";
  protected final String TEXT_756 = NL + "    ";
  protected final String TEXT_757 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_764 = ".contains(";
  protected final String TEXT_765 = "))" + NL + "      {";
  protected final String TEXT_766 = NL + "        ";
  protected final String TEXT_767 = ".remove(";
  protected final String TEXT_768 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_769 = NL + "        ";
  protected final String TEXT_770 = ".";
  protected final String TEXT_771 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_772 = " ";
  protected final String TEXT_773 = " : ";
  protected final String TEXT_774 = ")" + NL + "    {";
  protected final String TEXT_775 = NL + "      ";
  protected final String TEXT_776 = ".";
  protected final String TEXT_777 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_778 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_779 = NL + "  ";
  protected final String TEXT_780 = " ";
  protected final String TEXT_781 = "::";
  protected final String TEXT_782 = "(";
  protected final String TEXT_783 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_784 = "(";
  protected final String TEXT_785 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_786 = "::";
  protected final String TEXT_787 = "(";
  protected final String TEXT_788 = " ";
  protected final String TEXT_789 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_790 = NL + "    ";
  protected final String TEXT_791 = " ";
  protected final String TEXT_792 = " = ";
  protected final String TEXT_793 = ".";
  protected final String TEXT_794 = "();" + NL + "    bool ";
  protected final String TEXT_795 = " = ";
  protected final String TEXT_796 = " != null && !this.equals(";
  protected final String TEXT_797 = ");" + NL + "    if (";
  protected final String TEXT_798 = ")" + NL + "    {";
  protected final String TEXT_799 = NL + "      ";
  protected final String TEXT_800 = ".";
  protected final String TEXT_801 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_802 = NL + "      ";
  protected final String TEXT_803 = ".add(";
  protected final String TEXT_804 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_805 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_806 = "::";
  protected final String TEXT_807 = "(";
  protected final String TEXT_808 = " ";
  protected final String TEXT_809 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_810 = NL + "    //Unable to remove ";
  protected final String TEXT_811 = ", as it must always have a ";
  protected final String TEXT_812 = NL + "    if (!this.equals(";
  protected final String TEXT_813 = ".";
  protected final String TEXT_814 = "()))" + NL + "    {";
  protected final String TEXT_815 = NL + "      ";
  protected final String TEXT_816 = ".remove(";
  protected final String TEXT_817 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_818 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_819 = NL + "  bool ";
  protected final String TEXT_820 = "::";
  protected final String TEXT_821 = "(";
  protected final String TEXT_822 = "* ";
  protected final String TEXT_823 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_831 = " = null;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_837 = "(null);" + NL + "      }" + NL + "      wasSet = true;";
  ...
  protected final String TEXT_856 = "();" + NL + "" + NL + "    if (!equals(";
  ...
  protected final String TEXT_861 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_862 = NL + "  bool ";
  protected final String TEXT_863 = "::";
  protected final String TEXT_864 = "(";
  protected final String TEXT_865 = " ";
  protected final String TEXT_866 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_867 = NL + "    if (!";
  protected final String TEXT_868 = ".contains(";
  protected final String TEXT_869 = "))" + NL + "    {";
  protected final String TEXT_870 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_871 = "() <= ";
  protected final String TEXT_872 = "())" + NL + "    {";
  protected final String TEXT_873 = NL + "      return wasRemoved;" + NL + "    }" + NL + "\t" + NL + "    int oldIndex = std::find(";
  protected final String TEXT_874 = ".begin(), ";
  protected final String TEXT_875 = ".end(), ";
  protected final String TEXT_876 = ") - ";
  protected final String TEXT_877 = ".begin();";
  protected final String TEXT_878 = NL + "    ";
  protected final String TEXT_879 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_880 = ".";
  protected final String TEXT_881 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_882 = ".";
  protected final String TEXT_883 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_884 = NL + "        ";
  protected final String TEXT_885 = ".add(oldIndex,";
  protected final String TEXT_886 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_887 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_894 = ".contains(";
  protected final String TEXT_895 = "))" + NL + "    {";
  protected final String TEXT_896 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_897 = "() <= ";
  protected final String TEXT_898 = "())" + NL + "    {";
  protected final String TEXT_899 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = std::find(";
  protected final String TEXT_900 = ".begin(), ";
  protected final String TEXT_901 = ".end(), ";
  protected final String TEXT_902 = ") - ";
  protected final String TEXT_903 = ".begin();";
  protected final String TEXT_904 = NL + "    ";
  protected final String TEXT_905 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_906 = ".";
  protected final String TEXT_907 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_908 = ".";
  protected final String TEXT_909 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_910 = NL + "        ";
  protected final String TEXT_911 = ".add(oldIndex,";
  protected final String TEXT_912 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_913 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_925 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_934 = ".equals(";
  ...
  protected final String TEXT_939 = " != null)" + NL + "    {";
  protected final String TEXT_940 = NL + "      ";
  protected final String TEXT_941 = ".";
  protected final String TEXT_942 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_943 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_944 = NL + "  bool ";
  protected final String TEXT_945 = "::";
  protected final String TEXT_946 = "(";
  protected final String TEXT_947 = " ";
  protected final String TEXT_948 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_959 = " != null && !";
  protected final String TEXT_960 = ".equals(";
  protected final String TEXT_961 = "))" + NL + "    {";
  protected final String TEXT_962 = NL + "      ";
  protected final String TEXT_963 = ".";
  protected final String TEXT_964 = "(this);" + NL + "    }";
  protected final String TEXT_965 = NL + "    ";
  protected final String TEXT_966 = ".";
  protected final String TEXT_967 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_968 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_969 = NL + "  bool ";
  protected final String TEXT_970 = "::";
  protected final String TEXT_971 = "(";
  protected final String TEXT_972 = " ";
  protected final String TEXT_973 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_974 = NL + "    //Must provide ";
  protected final String TEXT_975 = " to ";
  protected final String TEXT_976 = NL + "    if (";
  protected final String TEXT_977 = " == null)" + NL + "    {";
  protected final String TEXT_978 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_979 = " already at maximum (";
  ...
  protected final String TEXT_994 = ".equals(";
  protected final String TEXT_995 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_996 = ".";
  protected final String TEXT_997 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1004 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1005 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1006 = NL + "  bool ";
  protected final String TEXT_1007 = "::";
  protected final String TEXT_1008 = "(";
  protected final String TEXT_1009 = " ";
  protected final String TEXT_1010 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1011 = NL + "    //Must provide ";
  protected final String TEXT_1012 = " to ";
  protected final String TEXT_1013 = NL + "    if (";
  protected final String TEXT_1014 = " == null)" + NL + "    {";
  protected final String TEXT_1015 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1030 = ".equals(";
  protected final String TEXT_1031 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1032 = ".";
  protected final String TEXT_1033 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1041 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1042 = NL + "  bool ";
  protected final String TEXT_1043 = "::";
  protected final String TEXT_1044 = "(";
  protected final String TEXT_1045 = " ";
  protected final String TEXT_1046 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1055 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1063 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1064 = NL + "      ";
  protected final String TEXT_1065 = ".add(";
  protected final String TEXT_1066 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1067 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1068 = "::";
  protected final String TEXT_1069 = "(";
  protected final String TEXT_1070 = " ";
  protected final String TEXT_1071 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1080 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1081 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1082 = NL + "  bool ";
  protected final String TEXT_1083 = "::";
  protected final String TEXT_1084 = "(";
  protected final String TEXT_1085 = "* ";
  protected final String TEXT_1086 = ")" + NL + "  {" + NL + "    boolwasSet = false;";
  ...
  protected final String TEXT_1113 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1122 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1130 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1131 = NL + "      ";
  protected final String TEXT_1132 = ".add(";
  protected final String TEXT_1133 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1134 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1135 = "::";
  protected final String TEXT_1136 = "(";
  protected final String TEXT_1137 = " ";
  protected final String TEXT_1138 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1147 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1148 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1159 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_1166 = ".contains(";
  protected final String TEXT_1167 = "))" + NL + "    {";
  protected final String TEXT_1168 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1169 = "() <= ";
  protected final String TEXT_1170 = "())" + NL + "    {";
  protected final String TEXT_1171 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1172 = NL + "    ";
  protected final String TEXT_1173 = ".remove(";
  protected final String TEXT_1174 = ");" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_1184 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1194 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1195 = " != null)" + NL + "    {";
  ...
  protected final String TEXT_1205 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1206 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1207 = "::";
  protected final String TEXT_1208 = "(";
  protected final String TEXT_1209 = " ";
  protected final String TEXT_1210 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1221 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1222 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1223 = NL + "  bool ";
  protected final String TEXT_1224 = "::";
  protected final String TEXT_1225 = "(";
  protected final String TEXT_1226 = "... ";
  protected final String TEXT_1227 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1228 = NL + "    vector<";
  protected final String TEXT_1229 = "*> ";
  protected final String TEXT_1230 = " = new vector<";
  protected final String TEXT_1231 = "*>();" + NL + "    for (";
  protected final String TEXT_1232 = " ";
  protected final String TEXT_1233 = " : ";
  protected final String TEXT_1234 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1235 = ".contains(";
  protected final String TEXT_1236 = "))" + NL + "      {";
  protected final String TEXT_1237 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1238 = ".";
  protected final String TEXT_1239 = "() != null && !this.equals(";
  protected final String TEXT_1240 = ".";
  protected final String TEXT_1241 = "()))" + NL + "      {";
  protected final String TEXT_1242 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1243 = NL + "      ";
  protected final String TEXT_1244 = ".add(";
  protected final String TEXT_1245 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1246 = ".size() != ";
  protected final String TEXT_1247 = "())" + NL + "    {";
  protected final String TEXT_1248 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1249 = NL + "    ";
  protected final String TEXT_1250 = ".removeAll(";
  protected final String TEXT_1251 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1252 = " orphan : ";
  protected final String TEXT_1253 = ")" + NL + "    {";
  protected final String TEXT_1254 = NL + "      ";
  protected final String TEXT_1255 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1256 = NL + "    ";
  protected final String TEXT_1257 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1265 = ".add(";
  protected final String TEXT_1266 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1267 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1268 = NL + "  void ";
  ...
  protected final String TEXT_1274 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1275 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1276 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1277 = ", ";
  protected final String TEXT_1278 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1279 = " to ";
  protected final String TEXT_1280 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1281 = NL + "  bool ";
  protected final String TEXT_1282 = "::";
  protected final String TEXT_1283 = "(";
  protected final String TEXT_1284 = " ";
  protected final String TEXT_1285 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1286 = NL + "    ";
  protected final String TEXT_1287 = ".add(";
  protected final String TEXT_1288 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1289 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1290 = "::";
  protected final String TEXT_1291 = "(";
  protected final String TEXT_1292 = " ";
  protected final String TEXT_1293 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1298 = ".remove(";
  protected final String TEXT_1299 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1300 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1301 = NL + "  bool ";
  protected final String TEXT_1302 = "::";
  protected final String TEXT_1303 = "(";
  protected final String TEXT_1304 = " ";
  protected final String TEXT_1305 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1311 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1312 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1313 = "::";
  protected final String TEXT_1314 = "(";
  protected final String TEXT_1315 = " ";
  protected final String TEXT_1316 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1322 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1328 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1329 = NL + "    ";
  protected final String TEXT_1330 = ".add(";
  protected final String TEXT_1331 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1332 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1333 = "::";
  protected final String TEXT_1334 = "(";
  protected final String TEXT_1335 = " ";
  protected final String TEXT_1336 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1337 = NL + "    if (!";
  protected final String TEXT_1338 = ".contains(";
  protected final String TEXT_1339 = "))" + NL + "    {";
  protected final String TEXT_1340 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1341 = "() <= ";
  protected final String TEXT_1342 = "())" + NL + "    {";
  protected final String TEXT_1343 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1344 = NL + "    ";
  protected final String TEXT_1345 = ".remove(";
  protected final String TEXT_1346 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1347 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1348 = NL + "  bool ";
  protected final String TEXT_1349 = "::";
  protected final String TEXT_1350 = "(";
  protected final String TEXT_1351 = "... ";
  protected final String TEXT_1352 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1353 = NL + "    vector<";
  protected final String TEXT_1354 = "*> ";
  protected final String TEXT_1355 = " = new vector<";
  protected final String TEXT_1356 = "*>();" + NL + "    for (";
  protected final String TEXT_1357 = " ";
  protected final String TEXT_1358 = " : ";
  protected final String TEXT_1359 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1360 = ".contains(";
  protected final String TEXT_1361 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1362 = NL + "      ";
  protected final String TEXT_1363 = ".add(";
  protected final String TEXT_1364 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1365 = ".size() != ";
  protected final String TEXT_1366 = ".length || ";
  ...
  protected final String TEXT_1371 = ".clear();";
  protected final String TEXT_1372 = NL + "    ";
  protected final String TEXT_1373 = ".addAll(";
  protected final String TEXT_1374 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1375 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1376 = NL + "  bool ";
  protected final String TEXT_1377 = "::";
  protected final String TEXT_1378 = "(";
  protected final String TEXT_1379 = "... ";
  protected final String TEXT_1380 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1381 = NL + "    vector<";
  protected final String TEXT_1382 = "*> ";
  protected final String TEXT_1383 = " = new vector<";
  protected final String TEXT_1384 = "*>();" + NL + "    for (";
  protected final String TEXT_1385 = " ";
  protected final String TEXT_1386 = " : ";
  protected final String TEXT_1387 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1388 = ".contains(";
  protected final String TEXT_1389 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1390 = NL + "      ";
  protected final String TEXT_1391 = ".add(";
  protected final String TEXT_1392 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1393 = ".size() != ";
  protected final String TEXT_1394 = ".length || ";
  ...
  protected final String TEXT_1399 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  ...
  protected final String TEXT_1405 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1415 = ".remove(";
  protected final String TEXT_1416 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1417 = NL + "        ";
  protected final String TEXT_1418 = ".";
  protected final String TEXT_1419 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1425 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1426 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1427 = NL + "  bool ";
  protected final String TEXT_1428 = "::";
  protected final String TEXT_1429 = "(";
  protected final String TEXT_1430 = "... ";
  protected final String TEXT_1431 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1432 = NL + "    vector<";
  protected final String TEXT_1433 = "*> ";
  protected final String TEXT_1434 = " = new vector<";
  protected final String TEXT_1435 = "*>();" + NL + "    for (";
  protected final String TEXT_1436 = " ";
  protected final String TEXT_1437 = " : ";
  protected final String TEXT_1438 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1439 = ".contains(";
  protected final String TEXT_1440 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1441 = NL + "      ";
  protected final String TEXT_1442 = ".add(";
  protected final String TEXT_1443 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1444 = ".size() != ";
  protected final String TEXT_1445 = ".length || ";
  protected final String TEXT_1446 = ".size() < ";
  protected final String TEXT_1447 = "())" + NL + "    {";
  protected final String TEXT_1448 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  ...
  protected final String TEXT_1460 = ");" + NL + "      if (";
  ...
  protected final String TEXT_1465 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1466 = NL + "        ";
  protected final String TEXT_1467 = ".";
  protected final String TEXT_1468 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1474 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1481 = NL + "    vector<";
  protected final String TEXT_1482 = "*> ";
  protected final String TEXT_1483 = " = new vector<";
  protected final String TEXT_1484 = "*>();" + NL + "    for (";
  protected final String TEXT_1485 = " ";
  protected final String TEXT_1486 = " : ";
  protected final String TEXT_1487 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1488 = ".contains(";
  protected final String TEXT_1489 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1490 = NL + "      ";
  protected final String TEXT_1491 = ".add(";
  protected final String TEXT_1492 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1493 = ".size() != ";
  protected final String TEXT_1494 = ".length || ";
  ...
  protected final String TEXT_1501 = ".clear();";
  protected final String TEXT_1502 = NL + "    ";
  protected final String TEXT_1503 = ".addAll(";
  protected final String TEXT_1504 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1505 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1506 = NL + "  bool ";
  protected final String TEXT_1507 = "::";
  protected final String TEXT_1508 = "(";
  protected final String TEXT_1509 = "... ";
  protected final String TEXT_1510 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1515 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1516 = "*> ";
  protected final String TEXT_1517 = " = new vector<";
  protected final String TEXT_1518 = "*>();" + NL + "    HashMap<";
  protected final String TEXT_1519 = ",Integer> ";
  protected final String TEXT_1520 = " = new HashMap<";
  protected final String TEXT_1521 = ",Integer>();" + NL + "    for (";
  ...
  protected final String TEXT_1527 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1528 = ".";
  protected final String TEXT_1529 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1537 = ".containsKey(";
  protected final String TEXT_1538 = "))" + NL + "        {";
  protected final String TEXT_1539 = NL + "          ";
  protected final String TEXT_1540 = ".put(";
  protected final String TEXT_1541 = ", new Integer(";
  protected final String TEXT_1542 = ".";
  protected final String TEXT_1543 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1544 = ".get(";
  protected final String TEXT_1545 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1546 = ")" + NL + "        {";
  protected final String TEXT_1547 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1548 = NL + "        ";
  protected final String TEXT_1549 = ".put(";
  protected final String TEXT_1550 = ", new Integer(nextCount));" + NL + "      }";
  protected final String TEXT_1551 = NL + "      ";
  protected final String TEXT_1552 = ".add(";
  protected final String TEXT_1553 = ");" + NL + "    }" + NL;
  protected final String TEXT_1554 = NL + "    ";
  protected final String TEXT_1555 = ".removeAll(";
  protected final String TEXT_1556 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1557 = " orphan : ";
  protected final String TEXT_1558 = ")" + NL + "    {";
  protected final String TEXT_1559 = NL + "      ";
  protected final String TEXT_1560 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1561 = NL + "    ";
  protected final String TEXT_1562 = ".clear();" + NL + "    for (";
  protected final String TEXT_1563 = " ";
  protected final String TEXT_1564 = " : ";
  protected final String TEXT_1565 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1566 = ".";
  protected final String TEXT_1567 = "() != null)" + NL + "      {";
  protected final String TEXT_1568 = NL + "        ";
  protected final String TEXT_1569 = ".";
  protected final String TEXT_1570 = "().";
  protected final String TEXT_1571 = ".remove(";
  ...
  protected final String TEXT_1578 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1579 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1580 = NL + "  void ";
  ...
  protected final String TEXT_1586 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1587 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1588 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1589 = ", ";
  protected final String TEXT_1590 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1591 = " to ";
  protected final String TEXT_1592 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1600 = " = new vector<";
  ...
  protected final String TEXT_1620 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1621 = NL + "  bool ";
  protected final String TEXT_1622 = "::";
  protected final String TEXT_1623 = "(";
  protected final String TEXT_1624 = "... ";
  protected final String TEXT_1625 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1626 = NL + "    vector<";
  protected final String TEXT_1627 = "*> ";
  protected final String TEXT_1628 = " = new vector<";
  ...
  protected final String TEXT_1642 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1643 = NL + "    ";
  protected final String TEXT_1644 = ".clear();";
  protected final String TEXT_1645 = NL + "    ";
  protected final String TEXT_1646 = ".addAll(";
  protected final String TEXT_1647 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1648 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1649 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1650 = NL + "    ";
  protected final String TEXT_1651 = " == (";
  protected final String TEXT_1652 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1653 = NL + "    ";
  protected final String TEXT_1654 = NL;
  protected final String TEXT_1655 = NL + "    ";
  protected final String TEXT_1656 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1657 = NL + "   void ";
  protected final String TEXT_1658 = "::";
  protected final String TEXT_1659 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1660 = NL + "       ";
  protected final String TEXT_1661 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1662 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1663 = NL + "    ";
  protected final String TEXT_1664 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1665 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1666 = NL + "      ";
  protected final String TEXT_1667 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1668 = NL + "  void ";
  protected final String TEXT_1669 = "::";
  protected final String TEXT_1670 = "()" + NL + "  {";
  protected final String TEXT_1671 = NL + "    ";
  protected final String TEXT_1672 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1673 = "\",";
  protected final String TEXT_1674 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1675 = "::";
  protected final String TEXT_1676 = "()" + NL + "  {";
  protected final String TEXT_1677 = NL + "    ";
  protected final String TEXT_1678 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1679 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1680 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1681 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1682 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1683 = "::run ()" + NL + "    {";
  protected final String TEXT_1684 = NL + "      if (\"";
  protected final String TEXT_1685 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1686 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1687 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1688 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1689 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1690 = NL + "    ";
  protected final String TEXT_1691 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1692 = ";";
  protected final String TEXT_1693 = NL + "    ";
  protected final String TEXT_1694 = ".clear();";
  ...
  protected final String TEXT_1700 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1701 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1707 = "(NULL);" + NL + "    }";
  ...
  protected final String TEXT_1713 = " = NULL;" + NL + "    if (";
  ...
  protected final String TEXT_1723 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1724 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1725 = ";" + NL + "    }";
  protected final String TEXT_1726 = NL + "    if (";
  protected final String TEXT_1727 = " != null)" + NL + "    {";
  protected final String TEXT_1728 = NL + "      ";
  protected final String TEXT_1729 = " ";
  protected final String TEXT_1730 = " = ";
  protected final String TEXT_1731 = ";" + NL + "      this.";
  protected final String TEXT_1732 = " = NULL;";
  protected final String TEXT_1733 = NL + "      ";
  protected final String TEXT_1734 = ".";
  protected final String TEXT_1735 = "(this);" + NL + "    }";
  protected final String TEXT_1736 = NL + "    if (";
  protected final String TEXT_1737 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1738 = ";" + NL + "    }";
  protected final String TEXT_1739 = NL + "    if (";
  protected final String TEXT_1740 = " != NULL)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1741 = ".";
  protected final String TEXT_1742 = "() <= ";
  protected final String TEXT_1743 = ")" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1744 = ";" + NL + "      }" + NL + "      else" + NL + "      {";
  ...
  protected final String TEXT_1791 = ");i++)" + NL + "    {";
  protected final String TEXT_1792 = NL + "      ";
  protected final String TEXT_1793 = "[i].";
  protected final String TEXT_1794 = "(this);" + NL + "    }";
  protected final String TEXT_1795 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1796 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1797 = "[i];" + NL + "    }";
  protected final String TEXT_1798 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1799 = "); i++)" + NL + "    {";
  protected final String TEXT_1800 = NL + "      ";
  protected final String TEXT_1801 = "[i].";
  protected final String TEXT_1802 = "(NULL);" + NL + "    }";
  protected final String TEXT_1803 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
