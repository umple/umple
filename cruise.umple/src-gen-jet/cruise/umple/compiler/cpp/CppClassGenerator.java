...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_1398 = NL + "    ArrayList<";
  protected final String TEXT_1399 = "> ";
  protected final String TEXT_1400 = " = new ArrayList<";
  ...
  protected final String TEXT_1411 = ".length)" + NL + "    {";
  protected final String TEXT_1412 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1413 = NL + "    ";
  protected final String TEXT_1414 = ".clear();";
  protected final String TEXT_1415 = NL + "    ";
  protected final String TEXT_1416 = ".addAll(";
  protected final String TEXT_1417 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1418 = NL + "    return wasSet;" + NL + "  }" + NL;
  ...
  protected final String TEXT_1423 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1424 = NL + "    vector<";
  protected final String TEXT_1425 = "*> ";
  protected final String TEXT_1426 = " = new vector<";
  protected final String TEXT_1427 = "*>();" + NL + "    for (";
  protected final String TEXT_1428 = " ";
  protected final String TEXT_1429 = " : ";
  protected final String TEXT_1430 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1431 = ".contains(";
  protected final String TEXT_1432 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1433 = NL + "      ";
  protected final String TEXT_1434 = ".add(";
  protected final String TEXT_1435 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1436 = ".size() != ";
  protected final String TEXT_1437 = ".length || ";
  protected final String TEXT_1438 = ".size() < ";
  protected final String TEXT_1439 = "() || ";
  protected final String TEXT_1440 = ".size() > ";
  protected final String TEXT_1441 = "())" + NL + "    {";
  protected final String TEXT_1442 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1443 = "*> ";
  protected final String TEXT_1444 = " = new vector<";
  protected final String TEXT_1445 = "*>(";
  protected final String TEXT_1446 = ");";
  protected final String TEXT_1447 = NL + "    ";
  protected final String TEXT_1448 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1459 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1460 = NL + "        ";
  protected final String TEXT_1461 = ".";
  protected final String TEXT_1462 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1468 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1469 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1470 = NL + "  bool ";
  protected final String TEXT_1471 = "::";
  protected final String TEXT_1472 = "(";
  protected final String TEXT_1473 = "... ";
  protected final String TEXT_1474 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1475 = NL + "    vector<";
  protected final String TEXT_1476 = "*> ";
  protected final String TEXT_1477 = " = new vector<";
  protected final String TEXT_1478 = "*>();" + NL + "    for (";
  protected final String TEXT_1479 = " ";
  protected final String TEXT_1480 = " : ";
  protected final String TEXT_1481 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1482 = ".contains(";
  protected final String TEXT_1483 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1484 = NL + "      ";
  protected final String TEXT_1485 = ".add(";
  protected final String TEXT_1486 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1497 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1517 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1518 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1519 = NL + "  bool ";
  protected final String TEXT_1520 = "::";
  protected final String TEXT_1521 = "(";
  protected final String TEXT_1522 = "... ";
  protected final String TEXT_1523 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1524 = NL + "    vector<";
  protected final String TEXT_1525 = "*> ";
  protected final String TEXT_1526 = " = new vector<";
  protected final String TEXT_1527 = "*>();" + NL + "    for (";
  protected final String TEXT_1528 = " ";
  protected final String TEXT_1529 = " : ";
  protected final String TEXT_1530 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1531 = ".contains(";
  protected final String TEXT_1532 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1533 = NL + "      ";
  protected final String TEXT_1534 = ".add(";
  protected final String TEXT_1535 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1536 = ".size() != ";
  protected final String TEXT_1537 = ".length || ";
  ...
  protected final String TEXT_1544 = ".clear();";
  protected final String TEXT_1545 = NL + "    ";
  protected final String TEXT_1546 = ".addAll(";
  protected final String TEXT_1547 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1548 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1549 = NL + "  bool ";
  protected final String TEXT_1550 = "::";
  protected final String TEXT_1551 = "(";
  protected final String TEXT_1552 = "... ";
  protected final String TEXT_1553 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1554 = NL + "    if (";
  protected final String TEXT_1555 = ".length < ";
  protected final String TEXT_1556 = "()";
  protected final String TEXT_1557 = ")" + NL + "    {";
  protected final String TEXT_1558 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1559 = "*> ";
  protected final String TEXT_1560 = " = new vector<";
  protected final String TEXT_1561 = "*>();" + NL + "    HashMap<";
  protected final String TEXT_1562 = ",Integer> ";
  protected final String TEXT_1563 = " = new HashMap<";
  protected final String TEXT_1564 = ",Integer>();" + NL + "    for (";
  protected final String TEXT_1565 = " ";
  protected final String TEXT_1566 = " : ";
  protected final String TEXT_1567 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1568 = ".contains(";
  protected final String TEXT_1569 = "))" + NL + "      {";
  protected final String TEXT_1570 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1571 = ".";
  protected final String TEXT_1572 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1580 = ".containsKey(";
  protected final String TEXT_1581 = "))" + NL + "        {";
  protected final String TEXT_1582 = NL + "          ";
  protected final String TEXT_1583 = ".put(";
  protected final String TEXT_1584 = ", new Integer(";
  protected final String TEXT_1585 = ".";
  protected final String TEXT_1586 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1587 = ".get(";
  protected final String TEXT_1588 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  ...
  protected final String TEXT_1592 = ".put(";
  protected final String TEXT_1593 = ", new Integer(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1598 = ".removeAll(";
  protected final String TEXT_1599 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1600 = " orphan : ";
  protected final String TEXT_1601 = ")" + NL + "    {";
  protected final String TEXT_1602 = NL + "      ";
  protected final String TEXT_1603 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1604 = NL + "    ";
  protected final String TEXT_1605 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1614 = ".remove(";
  ...
  protected final String TEXT_1621 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1622 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1623 = NL + "  void ";
  ...
  protected final String TEXT_1629 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1630 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1631 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1632 = ", ";
  protected final String TEXT_1633 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1634 = " to ";
  protected final String TEXT_1635 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1640 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1641 = NL + "    vector<";
  protected final String TEXT_1642 = "*> ";
  protected final String TEXT_1643 = " = new vector<";
  protected final String TEXT_1644 = "*>();" + NL + "    for (";
  protected final String TEXT_1645 = " ";
  protected final String TEXT_1646 = " : ";
  protected final String TEXT_1647 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1648 = ".contains(";
  protected final String TEXT_1649 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1650 = NL + "      ";
  protected final String TEXT_1651 = ".add(";
  protected final String TEXT_1652 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1653 = ".size() != ";
  protected final String TEXT_1654 = ".length || ";
  ...
  protected final String TEXT_1661 = ".addAll(";
  protected final String TEXT_1662 = ");" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1669 = NL + "    vector<";
  protected final String TEXT_1670 = "*> ";
  protected final String TEXT_1671 = " = new vector<";
  ...
  protected final String TEXT_1692 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1693 = NL + "    ";
  protected final String TEXT_1694 = " == (";
  protected final String TEXT_1695 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1696 = NL + "    ";
  protected final String TEXT_1697 = NL;
  protected final String TEXT_1698 = NL + "    ";
  protected final String TEXT_1699 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1700 = NL + "   void ";
  protected final String TEXT_1701 = "::";
  protected final String TEXT_1702 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1703 = NL + "       ";
  protected final String TEXT_1704 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1705 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1706 = NL + "    ";
  protected final String TEXT_1707 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1708 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1709 = NL + "      ";
  protected final String TEXT_1710 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1711 = NL + "  void ";
  protected final String TEXT_1712 = "::";
  protected final String TEXT_1713 = "()" + NL + "  {";
  protected final String TEXT_1714 = NL + "    ";
  protected final String TEXT_1715 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1716 = "\",";
  protected final String TEXT_1717 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1718 = "::";
  protected final String TEXT_1719 = "()" + NL + "  {";
  protected final String TEXT_1720 = NL + "    ";
  protected final String TEXT_1721 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1722 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1723 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1724 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1725 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1726 = "::run ()" + NL + "    {";
  protected final String TEXT_1727 = NL + "      if (\"";
  protected final String TEXT_1728 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1729 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1730 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1731 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1732 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1733 = NL + "    ";
  protected final String TEXT_1734 = " = NULL;" + NL + "    delete ";
  ...
  protected final String TEXT_1743 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1744 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1745 = ";" + NL + "    }";
  protected final String TEXT_1746 = NL + "    if (";
  protected final String TEXT_1747 = " != NULL)" + NL + "    {";
  ...
  protected final String TEXT_1756 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1757 = " != NULL)" + NL + "    {";
  ...
  protected final String TEXT_1766 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1767 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1803 = "(this);";
  protected final String TEXT_1804 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1805 = "); i++)" + NL + "    {";
  protected final String TEXT_1806 = NL + "      ";
  protected final String TEXT_1807 = "(";
  protected final String TEXT_1808 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1809 = NL + "    ";
  protected final String TEXT_1810 = ".clear();";
  protected final String TEXT_1811 = NL + "    vector<";
  protected final String TEXT_1812 = "> ";
  protected final String TEXT_1813 = " = vector<";
  protected final String TEXT_1814 = ">(";
  protected final String TEXT_1815 = ");";
  protected final String TEXT_1816 = NL + "    ";
  protected final String TEXT_1817 = ".clear();" + NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1818 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_1819 = ".";
  protected final String TEXT_1820 = "() <= ";
  protected final String TEXT_1821 = ".";
  protected final String TEXT_1822 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1823 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1824 = NL + "        ";
  protected final String TEXT_1825 = ".";
  protected final String TEXT_1826 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1827 = NL + "    vector<";
  protected final String TEXT_1828 = "> ";
  protected final String TEXT_1829 = " = new vector<";
  ...
  protected final String TEXT_1834 = ");i++)" + NL + "    {";
  protected final String TEXT_1835 = NL + "      ";
  protected final String TEXT_1836 = "[i].";
  protected final String TEXT_1837 = "(this);" + NL + "    }";
  protected final String TEXT_1838 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1839 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1840 = "[i];" + NL + "    }";
  protected final String TEXT_1841 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1842 = "); i++)" + NL + "    {";
  protected final String TEXT_1843 = NL + "      ";
  protected final String TEXT_1844 = "[i].";
  protected final String TEXT_1845 = "(NULL);" + NL + "    }";
  protected final String TEXT_1846 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
