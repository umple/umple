...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_252 = NL + "    int index = find(";
  protected final String TEXT_253 = ".begin(), ";
  protected final String TEXT_254 = ".end(), ";
  protected final String TEXT_255 = ") - ";
  protected final String TEXT_256 = ".begin();";
  protected final String TEXT_257 = NL + "    return index;" + NL + "  }" + NL;
  ...
  protected final String TEXT_286 = "() const" + NL + "  {";
  ...
  protected final String TEXT_302 = "() const" + NL + "  {";
  ...
  protected final String TEXT_318 = "() const" + NL + "  {";
  ...
  protected final String TEXT_333 = "bool ";
  protected final String TEXT_334 = "::";
  protected final String TEXT_335 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;" + NL;
  protected final String TEXT_336 = NL + "    ";
  protected final String TEXT_337 = NL + NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_338 = NL + "  bool ";
  ...
  protected final String TEXT_345 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_346 = NL + "  private void ";
  protected final String TEXT_347 = "::";
  protected final String TEXT_348 = "()" + NL + "  {" + NL + "    switch(";
  protected final String TEXT_349 = ")" + NL + "    {";
  protected final String TEXT_350 = NL + "      ";
  protected final String TEXT_351 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_352 = NL + "  private void ";
  ...
  protected final String TEXT_370 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_391 = "(int index) " + NL + "  {";
  protected final String TEXT_392 = NL + "    ";
  protected final String TEXT_393 = "* ";
  protected final String TEXT_394 = " = ";
  protected final String TEXT_395 = "[index];";
  protected final String TEXT_396 = NL + "    return ";
  protected final String TEXT_397 = ";" + NL + "  }" + NL + "" + NL + "  vector<";
  protected final String TEXT_398 = "*> ";
  protected final String TEXT_399 = "::";
  protected final String TEXT_400 = "() " + NL + "  {";
  protected final String TEXT_401 = NL + "    vector<";
  protected final String TEXT_402 = "*> ";
  protected final String TEXT_403 = " = ";
  protected final String TEXT_404 = ";";
  protected final String TEXT_405 = NL + "    return ";
  protected final String TEXT_406 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_407 = "::";
  protected final String TEXT_408 = "()" + NL + "  {";
  protected final String TEXT_409 = NL + "    int number = ";
  protected final String TEXT_410 = ".size();";
  protected final String TEXT_411 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_412 = "::";
  protected final String TEXT_413 = "()" + NL + "  {";
  protected final String TEXT_414 = NL + "    bool has = ";
  protected final String TEXT_415 = ".size() > 0;";
  protected final String TEXT_416 = NL + "    return has;" + NL + "  }" + NL + "  " + NL + "  int ";
  protected final String TEXT_417 = "::";
  protected final String TEXT_418 = "(";
  protected final String TEXT_419 = "* ";
  protected final String TEXT_420 = ")" + NL + "  {";
  protected final String TEXT_421 = NL + "    int index = find(";
  protected final String TEXT_422 = ".begin(), ";
  protected final String TEXT_423 = ".end(), ";
  protected final String TEXT_424 = ") - ";
  protected final String TEXT_425 = ".begin();";
  protected final String TEXT_426 = NL + "    return index;" + NL + "  }" + NL + "  ";
  protected final String TEXT_427 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_428 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_429 = " : ";
  protected final String TEXT_430 = NL + "  bool ";
  protected final String TEXT_431 = "::";
  protected final String TEXT_432 = "()" + NL + "  {";
  protected final String TEXT_433 = NL + "    bool isValid = ";
  ...
  protected final String TEXT_441 = NL + "    return isValid;" + NL + "  }";
  ...
  protected final String TEXT_449 = NL + "    int required = ";
  protected final String TEXT_450 = ";";
  protected final String TEXT_451 = NL + "    return required;" + NL + "  }";
  protected final String TEXT_452 = NL + "  static int ";
  protected final String TEXT_453 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_454 = ";" + NL + "  }";
  protected final String TEXT_455 = NL + "  static int ";
  protected final String TEXT_456 = "::";
  protected final String TEXT_457 = "()" + NL + "  {";
  protected final String TEXT_458 = NL + "    int minimum = ";
  protected final String TEXT_459 = ";";
  protected final String TEXT_460 = NL + "    return minimum;" + NL + "  }";
  ...
  protected final String TEXT_468 = NL + "    int maximum = ";
  protected final String TEXT_469 = ";";
  protected final String TEXT_470 = NL + "    return maximum;" + NL + "  }";
  protected final String TEXT_471 = NL + "  bool ";
  protected final String TEXT_472 = "::";
  protected final String TEXT_473 = "(";
  protected final String TEXT_474 = "* ";
  protected final String TEXT_475 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_476 = NL + "    if (";
  protected final String TEXT_477 = "() >= ";
  protected final String TEXT_478 = "())" + NL + "    {";
  protected final String TEXT_479 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_480 = NL + "    ";
  protected final String TEXT_481 = ".push_back(";
  protected final String TEXT_482 = ");" + NL + "    if (";
  protected final String TEXT_483 = "->";
  protected final String TEXT_484 = "(this) != -1)" + NL + "    {" + NL + "      wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasAdded = ";
  protected final String TEXT_485 = ".";
  protected final String TEXT_486 = "(this);" + NL + "      if (!wasAdded)" + NL + "      {";
  protected final String TEXT_487 = NL + "        ";
  protected final String TEXT_488 = ".erase(find(";
  protected final String TEXT_489 = ".begin(),";
  protected final String TEXT_490 = ".end(),";
  protected final String TEXT_491 = "));" + NL + "      }" + NL + "    }";
  protected final String TEXT_492 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_493 = NL + "  bool ";
  protected final String TEXT_494 = "::";
  protected final String TEXT_495 = "(";
  protected final String TEXT_496 = " ";
  protected final String TEXT_497 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_498 = NL + "    if (!find(";
  protected final String TEXT_499 = ".begin(),";
  protected final String TEXT_500 = ".end(),";
  protected final String TEXT_501 = "))" + NL + "    {";
  protected final String TEXT_502 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_503 = ".indexOf(";
  protected final String TEXT_504 = ");";
  protected final String TEXT_505 = NL + "    ";
  protected final String TEXT_506 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_507 = ".";
  protected final String TEXT_508 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_509 = ".";
  protected final String TEXT_510 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_511 = NL + "        ";
  protected final String TEXT_512 = ".add(oldIndex,";
  protected final String TEXT_513 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_514 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_515 = NL + "  bool ";
  protected final String TEXT_516 = "::";
  protected final String TEXT_517 = "(";
  protected final String TEXT_518 = "* ";
  protected final String TEXT_519 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_520 = NL + "    ";
  protected final String TEXT_521 = " = ";
  protected final String TEXT_522 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_523 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_530 = " != NULL)" + NL + "    {";
  protected final String TEXT_531 = NL + "      ";
  protected final String TEXT_532 = " = ";
  protected final String TEXT_533 = ";" + NL + "      wasSet = true;" + NL + "    }";
  ...
  protected final String TEXT_546 = ", as existing ";
  protected final String TEXT_547 = " would become an orphan";
  protected final String TEXT_548 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_557 = "() : NULL;" + NL + "" + NL + "    if (this!=";
  protected final String TEXT_558 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_559 = " != NULL)" + NL + "      {";
  protected final String TEXT_560 = NL + "        ";
  protected final String TEXT_561 = "->";
  protected final String TEXT_562 = " = NULL;" + NL + "      }" + NL + "      if (";
  protected final String TEXT_563 = " != NULL)" + NL + "      {";
  protected final String TEXT_564 = NL + "        ";
  protected final String TEXT_565 = "->";
  protected final String TEXT_566 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_567 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_568 = NL + "  bool ";
  protected final String TEXT_569 = "::";
  protected final String TEXT_570 = "(";
  protected final String TEXT_571 = " ";
  protected final String TEXT_572 = ")" + NL + "  {" + NL + "    bool";
  protected final String TEXT_573 = NL + "    if (";
  protected final String TEXT_574 = " == NULL)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_575 = " to null, as ";
  protected final String TEXT_576 = " must always be associated to a ";
  ...
  protected final String TEXT_584 = ")" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_585 = ", the current ";
  protected final String TEXT_586 = " already has a ";
  protected final String TEXT_587 = ", which would be orphaned if it were re-assigned";
  ...
  protected final String TEXT_598 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_599 = " != NULL)" + NL + "    {";
  protected final String TEXT_600 = NL + "      ";
  protected final String TEXT_601 = "->";
  protected final String TEXT_602 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_603 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_604 = NL + "  ";
  protected final String TEXT_605 = " ";
  protected final String TEXT_606 = "::";
  protected final String TEXT_607 = "(";
  protected final String TEXT_608 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_609 = "(";
  protected final String TEXT_610 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_611 = "::";
  protected final String TEXT_612 = "(";
  protected final String TEXT_613 = "* ";
  protected final String TEXT_614 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_615 = NL + "    ";
  protected final String TEXT_616 = " ";
  protected final String TEXT_617 = " = ";
  protected final String TEXT_618 = ".";
  protected final String TEXT_619 = "();" + NL + "    bool ";
  protected final String TEXT_620 = " = (";
  protected final String TEXT_621 = " != null && this != ";
  protected final String TEXT_622 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_623 = " && ";
  protected final String TEXT_624 = ".";
  protected final String TEXT_625 = "() <= ";
  protected final String TEXT_626 = "())" + NL + "    {" + NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_627 = ")" + NL + "    {";
  protected final String TEXT_628 = NL + "      ";
  protected final String TEXT_629 = ".";
  protected final String TEXT_630 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_631 = NL + "      ";
  protected final String TEXT_632 = ".add(";
  protected final String TEXT_633 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_634 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_635 = "::";
  protected final String TEXT_636 = "(";
  protected final String TEXT_637 = " ";
  protected final String TEXT_638 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\t";
  ...
  protected final String TEXT_651 = ".remove(";
  protected final String TEXT_652 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_653 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_662 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_663 = "::";
  protected final String TEXT_664 = "(";
  protected final String TEXT_665 = "* ";
  protected final String TEXT_666 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_667 = NL + "    if (";
  protected final String TEXT_668 = "() >= ";
  protected final String TEXT_669 = "())" + NL + "    {";
  protected final String TEXT_670 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_671 = NL + "    ";
  protected final String TEXT_672 = " ";
  protected final String TEXT_673 = " = ";
  protected final String TEXT_674 = "->";
  protected final String TEXT_675 = "();" + NL + "    bool ";
  protected final String TEXT_676 = " = (";
  protected final String TEXT_677 = " != NULL && this!=";
  protected final String TEXT_678 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_679 = " && ";
  protected final String TEXT_680 = "->";
  protected final String TEXT_681 = "() <= ";
  protected final String TEXT_682 = "())" + NL + "    {";
  protected final String TEXT_683 = NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_684 = ")" + NL + "    {";
  protected final String TEXT_685 = NL + "      ";
  protected final String TEXT_686 = "->";
  protected final String TEXT_687 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_688 = NL + "      ";
  protected final String TEXT_689 = ".add(";
  protected final String TEXT_690 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_691 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_692 = "::";
  protected final String TEXT_693 = "(";
  protected final String TEXT_694 = "* ";
  protected final String TEXT_695 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_696 = ".begin(), ";
  protected final String TEXT_697 = ".end(), ";
  protected final String TEXT_698 = ") - ";
  protected final String TEXT_699 = ".begin();";
  ...
  protected final String TEXT_705 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_706 = " already at minimum (";
  ...
  protected final String TEXT_712 = ".erase(find(";
  protected final String TEXT_713 = ".begin(),";
  protected final String TEXT_714 = ".end(),";
  protected final String TEXT_715 = "));" + NL + "\tdelete ";
  protected final String TEXT_716 = "[index];" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_724 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_725 = "(";
  protected final String TEXT_726 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_727 = "::";
  protected final String TEXT_728 = "(";
  protected final String TEXT_729 = "* ";
  protected final String TEXT_730 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_731 = NL + "    if (";
  protected final String TEXT_732 = "() >= ";
  protected final String TEXT_733 = "())" + NL + "    {";
  protected final String TEXT_734 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_735 = NL + "    ";
  protected final String TEXT_736 = " ";
  protected final String TEXT_737 = " = ";
  protected final String TEXT_738 = ".";
  protected final String TEXT_739 = "();" + NL + "    bool ";
  ...
  protected final String TEXT_746 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_747 = NL + "      ";
  protected final String TEXT_748 = ".push_back(";
  protected final String TEXT_749 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_750 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_751 = "::";
  protected final String TEXT_752 = "(";
  protected final String TEXT_753 = "* ";
  protected final String TEXT_754 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_755 = ".begin(), ";
  protected final String TEXT_756 = ".end(), ";
  protected final String TEXT_757 = ") - ";
  protected final String TEXT_758 = ".begin();";
  protected final String TEXT_759 = NL + "    //Unable to remove ";
  protected final String TEXT_760 = ", as it must always have a ";
  protected final String TEXT_761 = NL + "    if (this != ";
  protected final String TEXT_762 = "->";
  protected final String TEXT_763 = "())" + NL + "    {";
  protected final String TEXT_764 = NL + "      ";
  protected final String TEXT_765 = ".erase(find(";
  protected final String TEXT_766 = ".begin(),";
  protected final String TEXT_767 = ".end(),";
  protected final String TEXT_768 = "));" + NL + "\t  delete ";
  protected final String TEXT_769 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_770 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_771 = NL + "  bool ";
  protected final String TEXT_772 = "::";
  protected final String TEXT_773 = "(";
  protected final String TEXT_774 = "... ";
  protected final String TEXT_775 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_776 = NL + "    vector<";
  protected final String TEXT_777 = "*> ";
  protected final String TEXT_778 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_779 = " ";
  protected final String TEXT_780 = " : ";
  protected final String TEXT_781 = ")" + NL + "    {" + NL + "      if (find(";
  ...
  protected final String TEXT_792 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_793 = "*> ";
  protected final String TEXT_794 = ";";
  protected final String TEXT_795 = NL + "    ";
  protected final String TEXT_796 = ".clear();" + NL + "    for (";
  protected final String TEXT_797 = " ";
  protected final String TEXT_798 = " : ";
  protected final String TEXT_799 = ")" + NL + "    {";
  protected final String TEXT_800 = NL + "      ";
  protected final String TEXT_801 = "->add(";
  protected final String TEXT_802 = ");" + NL + "      if (find(";
  protected final String TEXT_803 = ".begin(),";
  protected final String TEXT_804 = ".end(),";
  protected final String TEXT_805 = "))" + NL + "      {";
  protected final String TEXT_806 = NL + "        ";
  protected final String TEXT_807 = ".erase(";
  protected final String TEXT_808 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_809 = NL + "        ";
  protected final String TEXT_810 = "->";
  protected final String TEXT_811 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_812 = " ";
  protected final String TEXT_813 = " : ";
  protected final String TEXT_814 = ")" + NL + "    {";
  protected final String TEXT_815 = NL + "      ";
  protected final String TEXT_816 = "->";
  protected final String TEXT_817 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_818 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_825 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_826 = "::";
  protected final String TEXT_827 = "(";
  protected final String TEXT_828 = "* ";
  protected final String TEXT_829 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_836 = " != NULL && this!=";
  protected final String TEXT_837 = ");" + NL + "    if (";
  protected final String TEXT_838 = ")" + NL + "    {";
  protected final String TEXT_839 = NL + "      ";
  protected final String TEXT_840 = "->";
  protected final String TEXT_841 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_842 = NL + "      ";
  protected final String TEXT_843 = "->push_back(";
  protected final String TEXT_844 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_845 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_846 = "::";
  protected final String TEXT_847 = "(";
  protected final String TEXT_848 = "* ";
  protected final String TEXT_849 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_850 = ".begin(), ";
  protected final String TEXT_851 = ".end(), ";
  protected final String TEXT_852 = ") - ";
  protected final String TEXT_853 = ".begin();";
  protected final String TEXT_854 = NL + "    //Unable to remove ";
  protected final String TEXT_855 = ", as it must always have a ";
  protected final String TEXT_856 = NL + "    if (this!=";
  protected final String TEXT_857 = "->";
  protected final String TEXT_858 = "())" + NL + "    {";
  protected final String TEXT_859 = NL + "      ";
  protected final String TEXT_860 = ".erase(find(";
  protected final String TEXT_861 = ".begin(),";
  protected final String TEXT_862 = ".end(),";
  protected final String TEXT_863 = "));" + NL + "\t  delete ";
  protected final String TEXT_864 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_865 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_866 = NL + "  bool ";
  protected final String TEXT_867 = "::";
  protected final String TEXT_868 = "(";
  protected final String TEXT_869 = "* ";
  protected final String TEXT_870 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_884 = "(NULL);" + NL + "      }" + NL + "      wasSet = true;";
  ...
  protected final String TEXT_903 = "();" + NL + "" + NL + "    if (!=";
  protected final String TEXT_904 = ")" + NL + "    {";
  protected final String TEXT_905 = NL + "      ";
  protected final String TEXT_906 = "->";
  protected final String TEXT_907 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_908 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_909 = NL + "  bool ";
  protected final String TEXT_910 = "::";
  protected final String TEXT_911 = "(";
  protected final String TEXT_912 = "* ";
  protected final String TEXT_913 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_914 = ".begin(), ";
  protected final String TEXT_915 = ".end(), ";
  protected final String TEXT_916 = ") - ";
  protected final String TEXT_917 = ".begin();";
  protected final String TEXT_918 = NL + "    if (! find(";
  protected final String TEXT_919 = ".begin(),";
  protected final String TEXT_920 = ".end(),";
  protected final String TEXT_921 = "))" + NL + "    {";
  protected final String TEXT_922 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_923 = "() <= ";
  protected final String TEXT_924 = "())" + NL + "    {";
  protected final String TEXT_925 = NL + "      return wasRemoved;" + NL + "    }" + NL + "\t" + NL + "    int oldIndex = find(";
  protected final String TEXT_926 = ".begin(), ";
  protected final String TEXT_927 = ".end(), ";
  protected final String TEXT_928 = ") - ";
  protected final String TEXT_929 = ".begin();";
  protected final String TEXT_930 = NL + "    ";
  protected final String TEXT_931 = ".erase(find(";
  protected final String TEXT_932 = ".begin(), ";
  protected final String TEXT_933 = ".end(), ";
  protected final String TEXT_934 = "));" + NL + "\tdelete ";
  protected final String TEXT_935 = "[oldIndex];" + NL + "    if (";
  protected final String TEXT_936 = "->";
  protected final String TEXT_937 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_938 = "->";
  protected final String TEXT_939 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_940 = NL + "        ";
  protected final String TEXT_941 = "->add(oldIndex,";
  protected final String TEXT_942 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_943 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_944 = NL + "  bool ";
  protected final String TEXT_945 = "::";
  protected final String TEXT_946 = "(";
  protected final String TEXT_947 = "* ";
  protected final String TEXT_948 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_949 = ".begin(), ";
  protected final String TEXT_950 = ".end(), ";
  protected final String TEXT_951 = ") - ";
  protected final String TEXT_952 = ".begin();";
  protected final String TEXT_953 = NL + "    if (! find(";
  protected final String TEXT_954 = ".begin(),";
  protected final String TEXT_955 = ".end(),";
  protected final String TEXT_956 = ") != ";
  protected final String TEXT_957 = ".end())" + NL + "    {";
  protected final String TEXT_958 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_959 = "() <= ";
  protected final String TEXT_960 = "())" + NL + "    {";
  protected final String TEXT_961 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = find(";
  ...
  protected final String TEXT_967 = ".erase(oldIndex);" + NL + "\tdelete ";
  protected final String TEXT_968 = "[oldIndex];" + NL + "    if (";
  protected final String TEXT_969 = "->";
  protected final String TEXT_970 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_971 = ".";
  protected final String TEXT_972 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_973 = NL + "        ";
  protected final String TEXT_974 = ".add(oldIndex,";
  protected final String TEXT_975 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_976 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_977 = NL + "  bool ";
  protected final String TEXT_978 = "::";
  protected final String TEXT_979 = "(";
  protected final String TEXT_980 = "* ";
  protected final String TEXT_981 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1001 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1002 = " != null)" + NL + "    {";
  protected final String TEXT_1003 = NL + "      ";
  protected final String TEXT_1004 = "->";
  protected final String TEXT_1005 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1027 = "(this);" + NL + "    }";
  protected final String TEXT_1028 = NL + "    ";
  protected final String TEXT_1029 = "->";
  protected final String TEXT_1030 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1031 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1032 = NL + "  bool ";
  protected final String TEXT_1033 = "::";
  protected final String TEXT_1034 = "(";
  protected final String TEXT_1035 = "* ";
  protected final String TEXT_1036 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1058 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  ...
  protected final String TEXT_1068 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1069 = NL + "  bool ";
  protected final String TEXT_1070 = "::";
  protected final String TEXT_1071 = "(";
  protected final String TEXT_1072 = "* ";
  protected final String TEXT_1073 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1074 = NL + "    //Must provide ";
  protected final String TEXT_1075 = " to ";
  protected final String TEXT_1076 = NL + "    if (";
  protected final String TEXT_1077 = " == NULL)" + NL + "    {";
  protected final String TEXT_1078 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1084 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1094 = ")" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1095 = "->";
  protected final String TEXT_1096 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  protected final String TEXT_1097 = NL + "        ";
  protected final String TEXT_1098 = " = ";
  protected final String TEXT_1099 = ";";
  protected final String TEXT_1100 = NL + "        return wasSet;" + NL + "      }" + NL + "    }";
  protected final String TEXT_1101 = NL + "    ";
  protected final String TEXT_1102 = "->";
  protected final String TEXT_1103 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1104 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1105 = NL + "  bool ";
  protected final String TEXT_1106 = "::";
  protected final String TEXT_1107 = "(";
  protected final String TEXT_1108 = "* ";
  protected final String TEXT_1109 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1118 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1126 = ");" + NL + "    } " + NL + "    else" + NL + "    {";
  protected final String TEXT_1127 = NL + "      ";
  protected final String TEXT_1128 = ".push_back(";
  protected final String TEXT_1129 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1130 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1131 = "::";
  protected final String TEXT_1132 = "(";
  protected final String TEXT_1133 = "* ";
  protected final String TEXT_1134 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1135 = ".begin(), ";
  protected final String TEXT_1136 = ".end(), ";
  protected final String TEXT_1137 = ") - ";
  protected final String TEXT_1138 = ".begin();";
  protected final String TEXT_1139 = NL + "    if (find(";
  protected final String TEXT_1140 = ".begin(),";
  protected final String TEXT_1141 = ".end(),";
  protected final String TEXT_1142 = "))" + NL + "    {";
  protected final String TEXT_1143 = NL + "      ";
  protected final String TEXT_1144 = ".erase(find(";
  ...
  protected final String TEXT_1150 = "(NULL);" + NL + "\t  delete ";
  protected final String TEXT_1151 = "[index]" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1152 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1153 = NL + "  bool ";
  protected final String TEXT_1154 = "::";
  protected final String TEXT_1155 = "(";
  protected final String TEXT_1156 = "* ";
  protected final String TEXT_1157 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1170 = "(this);" + NL + "    }" + NL + "    if (";
  ...
  protected final String TEXT_1175 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1184 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_1185 = NL + "    ";
  protected final String TEXT_1186 = " ";
  protected final String TEXT_1187 = " = ";
  protected final String TEXT_1188 = ".";
  protected final String TEXT_1189 = "();" + NL + "    if (";
  protected final String TEXT_1190 = " == NULL)" + NL + "    {";
  protected final String TEXT_1191 = NL + "      ";
  protected final String TEXT_1192 = ".";
  protected final String TEXT_1193 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1201 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1202 = NL + "      ";
  protected final String TEXT_1203 = ".add(";
  protected final String TEXT_1204 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1205 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1206 = "::";
  protected final String TEXT_1207 = "(";
  protected final String TEXT_1208 = " ";
  protected final String TEXT_1209 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1210 = ".begin(), ";
  protected final String TEXT_1211 = ".end(), ";
  protected final String TEXT_1212 = ") - ";
  protected final String TEXT_1213 = ".begin();";
  protected final String TEXT_1214 = NL + "    if (find(";
  protected final String TEXT_1215 = ".begin(),";
  protected final String TEXT_1216 = ".end(),";
  protected final String TEXT_1217 = ") != ";
  protected final String TEXT_1218 = ".end())" + NL + "    {";
  ...
  protected final String TEXT_1224 = "(NULL);" + NL + "\t  delete ";
  protected final String TEXT_1225 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1226 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1227 = NL + "  bool ";
  protected final String TEXT_1228 = "::";
  protected final String TEXT_1229 = "(";
  protected final String TEXT_1230 = " ";
  protected final String TEXT_1231 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1236 = ".push_back(";
  protected final String TEXT_1237 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1238 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1239 = "::";
  protected final String TEXT_1240 = "(";
  protected final String TEXT_1241 = "* ";
  protected final String TEXT_1242 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1243 = ".begin(), ";
  protected final String TEXT_1244 = ".end(), ";
  protected final String TEXT_1245 = ") - ";
  protected final String TEXT_1246 = ".begin();";
  protected final String TEXT_1247 = NL + "    if (!find(";
  protected final String TEXT_1248 = ".begin(),";
  protected final String TEXT_1249 = ".end(),";
  protected final String TEXT_1250 = ") != ";
  protected final String TEXT_1251 = ".end())" + NL + "    {";
  protected final String TEXT_1252 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1257 = ".erase(find(";
  protected final String TEXT_1258 = ".begin(),";
  protected final String TEXT_1259 = ".end(),";
  protected final String TEXT_1260 = "));" + NL + "\tdelete ";
  protected final String TEXT_1261 = "[index];" + NL + "    wasRemoved = true;";
  protected final String TEXT_1262 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1263 = NL + "  bool ";
  protected final String TEXT_1264 = "::";
  protected final String TEXT_1265 = "(";
  protected final String TEXT_1266 = "* ";
  protected final String TEXT_1267 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1268 = NL + "    if (";
  protected final String TEXT_1269 = "() >= ";
  protected final String TEXT_1270 = "())" + NL + "    {";
  protected final String TEXT_1271 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1281 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1282 = " != null)" + NL + "    {";
  ...
  protected final String TEXT_1292 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1293 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1294 = "::";
  protected final String TEXT_1295 = "(";
  protected final String TEXT_1296 = "* ";
  protected final String TEXT_1297 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1298 = ".begin(), ";
  protected final String TEXT_1299 = ".end(), ";
  protected final String TEXT_1300 = ") - ";
  protected final String TEXT_1301 = ".begin();";
  protected final String TEXT_1302 = NL + "    if ((find(";
  protected final String TEXT_1303 = ".begin(),";
  protected final String TEXT_1304 = ".end(),";
  protected final String TEXT_1305 = ") !=";
  protected final String TEXT_1306 = ".end()) && ";
  protected final String TEXT_1307 = "() > ";
  protected final String TEXT_1308 = "())" + NL + "    {";
  protected final String TEXT_1309 = NL + "      ";
  protected final String TEXT_1310 = ".erase(find(";
  ...
  protected final String TEXT_1316 = ",NULL);" + NL + "\t  delete ";
  protected final String TEXT_1317 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1318 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1319 = NL + "  bool ";
  ...
  protected final String TEXT_1326 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_1327 = " ";
  protected final String TEXT_1328 = " : ";
  protected final String TEXT_1329 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1330 = ".begin(),";
  protected final String TEXT_1331 = ".end(),";
  protected final String TEXT_1332 = "))" + NL + "      {";
  protected final String TEXT_1333 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1334 = ".";
  protected final String TEXT_1335 = "() != NULL && this!=(";
  protected final String TEXT_1336 = "->";
  protected final String TEXT_1337 = "()))" + NL + "      {";
  protected final String TEXT_1338 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1339 = NL + "      ";
  protected final String TEXT_1340 = ".push_back(";
  ...
  protected final String TEXT_1346 = ".removeAll(";
  protected final String TEXT_1347 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1348 = " orphan : ";
  protected final String TEXT_1349 = ")" + NL + "    {";
  protected final String TEXT_1350 = NL + "      ";
  protected final String TEXT_1351 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1352 = NL + "    ";
  protected final String TEXT_1353 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1359 = ", this);";
  protected final String TEXT_1360 = NL + "      ";
  protected final String TEXT_1361 = ".push_back(";
  protected final String TEXT_1362 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1363 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1364 = NL + "  void ";
  ...
  protected final String TEXT_1370 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1371 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1372 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1373 = ", ";
  protected final String TEXT_1374 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1375 = " to ";
  protected final String TEXT_1376 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1381 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1382 = NL + "    ";
  protected final String TEXT_1383 = "push_back(";
  protected final String TEXT_1384 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1385 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1386 = "::";
  protected final String TEXT_1387 = "(";
  protected final String TEXT_1388 = "* ";
  protected final String TEXT_1389 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1390 = ".begin(), ";
  protected final String TEXT_1391 = ".end(), ";
  protected final String TEXT_1392 = ") - ";
  protected final String TEXT_1393 = ".begin();";
  protected final String TEXT_1394 = NL + "    if (find(";
  protected final String TEXT_1395 = ".begin(),";
  protected final String TEXT_1396 = ".end(),";
  protected final String TEXT_1397 = ") != ";
  protected final String TEXT_1398 = ".end())" + NL + "    {";
  protected final String TEXT_1399 = NL + "      ";
  protected final String TEXT_1400 = ".erase(find(";
  protected final String TEXT_1401 = ".begin(),";
  protected final String TEXT_1402 = ".end(),";
  protected final String TEXT_1403 = "));" + NL + "\t  delete ";
  protected final String TEXT_1404 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1405 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1406 = NL + "  bool ";
  protected final String TEXT_1407 = "::";
  protected final String TEXT_1408 = "(";
  protected final String TEXT_1409 = "* ";
  protected final String TEXT_1410 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1415 = ".push_back(";
  protected final String TEXT_1416 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1417 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1418 = "::";
  protected final String TEXT_1419 = "(";
  protected final String TEXT_1420 = "* ";
  protected final String TEXT_1421 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1422 = ".begin(), ";
  protected final String TEXT_1423 = ".end(), ";
  protected final String TEXT_1424 = ") - ";
  protected final String TEXT_1425 = ".begin();";
  protected final String TEXT_1426 = NL + "    if (find(";
  protected final String TEXT_1427 = ".begin(),";
  protected final String TEXT_1428 = ".end(),";
  protected final String TEXT_1429 = ") != ";
  protected final String TEXT_1430 = ".end())" + NL + "    {";
  protected final String TEXT_1431 = NL + "      ";
  protected final String TEXT_1432 = ".erase(";
  protected final String TEXT_1433 = ");" + NL + "\t  delete ";
  protected final String TEXT_1434 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1435 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1440 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1441 = NL + "    ";
  protected final String TEXT_1442 = ".push_back(";
  protected final String TEXT_1443 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1444 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1445 = "::";
  protected final String TEXT_1446 = "(";
  protected final String TEXT_1447 = "* ";
  protected final String TEXT_1448 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1449 = ".begin(), ";
  protected final String TEXT_1450 = ".end(), ";
  protected final String TEXT_1451 = ") - ";
  protected final String TEXT_1452 = ".begin();";
  protected final String TEXT_1453 = NL + "    if (!find(";
  protected final String TEXT_1454 = ".begin(),";
  protected final String TEXT_1455 = ".end(),";
  protected final String TEXT_1456 = ") != ";
  protected final String TEXT_1457 = ".end())" + NL + "    {";
  protected final String TEXT_1458 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1463 = ".erase(find(";
  protected final String TEXT_1464 = ".begin(),";
  protected final String TEXT_1465 = ".end(),";
  protected final String TEXT_1466 = "));" + NL + "    delete ";
  protected final String TEXT_1467 = "[index];" + NL + "\twasRemoved = true;";
  protected final String TEXT_1468 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1469 = NL + "  bool ";
  protected final String TEXT_1470 = "::";
  protected final String TEXT_1471 = "(";
  protected final String TEXT_1472 = "... ";
  protected final String TEXT_1473 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1474 = NL + "    vector<";
  protected final String TEXT_1475 = "*> ";
  protected final String TEXT_1476 = ";" + NL + "    for (";
  protected final String TEXT_1477 = " ";
  protected final String TEXT_1478 = " : ";
  protected final String TEXT_1479 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1480 = ".begin(),";
  protected final String TEXT_1481 = ".end(),";
  protected final String TEXT_1482 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1483 = NL + "      ";
  protected final String TEXT_1484 = ".push_back(";
  protected final String TEXT_1485 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1486 = ".size() != ";
  protected final String TEXT_1487 = ".size() || ";
  protected final String TEXT_1488 = ".size() != ";
  protected final String TEXT_1489 = "())" + NL + "    {";
  protected final String TEXT_1490 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1491 = NL + "    ";
  protected final String TEXT_1492 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1493 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1494 = ".push_back(";
  protected final String TEXT_1495 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1496 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1497 = NL + "  ";
  protected final String TEXT_1498 = " bool ";
  protected final String TEXT_1499 = "(";
  protected final String TEXT_1500 = "... ";
  protected final String TEXT_1501 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1502 = NL + "    vector<";
  protected final String TEXT_1503 = "*> ";
  protected final String TEXT_1504 = ";" + NL + "    for (int i=0 ; i<";
  protected final String TEXT_1505 = ".size() ; i++)" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1506 = ".begin(),";
  protected final String TEXT_1507 = ".end(),(";
  protected final String TEXT_1508 = ") - ";
  protected final String TEXT_1509 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1514 = ".length)" + NL + "    {";
  protected final String TEXT_1515 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1516 = NL + "    ";
  protected final String TEXT_1517 = ".clear();";
  protected final String TEXT_1518 = NL + "    ";
  protected final String TEXT_1519 = ".addAll(";
  protected final String TEXT_1520 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1521 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1522 = NL + "  bool ";
  protected final String TEXT_1523 = "::";
  protected final String TEXT_1524 = "(";
  protected final String TEXT_1525 = "... ";
  protected final String TEXT_1526 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1527 = NL + "    vector<";
  protected final String TEXT_1528 = "*> ";
  protected final String TEXT_1529 = ";" + NL + "    for (";
  protected final String TEXT_1530 = " ";
  protected final String TEXT_1531 = " : ";
  protected final String TEXT_1532 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1533 = ".begin(),";
  protected final String TEXT_1534 = ".end(),";
  protected final String TEXT_1535 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1536 = NL + "      ";
  protected final String TEXT_1537 = "push_back(";
  protected final String TEXT_1538 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1539 = ".size() != ";
  protected final String TEXT_1540 = ".length || ";
  ...
  protected final String TEXT_1545 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1546 = "*> ";
  protected final String TEXT_1547 = " = new vector<";
  protected final String TEXT_1548 = "*>(";
  protected final String TEXT_1549 = ");";
  protected final String TEXT_1550 = NL + "    ";
  protected final String TEXT_1551 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1556 = ".push_back(";
  protected final String TEXT_1557 = ");" + NL + "      if (find(";
  protected final String TEXT_1558 = ".begin(),";
  protected final String TEXT_1559 = ".end(),";
  protected final String TEXT_1560 = "))" + NL + "      {";
  protected final String TEXT_1561 = NL + "        ";
  protected final String TEXT_1562 = ".erase(find(";
  protected final String TEXT_1563 = ".begin(),";
  protected final String TEXT_1564 = ".end(),";
  protected final String TEXT_1565 = "));" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1566 = NL + "        ";
  protected final String TEXT_1567 = "->";
  protected final String TEXT_1568 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1574 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1575 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1576 = NL + "  bool ";
  protected final String TEXT_1577 = "::";
  protected final String TEXT_1578 = "(";
  protected final String TEXT_1579 = "... ";
  protected final String TEXT_1580 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1581 = NL + "    vector<";
  ...
  protected final String TEXT_1586 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1587 = ".begin(),";
  protected final String TEXT_1588 = ".end(),";
  protected final String TEXT_1589 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1590 = NL + "      ";
  protected final String TEXT_1591 = ".push_back(";
  protected final String TEXT_1592 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1593 = ".size() != ";
  protected final String TEXT_1594 = ".length || ";
  protected final String TEXT_1595 = ".size() < ";
  protected final String TEXT_1596 = "())" + NL + "    {";
  protected final String TEXT_1597 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  ...
  protected final String TEXT_1606 = ".push_back(";
  protected final String TEXT_1607 = ");" + NL + "      if (find(";
  protected final String TEXT_1608 = ".begin(),";
  protected final String TEXT_1609 = ".end(),";
  protected final String TEXT_1610 = ")))" + NL + "      {";
  protected final String TEXT_1611 = NL + "        ";
  protected final String TEXT_1612 = ".erase(";
  protected final String TEXT_1613 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1614 = NL + "        ";
  protected final String TEXT_1615 = "->";
  protected final String TEXT_1616 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1622 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1623 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1624 = NL + "  bool ";
  protected final String TEXT_1625 = "::";
  protected final String TEXT_1626 = "(";
  protected final String TEXT_1627 = "... ";
  protected final String TEXT_1628 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1629 = NL + "    vector<";
  ...
  protected final String TEXT_1634 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1635 = ".begin(),";
  protected final String TEXT_1636 = ".end(),";
  protected final String TEXT_1637 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1638 = NL + "      ";
  protected final String TEXT_1639 = "->add(";
  ...
  protected final String TEXT_1649 = ".clear();" + NL + "\tfor (int i=0; i<";
  protected final String TEXT_1650 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1651 = ".push_back(";
  protected final String TEXT_1652 = "[i]);" + NL + "\t}" + NL + "    " + NL + "    wasSet = true;";
  protected final String TEXT_1653 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1660 = ".length < ";
  protected final String TEXT_1661 = "()";
  protected final String TEXT_1662 = ")" + NL + "    {";
  protected final String TEXT_1663 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1664 = "*> ";
  protected final String TEXT_1665 = ";" + NL + "\t" + NL + "    map<";
  protected final String TEXT_1666 = ",int> ";
  ...
  protected final String TEXT_1674 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1675 = "->";
  protected final String TEXT_1676 = "() != NULL && this!=";
  ...
  protected final String TEXT_1683 = "();" + NL + "        if (!";
  protected final String TEXT_1684 = ".find(";
  protected final String TEXT_1685 = "))" + NL + "        {";
  protected final String TEXT_1686 = NL + "          ";
  protected final String TEXT_1687 = ".insert(";
  protected final String TEXT_1688 = ", new int(";
  protected final String TEXT_1689 = "->";
  protected final String TEXT_1690 = "()));" + NL + "        }" + NL + "        int currentCount = ";
  protected final String TEXT_1691 = ".find(";
  protected final String TEXT_1692 = ")->firtst;" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1693 = ")" + NL + "        {";
  protected final String TEXT_1694 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1695 = NL + "        ";
  protected final String TEXT_1696 = ".insert(";
  protected final String TEXT_1697 = ", new int(nextCount));" + NL + "      }";
  protected final String TEXT_1698 = NL + "      ";
  protected final String TEXT_1699 = ".push_back(";
  protected final String TEXT_1700 = ");" + NL + "    }" + NL;
  protected final String TEXT_1701 = NL + "    ";
  protected final String TEXT_1702 = ".removeAll(";
  protected final String TEXT_1703 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1704 = " orphan : ";
  protected final String TEXT_1705 = ")" + NL + "    {";
  protected final String TEXT_1706 = NL + "      ";
  protected final String TEXT_1707 = "(orphan, null);" + NL + "    }";
  ...
  protected final String TEXT_1724 = ".push_back(";
  protected final String TEXT_1725 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1726 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1727 = NL + "  void ";
  ...
  protected final String TEXT_1733 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1734 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1735 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1736 = ", ";
  protected final String TEXT_1737 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1738 = " to ";
  protected final String TEXT_1739 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1740 = NL + "  bool ";
  protected final String TEXT_1741 = "::";
  protected final String TEXT_1742 = "(";
  protected final String TEXT_1743 = "... ";
  protected final String TEXT_1744 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1745 = NL + "    vector<";
  ...
  protected final String TEXT_1750 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1751 = ".begin(),";
  protected final String TEXT_1752 = ".end(),(";
  protected final String TEXT_1753 = ")) - ";
  protected final String TEXT_1754 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1755 = NL + "      ";
  protected final String TEXT_1756 = ".push_back(";
  protected final String TEXT_1757 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1758 = ".size() != ";
  protected final String TEXT_1759 = ".size() || ";
  protected final String TEXT_1760 = ".size() > ";
  protected final String TEXT_1761 = "())" + NL + "    {";
  protected final String TEXT_1762 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1763 = NL + "    ";
  protected final String TEXT_1764 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1765 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1766 = ".push_back(";
  protected final String TEXT_1767 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1768 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1769 = NL + "  bool ";
  protected final String TEXT_1770 = "::";
  protected final String TEXT_1771 = "(";
  protected final String TEXT_1772 = "... ";
  protected final String TEXT_1773 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1774 = NL + "    vector<";
  ...
  protected final String TEXT_1779 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1780 = ".begin(),";
  protected final String TEXT_1781 = ".end(),";
  protected final String TEXT_1782 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1783 = NL + "      ";
  protected final String TEXT_1784 = "->add(";
  protected final String TEXT_1785 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1786 = ".size() != ";
  protected final String TEXT_1787 = ".size() || ";
  protected final String TEXT_1788 = ".size() < ";
  protected final String TEXT_1789 = "())" + NL + "    {";
  protected final String TEXT_1790 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1791 = NL + "    ";
  protected final String TEXT_1792 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1793 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1794 = ".push_back(";
  protected final String TEXT_1795 = "[i]);" + NL + "\t}" + NL + "\t" + NL + "    wasSet = true;";
  protected final String TEXT_1796 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1797 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1798 = NL + "    ";
  protected final String TEXT_1799 = " == (";
  protected final String TEXT_1800 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1801 = NL + "    ";
  protected final String TEXT_1802 = NL;
  protected final String TEXT_1803 = NL + "    ";
  protected final String TEXT_1804 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1805 = NL + "   void ";
  protected final String TEXT_1806 = "::";
  protected final String TEXT_1807 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1808 = NL + "       ";
  protected final String TEXT_1809 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1810 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1811 = NL + "    ";
  protected final String TEXT_1812 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1813 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1814 = NL + "      ";
  protected final String TEXT_1815 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1816 = NL + "  void ";
  protected final String TEXT_1817 = "::";
  protected final String TEXT_1818 = "()" + NL + "  {";
  protected final String TEXT_1819 = NL + "    ";
  protected final String TEXT_1820 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1821 = "\",";
  protected final String TEXT_1822 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1823 = "::";
  protected final String TEXT_1824 = "()" + NL + "  {";
  protected final String TEXT_1825 = NL + "    ";
  protected final String TEXT_1826 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1827 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1828 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1829 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1830 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1831 = "::run ()" + NL + "    {";
  protected final String TEXT_1832 = NL + "      if (\"";
  protected final String TEXT_1833 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1834 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1835 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1836 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1837 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1838 = NL + "    ";
  protected final String TEXT_1839 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1840 = ";";
  protected final String TEXT_1841 = NL + "    ";
  protected final String TEXT_1842 = ".clear();";
  ...
  protected final String TEXT_1848 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1849 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1850 = ";" + NL + "    }";
  protected final String TEXT_1851 = NL + "    if (";
  protected final String TEXT_1852 = " != NULL)" + NL + "    {";
  protected final String TEXT_1853 = NL + "      ";
  protected final String TEXT_1854 = "->";
  protected final String TEXT_1855 = "(NULL);" + NL + "    }";
  ...
  protected final String TEXT_1861 = " = NULL;" + NL + "    if (";
  ...
  protected final String TEXT_1872 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1879 = ";" + NL + "      this->";
  protected final String TEXT_1880 = " = NULL;";
  protected final String TEXT_1881 = NL + "      ";
  protected final String TEXT_1882 = "->";
  protected final String TEXT_1883 = "(this);" + NL + "    }" + NL;
  protected final String TEXT_1884 = NL + "    if (";
  protected final String TEXT_1885 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1886 = ";" + NL + "    }";
  protected final String TEXT_1887 = NL + "    if (";
  protected final String TEXT_1888 = " != NULL)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1889 = ".";
  protected final String TEXT_1890 = "() <= ";
  protected final String TEXT_1891 = ")" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1892 = ";" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1893 = NL + "        ";
  protected final String TEXT_1894 = "* ";
  protected final String TEXT_1895 = " = ";
  protected final String TEXT_1896 = ";" + NL + "        this.";
  ...
  protected final String TEXT_1904 = ";" + NL + "    this->";
  ...
  protected final String TEXT_1909 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1910 = "); i++)" + NL + "    {";
  protected final String TEXT_1911 = NL + "      ";
  protected final String TEXT_1912 = "(";
  protected final String TEXT_1913 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1914 = NL + "    ";
  protected final String TEXT_1915 = ".clear();";
  protected final String TEXT_1916 = NL + "    vector<";
  ...
  protected final String TEXT_1921 = ".clear();" + NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1922 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_1923 = ".";
  protected final String TEXT_1924 = "() <= ";
  protected final String TEXT_1925 = "->";
  protected final String TEXT_1926 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1927 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1928 = NL + "        ";
  protected final String TEXT_1929 = "->";
  protected final String TEXT_1930 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1931 = NL + "    vector<";
  ...
  protected final String TEXT_1936 = ".clear();" + NL + "    for(int i=0;sizeof(";
  protected final String TEXT_1937 = ");i++)" + NL + "    {";
  protected final String TEXT_1938 = NL + "      ";
  protected final String TEXT_1939 = "[i]->";
  protected final String TEXT_1940 = "(this);" + NL + "    }";
  protected final String TEXT_1941 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1942 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1943 = "[i];" + NL + "    }";
  protected final String TEXT_1944 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1945 = "); i++)" + NL + "    {";
  protected final String TEXT_1946 = NL + "      ";
  protected final String TEXT_1947 = "[i]->";
  protected final String TEXT_1948 = "(NULL);" + NL + "    }";
  protected final String TEXT_1949 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
