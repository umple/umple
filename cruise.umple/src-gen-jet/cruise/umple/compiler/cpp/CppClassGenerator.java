...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_108 = " getInstance()" + NL + "  {" + NL + "    if(theInstance == null)" + NL + "    {" + NL + "      theInstance = new ";
  protected final String TEXT_109 = "();" + NL + "    }" + NL + "    return theInstance;" + NL + "  }";
  ...
  protected final String TEXT_116 = " = new vector<";
  ...
  protected final String TEXT_131 = " = new vector<";
  ...
  protected final String TEXT_141 = " = new vector<";
  protected final String TEXT_142 = "*>();" + NL + "    bool ";
  ...
  protected final String TEXT_150 = " = new vector<";
  ...
  protected final String TEXT_413 = NL + "    int index = std::find(";
  ...
  protected final String TEXT_480 = ".remove(";
  protected final String TEXT_481 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_482 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_483 = NL + "  bool ";
  protected final String TEXT_484 = "::";
  protected final String TEXT_485 = "(";
  protected final String TEXT_486 = " ";
  protected final String TEXT_487 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_488 = NL + "    if (!";
  protected final String TEXT_489 = ".contains(";
  protected final String TEXT_490 = "))" + NL + "    {";
  protected final String TEXT_491 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_492 = ".indexOf(";
  protected final String TEXT_493 = ");";
  protected final String TEXT_494 = NL + "    ";
  protected final String TEXT_495 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_496 = ".";
  protected final String TEXT_497 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_498 = ".";
  protected final String TEXT_499 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_500 = NL + "        ";
  protected final String TEXT_501 = ".add(oldIndex,";
  protected final String TEXT_502 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_503 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_504 = NL + "  bool ";
  protected final String TEXT_505 = "::";
  protected final String TEXT_506 = "(";
  protected final String TEXT_507 = "* ";
  protected final String TEXT_508 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_509 = NL + "    ";
  protected final String TEXT_510 = " = ";
  protected final String TEXT_511 = ";" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_522 = ";" + NL + "      wasSet = true;" + NL + "    }";
  ...
  protected final String TEXT_531 = ".equals(";
  protected final String TEXT_532 = ") && equals(";
  protected final String TEXT_533 = ".";
  protected final String TEXT_534 = "()))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_535 = ", as existing ";
  protected final String TEXT_536 = " would become an orphan";
  ...
  protected final String TEXT_546 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  protected final String TEXT_547 = "))" + NL + "    {" + NL + "      if (";
  protected final String TEXT_548 = " != null)" + NL + "      {";
  protected final String TEXT_549 = NL + "        ";
  protected final String TEXT_550 = ".";
  protected final String TEXT_551 = " = null;" + NL + "      }" + NL + "      if (";
  protected final String TEXT_552 = " != null)" + NL + "      {";
  protected final String TEXT_553 = NL + "        ";
  protected final String TEXT_554 = ".";
  protected final String TEXT_555 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_556 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_557 = NL + "  bool ";
  protected final String TEXT_558 = "::";
  protected final String TEXT_559 = "(";
  protected final String TEXT_560 = " ";
  protected final String TEXT_561 = ")" + NL + "  {" + NL + "    bool";
  protected final String TEXT_562 = NL + "    if (";
  protected final String TEXT_563 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_564 = " to null, as ";
  protected final String TEXT_565 = " must always be associated to a ";
  ...
  protected final String TEXT_572 = " != null && !equals(";
  protected final String TEXT_573 = "))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_574 = ", the current ";
  protected final String TEXT_575 = " already has a ";
  protected final String TEXT_576 = ", which would be orphaned if it were re-assigned";
  ...
  protected final String TEXT_587 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_588 = " != null)" + NL + "    {";
  protected final String TEXT_589 = NL + "      ";
  protected final String TEXT_590 = ".";
  protected final String TEXT_591 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_592 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_593 = NL + "  ";
  protected final String TEXT_594 = " ";
  protected final String TEXT_595 = "::";
  protected final String TEXT_596 = "(";
  protected final String TEXT_597 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_598 = "(";
  protected final String TEXT_599 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_600 = "::";
  protected final String TEXT_601 = "(";
  protected final String TEXT_602 = " ";
  protected final String TEXT_603 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_604 = NL + "    ";
  protected final String TEXT_605 = " ";
  protected final String TEXT_606 = " = ";
  protected final String TEXT_607 = ".";
  protected final String TEXT_608 = "();" + NL + "    bool ";
  protected final String TEXT_609 = " = ";
  protected final String TEXT_610 = " != null && !this.equals(";
  protected final String TEXT_611 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_612 = " && ";
  protected final String TEXT_613 = ".";
  protected final String TEXT_614 = "() <= ";
  protected final String TEXT_615 = "())" + NL + "    {" + NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_616 = ")" + NL + "    {";
  protected final String TEXT_617 = NL + "      ";
  protected final String TEXT_618 = ".";
  protected final String TEXT_619 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_620 = NL + "      ";
  protected final String TEXT_621 = ".add(";
  protected final String TEXT_622 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_623 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_624 = "::";
  protected final String TEXT_625 = "(";
  protected final String TEXT_626 = " ";
  protected final String TEXT_627 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_628 = NL + "    //Unable to remove ";
  protected final String TEXT_629 = ", as it must always have a ";
  protected final String TEXT_630 = NL + "    if (this.equals(";
  protected final String TEXT_631 = ".";
  protected final String TEXT_632 = "()))" + NL + "    {";
  protected final String TEXT_633 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_634 = " already at minimum (";
  protected final String TEXT_635 = ")" + NL + "    if (";
  protected final String TEXT_636 = "() <= ";
  protected final String TEXT_637 = "())" + NL + "    {";
  protected final String TEXT_638 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_639 = NL + "    ";
  protected final String TEXT_640 = ".remove(";
  protected final String TEXT_641 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_642 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_651 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_652 = "::";
  protected final String TEXT_653 = "(";
  protected final String TEXT_654 = " ";
  protected final String TEXT_655 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_656 = NL + "    if (";
  protected final String TEXT_657 = "() >= ";
  protected final String TEXT_658 = "())" + NL + "    {";
  protected final String TEXT_659 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_660 = NL + "    ";
  protected final String TEXT_661 = " ";
  protected final String TEXT_662 = " = ";
  protected final String TEXT_663 = ".";
  protected final String TEXT_664 = "();" + NL + "    bool ";
  protected final String TEXT_665 = " = ";
  protected final String TEXT_666 = " != null && !this.equals(";
  protected final String TEXT_667 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_668 = " && ";
  protected final String TEXT_669 = ".";
  protected final String TEXT_670 = "() <= ";
  protected final String TEXT_671 = "())" + NL + "    {";
  protected final String TEXT_672 = NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_673 = ")" + NL + "    {";
  protected final String TEXT_674 = NL + "      ";
  protected final String TEXT_675 = ".";
  protected final String TEXT_676 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_677 = NL + "      ";
  protected final String TEXT_678 = ".add(";
  protected final String TEXT_679 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_680 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_681 = "::";
  protected final String TEXT_682 = "(";
  protected final String TEXT_683 = " ";
  protected final String TEXT_684 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_685 = NL + "    //Unable to remove ";
  protected final String TEXT_686 = ", as it must always have a ";
  protected final String TEXT_687 = NL + "    if (this.equals(";
  protected final String TEXT_688 = ".";
  protected final String TEXT_689 = "()))" + NL + "    {";
  protected final String TEXT_690 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_691 = " already at minimum (";
  protected final String TEXT_692 = ")" + NL + "    if (";
  protected final String TEXT_693 = "() <= ";
  protected final String TEXT_694 = "())" + NL + "    {";
  protected final String TEXT_695 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_696 = NL + "    ";
  protected final String TEXT_697 = ".remove(";
  protected final String TEXT_698 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_699 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_700 = NL + "  ";
  protected final String TEXT_701 = " ";
  protected final String TEXT_702 = "::";
  protected final String TEXT_703 = "(";
  protected final String TEXT_704 = ")" + NL + "  {" + NL + "    if (";
  protected final String TEXT_705 = "() >= ";
  protected final String TEXT_706 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_707 = "(";
  protected final String TEXT_708 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_709 = "::";
  protected final String TEXT_710 = "(";
  protected final String TEXT_711 = " ";
  protected final String TEXT_712 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_713 = NL + "    if (";
  protected final String TEXT_714 = "() >= ";
  protected final String TEXT_715 = "())" + NL + "    {";
  protected final String TEXT_716 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_717 = NL + "    ";
  protected final String TEXT_718 = " ";
  protected final String TEXT_719 = " = ";
  protected final String TEXT_720 = ".";
  protected final String TEXT_721 = "();" + NL + "    bool ";
  ...
  protected final String TEXT_732 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_733 = "::";
  protected final String TEXT_734 = "(";
  protected final String TEXT_735 = " ";
  protected final String TEXT_736 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_744 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_745 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_746 = NL + "  bool ";
  protected final String TEXT_747 = "::";
  protected final String TEXT_748 = "(";
  protected final String TEXT_749 = "... ";
  protected final String TEXT_750 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_751 = NL + "    vector<";
  protected final String TEXT_752 = "*> ";
  protected final String TEXT_753 = " = new vector<";
  protected final String TEXT_754 = "*>();" + NL + "    for (";
  protected final String TEXT_755 = " ";
  protected final String TEXT_756 = " : ";
  protected final String TEXT_757 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_758 = ".contains(";
  protected final String TEXT_759 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_760 = NL + "      ";
  protected final String TEXT_761 = ".add(";
  protected final String TEXT_762 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_763 = ".size() != ";
  protected final String TEXT_764 = ".length || ";
  protected final String TEXT_765 = ".size() > ";
  protected final String TEXT_766 = "())" + NL + "    {";
  protected final String TEXT_767 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_768 = "*> ";
  protected final String TEXT_769 = " = new vector<";
  protected final String TEXT_770 = "*>(";
  protected final String TEXT_771 = ");";
  protected final String TEXT_772 = NL + "    ";
  protected final String TEXT_773 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_780 = ".contains(";
  protected final String TEXT_781 = "))" + NL + "      {";
  protected final String TEXT_782 = NL + "        ";
  protected final String TEXT_783 = ".remove(";
  protected final String TEXT_784 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_785 = NL + "        ";
  protected final String TEXT_786 = ".";
  protected final String TEXT_787 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_788 = " ";
  protected final String TEXT_789 = " : ";
  protected final String TEXT_790 = ")" + NL + "    {";
  protected final String TEXT_791 = NL + "      ";
  protected final String TEXT_792 = ".";
  protected final String TEXT_793 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_794 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_795 = NL + "  ";
  protected final String TEXT_796 = " ";
  protected final String TEXT_797 = "::";
  protected final String TEXT_798 = "(";
  protected final String TEXT_799 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_800 = "(";
  protected final String TEXT_801 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_802 = "::";
  protected final String TEXT_803 = "(";
  protected final String TEXT_804 = " ";
  protected final String TEXT_805 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_806 = NL + "    ";
  protected final String TEXT_807 = " ";
  protected final String TEXT_808 = " = ";
  protected final String TEXT_809 = ".";
  protected final String TEXT_810 = "();" + NL + "    bool ";
  protected final String TEXT_811 = " = ";
  protected final String TEXT_812 = " != null && !this.equals(";
  protected final String TEXT_813 = ");" + NL + "    if (";
  protected final String TEXT_814 = ")" + NL + "    {";
  protected final String TEXT_815 = NL + "      ";
  protected final String TEXT_816 = ".";
  protected final String TEXT_817 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_818 = NL + "      ";
  protected final String TEXT_819 = ".add(";
  protected final String TEXT_820 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_821 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_822 = "::";
  protected final String TEXT_823 = "(";
  protected final String TEXT_824 = " ";
  protected final String TEXT_825 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_826 = NL + "    //Unable to remove ";
  protected final String TEXT_827 = ", as it must always have a ";
  protected final String TEXT_828 = NL + "    if (!this.equals(";
  protected final String TEXT_829 = ".";
  protected final String TEXT_830 = "()))" + NL + "    {";
  protected final String TEXT_831 = NL + "      ";
  protected final String TEXT_832 = ".remove(";
  protected final String TEXT_833 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_834 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_835 = NL + "  bool ";
  protected final String TEXT_836 = "::";
  protected final String TEXT_837 = "(";
  protected final String TEXT_838 = "* ";
  protected final String TEXT_839 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_847 = " = null;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_853 = "(null);" + NL + "      }" + NL + "      wasSet = true;";
  protected final String TEXT_854 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_864 = "(null);" + NL + "    }" + NL;
  ...
  protected final String TEXT_872 = "();" + NL + "" + NL + "    if (!equals(";
  protected final String TEXT_873 = "))" + NL + "    {";
  protected final String TEXT_874 = NL + "      ";
  protected final String TEXT_875 = ".";
  protected final String TEXT_876 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_877 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_878 = NL + "  bool ";
  protected final String TEXT_879 = "::";
  protected final String TEXT_880 = "(";
  protected final String TEXT_881 = " ";
  protected final String TEXT_882 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_883 = NL + "    if (!";
  protected final String TEXT_884 = ".contains(";
  protected final String TEXT_885 = "))" + NL + "    {";
  protected final String TEXT_886 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_887 = "() <= ";
  protected final String TEXT_888 = "())" + NL + "    {";
  protected final String TEXT_889 = NL + "      return wasRemoved;" + NL + "    }" + NL + "\t" + NL + "    int oldIndex = std::find(";
  protected final String TEXT_890 = ".begin(), ";
  protected final String TEXT_891 = ".end(), ";
  protected final String TEXT_892 = ") - ";
  protected final String TEXT_893 = ".begin();";
  protected final String TEXT_894 = NL + "    ";
  protected final String TEXT_895 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_896 = ".";
  protected final String TEXT_897 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_898 = ".";
  protected final String TEXT_899 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_900 = NL + "        ";
  protected final String TEXT_901 = ".add(oldIndex,";
  ...
  protected final String TEXT_908 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_909 = NL + "    if (!";
  protected final String TEXT_910 = ".contains(";
  protected final String TEXT_911 = "))" + NL + "    {";
  protected final String TEXT_912 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_913 = "() <= ";
  protected final String TEXT_914 = "())" + NL + "    {";
  protected final String TEXT_915 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = std::find(";
  ...
  protected final String TEXT_921 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_922 = ".";
  protected final String TEXT_923 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_924 = ".";
  protected final String TEXT_925 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_926 = NL + "        ";
  protected final String TEXT_927 = ".add(oldIndex,";
  protected final String TEXT_928 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_929 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_930 = NL + "  bool ";
  protected final String TEXT_931 = "::";
  protected final String TEXT_932 = "(";
  protected final String TEXT_933 = "* ";
  protected final String TEXT_934 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_950 = ".equals(";
  protected final String TEXT_951 = "))" + NL + "    {";
  protected final String TEXT_952 = NL + "      ";
  protected final String TEXT_953 = ".";
  protected final String TEXT_954 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_955 = " != null)" + NL + "    {";
  protected final String TEXT_956 = NL + "      ";
  protected final String TEXT_957 = ".";
  protected final String TEXT_958 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_959 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_960 = NL + "  bool ";
  protected final String TEXT_961 = "::";
  protected final String TEXT_962 = "(";
  protected final String TEXT_963 = " ";
  protected final String TEXT_964 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_980 = "(this);" + NL + "    }";
  protected final String TEXT_981 = NL + "    ";
  protected final String TEXT_982 = ".";
  protected final String TEXT_983 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_984 = NL + "    return wasSet;" + NL + "  }" + NL;
  ...
  protected final String TEXT_990 = NL + "    //Must provide ";
  protected final String TEXT_991 = " to ";
  protected final String TEXT_992 = NL + "    if (";
  protected final String TEXT_993 = " == null)" + NL + "    {";
  protected final String TEXT_994 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_995 = " already at maximum (";
  ...
  protected final String TEXT_1011 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  ...
  protected final String TEXT_1021 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1022 = NL + "  bool ";
  protected final String TEXT_1023 = "::";
  protected final String TEXT_1024 = "(";
  protected final String TEXT_1025 = " ";
  protected final String TEXT_1026 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1027 = NL + "    //Must provide ";
  protected final String TEXT_1028 = " to ";
  protected final String TEXT_1029 = NL + "    if (";
  protected final String TEXT_1030 = " == null)" + NL + "    {";
  protected final String TEXT_1031 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1047 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1048 = ".";
  protected final String TEXT_1049 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1056 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1057 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1058 = NL + "  bool ";
  protected final String TEXT_1059 = "::";
  protected final String TEXT_1060 = "(";
  protected final String TEXT_1061 = " ";
  protected final String TEXT_1062 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1071 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1079 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1080 = NL + "      ";
  protected final String TEXT_1081 = ".add(";
  protected final String TEXT_1082 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1083 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1084 = "::";
  protected final String TEXT_1085 = "(";
  protected final String TEXT_1086 = " ";
  protected final String TEXT_1087 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1088 = NL + "    if (";
  protected final String TEXT_1089 = ".contains(";
  protected final String TEXT_1090 = "))" + NL + "    {";
  protected final String TEXT_1091 = NL + "      ";
  protected final String TEXT_1092 = ".remove(";
  protected final String TEXT_1093 = ");";
  protected final String TEXT_1094 = NL + "      ";
  protected final String TEXT_1095 = ".";
  protected final String TEXT_1096 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1097 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1098 = NL + "  bool ";
  protected final String TEXT_1099 = "::";
  protected final String TEXT_1100 = "(";
  protected final String TEXT_1101 = "* ";
  protected final String TEXT_1102 = ")" + NL + "  {" + NL + "    boolwasSet = false;";
  ...
  protected final String TEXT_1111 = ".equals(";
  protected final String TEXT_1112 = "))" + NL + "    {";
  protected final String TEXT_1113 = NL + "      ";
  protected final String TEXT_1114 = ".";
  protected final String TEXT_1115 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1116 = " != null)" + NL + "    {";
  protected final String TEXT_1117 = NL + "      ";
  protected final String TEXT_1118 = ".";
  protected final String TEXT_1119 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1120 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1121 = NL + "  bool ";
  protected final String TEXT_1122 = "::";
  protected final String TEXT_1123 = "(";
  protected final String TEXT_1124 = " ";
  protected final String TEXT_1125 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1126 = NL + "    if (";
  protected final String TEXT_1127 = "() >= ";
  protected final String TEXT_1128 = "())" + NL + "    {";
  protected final String TEXT_1129 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_1130 = NL + "    ";
  protected final String TEXT_1131 = " ";
  protected final String TEXT_1132 = " = ";
  protected final String TEXT_1133 = ".";
  protected final String TEXT_1134 = "();" + NL + "    if (";
  protected final String TEXT_1135 = " == null)" + NL + "    {";
  protected final String TEXT_1136 = NL + "      ";
  protected final String TEXT_1137 = ".";
  protected final String TEXT_1138 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1169 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1175 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_1184 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1190 = ");" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_1196 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1197 = NL + "    if (";
  protected final String TEXT_1198 = "() >= ";
  protected final String TEXT_1199 = "())" + NL + "    {";
  protected final String TEXT_1200 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1210 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1211 = " != null)" + NL + "    {";
  protected final String TEXT_1212 = NL + "      ";
  protected final String TEXT_1213 = ".";
  protected final String TEXT_1214 = ".remove(";
  ...
  protected final String TEXT_1221 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1222 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1223 = "::";
  protected final String TEXT_1224 = "(";
  protected final String TEXT_1225 = " ";
  protected final String TEXT_1226 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1227 = NL + "    if (";
  protected final String TEXT_1228 = ".contains(";
  ...
  protected final String TEXT_1243 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1244 = NL + "    vector<";
  protected final String TEXT_1245 = "*> ";
  protected final String TEXT_1246 = " = new vector<";
  protected final String TEXT_1247 = "*>();" + NL + "    for (";
  protected final String TEXT_1248 = " ";
  protected final String TEXT_1249 = " : ";
  protected final String TEXT_1250 = ")" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1255 = "() != null && !this.equals(";
  protected final String TEXT_1256 = ".";
  protected final String TEXT_1257 = "()))" + NL + "      {";
  protected final String TEXT_1258 = NL + "        return wasSet;" + NL + "      }";
  ...
  protected final String TEXT_1266 = ".removeAll(";
  protected final String TEXT_1267 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1268 = " orphan : ";
  protected final String TEXT_1269 = ")" + NL + "    {";
  protected final String TEXT_1270 = NL + "      ";
  protected final String TEXT_1271 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1272 = NL + "    ";
  protected final String TEXT_1273 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1279 = ", this);";
  protected final String TEXT_1280 = NL + "      ";
  protected final String TEXT_1281 = ".add(";
  protected final String TEXT_1282 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1283 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1284 = NL + "  void ";
  ...
  protected final String TEXT_1297 = NL + "  bool ";
  protected final String TEXT_1298 = "::";
  protected final String TEXT_1299 = "(";
  protected final String TEXT_1300 = " ";
  protected final String TEXT_1301 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1302 = NL + "    ";
  protected final String TEXT_1303 = ".add(";
  protected final String TEXT_1304 = ");" + NL + "    wasAdded = true;";
  ...
  protected final String TEXT_1309 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1315 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1321 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1327 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1328 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1329 = "::";
  protected final String TEXT_1330 = "(";
  protected final String TEXT_1331 = " ";
  protected final String TEXT_1332 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1338 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1339 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1340 = NL + "  bool ";
  protected final String TEXT_1341 = "::";
  protected final String TEXT_1342 = "(";
  protected final String TEXT_1343 = " ";
  protected final String TEXT_1344 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1345 = NL + "    ";
  protected final String TEXT_1346 = ".add(";
  protected final String TEXT_1347 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1348 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1349 = "::";
  protected final String TEXT_1350 = "(";
  protected final String TEXT_1351 = " ";
  protected final String TEXT_1352 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1353 = NL + "    if (!";
  protected final String TEXT_1354 = ".contains(";
  protected final String TEXT_1355 = "))" + NL + "    {";
  protected final String TEXT_1356 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1361 = ".remove(";
  protected final String TEXT_1362 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1363 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1364 = NL + "  bool ";
  protected final String TEXT_1365 = "::";
  protected final String TEXT_1366 = "(";
  protected final String TEXT_1367 = "... ";
  protected final String TEXT_1368 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1369 = NL + "    vector<";
  protected final String TEXT_1370 = "*> ";
  protected final String TEXT_1371 = " = new vector<";
  protected final String TEXT_1372 = "*>();" + NL + "    for (";
  protected final String TEXT_1373 = " ";
  protected final String TEXT_1374 = " : ";
  protected final String TEXT_1375 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1376 = ".contains(";
  protected final String TEXT_1377 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1382 = ".length || ";
  ...
  protected final String TEXT_1387 = ".clear();";
  protected final String TEXT_1388 = NL + "    ";
  protected final String TEXT_1389 = ".addAll(";
  protected final String TEXT_1390 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1391 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1396 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1397 = NL + "    vector<";
  protected final String TEXT_1398 = "*> ";
  protected final String TEXT_1399 = " = new vector<";
  protected final String TEXT_1400 = "*>();" + NL + "    for (";
  protected final String TEXT_1401 = " ";
  protected final String TEXT_1402 = " : ";
  protected final String TEXT_1403 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1404 = ".contains(";
  protected final String TEXT_1405 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1406 = NL + "      ";
  protected final String TEXT_1407 = ".add(";
  protected final String TEXT_1408 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1409 = ".size() != ";
  protected final String TEXT_1410 = ".length || ";
  ...
  protected final String TEXT_1415 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1416 = "*> ";
  protected final String TEXT_1417 = " = new vector<";
  ...
  protected final String TEXT_1426 = ".add(";
  protected final String TEXT_1427 = ");" + NL + "      if (";
  protected final String TEXT_1428 = ".contains(";
  protected final String TEXT_1429 = "))" + NL + "      {";
  protected final String TEXT_1430 = NL + "        ";
  protected final String TEXT_1431 = ".remove(";
  protected final String TEXT_1432 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1433 = NL + "        ";
  protected final String TEXT_1434 = ".";
  protected final String TEXT_1435 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1441 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1442 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1443 = NL + "  bool ";
  protected final String TEXT_1444 = "::";
  protected final String TEXT_1445 = "(";
  protected final String TEXT_1446 = "... ";
  protected final String TEXT_1447 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1448 = NL + "    vector<";
  protected final String TEXT_1449 = "*> ";
  protected final String TEXT_1450 = " = new vector<";
  ...
  protected final String TEXT_1456 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1457 = NL + "      ";
  protected final String TEXT_1458 = ".add(";
  protected final String TEXT_1459 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1460 = ".size() != ";
  protected final String TEXT_1461 = ".length || ";
  protected final String TEXT_1462 = ".size() < ";
  protected final String TEXT_1463 = "())" + NL + "    {";
  protected final String TEXT_1464 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1465 = "*> ";
  protected final String TEXT_1466 = " = new vector<";
  protected final String TEXT_1467 = "*>(";
  protected final String TEXT_1468 = ");";
  protected final String TEXT_1469 = NL + "    ";
  protected final String TEXT_1470 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1481 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1482 = NL + "        ";
  protected final String TEXT_1483 = ".";
  protected final String TEXT_1484 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1490 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1491 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1492 = NL + "  bool ";
  protected final String TEXT_1493 = "::";
  protected final String TEXT_1494 = "(";
  protected final String TEXT_1495 = "... ";
  protected final String TEXT_1496 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1497 = NL + "    vector<";
  protected final String TEXT_1498 = "*> ";
  protected final String TEXT_1499 = " = new vector<";
  protected final String TEXT_1500 = "*>();" + NL + "    for (";
  protected final String TEXT_1501 = " ";
  protected final String TEXT_1502 = " : ";
  protected final String TEXT_1503 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1504 = ".contains(";
  protected final String TEXT_1505 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1506 = NL + "      ";
  protected final String TEXT_1507 = ".add(";
  protected final String TEXT_1508 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1509 = ".size() != ";
  protected final String TEXT_1510 = ".length || ";
  ...
  protected final String TEXT_1521 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1531 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1532 = "*> ";
  protected final String TEXT_1533 = " = new vector<";
  protected final String TEXT_1534 = "*>();" + NL + "    HashMap<";
  protected final String TEXT_1535 = ",Integer> ";
  protected final String TEXT_1536 = " = new HashMap<";
  protected final String TEXT_1537 = ",Integer>();" + NL + "    for (";
  protected final String TEXT_1538 = " ";
  protected final String TEXT_1539 = " : ";
  protected final String TEXT_1540 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1541 = ".contains(";
  protected final String TEXT_1542 = "))" + NL + "      {";
  protected final String TEXT_1543 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1544 = ".";
  protected final String TEXT_1545 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1553 = ".containsKey(";
  protected final String TEXT_1554 = "))" + NL + "        {";
  protected final String TEXT_1555 = NL + "          ";
  protected final String TEXT_1556 = ".put(";
  protected final String TEXT_1557 = ", new Integer(";
  protected final String TEXT_1558 = ".";
  protected final String TEXT_1559 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1560 = ".get(";
  protected final String TEXT_1561 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1562 = ")" + NL + "        {";
  protected final String TEXT_1563 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1564 = NL + "        ";
  protected final String TEXT_1565 = ".put(";
  protected final String TEXT_1566 = ", new Integer(nextCount));" + NL + "      }";
  protected final String TEXT_1567 = NL + "      ";
  protected final String TEXT_1568 = ".add(";
  protected final String TEXT_1569 = ");" + NL + "    }" + NL;
  protected final String TEXT_1570 = NL + "    ";
  protected final String TEXT_1571 = ".removeAll(";
  protected final String TEXT_1572 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1573 = " orphan : ";
  protected final String TEXT_1574 = ")" + NL + "    {";
  protected final String TEXT_1575 = NL + "      ";
  protected final String TEXT_1576 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1577 = NL + "    ";
  protected final String TEXT_1578 = ".clear();" + NL + "    for (";
  protected final String TEXT_1579 = " ";
  protected final String TEXT_1580 = " : ";
  protected final String TEXT_1581 = ")" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1587 = ".remove(";
  ...
  protected final String TEXT_1593 = ".add(";
  protected final String TEXT_1594 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1595 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1596 = NL + "  void ";
  ...
  protected final String TEXT_1602 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1603 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1604 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1605 = ", ";
  protected final String TEXT_1606 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1607 = " to ";
  protected final String TEXT_1608 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1609 = NL + "  bool ";
  protected final String TEXT_1610 = "::";
  protected final String TEXT_1611 = "(";
  protected final String TEXT_1612 = "... ";
  protected final String TEXT_1613 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1614 = NL + "    vector<";
  protected final String TEXT_1615 = "*> ";
  protected final String TEXT_1616 = " = new vector<";
  protected final String TEXT_1617 = "*>();" + NL + "    for (";
  protected final String TEXT_1618 = " ";
  protected final String TEXT_1619 = " : ";
  protected final String TEXT_1620 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1621 = ".contains(";
  protected final String TEXT_1622 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1623 = NL + "      ";
  protected final String TEXT_1624 = ".add(";
  protected final String TEXT_1625 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1626 = ".size() != ";
  protected final String TEXT_1627 = ".length || ";
  ...
  protected final String TEXT_1632 = ".clear();";
  protected final String TEXT_1633 = NL + "    ";
  protected final String TEXT_1634 = ".addAll(";
  protected final String TEXT_1635 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1636 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1637 = NL + "  bool ";
  protected final String TEXT_1638 = "::";
  protected final String TEXT_1639 = "(";
  protected final String TEXT_1640 = "... ";
  protected final String TEXT_1641 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1642 = NL + "    vector<";
  protected final String TEXT_1643 = "*> ";
  protected final String TEXT_1644 = " = new vector<";
  ...
  protected final String TEXT_1658 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1659 = NL + "    ";
  protected final String TEXT_1660 = ".clear();";
  protected final String TEXT_1661 = NL + "    ";
  protected final String TEXT_1662 = ".addAll(";
  protected final String TEXT_1663 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1664 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1665 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1666 = NL + "    ";
  protected final String TEXT_1667 = " == (";
  protected final String TEXT_1668 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1669 = NL + "    ";
  protected final String TEXT_1670 = NL;
  protected final String TEXT_1671 = NL + "    ";
  protected final String TEXT_1672 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1673 = NL + "   void ";
  protected final String TEXT_1674 = "::";
  protected final String TEXT_1675 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1676 = NL + "       ";
  protected final String TEXT_1677 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1678 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1679 = NL + "    ";
  protected final String TEXT_1680 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1681 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1682 = NL + "      ";
  protected final String TEXT_1683 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1684 = NL + "  void ";
  protected final String TEXT_1685 = "::";
  protected final String TEXT_1686 = "()" + NL + "  {";
  protected final String TEXT_1687 = NL + "    ";
  protected final String TEXT_1688 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1689 = "\",";
  protected final String TEXT_1690 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1691 = "::";
  protected final String TEXT_1692 = "()" + NL + "  {";
  protected final String TEXT_1693 = NL + "    ";
  protected final String TEXT_1694 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1695 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1696 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1697 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1698 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1699 = "::run ()" + NL + "    {";
  protected final String TEXT_1700 = NL + "      if (\"";
  protected final String TEXT_1701 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1702 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1703 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1704 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1705 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1706 = NL + "    ";
  protected final String TEXT_1707 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1708 = ";";
  protected final String TEXT_1709 = NL + "    ";
  protected final String TEXT_1710 = ".clear();";
  ...
  protected final String TEXT_1716 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1717 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1718 = ";" + NL + "    }";
  protected final String TEXT_1719 = NL + "    if (";
  protected final String TEXT_1720 = " != NULL)" + NL + "    {";
  ...
  protected final String TEXT_1729 = " = NULL;" + NL + "    if (";
  ...
  protected final String TEXT_1739 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1740 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1741 = ";" + NL + "    }";
  protected final String TEXT_1742 = NL + "    if (";
  protected final String TEXT_1743 = " != null)" + NL + "    {";
  protected final String TEXT_1744 = NL + "      ";
  protected final String TEXT_1745 = " ";
  protected final String TEXT_1746 = " = ";
  protected final String TEXT_1747 = ";" + NL + "      this.";
  protected final String TEXT_1748 = " = NULL;";
  protected final String TEXT_1749 = NL + "      ";
  protected final String TEXT_1750 = ".";
  protected final String TEXT_1751 = "(this);" + NL + "    }";
  protected final String TEXT_1752 = NL + "    if (";
  protected final String TEXT_1753 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1754 = ";" + NL + "    }";
  protected final String TEXT_1755 = NL + "    if (";
  protected final String TEXT_1756 = " != NULL)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1757 = ".";
  protected final String TEXT_1758 = "() <= ";
  protected final String TEXT_1759 = ")" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1760 = ";" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1761 = NL + "        ";
  protected final String TEXT_1762 = " ";
  protected final String TEXT_1763 = " = ";
  protected final String TEXT_1764 = ";" + NL + "        this.";
  protected final String TEXT_1765 = " = NULL;";
  protected final String TEXT_1766 = NL + "        ";
  protected final String TEXT_1767 = ".";
  protected final String TEXT_1768 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1769 = NL + "    ";
  protected final String TEXT_1770 = " ";
  protected final String TEXT_1771 = " = ";
  protected final String TEXT_1772 = ";" + NL + "    this.";
  protected final String TEXT_1773 = " = NULL;";
  protected final String TEXT_1774 = NL + "    ";
  protected final String TEXT_1775 = ".";
  protected final String TEXT_1776 = "(this);";
  protected final String TEXT_1777 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1778 = "); i++)" + NL + "    {";
  protected final String TEXT_1779 = NL + "      ";
  protected final String TEXT_1780 = "(";
  protected final String TEXT_1781 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1782 = NL + "    ";
  protected final String TEXT_1783 = ".clear();";
  protected final String TEXT_1784 = NL + "    vector<";
  protected final String TEXT_1785 = "> ";
  protected final String TEXT_1786 = " = vector<";
  protected final String TEXT_1787 = ">(";
  protected final String TEXT_1788 = ");";
  protected final String TEXT_1789 = NL + "    ";
  protected final String TEXT_1790 = ".clear();" + NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1791 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_1792 = ".";
  protected final String TEXT_1793 = "() <= ";
  protected final String TEXT_1794 = ".";
  protected final String TEXT_1795 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1796 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1797 = NL + "        ";
  protected final String TEXT_1798 = ".";
  protected final String TEXT_1799 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1800 = NL + "    vector<";
  protected final String TEXT_1801 = "> ";
  protected final String TEXT_1802 = " = new vector<";
  protected final String TEXT_1803 = ">(";
  protected final String TEXT_1804 = ");";
  protected final String TEXT_1805 = NL + "    ";
  protected final String TEXT_1806 = ".clear();" + NL + "    for(int i=0;sizeof(";
  protected final String TEXT_1807 = ");i++)" + NL + "    {";
  protected final String TEXT_1808 = NL + "      ";
  protected final String TEXT_1809 = "[i].";
  protected final String TEXT_1810 = "(this);" + NL + "    }";
  protected final String TEXT_1811 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1812 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1813 = "[i];" + NL + "    }";
  ...
  protected final String TEXT_1817 = "[i].";
  protected final String TEXT_1818 = "(NULL);" + NL + "    }";
  protected final String TEXT_1819 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
