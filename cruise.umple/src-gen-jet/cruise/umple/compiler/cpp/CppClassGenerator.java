...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_505 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_506 = ".indexOf(";
  protected final String TEXT_507 = ");";
  protected final String TEXT_508 = NL + "    ";
  protected final String TEXT_509 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_510 = ".";
  protected final String TEXT_511 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_512 = ".";
  protected final String TEXT_513 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_514 = NL + "        ";
  protected final String TEXT_515 = ".add(oldIndex,";
  protected final String TEXT_516 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_517 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_518 = NL + "  bool ";
  protected final String TEXT_519 = "::";
  protected final String TEXT_520 = "(";
  protected final String TEXT_521 = "* ";
  protected final String TEXT_522 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_523 = NL + "    ";
  protected final String TEXT_524 = " = ";
  protected final String TEXT_525 = ";" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_549 = ", as existing ";
  protected final String TEXT_550 = " would become an orphan";
  ...
  protected final String TEXT_560 = "() : NULL;" + NL + "" + NL + "    if (this!=";
  protected final String TEXT_561 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_562 = " != NULL)" + NL + "      {";
  protected final String TEXT_563 = NL + "        ";
  protected final String TEXT_564 = "->";
  protected final String TEXT_565 = " = NULL;" + NL + "      }" + NL + "      if (";
  protected final String TEXT_566 = " != NULL)" + NL + "      {";
  protected final String TEXT_567 = NL + "        ";
  protected final String TEXT_568 = "->";
  protected final String TEXT_569 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_570 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_571 = NL + "  bool ";
  protected final String TEXT_572 = "::";
  protected final String TEXT_573 = "(";
  protected final String TEXT_574 = " ";
  protected final String TEXT_575 = ")" + NL + "  {" + NL + "    bool";
  protected final String TEXT_576 = NL + "    if (";
  protected final String TEXT_577 = " == NULL)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_578 = " to null, as ";
  protected final String TEXT_579 = " must always be associated to a ";
  ...
  protected final String TEXT_587 = ")" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_588 = ", the current ";
  protected final String TEXT_589 = " already has a ";
  protected final String TEXT_590 = ", which would be orphaned if it were re-assigned";
  protected final String TEXT_591 = NL + "      return wasSet;" + NL + "    }" + NL + "    ";
  ...
  protected final String TEXT_601 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_602 = " != NULL)" + NL + "    {";
  protected final String TEXT_603 = NL + "      ";
  protected final String TEXT_604 = "->";
  protected final String TEXT_605 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_606 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_607 = NL + "  ";
  protected final String TEXT_608 = " ";
  protected final String TEXT_609 = "::";
  protected final String TEXT_610 = "(";
  protected final String TEXT_611 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_612 = "(";
  protected final String TEXT_613 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_614 = "::";
  protected final String TEXT_615 = "(";
  protected final String TEXT_616 = "* ";
  protected final String TEXT_617 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_629 = "())" + NL + "    {" + NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_680 = " != NULL && this!=";
  protected final String TEXT_681 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_682 = " && ";
  protected final String TEXT_683 = "->";
  protected final String TEXT_684 = "() <= ";
  protected final String TEXT_685 = "())" + NL + "    {";
  protected final String TEXT_686 = NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_687 = ")" + NL + "    {";
  protected final String TEXT_688 = NL + "      ";
  protected final String TEXT_689 = "->";
  protected final String TEXT_690 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_691 = NL + "      ";
  protected final String TEXT_692 = ".add(";
  protected final String TEXT_693 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_694 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_695 = "::";
  protected final String TEXT_696 = "(";
  protected final String TEXT_697 = "* ";
  protected final String TEXT_698 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_699 = ".begin(), ";
  protected final String TEXT_700 = ".end(), ";
  ...
  protected final String TEXT_705 = NL + "    if (this == ";
  protected final String TEXT_706 = "->";
  protected final String TEXT_707 = "())" + NL + "    {";
  protected final String TEXT_708 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_709 = " already at minimum (";
  protected final String TEXT_710 = ")" + NL + "    if (";
  protected final String TEXT_711 = "() <= ";
  protected final String TEXT_712 = "())" + NL + "    {";
  protected final String TEXT_713 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_714 = NL + "    ";
  protected final String TEXT_715 = ".erase(find(";
  protected final String TEXT_716 = ".begin(),";
  protected final String TEXT_717 = ".end(),";
  protected final String TEXT_718 = "));" + NL + "\tdelete ";
  protected final String TEXT_719 = "[index];" + NL + "    wasRemoved = true;";
  protected final String TEXT_720 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_727 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_728 = "(";
  protected final String TEXT_729 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_730 = "::";
  protected final String TEXT_731 = "(";
  protected final String TEXT_732 = "* ";
  protected final String TEXT_733 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_734 = NL + "    if (";
  protected final String TEXT_735 = "() >= ";
  protected final String TEXT_736 = "())" + NL + "    {";
  protected final String TEXT_737 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_738 = NL + "    ";
  protected final String TEXT_739 = " ";
  protected final String TEXT_740 = " = ";
  protected final String TEXT_741 = ".";
  protected final String TEXT_742 = "();" + NL + "    bool ";
  protected final String TEXT_743 = " = (";
  protected final String TEXT_744 = " != NULL && this != ";
  protected final String TEXT_745 = ");" + NL + "    if (";
  protected final String TEXT_746 = ")" + NL + "    {";
  protected final String TEXT_747 = NL + "      ";
  protected final String TEXT_748 = "->";
  protected final String TEXT_749 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_750 = NL + "      ";
  protected final String TEXT_751 = ".push_back(";
  protected final String TEXT_752 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_753 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_754 = "::";
  protected final String TEXT_755 = "(";
  protected final String TEXT_756 = "* ";
  protected final String TEXT_757 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_758 = ".begin(), ";
  protected final String TEXT_759 = ".end(), ";
  protected final String TEXT_760 = ") - ";
  protected final String TEXT_761 = ".begin();";
  protected final String TEXT_762 = NL + "    //Unable to remove ";
  protected final String TEXT_763 = ", as it must always have a ";
  protected final String TEXT_764 = NL + "    if (this != ";
  protected final String TEXT_765 = "->";
  protected final String TEXT_766 = "())" + NL + "    {";
  protected final String TEXT_767 = NL + "      ";
  protected final String TEXT_768 = ".erase(find(";
  protected final String TEXT_769 = ".begin(),";
  protected final String TEXT_770 = ".end(),";
  protected final String TEXT_771 = "));" + NL + "\t  delete ";
  protected final String TEXT_772 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_773 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_774 = NL + "  bool ";
  protected final String TEXT_775 = "::";
  protected final String TEXT_776 = "(";
  protected final String TEXT_777 = "... ";
  protected final String TEXT_778 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_779 = NL + "    vector<";
  protected final String TEXT_780 = "*> ";
  protected final String TEXT_781 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_782 = " ";
  protected final String TEXT_783 = " : ";
  protected final String TEXT_784 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_785 = ".begin(),";
  protected final String TEXT_786 = ".end(),";
  protected final String TEXT_787 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_788 = NL + "      ";
  protected final String TEXT_789 = "->add(";
  protected final String TEXT_790 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_791 = ".size() != ";
  protected final String TEXT_792 = ".length || ";
  protected final String TEXT_793 = ".size() > ";
  protected final String TEXT_794 = "())" + NL + "    {";
  protected final String TEXT_795 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_796 = "*> ";
  protected final String TEXT_797 = ";";
  protected final String TEXT_798 = NL + "    ";
  protected final String TEXT_799 = ".clear();" + NL + "    for (";
  protected final String TEXT_800 = " ";
  protected final String TEXT_801 = " : ";
  protected final String TEXT_802 = ")" + NL + "    {";
  protected final String TEXT_803 = NL + "      ";
  protected final String TEXT_804 = "->add(";
  protected final String TEXT_805 = ");" + NL + "      if (find(";
  protected final String TEXT_806 = ".begin(),";
  protected final String TEXT_807 = ".end(),";
  protected final String TEXT_808 = "))" + NL + "      {";
  protected final String TEXT_809 = NL + "        ";
  protected final String TEXT_810 = ".erase(";
  protected final String TEXT_811 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_812 = NL + "        ";
  protected final String TEXT_813 = "->";
  protected final String TEXT_814 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_815 = " ";
  protected final String TEXT_816 = " : ";
  protected final String TEXT_817 = ")" + NL + "    {";
  protected final String TEXT_818 = NL + "      ";
  protected final String TEXT_819 = "->";
  protected final String TEXT_820 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_821 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_822 = NL + "  ";
  protected final String TEXT_823 = " ";
  protected final String TEXT_824 = "::";
  protected final String TEXT_825 = "(";
  protected final String TEXT_826 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_827 = "(";
  protected final String TEXT_828 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_829 = "::";
  protected final String TEXT_830 = "(";
  protected final String TEXT_831 = "* ";
  protected final String TEXT_832 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_839 = " != NULL && this!=";
  protected final String TEXT_840 = ");" + NL + "    if (";
  protected final String TEXT_841 = ")" + NL + "    {";
  protected final String TEXT_842 = NL + "      ";
  protected final String TEXT_843 = "->";
  protected final String TEXT_844 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_845 = NL + "      ";
  protected final String TEXT_846 = "->push_back(";
  protected final String TEXT_847 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_848 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_849 = "::";
  protected final String TEXT_850 = "(";
  protected final String TEXT_851 = "* ";
  protected final String TEXT_852 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_853 = ".begin(), ";
  protected final String TEXT_854 = ".end(), ";
  protected final String TEXT_855 = ") - ";
  protected final String TEXT_856 = ".begin();";
  protected final String TEXT_857 = NL + "    //Unable to remove ";
  protected final String TEXT_858 = ", as it must always have a ";
  ...
  protected final String TEXT_863 = ".erase(find(";
  protected final String TEXT_864 = ".begin(),";
  protected final String TEXT_865 = ".end(),";
  protected final String TEXT_866 = "));" + NL + "\t  delete ";
  protected final String TEXT_867 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_868 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_869 = NL + "  bool ";
  protected final String TEXT_870 = "::";
  protected final String TEXT_871 = "(";
  protected final String TEXT_872 = "* ";
  protected final String TEXT_873 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_874 = NL + "    if (";
  protected final String TEXT_875 = " == NULL)" + NL + "    {";
  protected final String TEXT_876 = NL + "      ";
  protected final String TEXT_877 = " ";
  protected final String TEXT_878 = " = ";
  protected final String TEXT_879 = ";";
  protected final String TEXT_880 = NL + "      ";
  protected final String TEXT_881 = " = NULL;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_887 = "(NULL);" + NL + "      }" + NL + "      wasSet = true;";
  ...
  protected final String TEXT_898 = "(NULL);" + NL + "    }" + NL;
  ...
  protected final String TEXT_906 = "();" + NL + "" + NL + "    if (!=";
  ...
  protected final String TEXT_916 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_917 = ".begin(), ";
  protected final String TEXT_918 = ".end(), ";
  protected final String TEXT_919 = ") - ";
  protected final String TEXT_920 = ".begin();";
  protected final String TEXT_921 = NL + "    if (! find(";
  protected final String TEXT_922 = ".begin(),";
  protected final String TEXT_923 = ".end(),";
  protected final String TEXT_924 = "))" + NL + "    {";
  protected final String TEXT_925 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_926 = "() <= ";
  protected final String TEXT_927 = "())" + NL + "    {";
  protected final String TEXT_928 = NL + "      return wasRemoved;" + NL + "    }" + NL + "\t" + NL + "    int oldIndex = find(";
  ...
  protected final String TEXT_934 = ".erase(find(";
  protected final String TEXT_935 = ".begin(), ";
  protected final String TEXT_936 = ".end(), ";
  protected final String TEXT_937 = "));" + NL + "\tdelete ";
  protected final String TEXT_938 = "[oldIndex];" + NL + "    if (";
  protected final String TEXT_939 = "->";
  protected final String TEXT_940 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_941 = "->";
  protected final String TEXT_942 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_943 = NL + "        ";
  protected final String TEXT_944 = "->add(oldIndex,";
  protected final String TEXT_945 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_946 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_960 = ".end())" + NL + "    {";
  protected final String TEXT_961 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_962 = "() <= ";
  protected final String TEXT_963 = "())" + NL + "    {";
  protected final String TEXT_964 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = find(";
  ...
  protected final String TEXT_970 = ".erase(oldIndex);" + NL + "\tdelete ";
  protected final String TEXT_971 = "[oldIndex];" + NL + "    if (";
  ...
  protected final String TEXT_979 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_980 = NL + "  bool ";
  protected final String TEXT_981 = "::";
  protected final String TEXT_982 = "(";
  protected final String TEXT_983 = "* ";
  protected final String TEXT_984 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1014 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1030 = "(this);" + NL + "    }";
  protected final String TEXT_1031 = NL + "    ";
  protected final String TEXT_1032 = "->";
  protected final String TEXT_1033 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1034 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1035 = NL + "  bool ";
  protected final String TEXT_1036 = "::";
  protected final String TEXT_1037 = "(";
  protected final String TEXT_1038 = "* ";
  protected final String TEXT_1039 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1040 = NL + "    //Must provide ";
  protected final String TEXT_1041 = " to ";
  protected final String TEXT_1042 = NL + "    if (";
  protected final String TEXT_1043 = " == NULL)" + NL + "    {";
  protected final String TEXT_1044 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_1045 = " already at maximum (";
  ...
  protected final String TEXT_1061 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1062 = ".";
  protected final String TEXT_1063 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1071 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1072 = NL + "  bool ";
  protected final String TEXT_1073 = "::";
  protected final String TEXT_1074 = "(";
  protected final String TEXT_1075 = "* ";
  protected final String TEXT_1076 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1077 = NL + "    //Must provide ";
  protected final String TEXT_1078 = " to ";
  protected final String TEXT_1079 = NL + "    if (";
  protected final String TEXT_1080 = " == NULL)" + NL + "    {";
  protected final String TEXT_1081 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1097 = ")" + NL + "    {" + NL + "      bool didRemove = ";
  ...
  protected final String TEXT_1107 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1108 = NL + "  bool ";
  protected final String TEXT_1109 = "::";
  protected final String TEXT_1110 = "(";
  protected final String TEXT_1111 = "* ";
  protected final String TEXT_1112 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1121 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1129 = ");" + NL + "    } " + NL + "    else" + NL + "    {";
  protected final String TEXT_1130 = NL + "      ";
  protected final String TEXT_1131 = ".push_back(";
  protected final String TEXT_1132 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1133 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1134 = "::";
  protected final String TEXT_1135 = "(";
  protected final String TEXT_1136 = "* ";
  protected final String TEXT_1137 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1138 = ".begin(), ";
  protected final String TEXT_1139 = ".end(), ";
  protected final String TEXT_1140 = ") - ";
  protected final String TEXT_1141 = ".begin();";
  protected final String TEXT_1142 = NL + "    if (find(";
  ...
  protected final String TEXT_1147 = ".erase(find(";
  ...
  protected final String TEXT_1153 = "(NULL);" + NL + "\t  delete ";
  protected final String TEXT_1154 = "[index]" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1155 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1156 = NL + "  bool ";
  protected final String TEXT_1157 = "::";
  protected final String TEXT_1158 = "(";
  protected final String TEXT_1159 = "* ";
  protected final String TEXT_1160 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1193 = " == NULL)" + NL + "    {";
  protected final String TEXT_1194 = NL + "      ";
  protected final String TEXT_1195 = ".";
  protected final String TEXT_1196 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1207 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  ...
  protected final String TEXT_1212 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1213 = ".begin(), ";
  protected final String TEXT_1214 = ".end(), ";
  protected final String TEXT_1215 = ") - ";
  protected final String TEXT_1216 = ".begin();";
  protected final String TEXT_1217 = NL + "    if (find(";
  protected final String TEXT_1218 = ".begin(),";
  protected final String TEXT_1219 = ".end(),";
  protected final String TEXT_1220 = ") != ";
  protected final String TEXT_1221 = ".end())" + NL + "    {";
  protected final String TEXT_1222 = NL + "      ";
  protected final String TEXT_1223 = ".remove(";
  protected final String TEXT_1224 = ");";
  protected final String TEXT_1225 = NL + "      ";
  protected final String TEXT_1226 = "->";
  protected final String TEXT_1227 = "(NULL);" + NL + "\t  delete ";
  protected final String TEXT_1228 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1229 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1230 = NL + "  bool ";
  protected final String TEXT_1231 = "::";
  protected final String TEXT_1232 = "(";
  protected final String TEXT_1233 = " ";
  protected final String TEXT_1234 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1239 = ".push_back(";
  protected final String TEXT_1240 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1241 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1242 = "::";
  protected final String TEXT_1243 = "(";
  protected final String TEXT_1244 = "* ";
  protected final String TEXT_1245 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1246 = ".begin(), ";
  protected final String TEXT_1247 = ".end(), ";
  protected final String TEXT_1248 = ") - ";
  protected final String TEXT_1249 = ".begin();";
  protected final String TEXT_1250 = NL + "    if (!find(";
  protected final String TEXT_1251 = ".begin(),";
  protected final String TEXT_1252 = ".end(),";
  protected final String TEXT_1253 = ") != ";
  protected final String TEXT_1254 = ".end())" + NL + "    {";
  protected final String TEXT_1255 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1260 = ".erase(find(";
  protected final String TEXT_1261 = ".begin(),";
  protected final String TEXT_1262 = ".end(),";
  protected final String TEXT_1263 = "));" + NL + "\tdelete ";
  protected final String TEXT_1264 = "[index];" + NL + "    wasRemoved = true;";
  protected final String TEXT_1265 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1266 = NL + "  bool ";
  protected final String TEXT_1267 = "::";
  protected final String TEXT_1268 = "(";
  protected final String TEXT_1269 = "* ";
  protected final String TEXT_1270 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1271 = NL + "    if (";
  protected final String TEXT_1272 = "() >= ";
  protected final String TEXT_1273 = "())" + NL + "    {";
  protected final String TEXT_1274 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1295 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1296 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1297 = "::";
  protected final String TEXT_1298 = "(";
  protected final String TEXT_1299 = "* ";
  protected final String TEXT_1300 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1301 = ".begin(), ";
  protected final String TEXT_1302 = ".end(), ";
  protected final String TEXT_1303 = ") - ";
  protected final String TEXT_1304 = ".begin();";
  protected final String TEXT_1305 = NL + "    if ((find(";
  protected final String TEXT_1306 = ".begin(),";
  protected final String TEXT_1307 = ".end(),";
  ...
  protected final String TEXT_1313 = ".erase(find(";
  ...
  protected final String TEXT_1319 = ",NULL);" + NL + "\t  delete ";
  protected final String TEXT_1320 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1321 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1322 = NL + "  bool ";
  ...
  protected final String TEXT_1327 = NL + "    vector<";
  protected final String TEXT_1328 = "*> ";
  protected final String TEXT_1329 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_1330 = " ";
  protected final String TEXT_1331 = " : ";
  protected final String TEXT_1332 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1333 = ".begin(),";
  protected final String TEXT_1334 = ".end(),";
  ...
  protected final String TEXT_1338 = "() != NULL && this!=(";
  ...
  protected final String TEXT_1343 = ".push_back(";
  ...
  protected final String TEXT_1373 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1374 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1375 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1376 = ", ";
  protected final String TEXT_1377 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1378 = " to ";
  protected final String TEXT_1379 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1380 = NL + "  bool ";
  protected final String TEXT_1381 = "::";
  protected final String TEXT_1382 = "(";
  protected final String TEXT_1383 = " ";
  protected final String TEXT_1384 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1385 = NL + "    ";
  protected final String TEXT_1386 = "push_back(";
  protected final String TEXT_1387 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1388 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1389 = "::";
  protected final String TEXT_1390 = "(";
  protected final String TEXT_1391 = "* ";
  protected final String TEXT_1392 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1393 = ".begin(), ";
  protected final String TEXT_1394 = ".end(), ";
  protected final String TEXT_1395 = ") - ";
  protected final String TEXT_1396 = ".begin();";
  protected final String TEXT_1397 = NL + "    if (find(";
  protected final String TEXT_1398 = ".begin(),";
  protected final String TEXT_1399 = ".end(),";
  protected final String TEXT_1400 = ") != ";
  protected final String TEXT_1401 = ".end())" + NL + "    {";
  protected final String TEXT_1402 = NL + "      ";
  protected final String TEXT_1403 = ".erase(find(";
  protected final String TEXT_1404 = ".begin(),";
  protected final String TEXT_1405 = ".end(),";
  protected final String TEXT_1406 = "));" + NL + "\t  delete ";
  protected final String TEXT_1407 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1408 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1409 = NL + "  bool ";
  protected final String TEXT_1410 = "::";
  protected final String TEXT_1411 = "(";
  protected final String TEXT_1412 = "* ";
  protected final String TEXT_1413 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1419 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_1435 = ".erase(";
  protected final String TEXT_1436 = ");" + NL + "\t  delete ";
  protected final String TEXT_1437 = "[index];" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1438 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1439 = NL + "  bool ";
  protected final String TEXT_1440 = "::";
  protected final String TEXT_1441 = "(";
  protected final String TEXT_1442 = "* ";
  protected final String TEXT_1443 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1444 = NL + "    ";
  protected final String TEXT_1445 = ".push_back(";
  protected final String TEXT_1446 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1447 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1448 = "::";
  protected final String TEXT_1449 = "(";
  protected final String TEXT_1450 = "* ";
  protected final String TEXT_1451 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;" + NL + "\tint index = find(";
  protected final String TEXT_1452 = ".begin(), ";
  protected final String TEXT_1453 = ".end(), ";
  protected final String TEXT_1454 = ") - ";
  protected final String TEXT_1455 = ".begin();";
  protected final String TEXT_1456 = NL + "    if (!find(";
  protected final String TEXT_1457 = ".begin(),";
  protected final String TEXT_1458 = ".end(),";
  protected final String TEXT_1459 = ") != ";
  protected final String TEXT_1460 = ".end())" + NL + "    {";
  protected final String TEXT_1461 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1462 = "() <= ";
  protected final String TEXT_1463 = "())" + NL + "    {";
  protected final String TEXT_1464 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1465 = NL + "    ";
  protected final String TEXT_1466 = ".erase(find(";
  protected final String TEXT_1467 = ".begin(),";
  protected final String TEXT_1468 = ".end(),";
  protected final String TEXT_1469 = "));" + NL + "    delete ";
  protected final String TEXT_1470 = "[index];" + NL + "\twasRemoved = true;";
  protected final String TEXT_1471 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1472 = NL + "  bool ";
  protected final String TEXT_1473 = "::";
  protected final String TEXT_1474 = "(";
  protected final String TEXT_1475 = "... ";
  protected final String TEXT_1476 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1477 = NL + "    vector<";
  protected final String TEXT_1478 = "*> ";
  protected final String TEXT_1479 = ";" + NL + "    for (";
  protected final String TEXT_1480 = " ";
  protected final String TEXT_1481 = " : ";
  protected final String TEXT_1482 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1483 = ".begin(),";
  protected final String TEXT_1484 = ".end(),";
  protected final String TEXT_1485 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1486 = NL + "      ";
  protected final String TEXT_1487 = ".push_back(";
  protected final String TEXT_1488 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1489 = ".size() != ";
  protected final String TEXT_1490 = ".size() || ";
  protected final String TEXT_1491 = ".size() != ";
  protected final String TEXT_1492 = "())" + NL + "    {";
  protected final String TEXT_1493 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1494 = NL + "    ";
  protected final String TEXT_1495 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1496 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1497 = ".push_back(";
  protected final String TEXT_1498 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1499 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1500 = NL + "  ";
  protected final String TEXT_1501 = " bool ";
  protected final String TEXT_1502 = "(";
  protected final String TEXT_1503 = "... ";
  protected final String TEXT_1504 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1505 = NL + "    vector<";
  protected final String TEXT_1506 = "*> ";
  protected final String TEXT_1507 = ";" + NL + "    for (int i=0 ; i<";
  protected final String TEXT_1508 = ".size() ; i++)" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1509 = ".begin(),";
  protected final String TEXT_1510 = ".end(),(";
  protected final String TEXT_1511 = ") - ";
  protected final String TEXT_1512 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1513 = NL + "      ";
  protected final String TEXT_1514 = ".push_back(";
  protected final String TEXT_1515 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1516 = ".size() != ";
  protected final String TEXT_1517 = ".length)" + NL + "    {";
  ...
  protected final String TEXT_1524 = NL + "    return wasSet;" + NL + "  }" + NL;
  ...
  protected final String TEXT_1530 = NL + "    vector<";
  protected final String TEXT_1531 = "*> ";
  protected final String TEXT_1532 = ";" + NL + "    for (";
  protected final String TEXT_1533 = " ";
  protected final String TEXT_1534 = " : ";
  protected final String TEXT_1535 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1536 = ".begin(),";
  protected final String TEXT_1537 = ".end(),";
  protected final String TEXT_1538 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1539 = NL + "      ";
  protected final String TEXT_1540 = "push_back(";
  protected final String TEXT_1541 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1542 = ".size() != ";
  protected final String TEXT_1543 = ".length || ";
  protected final String TEXT_1544 = ".size() < ";
  protected final String TEXT_1545 = "() || ";
  protected final String TEXT_1546 = ".size() > ";
  protected final String TEXT_1547 = "())" + NL + "    {";
  protected final String TEXT_1548 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1549 = "*> ";
  protected final String TEXT_1550 = " = new vector<";
  protected final String TEXT_1551 = "*>(";
  protected final String TEXT_1552 = ");";
  protected final String TEXT_1553 = NL + "    ";
  protected final String TEXT_1554 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1559 = ".push_back(";
  protected final String TEXT_1560 = ");" + NL + "      if (find(";
  protected final String TEXT_1561 = ".begin(),";
  protected final String TEXT_1562 = ".end(),";
  protected final String TEXT_1563 = "))" + NL + "      {";
  protected final String TEXT_1564 = NL + "        ";
  protected final String TEXT_1565 = ".erase(find(";
  protected final String TEXT_1566 = ".begin(),";
  protected final String TEXT_1567 = ".end(),";
  protected final String TEXT_1568 = "));" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1569 = NL + "        ";
  protected final String TEXT_1570 = "->";
  protected final String TEXT_1571 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1577 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1578 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1579 = NL + "  bool ";
  protected final String TEXT_1580 = "::";
  protected final String TEXT_1581 = "(";
  protected final String TEXT_1582 = "... ";
  protected final String TEXT_1583 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1584 = NL + "    vector<";
  protected final String TEXT_1585 = "*> ";
  protected final String TEXT_1586 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_1587 = " ";
  protected final String TEXT_1588 = " : ";
  protected final String TEXT_1589 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1590 = ".begin(),";
  protected final String TEXT_1591 = ".end(),";
  protected final String TEXT_1592 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1593 = NL + "      ";
  protected final String TEXT_1594 = ".push_back(";
  protected final String TEXT_1595 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1596 = ".size() != ";
  protected final String TEXT_1597 = ".length || ";
  protected final String TEXT_1598 = ".size() < ";
  protected final String TEXT_1599 = "())" + NL + "    {";
  protected final String TEXT_1600 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1601 = "*> ";
  protected final String TEXT_1602 = ";";
  protected final String TEXT_1603 = NL + "    ";
  protected final String TEXT_1604 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1610 = ");" + NL + "      if (find(";
  protected final String TEXT_1611 = ".begin(),";
  protected final String TEXT_1612 = ".end(),";
  protected final String TEXT_1613 = ")))" + NL + "      {";
  protected final String TEXT_1614 = NL + "        ";
  protected final String TEXT_1615 = ".erase(";
  protected final String TEXT_1616 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1617 = NL + "        ";
  protected final String TEXT_1618 = "->";
  protected final String TEXT_1619 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1625 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1626 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1652 = ".clear();" + NL + "\tfor (int i=0; i<";
  protected final String TEXT_1653 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1654 = ".push_back(";
  protected final String TEXT_1655 = "[i]);" + NL + "\t}" + NL + "    " + NL + "    wasSet = true;";
  protected final String TEXT_1656 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1657 = NL + "  bool ";
  protected final String TEXT_1658 = "::";
  protected final String TEXT_1659 = "(";
  protected final String TEXT_1660 = "... ";
  protected final String TEXT_1661 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1666 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1667 = "*> ";
  protected final String TEXT_1668 = ";" + NL + "\t" + NL + "    map<";
  protected final String TEXT_1669 = ",int> ";
  protected final String TEXT_1670 = ";" + NL + "    for (";
  protected final String TEXT_1671 = " ";
  protected final String TEXT_1672 = " : ";
  protected final String TEXT_1673 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1674 = ".begin(),";
  protected final String TEXT_1675 = ".end(),";
  protected final String TEXT_1676 = "))" + NL + "      {";
  protected final String TEXT_1677 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1678 = "->";
  protected final String TEXT_1679 = "() != NULL && this!=";
  ...
  protected final String TEXT_1687 = ".find(";
  protected final String TEXT_1688 = "))" + NL + "        {";
  protected final String TEXT_1689 = NL + "          ";
  protected final String TEXT_1690 = ".insert(";
  protected final String TEXT_1691 = ", new int(";
  protected final String TEXT_1692 = "->";
  protected final String TEXT_1693 = "()));" + NL + "        }" + NL + "        int currentCount = ";
  protected final String TEXT_1694 = ".find(";
  protected final String TEXT_1695 = ")->firtst;" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1696 = ")" + NL + "        {";
  protected final String TEXT_1697 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1698 = NL + "        ";
  protected final String TEXT_1699 = ".insert(";
  protected final String TEXT_1700 = ", new int(nextCount));" + NL + "      }";
  protected final String TEXT_1701 = NL + "      ";
  protected final String TEXT_1702 = ".push_back(";
  protected final String TEXT_1703 = ");" + NL + "    }" + NL;
  protected final String TEXT_1704 = NL + "    ";
  protected final String TEXT_1705 = ".removeAll(";
  protected final String TEXT_1706 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1707 = " orphan : ";
  protected final String TEXT_1708 = ")" + NL + "    {";
  protected final String TEXT_1709 = NL + "      ";
  protected final String TEXT_1710 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1711 = NL + "    ";
  protected final String TEXT_1712 = ".clear();" + NL + "    for (";
  protected final String TEXT_1713 = " ";
  protected final String TEXT_1714 = " : ";
  protected final String TEXT_1715 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1716 = ".";
  protected final String TEXT_1717 = "() != null)" + NL + "      {";
  ...
  protected final String TEXT_1725 = ", this);";
  protected final String TEXT_1726 = NL + "      ";
  protected final String TEXT_1727 = ".push_back(";
  protected final String TEXT_1728 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1729 = NL + "    return wasSet;" + NL + "  }" + NL;
  ...
  protected final String TEXT_1736 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1737 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1738 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1739 = ", ";
  protected final String TEXT_1740 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1741 = " to ";
  protected final String TEXT_1742 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1743 = NL + "  bool ";
  protected final String TEXT_1744 = "::";
  protected final String TEXT_1745 = "(";
  protected final String TEXT_1746 = "... ";
  protected final String TEXT_1747 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1748 = NL + "    vector<";
  ...
  protected final String TEXT_1753 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1754 = ".begin(),";
  protected final String TEXT_1755 = ".end(),(";
  protected final String TEXT_1756 = ")) - ";
  protected final String TEXT_1757 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1758 = NL + "      ";
  protected final String TEXT_1759 = ".push_back(";
  protected final String TEXT_1760 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1761 = ".size() != ";
  protected final String TEXT_1762 = ".size() || ";
  protected final String TEXT_1763 = ".size() > ";
  ...
  protected final String TEXT_1767 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1768 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1769 = ".push_back(";
  protected final String TEXT_1770 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1771 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1772 = NL + "  bool ";
  protected final String TEXT_1773 = "::";
  protected final String TEXT_1774 = "(";
  protected final String TEXT_1775 = "... ";
  protected final String TEXT_1776 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1777 = NL + "    vector<";
  protected final String TEXT_1778 = "*> ";
  protected final String TEXT_1779 = ";" + NL + "    for (";
  protected final String TEXT_1780 = " ";
  protected final String TEXT_1781 = " : ";
  protected final String TEXT_1782 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1783 = ".begin(),";
  protected final String TEXT_1784 = ".end(),";
  protected final String TEXT_1785 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1786 = NL + "      ";
  protected final String TEXT_1787 = "->add(";
  protected final String TEXT_1788 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1789 = ".size() != ";
  protected final String TEXT_1790 = ".size() || ";
  protected final String TEXT_1791 = ".size() < ";
  protected final String TEXT_1792 = "())" + NL + "    {";
  protected final String TEXT_1793 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1794 = NL + "    ";
  protected final String TEXT_1795 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1796 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1797 = ".push_back(";
  protected final String TEXT_1798 = "[i]);" + NL + "\t}" + NL + "\t" + NL + "    wasSet = true;";
  protected final String TEXT_1799 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1800 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1801 = NL + "    ";
  protected final String TEXT_1802 = " == (";
  protected final String TEXT_1803 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1804 = NL + "    ";
  protected final String TEXT_1805 = NL;
  protected final String TEXT_1806 = NL + "    ";
  protected final String TEXT_1807 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1808 = NL + "   void ";
  protected final String TEXT_1809 = "::";
  protected final String TEXT_1810 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1811 = NL + "       ";
  protected final String TEXT_1812 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1813 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1814 = NL + "    ";
  protected final String TEXT_1815 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1816 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1817 = NL + "      ";
  protected final String TEXT_1818 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1819 = NL + "  void ";
  protected final String TEXT_1820 = "::";
  protected final String TEXT_1821 = "()" + NL + "  {";
  protected final String TEXT_1822 = NL + "    ";
  protected final String TEXT_1823 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1824 = "\",";
  protected final String TEXT_1825 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1826 = "::";
  protected final String TEXT_1827 = "()" + NL + "  {";
  protected final String TEXT_1828 = NL + "    ";
  protected final String TEXT_1829 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1830 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1831 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1832 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1833 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1834 = "::run ()" + NL + "    {";
  protected final String TEXT_1835 = NL + "      if (\"";
  protected final String TEXT_1836 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1837 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1838 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1839 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1840 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1841 = NL + "    ";
  protected final String TEXT_1842 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1843 = ";";
  protected final String TEXT_1844 = NL + "    ";
  protected final String TEXT_1845 = ".clear();";
  ...
  protected final String TEXT_1851 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1852 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1864 = " = NULL;" + NL + "    if (";
  ...
  protected final String TEXT_1874 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1875 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1876 = ";" + NL + "    }";
  protected final String TEXT_1877 = NL + "    if (";
  protected final String TEXT_1878 = " != NULL)" + NL + "    {";
  protected final String TEXT_1879 = NL + "      ";
  protected final String TEXT_1880 = "* ";
  protected final String TEXT_1881 = " = ";
  protected final String TEXT_1882 = ";" + NL + "      this->";
  protected final String TEXT_1883 = " = NULL;";
  protected final String TEXT_1884 = NL + "      ";
  protected final String TEXT_1885 = "->";
  protected final String TEXT_1886 = "(this);" + NL + "    }" + NL;
  protected final String TEXT_1887 = NL + "    if (";
  protected final String TEXT_1888 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1889 = ";" + NL + "    }";
  protected final String TEXT_1890 = NL + "    if (";
  protected final String TEXT_1891 = " != NULL)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1892 = ".";
  protected final String TEXT_1893 = "() <= ";
  protected final String TEXT_1894 = ")" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1895 = ";" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1896 = NL + "        ";
  protected final String TEXT_1897 = "* ";
  protected final String TEXT_1898 = " = ";
  protected final String TEXT_1899 = ";" + NL + "        this.";
  protected final String TEXT_1900 = " = NULL;";
  protected final String TEXT_1901 = NL + "        ";
  protected final String TEXT_1902 = "->";
  protected final String TEXT_1903 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1904 = NL + "    ";
  protected final String TEXT_1905 = " ";
  protected final String TEXT_1906 = " = ";
  protected final String TEXT_1907 = ";" + NL + "    this->";
  protected final String TEXT_1908 = " = NULL;";
  protected final String TEXT_1909 = NL + "    ";
  protected final String TEXT_1910 = "->";
  protected final String TEXT_1911 = "(this);";
  protected final String TEXT_1912 = NL + "    for(i =0; sizeof(";
  protected final String TEXT_1913 = "); i++)" + NL + "    {";
  protected final String TEXT_1914 = NL + "      ";
  protected final String TEXT_1915 = "(";
  protected final String TEXT_1916 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1917 = NL + "    ";
  protected final String TEXT_1918 = ".clear();";
  protected final String TEXT_1919 = NL + "    vector<";
  ...
  protected final String TEXT_1924 = ".clear();" + NL + "    for(i =0; sizeof(";
  protected final String TEXT_1925 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_1926 = ".";
  protected final String TEXT_1927 = "() <= ";
  protected final String TEXT_1928 = "->";
  protected final String TEXT_1929 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1930 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1931 = NL + "        ";
  protected final String TEXT_1932 = "->";
  protected final String TEXT_1933 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1934 = NL + "    vector<";
  ...
  protected final String TEXT_1939 = ".clear();" + NL + "    for(i=0;sizeof(";
  protected final String TEXT_1940 = ");i++)" + NL + "    {";
  protected final String TEXT_1941 = NL + "      ";
  protected final String TEXT_1942 = "[i]->";
  protected final String TEXT_1943 = "(this);" + NL + "    }";
  protected final String TEXT_1944 = NL + "    for(i =0; sizeof(";
  protected final String TEXT_1945 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1946 = "[i];" + NL + "    }";
  protected final String TEXT_1947 = NL + "    for(i =0; sizeof(";
  protected final String TEXT_1948 = "); i++)" + NL + "    {";
  protected final String TEXT_1949 = NL + "      ";
  protected final String TEXT_1950 = "[i]->";
  protected final String TEXT_1951 = "(NULL);" + NL + "    }";
  protected final String TEXT_1952 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
