...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_136 = NL + "    return wasSet;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_137 = "::";
  protected final String TEXT_138 = "()" + NL + "  {" + NL + "    bool wasReset = false;";
  protected final String TEXT_139 = NL + "    ";
  protected final String TEXT_140 = " = ";
  protected final String TEXT_141 = "();" + NL + "    wasReset = true;";
  protected final String TEXT_142 = NL + "    return wasReset;" + NL + "  }" + NL;
  protected final String TEXT_143 = NL + "  bool ";
  protected final String TEXT_144 = "::";
  protected final String TEXT_145 = "(";
  protected final String TEXT_146 = " ";
  protected final String TEXT_147 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_148 = NL + "    wasAdded = ";
  protected final String TEXT_149 = ".add(";
  protected final String TEXT_150 = ");";
  protected final String TEXT_151 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_152 = "::";
  protected final String TEXT_153 = "(";
  protected final String TEXT_154 = " ";
  protected final String TEXT_155 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_156 = NL + "    wasRemoved = ";
  protected final String TEXT_157 = ".remove(";
  protected final String TEXT_158 = ");";
  protected final String TEXT_159 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  ...
  protected final String TEXT_190 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_191 = "::";
  protected final String TEXT_192 = "()" + NL + "  {";
  protected final String TEXT_193 = NL + "    int number = ";
  protected final String TEXT_194 = ".size();";
  protected final String TEXT_195 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_196 = "::";
  protected final String TEXT_197 = "()" + NL + "  {";
  protected final String TEXT_198 = NL + "    bool has = ";
  protected final String TEXT_199 = ".size() > 0;";
  protected final String TEXT_200 = NL + "    return has;" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_201 = "::";
  protected final String TEXT_202 = "(";
  protected final String TEXT_203 = " ";
  protected final String TEXT_204 = ")" + NL + "  {";
  protected final String TEXT_205 = NL + "    int index = ";
  protected final String TEXT_206 = ".indexOf(";
  protected final String TEXT_207 = ");";
  protected final String TEXT_208 = NL + "    return index;" + NL + "  }" + NL;
  ...
  protected final String TEXT_274 = "()" + NL + "  {" + NL + "    String answer = ";
  ...
  protected final String TEXT_279 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_280 = ";" + NL + "  }" + NL;
  protected final String TEXT_281 = NL + "  public boolean ";
  protected final String TEXT_282 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;" + NL;
  protected final String TEXT_283 = NL + "    ";
  protected final String TEXT_284 = NL + NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_285 = NL + "  public boolean ";
  protected final String TEXT_286 = "(";
  protected final String TEXT_287 = " ";
  protected final String TEXT_288 = ")" + NL + "  {";
  protected final String TEXT_289 = NL + "    ";
  protected final String TEXT_290 = " = ";
  protected final String TEXT_291 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_292 = NL + "  private void ";
  protected final String TEXT_293 = "()" + NL + "  {" + NL + "    switch(";
  protected final String TEXT_294 = ")" + NL + "    {";
  protected final String TEXT_295 = NL + "      ";
  protected final String TEXT_296 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_297 = NL + "  private void ";
  ...
  protected final String TEXT_314 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_335 = "(int index)" + NL + "  {";
  protected final String TEXT_336 = NL + "    ";
  protected final String TEXT_337 = " ";
  protected final String TEXT_338 = " = ";
  protected final String TEXT_339 = ".get(index);";
  protected final String TEXT_340 = NL + "    return ";
  protected final String TEXT_341 = ";" + NL + "  }" + NL + "" + NL + "  List<";
  protected final String TEXT_342 = "> ";
  protected final String TEXT_343 = "::";
  protected final String TEXT_344 = "()" + NL + "  {";
  protected final String TEXT_345 = NL + "    List<";
  protected final String TEXT_346 = "> ";
  protected final String TEXT_347 = " = Collections.unmodifiableList(";
  protected final String TEXT_348 = ");";
  protected final String TEXT_349 = NL + "    return ";
  protected final String TEXT_350 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_351 = "::";
  protected final String TEXT_352 = "()" + NL + "  {";
  protected final String TEXT_353 = NL + "    int number = ";
  protected final String TEXT_354 = ".size();";
  protected final String TEXT_355 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_356 = "::";
  protected final String TEXT_357 = "()" + NL + "  {";
  protected final String TEXT_358 = NL + "    bool has = ";
  protected final String TEXT_359 = ".size() > 0;";
  protected final String TEXT_360 = NL + "    return has;" + NL + "  }" + NL + "  " + NL + "  int ";
  protected final String TEXT_361 = "::";
  protected final String TEXT_362 = "(";
  protected final String TEXT_363 = " ";
  protected final String TEXT_364 = ")" + NL + "  {";
  protected final String TEXT_365 = NL + "    int index = ";
  protected final String TEXT_366 = ".indexOf(";
  ...
  protected final String TEXT_375 = NL + "    bool isValid = ";
  protected final String TEXT_376 = "() >= ";
  protected final String TEXT_377 = "();";
  protected final String TEXT_378 = NL + "    bool isValid = ";
  ...
  protected final String TEXT_388 = NL + "  static int ";
  protected final String TEXT_389 = "::";
  protected final String TEXT_390 = "()" + NL + "  {";
  protected final String TEXT_391 = NL + "    int required = ";
  protected final String TEXT_392 = ";";
  protected final String TEXT_393 = NL + "    return required;" + NL + "  }";
  protected final String TEXT_394 = NL + "  static int ";
  protected final String TEXT_395 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_396 = ";" + NL + "  }";
  protected final String TEXT_397 = NL + "  static int ";
  protected final String TEXT_398 = "::";
  protected final String TEXT_399 = "()" + NL + "  {";
  protected final String TEXT_400 = NL + "    int minimum = ";
  protected final String TEXT_401 = ";";
  protected final String TEXT_402 = NL + "    return minimum;" + NL + "  }";
  ...
  protected final String TEXT_410 = NL + "    int maximum = ";
  protected final String TEXT_411 = ";";
  protected final String TEXT_412 = NL + "    return maximum;" + NL + "  }";
  protected final String TEXT_413 = NL + "  bool ";
  protected final String TEXT_414 = "::";
  protected final String TEXT_415 = "(";
  protected final String TEXT_416 = " ";
  protected final String TEXT_417 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_418 = NL + "    if (";
  protected final String TEXT_419 = "() >= ";
  protected final String TEXT_420 = "())" + NL + "    {";
  protected final String TEXT_421 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_422 = NL + "    ";
  protected final String TEXT_423 = ".add(";
  protected final String TEXT_424 = ");" + NL + "    if (";
  protected final String TEXT_425 = ".";
  protected final String TEXT_426 = "(this) != -1)" + NL + "    {" + NL + "      wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasAdded = ";
  protected final String TEXT_427 = ".";
  protected final String TEXT_428 = "(this);" + NL + "      if (!wasAdded)" + NL + "      {";
  protected final String TEXT_429 = NL + "        ";
  protected final String TEXT_430 = ".remove(";
  protected final String TEXT_431 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_432 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_433 = NL + "  bool ";
  protected final String TEXT_434 = "::";
  protected final String TEXT_435 = "(";
  protected final String TEXT_436 = " ";
  protected final String TEXT_437 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_438 = NL + "    if (!";
  protected final String TEXT_439 = ".contains(";
  protected final String TEXT_440 = "))" + NL + "    {";
  protected final String TEXT_441 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_442 = ".indexOf(";
  protected final String TEXT_443 = ");";
  protected final String TEXT_444 = NL + "    ";
  protected final String TEXT_445 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_446 = ".";
  protected final String TEXT_447 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_448 = ".";
  protected final String TEXT_449 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_450 = NL + "        ";
  protected final String TEXT_451 = ".add(oldIndex,";
  protected final String TEXT_452 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_453 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_454 = NL + "  bool ";
  protected final String TEXT_455 = "::";
  protected final String TEXT_456 = "(";
  protected final String TEXT_457 = " ";
  protected final String TEXT_458 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_459 = NL + "    ";
  protected final String TEXT_460 = " = ";
  protected final String TEXT_461 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_462 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_463 = NL + "  bool ";
  protected final String TEXT_464 = "::";
  protected final String TEXT_465 = "(";
  protected final String TEXT_466 = " ";
  protected final String TEXT_467 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_468 = NL + "    if (";
  protected final String TEXT_469 = " != null)" + NL + "    {";
  protected final String TEXT_470 = NL + "      ";
  protected final String TEXT_471 = " = ";
  protected final String TEXT_472 = ";" + NL + "      wasSet = true;" + NL + "    }";
  protected final String TEXT_473 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_474 = NL + "  bool ";
  protected final String TEXT_475 = "::";
  protected final String TEXT_476 = "(";
  protected final String TEXT_477 = " ";
  protected final String TEXT_478 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_484 = "()))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_485 = ", as existing ";
  protected final String TEXT_486 = " would become an orphan";
  ...
  protected final String TEXT_496 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  protected final String TEXT_497 = "))" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_549 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_550 = "::";
  protected final String TEXT_551 = "(";
  protected final String TEXT_552 = " ";
  protected final String TEXT_553 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_573 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_574 = "::";
  protected final String TEXT_575 = "(";
  protected final String TEXT_576 = " ";
  protected final String TEXT_577 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_592 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_599 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_600 = "(";
  protected final String TEXT_601 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  ...
  protected final String TEXT_609 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_610 = NL + "    ";
  protected final String TEXT_611 = " ";
  protected final String TEXT_612 = " = ";
  protected final String TEXT_613 = ".";
  protected final String TEXT_614 = "();" + NL + "    bool ";
  protected final String TEXT_615 = " = ";
  protected final String TEXT_616 = " != null && !this.equals(";
  ...
  protected final String TEXT_626 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_627 = NL + "      ";
  protected final String TEXT_628 = ".add(";
  protected final String TEXT_629 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_630 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_631 = "::";
  protected final String TEXT_632 = "(";
  protected final String TEXT_633 = " ";
  protected final String TEXT_634 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_635 = NL + "    //Unable to remove ";
  protected final String TEXT_636 = ", as it must always have a ";
  protected final String TEXT_637 = NL + "    if (this.equals(";
  ...
  protected final String TEXT_647 = ".remove(";
  protected final String TEXT_648 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_649 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_650 = NL + "  ";
  protected final String TEXT_651 = " ";
  protected final String TEXT_652 = "::";
  protected final String TEXT_653 = "(";
  protected final String TEXT_654 = ")" + NL + "  {" + NL + "    if (";
  protected final String TEXT_655 = "() >= ";
  protected final String TEXT_656 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_657 = "(";
  protected final String TEXT_658 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_659 = "::";
  protected final String TEXT_660 = "(";
  protected final String TEXT_661 = " ";
  protected final String TEXT_662 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_663 = NL + "    if (";
  protected final String TEXT_664 = "() >= ";
  protected final String TEXT_665 = "())" + NL + "    {";
  protected final String TEXT_666 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_667 = NL + "    ";
  protected final String TEXT_668 = " ";
  protected final String TEXT_669 = " = ";
  protected final String TEXT_670 = ".";
  protected final String TEXT_671 = "();" + NL + "    bool ";
  protected final String TEXT_672 = " = ";
  protected final String TEXT_673 = " != null && !this.equals(";
  ...
  protected final String TEXT_694 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_695 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_696 = NL + "  bool ";
  protected final String TEXT_697 = "::";
  protected final String TEXT_698 = "(";
  protected final String TEXT_699 = "... ";
  protected final String TEXT_700 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_701 = NL + "    ArrayList<";
  protected final String TEXT_702 = "> ";
  protected final String TEXT_703 = " = new ArrayList<";
  protected final String TEXT_704 = ">();" + NL + "    for (";
  protected final String TEXT_705 = " ";
  protected final String TEXT_706 = " : ";
  protected final String TEXT_707 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_708 = ".contains(";
  protected final String TEXT_709 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_710 = NL + "      ";
  protected final String TEXT_711 = ".add(";
  protected final String TEXT_712 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_713 = ".size() != ";
  protected final String TEXT_714 = ".length || ";
  protected final String TEXT_715 = ".size() > ";
  protected final String TEXT_716 = "())" + NL + "    {";
  protected final String TEXT_717 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_718 = "> ";
  protected final String TEXT_719 = " = new ArrayList<";
  protected final String TEXT_720 = ">(";
  protected final String TEXT_721 = ");";
  protected final String TEXT_722 = NL + "    ";
  protected final String TEXT_723 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_730 = ".contains(";
  protected final String TEXT_731 = "))" + NL + "      {";
  protected final String TEXT_732 = NL + "        ";
  protected final String TEXT_733 = ".remove(";
  protected final String TEXT_734 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_735 = NL + "        ";
  protected final String TEXT_736 = ".";
  protected final String TEXT_737 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_744 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_745 = NL + "  ";
  protected final String TEXT_746 = " ";
  protected final String TEXT_747 = "::";
  protected final String TEXT_748 = "(";
  protected final String TEXT_749 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_750 = "(";
  protected final String TEXT_751 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_752 = "::";
  protected final String TEXT_753 = "(";
  protected final String TEXT_754 = " ";
  protected final String TEXT_755 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_756 = NL + "    ";
  protected final String TEXT_757 = " ";
  protected final String TEXT_758 = " = ";
  protected final String TEXT_759 = ".";
  protected final String TEXT_760 = "();" + NL + "    bool ";
  protected final String TEXT_761 = " = ";
  protected final String TEXT_762 = " != null && !this.equals(";
  protected final String TEXT_763 = ");" + NL + "    if (";
  protected final String TEXT_764 = ")" + NL + "    {";
  protected final String TEXT_765 = NL + "      ";
  protected final String TEXT_766 = ".";
  protected final String TEXT_767 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_768 = NL + "      ";
  protected final String TEXT_769 = ".add(";
  protected final String TEXT_770 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_771 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_772 = "::";
  protected final String TEXT_773 = "(";
  protected final String TEXT_774 = " ";
  protected final String TEXT_775 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_784 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_785 = NL + "  bool ";
  protected final String TEXT_786 = "::";
  protected final String TEXT_787 = "(";
  protected final String TEXT_788 = " ";
  protected final String TEXT_789 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_797 = " = null;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_803 = "(null);" + NL + "      }" + NL + "      wasSet = true;";
  ...
  protected final String TEXT_814 = "(null);" + NL + "    }" + NL;
  ...
  protected final String TEXT_822 = "();" + NL + "" + NL + "    if (!equals(";
  ...
  protected final String TEXT_828 = NL + "  bool ";
  protected final String TEXT_829 = "::";
  protected final String TEXT_830 = "(";
  protected final String TEXT_831 = " ";
  protected final String TEXT_832 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_833 = NL + "    if (!";
  protected final String TEXT_834 = ".contains(";
  protected final String TEXT_835 = "))" + NL + "    {";
  protected final String TEXT_836 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_837 = "() <= ";
  protected final String TEXT_838 = "())" + NL + "    {";
  protected final String TEXT_839 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_840 = ".indexOf(";
  protected final String TEXT_841 = ");";
  protected final String TEXT_842 = NL + "    ";
  protected final String TEXT_843 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_844 = ".";
  protected final String TEXT_845 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_846 = ".";
  protected final String TEXT_847 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_848 = NL + "        ";
  protected final String TEXT_849 = ".add(oldIndex,";
  protected final String TEXT_850 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_851 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_852 = NL + "  bool ";
  protected final String TEXT_853 = "::";
  protected final String TEXT_854 = "(";
  protected final String TEXT_855 = " ";
  protected final String TEXT_856 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_896 = ".equals(";
  ...
  protected final String TEXT_905 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_906 = NL + "  bool ";
  protected final String TEXT_907 = "::";
  protected final String TEXT_908 = "(";
  protected final String TEXT_909 = " ";
  protected final String TEXT_910 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_911 = NL + "    if (";
  protected final String TEXT_912 = " == null)" + NL + "    {";
  ...
  protected final String TEXT_922 = ".equals(";
  protected final String TEXT_923 = "))" + NL + "    {";
  protected final String TEXT_924 = NL + "      ";
  protected final String TEXT_925 = ".";
  protected final String TEXT_926 = "(this);" + NL + "    }";
  ...
  protected final String TEXT_936 = NL + "    //Must provide ";
  protected final String TEXT_937 = " to ";
  protected final String TEXT_938 = NL + "    if (";
  protected final String TEXT_939 = " == null)" + NL + "    {";
  protected final String TEXT_940 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_941 = " already at maximum (";
  ...
  protected final String TEXT_956 = ".equals(";
  protected final String TEXT_957 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_958 = ".";
  protected final String TEXT_959 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_967 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_977 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_992 = ".equals(";
  protected final String TEXT_993 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_994 = ".";
  protected final String TEXT_995 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1003 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1004 = NL + "  bool ";
  protected final String TEXT_1005 = "::";
  protected final String TEXT_1006 = "(";
  protected final String TEXT_1007 = " ";
  protected final String TEXT_1008 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1017 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1025 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1026 = NL + "      ";
  protected final String TEXT_1027 = ".add(";
  protected final String TEXT_1028 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1029 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1030 = "::";
  protected final String TEXT_1031 = "(";
  protected final String TEXT_1032 = " ";
  protected final String TEXT_1033 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1034 = NL + "    if (";
  protected final String TEXT_1035 = ".contains(";
  protected final String TEXT_1036 = "))" + NL + "    {";
  protected final String TEXT_1037 = NL + "      ";
  protected final String TEXT_1038 = ".remove(";
  protected final String TEXT_1039 = ");";
  protected final String TEXT_1040 = NL + "      ";
  protected final String TEXT_1041 = ".";
  protected final String TEXT_1042 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1043 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1048 = ")" + NL + "  {" + NL + "    boolwasSet = false;";
  ...
  protected final String TEXT_1066 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1067 = NL + "  bool ";
  protected final String TEXT_1068 = "::";
  protected final String TEXT_1069 = "(";
  protected final String TEXT_1070 = " ";
  protected final String TEXT_1071 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1096 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1097 = "::";
  protected final String TEXT_1098 = "(";
  protected final String TEXT_1099 = " ";
  protected final String TEXT_1100 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1110 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1120 = ".add(";
  protected final String TEXT_1121 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1122 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1123 = "::";
  protected final String TEXT_1124 = "(";
  protected final String TEXT_1125 = " ";
  protected final String TEXT_1126 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1127 = NL + "    if (!";
  protected final String TEXT_1128 = ".contains(";
  protected final String TEXT_1129 = "))" + NL + "    {";
  protected final String TEXT_1130 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1131 = "() <= ";
  protected final String TEXT_1132 = "())" + NL + "    {";
  protected final String TEXT_1133 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1134 = NL + "    ";
  protected final String TEXT_1135 = ".remove(";
  protected final String TEXT_1136 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1137 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1138 = NL + "  bool ";
  protected final String TEXT_1139 = "::";
  protected final String TEXT_1140 = "(";
  protected final String TEXT_1141 = " ";
  protected final String TEXT_1142 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1143 = NL + "    if (";
  protected final String TEXT_1144 = "() >= ";
  protected final String TEXT_1145 = "())" + NL + "    {";
  protected final String TEXT_1146 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1156 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  ...
  protected final String TEXT_1167 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1168 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1169 = "::";
  protected final String TEXT_1170 = "(";
  protected final String TEXT_1171 = " ";
  protected final String TEXT_1172 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1179 = ".remove(";
  protected final String TEXT_1180 = ");";
  protected final String TEXT_1181 = NL + "      ";
  protected final String TEXT_1182 = "(";
  protected final String TEXT_1183 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1184 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1185 = NL + "  bool ";
  protected final String TEXT_1186 = "::";
  protected final String TEXT_1187 = "(";
  protected final String TEXT_1188 = "... ";
  protected final String TEXT_1189 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1190 = NL + "    ArrayList<";
  protected final String TEXT_1191 = "> ";
  protected final String TEXT_1192 = " = new ArrayList<";
  protected final String TEXT_1193 = ">();" + NL + "    for (";
  protected final String TEXT_1194 = " ";
  protected final String TEXT_1195 = " : ";
  protected final String TEXT_1196 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1197 = ".contains(";
  protected final String TEXT_1198 = "))" + NL + "      {";
  protected final String TEXT_1199 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1200 = ".";
  protected final String TEXT_1201 = "() != null && !this.equals(";
  protected final String TEXT_1202 = ".";
  protected final String TEXT_1203 = "()))" + NL + "      {";
  protected final String TEXT_1204 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1205 = NL + "      ";
  protected final String TEXT_1206 = ".add(";
  protected final String TEXT_1207 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1208 = ".size() != ";
  protected final String TEXT_1209 = "())" + NL + "    {";
  protected final String TEXT_1210 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1211 = NL + "    ";
  protected final String TEXT_1212 = ".removeAll(";
  protected final String TEXT_1213 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1214 = " orphan : ";
  protected final String TEXT_1215 = ")" + NL + "    {";
  protected final String TEXT_1216 = NL + "      ";
  protected final String TEXT_1217 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1218 = NL + "    ";
  protected final String TEXT_1219 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1228 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1229 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1230 = NL + "  void ";
  ...
  protected final String TEXT_1236 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1237 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1238 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1239 = ", ";
  protected final String TEXT_1240 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1241 = " to ";
  protected final String TEXT_1242 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1247 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1248 = NL + "    ";
  protected final String TEXT_1249 = ".add(";
  protected final String TEXT_1250 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1251 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1252 = "::";
  protected final String TEXT_1253 = "(";
  protected final String TEXT_1254 = " ";
  protected final String TEXT_1255 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1260 = ".remove(";
  protected final String TEXT_1261 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1272 = ".add(";
  protected final String TEXT_1273 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1274 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1275 = "::";
  protected final String TEXT_1276 = "(";
  protected final String TEXT_1277 = " ";
  protected final String TEXT_1278 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1285 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1286 = NL + "  bool ";
  protected final String TEXT_1287 = "::";
  protected final String TEXT_1288 = "(";
  protected final String TEXT_1289 = " ";
  protected final String TEXT_1290 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1308 = ");" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_1314 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1315 = NL + "    ArrayList<";
  protected final String TEXT_1316 = "> ";
  protected final String TEXT_1317 = " = new ArrayList<";
  protected final String TEXT_1318 = ">();" + NL + "    for (";
  protected final String TEXT_1319 = " ";
  protected final String TEXT_1320 = " : ";
  protected final String TEXT_1321 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1322 = ".contains(";
  protected final String TEXT_1323 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1324 = NL + "      ";
  protected final String TEXT_1325 = ".add(";
  protected final String TEXT_1326 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1327 = ".size() != ";
  protected final String TEXT_1328 = ".length || ";
  ...
  protected final String TEXT_1336 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1337 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1342 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1343 = NL + "    ArrayList<";
  protected final String TEXT_1344 = "> ";
  protected final String TEXT_1345 = " = new ArrayList<";
  protected final String TEXT_1346 = ">();" + NL + "    for (";
  protected final String TEXT_1347 = " ";
  protected final String TEXT_1348 = " : ";
  protected final String TEXT_1349 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1350 = ".contains(";
  protected final String TEXT_1351 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1356 = ".length || ";
  ...
  protected final String TEXT_1361 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_1362 = "> ";
  protected final String TEXT_1363 = " = new ArrayList<";
  ...
  protected final String TEXT_1374 = ".contains(";
  protected final String TEXT_1375 = "))" + NL + "      {";
  protected final String TEXT_1376 = NL + "        ";
  protected final String TEXT_1377 = ".remove(";
  protected final String TEXT_1378 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1379 = NL + "        ";
  protected final String TEXT_1380 = ".";
  protected final String TEXT_1381 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1387 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1388 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1421 = ".add(";
  ...
  protected final String TEXT_1427 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1428 = NL + "        ";
  protected final String TEXT_1429 = ".";
  protected final String TEXT_1430 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1436 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1437 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1438 = NL + "  bool ";
  protected final String TEXT_1439 = "::";
  protected final String TEXT_1440 = "(";
  protected final String TEXT_1441 = "... ";
  protected final String TEXT_1442 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1443 = NL + "    ArrayList<";
  protected final String TEXT_1444 = "> ";
  protected final String TEXT_1445 = " = new ArrayList<";
  protected final String TEXT_1446 = ">();" + NL + "    for (";
  protected final String TEXT_1447 = " ";
  protected final String TEXT_1448 = " : ";
  protected final String TEXT_1449 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1450 = ".contains(";
  protected final String TEXT_1451 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1452 = NL + "      ";
  protected final String TEXT_1453 = ".add(";
  protected final String TEXT_1454 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1455 = ".size() != ";
  protected final String TEXT_1456 = ".length || ";
  ...
  protected final String TEXT_1463 = ".clear();";
  protected final String TEXT_1464 = NL + "    ";
  protected final String TEXT_1465 = ".addAll(";
  protected final String TEXT_1466 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1467 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1468 = NL + "  bool ";
  protected final String TEXT_1469 = "::";
  protected final String TEXT_1470 = "(";
  protected final String TEXT_1471 = "... ";
  protected final String TEXT_1472 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1473 = NL + "    if (";
  protected final String TEXT_1474 = ".length < ";
  protected final String TEXT_1475 = "()";
  protected final String TEXT_1476 = ")" + NL + "    {";
  protected final String TEXT_1477 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_1478 = "> ";
  protected final String TEXT_1479 = " = new ArrayList<";
  protected final String TEXT_1480 = ">();" + NL + "    HashMap<";
  protected final String TEXT_1481 = ",Integer> ";
  protected final String TEXT_1482 = " = new HashMap<";
  protected final String TEXT_1483 = ",Integer>();" + NL + "    for (";
  ...
  protected final String TEXT_1489 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1490 = ".";
  protected final String TEXT_1491 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1498 = "();" + NL + "        if (!";
  protected final String TEXT_1499 = ".containsKey(";
  protected final String TEXT_1500 = "))" + NL + "        {";
  protected final String TEXT_1501 = NL + "          ";
  protected final String TEXT_1502 = ".put(";
  protected final String TEXT_1503 = ", new Integer(";
  protected final String TEXT_1504 = ".";
  protected final String TEXT_1505 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1506 = ".get(";
  protected final String TEXT_1507 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  ...
  protected final String TEXT_1511 = ".put(";
  protected final String TEXT_1512 = ", new Integer(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1517 = ".removeAll(";
  protected final String TEXT_1518 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1519 = " orphan : ";
  protected final String TEXT_1520 = ")" + NL + "    {";
  protected final String TEXT_1521 = NL + "      ";
  protected final String TEXT_1522 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1523 = NL + "    ";
  protected final String TEXT_1524 = ".clear();" + NL + "    for (";
  protected final String TEXT_1525 = " ";
  protected final String TEXT_1526 = " : ";
  protected final String TEXT_1527 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1528 = ".";
  protected final String TEXT_1529 = "() != null)" + NL + "      {";
  ...
  protected final String TEXT_1539 = ".add(";
  protected final String TEXT_1540 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1541 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1542 = NL + "  void ";
  ...
  protected final String TEXT_1548 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1549 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1550 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1551 = ", ";
  protected final String TEXT_1552 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1553 = " to ";
  protected final String TEXT_1554 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1555 = NL + "  bool ";
  protected final String TEXT_1556 = "::";
  protected final String TEXT_1557 = "(";
  protected final String TEXT_1558 = "... ";
  protected final String TEXT_1559 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1560 = NL + "    ArrayList<";
  protected final String TEXT_1561 = "> ";
  protected final String TEXT_1562 = " = new ArrayList<";
  protected final String TEXT_1563 = ">();" + NL + "    for (";
  protected final String TEXT_1564 = " ";
  protected final String TEXT_1565 = " : ";
  protected final String TEXT_1566 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1567 = ".contains(";
  protected final String TEXT_1568 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1569 = NL + "      ";
  protected final String TEXT_1570 = ".add(";
  protected final String TEXT_1571 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1572 = ".size() != ";
  protected final String TEXT_1573 = ".length || ";
  protected final String TEXT_1574 = ".size() > ";
  protected final String TEXT_1575 = "())" + NL + "    {";
  protected final String TEXT_1576 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1577 = NL + "    ";
  protected final String TEXT_1578 = ".clear();";
  protected final String TEXT_1579 = NL + "    ";
  protected final String TEXT_1580 = ".addAll(";
  protected final String TEXT_1581 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1582 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1587 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1588 = NL + "    ArrayList<";
  protected final String TEXT_1589 = "> ";
  protected final String TEXT_1590 = " = new ArrayList<";
  protected final String TEXT_1591 = ">();" + NL + "    for (";
  protected final String TEXT_1592 = " ";
  protected final String TEXT_1593 = " : ";
  protected final String TEXT_1594 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1595 = ".contains(";
  protected final String TEXT_1596 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1597 = NL + "      ";
  protected final String TEXT_1598 = ".add(";
  protected final String TEXT_1599 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1600 = ".size() != ";
  protected final String TEXT_1601 = ".length || ";
  protected final String TEXT_1602 = ".size() < ";
  protected final String TEXT_1603 = "())" + NL + "    {";
  protected final String TEXT_1604 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1605 = NL + "    ";
  protected final String TEXT_1606 = ".clear();";
  protected final String TEXT_1607 = NL + "    ";
  protected final String TEXT_1608 = ".addAll(";
  protected final String TEXT_1609 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1610 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1611 = NL + "  public boolean equals(Object obj)" + NL + "  {" + NL + "    if (obj == null) { return false; }" + NL + "    if (!getClass().equals(obj.getClass())) { return false; }" + NL;
  protected final String TEXT_1612 = NL + "    ";
  protected final String TEXT_1613 = " compareTo = (";
  protected final String TEXT_1614 = ")obj;" + NL + "  ";
  protected final String TEXT_1615 = NL + "    ";
  protected final String TEXT_1616 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1617 = NL + "    ";
  protected final String TEXT_1618 = NL;
  protected final String TEXT_1619 = NL + "    ";
  protected final String TEXT_1620 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1621 = NL + "  private void ";
  protected final String TEXT_1622 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1623 = NL + "       ";
  protected final String TEXT_1624 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1625 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1626 = NL + "    ";
  protected final String TEXT_1627 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1628 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  ...
  protected final String TEXT_1634 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1635 = "\",";
  protected final String TEXT_1636 = ");" + NL + "  }" + NL + "" + NL + "  private void ";
  protected final String TEXT_1637 = "()" + NL + "  {";
  protected final String TEXT_1638 = NL + "    ";
  protected final String TEXT_1639 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1640 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1641 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1642 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void run ()" + NL + "    {";
  protected final String TEXT_1643 = NL + "      if (\"";
  protected final String TEXT_1644 = "\".equals(timeoutMethodName))" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1645 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1646 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1647 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1648 = NL + "    ";
  protected final String TEXT_1649 = " = null;";
  protected final String TEXT_1650 = NL + "    ";
  protected final String TEXT_1651 = ".clear();";
  ...
  protected final String TEXT_1657 = " = null;" + NL + "    if (";
  protected final String TEXT_1658 = " != null)" + NL + "    {";
  protected final String TEXT_1659 = NL + "      ";
  protected final String TEXT_1660 = ".delete();" + NL + "    }";
  ...
  protected final String TEXT_1684 = ".delete();" + NL + "    }";
  ...
  protected final String TEXT_1730 = ".clear();";
  ...
  protected final String TEXT_1737 = ".clear();" + NL + "    for(";
  protected final String TEXT_1738 = " ";
  protected final String TEXT_1739 = " : ";
  protected final String TEXT_1740 = ")" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1746 = ".delete();" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1747 = NL + "        ";
  protected final String TEXT_1748 = ".";
  protected final String TEXT_1749 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1750 = NL + "    ArrayList<";
  protected final String TEXT_1751 = "> ";
  protected final String TEXT_1752 = " = new ArrayList<";
  ...
  protected final String TEXT_1762 = "(this);" + NL + "    }";
  protected final String TEXT_1763 = NL + "    for(";
  ...
  protected final String TEXT_1768 = ".delete();" + NL + "    }";
  ...
  protected final String TEXT_1776 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
