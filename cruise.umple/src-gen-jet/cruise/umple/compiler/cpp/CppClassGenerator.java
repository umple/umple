...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_283 = "()" + NL + "  {" + NL + "    String answer = ";
  protected final String TEXT_284 = ".toString();";
  protected final String TEXT_285 = NL + "    return answer;" + NL + "  }" + NL;
  ...
  protected final String TEXT_293 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;" + NL;
  protected final String TEXT_294 = NL + "    ";
  protected final String TEXT_295 = NL + NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  ...
  protected final String TEXT_303 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_304 = NL + "  private void ";
  protected final String TEXT_305 = "::";
  protected final String TEXT_306 = "()" + NL + "  {" + NL + "    switch(";
  ...
  protected final String TEXT_328 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_336 = "() const" + NL + "  {";
  ...
  protected final String TEXT_349 = "(int index) const" + NL + "  {";
  protected final String TEXT_350 = NL + "    ";
  protected final String TEXT_351 = " ";
  protected final String TEXT_352 = " = ";
  protected final String TEXT_353 = ".get(index);";
  protected final String TEXT_354 = NL + "    return ";
  protected final String TEXT_355 = ";" + NL + "  }" + NL + "" + NL + "  vector<";
  protected final String TEXT_356 = "*> ";
  protected final String TEXT_357 = "::";
  protected final String TEXT_358 = "() const" + NL + "  {";
  protected final String TEXT_359 = NL + "    vector<";
  protected final String TEXT_360 = "*> ";
  protected final String TEXT_361 = " = ";
  protected final String TEXT_362 = ";";
  protected final String TEXT_363 = NL + "    return ";
  protected final String TEXT_364 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_365 = "::";
  protected final String TEXT_366 = "()" + NL + "  {";
  protected final String TEXT_367 = NL + "    int number = ";
  protected final String TEXT_368 = ".size();";
  protected final String TEXT_369 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_370 = "::";
  protected final String TEXT_371 = "()" + NL + "  {";
  protected final String TEXT_372 = NL + "    bool has = ";
  protected final String TEXT_373 = ".size() > 0;";
  protected final String TEXT_374 = NL + "    return has;" + NL + "  }" + NL + "  " + NL + "  int ";
  protected final String TEXT_375 = "::";
  protected final String TEXT_376 = "(";
  protected final String TEXT_377 = " ";
  protected final String TEXT_378 = ")" + NL + "  {";
  protected final String TEXT_379 = NL + "    int index = std::find(";
  protected final String TEXT_380 = ".begin(), ";
  protected final String TEXT_381 = ".end(), ";
  protected final String TEXT_382 = ") - ";
  protected final String TEXT_383 = ".begin();";
  protected final String TEXT_384 = NL + "    return index;" + NL + "  }" + NL + "  ";
  protected final String TEXT_385 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_386 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_387 = " : ";
  protected final String TEXT_388 = NL + "  bool ";
  protected final String TEXT_389 = "::";
  protected final String TEXT_390 = "()" + NL + "  {";
  protected final String TEXT_391 = NL + "    bool isValid = ";
  protected final String TEXT_392 = "() >= ";
  protected final String TEXT_393 = "();";
  protected final String TEXT_394 = NL + "    bool isValid = ";
  protected final String TEXT_395 = "() >= ";
  protected final String TEXT_396 = "() && ";
  protected final String TEXT_397 = "() <= ";
  protected final String TEXT_398 = "();";
  protected final String TEXT_399 = NL + "    return isValid;" + NL + "  }";
  ...
  protected final String TEXT_407 = NL + "    int required = ";
  protected final String TEXT_408 = ";";
  protected final String TEXT_409 = NL + "    return required;" + NL + "  }";
  ...
  protected final String TEXT_416 = NL + "    int minimum = ";
  protected final String TEXT_417 = ";";
  protected final String TEXT_418 = NL + "    return minimum;" + NL + "  }";
  ...
  protected final String TEXT_426 = NL + "    int maximum = ";
  protected final String TEXT_427 = ";";
  protected final String TEXT_428 = NL + "    return maximum;" + NL + "  }";
  protected final String TEXT_429 = NL + "  bool ";
  protected final String TEXT_430 = "::";
  protected final String TEXT_431 = "(";
  protected final String TEXT_432 = " ";
  protected final String TEXT_433 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_453 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_454 = NL + "    if (!";
  protected final String TEXT_455 = ".contains(";
  protected final String TEXT_456 = "))" + NL + "    {";
  protected final String TEXT_457 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_458 = ".indexOf(";
  protected final String TEXT_459 = ");";
  protected final String TEXT_460 = NL + "    ";
  protected final String TEXT_461 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_462 = ".";
  protected final String TEXT_463 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_464 = ".";
  protected final String TEXT_465 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_466 = NL + "        ";
  protected final String TEXT_467 = ".add(oldIndex,";
  protected final String TEXT_468 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_469 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_477 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_478 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_479 = NL + "  bool ";
  protected final String TEXT_480 = "::";
  protected final String TEXT_481 = "(";
  protected final String TEXT_482 = "* ";
  protected final String TEXT_483 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_484 = NL + "    if (";
  protected final String TEXT_485 = " != null)" + NL + "    {";
  protected final String TEXT_486 = NL + "      ";
  protected final String TEXT_487 = " = ";
  protected final String TEXT_488 = ";" + NL + "      wasSet = true;" + NL + "    }";
  protected final String TEXT_489 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_497 = ".equals(";
  protected final String TEXT_498 = ") && equals(";
  protected final String TEXT_499 = ".";
  protected final String TEXT_500 = "()))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_501 = ", as existing ";
  protected final String TEXT_502 = " would become an orphan";
  ...
  protected final String TEXT_512 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  ...
  protected final String TEXT_521 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_522 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_523 = NL + "  bool ";
  protected final String TEXT_524 = "::";
  protected final String TEXT_525 = "(";
  protected final String TEXT_526 = " ";
  protected final String TEXT_527 = ")" + NL + "  {" + NL + "    bool";
  protected final String TEXT_528 = NL + "    if (";
  protected final String TEXT_529 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_530 = " to null, as ";
  protected final String TEXT_531 = " must always be associated to a ";
  ...
  protected final String TEXT_538 = " != null && !equals(";
  protected final String TEXT_539 = "))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_540 = ", the current ";
  protected final String TEXT_541 = " already has a ";
  protected final String TEXT_542 = ", which would be orphaned if it were re-assigned";
  protected final String TEXT_543 = NL + "      return wasSet;" + NL + "    }" + NL + "    ";
  ...
  protected final String TEXT_553 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_554 = " != null)" + NL + "    {";
  protected final String TEXT_555 = NL + "      ";
  protected final String TEXT_556 = ".";
  protected final String TEXT_557 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_558 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_559 = NL + "  ";
  protected final String TEXT_560 = " ";
  protected final String TEXT_561 = "::";
  protected final String TEXT_562 = "(";
  protected final String TEXT_563 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_564 = "(";
  protected final String TEXT_565 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_566 = "::";
  protected final String TEXT_567 = "(";
  protected final String TEXT_568 = " ";
  protected final String TEXT_569 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_576 = " != null && !this.equals(";
  ...
  protected final String TEXT_585 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_586 = NL + "      ";
  protected final String TEXT_587 = ".add(";
  protected final String TEXT_588 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_589 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_590 = "::";
  protected final String TEXT_591 = "(";
  protected final String TEXT_592 = " ";
  protected final String TEXT_593 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_594 = NL + "    //Unable to remove ";
  protected final String TEXT_595 = ", as it must always have a ";
  protected final String TEXT_596 = NL + "    if (this.equals(";
  protected final String TEXT_597 = ".";
  protected final String TEXT_598 = "()))" + NL + "    {";
  protected final String TEXT_599 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_600 = " already at minimum (";
  ...
  protected final String TEXT_606 = ".remove(";
  protected final String TEXT_607 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_608 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_615 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_616 = "(";
  protected final String TEXT_617 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  ...
  protected final String TEXT_625 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_632 = " != null && !this.equals(";
  protected final String TEXT_633 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_634 = " && ";
  protected final String TEXT_635 = ".";
  protected final String TEXT_636 = "() <= ";
  protected final String TEXT_637 = "())" + NL + "    {";
  protected final String TEXT_638 = NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_646 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_647 = "::";
  protected final String TEXT_648 = "(";
  protected final String TEXT_649 = " ";
  protected final String TEXT_650 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_656 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_657 = " already at minimum (";
  protected final String TEXT_658 = ")" + NL + "    if (";
  protected final String TEXT_659 = "() <= ";
  protected final String TEXT_660 = "())" + NL + "    {";
  protected final String TEXT_661 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_662 = NL + "    ";
  protected final String TEXT_663 = ".remove(";
  protected final String TEXT_664 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_665 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_672 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_673 = "(";
  protected final String TEXT_674 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_675 = "::";
  protected final String TEXT_676 = "(";
  protected final String TEXT_677 = " ";
  protected final String TEXT_678 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_687 = "();" + NL + "    bool ";
  ...
  protected final String TEXT_702 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_711 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_712 = NL + "  bool ";
  protected final String TEXT_713 = "::";
  protected final String TEXT_714 = "(";
  protected final String TEXT_715 = "... ";
  protected final String TEXT_716 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_717 = NL + "    vector<";
  protected final String TEXT_718 = "*> ";
  protected final String TEXT_719 = " = new vector<";
  protected final String TEXT_720 = "*>();" + NL + "    for (";
  protected final String TEXT_721 = " ";
  protected final String TEXT_722 = " : ";
  protected final String TEXT_723 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_724 = ".contains(";
  protected final String TEXT_725 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_726 = NL + "      ";
  protected final String TEXT_727 = ".add(";
  protected final String TEXT_728 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_729 = ".size() != ";
  protected final String TEXT_730 = ".length || ";
  protected final String TEXT_731 = ".size() > ";
  protected final String TEXT_732 = "())" + NL + "    {";
  protected final String TEXT_733 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_734 = "*> ";
  protected final String TEXT_735 = " = new vector<";
  protected final String TEXT_736 = "*>(";
  protected final String TEXT_737 = ");";
  protected final String TEXT_738 = NL + "    ";
  protected final String TEXT_739 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_746 = ".contains(";
  protected final String TEXT_747 = "))" + NL + "      {";
  protected final String TEXT_748 = NL + "        ";
  protected final String TEXT_749 = ".remove(";
  protected final String TEXT_750 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_751 = NL + "        ";
  protected final String TEXT_752 = ".";
  protected final String TEXT_753 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_754 = " ";
  protected final String TEXT_755 = " : ";
  protected final String TEXT_756 = ")" + NL + "    {";
  protected final String TEXT_757 = NL + "      ";
  protected final String TEXT_758 = ".";
  protected final String TEXT_759 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_760 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_761 = NL + "  ";
  protected final String TEXT_762 = " ";
  protected final String TEXT_763 = "::";
  protected final String TEXT_764 = "(";
  protected final String TEXT_765 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_766 = "(";
  protected final String TEXT_767 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_768 = "::";
  protected final String TEXT_769 = "(";
  protected final String TEXT_770 = " ";
  protected final String TEXT_771 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_772 = NL + "    ";
  protected final String TEXT_773 = " ";
  protected final String TEXT_774 = " = ";
  protected final String TEXT_775 = ".";
  protected final String TEXT_776 = "();" + NL + "    bool ";
  protected final String TEXT_777 = " = ";
  protected final String TEXT_778 = " != null && !this.equals(";
  ...
  protected final String TEXT_786 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_787 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_788 = "::";
  protected final String TEXT_789 = "(";
  protected final String TEXT_790 = " ";
  protected final String TEXT_791 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_799 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_800 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_801 = NL + "  bool ";
  protected final String TEXT_802 = "::";
  protected final String TEXT_803 = "(";
  protected final String TEXT_804 = "* ";
  protected final String TEXT_805 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_813 = " = null;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_838 = "();" + NL + "" + NL + "    if (!equals(";
  protected final String TEXT_839 = "))" + NL + "    {";
  protected final String TEXT_840 = NL + "      ";
  protected final String TEXT_841 = ".";
  protected final String TEXT_842 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_843 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_844 = NL + "  bool ";
  protected final String TEXT_845 = "::";
  protected final String TEXT_846 = "(";
  protected final String TEXT_847 = " ";
  protected final String TEXT_848 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_849 = NL + "    if (!";
  protected final String TEXT_850 = ".contains(";
  protected final String TEXT_851 = "))" + NL + "    {";
  protected final String TEXT_852 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_853 = "() <= ";
  protected final String TEXT_854 = "())" + NL + "    {";
  protected final String TEXT_855 = NL + "      return wasRemoved;" + NL + "    }" + NL + "\t" + NL + "    int oldIndex = std::find(";
  ...
  protected final String TEXT_861 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_862 = ".";
  protected final String TEXT_863 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_864 = ".";
  protected final String TEXT_865 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_866 = NL + "        ";
  protected final String TEXT_867 = ".add(oldIndex,";
  protected final String TEXT_868 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_869 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_870 = NL + "  bool ";
  protected final String TEXT_871 = "::";
  protected final String TEXT_872 = "(";
  protected final String TEXT_873 = " ";
  protected final String TEXT_874 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_875 = NL + "    if (!";
  protected final String TEXT_876 = ".contains(";
  protected final String TEXT_877 = "))" + NL + "    {";
  protected final String TEXT_878 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_879 = "() <= ";
  protected final String TEXT_880 = "())" + NL + "    {";
  protected final String TEXT_881 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = std::find(";
  protected final String TEXT_882 = ".begin(), ";
  protected final String TEXT_883 = ".end(), ";
  protected final String TEXT_884 = ") - ";
  protected final String TEXT_885 = ".begin();";
  protected final String TEXT_886 = NL + "    ";
  protected final String TEXT_887 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_888 = ".";
  protected final String TEXT_889 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_890 = ".";
  protected final String TEXT_891 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_892 = NL + "        ";
  protected final String TEXT_893 = ".add(oldIndex,";
  protected final String TEXT_894 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_895 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_896 = NL + "  bool ";
  protected final String TEXT_897 = "::";
  protected final String TEXT_898 = "(";
  protected final String TEXT_899 = "* ";
  protected final String TEXT_900 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_920 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_921 = " != null)" + NL + "    {";
  protected final String TEXT_922 = NL + "      ";
  protected final String TEXT_923 = ".";
  protected final String TEXT_924 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_925 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_926 = NL + "  bool ";
  protected final String TEXT_927 = "::";
  protected final String TEXT_928 = "(";
  protected final String TEXT_929 = " ";
  protected final String TEXT_930 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_951 = NL + "  bool ";
  protected final String TEXT_952 = "::";
  protected final String TEXT_953 = "(";
  protected final String TEXT_954 = " ";
  protected final String TEXT_955 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_977 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  ...
  protected final String TEXT_987 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_993 = NL + "    //Must provide ";
  protected final String TEXT_994 = " to ";
  protected final String TEXT_995 = NL + "    if (";
  protected final String TEXT_996 = " == null)" + NL + "    {";
  protected final String TEXT_997 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1028 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1029 = NL + "    ";
  protected final String TEXT_1030 = " ";
  protected final String TEXT_1031 = " = ";
  protected final String TEXT_1032 = ".";
  protected final String TEXT_1033 = "();" + NL + "    if (";
  protected final String TEXT_1034 = " == null)" + NL + "    {";
  protected final String TEXT_1035 = NL + "      ";
  protected final String TEXT_1036 = ".";
  protected final String TEXT_1037 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1045 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1046 = NL + "      ";
  protected final String TEXT_1047 = ".add(";
  protected final String TEXT_1048 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1049 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1050 = "::";
  protected final String TEXT_1051 = "(";
  protected final String TEXT_1052 = " ";
  protected final String TEXT_1053 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1054 = NL + "    if (";
  protected final String TEXT_1055 = ".contains(";
  protected final String TEXT_1056 = "))" + NL + "    {";
  protected final String TEXT_1057 = NL + "      ";
  protected final String TEXT_1058 = ".remove(";
  protected final String TEXT_1059 = ");";
  protected final String TEXT_1060 = NL + "      ";
  protected final String TEXT_1061 = ".";
  protected final String TEXT_1062 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1063 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1064 = NL + "  bool ";
  protected final String TEXT_1065 = "::";
  protected final String TEXT_1066 = "(";
  protected final String TEXT_1067 = "* ";
  protected final String TEXT_1068 = ")" + NL + "  {" + NL + "    boolwasSet = false;";
  ...
  protected final String TEXT_1077 = ".equals(";
  protected final String TEXT_1078 = "))" + NL + "    {";
  protected final String TEXT_1079 = NL + "      ";
  protected final String TEXT_1080 = ".";
  protected final String TEXT_1081 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1082 = " != null)" + NL + "    {";
  protected final String TEXT_1083 = NL + "      ";
  protected final String TEXT_1084 = ".";
  protected final String TEXT_1085 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1086 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1087 = NL + "  bool ";
  protected final String TEXT_1088 = "::";
  protected final String TEXT_1089 = "(";
  protected final String TEXT_1090 = " ";
  protected final String TEXT_1091 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1092 = NL + "    if (";
  protected final String TEXT_1093 = "() >= ";
  protected final String TEXT_1094 = "())" + NL + "    {";
  protected final String TEXT_1095 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1104 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1112 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1113 = NL + "      ";
  protected final String TEXT_1114 = ".add(";
  protected final String TEXT_1115 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1116 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1117 = "::";
  protected final String TEXT_1118 = "(";
  protected final String TEXT_1119 = " ";
  protected final String TEXT_1120 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1121 = NL + "    if (";
  protected final String TEXT_1122 = ".contains(";
  protected final String TEXT_1123 = "))" + NL + "    {";
  protected final String TEXT_1124 = NL + "      ";
  protected final String TEXT_1125 = ".remove(";
  protected final String TEXT_1126 = ");";
  protected final String TEXT_1127 = NL + "      ";
  protected final String TEXT_1128 = ".";
  protected final String TEXT_1129 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1130 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1140 = ".add(";
  protected final String TEXT_1141 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1142 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1143 = "::";
  protected final String TEXT_1144 = "(";
  protected final String TEXT_1145 = " ";
  protected final String TEXT_1146 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1147 = NL + "    if (!";
  protected final String TEXT_1148 = ".contains(";
  protected final String TEXT_1149 = "))" + NL + "    {";
  protected final String TEXT_1150 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1155 = ".remove(";
  protected final String TEXT_1156 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1157 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1158 = NL + "  bool ";
  protected final String TEXT_1159 = "::";
  protected final String TEXT_1160 = "(";
  protected final String TEXT_1161 = " ";
  protected final String TEXT_1162 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1163 = NL + "    if (";
  protected final String TEXT_1164 = "() >= ";
  protected final String TEXT_1165 = "())" + NL + "    {";
  protected final String TEXT_1166 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1176 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1177 = " != null)" + NL + "    {";
  protected final String TEXT_1178 = NL + "      ";
  protected final String TEXT_1179 = ".";
  protected final String TEXT_1180 = ".remove(";
  protected final String TEXT_1181 = ");" + NL + "    }";
  protected final String TEXT_1182 = NL + "    ";
  protected final String TEXT_1183 = ".add(";
  protected final String TEXT_1184 = ");";
  protected final String TEXT_1185 = NL + "    ";
  protected final String TEXT_1186 = "(";
  protected final String TEXT_1187 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1188 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1189 = "::";
  protected final String TEXT_1190 = "(";
  protected final String TEXT_1191 = " ";
  protected final String TEXT_1192 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1193 = NL + "    if (";
  protected final String TEXT_1194 = ".contains(";
  ...
  protected final String TEXT_1203 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1204 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1205 = NL + "  bool ";
  protected final String TEXT_1206 = "::";
  protected final String TEXT_1207 = "(";
  protected final String TEXT_1208 = "... ";
  protected final String TEXT_1209 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1210 = NL + "    vector<";
  protected final String TEXT_1211 = "*> ";
  protected final String TEXT_1212 = " = new vector<";
  protected final String TEXT_1213 = "*>();" + NL + "    for (";
  protected final String TEXT_1214 = " ";
  protected final String TEXT_1215 = " : ";
  protected final String TEXT_1216 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1217 = ".contains(";
  protected final String TEXT_1218 = "))" + NL + "      {";
  protected final String TEXT_1219 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1220 = ".";
  protected final String TEXT_1221 = "() != null && !this.equals(";
  protected final String TEXT_1222 = ".";
  protected final String TEXT_1223 = "()))" + NL + "      {";
  protected final String TEXT_1224 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1225 = NL + "      ";
  protected final String TEXT_1226 = ".add(";
  protected final String TEXT_1227 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1228 = ".size() != ";
  ...
  protected final String TEXT_1232 = ".removeAll(";
  protected final String TEXT_1233 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1234 = " orphan : ";
  protected final String TEXT_1235 = ")" + NL + "    {";
  protected final String TEXT_1236 = NL + "      ";
  protected final String TEXT_1237 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1238 = NL + "    ";
  protected final String TEXT_1239 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1245 = ", this);";
  protected final String TEXT_1246 = NL + "      ";
  protected final String TEXT_1247 = ".add(";
  protected final String TEXT_1248 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1249 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1250 = NL + "  void ";
  ...
  protected final String TEXT_1256 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1257 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1258 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1259 = ", ";
  protected final String TEXT_1260 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1261 = " to ";
  protected final String TEXT_1262 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1271 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1272 = "::";
  protected final String TEXT_1273 = "(";
  protected final String TEXT_1274 = " ";
  protected final String TEXT_1275 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1276 = NL + "    if (";
  protected final String TEXT_1277 = ".contains(";
  protected final String TEXT_1278 = "))" + NL + "    {";
  protected final String TEXT_1279 = NL + "      ";
  protected final String TEXT_1280 = ".remove(";
  protected final String TEXT_1281 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1282 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1292 = ".add(";
  protected final String TEXT_1293 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1294 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1295 = "::";
  protected final String TEXT_1296 = "(";
  protected final String TEXT_1297 = " ";
  protected final String TEXT_1298 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1322 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1323 = "() <= ";
  protected final String TEXT_1324 = "())" + NL + "    {";
  protected final String TEXT_1325 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1326 = NL + "    ";
  protected final String TEXT_1327 = ".remove(";
  protected final String TEXT_1328 = ");" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_1337 = " = new vector<";
  ...
  protected final String TEXT_1343 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1344 = NL + "      ";
  protected final String TEXT_1345 = ".add(";
  protected final String TEXT_1346 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1353 = ".clear();";
  protected final String TEXT_1354 = NL + "    ";
  protected final String TEXT_1355 = ".addAll(";
  protected final String TEXT_1356 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1357 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1358 = NL + "  bool ";
  protected final String TEXT_1359 = "::";
  protected final String TEXT_1360 = "(";
  protected final String TEXT_1361 = "... ";
  protected final String TEXT_1362 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1363 = NL + "    vector<";
  protected final String TEXT_1364 = "*> ";
  protected final String TEXT_1365 = " = new vector<";
  ...
  protected final String TEXT_1381 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  ...
  protected final String TEXT_1387 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1393 = ");" + NL + "      if (";
  protected final String TEXT_1394 = ".contains(";
  protected final String TEXT_1395 = "))" + NL + "      {";
  protected final String TEXT_1396 = NL + "        ";
  protected final String TEXT_1397 = ".remove(";
  protected final String TEXT_1398 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1399 = NL + "        ";
  protected final String TEXT_1400 = ".";
  protected final String TEXT_1401 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1407 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1408 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1413 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1414 = NL + "    vector<";
  protected final String TEXT_1415 = "*> ";
  protected final String TEXT_1416 = " = new vector<";
  protected final String TEXT_1417 = "*>();" + NL + "    for (";
  protected final String TEXT_1418 = " ";
  protected final String TEXT_1419 = " : ";
  protected final String TEXT_1420 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1421 = ".contains(";
  protected final String TEXT_1422 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1423 = NL + "      ";
  protected final String TEXT_1424 = ".add(";
  protected final String TEXT_1425 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1426 = ".size() != ";
  protected final String TEXT_1427 = ".length || ";
  protected final String TEXT_1428 = ".size() < ";
  protected final String TEXT_1429 = "())" + NL + "    {";
  protected final String TEXT_1430 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1431 = "*> ";
  protected final String TEXT_1432 = " = new vector<";
  protected final String TEXT_1433 = "*>(";
  protected final String TEXT_1434 = ");";
  protected final String TEXT_1435 = NL + "    ";
  protected final String TEXT_1436 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1446 = ".remove(";
  protected final String TEXT_1447 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1448 = NL + "        ";
  protected final String TEXT_1449 = ".";
  protected final String TEXT_1450 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1456 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1457 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1458 = NL + "  bool ";
  protected final String TEXT_1459 = "::";
  protected final String TEXT_1460 = "(";
  protected final String TEXT_1461 = "... ";
  protected final String TEXT_1462 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1463 = NL + "    vector<";
  protected final String TEXT_1464 = "*> ";
  protected final String TEXT_1465 = " = new vector<";
  protected final String TEXT_1466 = "*>();" + NL + "    for (";
  protected final String TEXT_1467 = " ";
  protected final String TEXT_1468 = " : ";
  protected final String TEXT_1469 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1470 = ".contains(";
  protected final String TEXT_1471 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1472 = NL + "      ";
  protected final String TEXT_1473 = ".add(";
  protected final String TEXT_1474 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1475 = ".size() != ";
  protected final String TEXT_1476 = ".length || ";
  ...
  protected final String TEXT_1487 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1488 = NL + "  bool ";
  protected final String TEXT_1489 = "::";
  protected final String TEXT_1490 = "(";
  protected final String TEXT_1491 = "... ";
  protected final String TEXT_1492 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1497 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1498 = "*> ";
  protected final String TEXT_1499 = " = new vector<";
  protected final String TEXT_1500 = "*>();" + NL + "    HashMap<";
  protected final String TEXT_1501 = ",Integer> ";
  protected final String TEXT_1502 = " = new HashMap<";
  protected final String TEXT_1503 = ",Integer>();" + NL + "    for (";
  ...
  protected final String TEXT_1509 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1510 = ".";
  protected final String TEXT_1511 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1518 = "();" + NL + "        if (!";
  protected final String TEXT_1519 = ".containsKey(";
  protected final String TEXT_1520 = "))" + NL + "        {";
  protected final String TEXT_1521 = NL + "          ";
  protected final String TEXT_1522 = ".put(";
  protected final String TEXT_1523 = ", new Integer(";
  protected final String TEXT_1524 = ".";
  protected final String TEXT_1525 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1526 = ".get(";
  protected final String TEXT_1527 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1528 = ")" + NL + "        {";
  protected final String TEXT_1529 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1530 = NL + "        ";
  protected final String TEXT_1531 = ".put(";
  protected final String TEXT_1532 = ", new Integer(nextCount));" + NL + "      }";
  protected final String TEXT_1533 = NL + "      ";
  protected final String TEXT_1534 = ".add(";
  protected final String TEXT_1535 = ");" + NL + "    }" + NL;
  protected final String TEXT_1536 = NL + "    ";
  protected final String TEXT_1537 = ".removeAll(";
  protected final String TEXT_1538 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1539 = " orphan : ";
  protected final String TEXT_1540 = ")" + NL + "    {";
  protected final String TEXT_1541 = NL + "      ";
  protected final String TEXT_1542 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1543 = NL + "    ";
  protected final String TEXT_1544 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1553 = ".remove(";
  ...
  protected final String TEXT_1560 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1561 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1562 = NL + "  void ";
  ...
  protected final String TEXT_1568 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1569 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1570 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1571 = ", ";
  protected final String TEXT_1572 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1573 = " to ";
  protected final String TEXT_1574 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1575 = NL + "  bool ";
  protected final String TEXT_1576 = "::";
  protected final String TEXT_1577 = "(";
  protected final String TEXT_1578 = "... ";
  protected final String TEXT_1579 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1580 = NL + "    vector<";
  protected final String TEXT_1581 = "*> ";
  protected final String TEXT_1582 = " = new vector<";
  protected final String TEXT_1583 = "*>();" + NL + "    for (";
  protected final String TEXT_1584 = " ";
  protected final String TEXT_1585 = " : ";
  protected final String TEXT_1586 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1587 = ".contains(";
  protected final String TEXT_1588 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1589 = NL + "      ";
  protected final String TEXT_1590 = ".add(";
  protected final String TEXT_1591 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1592 = ".size() != ";
  protected final String TEXT_1593 = ".length || ";
  protected final String TEXT_1594 = ".size() > ";
  ...
  protected final String TEXT_1598 = ".clear();";
  protected final String TEXT_1599 = NL + "    ";
  protected final String TEXT_1600 = ".addAll(";
  protected final String TEXT_1601 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1602 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1603 = NL + "  bool ";
  protected final String TEXT_1604 = "::";
  protected final String TEXT_1605 = "(";
  protected final String TEXT_1606 = "... ";
  protected final String TEXT_1607 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1608 = NL + "    vector<";
  protected final String TEXT_1609 = "*> ";
  protected final String TEXT_1610 = " = new vector<";
  protected final String TEXT_1611 = "*>();" + NL + "    for (";
  protected final String TEXT_1612 = " ";
  protected final String TEXT_1613 = " : ";
  protected final String TEXT_1614 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1615 = ".contains(";
  protected final String TEXT_1616 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1617 = NL + "      ";
  protected final String TEXT_1618 = ".add(";
  protected final String TEXT_1619 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1620 = ".size() != ";
  protected final String TEXT_1621 = ".length || ";
  protected final String TEXT_1622 = ".size() < ";
  ...
  protected final String TEXT_1626 = ".clear();";
  protected final String TEXT_1627 = NL + "    ";
  protected final String TEXT_1628 = ".addAll(";
  protected final String TEXT_1629 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1630 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1631 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1632 = NL + "    ";
  protected final String TEXT_1633 = " == (";
  protected final String TEXT_1634 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1635 = NL + "    ";
  protected final String TEXT_1636 = NL;
  protected final String TEXT_1637 = NL + "    ";
  protected final String TEXT_1638 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1639 = NL + "   void ";
  protected final String TEXT_1640 = "::";
  protected final String TEXT_1641 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1642 = NL + "       ";
  protected final String TEXT_1643 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1644 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1645 = NL + "    ";
  protected final String TEXT_1646 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1647 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1648 = NL + "      ";
  protected final String TEXT_1649 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1650 = NL + "  void ";
  protected final String TEXT_1651 = "::";
  protected final String TEXT_1652 = "()" + NL + "  {";
  protected final String TEXT_1653 = NL + "    ";
  protected final String TEXT_1654 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1655 = "\",";
  protected final String TEXT_1656 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1657 = "::";
  protected final String TEXT_1658 = "()" + NL + "  {";
  protected final String TEXT_1659 = NL + "    ";
  protected final String TEXT_1660 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1661 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1662 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1663 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1664 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1665 = "::run ()" + NL + "    {";
  protected final String TEXT_1666 = NL + "      if (\"";
  protected final String TEXT_1667 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1668 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1669 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1670 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1671 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1672 = NL + "    ";
  protected final String TEXT_1673 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1674 = ";";
  protected final String TEXT_1675 = NL + "    ";
  protected final String TEXT_1676 = ".clear();";
  ...
  protected final String TEXT_1682 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1683 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1695 = " = NULL;" + NL + "    if (";
  ...
  protected final String TEXT_1705 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1706 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1713 = ";" + NL + "      this.";
  ...
  protected final String TEXT_1722 = " != NULL)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1723 = ".";
  protected final String TEXT_1724 = "() <= ";
  protected final String TEXT_1725 = ")" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1726 = ";" + NL + "      }" + NL + "      else" + NL + "      {";
  ...
  protected final String TEXT_1743 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1744 = "); i++)" + NL + "    {";
  protected final String TEXT_1745 = NL + "      ";
  protected final String TEXT_1746 = "(";
  protected final String TEXT_1747 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1748 = NL + "    ";
  protected final String TEXT_1749 = ".clear();";
  protected final String TEXT_1750 = NL + "    vector<";
  protected final String TEXT_1751 = "> ";
  protected final String TEXT_1752 = " = vector<";
  protected final String TEXT_1753 = ">(";
  protected final String TEXT_1754 = ");";
  protected final String TEXT_1755 = NL + "    ";
  protected final String TEXT_1756 = ".clear();" + NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1757 = "); i++)" + NL + "     {" + NL + "      if (";
  ...
  protected final String TEXT_1762 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1763 = NL + "        ";
  protected final String TEXT_1764 = ".";
  protected final String TEXT_1765 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1766 = NL + "    vector<";
  protected final String TEXT_1767 = "> ";
  protected final String TEXT_1768 = " = new vector<";
  protected final String TEXT_1769 = ">(";
  protected final String TEXT_1770 = ");";
  protected final String TEXT_1771 = NL + "    ";
  protected final String TEXT_1772 = ".clear();" + NL + "    for(int i=0;sizeof(";
  protected final String TEXT_1773 = ");i++)" + NL + "    {";
  protected final String TEXT_1774 = NL + "      ";
  protected final String TEXT_1775 = "[i].";
  protected final String TEXT_1776 = "(this);" + NL + "    }";
  protected final String TEXT_1777 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1778 = "); i++)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1783 = "[i].";
  protected final String TEXT_1784 = "(NULL);" + NL + "    }";
  protected final String TEXT_1785 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
