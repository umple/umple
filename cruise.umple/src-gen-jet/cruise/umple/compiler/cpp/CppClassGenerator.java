...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_85 = "[i] = NULL;" + NL + "\t}" + NL + "    bool ";
  ...
  protected final String TEXT_93 = "for (unsigned int i=0; i<";
  protected final String TEXT_94 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_95 = "[i] = NULL;" + NL + "\t};";
  protected final String TEXT_96 = NL + "    ";
  protected final String TEXT_97 = ".push_back(";
  ...
  protected final String TEXT_110 = "::getInstance()" + NL + "  {" + NL + "    if(!theInstance)" + NL + "    {" + NL + "      theInstance = new ";
  ...
  protected final String TEXT_117 = NL + "        for (unsigned int i=0; i<";
  protected final String TEXT_118 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_119 = "[i] = NULL;" + NL + "\t}";
  ...
  protected final String TEXT_129 = NL + "    for (unsigned int i=0; i<";
  protected final String TEXT_130 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_131 = "[i] = NULL;" + NL + "\t}";
  ...
  protected final String TEXT_137 = " due to ";
  protected final String TEXT_138 = "\");" + NL + "    }";
  protected final String TEXT_139 = NL + "    for (unsigned int i=0; i<";
  protected final String TEXT_140 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_141 = "[i] = NULL;" + NL + "\t}" + NL + "    bool ";
  protected final String TEXT_142 = " = ";
  protected final String TEXT_143 = "(";
  protected final String TEXT_144 = ");" + NL + "    if (!";
  protected final String TEXT_145 = ")" + NL + "    {" + NL + "      throw new RuntimeException(\"Unable to create ";
  protected final String TEXT_146 = ", must have ";
  protected final String TEXT_147 = " ";
  protected final String TEXT_148 = "\");" + NL + "    }";
  protected final String TEXT_149 = "for (unsigned int i=0; i<";
  protected final String TEXT_150 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_151 = "[i] = NULL;" + NL + "\t};";
  protected final String TEXT_152 = NL + "    ";
  protected final String TEXT_153 = ".push_back(";
  protected final String TEXT_154 = ");";
  protected final String TEXT_155 = NL + "  ";
  protected final String TEXT_156 = NL + "  \t";
  protected final String TEXT_157 = NL + NL + "  //------------------------" + NL + "  // INTERFACE" + NL + "  //------------------------" + NL;
  protected final String TEXT_158 = NL + "  bool ";
  protected final String TEXT_159 = "::";
  protected final String TEXT_160 = "(const ";
  protected final String TEXT_161 = " & ";
  protected final String TEXT_162 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_171 = "(const ";
  protected final String TEXT_172 = " & ";
  protected final String TEXT_173 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_174 = NL + "    ";
  protected final String TEXT_175 = " = ";
  protected final String TEXT_176 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_177 = NL + "    return wasSet;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_178 = "::";
  protected final String TEXT_179 = "()" + NL + "  {" + NL + "    bool wasReset = false;";
  protected final String TEXT_180 = NL + "    ";
  protected final String TEXT_181 = " = ";
  protected final String TEXT_182 = "();" + NL + "    wasReset = true;";
  protected final String TEXT_183 = NL + "    return wasReset;" + NL + "  }" + NL;
  protected final String TEXT_184 = NL + "  bool ";
  protected final String TEXT_185 = "::";
  protected final String TEXT_186 = "(const ";
  protected final String TEXT_187 = " & ";
  protected final String TEXT_188 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_189 = NL + "    wasAdded = ";
  protected final String TEXT_190 = ".add(";
  protected final String TEXT_191 = ");";
  protected final String TEXT_192 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_193 = "::";
  protected final String TEXT_194 = "(";
  protected final String TEXT_195 = " & ";
  protected final String TEXT_196 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_197 = NL + "    wasRemoved = ";
  protected final String TEXT_198 = ".remove(";
  protected final String TEXT_199 = ");";
  protected final String TEXT_200 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_201 = NL + "  bool ";
  protected final String TEXT_202 = "::";
  protected final String TEXT_203 = "(const ";
  protected final String TEXT_204 = " & ";
  protected final String TEXT_205 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_206 = NL + "    ";
  protected final String TEXT_207 = " = ";
  protected final String TEXT_208 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_209 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_210 = NL + "  ";
  protected final String TEXT_211 = " ";
  protected final String TEXT_212 = "::";
  protected final String TEXT_213 = "(int index)" + NL + "  {";
  protected final String TEXT_214 = NL + "    ";
  protected final String TEXT_215 = " ";
  protected final String TEXT_216 = " = ";
  protected final String TEXT_217 = ".get(index);";
  ...
  protected final String TEXT_227 = ".toArray(new ";
  protected final String TEXT_228 = "[";
  protected final String TEXT_229 = ".size()]);";
  protected final String TEXT_230 = NL + "    return ";
  protected final String TEXT_231 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_232 = "::";
  protected final String TEXT_233 = "()" + NL + "  {";
  protected final String TEXT_234 = NL + "    int number = ";
  protected final String TEXT_235 = ".size();";
  protected final String TEXT_236 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_237 = "::";
  protected final String TEXT_238 = "()" + NL + "  {";
  protected final String TEXT_239 = NL + "    bool has = ";
  protected final String TEXT_240 = ".size() > 0;";
  protected final String TEXT_241 = NL + "    return has;" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_242 = "::";
  protected final String TEXT_243 = "(";
  protected final String TEXT_244 = " ";
  protected final String TEXT_245 = ")" + NL + "  {";
  protected final String TEXT_246 = NL + "    int index = ";
  protected final String TEXT_247 = ".indexOf(";
  protected final String TEXT_248 = ");";
  protected final String TEXT_249 = NL + "    return index;" + NL + "  }" + NL;
  ...
  protected final String TEXT_278 = "() const" + NL + "  {";
  ...
  protected final String TEXT_294 = "() const" + NL + "  {";
  ...
  protected final String TEXT_310 = "() const" + NL + "  {";
  protected final String TEXT_311 = NL + "    return ";
  protected final String TEXT_312 = ";" + NL + "  }";
  protected final String TEXT_313 = NL + "  ";
  protected final String TEXT_314 = " ";
  protected final String TEXT_315 = "::";
  protected final String TEXT_316 = "()" + NL + "  {" + NL + "    String answer = ";
  protected final String TEXT_317 = ".toString();";
  protected final String TEXT_318 = NL + "    return answer;" + NL + "  }" + NL;
  protected final String TEXT_319 = NL + "  ";
  protected final String TEXT_320 = " ";
  protected final String TEXT_321 = "::";
  protected final String TEXT_322 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_323 = ";" + NL + "  }" + NL;
  protected final String TEXT_324 = NL + "  ";
  protected final String TEXT_325 = "bool ";
  protected final String TEXT_326 = "::";
  protected final String TEXT_327 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;" + NL;
  protected final String TEXT_328 = NL + "    ";
  protected final String TEXT_329 = NL + NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_330 = NL + "  bool ";
  ...
  protected final String TEXT_337 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_338 = NL + "  private void ";
  protected final String TEXT_339 = "::";
  protected final String TEXT_340 = "()" + NL + "  {" + NL + "    switch(";
  ...
  protected final String TEXT_362 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_389 = ";" + NL + "  }" + NL + "" + NL + "  vector<";
  protected final String TEXT_390 = "*> ";
  protected final String TEXT_391 = "::";
  protected final String TEXT_392 = "() " + NL + "  {";
  protected final String TEXT_393 = NL + "    vector<";
  protected final String TEXT_394 = "*> ";
  protected final String TEXT_395 = " = ";
  protected final String TEXT_396 = ";";
  protected final String TEXT_397 = NL + "    return ";
  protected final String TEXT_398 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_399 = "::";
  protected final String TEXT_400 = "()" + NL + "  {";
  protected final String TEXT_401 = NL + "    int number = ";
  protected final String TEXT_402 = ".size();";
  protected final String TEXT_403 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_404 = "::";
  protected final String TEXT_405 = "()" + NL + "  {";
  protected final String TEXT_406 = NL + "    bool has = ";
  protected final String TEXT_407 = ".size() > 0;";
  protected final String TEXT_408 = NL + "    return has;" + NL + "  }" + NL + "  " + NL + "  int ";
  protected final String TEXT_409 = "::";
  protected final String TEXT_410 = "(";
  protected final String TEXT_411 = "* ";
  protected final String TEXT_412 = ")" + NL + "  {";
  protected final String TEXT_413 = NL + "    int index = find(";
  protected final String TEXT_414 = ".begin(), ";
  protected final String TEXT_415 = ".end(), ";
  protected final String TEXT_416 = ") - ";
  protected final String TEXT_417 = ".begin();";
  ...
  protected final String TEXT_422 = NL + "  bool ";
  protected final String TEXT_423 = "::";
  protected final String TEXT_424 = "()" + NL + "  {";
  protected final String TEXT_425 = NL + "    bool isValid = ";
  protected final String TEXT_426 = "() >= ";
  protected final String TEXT_427 = "();";
  protected final String TEXT_428 = NL + "    bool isValid = ";
  protected final String TEXT_429 = "() >= ";
  protected final String TEXT_430 = "() && ";
  protected final String TEXT_431 = "() <= ";
  protected final String TEXT_432 = "();";
  protected final String TEXT_433 = NL + "    return isValid;" + NL + "  }";
  protected final String TEXT_434 = NL + "  static int ";
  ...
  protected final String TEXT_441 = NL + "    int required = ";
  protected final String TEXT_442 = ";";
  protected final String TEXT_443 = NL + "    return required;" + NL + "  }";
  ...
  protected final String TEXT_450 = NL + "    int minimum = ";
  protected final String TEXT_451 = ";";
  protected final String TEXT_452 = NL + "    return minimum;" + NL + "  }";
  ...
  protected final String TEXT_460 = NL + "    int maximum = ";
  protected final String TEXT_461 = ";";
  protected final String TEXT_462 = NL + "    return maximum;" + NL + "  }";
  protected final String TEXT_463 = NL + "  bool ";
  protected final String TEXT_464 = "::";
  protected final String TEXT_465 = "(";
  protected final String TEXT_466 = "* ";
  protected final String TEXT_467 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_468 = NL + "    if (";
  protected final String TEXT_469 = "() >= ";
  protected final String TEXT_470 = "())" + NL + "    {";
  protected final String TEXT_471 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_472 = NL + "    ";
  protected final String TEXT_473 = ".push_back(";
  protected final String TEXT_474 = ");" + NL + "    if (";
  protected final String TEXT_475 = "->";
  protected final String TEXT_476 = "(this) != -1)" + NL + "    {" + NL + "      wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasAdded = ";
  protected final String TEXT_477 = ".";
  protected final String TEXT_478 = "(this);" + NL + "      if (!wasAdded)" + NL + "      {";
  protected final String TEXT_479 = NL + "        ";
  protected final String TEXT_480 = ".erase(find(";
  protected final String TEXT_481 = ".begin(),";
  protected final String TEXT_482 = ".end(),";
  protected final String TEXT_483 = "));" + NL + "      }" + NL + "    }";
  protected final String TEXT_484 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_485 = NL + "  bool ";
  protected final String TEXT_486 = "::";
  protected final String TEXT_487 = "(";
  protected final String TEXT_488 = " ";
  protected final String TEXT_489 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_490 = NL + "    if (!find(";
  protected final String TEXT_491 = ".begin(),";
  protected final String TEXT_492 = ".end(),";
  protected final String TEXT_493 = "))" + NL + "    {";
  protected final String TEXT_494 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_495 = ".indexOf(";
  protected final String TEXT_496 = ");";
  protected final String TEXT_497 = NL + "    ";
  protected final String TEXT_498 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_499 = ".";
  protected final String TEXT_500 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_501 = ".";
  protected final String TEXT_502 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_503 = NL + "        ";
  protected final String TEXT_504 = ".add(oldIndex,";
  protected final String TEXT_505 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_506 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_507 = NL + "  bool ";
  protected final String TEXT_508 = "::";
  protected final String TEXT_509 = "(";
  protected final String TEXT_510 = "* ";
  protected final String TEXT_511 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_512 = NL + "    ";
  protected final String TEXT_513 = " = ";
  protected final String TEXT_514 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_515 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_516 = NL + "  bool ";
  protected final String TEXT_517 = "::";
  protected final String TEXT_518 = "(";
  protected final String TEXT_519 = "* ";
  protected final String TEXT_520 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_521 = NL + "    if (";
  protected final String TEXT_522 = " != NULL)" + NL + "    {";
  protected final String TEXT_523 = NL + "      ";
  protected final String TEXT_524 = " = ";
  protected final String TEXT_525 = ";" + NL + "      wasSet = true;" + NL + "    }";
  protected final String TEXT_526 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_527 = NL + "  bool ";
  protected final String TEXT_528 = "::";
  protected final String TEXT_529 = "(";
  protected final String TEXT_530 = "* ";
  protected final String TEXT_531 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_532 = NL + "    if (";
  protected final String TEXT_533 = " != NULL && ";
  protected final String TEXT_534 = "!=";
  protected final String TEXT_535 = " && = ";
  protected final String TEXT_536 = "->";
  protected final String TEXT_537 = "())" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_538 = ", as existing ";
  protected final String TEXT_539 = " would become an orphan";
  ...
  protected final String TEXT_549 = "() : NULL;" + NL + "" + NL + "    if (this!=";
  protected final String TEXT_550 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_551 = " != NULL)" + NL + "      {";
  ...
  protected final String TEXT_558 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_559 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_560 = NL + "  bool ";
  protected final String TEXT_561 = "::";
  protected final String TEXT_562 = "(";
  protected final String TEXT_563 = " ";
  protected final String TEXT_564 = ")" + NL + "  {" + NL + "    bool";
  protected final String TEXT_565 = NL + "    if (";
  protected final String TEXT_566 = " == NULL)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_567 = " to null, as ";
  protected final String TEXT_568 = " must always be associated to a ";
  protected final String TEXT_569 = NL + "      return wasSet;" + NL + "    }" + NL + "    ";
  ...
  protected final String TEXT_576 = ")" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_577 = ", the current ";
  protected final String TEXT_578 = " already has a ";
  protected final String TEXT_579 = ", which would be orphaned if it were re-assigned";
  ...
  protected final String TEXT_590 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_591 = " != NULL)" + NL + "    {";
  protected final String TEXT_592 = NL + "      ";
  protected final String TEXT_593 = "->";
  protected final String TEXT_594 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_595 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_596 = NL + "  ";
  protected final String TEXT_597 = " ";
  protected final String TEXT_598 = "::";
  protected final String TEXT_599 = "(";
  protected final String TEXT_600 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_601 = "(";
  protected final String TEXT_602 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_603 = "::";
  protected final String TEXT_604 = "(";
  protected final String TEXT_605 = "* ";
  protected final String TEXT_606 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_607 = NL + "    ";
  protected final String TEXT_608 = " ";
  protected final String TEXT_609 = " = ";
  protected final String TEXT_610 = ".";
  protected final String TEXT_611 = "();" + NL + "    bool ";
  protected final String TEXT_612 = " = (";
  protected final String TEXT_613 = " != null && this != ";
  protected final String TEXT_614 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_615 = " && ";
  protected final String TEXT_616 = ".";
  protected final String TEXT_617 = "() <= ";
  protected final String TEXT_618 = "())" + NL + "    {" + NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_619 = ")" + NL + "    {";
  protected final String TEXT_620 = NL + "      ";
  protected final String TEXT_621 = ".";
  protected final String TEXT_622 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_623 = NL + "      ";
  protected final String TEXT_624 = ".add(";
  protected final String TEXT_625 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_626 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_627 = "::";
  protected final String TEXT_628 = "(";
  protected final String TEXT_629 = " ";
  protected final String TEXT_630 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_645 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_654 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_655 = "::";
  protected final String TEXT_656 = "(";
  protected final String TEXT_657 = " ";
  protected final String TEXT_658 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_659 = NL + "    if (";
  protected final String TEXT_660 = "() >= ";
  protected final String TEXT_661 = "())" + NL + "    {";
  protected final String TEXT_662 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_663 = NL + "    ";
  protected final String TEXT_664 = " ";
  protected final String TEXT_665 = " = ";
  protected final String TEXT_666 = ".";
  protected final String TEXT_667 = "();" + NL + "    bool ";
  protected final String TEXT_668 = " = ";
  protected final String TEXT_669 = " != null && !this.equals(";
  protected final String TEXT_670 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_671 = " && ";
  protected final String TEXT_672 = ".";
  protected final String TEXT_673 = "() <= ";
  protected final String TEXT_674 = "())" + NL + "    {";
  protected final String TEXT_675 = NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_676 = ")" + NL + "    {";
  protected final String TEXT_677 = NL + "      ";
  protected final String TEXT_678 = ".";
  protected final String TEXT_679 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_680 = NL + "      ";
  protected final String TEXT_681 = ".add(";
  protected final String TEXT_682 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_683 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_684 = "::";
  protected final String TEXT_685 = "(";
  protected final String TEXT_686 = " ";
  protected final String TEXT_687 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_688 = NL + "    //Unable to remove ";
  protected final String TEXT_689 = ", as it must always have a ";
  protected final String TEXT_690 = NL + "    if (this.equals(";
  protected final String TEXT_691 = ".";
  protected final String TEXT_692 = "()))" + NL + "    {";
  protected final String TEXT_693 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_694 = " already at minimum (";
  ...
  protected final String TEXT_701 = ");" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_709 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_710 = "(";
  protected final String TEXT_711 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_712 = "::";
  protected final String TEXT_713 = "(";
  protected final String TEXT_714 = " ";
  protected final String TEXT_715 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_716 = NL + "    if (";
  protected final String TEXT_717 = "() >= ";
  protected final String TEXT_718 = "())" + NL + "    {";
  protected final String TEXT_719 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_720 = NL + "    ";
  protected final String TEXT_721 = " ";
  protected final String TEXT_722 = " = ";
  protected final String TEXT_723 = ".";
  protected final String TEXT_724 = "();" + NL + "    bool ";
  protected final String TEXT_725 = " = ";
  protected final String TEXT_726 = " != null && !this.equals(";
  ...
  protected final String TEXT_735 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_736 = "::";
  protected final String TEXT_737 = "(";
  protected final String TEXT_738 = " ";
  protected final String TEXT_739 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_740 = NL + "    //Unable to remove ";
  protected final String TEXT_741 = ", as it must always have a ";
  protected final String TEXT_742 = NL + "    if (!this.equals(";
  protected final String TEXT_743 = ".";
  protected final String TEXT_744 = "()))" + NL + "    {";
  protected final String TEXT_745 = NL + "      ";
  protected final String TEXT_746 = ".remove(";
  protected final String TEXT_747 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_748 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_749 = NL + "  bool ";
  protected final String TEXT_750 = "::";
  protected final String TEXT_751 = "(";
  protected final String TEXT_752 = "... ";
  protected final String TEXT_753 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_754 = NL + "    vector<";
  protected final String TEXT_755 = "*> ";
  protected final String TEXT_756 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_757 = " ";
  protected final String TEXT_758 = " : ";
  protected final String TEXT_759 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_760 = ".begin(),";
  protected final String TEXT_761 = ".end(),";
  protected final String TEXT_762 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_763 = NL + "      ";
  protected final String TEXT_764 = "->add(";
  protected final String TEXT_765 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_766 = ".size() != ";
  protected final String TEXT_767 = ".length || ";
  protected final String TEXT_768 = ".size() > ";
  protected final String TEXT_769 = "())" + NL + "    {";
  protected final String TEXT_770 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  ...
  protected final String TEXT_780 = ");" + NL + "      if (find(";
  protected final String TEXT_781 = ".begin(),";
  protected final String TEXT_782 = ".end(),";
  protected final String TEXT_783 = "))" + NL + "      {";
  protected final String TEXT_784 = NL + "        ";
  protected final String TEXT_785 = ".erase(";
  protected final String TEXT_786 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_787 = NL + "        ";
  protected final String TEXT_788 = "->";
  protected final String TEXT_789 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_790 = " ";
  protected final String TEXT_791 = " : ";
  protected final String TEXT_792 = ")" + NL + "    {";
  protected final String TEXT_793 = NL + "      ";
  protected final String TEXT_794 = "->";
  protected final String TEXT_795 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_796 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_797 = NL + "  ";
  protected final String TEXT_798 = " ";
  protected final String TEXT_799 = "::";
  protected final String TEXT_800 = "(";
  protected final String TEXT_801 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_802 = "(";
  protected final String TEXT_803 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_804 = "::";
  protected final String TEXT_805 = "(";
  protected final String TEXT_806 = "* ";
  protected final String TEXT_807 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_808 = NL + "    ";
  protected final String TEXT_809 = "* ";
  protected final String TEXT_810 = " = ";
  protected final String TEXT_811 = "->";
  protected final String TEXT_812 = "();" + NL + "    bool ";
  protected final String TEXT_813 = " = (";
  protected final String TEXT_814 = " != NULL && this!=";
  protected final String TEXT_815 = ");" + NL + "    if (";
  protected final String TEXT_816 = ")" + NL + "    {";
  protected final String TEXT_817 = NL + "      ";
  protected final String TEXT_818 = "->";
  protected final String TEXT_819 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_820 = NL + "      ";
  protected final String TEXT_821 = "->push_back(";
  protected final String TEXT_822 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_823 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_824 = "::";
  protected final String TEXT_825 = "(";
  protected final String TEXT_826 = "* ";
  protected final String TEXT_827 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_828 = NL + "    //Unable to remove ";
  protected final String TEXT_829 = ", as it must always have a ";
  protected final String TEXT_830 = NL + "    if (this!=";
  protected final String TEXT_831 = "->";
  protected final String TEXT_832 = "())" + NL + "    {";
  protected final String TEXT_833 = NL + "      ";
  protected final String TEXT_834 = "->erase(find(";
  protected final String TEXT_835 = ".begin(),";
  protected final String TEXT_836 = ".end(),";
  protected final String TEXT_837 = "));" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_838 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_839 = NL + "  bool ";
  protected final String TEXT_840 = "::";
  protected final String TEXT_841 = "(";
  protected final String TEXT_842 = "* ";
  protected final String TEXT_843 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_851 = " = NULL;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_857 = "(NULL);" + NL + "      }" + NL + "      wasSet = true;";
  ...
  protected final String TEXT_868 = "(NULL);" + NL + "    }" + NL;
  ...
  protected final String TEXT_876 = "();" + NL + "" + NL + "    if (!=";
  protected final String TEXT_877 = ")" + NL + "    {";
  protected final String TEXT_878 = NL + "      ";
  protected final String TEXT_879 = "->";
  protected final String TEXT_880 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_881 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_882 = NL + "  bool ";
  protected final String TEXT_883 = "::";
  protected final String TEXT_884 = "(";
  protected final String TEXT_885 = " ";
  protected final String TEXT_886 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_887 = NL + "    if (! find(";
  protected final String TEXT_888 = ".begin(),";
  protected final String TEXT_889 = ".end(),";
  protected final String TEXT_890 = "))" + NL + "    {";
  protected final String TEXT_891 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_892 = "() <= ";
  protected final String TEXT_893 = "())" + NL + "    {";
  protected final String TEXT_894 = NL + "      return wasRemoved;" + NL + "    }" + NL + "\t" + NL + "    int oldIndex = find(";
  protected final String TEXT_895 = ".begin(), ";
  protected final String TEXT_896 = ".end(), ";
  protected final String TEXT_897 = ") - ";
  protected final String TEXT_898 = ".begin();";
  protected final String TEXT_899 = NL + "    ";
  protected final String TEXT_900 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_901 = "->";
  protected final String TEXT_902 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_903 = "->";
  protected final String TEXT_904 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_905 = NL + "        ";
  protected final String TEXT_906 = "->add(oldIndex,";
  protected final String TEXT_907 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_908 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_909 = NL + "  bool ";
  protected final String TEXT_910 = "::";
  protected final String TEXT_911 = "(";
  protected final String TEXT_912 = " ";
  protected final String TEXT_913 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_914 = NL + "    if (! find(";
  protected final String TEXT_915 = ".begin(),";
  protected final String TEXT_916 = ".end(),";
  protected final String TEXT_917 = "))" + NL + "    {";
  protected final String TEXT_918 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_919 = "() <= ";
  protected final String TEXT_920 = "())" + NL + "    {";
  protected final String TEXT_921 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = find(";
  ...
  protected final String TEXT_927 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_928 = ".";
  protected final String TEXT_929 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_930 = ".";
  protected final String TEXT_931 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_932 = NL + "        ";
  protected final String TEXT_933 = ".add(oldIndex,";
  protected final String TEXT_934 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_935 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_936 = NL + "  bool ";
  protected final String TEXT_937 = "::";
  protected final String TEXT_938 = "(";
  protected final String TEXT_939 = "* ";
  protected final String TEXT_940 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_960 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_961 = " != null)" + NL + "    {";
  protected final String TEXT_962 = NL + "      ";
  protected final String TEXT_963 = "->";
  protected final String TEXT_964 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_965 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_966 = NL + "  bool ";
  protected final String TEXT_967 = "::";
  protected final String TEXT_968 = "(";
  protected final String TEXT_969 = "* ";
  protected final String TEXT_970 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_986 = "(this);" + NL + "    }";
  protected final String TEXT_987 = NL + "    ";
  protected final String TEXT_988 = "->";
  protected final String TEXT_989 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_990 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_991 = NL + "  bool ";
  protected final String TEXT_992 = "::";
  protected final String TEXT_993 = "(";
  protected final String TEXT_994 = "* ";
  protected final String TEXT_995 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_996 = NL + "    //Must provide ";
  protected final String TEXT_997 = " to ";
  protected final String TEXT_998 = NL + "    if (";
  protected final String TEXT_999 = " == NULL)" + NL + "    {";
  protected final String TEXT_1000 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_1001 = " already at maximum (";
  ...
  protected final String TEXT_1017 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1018 = ".";
  protected final String TEXT_1019 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1026 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1027 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1028 = NL + "  bool ";
  protected final String TEXT_1029 = "::";
  protected final String TEXT_1030 = "(";
  protected final String TEXT_1031 = "* ";
  protected final String TEXT_1032 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1033 = NL + "    //Must provide ";
  protected final String TEXT_1034 = " to ";
  protected final String TEXT_1035 = NL + "    if (";
  protected final String TEXT_1036 = " == NULL)" + NL + "    {";
  protected final String TEXT_1037 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1053 = ")" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1054 = "->";
  protected final String TEXT_1055 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1062 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1063 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1064 = NL + "  bool ";
  protected final String TEXT_1065 = "::";
  protected final String TEXT_1066 = "(";
  protected final String TEXT_1067 = "* ";
  protected final String TEXT_1068 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1077 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1085 = ");" + NL + "    } " + NL + "    else" + NL + "    {";
  protected final String TEXT_1086 = NL + "      ";
  protected final String TEXT_1087 = ".push_back(";
  protected final String TEXT_1088 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1089 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1090 = "::";
  protected final String TEXT_1091 = "(";
  protected final String TEXT_1092 = "* ";
  protected final String TEXT_1093 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1094 = NL + "    if (find(";
  protected final String TEXT_1095 = ".begin(),";
  protected final String TEXT_1096 = ".end(),";
  protected final String TEXT_1097 = "))" + NL + "    {";
  protected final String TEXT_1098 = NL + "      ";
  protected final String TEXT_1099 = ".erase(find(";
  protected final String TEXT_1100 = ".begin(),";
  protected final String TEXT_1101 = ".end(),";
  ...
  protected final String TEXT_1106 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1107 = NL + "  bool ";
  protected final String TEXT_1108 = "::";
  protected final String TEXT_1109 = "(";
  protected final String TEXT_1110 = "* ";
  protected final String TEXT_1111 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1124 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1125 = " != NULL)" + NL + "    {";
  protected final String TEXT_1126 = NL + "      ";
  protected final String TEXT_1127 = "->";
  protected final String TEXT_1128 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1129 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1130 = NL + "  bool ";
  protected final String TEXT_1131 = "::";
  protected final String TEXT_1132 = "(";
  protected final String TEXT_1133 = " ";
  protected final String TEXT_1134 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1135 = NL + "    if (";
  protected final String TEXT_1136 = "() >= ";
  protected final String TEXT_1137 = "())" + NL + "    {";
  protected final String TEXT_1138 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_1139 = NL + "    ";
  protected final String TEXT_1140 = " ";
  protected final String TEXT_1141 = " = ";
  protected final String TEXT_1142 = ".";
  protected final String TEXT_1143 = "();" + NL + "    if (";
  protected final String TEXT_1144 = " == NULL)" + NL + "    {";
  protected final String TEXT_1145 = NL + "      ";
  protected final String TEXT_1146 = ".";
  protected final String TEXT_1147 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1155 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1156 = NL + "      ";
  protected final String TEXT_1157 = ".add(";
  protected final String TEXT_1158 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1159 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1160 = "::";
  protected final String TEXT_1161 = "(";
  protected final String TEXT_1162 = " ";
  protected final String TEXT_1163 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1164 = NL + "    if (find(";
  protected final String TEXT_1165 = ".begin(),";
  protected final String TEXT_1166 = ".end(),";
  protected final String TEXT_1167 = "))" + NL + "    {";
  protected final String TEXT_1168 = NL + "      ";
  protected final String TEXT_1169 = ".remove(";
  protected final String TEXT_1170 = ");";
  protected final String TEXT_1171 = NL + "      ";
  protected final String TEXT_1172 = "->";
  protected final String TEXT_1173 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1174 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1175 = NL + "  bool ";
  protected final String TEXT_1176 = "::";
  protected final String TEXT_1177 = "(";
  protected final String TEXT_1178 = " ";
  protected final String TEXT_1179 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1184 = ".push_back(";
  protected final String TEXT_1185 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1186 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1187 = "::";
  protected final String TEXT_1188 = "(";
  protected final String TEXT_1189 = "* ";
  protected final String TEXT_1190 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1191 = NL + "    if (!find(";
  protected final String TEXT_1192 = ".begin(),";
  protected final String TEXT_1193 = ".end(),";
  protected final String TEXT_1194 = ")))" + NL + "    {";
  protected final String TEXT_1195 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1200 = "erase(";
  protected final String TEXT_1201 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1202 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1203 = NL + "  bool ";
  protected final String TEXT_1204 = "::";
  protected final String TEXT_1205 = "(";
  protected final String TEXT_1206 = " ";
  protected final String TEXT_1207 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1208 = NL + "    if (";
  protected final String TEXT_1209 = "() >= ";
  protected final String TEXT_1210 = "())" + NL + "    {";
  protected final String TEXT_1211 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1232 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1233 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1234 = "::";
  protected final String TEXT_1235 = "(";
  protected final String TEXT_1236 = " ";
  protected final String TEXT_1237 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1238 = NL + "    if (find(";
  protected final String TEXT_1239 = ".begin(),";
  protected final String TEXT_1240 = ".end(),";
  protected final String TEXT_1241 = ") && ";
  protected final String TEXT_1242 = "() > ";
  protected final String TEXT_1243 = "())" + NL + "    {";
  protected final String TEXT_1244 = NL + "      ";
  protected final String TEXT_1245 = ".remove(";
  protected final String TEXT_1246 = ");";
  protected final String TEXT_1247 = NL + "      ";
  protected final String TEXT_1248 = "(";
  protected final String TEXT_1249 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1250 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_1255 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1256 = NL + "    vector<";
  protected final String TEXT_1257 = "*> ";
  protected final String TEXT_1258 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_1259 = " ";
  protected final String TEXT_1260 = " : ";
  protected final String TEXT_1261 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1262 = ".begin(),";
  protected final String TEXT_1263 = ".end(),";
  protected final String TEXT_1264 = "))" + NL + "      {";
  protected final String TEXT_1265 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1266 = ".";
  protected final String TEXT_1267 = "() != NULL && this!=(";
  protected final String TEXT_1268 = "->";
  protected final String TEXT_1269 = "()))" + NL + "      {";
  protected final String TEXT_1270 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1271 = NL + "      ";
  protected final String TEXT_1272 = ".push_back(";
  protected final String TEXT_1273 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1274 = ".size() != ";
  ...
  protected final String TEXT_1278 = ".removeAll(";
  protected final String TEXT_1279 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1280 = " orphan : ";
  protected final String TEXT_1281 = ")" + NL + "    {";
  protected final String TEXT_1282 = NL + "      ";
  protected final String TEXT_1283 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1284 = NL + "    ";
  protected final String TEXT_1285 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1291 = ", this);";
  protected final String TEXT_1292 = NL + "      ";
  protected final String TEXT_1293 = ".push_back(";
  protected final String TEXT_1294 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1295 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1296 = NL + "  void ";
  ...
  protected final String TEXT_1302 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1303 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1304 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1305 = ", ";
  protected final String TEXT_1306 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1307 = " to ";
  protected final String TEXT_1308 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1309 = NL + "  bool ";
  protected final String TEXT_1310 = "::";
  protected final String TEXT_1311 = "(";
  protected final String TEXT_1312 = " ";
  protected final String TEXT_1313 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1314 = NL + "    ";
  protected final String TEXT_1315 = "push_back(";
  protected final String TEXT_1316 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1317 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1318 = "::";
  protected final String TEXT_1319 = "(";
  protected final String TEXT_1320 = "* ";
  protected final String TEXT_1321 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1322 = NL + "    if (find(";
  ...
  protected final String TEXT_1327 = ".erase(find(";
  protected final String TEXT_1328 = ".begin(),";
  protected final String TEXT_1329 = ".end(),";
  protected final String TEXT_1330 = "));" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1336 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1341 = ".push_back(";
  protected final String TEXT_1342 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1343 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1344 = "::";
  protected final String TEXT_1345 = "(";
  protected final String TEXT_1346 = "* ";
  protected final String TEXT_1347 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1348 = NL + "    if (find(";
  protected final String TEXT_1349 = ".begin(),";
  protected final String TEXT_1350 = ".end(),";
  protected final String TEXT_1351 = "))" + NL + "    {";
  protected final String TEXT_1352 = NL + "      ";
  protected final String TEXT_1353 = "erase(";
  protected final String TEXT_1354 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1355 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1356 = NL + "  bool ";
  protected final String TEXT_1357 = "::";
  protected final String TEXT_1358 = "(";
  protected final String TEXT_1359 = "* ";
  protected final String TEXT_1360 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1361 = NL + "    ";
  protected final String TEXT_1362 = ".push_back(";
  protected final String TEXT_1363 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1364 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1365 = "::";
  protected final String TEXT_1366 = "(";
  protected final String TEXT_1367 = "* ";
  protected final String TEXT_1368 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1373 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1374 = "() <= ";
  protected final String TEXT_1375 = "())" + NL + "    {";
  protected final String TEXT_1376 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1377 = NL + "    ";
  protected final String TEXT_1378 = ".erase(find(";
  protected final String TEXT_1379 = ".begin(),";
  protected final String TEXT_1380 = ".end(),";
  protected final String TEXT_1381 = "));" + NL + "    wasRemoved = true;";
  protected final String TEXT_1382 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1383 = NL + "  bool ";
  protected final String TEXT_1384 = "::";
  protected final String TEXT_1385 = "(";
  protected final String TEXT_1386 = "... ";
  protected final String TEXT_1387 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1388 = NL + "    vector<";
  protected final String TEXT_1389 = "*> ";
  protected final String TEXT_1390 = ";" + NL + "    for (";
  protected final String TEXT_1391 = " ";
  protected final String TEXT_1392 = " : ";
  protected final String TEXT_1393 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1394 = ".begin(),";
  protected final String TEXT_1395 = ".end(),";
  protected final String TEXT_1396 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1397 = NL + "      ";
  protected final String TEXT_1398 = ".push_back(";
  protected final String TEXT_1399 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1400 = ".size() != ";
  ...
  protected final String TEXT_1406 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1407 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1408 = ".push_back(";
  protected final String TEXT_1409 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  protected final String TEXT_1410 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1411 = NL + "  ";
  protected final String TEXT_1412 = " bool ";
  protected final String TEXT_1413 = "(";
  protected final String TEXT_1414 = "... ";
  protected final String TEXT_1415 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1416 = NL + "    vector<";
  protected final String TEXT_1417 = "*> ";
  protected final String TEXT_1418 = ";" + NL + "    for (int i=0 ; i<";
  protected final String TEXT_1419 = ".size() ; i++)" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1420 = ".begin(),";
  protected final String TEXT_1421 = ".end(),(";
  protected final String TEXT_1422 = ") - ";
  protected final String TEXT_1423 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1424 = NL + "      ";
  protected final String TEXT_1425 = ".push_back(";
  protected final String TEXT_1426 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1427 = ".size() != ";
  protected final String TEXT_1428 = ".length)" + NL + "    {";
  ...
  protected final String TEXT_1433 = ".addAll(";
  protected final String TEXT_1434 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1435 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1436 = NL + "  bool ";
  protected final String TEXT_1437 = "::";
  protected final String TEXT_1438 = "(";
  protected final String TEXT_1439 = "... ";
  protected final String TEXT_1440 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1441 = NL + "    vector<";
  ...
  protected final String TEXT_1446 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1447 = ".begin(),";
  protected final String TEXT_1448 = ".end(),";
  protected final String TEXT_1449 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1450 = NL + "      ";
  protected final String TEXT_1451 = "push_back(";
  protected final String TEXT_1452 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1453 = ".size() != ";
  protected final String TEXT_1454 = ".length || ";
  protected final String TEXT_1455 = ".size() < ";
  protected final String TEXT_1456 = "() || ";
  protected final String TEXT_1457 = ".size() > ";
  protected final String TEXT_1458 = "())" + NL + "    {";
  protected final String TEXT_1459 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1460 = "*> ";
  protected final String TEXT_1461 = " = new vector<";
  protected final String TEXT_1462 = "*>(";
  protected final String TEXT_1463 = ");";
  protected final String TEXT_1464 = NL + "    ";
  protected final String TEXT_1465 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1470 = ".push_back(";
  protected final String TEXT_1471 = ");" + NL + "      if (find(";
  protected final String TEXT_1472 = ".begin(),";
  protected final String TEXT_1473 = ".end(),";
  ...
  protected final String TEXT_1479 = "));" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1480 = NL + "        ";
  protected final String TEXT_1481 = "->";
  protected final String TEXT_1482 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1488 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1489 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1490 = NL + "  bool ";
  protected final String TEXT_1491 = "::";
  protected final String TEXT_1492 = "(";
  protected final String TEXT_1493 = "... ";
  protected final String TEXT_1494 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1495 = NL + "    vector<";
  protected final String TEXT_1496 = "*> ";
  protected final String TEXT_1497 = ";" + NL + "\t" + NL + "    for (";
  protected final String TEXT_1498 = " ";
  protected final String TEXT_1499 = " : ";
  protected final String TEXT_1500 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1501 = ".begin(),";
  protected final String TEXT_1502 = ".end(),";
  protected final String TEXT_1503 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1504 = NL + "      ";
  protected final String TEXT_1505 = ".push_back(";
  protected final String TEXT_1506 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1507 = ".size() != ";
  protected final String TEXT_1508 = ".length || ";
  protected final String TEXT_1509 = ".size() < ";
  protected final String TEXT_1510 = "())" + NL + "    {";
  protected final String TEXT_1511 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1512 = "*> ";
  protected final String TEXT_1513 = ";";
  protected final String TEXT_1514 = NL + "    ";
  protected final String TEXT_1515 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1520 = ".push_back(";
  ...
  protected final String TEXT_1526 = ".erase(";
  protected final String TEXT_1527 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1528 = NL + "        ";
  protected final String TEXT_1529 = "->";
  protected final String TEXT_1530 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1536 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1537 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1542 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1543 = NL + "    vector<";
  protected final String TEXT_1544 = "*> ";
  protected final String TEXT_1545 = ";" + NL + "    for (";
  protected final String TEXT_1546 = " ";
  protected final String TEXT_1547 = " : ";
  protected final String TEXT_1548 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1549 = ".begin(),";
  protected final String TEXT_1550 = ".end(),";
  ...
  protected final String TEXT_1563 = ".clear();" + NL + "\tfor (int i=0; i<";
  protected final String TEXT_1564 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1565 = ".push_back(";
  protected final String TEXT_1566 = "[i]);" + NL + "\t}" + NL + "    " + NL + "    wasSet = true;";
  protected final String TEXT_1567 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1568 = NL + "  bool ";
  protected final String TEXT_1569 = "::";
  protected final String TEXT_1570 = "(";
  protected final String TEXT_1571 = "... ";
  protected final String TEXT_1572 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1573 = NL + "    if (";
  protected final String TEXT_1574 = ".length < ";
  protected final String TEXT_1575 = "()";
  protected final String TEXT_1576 = ")" + NL + "    {";
  protected final String TEXT_1577 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1578 = "*> ";
  protected final String TEXT_1579 = ";" + NL + "\t" + NL + "    map<";
  protected final String TEXT_1580 = ",int> ";
  protected final String TEXT_1581 = ";" + NL + "    for (";
  protected final String TEXT_1582 = " ";
  protected final String TEXT_1583 = " : ";
  protected final String TEXT_1584 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1585 = ".begin(),";
  protected final String TEXT_1586 = ".end(),";
  protected final String TEXT_1587 = "))" + NL + "      {";
  protected final String TEXT_1588 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1589 = "->";
  protected final String TEXT_1590 = "() != NULL && this!=";
  ...
  protected final String TEXT_1598 = ".find(";
  protected final String TEXT_1599 = "))" + NL + "        {";
  protected final String TEXT_1600 = NL + "          ";
  protected final String TEXT_1601 = ".insert(";
  protected final String TEXT_1602 = ", new int(";
  protected final String TEXT_1603 = "->";
  protected final String TEXT_1604 = "()));" + NL + "        }" + NL + "        int currentCount = ";
  protected final String TEXT_1605 = ".find(";
  protected final String TEXT_1606 = ")->firtst;" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1607 = ")" + NL + "        {";
  protected final String TEXT_1608 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1609 = NL + "        ";
  protected final String TEXT_1610 = ".insert(";
  protected final String TEXT_1611 = ", new int(nextCount));" + NL + "      }";
  protected final String TEXT_1612 = NL + "      ";
  protected final String TEXT_1613 = ".push_back(";
  protected final String TEXT_1614 = ");" + NL + "    }" + NL;
  protected final String TEXT_1615 = NL + "    ";
  protected final String TEXT_1616 = ".removeAll(";
  protected final String TEXT_1617 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1618 = " orphan : ";
  protected final String TEXT_1619 = ")" + NL + "    {";
  protected final String TEXT_1620 = NL + "      ";
  protected final String TEXT_1621 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1622 = NL + "    ";
  protected final String TEXT_1623 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1639 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1640 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1641 = NL + "  void ";
  ...
  protected final String TEXT_1647 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1648 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1649 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1650 = ", ";
  protected final String TEXT_1651 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1652 = " to ";
  protected final String TEXT_1653 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1654 = NL + "  bool ";
  protected final String TEXT_1655 = "::";
  protected final String TEXT_1656 = "(";
  protected final String TEXT_1657 = "... ";
  protected final String TEXT_1658 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1659 = NL + "    vector<";
  protected final String TEXT_1660 = "*> ";
  protected final String TEXT_1661 = ";" + NL + "    for (";
  protected final String TEXT_1662 = " ";
  protected final String TEXT_1663 = " : ";
  protected final String TEXT_1664 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1665 = ".begin(),";
  protected final String TEXT_1666 = ".end(),(";
  protected final String TEXT_1667 = ")) - ";
  protected final String TEXT_1668 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1669 = NL + "      ";
  protected final String TEXT_1670 = ".push_back(";
  protected final String TEXT_1671 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1672 = ".size() != ";
  protected final String TEXT_1673 = ".size() || ";
  protected final String TEXT_1674 = ".size() > ";
  protected final String TEXT_1675 = "())" + NL + "    {";
  protected final String TEXT_1676 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1677 = NL + "    ";
  protected final String TEXT_1678 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1679 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1680 = ".push_back(";
  protected final String TEXT_1681 = "[i]);" + NL + "\t}" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1696 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1697 = NL + "      ";
  protected final String TEXT_1698 = "->add(";
  protected final String TEXT_1699 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1704 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1705 = NL + "    ";
  protected final String TEXT_1706 = ".clear();" + NL + "    for (int i=0; i<";
  protected final String TEXT_1707 = ".size(); i++)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1708 = ".push_back(";
  protected final String TEXT_1709 = "[i]);" + NL + "\t}" + NL + "\t" + NL + "    wasSet = true;";
  protected final String TEXT_1710 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1711 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1712 = NL + "    ";
  protected final String TEXT_1713 = " == (";
  protected final String TEXT_1714 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1715 = NL + "    ";
  protected final String TEXT_1716 = NL;
  protected final String TEXT_1717 = NL + "    ";
  protected final String TEXT_1718 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1719 = NL + "   void ";
  protected final String TEXT_1720 = "::";
  protected final String TEXT_1721 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1722 = NL + "       ";
  protected final String TEXT_1723 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1724 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1725 = NL + "    ";
  protected final String TEXT_1726 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1727 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1728 = NL + "      ";
  protected final String TEXT_1729 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1730 = NL + "  void ";
  protected final String TEXT_1731 = "::";
  protected final String TEXT_1732 = "()" + NL + "  {";
  protected final String TEXT_1733 = NL + "    ";
  protected final String TEXT_1734 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1735 = "\",";
  protected final String TEXT_1736 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1737 = "::";
  protected final String TEXT_1738 = "()" + NL + "  {";
  protected final String TEXT_1739 = NL + "    ";
  protected final String TEXT_1740 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1741 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1742 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1743 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1744 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1745 = "::run ()" + NL + "    {";
  protected final String TEXT_1746 = NL + "      if (\"";
  protected final String TEXT_1747 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1748 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1749 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1750 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1751 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1752 = NL + "    ";
  protected final String TEXT_1753 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1754 = ";";
  protected final String TEXT_1755 = NL + "    ";
  protected final String TEXT_1756 = ".clear();";
  ...
  protected final String TEXT_1762 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1763 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1764 = ";" + NL + "    }";
  protected final String TEXT_1765 = NL + "    if (";
  protected final String TEXT_1766 = " != NULL)" + NL + "    {";
  protected final String TEXT_1767 = NL + "      ";
  protected final String TEXT_1768 = "->";
  protected final String TEXT_1769 = "(NULL);" + NL + "    }";
  ...
  protected final String TEXT_1823 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1824 = "); i++)" + NL + "    {";
  protected final String TEXT_1825 = NL + "      ";
  protected final String TEXT_1826 = "(";
  protected final String TEXT_1827 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1828 = NL + "    ";
  protected final String TEXT_1829 = ".clear();";
  protected final String TEXT_1830 = NL + "    vector<";
  ...
  protected final String TEXT_1835 = ".clear();" + NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1836 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_1837 = ".";
  protected final String TEXT_1838 = "() <= ";
  protected final String TEXT_1839 = "->";
  protected final String TEXT_1840 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1841 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1842 = NL + "        ";
  protected final String TEXT_1843 = "->";
  protected final String TEXT_1844 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1845 = NL + "    vector<";
  ...
  protected final String TEXT_1850 = ".clear();" + NL + "    for(int i=0;sizeof(";
  protected final String TEXT_1851 = ");i++)" + NL + "    {";
  protected final String TEXT_1852 = NL + "      ";
  protected final String TEXT_1853 = "[i]->";
  protected final String TEXT_1854 = "(this);" + NL + "    }";
  protected final String TEXT_1855 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1856 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1857 = "[i];" + NL + "    }";
  protected final String TEXT_1858 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1859 = "); i++)" + NL + "    {";
  protected final String TEXT_1860 = NL + "      ";
  protected final String TEXT_1861 = "[i]->";
  protected final String TEXT_1862 = "(NULL);" + NL + "    }";
  protected final String TEXT_1863 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
