...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_34 = " = new vector<";
  ...
  protected final String TEXT_44 = " = new vector<";
  protected final String TEXT_45 = "*>();" + NL + "    bool ";
  protected final String TEXT_46 = " = ";
  protected final String TEXT_47 = "(";
  protected final String TEXT_48 = ");" + NL + "    if (!";
  protected final String TEXT_49 = ")" + NL + "    {" + NL + "    \ttry" + NL + "    \t{    \t" + NL + "      \t  cout<<\"Unable to create ";
  protected final String TEXT_50 = ", must have ";
  protected final String TEXT_51 = " or fewer ";
  protected final String TEXT_52 = ", no duplicates.\";" + NL + "      \t}" + NL + "      \t" + NL + "      \tcatch" + NL + "      \t{" + NL + "      \t\tcerr<<\"exception caught:\"<<e.what()<<endl;" + NL + "      \t}" + NL + "    }";
  ...
  protected final String TEXT_59 = ")" + NL + "    {" + NL + "    " + NL + "    try" + NL + "    \t{    \t" + NL + "      \t  cout<<\"Unable to create ";
  protected final String TEXT_60 = ", must not have duplicate ";
  protected final String TEXT_61 = ".\");" + NL + "      \t}" + NL + "      \t" + NL + "      \tcatch" + NL + "      \t{" + NL + "      \t\tcerr<<\"exception caught:\"<<e.what()<<endl;" + NL + "      \t}" + NL + "    }";
  ...
  protected final String TEXT_68 = "() != null)" + NL + "    {" + NL + "      throw new RuntimeException(\"Unable to create ";
  ...
  protected final String TEXT_75 = " = new vector<";
  protected final String TEXT_76 = "*>();";
  protected final String TEXT_77 = NL + "    bool ";
  protected final String TEXT_78 = " = ";
  protected final String TEXT_79 = "(";
  protected final String TEXT_80 = ");" + NL + "    if (!";
  protected final String TEXT_81 = ")" + NL + "    {" + NL + "      throw new RuntimeException(\"Unable to create ";
  ...
  protected final String TEXT_91 = ", must have ";
  protected final String TEXT_92 = " ";
  protected final String TEXT_93 = "\");" + NL + "    }";
  protected final String TEXT_94 = " = new vector<";
  ...
  protected final String TEXT_118 = " = new vector<";
  ...
  protected final String TEXT_133 = " = new vector<";
  ...
  protected final String TEXT_143 = " = new vector<";
  ...
  protected final String TEXT_149 = ", must have ";
  protected final String TEXT_150 = " ";
  protected final String TEXT_151 = "\");" + NL + "    }";
  protected final String TEXT_152 = " = new vector<";
  protected final String TEXT_153 = "*>();";
  protected final String TEXT_154 = NL + "    ";
  protected final String TEXT_155 = ".push_back(";
  ...
  protected final String TEXT_169 = ";" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_179 = NL + "    return wasSet;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_180 = "::";
  protected final String TEXT_181 = "()" + NL + "  {" + NL + "    bool wasReset = false;";
  protected final String TEXT_182 = NL + "    ";
  protected final String TEXT_183 = " = ";
  protected final String TEXT_184 = "();" + NL + "    wasReset = true;";
  ...
  protected final String TEXT_210 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_211 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_212 = NL + "  ";
  protected final String TEXT_213 = " ";
  protected final String TEXT_214 = "::";
  protected final String TEXT_215 = "(int index)" + NL + "  {";
  protected final String TEXT_216 = NL + "    ";
  protected final String TEXT_217 = " ";
  protected final String TEXT_218 = " = ";
  protected final String TEXT_219 = ".get(index);";
  ...
  protected final String TEXT_229 = ".toArray(new ";
  protected final String TEXT_230 = "[";
  protected final String TEXT_231 = ".size()]);";
  protected final String TEXT_232 = NL + "    return ";
  protected final String TEXT_233 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_234 = "::";
  protected final String TEXT_235 = "()" + NL + "  {";
  protected final String TEXT_236 = NL + "    int number = ";
  protected final String TEXT_237 = ".size();";
  protected final String TEXT_238 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_239 = "::";
  protected final String TEXT_240 = "()" + NL + "  {";
  protected final String TEXT_241 = NL + "    bool has = ";
  protected final String TEXT_242 = ".size() > 0;";
  protected final String TEXT_243 = NL + "    return has;" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_244 = "::";
  protected final String TEXT_245 = "(";
  protected final String TEXT_246 = " ";
  protected final String TEXT_247 = ")" + NL + "  {";
  protected final String TEXT_248 = NL + "    int index = ";
  protected final String TEXT_249 = ".indexOf(";
  protected final String TEXT_250 = ");";
  protected final String TEXT_251 = NL + "    return index;" + NL + "  }" + NL;
  ...
  protected final String TEXT_318 = "()" + NL + "  {" + NL + "    String answer = ";
  protected final String TEXT_319 = ".toString();";
  protected final String TEXT_320 = NL + "    return answer;" + NL + "  }" + NL;
  protected final String TEXT_321 = NL + "  ";
  protected final String TEXT_322 = " ";
  protected final String TEXT_323 = "::";
  protected final String TEXT_324 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_325 = ";" + NL + "  }" + NL;
  protected final String TEXT_326 = NL + "  ";
  protected final String TEXT_327 = "bool ";
  protected final String TEXT_328 = "::";
  protected final String TEXT_329 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;" + NL;
  protected final String TEXT_330 = NL + "    ";
  protected final String TEXT_331 = NL + NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  ...
  protected final String TEXT_342 = "()" + NL + "  {" + NL + "    switch(";
  ...
  protected final String TEXT_385 = "(int index) " + NL + "  {";
  protected final String TEXT_386 = NL + "    ";
  protected final String TEXT_387 = " ";
  protected final String TEXT_388 = " = ";
  protected final String TEXT_389 = ".get(index);";
  protected final String TEXT_390 = NL + "    return ";
  protected final String TEXT_391 = ";" + NL + "  }" + NL + "" + NL + "  vector<";
  protected final String TEXT_392 = "*> ";
  protected final String TEXT_393 = "::";
  protected final String TEXT_394 = "() " + NL + "  {";
  protected final String TEXT_395 = NL + "    vector<";
  protected final String TEXT_396 = "*> ";
  protected final String TEXT_397 = " = ";
  protected final String TEXT_398 = ";";
  protected final String TEXT_399 = NL + "    return ";
  protected final String TEXT_400 = ";" + NL + "  }" + NL + "" + NL + "  int ";
  protected final String TEXT_401 = "::";
  protected final String TEXT_402 = "()" + NL + "  {";
  protected final String TEXT_403 = NL + "    int number = ";
  protected final String TEXT_404 = ".size();";
  protected final String TEXT_405 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_406 = "::";
  protected final String TEXT_407 = "()" + NL + "  {";
  protected final String TEXT_408 = NL + "    bool has = ";
  protected final String TEXT_409 = ".size() > 0;";
  protected final String TEXT_410 = NL + "    return has;" + NL + "  }" + NL + "  " + NL + "  int ";
  protected final String TEXT_411 = "::";
  protected final String TEXT_412 = "(";
  protected final String TEXT_413 = " ";
  protected final String TEXT_414 = ")" + NL + "  {";
  protected final String TEXT_415 = NL + "    int index = std::find(";
  protected final String TEXT_416 = ".begin(), ";
  protected final String TEXT_417 = ".end(), ";
  protected final String TEXT_418 = ") - ";
  protected final String TEXT_419 = ".begin();";
  protected final String TEXT_420 = NL + "    return index;" + NL + "  }" + NL + "  ";
  protected final String TEXT_421 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_422 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_423 = " : ";
  protected final String TEXT_424 = NL + "  bool ";
  protected final String TEXT_425 = "::";
  protected final String TEXT_426 = "()" + NL + "  {";
  protected final String TEXT_427 = NL + "    bool isValid = ";
  protected final String TEXT_428 = "() >= ";
  protected final String TEXT_429 = "();";
  protected final String TEXT_430 = NL + "    bool isValid = ";
  protected final String TEXT_431 = "() >= ";
  protected final String TEXT_432 = "() && ";
  protected final String TEXT_433 = "() <= ";
  protected final String TEXT_434 = "();";
  protected final String TEXT_435 = NL + "    return isValid;" + NL + "  }";
  protected final String TEXT_436 = NL + "  static int ";
  protected final String TEXT_437 = "::";
  protected final String TEXT_438 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_439 = ";" + NL + "  }";
  protected final String TEXT_440 = NL + "  static int ";
  protected final String TEXT_441 = "::";
  protected final String TEXT_442 = "()" + NL + "  {";
  protected final String TEXT_443 = NL + "    int required = ";
  protected final String TEXT_444 = ";";
  protected final String TEXT_445 = NL + "    return required;" + NL + "  }";
  ...
  protected final String TEXT_452 = NL + "    int minimum = ";
  protected final String TEXT_453 = ";";
  protected final String TEXT_454 = NL + "    return minimum;" + NL + "  }";
  ...
  protected final String TEXT_462 = NL + "    int maximum = ";
  protected final String TEXT_463 = ";";
  protected final String TEXT_464 = NL + "    return maximum;" + NL + "  }";
  protected final String TEXT_465 = NL + "  bool ";
  protected final String TEXT_466 = "::";
  protected final String TEXT_467 = "(";
  protected final String TEXT_468 = " ";
  protected final String TEXT_469 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_470 = NL + "    if (";
  protected final String TEXT_471 = "() >= ";
  protected final String TEXT_472 = "())" + NL + "    {";
  protected final String TEXT_473 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_474 = NL + "    ";
  protected final String TEXT_475 = ".add(";
  protected final String TEXT_476 = ");" + NL + "    if (";
  protected final String TEXT_477 = ".";
  protected final String TEXT_478 = "(this) != -1)" + NL + "    {" + NL + "      wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasAdded = ";
  protected final String TEXT_479 = ".";
  protected final String TEXT_480 = "(this);" + NL + "      if (!wasAdded)" + NL + "      {";
  protected final String TEXT_481 = NL + "        ";
  protected final String TEXT_482 = ".remove(";
  ...
  protected final String TEXT_491 = ".contains(";
  protected final String TEXT_492 = "))" + NL + "    {";
  protected final String TEXT_493 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_494 = ".indexOf(";
  protected final String TEXT_495 = ");";
  protected final String TEXT_496 = NL + "    ";
  protected final String TEXT_497 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_498 = ".";
  protected final String TEXT_499 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_500 = ".";
  protected final String TEXT_501 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_502 = NL + "        ";
  protected final String TEXT_503 = ".add(oldIndex,";
  protected final String TEXT_504 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_505 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_506 = NL + "  bool ";
  protected final String TEXT_507 = "::";
  protected final String TEXT_508 = "(";
  protected final String TEXT_509 = "* ";
  protected final String TEXT_510 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_511 = NL + "    ";
  protected final String TEXT_512 = " = ";
  protected final String TEXT_513 = ";" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_524 = ";" + NL + "      wasSet = true;" + NL + "    }";
  protected final String TEXT_525 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_534 = ") && equals(";
  protected final String TEXT_535 = ".";
  protected final String TEXT_536 = "()))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_537 = ", as existing ";
  protected final String TEXT_538 = " would become an orphan";
  protected final String TEXT_539 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_548 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  protected final String TEXT_549 = "))" + NL + "    {" + NL + "      if (";
  protected final String TEXT_550 = " != null)" + NL + "      {";
  protected final String TEXT_551 = NL + "        ";
  protected final String TEXT_552 = ".";
  protected final String TEXT_553 = " = null;" + NL + "      }" + NL + "      if (";
  protected final String TEXT_554 = " != null)" + NL + "      {";
  protected final String TEXT_555 = NL + "        ";
  protected final String TEXT_556 = ".";
  protected final String TEXT_557 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_558 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_559 = NL + "  bool ";
  protected final String TEXT_560 = "::";
  protected final String TEXT_561 = "(";
  protected final String TEXT_562 = " ";
  protected final String TEXT_563 = ")" + NL + "  {" + NL + "    bool";
  protected final String TEXT_564 = NL + "    if (";
  protected final String TEXT_565 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_566 = " to null, as ";
  protected final String TEXT_567 = " must always be associated to a ";
  protected final String TEXT_568 = NL + "      return wasSet;" + NL + "    }" + NL + "    ";
  protected final String TEXT_569 = NL + "    ";
  protected final String TEXT_570 = " ";
  protected final String TEXT_571 = " = ";
  protected final String TEXT_572 = ".";
  protected final String TEXT_573 = "();" + NL + "    if (";
  protected final String TEXT_574 = " != null && !equals(";
  protected final String TEXT_575 = "))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_576 = ", the current ";
  protected final String TEXT_577 = " already has a ";
  protected final String TEXT_578 = ", which would be orphaned if it were re-assigned";
  protected final String TEXT_579 = NL + "      return wasSet;" + NL + "    }" + NL + "    ";
  ...
  protected final String TEXT_589 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_590 = " != null)" + NL + "    {";
  protected final String TEXT_591 = NL + "      ";
  protected final String TEXT_592 = ".";
  protected final String TEXT_593 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_594 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_595 = NL + "  ";
  protected final String TEXT_596 = " ";
  protected final String TEXT_597 = "::";
  protected final String TEXT_598 = "(";
  protected final String TEXT_599 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_600 = "(";
  protected final String TEXT_601 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_602 = "::";
  protected final String TEXT_603 = "(";
  protected final String TEXT_604 = " ";
  protected final String TEXT_605 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_606 = NL + "    ";
  protected final String TEXT_607 = " ";
  protected final String TEXT_608 = " = ";
  protected final String TEXT_609 = ".";
  protected final String TEXT_610 = "();" + NL + "    bool ";
  protected final String TEXT_611 = " = ";
  protected final String TEXT_612 = " != null && !this.equals(";
  protected final String TEXT_613 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_614 = " && ";
  protected final String TEXT_615 = ".";
  protected final String TEXT_616 = "() <= ";
  protected final String TEXT_617 = "())" + NL + "    {" + NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_625 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_626 = "::";
  protected final String TEXT_627 = "(";
  protected final String TEXT_628 = " ";
  protected final String TEXT_629 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_630 = NL + "    //Unable to remove ";
  protected final String TEXT_631 = ", as it must always have a ";
  protected final String TEXT_632 = NL + "    if (this.equals(";
  protected final String TEXT_633 = ".";
  protected final String TEXT_634 = "()))" + NL + "    {";
  protected final String TEXT_635 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_636 = " already at minimum (";
  protected final String TEXT_637 = ")" + NL + "    if (";
  protected final String TEXT_638 = "() <= ";
  protected final String TEXT_639 = "())" + NL + "    {";
  protected final String TEXT_640 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_641 = NL + "    ";
  protected final String TEXT_642 = ".remove(";
  protected final String TEXT_643 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_644 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_653 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_654 = "::";
  protected final String TEXT_655 = "(";
  protected final String TEXT_656 = " ";
  protected final String TEXT_657 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_666 = "();" + NL + "    bool ";
  ...
  protected final String TEXT_674 = NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_675 = ")" + NL + "    {";
  protected final String TEXT_676 = NL + "      ";
  protected final String TEXT_677 = ".";
  protected final String TEXT_678 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_679 = NL + "      ";
  protected final String TEXT_680 = ".add(";
  protected final String TEXT_681 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_682 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_683 = "::";
  protected final String TEXT_684 = "(";
  protected final String TEXT_685 = " ";
  protected final String TEXT_686 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_687 = NL + "    //Unable to remove ";
  protected final String TEXT_688 = ", as it must always have a ";
  protected final String TEXT_689 = NL + "    if (this.equals(";
  protected final String TEXT_690 = ".";
  protected final String TEXT_691 = "()))" + NL + "    {";
  protected final String TEXT_692 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_693 = " already at minimum (";
  ...
  protected final String TEXT_700 = ");" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_708 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_709 = "(";
  protected final String TEXT_710 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_711 = "::";
  protected final String TEXT_712 = "(";
  protected final String TEXT_713 = " ";
  protected final String TEXT_714 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_715 = NL + "    if (";
  protected final String TEXT_716 = "() >= ";
  protected final String TEXT_717 = "())" + NL + "    {";
  protected final String TEXT_718 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_719 = NL + "    ";
  protected final String TEXT_720 = " ";
  protected final String TEXT_721 = " = ";
  protected final String TEXT_722 = ".";
  protected final String TEXT_723 = "();" + NL + "    bool ";
  protected final String TEXT_724 = " = ";
  protected final String TEXT_725 = " != null && !this.equals(";
  protected final String TEXT_726 = ");" + NL + "    if (";
  protected final String TEXT_727 = ")" + NL + "    {";
  protected final String TEXT_728 = NL + "      ";
  protected final String TEXT_729 = ".";
  protected final String TEXT_730 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_731 = NL + "      ";
  protected final String TEXT_732 = ".add(";
  protected final String TEXT_733 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_734 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_735 = "::";
  protected final String TEXT_736 = "(";
  protected final String TEXT_737 = " ";
  protected final String TEXT_738 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_739 = NL + "    //Unable to remove ";
  protected final String TEXT_740 = ", as it must always have a ";
  protected final String TEXT_741 = NL + "    if (!this.equals(";
  protected final String TEXT_742 = ".";
  protected final String TEXT_743 = "()))" + NL + "    {";
  protected final String TEXT_744 = NL + "      ";
  protected final String TEXT_745 = ".remove(";
  protected final String TEXT_746 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_752 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_753 = NL + "    vector<";
  protected final String TEXT_754 = "*> ";
  protected final String TEXT_755 = " = new vector<";
  protected final String TEXT_756 = "*>();" + NL + "    for (";
  protected final String TEXT_757 = " ";
  protected final String TEXT_758 = " : ";
  protected final String TEXT_759 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_760 = ".contains(";
  protected final String TEXT_761 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_762 = NL + "      ";
  protected final String TEXT_763 = ".add(";
  protected final String TEXT_764 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_765 = ".size() != ";
  protected final String TEXT_766 = ".length || ";
  protected final String TEXT_767 = ".size() > ";
  protected final String TEXT_768 = "())" + NL + "    {";
  protected final String TEXT_769 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_770 = "*> ";
  protected final String TEXT_771 = " = new vector<";
  ...
  protected final String TEXT_782 = ".contains(";
  protected final String TEXT_783 = "))" + NL + "      {";
  protected final String TEXT_784 = NL + "        ";
  protected final String TEXT_785 = ".remove(";
  ...
  protected final String TEXT_814 = " != null && !this.equals(";
  ...
  protected final String TEXT_821 = ".add(";
  ...
  protected final String TEXT_830 = NL + "    if (!this.equals(";
  protected final String TEXT_831 = ".";
  protected final String TEXT_832 = "()))" + NL + "    {";
  protected final String TEXT_833 = NL + "      ";
  protected final String TEXT_834 = ".remove(";
  protected final String TEXT_835 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_836 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_837 = NL + "  bool ";
  protected final String TEXT_838 = "::";
  protected final String TEXT_839 = "(";
  protected final String TEXT_840 = "* ";
  protected final String TEXT_841 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_855 = "(null);" + NL + "      }" + NL + "      wasSet = true;";
  ...
  protected final String TEXT_862 = ".equals(";
  protected final String TEXT_863 = "))" + NL + "    {";
  protected final String TEXT_864 = NL + "      ";
  protected final String TEXT_865 = ".";
  protected final String TEXT_866 = "(null);" + NL + "    }" + NL;
  ...
  protected final String TEXT_874 = "();" + NL + "" + NL + "    if (!equals(";
  ...
  protected final String TEXT_879 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_880 = NL + "  bool ";
  protected final String TEXT_881 = "::";
  protected final String TEXT_882 = "(";
  protected final String TEXT_883 = " ";
  protected final String TEXT_884 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_885 = NL + "    if (!";
  protected final String TEXT_886 = ".contains(";
  protected final String TEXT_887 = "))" + NL + "    {";
  protected final String TEXT_888 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_889 = "() <= ";
  protected final String TEXT_890 = "())" + NL + "    {";
  protected final String TEXT_891 = NL + "      return wasRemoved;" + NL + "    }" + NL + "\t" + NL + "    int oldIndex = std::find(";
  protected final String TEXT_892 = ".begin(), ";
  protected final String TEXT_893 = ".end(), ";
  protected final String TEXT_894 = ") - ";
  protected final String TEXT_895 = ".begin();";
  protected final String TEXT_896 = NL + "    ";
  protected final String TEXT_897 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_898 = ".";
  protected final String TEXT_899 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_900 = ".";
  protected final String TEXT_901 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_902 = NL + "        ";
  protected final String TEXT_903 = ".add(oldIndex,";
  protected final String TEXT_904 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_905 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_906 = NL + "  bool ";
  protected final String TEXT_907 = "::";
  protected final String TEXT_908 = "(";
  protected final String TEXT_909 = " ";
  protected final String TEXT_910 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_911 = NL + "    if (!";
  protected final String TEXT_912 = ".contains(";
  protected final String TEXT_913 = "))" + NL + "    {";
  protected final String TEXT_914 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_915 = "() <= ";
  protected final String TEXT_916 = "())" + NL + "    {";
  protected final String TEXT_917 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = std::find(";
  protected final String TEXT_918 = ".begin(), ";
  protected final String TEXT_919 = ".end(), ";
  protected final String TEXT_920 = ") - ";
  protected final String TEXT_921 = ".begin();";
  protected final String TEXT_922 = NL + "    ";
  protected final String TEXT_923 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_924 = ".";
  protected final String TEXT_925 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_926 = ".";
  protected final String TEXT_927 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_928 = NL + "        ";
  protected final String TEXT_929 = ".add(oldIndex,";
  protected final String TEXT_930 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_931 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_932 = NL + "  bool ";
  protected final String TEXT_933 = "::";
  protected final String TEXT_934 = "(";
  protected final String TEXT_935 = "* ";
  protected final String TEXT_936 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_943 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_956 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_957 = " != null)" + NL + "    {";
  protected final String TEXT_958 = NL + "      ";
  protected final String TEXT_959 = ".";
  protected final String TEXT_960 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_961 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_962 = NL + "  bool ";
  protected final String TEXT_963 = "::";
  protected final String TEXT_964 = "(";
  protected final String TEXT_965 = " ";
  protected final String TEXT_966 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_982 = "(this);" + NL + "    }";
  ...
  protected final String TEXT_996 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_997 = " already at maximum (";
  ...
  protected final String TEXT_1012 = ".equals(";
  protected final String TEXT_1013 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1014 = ".";
  protected final String TEXT_1015 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  protected final String TEXT_1016 = NL + "        ";
  protected final String TEXT_1017 = " = ";
  protected final String TEXT_1018 = ";";
  protected final String TEXT_1019 = NL + "        return wasSet;" + NL + "      }" + NL + "    }";
  protected final String TEXT_1020 = NL + "    ";
  protected final String TEXT_1021 = ".";
  protected final String TEXT_1022 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1023 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1024 = NL + "  bool ";
  protected final String TEXT_1025 = "::";
  protected final String TEXT_1026 = "(";
  protected final String TEXT_1027 = " ";
  protected final String TEXT_1028 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1029 = NL + "    //Must provide ";
  protected final String TEXT_1030 = " to ";
  protected final String TEXT_1031 = NL + "    if (";
  protected final String TEXT_1032 = " == null)" + NL + "    {";
  protected final String TEXT_1033 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1049 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1050 = ".";
  protected final String TEXT_1051 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1058 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1059 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1060 = NL + "  bool ";
  protected final String TEXT_1061 = "::";
  protected final String TEXT_1062 = "(";
  protected final String TEXT_1063 = " ";
  protected final String TEXT_1064 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1073 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1081 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1082 = NL + "      ";
  protected final String TEXT_1083 = ".add(";
  protected final String TEXT_1084 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1085 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1086 = "::";
  protected final String TEXT_1087 = "(";
  protected final String TEXT_1088 = " ";
  protected final String TEXT_1089 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1090 = NL + "    if (";
  protected final String TEXT_1091 = ".contains(";
  protected final String TEXT_1092 = "))" + NL + "    {";
  protected final String TEXT_1093 = NL + "      ";
  protected final String TEXT_1094 = ".remove(";
  protected final String TEXT_1095 = ");";
  protected final String TEXT_1096 = NL + "      ";
  protected final String TEXT_1097 = ".";
  protected final String TEXT_1098 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1099 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1100 = NL + "  bool ";
  protected final String TEXT_1101 = "::";
  protected final String TEXT_1102 = "(";
  protected final String TEXT_1103 = "* ";
  protected final String TEXT_1104 = ")" + NL + "  {" + NL + "    boolwasSet = false;";
  ...
  protected final String TEXT_1113 = ".equals(";
  protected final String TEXT_1114 = "))" + NL + "    {";
  protected final String TEXT_1115 = NL + "      ";
  protected final String TEXT_1116 = ".";
  protected final String TEXT_1117 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1118 = " != null)" + NL + "    {";
  protected final String TEXT_1119 = NL + "      ";
  protected final String TEXT_1120 = ".";
  protected final String TEXT_1121 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1122 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1123 = NL + "  bool ";
  protected final String TEXT_1124 = "::";
  protected final String TEXT_1125 = "(";
  protected final String TEXT_1126 = " ";
  protected final String TEXT_1127 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1128 = NL + "    if (";
  protected final String TEXT_1129 = "() >= ";
  protected final String TEXT_1130 = "())" + NL + "    {";
  protected final String TEXT_1131 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1140 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1148 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1149 = NL + "      ";
  protected final String TEXT_1150 = ".add(";
  protected final String TEXT_1151 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1152 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1153 = "::";
  protected final String TEXT_1154 = "(";
  protected final String TEXT_1155 = " ";
  protected final String TEXT_1156 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1157 = NL + "    if (";
  protected final String TEXT_1158 = ".contains(";
  protected final String TEXT_1159 = "))" + NL + "    {";
  protected final String TEXT_1160 = NL + "      ";
  protected final String TEXT_1161 = ".remove(";
  protected final String TEXT_1162 = ");";
  protected final String TEXT_1163 = NL + "      ";
  protected final String TEXT_1164 = ".";
  protected final String TEXT_1165 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1171 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1172 = NL + "    if (";
  protected final String TEXT_1173 = "() < ";
  protected final String TEXT_1174 = "())" + NL + "    {";
  protected final String TEXT_1175 = NL + "      ";
  protected final String TEXT_1176 = ".add(";
  protected final String TEXT_1177 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_1182 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1183 = NL + "    if (!";
  protected final String TEXT_1184 = ".contains(";
  protected final String TEXT_1185 = "))" + NL + "    {";
  protected final String TEXT_1186 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1191 = ".remove(";
  protected final String TEXT_1192 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1193 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1194 = NL + "  bool ";
  protected final String TEXT_1195 = "::";
  protected final String TEXT_1196 = "(";
  protected final String TEXT_1197 = " ";
  protected final String TEXT_1198 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1199 = NL + "    if (";
  protected final String TEXT_1200 = "() >= ";
  protected final String TEXT_1201 = "())" + NL + "    {";
  protected final String TEXT_1202 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1212 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1213 = " != null)" + NL + "    {";
  ...
  protected final String TEXT_1223 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1224 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1225 = "::";
  protected final String TEXT_1226 = "(";
  protected final String TEXT_1227 = " ";
  protected final String TEXT_1228 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1245 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1246 = NL + "    vector<";
  protected final String TEXT_1247 = "*> ";
  protected final String TEXT_1248 = " = new vector<";
  ...
  protected final String TEXT_1255 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1256 = ".";
  protected final String TEXT_1257 = "() != null && !this.equals(";
  protected final String TEXT_1258 = ".";
  protected final String TEXT_1259 = "()))" + NL + "      {";
  protected final String TEXT_1260 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1261 = NL + "      ";
  protected final String TEXT_1262 = ".add(";
  protected final String TEXT_1263 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1268 = ".removeAll(";
  protected final String TEXT_1269 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1270 = " orphan : ";
  protected final String TEXT_1271 = ")" + NL + "    {";
  protected final String TEXT_1272 = NL + "      ";
  protected final String TEXT_1273 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1274 = NL + "    ";
  protected final String TEXT_1275 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1284 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1285 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1286 = NL + "  void ";
  ...
  protected final String TEXT_1292 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1293 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1294 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1295 = ", ";
  protected final String TEXT_1296 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1297 = " to ";
  protected final String TEXT_1298 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1299 = NL + "  bool ";
  protected final String TEXT_1300 = "::";
  protected final String TEXT_1301 = "(";
  protected final String TEXT_1302 = " ";
  protected final String TEXT_1303 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1311 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1316 = ".remove(";
  protected final String TEXT_1317 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1323 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1329 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1330 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1331 = "::";
  protected final String TEXT_1332 = "(";
  protected final String TEXT_1333 = " ";
  protected final String TEXT_1334 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  ...
  protected final String TEXT_1339 = ".remove(";
  protected final String TEXT_1340 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1341 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1342 = NL + "  bool ";
  protected final String TEXT_1343 = "::";
  protected final String TEXT_1344 = "(";
  protected final String TEXT_1345 = " ";
  protected final String TEXT_1346 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1347 = NL + "    ";
  protected final String TEXT_1348 = ".add(";
  protected final String TEXT_1349 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1350 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1351 = "::";
  protected final String TEXT_1352 = "(";
  protected final String TEXT_1353 = " ";
  protected final String TEXT_1354 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1355 = NL + "    if (!";
  protected final String TEXT_1356 = ".contains(";
  protected final String TEXT_1357 = "))" + NL + "    {";
  protected final String TEXT_1358 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1359 = "() <= ";
  protected final String TEXT_1360 = "())" + NL + "    {";
  protected final String TEXT_1361 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1362 = NL + "    ";
  protected final String TEXT_1363 = ".remove(";
  protected final String TEXT_1364 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1365 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1366 = NL + "  bool ";
  protected final String TEXT_1367 = "::";
  protected final String TEXT_1368 = "(";
  protected final String TEXT_1369 = "... ";
  protected final String TEXT_1370 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1371 = NL + "    vector<";
  protected final String TEXT_1372 = "*> ";
  protected final String TEXT_1373 = " = new vector<";
  ...
  protected final String TEXT_1389 = ".clear();";
  ...
  protected final String TEXT_1393 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1398 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1399 = NL + "    vector<";
  protected final String TEXT_1400 = "*> ";
  protected final String TEXT_1401 = " = new vector<";
  protected final String TEXT_1402 = "*>();" + NL + "    for (";
  protected final String TEXT_1403 = " ";
  protected final String TEXT_1404 = " : ";
  protected final String TEXT_1405 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1406 = ".contains(";
  protected final String TEXT_1407 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1408 = NL + "      ";
  protected final String TEXT_1409 = ".add(";
  protected final String TEXT_1410 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1411 = ".size() != ";
  protected final String TEXT_1412 = ".length || ";
  ...
  protected final String TEXT_1417 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1418 = "*> ";
  protected final String TEXT_1419 = " = new vector<";
  ...
  protected final String TEXT_1466 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1467 = "*> ";
  protected final String TEXT_1468 = " = new vector<";
  protected final String TEXT_1469 = "*>(";
  protected final String TEXT_1470 = ");";
  protected final String TEXT_1471 = NL + "    ";
  protected final String TEXT_1472 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1492 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1493 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1494 = NL + "  bool ";
  protected final String TEXT_1495 = "::";
  protected final String TEXT_1496 = "(";
  protected final String TEXT_1497 = "... ";
  protected final String TEXT_1498 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1499 = NL + "    vector<";
  protected final String TEXT_1500 = "*> ";
  protected final String TEXT_1501 = " = new vector<";
  protected final String TEXT_1502 = "*>();" + NL + "    for (";
  protected final String TEXT_1503 = " ";
  protected final String TEXT_1504 = " : ";
  protected final String TEXT_1505 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1506 = ".contains(";
  protected final String TEXT_1507 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1508 = NL + "      ";
  protected final String TEXT_1509 = ".add(";
  protected final String TEXT_1510 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1511 = ".size() != ";
  protected final String TEXT_1512 = ".length || ";
  ...
  protected final String TEXT_1517 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1518 = NL + "    ";
  protected final String TEXT_1519 = ".clear();";
  protected final String TEXT_1520 = NL + "    ";
  protected final String TEXT_1521 = ".addAll(";
  protected final String TEXT_1522 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1523 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1524 = NL + "  bool ";
  protected final String TEXT_1525 = "::";
  protected final String TEXT_1526 = "(";
  protected final String TEXT_1527 = "... ";
  protected final String TEXT_1528 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1529 = NL + "    if (";
  protected final String TEXT_1530 = ".length < ";
  protected final String TEXT_1531 = "()";
  protected final String TEXT_1532 = ")" + NL + "    {";
  protected final String TEXT_1533 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1534 = "*> ";
  protected final String TEXT_1535 = " = new vector<";
  protected final String TEXT_1536 = "*>();" + NL + "    HashMap<";
  protected final String TEXT_1537 = ",Integer> ";
  protected final String TEXT_1538 = " = new HashMap<";
  protected final String TEXT_1539 = ",Integer>();" + NL + "    for (";
  protected final String TEXT_1540 = " ";
  protected final String TEXT_1541 = " : ";
  protected final String TEXT_1542 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1543 = ".contains(";
  protected final String TEXT_1544 = "))" + NL + "      {";
  protected final String TEXT_1545 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1546 = ".";
  protected final String TEXT_1547 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1555 = ".containsKey(";
  protected final String TEXT_1556 = "))" + NL + "        {";
  protected final String TEXT_1557 = NL + "          ";
  protected final String TEXT_1558 = ".put(";
  protected final String TEXT_1559 = ", new Integer(";
  protected final String TEXT_1560 = ".";
  protected final String TEXT_1561 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1562 = ".get(";
  protected final String TEXT_1563 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  ...
  protected final String TEXT_1567 = ".put(";
  protected final String TEXT_1568 = ", new Integer(nextCount));" + NL + "      }";
  protected final String TEXT_1569 = NL + "      ";
  protected final String TEXT_1570 = ".add(";
  protected final String TEXT_1571 = ");" + NL + "    }" + NL;
  protected final String TEXT_1572 = NL + "    ";
  protected final String TEXT_1573 = ".removeAll(";
  protected final String TEXT_1574 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1575 = " orphan : ";
  protected final String TEXT_1576 = ")" + NL + "    {";
  protected final String TEXT_1577 = NL + "      ";
  protected final String TEXT_1578 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1579 = NL + "    ";
  protected final String TEXT_1580 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1589 = ".remove(";
  ...
  protected final String TEXT_1595 = ".add(";
  protected final String TEXT_1596 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1597 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1598 = NL + "  void ";
  ...
  protected final String TEXT_1604 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1605 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1606 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1607 = ", ";
  protected final String TEXT_1608 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1609 = " to ";
  protected final String TEXT_1610 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1611 = NL + "  bool ";
  protected final String TEXT_1612 = "::";
  protected final String TEXT_1613 = "(";
  protected final String TEXT_1614 = "... ";
  protected final String TEXT_1615 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1616 = NL + "    vector<";
  protected final String TEXT_1617 = "*> ";
  protected final String TEXT_1618 = " = new vector<";
  protected final String TEXT_1619 = "*>();" + NL + "    for (";
  protected final String TEXT_1620 = " ";
  protected final String TEXT_1621 = " : ";
  protected final String TEXT_1622 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1623 = ".contains(";
  protected final String TEXT_1624 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1625 = NL + "      ";
  protected final String TEXT_1626 = ".add(";
  protected final String TEXT_1627 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1628 = ".size() != ";
  protected final String TEXT_1629 = ".length || ";
  protected final String TEXT_1630 = ".size() > ";
  protected final String TEXT_1631 = "())" + NL + "    {";
  protected final String TEXT_1632 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1633 = NL + "    ";
  protected final String TEXT_1634 = ".clear();";
  protected final String TEXT_1635 = NL + "    ";
  protected final String TEXT_1636 = ".addAll(";
  protected final String TEXT_1637 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1638 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1639 = NL + "  bool ";
  protected final String TEXT_1640 = "::";
  protected final String TEXT_1641 = "(";
  protected final String TEXT_1642 = "... ";
  protected final String TEXT_1643 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1644 = NL + "    vector<";
  protected final String TEXT_1645 = "*> ";
  protected final String TEXT_1646 = " = new vector<";
  protected final String TEXT_1647 = "*>();" + NL + "    for (";
  protected final String TEXT_1648 = " ";
  protected final String TEXT_1649 = " : ";
  protected final String TEXT_1650 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1651 = ".contains(";
  protected final String TEXT_1652 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1653 = NL + "      ";
  protected final String TEXT_1654 = ".add(";
  protected final String TEXT_1655 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1656 = ".size() != ";
  protected final String TEXT_1657 = ".length || ";
  protected final String TEXT_1658 = ".size() < ";
  protected final String TEXT_1659 = "())" + NL + "    {";
  protected final String TEXT_1660 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1661 = NL + "    ";
  protected final String TEXT_1662 = ".clear();";
  protected final String TEXT_1663 = NL + "    ";
  protected final String TEXT_1664 = ".addAll(";
  protected final String TEXT_1665 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1666 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1667 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1668 = NL + "    ";
  protected final String TEXT_1669 = " == (";
  protected final String TEXT_1670 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1671 = NL + "    ";
  protected final String TEXT_1672 = NL;
  protected final String TEXT_1673 = NL + "    ";
  protected final String TEXT_1674 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1675 = NL + "   void ";
  protected final String TEXT_1676 = "::";
  protected final String TEXT_1677 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1678 = NL + "       ";
  protected final String TEXT_1679 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1680 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1681 = NL + "    ";
  protected final String TEXT_1682 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1683 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1684 = NL + "      ";
  protected final String TEXT_1685 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1686 = NL + "  void ";
  protected final String TEXT_1687 = "::";
  protected final String TEXT_1688 = "()" + NL + "  {";
  protected final String TEXT_1689 = NL + "    ";
  protected final String TEXT_1690 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1691 = "\",";
  protected final String TEXT_1692 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1693 = "::";
  protected final String TEXT_1694 = "()" + NL + "  {";
  protected final String TEXT_1695 = NL + "    ";
  protected final String TEXT_1696 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1697 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1698 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1699 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1700 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1701 = "::run ()" + NL + "    {";
  protected final String TEXT_1702 = NL + "      if (\"";
  protected final String TEXT_1703 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1704 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1705 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1706 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1707 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1708 = NL + "    ";
  protected final String TEXT_1709 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1710 = ";";
  protected final String TEXT_1711 = NL + "    ";
  protected final String TEXT_1712 = ".clear();";
  ...
  protected final String TEXT_1718 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1719 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1720 = ";" + NL + "    }";
  protected final String TEXT_1721 = NL + "    if (";
  protected final String TEXT_1722 = " != NULL)" + NL + "    {";
  protected final String TEXT_1723 = NL + "      ";
  protected final String TEXT_1724 = ".";
  protected final String TEXT_1725 = "(NULL);" + NL + "    }";
  ...
  protected final String TEXT_1731 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1732 = " != NULL)" + NL + "    {";
  ...
  protected final String TEXT_1741 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1742 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1743 = ";" + NL + "    }";
  protected final String TEXT_1744 = NL + "    if (";
  protected final String TEXT_1745 = " != null)" + NL + "    {";
  ...
  protected final String TEXT_1779 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1780 = "); i++)" + NL + "    {";
  protected final String TEXT_1781 = NL + "      ";
  protected final String TEXT_1782 = "(";
  protected final String TEXT_1783 = "[i],NULL);" + NL + "    }";
  protected final String TEXT_1784 = NL + "    ";
  protected final String TEXT_1785 = ".clear();";
  protected final String TEXT_1786 = NL + "    vector<";
  protected final String TEXT_1787 = "> ";
  protected final String TEXT_1788 = " = vector<";
  ...
  protected final String TEXT_1793 = "); i++)" + NL + "     {" + NL + "      if (";
  protected final String TEXT_1794 = ".";
  protected final String TEXT_1795 = "() <= ";
  protected final String TEXT_1796 = ".";
  protected final String TEXT_1797 = "())" + NL + "      {" + NL + "        delete ";
  protected final String TEXT_1798 = "[i];" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1799 = NL + "        ";
  protected final String TEXT_1800 = ".";
  protected final String TEXT_1801 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1802 = NL + "    vector<";
  protected final String TEXT_1803 = "> ";
  protected final String TEXT_1804 = " = new vector<";
  protected final String TEXT_1805 = ">(";
  protected final String TEXT_1806 = ");";
  protected final String TEXT_1807 = NL + "    ";
  protected final String TEXT_1808 = ".clear();" + NL + "    for(int i=0;sizeof(";
  protected final String TEXT_1809 = ");i++)" + NL + "    {";
  protected final String TEXT_1810 = NL + "      ";
  protected final String TEXT_1811 = "[i].";
  protected final String TEXT_1812 = "(this);" + NL + "    }";
  protected final String TEXT_1813 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1814 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1815 = "[i];" + NL + "    }";
  protected final String TEXT_1816 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1817 = "); i++)" + NL + "    {";
  protected final String TEXT_1818 = NL + "      ";
  protected final String TEXT_1819 = "[i].";
  protected final String TEXT_1820 = "(NULL);" + NL + "    }";
  protected final String TEXT_1821 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
