...
public class CppClassGenerator implements ILang 
{
  ...
  protected final String TEXT_536 = ") && equals(";
  ...
  protected final String TEXT_550 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  ...
  protected final String TEXT_576 = " != null && !equals(";
  ...
  protected final String TEXT_757 = " = new vector<";
  protected final String TEXT_758 = "*>();" + NL + "    for (";
  protected final String TEXT_759 = " ";
  protected final String TEXT_760 = " : ";
  protected final String TEXT_761 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_762 = ".contains(";
  ...
  protected final String TEXT_773 = " = new vector<";
  protected final String TEXT_774 = "*>(";
  protected final String TEXT_775 = ");";
  protected final String TEXT_776 = NL + "    ";
  protected final String TEXT_777 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_784 = ".contains(";
  protected final String TEXT_785 = "))" + NL + "      {";
  protected final String TEXT_786 = NL + "        ";
  protected final String TEXT_787 = ".remove(";
  protected final String TEXT_788 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_789 = NL + "        ";
  protected final String TEXT_790 = ".";
  protected final String TEXT_791 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_792 = " ";
  protected final String TEXT_793 = " : ";
  protected final String TEXT_794 = ")" + NL + "    {";
  protected final String TEXT_795 = NL + "      ";
  protected final String TEXT_796 = ".";
  protected final String TEXT_797 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_798 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_799 = NL + "  ";
  protected final String TEXT_800 = " ";
  protected final String TEXT_801 = "::";
  protected final String TEXT_802 = "(";
  protected final String TEXT_803 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_804 = "(";
  protected final String TEXT_805 = ");" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_806 = "::";
  protected final String TEXT_807 = "(";
  protected final String TEXT_808 = "* ";
  protected final String TEXT_809 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_810 = NL + "    ";
  protected final String TEXT_811 = " ";
  protected final String TEXT_812 = " = ";
  protected final String TEXT_813 = ".";
  protected final String TEXT_814 = "();" + NL + "    bool ";
  protected final String TEXT_815 = " = (";
  protected final String TEXT_816 = " != NULL && this!=";
  protected final String TEXT_817 = ");" + NL + "    if (";
  protected final String TEXT_818 = ")" + NL + "    {";
  protected final String TEXT_819 = NL + "      ";
  protected final String TEXT_820 = "->";
  protected final String TEXT_821 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_822 = NL + "      ";
  protected final String TEXT_823 = "->push_back(";
  protected final String TEXT_824 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_825 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_826 = "::";
  protected final String TEXT_827 = "(";
  protected final String TEXT_828 = "* ";
  protected final String TEXT_829 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_830 = NL + "    //Unable to remove ";
  protected final String TEXT_831 = ", as it must always have a ";
  protected final String TEXT_832 = NL + "    if (this!=";
  protected final String TEXT_833 = "->";
  protected final String TEXT_834 = "())" + NL + "    {";
  protected final String TEXT_835 = NL + "      ";
  protected final String TEXT_836 = "->erase(find(";
  protected final String TEXT_837 = ".begin(),";
  protected final String TEXT_838 = ".end(),";
  protected final String TEXT_839 = "));" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_840 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_841 = NL + "  bool ";
  protected final String TEXT_842 = "::";
  protected final String TEXT_843 = "(";
  protected final String TEXT_844 = "* ";
  protected final String TEXT_845 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_853 = " = null;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_859 = "(null);" + NL + "      }" + NL + "      wasSet = true;";
  ...
  protected final String TEXT_878 = "();" + NL + "" + NL + "    if (!equals(";
  protected final String TEXT_879 = "))" + NL + "    {";
  protected final String TEXT_880 = NL + "      ";
  protected final String TEXT_881 = ".";
  protected final String TEXT_882 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_883 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_884 = NL + "  bool ";
  protected final String TEXT_885 = "::";
  protected final String TEXT_886 = "(";
  protected final String TEXT_887 = " ";
  protected final String TEXT_888 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_889 = NL + "    if (! find(";
  protected final String TEXT_890 = ".begin(),";
  protected final String TEXT_891 = ".end(),";
  protected final String TEXT_892 = "))" + NL + "    {";
  protected final String TEXT_893 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_894 = "() <= ";
  protected final String TEXT_895 = "())" + NL + "    {";
  protected final String TEXT_896 = NL + "      return wasRemoved;" + NL + "    }" + NL + "\t" + NL + "    int oldIndex = find(";
  protected final String TEXT_897 = ".begin(), ";
  protected final String TEXT_898 = ".end(), ";
  protected final String TEXT_899 = ") - ";
  protected final String TEXT_900 = ".begin();";
  protected final String TEXT_901 = NL + "    ";
  protected final String TEXT_902 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_903 = "->";
  protected final String TEXT_904 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_905 = "->";
  protected final String TEXT_906 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_907 = NL + "        ";
  protected final String TEXT_908 = "->add(oldIndex,";
  protected final String TEXT_909 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_910 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_911 = NL + "  bool ";
  protected final String TEXT_912 = "::";
  protected final String TEXT_913 = "(";
  protected final String TEXT_914 = " ";
  protected final String TEXT_915 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_916 = NL + "    if (! find(";
  protected final String TEXT_917 = ".begin(),";
  protected final String TEXT_918 = ".end(),";
  protected final String TEXT_919 = "))" + NL + "    {";
  protected final String TEXT_920 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_921 = "() <= ";
  protected final String TEXT_922 = "())" + NL + "    {";
  protected final String TEXT_923 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = find(";
  ...
  protected final String TEXT_929 = ".erase(oldIndex);" + NL + "    if (";
  protected final String TEXT_930 = ".";
  protected final String TEXT_931 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_932 = ".";
  protected final String TEXT_933 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_934 = NL + "        ";
  protected final String TEXT_935 = ".add(oldIndex,";
  protected final String TEXT_936 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_937 = NL + "    return wasRemoved;" + NL + "  }";
  ...
  protected final String TEXT_988 = "(this);" + NL + "    }";
  protected final String TEXT_989 = NL + "    ";
  protected final String TEXT_990 = "->";
  protected final String TEXT_991 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_992 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_993 = NL + "  bool ";
  protected final String TEXT_994 = "::";
  protected final String TEXT_995 = "(";
  protected final String TEXT_996 = " ";
  protected final String TEXT_997 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_998 = NL + "    //Must provide ";
  protected final String TEXT_999 = " to ";
  protected final String TEXT_1000 = NL + "    if (";
  protected final String TEXT_1001 = " == null)" + NL + "    {";
  protected final String TEXT_1002 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_1003 = " already at maximum (";
  protected final String TEXT_1004 = ")" + NL + "    if (";
  protected final String TEXT_1005 = ".";
  protected final String TEXT_1006 = "() >= ";
  protected final String TEXT_1007 = ".";
  protected final String TEXT_1008 = "())" + NL + "    {";
  protected final String TEXT_1009 = NL + "      return wasSet;" + NL + "    }" + NL + "    ";
  ...
  protected final String TEXT_1019 = "))" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1020 = ".";
  protected final String TEXT_1021 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1028 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1029 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1030 = NL + "  bool ";
  protected final String TEXT_1031 = "::";
  protected final String TEXT_1032 = "(";
  protected final String TEXT_1033 = "* ";
  protected final String TEXT_1034 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1035 = NL + "    //Must provide ";
  protected final String TEXT_1036 = " to ";
  protected final String TEXT_1037 = NL + "    if (";
  protected final String TEXT_1038 = " == null)" + NL + "    {";
  protected final String TEXT_1039 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1055 = ")" + NL + "    {" + NL + "      bool didRemove = ";
  protected final String TEXT_1056 = ".";
  protected final String TEXT_1057 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1064 = "(this);" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1079 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1087 = ");" + NL + "    } " + NL + "    else" + NL + "    {";
  protected final String TEXT_1088 = NL + "      ";
  protected final String TEXT_1089 = ".push_back(";
  protected final String TEXT_1090 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1091 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1092 = "::";
  protected final String TEXT_1093 = "(";
  protected final String TEXT_1094 = "* ";
  protected final String TEXT_1095 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1096 = NL + "    if (find(";
  protected final String TEXT_1097 = ".begin(),";
  protected final String TEXT_1098 = ".end(),(";
  protected final String TEXT_1099 = ")))" + NL + "    {";
  protected final String TEXT_1100 = NL + "      ";
  protected final String TEXT_1101 = ".erase(find(";
  protected final String TEXT_1102 = ".begin(),";
  protected final String TEXT_1103 = ".end(),";
  protected final String TEXT_1104 = "));";
  protected final String TEXT_1105 = NL + "      ";
  protected final String TEXT_1106 = "->";
  protected final String TEXT_1107 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1108 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1109 = NL + "  bool ";
  protected final String TEXT_1110 = "::";
  protected final String TEXT_1111 = "(";
  protected final String TEXT_1112 = "* ";
  protected final String TEXT_1113 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  ...
  protected final String TEXT_1126 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1127 = " != NULL)" + NL + "    {";
  protected final String TEXT_1128 = NL + "      ";
  protected final String TEXT_1129 = "->";
  protected final String TEXT_1130 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1131 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1132 = NL + "  bool ";
  protected final String TEXT_1133 = "::";
  protected final String TEXT_1134 = "(";
  protected final String TEXT_1135 = " ";
  protected final String TEXT_1136 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1137 = NL + "    if (";
  protected final String TEXT_1138 = "() >= ";
  protected final String TEXT_1139 = "())" + NL + "    {";
  protected final String TEXT_1140 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1146 = " == NULL)" + NL + "    {";
  protected final String TEXT_1147 = NL + "      ";
  protected final String TEXT_1148 = ".";
  protected final String TEXT_1149 = "(this);" + NL + "    }" + NL + "    else if (this!=";
  ...
  protected final String TEXT_1157 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1158 = NL + "      ";
  protected final String TEXT_1159 = ".add(";
  protected final String TEXT_1160 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  ...
  protected final String TEXT_1166 = NL + "    if (find(";
  protected final String TEXT_1167 = ".begin(),";
  protected final String TEXT_1168 = ".end(),";
  ...
  protected final String TEXT_1175 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1186 = ".push_back(";
  protected final String TEXT_1187 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_1193 = NL + "    if (!find(";
  protected final String TEXT_1194 = ".begin(),";
  protected final String TEXT_1195 = ".end(),";
  protected final String TEXT_1196 = ")))" + NL + "    {";
  protected final String TEXT_1197 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1202 = "erase(";
  protected final String TEXT_1203 = ");" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_1209 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1223 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  ...
  protected final String TEXT_1234 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1235 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1236 = "::";
  protected final String TEXT_1237 = "(";
  protected final String TEXT_1238 = " ";
  protected final String TEXT_1239 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1240 = NL + "    if (find(";
  protected final String TEXT_1241 = ".begin(),";
  protected final String TEXT_1242 = ".end(),";
  protected final String TEXT_1243 = ") && ";
  protected final String TEXT_1244 = "() > ";
  protected final String TEXT_1245 = "())" + NL + "    {";
  protected final String TEXT_1246 = NL + "      ";
  protected final String TEXT_1247 = ".remove(";
  protected final String TEXT_1248 = ");";
  protected final String TEXT_1249 = NL + "      ";
  protected final String TEXT_1250 = "(";
  protected final String TEXT_1251 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1252 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1253 = NL + "  bool ";
  protected final String TEXT_1254 = "::";
  protected final String TEXT_1255 = "(";
  protected final String TEXT_1256 = "... ";
  protected final String TEXT_1257 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1258 = NL + "    vector<";
  protected final String TEXT_1259 = "*> ";
  protected final String TEXT_1260 = " = new vector<";
  protected final String TEXT_1261 = "*>();" + NL + "    for (";
  protected final String TEXT_1262 = " ";
  protected final String TEXT_1263 = " : ";
  protected final String TEXT_1264 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1265 = ".contains(";
  protected final String TEXT_1266 = "))" + NL + "      {";
  protected final String TEXT_1267 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1268 = ".";
  protected final String TEXT_1269 = "() != null && !this.equals(";
  protected final String TEXT_1270 = ".";
  protected final String TEXT_1271 = "()))" + NL + "      {";
  protected final String TEXT_1272 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1273 = NL + "      ";
  protected final String TEXT_1274 = ".add(";
  protected final String TEXT_1275 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1280 = ".removeAll(";
  protected final String TEXT_1281 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1282 = " orphan : ";
  protected final String TEXT_1283 = ")" + NL + "    {";
  protected final String TEXT_1284 = NL + "      ";
  protected final String TEXT_1285 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1286 = NL + "    ";
  protected final String TEXT_1287 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1296 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1297 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1298 = NL + "  void ";
  ...
  protected final String TEXT_1304 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1305 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1306 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1307 = ", ";
  protected final String TEXT_1308 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1309 = " to ";
  protected final String TEXT_1310 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1311 = NL + "  bool ";
  protected final String TEXT_1312 = "::";
  protected final String TEXT_1313 = "(";
  protected final String TEXT_1314 = " ";
  protected final String TEXT_1315 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1316 = NL + "    ";
  protected final String TEXT_1317 = "push_back(";
  protected final String TEXT_1318 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1319 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1320 = "::";
  protected final String TEXT_1321 = "(";
  protected final String TEXT_1322 = "* ";
  protected final String TEXT_1323 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1324 = NL + "    if (find(";
  protected final String TEXT_1325 = ".begin(),";
  protected final String TEXT_1326 = ".end(),";
  protected final String TEXT_1327 = ") - ";
  protected final String TEXT_1328 = ".end()))" + NL + "    {";
  protected final String TEXT_1329 = NL + "      ";
  protected final String TEXT_1330 = ".erase(find(";
  protected final String TEXT_1331 = ".begin(),";
  protected final String TEXT_1332 = ".end(),";
  protected final String TEXT_1333 = "));" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1339 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  ...
  protected final String TEXT_1344 = ".push_back(";
  protected final String TEXT_1345 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1346 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1347 = "::";
  protected final String TEXT_1348 = "(";
  protected final String TEXT_1349 = "* ";
  protected final String TEXT_1350 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1351 = NL + "    if (find(";
  protected final String TEXT_1352 = ".begin(),";
  protected final String TEXT_1353 = ".end(),";
  protected final String TEXT_1354 = "))" + NL + "    {";
  protected final String TEXT_1355 = NL + "      ";
  protected final String TEXT_1356 = "erase(";
  protected final String TEXT_1357 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1358 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_1359 = NL + "  bool ";
  protected final String TEXT_1360 = "::";
  protected final String TEXT_1361 = "(";
  protected final String TEXT_1362 = "* ";
  protected final String TEXT_1363 = ")" + NL + "  {" + NL + "    bool wasAdded = false;";
  protected final String TEXT_1364 = NL + "    ";
  protected final String TEXT_1365 = ".push_back(";
  protected final String TEXT_1366 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1367 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  bool ";
  protected final String TEXT_1368 = "::";
  protected final String TEXT_1369 = "(";
  protected final String TEXT_1370 = "* ";
  protected final String TEXT_1371 = ")" + NL + "  {" + NL + "    bool wasRemoved = false;";
  protected final String TEXT_1372 = NL + "    if (!find(";
  protected final String TEXT_1373 = ".begin(),";
  protected final String TEXT_1374 = ".end(),";
  protected final String TEXT_1375 = ")))" + NL + "    {";
  protected final String TEXT_1376 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1377 = "() <= ";
  protected final String TEXT_1378 = "())" + NL + "    {";
  protected final String TEXT_1379 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1380 = NL + "    ";
  protected final String TEXT_1381 = ".erase(find(";
  protected final String TEXT_1382 = ".begin(),";
  protected final String TEXT_1383 = ".end(),";
  protected final String TEXT_1384 = "));" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_1393 = " = new vector<";
  ...
  protected final String TEXT_1411 = ".addAll(";
  protected final String TEXT_1412 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1413 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1414 = NL + "  ";
  protected final String TEXT_1415 = " bool ";
  protected final String TEXT_1416 = "(";
  protected final String TEXT_1417 = "... ";
  protected final String TEXT_1418 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1419 = NL + "    vector<";
  protected final String TEXT_1420 = "*> ";
  protected final String TEXT_1421 = ";" + NL + "    for (int i=0 ; i<";
  protected final String TEXT_1422 = ".size() ; i++)" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1423 = ".begin(),";
  protected final String TEXT_1424 = ".end(),(";
  protected final String TEXT_1425 = ") - ";
  protected final String TEXT_1426 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1427 = NL + "      ";
  protected final String TEXT_1428 = ".push_back(";
  protected final String TEXT_1429 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1430 = ".size() != ";
  protected final String TEXT_1431 = ".length)" + NL + "    {";
  protected final String TEXT_1432 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1433 = NL + "    ";
  protected final String TEXT_1434 = ".clear();";
  protected final String TEXT_1435 = NL + "    ";
  protected final String TEXT_1436 = ".addAll(";
  protected final String TEXT_1437 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1438 = NL + "    return wasSet;" + NL + "  }" + NL;
  ...
  protected final String TEXT_1443 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1444 = NL + "    vector<";
  protected final String TEXT_1445 = "*> ";
  protected final String TEXT_1446 = " = new vector<";
  protected final String TEXT_1447 = "*>();" + NL + "    for (";
  protected final String TEXT_1448 = " ";
  protected final String TEXT_1449 = " : ";
  protected final String TEXT_1450 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1451 = ".contains(";
  protected final String TEXT_1452 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1453 = NL + "      ";
  protected final String TEXT_1454 = ".add(";
  protected final String TEXT_1455 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1456 = ".size() != ";
  protected final String TEXT_1457 = ".length || ";
  ...
  protected final String TEXT_1462 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    vector<";
  protected final String TEXT_1463 = "*> ";
  protected final String TEXT_1464 = " = new vector<";
  protected final String TEXT_1465 = "*>(";
  protected final String TEXT_1466 = ");";
  protected final String TEXT_1467 = NL + "    ";
  protected final String TEXT_1468 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1478 = ".remove(";
  ...
  protected final String TEXT_1497 = " = new vector<";
  protected final String TEXT_1498 = "*>();" + NL + "    for (";
  protected final String TEXT_1499 = " ";
  protected final String TEXT_1500 = " : ";
  protected final String TEXT_1501 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1502 = ".contains(";
  protected final String TEXT_1503 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1504 = NL + "      ";
  protected final String TEXT_1505 = ".add(";
  ...
  protected final String TEXT_1546 = " = new vector<";
  ...
  protected final String TEXT_1580 = " = new vector<";
  protected final String TEXT_1581 = "*>();" + NL + "    HashMap<";
  protected final String TEXT_1582 = ",Integer> ";
  protected final String TEXT_1583 = " = new HashMap<";
  protected final String TEXT_1584 = ",Integer>();" + NL + "    for (";
  protected final String TEXT_1585 = " ";
  protected final String TEXT_1586 = " : ";
  protected final String TEXT_1587 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1588 = ".contains(";
  protected final String TEXT_1589 = "))" + NL + "      {";
  protected final String TEXT_1590 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1591 = ".";
  protected final String TEXT_1592 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1600 = ".containsKey(";
  protected final String TEXT_1601 = "))" + NL + "        {";
  protected final String TEXT_1602 = NL + "          ";
  protected final String TEXT_1603 = ".put(";
  protected final String TEXT_1604 = ", new Integer(";
  protected final String TEXT_1605 = ".";
  protected final String TEXT_1606 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1607 = ".get(";
  protected final String TEXT_1608 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  ...
  protected final String TEXT_1613 = ", new Integer(nextCount));" + NL + "      }";
  protected final String TEXT_1614 = NL + "      ";
  protected final String TEXT_1615 = ".add(";
  protected final String TEXT_1616 = ");" + NL + "    }" + NL;
  protected final String TEXT_1617 = NL + "    ";
  protected final String TEXT_1618 = ".removeAll(";
  protected final String TEXT_1619 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1620 = " orphan : ";
  protected final String TEXT_1621 = ")" + NL + "    {";
  protected final String TEXT_1622 = NL + "      ";
  protected final String TEXT_1623 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1624 = NL + "    ";
  protected final String TEXT_1625 = ".clear();" + NL + "    for (";
  protected final String TEXT_1626 = " ";
  protected final String TEXT_1627 = " : ";
  protected final String TEXT_1628 = ")" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1638 = ", this);";
  protected final String TEXT_1639 = NL + "      ";
  protected final String TEXT_1640 = ".add(";
  protected final String TEXT_1641 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1642 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1643 = NL + "  void ";
  ...
  protected final String TEXT_1649 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1650 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1651 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1652 = ", ";
  protected final String TEXT_1653 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1654 = " to ";
  protected final String TEXT_1655 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1656 = NL + "  bool ";
  protected final String TEXT_1657 = "::";
  protected final String TEXT_1658 = "(";
  protected final String TEXT_1659 = "... ";
  protected final String TEXT_1660 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1661 = NL + "    vector<";
  protected final String TEXT_1662 = "*> ";
  protected final String TEXT_1663 = " = new vector<";
  protected final String TEXT_1664 = "*>();" + NL + "    for (";
  protected final String TEXT_1665 = " ";
  protected final String TEXT_1666 = " : ";
  protected final String TEXT_1667 = ")" + NL + "    {" + NL + "      if (find(";
  protected final String TEXT_1668 = ".begin(),";
  protected final String TEXT_1669 = ".end(),(";
  protected final String TEXT_1670 = ")) - ";
  protected final String TEXT_1671 = ".end())" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1672 = NL + "      ";
  protected final String TEXT_1673 = ".add(";
  protected final String TEXT_1674 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1675 = ".size() != ";
  protected final String TEXT_1676 = ".length || ";
  ...
  protected final String TEXT_1681 = ".clear();";
  protected final String TEXT_1682 = NL + "    ";
  protected final String TEXT_1683 = ".addAll(";
  protected final String TEXT_1684 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1685 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1686 = NL + "  bool ";
  protected final String TEXT_1687 = "::";
  protected final String TEXT_1688 = "(";
  protected final String TEXT_1689 = "... ";
  protected final String TEXT_1690 = ")" + NL + "  {" + NL + "    bool wasSet = false;";
  protected final String TEXT_1691 = NL + "    vector<";
  protected final String TEXT_1692 = "*> ";
  protected final String TEXT_1693 = " = new vector<";
  ...
  protected final String TEXT_1707 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1708 = NL + "    ";
  protected final String TEXT_1709 = ".clear();";
  protected final String TEXT_1710 = NL + "    ";
  protected final String TEXT_1711 = ".addAll(";
  protected final String TEXT_1712 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1713 = NL + "    return wasSet;" + NL + "  }";
  protected final String TEXT_1714 = NL + "  bool equals(Object obj)" + NL + "  {" + NL + "    if (obj == NULL) { return false; }" + NL + "    if (getClass() != obj.getClass()) { return false; }" + NL;
  protected final String TEXT_1715 = NL + "    ";
  protected final String TEXT_1716 = " == (";
  protected final String TEXT_1717 = ")obj;" + NL + "  " + NL + "    return true;" + NL + "  }" + NL + "" + NL + " int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1718 = NL + "    ";
  protected final String TEXT_1719 = NL;
  protected final String TEXT_1720 = NL + "    ";
  protected final String TEXT_1721 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1722 = NL + "   void ";
  protected final String TEXT_1723 = "::";
  protected final String TEXT_1724 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_1725 = NL + "       ";
  protected final String TEXT_1726 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_1727 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1728 = NL + "    ";
  protected final String TEXT_1729 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1730 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1731 = NL + "      ";
  protected final String TEXT_1732 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1733 = NL + "  void ";
  protected final String TEXT_1734 = "::";
  protected final String TEXT_1735 = "()" + NL + "  {";
  protected final String TEXT_1736 = NL + "    ";
  protected final String TEXT_1737 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1738 = "\",";
  protected final String TEXT_1739 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_1740 = "::";
  protected final String TEXT_1741 = "()" + NL + "  {";
  protected final String TEXT_1742 = NL + "    ";
  protected final String TEXT_1743 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1744 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1745 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1746 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1747 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_1748 = "::run ()" + NL + "    {";
  protected final String TEXT_1749 = NL + "      if (\"";
  protected final String TEXT_1750 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1751 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1752 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1753 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1754 = NL + "  " + NL + "  //------------------------" + NL + "  // DESTRUCTOR" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_1755 = NL + "    ";
  protected final String TEXT_1756 = " = NULL;" + NL + "    delete ";
  protected final String TEXT_1757 = ";";
  protected final String TEXT_1758 = NL + "    ";
  protected final String TEXT_1759 = ".clear();";
  ...
  protected final String TEXT_1765 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1766 = " != NULL)" + NL + "    {" + NL + "      delete ";
  ...
  protected final String TEXT_1778 = " = NULL;" + NL + "    if (";
  ...
  protected final String TEXT_1788 = " = NULL;" + NL + "    if (";
  protected final String TEXT_1789 = " != NULL)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1790 = ";" + NL + "    }";
  protected final String TEXT_1791 = NL + "    if (";
  protected final String TEXT_1792 = " != NULL)" + NL + "    {";
  protected final String TEXT_1793 = NL + "      ";
  protected final String TEXT_1794 = "* ";
  protected final String TEXT_1795 = " = ";
  protected final String TEXT_1796 = ";" + NL + "      this->";
  ...
  protected final String TEXT_1851 = " = new vector<";
  protected final String TEXT_1852 = ">(";
  protected final String TEXT_1853 = ");";
  protected final String TEXT_1854 = NL + "    ";
  protected final String TEXT_1855 = ".clear();" + NL + "    for(int i=0;sizeof(";
  protected final String TEXT_1856 = ");i++)" + NL + "    {";
  protected final String TEXT_1857 = NL + "      ";
  protected final String TEXT_1858 = "[i].";
  protected final String TEXT_1859 = "(this);" + NL + "    }";
  protected final String TEXT_1860 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1861 = "); i++)" + NL + "    {" + NL + "      delete ";
  protected final String TEXT_1862 = "[i];" + NL + "    }";
  protected final String TEXT_1863 = NL + "    for( int i =0; sizeof(";
  protected final String TEXT_1864 = "); i++)" + NL + "    {";
  protected final String TEXT_1865 = NL + "      ";
  protected final String TEXT_1866 = "[i].";
  protected final String TEXT_1867 = "(NULL);" + NL + "    }";
  protected final String TEXT_1868 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "   ";
