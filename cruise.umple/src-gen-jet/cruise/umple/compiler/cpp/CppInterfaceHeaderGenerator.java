...
public class CppInterfaceHeaderGenerator implements ILang 
{
  ...
  public static synchronized CppInterfaceHeaderGenerator create(String lineSeparator)
  {
    nl = lineSeparator;
    CppInterfaceHeaderGenerator result = new CppInterfaceHeaderGenerator();
    nl = null;
    return result;
  }

  public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
  protected final String TEXT_1 = "/* EXPERIMENTAL CODE - NON COMPILEABLE VERSION OF C++ */" + NL + "/*PLEASE DO NOT EDIT THIS CODE*/" + NL + "/*This code was generated using the UMPLE 1.21.0.4666 modeling language!*/";
  protected final String TEXT_2 = NL + NL + "#ifndef ";
  protected final String TEXT_3 = "_H_" + NL + "#define ";
  protected final String TEXT_4 = "_H_" + NL;
  ...
  */
  ...
  if (uInterface.getExtraCode() != null)
  {
    ...
    stringBuffer.append(uInterface.getName().toUpperCase());
