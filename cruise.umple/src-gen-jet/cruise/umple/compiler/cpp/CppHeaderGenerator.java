...
public class CppHeaderGenerator implements ILang 
{
  ...
  protected final String TEXT_9 = NL + "  " + NL + "" + NL + "  //------------------------" + NL + "  // Constructor" + NL + "  //------------------------" + NL + "  public:" + NL;
  ...
  protected final String TEXT_23 = "(const ";
  ...
  protected final String TEXT_35 = "(const ";
  ...
  protected final String TEXT_60 = "() const;";
  protected final String TEXT_61 = NL + "  ";
  protected final String TEXT_62 = " ";
  protected final String TEXT_63 = "();";
  protected final String TEXT_64 = NL + "  ";
  protected final String TEXT_65 = " ";
  protected final String TEXT_66 = "() const;";
  protected final String TEXT_67 = NL + "  ";
  protected final String TEXT_68 = " ";
  protected final String TEXT_69 = "();";
  protected final String TEXT_70 = NL + "  ";
  protected final String TEXT_71 = " ";
  protected final String TEXT_72 = "() const;";
  ...
  protected final String TEXT_80 = NL + "  bool ";
  ...
  protected final String TEXT_88 = NL + "  void ";
  ...
  protected final String TEXT_97 = "(int index);" + NL + "  vector<";
  protected final String TEXT_98 = "*> ";
  protected final String TEXT_99 = "();" + NL + "  int ";
  protected final String TEXT_100 = "();" + NL + "  bool ";
  protected final String TEXT_101 = "();" + NL + "  int ";
  protected final String TEXT_102 = "(";
  protected final String TEXT_103 = "* ";
  protected final String TEXT_104 = ");";
  protected final String TEXT_105 = "UNABLE TO UNDERSAND association variable (see header_association_Get_All.jet)";
  protected final String TEXT_106 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_107 = " : ";
  protected final String TEXT_108 = NL + "  bool ";
  protected final String TEXT_109 = "();";
  protected final String TEXT_110 = NL + "  static int ";
  protected final String TEXT_111 = "();";
  protected final String TEXT_112 = NL + "  static int ";
  protected final String TEXT_113 = "();";
  protected final String TEXT_114 = NL + "static int ";
  protected final String TEXT_115 = "();";
  protected final String TEXT_116 = NL + "  bool ";
  ...
  protected final String TEXT_165 = "( vector<";
  ...
  protected final String TEXT_191 = "( vector<";
  protected final String TEXT_192 = "*> ";
  protected final String TEXT_193 = ");";
  protected final String TEXT_194 = NL + "  void ";
  protected final String TEXT_195 = "::";
  protected final String TEXT_196 = "(";
  protected final String TEXT_197 = " ";
  protected final String TEXT_198 = ", ";
  protected final String TEXT_199 = " ";
  protected final String TEXT_200 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_201 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_202 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_203 = ", ";
  protected final String TEXT_204 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_205 = " to ";
  protected final String TEXT_206 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_233 = ");" + NL + "  bool ";
  ...
  protected final String TEXT_240 = ");" + NL + "  bool ";
  ...
  protected final String TEXT_252 = "( vector<";
  protected final String TEXT_253 = "*> ";
  protected final String TEXT_254 = ");";
  protected final String TEXT_255 = NL + "  void ";
  protected final String TEXT_256 = "::";
  protected final String TEXT_257 = "(";
  protected final String TEXT_258 = " ";
  protected final String TEXT_259 = ", ";
  protected final String TEXT_260 = " ";
  protected final String TEXT_261 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_262 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_263 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_264 = ", ";
  protected final String TEXT_265 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_266 = " to ";
  protected final String TEXT_267 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_319 = NL + " bool equals(Object obj);" + NL + " int hashCode();" + NL;
  protected final String TEXT_320 = NL + "   void ";
  protected final String TEXT_321 = "::";
  protected final String TEXT_322 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_323 = NL + "       ";
  protected final String TEXT_324 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_325 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_326 = NL + "    ";
  protected final String TEXT_327 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_328 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_329 = NL + "      ";
  protected final String TEXT_330 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_331 = NL + "  void ";
  protected final String TEXT_332 = "();" + NL + "  void ";
  protected final String TEXT_333 = "();" + NL + "  " + NL + NL;
  protected final String TEXT_334 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_335 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_336 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_337 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_338 = "::run ()" + NL + "    {";
  protected final String TEXT_339 = NL + "      if (\"";
  protected final String TEXT_340 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_341 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_342 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_343 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_344 = NL + "  //------------------------" + NL + "  // Destructor" + NL + "  //------------------------";
  protected final String TEXT_345 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_346 = NL + "  ";
  protected final String TEXT_347 = NL + "};" + NL + "" + NL + "#endif";
    ...
    
{
  ...
  for(StateMachine sm : uClass.getStateMachines())
  {
    ...
    appendln(stringBuffer,"  {0}({1});",new Object[] {uClass.getName(), gClass.getLookup("constructorSignature")});
