...
public class CppHeaderGenerator implements ILang 
{
  ...
  protected final String TEXT_80 = "()" + NL + "  {" + NL + "    String answer = ";
  protected final String TEXT_81 = ".toString();";
  protected final String TEXT_82 = NL + "    return answer;" + NL + "  }" + NL;
  ...
  protected final String TEXT_89 = "bool ";
  protected final String TEXT_90 = "::";
  protected final String TEXT_91 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;" + NL;
  protected final String TEXT_92 = NL + "    ";
  protected final String TEXT_93 = NL + NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_94 = NL + "  bool ";
  ...
  protected final String TEXT_101 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_102 = NL + "  private void ";
  protected final String TEXT_103 = "::";
  protected final String TEXT_104 = "()" + NL + "  {" + NL + "    switch(";
  protected final String TEXT_105 = ")" + NL + "    {";
  protected final String TEXT_106 = NL + "      ";
  protected final String TEXT_107 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_108 = NL + "  private void ";
  ...
  protected final String TEXT_126 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_136 = "(int index);" + NL + "  vector<";
  ...
  protected final String TEXT_153 = NL + "static int ";
  ...
  protected final String TEXT_204 = "( vector<";
  ...
  protected final String TEXT_229 = NL + "  bool ";
  protected final String TEXT_230 = "( vector<";
  protected final String TEXT_231 = "*> ";
  protected final String TEXT_232 = ");";
  protected final String TEXT_233 = NL + "  void ";
  protected final String TEXT_234 = "::";
  protected final String TEXT_235 = "(";
  protected final String TEXT_236 = " ";
  protected final String TEXT_237 = ", ";
  protected final String TEXT_238 = " ";
  protected final String TEXT_239 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_240 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_241 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_242 = ", ";
  protected final String TEXT_243 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_244 = " to ";
  protected final String TEXT_245 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_291 = "( vector<";
  protected final String TEXT_292 = "*> ";
  protected final String TEXT_293 = ");";
  protected final String TEXT_294 = NL + "  void ";
  protected final String TEXT_295 = "::";
  protected final String TEXT_296 = "(";
  protected final String TEXT_297 = " ";
  protected final String TEXT_298 = ", ";
  protected final String TEXT_299 = " ";
  protected final String TEXT_300 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_301 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_302 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_303 = ", ";
  protected final String TEXT_304 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_305 = " to ";
  protected final String TEXT_306 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_352 = NL + "  bool ";
  protected final String TEXT_353 = "( vector<";
  protected final String TEXT_354 = "*> ";
  protected final String TEXT_355 = ");";
  protected final String TEXT_356 = NL + "  ";
  protected final String TEXT_357 = " ";
  protected final String TEXT_358 = NL + " bool equals(Object obj);" + NL + " int hashCode();" + NL;
  protected final String TEXT_359 = NL + "   void ";
  protected final String TEXT_360 = "::";
  protected final String TEXT_361 = "()" + NL + "  {" + NL + "     try" + NL + "     {";
  protected final String TEXT_362 = NL + "       ";
  protected final String TEXT_363 = NL + "     }" + NL + "     catch (InterruptedException e)" + NL + "     {" + NL + " " + NL + "     }" + NL + "  }" + NL;
  protected final String TEXT_364 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_365 = NL + "    ";
  protected final String TEXT_366 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_367 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_368 = NL + "      ";
  protected final String TEXT_369 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_370 = NL + "  void ";
  protected final String TEXT_371 = "::";
  protected final String TEXT_372 = "()" + NL + "  {";
  protected final String TEXT_373 = NL + "    ";
  protected final String TEXT_374 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_375 = "\",";
  protected final String TEXT_376 = ");" + NL + "  }" + NL + "" + NL + "  void ";
  protected final String TEXT_377 = "::";
  protected final String TEXT_378 = "()" + NL + "  {";
  protected final String TEXT_379 = NL + "    ";
  protected final String TEXT_380 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_381 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_382 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_383 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_384 = "::stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void ";
  protected final String TEXT_385 = "::run ()" + NL + "    {";
  protected final String TEXT_386 = NL + "      if (\"";
  protected final String TEXT_387 = "\" == timeoutMethodName)" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_388 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_389 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_390 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_391 = NL + "  //------------------------" + NL + "  // Destructor" + NL + "  //------------------------";
  protected final String TEXT_392 = NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
  protected final String TEXT_393 = NL + "  ";
  protected final String TEXT_394 = NL + "};" + NL + "" + NL + "#endif";
