...
public class JavaSpecGenerator 
{
  ...
  protected final String TEXT_1484 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1485 = NL + "    if (!";
  protected final String TEXT_1486 = ".contains(";
  protected final String TEXT_1487 = "))" + NL + "    {";
  protected final String TEXT_1488 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1489 = "() <= ";
  protected final String TEXT_1490 = "_";
  protected final String TEXT_1491 = "())" + NL + "    {";
  protected final String TEXT_1492 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_1493 = ".indexOf(";
  protected final String TEXT_1494 = ");";
  protected final String TEXT_1495 = NL + "    ";
  protected final String TEXT_1496 = ".remove(oldIndex);";
  protected final String TEXT_1497 = NL + "    if (";
  protected final String TEXT_1498 = ".";
  protected final String TEXT_1499 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_1500 = ".";
  protected final String TEXT_1501 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_1502 = NL + "        ";
  protected final String TEXT_1503 = ".add(oldIndex,";
  protected final String TEXT_1504 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_1505 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1506 = NL + "  public boolean ";
  protected final String TEXT_1507 = "(";
  protected final String TEXT_1508 = " ";
  protected final String TEXT_1509 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1510 = NL + "    if (!";
  protected final String TEXT_1511 = ".contains(";
  protected final String TEXT_1512 = "))" + NL + "    {";
  protected final String TEXT_1513 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1514 = "() <= ";
  protected final String TEXT_1515 = "_";
  protected final String TEXT_1516 = "())" + NL + "    {";
  protected final String TEXT_1517 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_1518 = ".indexOf(";
  protected final String TEXT_1519 = ");";
  protected final String TEXT_1520 = NL + "    ";
  protected final String TEXT_1521 = ".remove(oldIndex);";
  protected final String TEXT_1522 = NL + "    if (";
  protected final String TEXT_1523 = ".";
  protected final String TEXT_1524 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_1525 = ".";
  protected final String TEXT_1526 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_1527 = NL + "        ";
  protected final String TEXT_1528 = ".add(oldIndex,";
  protected final String TEXT_1529 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_1530 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1531 = NL + "  public boolean ";
  protected final String TEXT_1532 = "_";
  protected final String TEXT_1533 = "(";
  protected final String TEXT_1534 = " ";
  protected final String TEXT_1535 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_1558 = ".add(";
  ...
  protected final String TEXT_1566 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1567 = " != null)" + NL + "    {";
  protected final String TEXT_1568 = NL + "      ";
  protected final String TEXT_1569 = ".";
  protected final String TEXT_1570 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1571 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1572 = NL + "  public boolean ";
  protected final String TEXT_1573 = "_";
  ...
  protected final String TEXT_1583 = "_One";
  ...
  protected final String TEXT_1590 = ";" + NL + "    if (";
  ...
  protected final String TEXT_1599 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1600 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1601 = NL + "  public boolean ";
  protected final String TEXT_1602 = "_";
  protected final String TEXT_1603 = "(";
  protected final String TEXT_1604 = " ";
  protected final String TEXT_1605 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1606 = NL + "    if (";
  ...
  protected final String TEXT_1612 = "_One";
  ...
  protected final String TEXT_1625 = "(this);" + NL + "    }" + NL + "    if (!";
  protected final String TEXT_1626 = ".";
  protected final String TEXT_1627 = "(this))" + NL + "    {";
  protected final String TEXT_1628 = NL + "      ";
  protected final String TEXT_1629 = " = ";
  protected final String TEXT_1630 = ";" + NL + "      wasSet = false;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasSet = true;" + NL + "    }";
  protected final String TEXT_1631 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1632 = NL + "  public boolean ";
  protected final String TEXT_1633 = "_";
  ...
  protected final String TEXT_1637 = NL + "    //Must provide ";
  protected final String TEXT_1638 = " to ";
  protected final String TEXT_1639 = NL + "    if (";
  protected final String TEXT_1640 = " == null)" + NL + "    {";
  protected final String TEXT_1641 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_1642 = " already at maximum (";
  ...
  protected final String TEXT_1664 = ".add(";
  ...
  protected final String TEXT_1669 = "))" + NL + "    {" + NL + "      boolean didRemove = ";
  protected final String TEXT_1670 = ".";
  protected final String TEXT_1671 = "(this);" + NL + "      if (!didRemove)" + NL + "      {" + NL + "      \t";
  ...
  protected final String TEXT_1716 = ".clear();";
  protected final String TEXT_1717 = NL + "    ";
  protected final String TEXT_1718 = ".add(";
  protected final String TEXT_1719 = ");";
  protected final String TEXT_1720 = NL + "    if (";
  protected final String TEXT_1721 = " != null && !";
  protected final String TEXT_1722 = ".equals(";
  protected final String TEXT_1723 = "))" + NL + "    {" + NL + "      boolean didRemove = ";
  protected final String TEXT_1724 = ".";
  protected final String TEXT_1725 = "(this);" + NL + "      if (!didRemove)" + NL + "      {" + NL + "      \t";
  ...
  protected final String TEXT_1730 = ".clear();" + NL + "    \t";
  protected final String TEXT_1731 = ".add(";
  protected final String TEXT_1732 = ");";
  protected final String TEXT_1733 = NL + "        return wasSet;" + NL + "      }" + NL + "    }";
  ...
  protected final String TEXT_1738 = "_One";
  protected final String TEXT_1739 = "().";
  protected final String TEXT_1740 = "(this);";
  protected final String TEXT_1741 = NL + "    wasSet = true;";
  protected final String TEXT_1742 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1743 = NL + "  public boolean ";
  protected final String TEXT_1744 = "(";
  protected final String TEXT_1745 = " ";
  protected final String TEXT_1746 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_1751 = "_One";
  protected final String TEXT_1752 = "();";
  protected final String TEXT_1753 = NL + "    if (";
  protected final String TEXT_1754 = " == null)" + NL + "    {";
  ...
  protected final String TEXT_1759 = ".clear_";
  protected final String TEXT_1760 = "();";
  protected final String TEXT_1761 = NL + "      ";
  protected final String TEXT_1762 = ".";
  protected final String TEXT_1763 = "(this);";
  protected final String TEXT_1764 = NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1772 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1773 = NL + "      ";
  protected final String TEXT_1774 = ".add(";
  protected final String TEXT_1775 = ");" + NL + "    }";
  protected final String TEXT_1776 = NL + "    wasAdded = true;";
  protected final String TEXT_1777 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1778 = "(";
  protected final String TEXT_1779 = " ";
  protected final String TEXT_1780 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1781 = NL + "    if (";
  protected final String TEXT_1782 = ".contains(";
  protected final String TEXT_1783 = "))" + NL + "    {";
  protected final String TEXT_1784 = NL + "      ";
  protected final String TEXT_1785 = ".remove(";
  protected final String TEXT_1786 = ");";
  protected final String TEXT_1787 = NL + "      ";
  protected final String TEXT_1788 = ".clear_";
  protected final String TEXT_1789 = "();" + NL + "      wasRemoved = true;";
  protected final String TEXT_1790 = NL + "    }";
  protected final String TEXT_1791 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1792 = NL + "  public boolean ";
  protected final String TEXT_1793 = "_";
  protected final String TEXT_1794 = "(";
  protected final String TEXT_1795 = " ";
  protected final String TEXT_1796 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1797 = NL + "    ";
  protected final String TEXT_1798 = " ";
  protected final String TEXT_1799 = " = ";
  protected final String TEXT_1800 = "_One";
  ...
  protected final String TEXT_1811 = ".add(";
  protected final String TEXT_1812 = ");";
  protected final String TEXT_1813 = NL + "    if (";
  protected final String TEXT_1814 = " != null && !";
  protected final String TEXT_1815 = ".equals(";
  protected final String TEXT_1816 = "))" + NL + "    {";
  protected final String TEXT_1817 = NL + "      ";
  protected final String TEXT_1818 = ".";
  protected final String TEXT_1819 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1820 = " != null)" + NL + "    {";
  protected final String TEXT_1821 = NL + "      ";
  protected final String TEXT_1822 = ".";
  protected final String TEXT_1823 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1824 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1825 = NL + "  public boolean ";
  protected final String TEXT_1826 = "(";
  protected final String TEXT_1827 = " ";
  protected final String TEXT_1828 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1829 = NL + "    if (";
  protected final String TEXT_1830 = "() >= ";
  protected final String TEXT_1831 = "_";
  protected final String TEXT_1832 = "())" + NL + "    {";
  protected final String TEXT_1833 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1838 = "_One";
  protected final String TEXT_1839 = "();";
  protected final String TEXT_1840 = NL + "    if (";
  protected final String TEXT_1841 = " == null)" + NL + "    {";
  protected final String TEXT_1842 = NL + "      ";
  protected final String TEXT_1843 = ".";
  protected final String TEXT_1844 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1852 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1853 = NL + "      ";
  protected final String TEXT_1854 = ".add(";
  protected final String TEXT_1855 = ");" + NL + "    }";
  protected final String TEXT_1856 = NL + "    wasAdded = true;";
  protected final String TEXT_1857 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1858 = "(";
  protected final String TEXT_1859 = " ";
  protected final String TEXT_1860 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1861 = NL + "    if (";
  protected final String TEXT_1862 = ".contains(";
  protected final String TEXT_1863 = "))" + NL + "    {";
  protected final String TEXT_1864 = NL + "      ";
  protected final String TEXT_1865 = ".remove(";
  protected final String TEXT_1866 = ");";
  protected final String TEXT_1867 = NL + "      ";
  protected final String TEXT_1868 = ".clear_";
  protected final String TEXT_1869 = "();" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1870 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1871 = NL + "  public boolean ";
  protected final String TEXT_1872 = "(";
  protected final String TEXT_1873 = " ";
  protected final String TEXT_1874 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1875 = NL + "    if (";
  protected final String TEXT_1876 = "() < ";
  protected final String TEXT_1877 = "_";
  protected final String TEXT_1878 = "())" + NL + "    {";
  protected final String TEXT_1879 = NL + "      ";
  protected final String TEXT_1880 = ".add(";
  protected final String TEXT_1881 = ");";
  protected final String TEXT_1882 = NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1883 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1884 = "(";
  protected final String TEXT_1885 = " ";
  protected final String TEXT_1886 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1887 = NL + "    if (!";
  protected final String TEXT_1888 = ".contains(";
  protected final String TEXT_1889 = "))" + NL + "    {";
  protected final String TEXT_1890 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1891 = "() <= ";
  protected final String TEXT_1892 = "_";
  protected final String TEXT_1893 = "())" + NL + "    {";
  protected final String TEXT_1894 = NL + "      return wasRemoved;" + NL + "    }";
  protected final String TEXT_1895 = NL;
  protected final String TEXT_1896 = NL + "    ";
  protected final String TEXT_1897 = ".remove(";
  protected final String TEXT_1898 = ");";
  protected final String TEXT_1899 = NL + "    wasRemoved = true;";
  protected final String TEXT_1900 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1901 = NL + "  public boolean ";
  protected final String TEXT_1902 = "(";
  protected final String TEXT_1903 = " ";
  protected final String TEXT_1904 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1905 = NL + "    if (";
  protected final String TEXT_1906 = "() >= ";
  protected final String TEXT_1907 = "_";
  protected final String TEXT_1908 = "())" + NL + "    {";
  protected final String TEXT_1909 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1914 = "_One";
  protected final String TEXT_1915 = "();" + NL + "    if (";
  protected final String TEXT_1916 = " != null && ";
  protected final String TEXT_1917 = ".";
  protected final String TEXT_1918 = "() <= ";
  protected final String TEXT_1919 = "_";
  protected final String TEXT_1920 = "())" + NL + "    {";
  protected final String TEXT_1921 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1922 = " != null)" + NL + "    {";
  protected final String TEXT_1923 = NL + "      ";
  protected final String TEXT_1924 = ".";
  protected final String TEXT_1925 = ".remove(";
  protected final String TEXT_1926 = ");" + NL + "    }";
  protected final String TEXT_1927 = NL + "    ";
  protected final String TEXT_1928 = ".add(";
  protected final String TEXT_1929 = ");";
  protected final String TEXT_1930 = NL + "    ";
  protected final String TEXT_1931 = "(";
  protected final String TEXT_1932 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1933 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1934 = "(";
  protected final String TEXT_1935 = " ";
  protected final String TEXT_1936 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1937 = NL + "    if (";
  protected final String TEXT_1938 = ".contains(";
  protected final String TEXT_1939 = ") && ";
  protected final String TEXT_1940 = "() > ";
  protected final String TEXT_1941 = "_";
  protected final String TEXT_1942 = "())" + NL + "    {";
  protected final String TEXT_1943 = NL + "      ";
  protected final String TEXT_1944 = ".remove(";
  protected final String TEXT_1945 = ");";
  protected final String TEXT_1946 = NL + "      ";
  protected final String TEXT_1947 = "(";
  protected final String TEXT_1948 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1949 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1950 = NL + "  public boolean ";
  protected final String TEXT_1951 = "_";
  protected final String TEXT_1952 = "(";
  protected final String TEXT_1953 = "... ";
  protected final String TEXT_1954 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1955 = NL + "    ArrayList<";
  protected final String TEXT_1956 = "> ";
  protected final String TEXT_1957 = " = new ArrayList<";
  protected final String TEXT_1958 = ">();" + NL + "    for (";
  protected final String TEXT_1959 = " ";
  protected final String TEXT_1960 = " : ";
  protected final String TEXT_1961 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1962 = ".contains(";
  protected final String TEXT_1963 = "))" + NL + "      {";
  protected final String TEXT_1964 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1965 = ".";
  protected final String TEXT_1966 = "_One";
  protected final String TEXT_1967 = "() != null && !this.equals(";
  protected final String TEXT_1968 = ".";
  protected final String TEXT_1969 = "_One";
  protected final String TEXT_1970 = "()))" + NL + "      {";
  protected final String TEXT_1971 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1972 = NL + "      ";
  protected final String TEXT_1973 = ".add(";
  protected final String TEXT_1974 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1975 = ".size() != ";
  protected final String TEXT_1976 = "_";
  protected final String TEXT_1977 = "())" + NL + "    {";
  protected final String TEXT_1978 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1979 = NL + "    ";
  protected final String TEXT_1980 = ".removeAll(";
  protected final String TEXT_1981 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1982 = " orphan : ";
  protected final String TEXT_1983 = "_";
  protected final String TEXT_1984 = "())" + NL + "    {";
  protected final String TEXT_1985 = NL + "      ";
  protected final String TEXT_1986 = "_";
  protected final String TEXT_1987 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1988 = NL + "    ";
  protected final String TEXT_1989 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1994 = "_";
  protected final String TEXT_1995 = "(";
  protected final String TEXT_1996 = ", this);";
  protected final String TEXT_1997 = NL + "      ";
  protected final String TEXT_1998 = ".add(";
  protected final String TEXT_1999 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_2000 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_2001 = NL + "  private void ";
  ...
  protected final String TEXT_2006 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_2007 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_2008 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_2009 = ", ";
  protected final String TEXT_2010 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_2011 = " to ";
  protected final String TEXT_2012 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_2013 = NL + "  public boolean ";
  protected final String TEXT_2014 = "(";
  protected final String TEXT_2015 = " ";
  protected final String TEXT_2016 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_2017 = NL + "    ";
  protected final String TEXT_2018 = ".add(";
  protected final String TEXT_2019 = ");";
  protected final String TEXT_2020 = NL + "    wasAdded = true;";
  protected final String TEXT_2021 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_2022 = "(";
  protected final String TEXT_2023 = " ";
  protected final String TEXT_2024 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_2025 = NL + "    if (";
  protected final String TEXT_2026 = ".contains(";
  protected final String TEXT_2027 = "))" + NL + "    {";
  protected final String TEXT_2028 = NL + "      ";
  protected final String TEXT_2029 = ".remove(";
  protected final String TEXT_2030 = ");";
  protected final String TEXT_2031 = NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_2032 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_2033 = NL + "  public boolean ";
  protected final String TEXT_2034 = "(";
  protected final String TEXT_2035 = " ";
  protected final String TEXT_2036 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_2037 = NL + "    if (";
  ...
  protected final String TEXT_2042 = ".add(";
  protected final String TEXT_2043 = ");";
  protected final String TEXT_2044 = NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_2045 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_2046 = NL;
  protected final String TEXT_2047 = NL + "  public boolean ";
  protected final String TEXT_2048 = "(";
  protected final String TEXT_2049 = " ";
  protected final String TEXT_2050 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_2051 = NL + "    if (";
  protected final String TEXT_2052 = ".contains(";
  protected final String TEXT_2053 = "))" + NL + "    {";
  protected final String TEXT_2054 = NL + "      ";
  protected final String TEXT_2055 = ".remove(";
  protected final String TEXT_2056 = ");";
  protected final String TEXT_2057 = NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_2058 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_2059 = NL + "  public boolean ";
  protected final String TEXT_2060 = "(";
  protected final String TEXT_2061 = " ";
  protected final String TEXT_2062 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_2063 = NL + "    ";
  protected final String TEXT_2064 = ".add(";
  protected final String TEXT_2065 = ");";
  protected final String TEXT_2066 = NL + "    wasAdded = true;";
  protected final String TEXT_2067 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_2068 = "(";
  protected final String TEXT_2069 = " ";
  protected final String TEXT_2070 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_2071 = NL + "    if (!";
  protected final String TEXT_2072 = ".contains(";
  protected final String TEXT_2073 = "))" + NL + "    {";
  protected final String TEXT_2074 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_2075 = "() <= ";
  protected final String TEXT_2076 = "_";
  protected final String TEXT_2077 = "())" + NL + "    {";
  protected final String TEXT_2078 = NL + "      return wasRemoved;" + NL + "    }";
  protected final String TEXT_2079 = NL;
  protected final String TEXT_2080 = NL + "    ";
  protected final String TEXT_2081 = ".remove(";
  protected final String TEXT_2082 = ");";
  protected final String TEXT_2083 = NL + "    wasRemoved = true;";
  protected final String TEXT_2084 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_2085 = NL + "  ";
  protected final String TEXT_2086 = " boolean ";
  protected final String TEXT_2087 = "(";
  protected final String TEXT_2088 = "... ";
  protected final String TEXT_2089 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_2090 = NL + "    ArrayList<";
  protected final String TEXT_2091 = "> ";
  protected final String TEXT_2092 = " = new ArrayList<";
  protected final String TEXT_2093 = ">();" + NL + "    for (";
  protected final String TEXT_2094 = " ";
  protected final String TEXT_2095 = " : ";
  protected final String TEXT_2096 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_2097 = ".contains(";
  protected final String TEXT_2098 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_2099 = NL + "      ";
  protected final String TEXT_2100 = ".add(";
  protected final String TEXT_2101 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_2102 = ".size() != ";
  protected final String TEXT_2103 = ".length || ";
  protected final String TEXT_2104 = ".size() != ";
  protected final String TEXT_2105 = "_";
  protected final String TEXT_2106 = "())" + NL + "    {";
  protected final String TEXT_2107 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_2108 = NL + "    ";
  protected final String TEXT_2109 = ".clear();";
  protected final String TEXT_2110 = NL + "    ";
  protected final String TEXT_2111 = ".addAll(";
  protected final String TEXT_2112 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_2113 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_2114 = NL + "  ";
  protected final String TEXT_2115 = " boolean ";
  protected final String TEXT_2116 = "(";
  protected final String TEXT_2117 = "... ";
  protected final String TEXT_2118 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_2119 = NL + "    ArrayList<";
  protected final String TEXT_2120 = "> ";
  protected final String TEXT_2121 = " = new ArrayList<";
  protected final String TEXT_2122 = ">();" + NL + "    for (";
  protected final String TEXT_2123 = " ";
  protected final String TEXT_2124 = " : ";
  protected final String TEXT_2125 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_2126 = ".contains(";
  protected final String TEXT_2127 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_2128 = NL + "      ";
  protected final String TEXT_2129 = ".add(";
  protected final String TEXT_2130 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_2131 = ".size() != ";
  protected final String TEXT_2132 = ".length)" + NL + "    {";
  protected final String TEXT_2133 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_2134 = NL + "    ";
  protected final String TEXT_2135 = ".clear();";
  protected final String TEXT_2136 = NL + "    ";
  protected final String TEXT_2137 = ".addAll(";
  protected final String TEXT_2138 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_2139 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_2140 = NL + "  public boolean ";
  protected final String TEXT_2141 = "_";
  protected final String TEXT_2142 = "(";
  protected final String TEXT_2143 = " ";
  protected final String TEXT_2144 = ")" + NL + "  {" + NL + "    //" + NL + "    // This source of this source generation is association_SetOptionalOneToMandatoryMany.jet" + NL + "    // This set file assumes the generation of a maximumNumberOfXXX method does not exist because " + NL + "    // it's not required (No upper bound)" + NL + "    //   " + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_2154 = " != null)" + NL + "      {" + NL + "        if (";
  protected final String TEXT_2155 = ".";
  protected final String TEXT_2156 = "(this))" + NL + "        {";
  protected final String TEXT_2157 = NL + "          ";
  protected final String TEXT_2158 = " = ";
  protected final String TEXT_2159 = ";" + NL + "          wasSet = true;" + NL + "        }" + NL + "      }" + NL + "    } " + NL + "    else if (";
  protected final String TEXT_2160 = " != null)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_2161 = " == null)" + NL + "      {" + NL + "        if (";
  protected final String TEXT_2162 = ".";
  protected final String TEXT_2163 = "_";
  ...
  protected final String TEXT_2169 = "(this);";
  protected final String TEXT_2170 = NL + "          ";
  protected final String TEXT_2171 = " = ";
  protected final String TEXT_2172 = ";  // ";
  protected final String TEXT_2173 = " == null" + NL + "          wasSet = true;" + NL + "        }" + NL + "      } " + NL + "      else" + NL + "      {" + NL + "        if (";
  protected final String TEXT_2174 = ".";
  protected final String TEXT_2175 = "_";
  ...
  protected final String TEXT_2181 = "(this);";
  protected final String TEXT_2182 = NL + "          ";
  protected final String TEXT_2183 = ".";
  protected final String TEXT_2184 = "(this);";
  protected final String TEXT_2185 = NL + "          ";
  protected final String TEXT_2186 = " = ";
  protected final String TEXT_2187 = ";" + NL + "          wasSet = true;" + NL + "        }" + NL + "      }" + NL + "    }" + NL + "    if (wasSet)" + NL + "    {";
  protected final String TEXT_2188 = NL + "      ";
  protected final String TEXT_2189 = " = ";
  protected final String TEXT_2190 = ";" + NL + "    }" + NL + "    return wasSet;" + NL + "  }" + NL + "  ";
  protected final String TEXT_2191 = NL + "//  public boolean ";
  protected final String TEXT_2192 = "_";
  protected final String TEXT_2193 = "(";
  protected final String TEXT_2194 = " ";
  protected final String TEXT_2195 = ")" + NL + "//  {" + NL + "//    //" + NL + "//    // The source of the code generation is association_SetOptionalOneToMN.jet" + NL + "//    // (this) set file assumes the generation of a maximumNumberOfXXX " + NL + "//    //   method ";
  protected final String TEXT_2196 = NL + "//    // Currently this will not compile due to Issue351 - the template code is fine." + NL + "//    //" + NL + "//" + NL + "//    boolean wasSet = false;" + NL + "//    ";
  ...
  protected final String TEXT_2203 = ";" + NL + "//  " + NL + "//    if (";
  protected final String TEXT_2204 = " == null)" + NL + "//    {  " + NL + "//      if (";
  protected final String TEXT_2205 = " != null)" + NL + "//      { " + NL + "//        if (";
  protected final String TEXT_2206 = ".";
  protected final String TEXT_2207 = "(this))" + NL + "//          ";
  protected final String TEXT_2208 = " = ";
  protected final String TEXT_2209 = ";" + NL + "//          wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//    }" + NL + "//    else" + NL + "//    {" + NL + "//      if (";
  protected final String TEXT_2210 = " != null)" + NL + "//      {" + NL + "//        if (";
  protected final String TEXT_2211 = " == null)" + NL + "//        {" + NL + "//          if (";
  ...
  protected final String TEXT_2217 = "(this);" + NL + "//            ";
  protected final String TEXT_2218 = " = ";
  protected final String TEXT_2219 = "  // ";
  protected final String TEXT_2220 = " == null;" + NL + "//            wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//      else" + NL + "//      {" + NL + "//        if (   ";
  ...
  protected final String TEXT_2230 = "(this);" + NL + "//          ";
  protected final String TEXT_2231 = ".";
  protected final String TEXT_2232 = "(this);" + NL + "//          ";
  protected final String TEXT_2233 = " = ";
  protected final String TEXT_2234 = ";" + NL + "//          wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//    }" + NL + "//    " + NL + "//    if (wasSet)" + NL + "//    {" + NL + "//      ";
  protected final String TEXT_2235 = " = ";
  protected final String TEXT_2236 = ";" + NL + "//    }" + NL + "//    " + NL + "//    return wasSet;" + NL + "//  }";
  protected final String TEXT_2237 = NL + "  public boolean ";
  protected final String TEXT_2238 = "_";
  protected final String TEXT_2239 = "(";
  protected final String TEXT_2240 = "... ";
  protected final String TEXT_2241 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_2242 = NL + "    ArrayList<";
  protected final String TEXT_2243 = "> ";
  protected final String TEXT_2244 = " = new ArrayList<";
  protected final String TEXT_2245 = ">();" + NL + "    for (";
  protected final String TEXT_2246 = " ";
  protected final String TEXT_2247 = " : ";
  protected final String TEXT_2248 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_2249 = ".contains(";
  protected final String TEXT_2250 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_2251 = NL + "      ";
  protected final String TEXT_2252 = ".add(";
  protected final String TEXT_2253 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_2254 = ".size() != ";
  protected final String TEXT_2255 = ".length || ";
  protected final String TEXT_2256 = ".size() < ";
  protected final String TEXT_2257 = "_";
  protected final String TEXT_2258 = "() || ";
  protected final String TEXT_2259 = ".size() > ";
  protected final String TEXT_2260 = "_";
  protected final String TEXT_2261 = "())" + NL + "    {";
  protected final String TEXT_2262 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_2263 = "> ";
  protected final String TEXT_2264 = " = new ArrayList<";
  protected final String TEXT_2265 = ">(";
  protected final String TEXT_2266 = "_";
  protected final String TEXT_2267 = "());";
  protected final String TEXT_2268 = NL + "    ";
  protected final String TEXT_2269 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_2274 = ".add(";
  protected final String TEXT_2275 = ");" + NL + "      if (";
  protected final String TEXT_2276 = ".contains(";
  protected final String TEXT_2277 = "))" + NL + "      {";
  protected final String TEXT_2278 = NL + "        ";
  protected final String TEXT_2279 = ".remove(";
  protected final String TEXT_2280 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_2281 = NL + "        ";
  protected final String TEXT_2282 = ".";
  protected final String TEXT_2283 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_2289 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_2290 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_2291 = NL + "  public boolean ";
  protected final String TEXT_2292 = "_";
  protected final String TEXT_2293 = "(";
  protected final String TEXT_2294 = "... ";
  protected final String TEXT_2295 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_2296 = NL + "    ArrayList<";
  protected final String TEXT_2297 = "> ";
  protected final String TEXT_2298 = " = new ArrayList<";
  protected final String TEXT_2299 = ">();" + NL + "    for (";
  protected final String TEXT_2300 = " ";
  protected final String TEXT_2301 = " : ";
  protected final String TEXT_2302 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_2303 = ".contains(";
  protected final String TEXT_2304 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_2305 = NL + "      ";
  protected final String TEXT_2306 = ".add(";
  protected final String TEXT_2307 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_2308 = ".size() != ";
  protected final String TEXT_2309 = ".length || ";
  protected final String TEXT_2310 = ".size() < ";
  protected final String TEXT_2311 = "_";
  protected final String TEXT_2312 = "())" + NL + "    {";
  protected final String TEXT_2313 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_2314 = "> ";
  protected final String TEXT_2315 = " = new ArrayList<";
  protected final String TEXT_2316 = ">(";
  protected final String TEXT_2317 = "_";
  protected final String TEXT_2318 = "());";
  protected final String TEXT_2319 = NL + "    ";
  protected final String TEXT_2320 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_2325 = ".add(";
  protected final String TEXT_2326 = ");" + NL + "      if (";
  protected final String TEXT_2327 = ".contains(";
  protected final String TEXT_2328 = "))" + NL + "      {";
  protected final String TEXT_2329 = NL + "        ";
  protected final String TEXT_2330 = ".remove(";
  protected final String TEXT_2331 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_2332 = NL + "        ";
  protected final String TEXT_2333 = ".";
  protected final String TEXT_2334 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_2340 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_2341 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_2342 = NL + "  ";
  protected final String TEXT_2343 = " boolean ";
  protected final String TEXT_2344 = "(";
  protected final String TEXT_2345 = "... ";
  protected final String TEXT_2346 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_2347 = NL + "    ArrayList<";
  protected final String TEXT_2348 = "> ";
  protected final String TEXT_2349 = " = new ArrayList<";
  protected final String TEXT_2350 = ">();" + NL + "    for (";
  protected final String TEXT_2351 = " ";
  protected final String TEXT_2352 = " : ";
  protected final String TEXT_2353 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_2354 = ".contains(";
  protected final String TEXT_2355 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_2356 = NL + "      ";
  protected final String TEXT_2357 = ".add(";
  protected final String TEXT_2358 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_2359 = ".size() != ";
  protected final String TEXT_2360 = ".length || ";
  protected final String TEXT_2361 = ".size() < ";
  protected final String TEXT_2362 = "_";
  protected final String TEXT_2363 = "() || ";
  protected final String TEXT_2364 = ".size() > ";
  protected final String TEXT_2365 = "_";
  protected final String TEXT_2366 = "())" + NL + "    {";
  protected final String TEXT_2367 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_2368 = NL + "    ";
  protected final String TEXT_2369 = ".clear();";
  protected final String TEXT_2370 = NL + "    ";
  protected final String TEXT_2371 = ".addAll(";
  protected final String TEXT_2372 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_2373 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_2374 = NL + "  public boolean ";
  protected final String TEXT_2375 = "_";
  protected final String TEXT_2376 = "(";
  protected final String TEXT_2377 = "... ";
  protected final String TEXT_2378 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_2379 = NL + "    if (";
  protected final String TEXT_2380 = ".length < ";
  protected final String TEXT_2381 = "_";
  protected final String TEXT_2382 = "()";
  protected final String TEXT_2383 = ")" + NL + "    {";
  protected final String TEXT_2384 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_2385 = "> ";
  protected final String TEXT_2386 = " = new ArrayList<";
  protected final String TEXT_2387 = ">();" + NL + "    HashMap<";
  protected final String TEXT_2388 = ",Integer> ";
  protected final String TEXT_2389 = " = new HashMap<";
  protected final String TEXT_2390 = ",Integer>();" + NL + "    for (";
  protected final String TEXT_2391 = " ";
  protected final String TEXT_2392 = " : ";
  protected final String TEXT_2393 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_2394 = ".contains(";
  protected final String TEXT_2395 = "))" + NL + "      {";
  protected final String TEXT_2396 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_2397 = ".";
  protected final String TEXT_2398 = "(";
  protected final String TEXT_2399 = "0";
  protected final String TEXT_2400 = ") != null && !this.equals(";
  protected final String TEXT_2401 = ".";
  protected final String TEXT_2402 = "(";
  protected final String TEXT_2403 = "0";
  ...
  protected final String TEXT_2410 = "0";
  protected final String TEXT_2411 = ");" + NL + "        if (!";
  protected final String TEXT_2412 = ".containsKey(";
  protected final String TEXT_2413 = "))" + NL + "        {";
  protected final String TEXT_2414 = NL + "          ";
  protected final String TEXT_2415 = ".put(";
  protected final String TEXT_2416 = ", new Integer(";
  protected final String TEXT_2417 = ".";
  protected final String TEXT_2418 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_2419 = ".get(";
  protected final String TEXT_2420 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_2421 = ")" + NL + "        {";
  protected final String TEXT_2422 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_2423 = NL + "        ";
  protected final String TEXT_2424 = ".put(";
  protected final String TEXT_2425 = ", new Integer(nextCount));" + NL + "      }";
  protected final String TEXT_2426 = NL + "      ";
  protected final String TEXT_2427 = ".add(";
  protected final String TEXT_2428 = ");" + NL + "    }" + NL;
  protected final String TEXT_2429 = NL + "    ";
  protected final String TEXT_2430 = ".removeAll(";
  protected final String TEXT_2431 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_2432 = " orphan : ";
  protected final String TEXT_2433 = "_";
  protected final String TEXT_2434 = "())" + NL + "    {";
  protected final String TEXT_2435 = NL + "      ";
  protected final String TEXT_2436 = "_";
  protected final String TEXT_2437 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_2438 = NL + "    ";
  protected final String TEXT_2439 = ".clear();" + NL + "    for (";
  protected final String TEXT_2440 = " ";
  protected final String TEXT_2441 = " : ";
  protected final String TEXT_2442 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_2443 = ".";
  protected final String TEXT_2444 = "(";
  protected final String TEXT_2445 = "0";
  ...
  protected final String TEXT_2450 = "0";
  protected final String TEXT_2451 = ").";
  protected final String TEXT_2452 = ".remove(";
  protected final String TEXT_2453 = ");" + NL + "      }";
  protected final String TEXT_2454 = NL + "      ";
  protected final String TEXT_2455 = "_";
  protected final String TEXT_2456 = "(";
  protected final String TEXT_2457 = ", this);";
  protected final String TEXT_2458 = NL + "      ";
  protected final String TEXT_2459 = ".add(";
  protected final String TEXT_2460 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_2461 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_2462 = NL + "  private void ";
  ...
  protected final String TEXT_2467 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_2468 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_2469 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_2470 = ", ";
  protected final String TEXT_2471 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_2472 = " to ";
  protected final String TEXT_2473 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_2474 = NL + "  ";
  protected final String TEXT_2475 = " boolean ";
  protected final String TEXT_2476 = "(";
  protected final String TEXT_2477 = "... ";
  protected final String TEXT_2478 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_2479 = NL + "    ArrayList<";
  protected final String TEXT_2480 = "> ";
  protected final String TEXT_2481 = " = new ArrayList<";
  protected final String TEXT_2482 = ">();" + NL + "    for (";
  protected final String TEXT_2483 = " ";
  protected final String TEXT_2484 = " : ";
  protected final String TEXT_2485 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_2486 = ".contains(";
  protected final String TEXT_2487 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_2488 = NL + "      ";
  protected final String TEXT_2489 = ".add(";
  protected final String TEXT_2490 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_2491 = ".size() != ";
  protected final String TEXT_2492 = ".length || ";
  protected final String TEXT_2493 = ".size() > ";
  protected final String TEXT_2494 = "_";
  protected final String TEXT_2495 = "())" + NL + "    {";
  protected final String TEXT_2496 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_2497 = NL + "    ";
  protected final String TEXT_2498 = ".clear();";
  protected final String TEXT_2499 = NL + "    ";
  protected final String TEXT_2500 = ".addAll(";
  protected final String TEXT_2501 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_2502 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_2503 = NL + "  ";
  protected final String TEXT_2504 = " boolean ";
  protected final String TEXT_2505 = "(";
  protected final String TEXT_2506 = "... ";
  protected final String TEXT_2507 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_2508 = NL + "    ArrayList<";
  protected final String TEXT_2509 = "> ";
  protected final String TEXT_2510 = " = new ArrayList<";
  protected final String TEXT_2511 = ">();" + NL + "    for (";
  protected final String TEXT_2512 = " ";
  protected final String TEXT_2513 = " : ";
  protected final String TEXT_2514 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_2515 = ".contains(";
  protected final String TEXT_2516 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_2517 = NL + "      ";
  protected final String TEXT_2518 = ".add(";
  protected final String TEXT_2519 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_2520 = ".size() != ";
  protected final String TEXT_2521 = ".length || ";
  protected final String TEXT_2522 = ".size() < ";
  protected final String TEXT_2523 = "_";
  protected final String TEXT_2524 = "())" + NL + "    {";
  protected final String TEXT_2525 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_2526 = NL + "    ";
  protected final String TEXT_2527 = ".clear();";
  protected final String TEXT_2528 = NL + "    ";
  protected final String TEXT_2529 = ".addAll(";
  protected final String TEXT_2530 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_2531 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_2532 = NL + "  ";
  protected final String TEXT_2533 = NL + "  public boolean ";
  protected final String TEXT_2534 = "(";
  protected final String TEXT_2535 = " ";
  protected final String TEXT_2536 = ", int index)" + NL + "  {  " + NL + "    boolean wasAdded = false;" + NL + "    if(";
  protected final String TEXT_2537 = "(";
  protected final String TEXT_2538 = "))" + NL + "    {" + NL + "      if(index < 0 ) { index = 0; }" + NL + "      if(index > ";
  protected final String TEXT_2539 = "()) { index = ";
  protected final String TEXT_2540 = "() - 1; }";
  protected final String TEXT_2541 = NL + "      ";
  protected final String TEXT_2542 = ".remove(";
  protected final String TEXT_2543 = ");";
  protected final String TEXT_2544 = NL + "      ";
  protected final String TEXT_2545 = ".add(index, ";
  protected final String TEXT_2546 = ");";
  protected final String TEXT_2547 = NL + "      wasAdded = true;" + NL + "    }" + NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_2548 = "(";
  protected final String TEXT_2549 = " ";
  protected final String TEXT_2550 = ", int index)" + NL + "  {" + NL + "    boolean wasAdded = false;" + NL + "    if(";
  protected final String TEXT_2551 = ".contains(";
  protected final String TEXT_2552 = "))" + NL + "    {" + NL + "      if(index < 0 ) { index = 0; }" + NL + "      if(index > ";
  protected final String TEXT_2553 = "()) { index = ";
  protected final String TEXT_2554 = "() - 1; }";
  protected final String TEXT_2555 = NL + "      ";
  protected final String TEXT_2556 = ".remove(";
  protected final String TEXT_2557 = ");";
  protected final String TEXT_2558 = NL + "      ";
  protected final String TEXT_2559 = ".add(index, ";
  protected final String TEXT_2560 = ");";
  protected final String TEXT_2561 = NL + "      wasAdded = true;" + NL + "    } " + NL + "    else " + NL + "    {";
  protected final String TEXT_2562 = NL + "      wasAdded = ";
  protected final String TEXT_2563 = "(";
  protected final String TEXT_2564 = ", index);";
  protected final String TEXT_2565 = NL + "    }" + NL + "    return wasAdded;" + NL + "  }" + NL;
