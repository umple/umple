...
public class JavaClassGenerator implements ILang 
{
  ...
  protected final String TEXT_299 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;";
  protected final String TEXT_300 = NL + "    ";
  protected final String TEXT_301 = NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_302 = NL + "  public boolean ";
  protected final String TEXT_303 = "(";
  protected final String TEXT_304 = " ";
  protected final String TEXT_305 = ")" + NL + "  {";
  protected final String TEXT_306 = NL + "    ";
  protected final String TEXT_307 = " = ";
  protected final String TEXT_308 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_309 = NL + "  private void ";
  protected final String TEXT_310 = "()" + NL + "  {";
  protected final String TEXT_311 = NL + "    switch(";
  protected final String TEXT_312 = ")" + NL + "    {";
  protected final String TEXT_313 = NL + "      ";
  protected final String TEXT_314 = NL + "    }";
  protected final String TEXT_315 = NL + "  }" + NL;
  protected final String TEXT_316 = NL + "  private void ";
  ...
  protected final String TEXT_333 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_352 = "(int index)" + NL + "  {";
  protected final String TEXT_353 = NL + "    ";
  protected final String TEXT_354 = " ";
  protected final String TEXT_355 = " = ";
  protected final String TEXT_356 = ".get(index);";
  protected final String TEXT_357 = NL + "    return ";
  protected final String TEXT_358 = ";" + NL + "  }" + NL + "" + NL + "  public List<";
  protected final String TEXT_359 = "> ";
  protected final String TEXT_360 = "()" + NL + "  {";
  protected final String TEXT_361 = NL + "    List<";
  protected final String TEXT_362 = "> ";
  protected final String TEXT_363 = " = Collections.unmodifiableList(";
  protected final String TEXT_364 = ");";
  protected final String TEXT_365 = NL + "    return ";
  protected final String TEXT_366 = ";" + NL + "  }" + NL + "" + NL + "  public int ";
  protected final String TEXT_367 = "()" + NL + "  {";
  protected final String TEXT_368 = NL + "    int number = ";
  protected final String TEXT_369 = ".size();";
  protected final String TEXT_370 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_371 = "()" + NL + "  {";
  protected final String TEXT_372 = NL + "    boolean has = ";
  protected final String TEXT_373 = ".size() > 0;";
  protected final String TEXT_374 = NL + "    return has;" + NL + "  }" + NL + "" + NL + "  public int ";
  protected final String TEXT_375 = "(";
  protected final String TEXT_376 = " ";
  protected final String TEXT_377 = ")" + NL + "  {";
  protected final String TEXT_378 = NL + "    int index = ";
  protected final String TEXT_379 = ".indexOf(";
  protected final String TEXT_380 = ");";
  protected final String TEXT_381 = NL + "    return index;" + NL + "  }" + NL;
  protected final String TEXT_382 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_383 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_384 = " : ";
  protected final String TEXT_385 = NL + "  public boolean ";
  protected final String TEXT_386 = "()" + NL + "  {";
  protected final String TEXT_387 = NL + "    boolean isValid = ";
  protected final String TEXT_388 = "() >= ";
  protected final String TEXT_389 = "();";
  protected final String TEXT_390 = NL + "    boolean isValid = ";
  protected final String TEXT_391 = "() >= ";
  protected final String TEXT_392 = "() && ";
  protected final String TEXT_393 = "() <= ";
  protected final String TEXT_394 = "();";
  protected final String TEXT_395 = NL + "    return isValid;" + NL + "  }";
  protected final String TEXT_396 = NL + "  public static int ";
  protected final String TEXT_397 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_398 = ";" + NL + "  }";
  protected final String TEXT_399 = NL + "  public static int ";
  protected final String TEXT_400 = "()" + NL + "  {";
  protected final String TEXT_401 = NL + "    int required = ";
  protected final String TEXT_402 = ";";
  protected final String TEXT_403 = NL + "    return required;" + NL + "  }";
  protected final String TEXT_404 = NL + "  public static int ";
  protected final String TEXT_405 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_406 = ";" + NL + "  }";
  protected final String TEXT_407 = NL + "  public static int ";
  protected final String TEXT_408 = "()" + NL + "  {";
  protected final String TEXT_409 = NL + "    int minimum = ";
  protected final String TEXT_410 = ";";
  protected final String TEXT_411 = NL + "    return minimum;" + NL + "  }";
  protected final String TEXT_412 = NL + "  public static int ";
  protected final String TEXT_413 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_414 = ";" + NL + "  }";
  protected final String TEXT_415 = NL + "  public static int ";
  ...
  protected final String TEXT_423 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_442 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_443 = NL + "    if (!";
  protected final String TEXT_444 = ".contains(";
  protected final String TEXT_445 = "))" + NL + "    {";
  protected final String TEXT_446 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_447 = ".indexOf(";
  protected final String TEXT_448 = ");";
  protected final String TEXT_449 = NL + "    ";
  protected final String TEXT_450 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_451 = ".";
  protected final String TEXT_452 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_453 = ".";
  protected final String TEXT_454 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_455 = NL + "        ";
  protected final String TEXT_456 = ".add(oldIndex,";
  protected final String TEXT_457 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_458 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_459 = NL + "  public boolean ";
  protected final String TEXT_460 = "(";
  protected final String TEXT_461 = " ";
  protected final String TEXT_462 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_463 = NL + "    ";
  protected final String TEXT_464 = " = ";
  protected final String TEXT_465 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_466 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_467 = NL + "  public boolean ";
  protected final String TEXT_468 = "(";
  protected final String TEXT_469 = " ";
  protected final String TEXT_470 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_471 = NL + "    if (";
  protected final String TEXT_472 = " != null)" + NL + "    {";
  protected final String TEXT_473 = NL + "      ";
  protected final String TEXT_474 = " = ";
  protected final String TEXT_475 = ";" + NL + "      wasSet = true;" + NL + "    }";
  ...
  protected final String TEXT_486 = "()))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_487 = ", as existing ";
  protected final String TEXT_488 = " would become an orphan";
  ...
  protected final String TEXT_498 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  protected final String TEXT_499 = "))" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_507 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_508 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_509 = NL + "  public boolean ";
  protected final String TEXT_510 = "(";
  protected final String TEXT_511 = " ";
  protected final String TEXT_512 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_513 = NL + "    if (";
  protected final String TEXT_514 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_515 = " to null, as ";
  protected final String TEXT_516 = " must always be associated to a ";
  ...
  protected final String TEXT_523 = " != null && !equals(";
  protected final String TEXT_524 = "))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_525 = ", the current ";
  protected final String TEXT_526 = " already has a ";
  protected final String TEXT_527 = ", which would be orphaned if it were re-assigned";
  ...
  protected final String TEXT_538 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_539 = " != null)" + NL + "    {";
  protected final String TEXT_540 = NL + "      ";
  protected final String TEXT_541 = ".";
  protected final String TEXT_542 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_543 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_544 = NL + "  public ";
  protected final String TEXT_545 = " ";
  protected final String TEXT_546 = "(";
  protected final String TEXT_547 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_548 = "(";
  protected final String TEXT_549 = ");" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_550 = "(";
  protected final String TEXT_551 = " ";
  protected final String TEXT_552 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_553 = NL + "    ";
  protected final String TEXT_554 = " ";
  protected final String TEXT_555 = " = ";
  protected final String TEXT_556 = ".";
  protected final String TEXT_557 = "();" + NL + "    boolean ";
  ...
  protected final String TEXT_572 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_573 = "(";
  protected final String TEXT_574 = " ";
  protected final String TEXT_575 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_576 = NL + "    //Unable to remove ";
  protected final String TEXT_577 = ", as it must always have a ";
  protected final String TEXT_578 = NL + "    if (this.equals(";
  protected final String TEXT_579 = ".";
  protected final String TEXT_580 = "()))" + NL + "    {";
  protected final String TEXT_581 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_582 = " already at minimum (";
  protected final String TEXT_583 = ")" + NL + "    if (";
  protected final String TEXT_584 = "() <= ";
  protected final String TEXT_585 = "())" + NL + "    {";
  protected final String TEXT_586 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_587 = NL + "    ";
  protected final String TEXT_588 = ".remove(";
  protected final String TEXT_589 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_590 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_591 = NL + "  public ";
  protected final String TEXT_592 = " ";
  protected final String TEXT_593 = "(";
  protected final String TEXT_594 = ")" + NL + "  {" + NL + "    if (";
  protected final String TEXT_595 = "() >= ";
  protected final String TEXT_596 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_597 = "(";
  protected final String TEXT_598 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_599 = "(";
  protected final String TEXT_600 = " ";
  protected final String TEXT_601 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_602 = NL + "    if (";
  protected final String TEXT_603 = "() >= ";
  protected final String TEXT_604 = "())" + NL + "    {";
  protected final String TEXT_605 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_606 = NL + "    ";
  protected final String TEXT_607 = " ";
  protected final String TEXT_608 = " = ";
  protected final String TEXT_609 = ".";
  protected final String TEXT_610 = "();" + NL + "    boolean ";
  ...
  protected final String TEXT_618 = NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_626 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_627 = "(";
  protected final String TEXT_628 = " ";
  protected final String TEXT_629 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_645 = NL + "  public ";
  ...
  protected final String TEXT_652 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public boolean ";
  ...
  protected final String TEXT_664 = "();" + NL + "    boolean ";
  ...
  protected final String TEXT_691 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_692 = NL + "    ArrayList<";
  protected final String TEXT_693 = "> ";
  protected final String TEXT_694 = " = new ArrayList<";
  protected final String TEXT_695 = ">();" + NL + "    for (";
  protected final String TEXT_696 = " ";
  protected final String TEXT_697 = " : ";
  protected final String TEXT_698 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_699 = ".contains(";
  protected final String TEXT_700 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_701 = NL + "      ";
  protected final String TEXT_702 = ".add(";
  protected final String TEXT_703 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_704 = ".size() != ";
  protected final String TEXT_705 = ".length || ";
  protected final String TEXT_706 = ".size() > ";
  protected final String TEXT_707 = "())" + NL + "    {";
  protected final String TEXT_708 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_709 = "> ";
  protected final String TEXT_710 = " = new ArrayList<";
  protected final String TEXT_711 = ">(";
  protected final String TEXT_712 = ");";
  protected final String TEXT_713 = NL + "    ";
  protected final String TEXT_714 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_721 = ".contains(";
  protected final String TEXT_722 = "))" + NL + "      {";
  protected final String TEXT_723 = NL + "        ";
  protected final String TEXT_724 = ".remove(";
  protected final String TEXT_725 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_726 = NL + "        ";
  protected final String TEXT_727 = ".";
  protected final String TEXT_728 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_729 = " ";
  protected final String TEXT_730 = " : ";
  protected final String TEXT_731 = ")" + NL + "    {";
  protected final String TEXT_732 = NL + "      ";
  protected final String TEXT_733 = ".";
  protected final String TEXT_734 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_735 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_736 = NL + "  public ";
  protected final String TEXT_737 = " ";
  protected final String TEXT_738 = "(";
  protected final String TEXT_739 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_740 = "(";
  protected final String TEXT_741 = ");" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_742 = "(";
  protected final String TEXT_743 = " ";
  protected final String TEXT_744 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_745 = NL + "    ";
  protected final String TEXT_746 = " ";
  protected final String TEXT_747 = " = ";
  protected final String TEXT_748 = ".";
  protected final String TEXT_749 = "();" + NL + "    boolean ";
  protected final String TEXT_750 = " = ";
  protected final String TEXT_751 = " != null && !this.equals(";
  ...
  protected final String TEXT_759 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_760 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_761 = "(";
  protected final String TEXT_762 = " ";
  protected final String TEXT_763 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_764 = NL + "    //Unable to remove ";
  protected final String TEXT_765 = ", as it must always have a ";
  protected final String TEXT_766 = NL + "    if (!this.equals(";
  protected final String TEXT_767 = ".";
  protected final String TEXT_768 = "()))" + NL + "    {";
  protected final String TEXT_769 = NL + "      ";
  protected final String TEXT_770 = ".remove(";
  protected final String TEXT_771 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_772 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_773 = NL + "  public boolean ";
  protected final String TEXT_774 = "(";
  protected final String TEXT_775 = " ";
  protected final String TEXT_776 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_784 = " = null;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_790 = "(null);" + NL + "      }" + NL + "      wasSet = true;";
  ...
  protected final String TEXT_801 = "(null);" + NL + "    }" + NL;
  ...
  protected final String TEXT_809 = "();" + NL + "" + NL + "    if (!equals(";
  ...
  protected final String TEXT_815 = NL + "  public boolean ";
  protected final String TEXT_816 = "(";
  protected final String TEXT_817 = " ";
  protected final String TEXT_818 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_819 = NL + "    if (!";
  protected final String TEXT_820 = ".contains(";
  protected final String TEXT_821 = "))" + NL + "    {";
  protected final String TEXT_822 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_823 = "() <= ";
  protected final String TEXT_824 = "())" + NL + "    {";
  protected final String TEXT_825 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_826 = ".indexOf(";
  protected final String TEXT_827 = ");";
  protected final String TEXT_828 = NL + "    ";
  protected final String TEXT_829 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_830 = ".";
  protected final String TEXT_831 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_832 = ".";
  protected final String TEXT_833 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_834 = NL + "        ";
  protected final String TEXT_835 = ".add(oldIndex,";
  ...
  protected final String TEXT_880 = ".equals(";
  protected final String TEXT_881 = "))" + NL + "    {";
  protected final String TEXT_882 = NL + "      ";
  protected final String TEXT_883 = ".";
  protected final String TEXT_884 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_885 = " != null)" + NL + "    {";
  protected final String TEXT_886 = NL + "      ";
  protected final String TEXT_887 = ".";
  protected final String TEXT_888 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_889 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_890 = NL + "  public boolean ";
  protected final String TEXT_891 = "(";
  protected final String TEXT_892 = " ";
  protected final String TEXT_893 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_909 = "(this);" + NL + "    }";
  protected final String TEXT_910 = NL + "    ";
  protected final String TEXT_911 = ".";
  protected final String TEXT_912 = "(this);" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_918 = NL + "    //Must provide ";
  protected final String TEXT_919 = " to ";
  ...
  protected final String TEXT_923 = " already at maximum (";
  ...
  protected final String TEXT_939 = "))" + NL + "    {" + NL + "      boolean didRemove = ";
  protected final String TEXT_940 = ".";
  protected final String TEXT_941 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_948 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_949 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_950 = NL + "  public boolean ";
  protected final String TEXT_951 = "(";
  protected final String TEXT_952 = " ";
  protected final String TEXT_953 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_954 = NL + "    //Must provide ";
  protected final String TEXT_955 = " to ";
  protected final String TEXT_956 = NL + "    if (";
  protected final String TEXT_957 = " == null)" + NL + "    {";
  protected final String TEXT_958 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_959 = " != null && ";
  protected final String TEXT_960 = ".";
  protected final String TEXT_961 = "() <= ";
  protected final String TEXT_962 = ".";
  protected final String TEXT_963 = "())" + NL + "    {";
  protected final String TEXT_964 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_973 = ".equals(";
  protected final String TEXT_974 = "))" + NL + "    {" + NL + "      boolean didRemove = ";
  protected final String TEXT_975 = ".";
  protected final String TEXT_976 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_985 = NL + "  public boolean ";
  protected final String TEXT_986 = "(";
  protected final String TEXT_987 = " ";
  protected final String TEXT_988 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_997 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1005 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1006 = NL + "      ";
  protected final String TEXT_1007 = ".add(";
  protected final String TEXT_1008 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1009 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1010 = "(";
  protected final String TEXT_1011 = " ";
  protected final String TEXT_1012 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1013 = NL + "    if (";
  protected final String TEXT_1014 = ".contains(";
  protected final String TEXT_1015 = "))" + NL + "    {";
  protected final String TEXT_1016 = NL + "      ";
  protected final String TEXT_1017 = ".remove(";
  ...
  protected final String TEXT_1035 = ".equals(";
  ...
  protected final String TEXT_1045 = NL + "  public boolean ";
  protected final String TEXT_1046 = "(";
  protected final String TEXT_1047 = " ";
  protected final String TEXT_1048 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1049 = NL + "    if (";
  protected final String TEXT_1050 = "() >= ";
  protected final String TEXT_1051 = "())" + NL + "    {";
  protected final String TEXT_1052 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1061 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1069 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1070 = NL + "      ";
  protected final String TEXT_1071 = ".add(";
  protected final String TEXT_1072 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1073 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1074 = "(";
  protected final String TEXT_1075 = " ";
  protected final String TEXT_1076 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1077 = NL + "    if (";
  protected final String TEXT_1078 = ".contains(";
  ...
  protected final String TEXT_1085 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1086 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1087 = NL + "  public boolean ";
  protected final String TEXT_1088 = "(";
  protected final String TEXT_1089 = " ";
  protected final String TEXT_1090 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_1096 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_1104 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1105 = "() <= ";
  protected final String TEXT_1106 = "())" + NL + "    {";
  protected final String TEXT_1107 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1108 = NL + "    ";
  protected final String TEXT_1109 = ".remove(";
  ...
  protected final String TEXT_1115 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1116 = NL + "    if (";
  protected final String TEXT_1117 = "() >= ";
  protected final String TEXT_1118 = "())" + NL + "    {";
  protected final String TEXT_1119 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1129 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  ...
  protected final String TEXT_1136 = ".add(";
  protected final String TEXT_1137 = ");";
  protected final String TEXT_1138 = NL + "    ";
  protected final String TEXT_1139 = "(";
  protected final String TEXT_1140 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1141 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1142 = "(";
  protected final String TEXT_1143 = " ";
  protected final String TEXT_1144 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1145 = NL + "    if (";
  protected final String TEXT_1146 = ".contains(";
  protected final String TEXT_1147 = ") && ";
  protected final String TEXT_1148 = "() > ";
  protected final String TEXT_1149 = "())" + NL + "    {";
  protected final String TEXT_1150 = NL + "      ";
  protected final String TEXT_1151 = ".remove(";
  protected final String TEXT_1152 = ");";
  protected final String TEXT_1153 = NL + "      ";
  protected final String TEXT_1154 = "(";
  protected final String TEXT_1155 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1156 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1157 = NL + "  public boolean ";
  protected final String TEXT_1158 = "(";
  protected final String TEXT_1159 = "... ";
  protected final String TEXT_1160 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1161 = NL + "    ArrayList<";
  protected final String TEXT_1162 = "> ";
  protected final String TEXT_1163 = " = new ArrayList<";
  protected final String TEXT_1164 = ">();" + NL + "    for (";
  protected final String TEXT_1165 = " ";
  protected final String TEXT_1166 = " : ";
  protected final String TEXT_1167 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1168 = ".contains(";
  protected final String TEXT_1169 = "))" + NL + "      {";
  protected final String TEXT_1170 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1171 = ".";
  protected final String TEXT_1172 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1178 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1179 = ".size() != ";
  protected final String TEXT_1180 = "())" + NL + "    {";
  protected final String TEXT_1181 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1182 = NL + "    ";
  protected final String TEXT_1183 = ".removeAll(";
  protected final String TEXT_1184 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1185 = " orphan : ";
  protected final String TEXT_1186 = ")" + NL + "    {";
  protected final String TEXT_1187 = NL + "      ";
  protected final String TEXT_1188 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1189 = NL + "    ";
  protected final String TEXT_1190 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1198 = ".add(";
  protected final String TEXT_1199 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1200 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1201 = NL + "  private void ";
  protected final String TEXT_1202 = "(";
  protected final String TEXT_1203 = " ";
  protected final String TEXT_1204 = ", ";
  protected final String TEXT_1205 = " ";
  protected final String TEXT_1206 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1207 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1208 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1209 = ", ";
  protected final String TEXT_1210 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1211 = " to ";
  protected final String TEXT_1212 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1213 = NL + "  public boolean ";
  protected final String TEXT_1214 = "(";
  protected final String TEXT_1215 = " ";
  protected final String TEXT_1216 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1217 = NL + "    ";
  protected final String TEXT_1218 = ".add(";
  protected final String TEXT_1219 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1220 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1221 = "(";
  protected final String TEXT_1222 = " ";
  protected final String TEXT_1223 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1224 = NL + "    if (";
  protected final String TEXT_1225 = ".contains(";
  protected final String TEXT_1226 = "))" + NL + "    {";
  protected final String TEXT_1227 = NL + "      ";
  protected final String TEXT_1228 = ".remove(";
  protected final String TEXT_1229 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1230 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1231 = NL + "  public boolean ";
  protected final String TEXT_1232 = "(";
  protected final String TEXT_1233 = " ";
  protected final String TEXT_1234 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_1241 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1242 = "(";
  protected final String TEXT_1243 = " ";
  protected final String TEXT_1244 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1245 = NL + "    if (";
  protected final String TEXT_1246 = ".contains(";
  protected final String TEXT_1247 = "))" + NL + "    {";
  protected final String TEXT_1248 = NL + "      ";
  protected final String TEXT_1249 = ".remove(";
  protected final String TEXT_1250 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1251 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1252 = NL + "  public boolean ";
  protected final String TEXT_1253 = "(";
  protected final String TEXT_1254 = " ";
  protected final String TEXT_1255 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1256 = NL + "    ";
  protected final String TEXT_1257 = ".add(";
  protected final String TEXT_1258 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1259 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  ...
  protected final String TEXT_1271 = ".remove(";
  protected final String TEXT_1272 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1273 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1274 = NL + "  public boolean ";
  protected final String TEXT_1275 = "(";
  protected final String TEXT_1276 = "... ";
  protected final String TEXT_1277 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1278 = NL + "    ArrayList<";
  protected final String TEXT_1279 = "> ";
  protected final String TEXT_1280 = " = new ArrayList<";
  protected final String TEXT_1281 = ">();" + NL + "    for (";
  protected final String TEXT_1282 = " ";
  protected final String TEXT_1283 = " : ";
  protected final String TEXT_1284 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1285 = ".contains(";
  protected final String TEXT_1286 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1287 = NL + "      ";
  protected final String TEXT_1288 = ".add(";
  protected final String TEXT_1289 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1290 = ".size() != ";
  protected final String TEXT_1291 = ".length || ";
  protected final String TEXT_1292 = ".size() != ";
  protected final String TEXT_1293 = "())" + NL + "    {";
  protected final String TEXT_1294 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1295 = NL + "    ";
  protected final String TEXT_1296 = ".clear();";
  protected final String TEXT_1297 = NL + "    ";
  protected final String TEXT_1298 = ".addAll(";
  protected final String TEXT_1299 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1300 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1301 = NL + "  public boolean ";
  protected final String TEXT_1302 = "(";
  protected final String TEXT_1303 = "... ";
  protected final String TEXT_1304 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1305 = NL + "    ArrayList<";
  protected final String TEXT_1306 = "> ";
  protected final String TEXT_1307 = " = new ArrayList<";
  protected final String TEXT_1308 = ">();" + NL + "    for (";
  protected final String TEXT_1309 = " ";
  protected final String TEXT_1310 = " : ";
  protected final String TEXT_1311 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1312 = ".contains(";
  protected final String TEXT_1313 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1314 = NL + "      ";
  protected final String TEXT_1315 = ".add(";
  protected final String TEXT_1316 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1317 = ".size() != ";
  protected final String TEXT_1318 = ".length || ";
  ...
  protected final String TEXT_1323 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  ...
  protected final String TEXT_1340 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1341 = NL + "        ";
  protected final String TEXT_1342 = ".";
  protected final String TEXT_1343 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1349 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1371 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  ...
  protected final String TEXT_1377 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1384 = ".contains(";
  protected final String TEXT_1385 = "))" + NL + "      {";
  protected final String TEXT_1386 = NL + "        ";
  protected final String TEXT_1387 = ".remove(";
  protected final String TEXT_1388 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1389 = NL + "        ";
  protected final String TEXT_1390 = ".";
  protected final String TEXT_1391 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1397 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1410 = ".contains(";
  protected final String TEXT_1411 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1412 = NL + "      ";
  protected final String TEXT_1413 = ".add(";
  protected final String TEXT_1414 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1421 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1422 = NL + "    ";
  protected final String TEXT_1423 = ".clear();";
  protected final String TEXT_1424 = NL + "    ";
  protected final String TEXT_1425 = ".addAll(";
  protected final String TEXT_1426 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1427 = NL + "    return wasSet;" + NL + "  }" + NL;
  ...
  protected final String TEXT_1433 = ".length < ";
  protected final String TEXT_1434 = "()";
  protected final String TEXT_1435 = ")" + NL + "    {";
  protected final String TEXT_1436 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_1437 = "> ";
  protected final String TEXT_1438 = " = new ArrayList<";
  protected final String TEXT_1439 = ">();" + NL + "    HashMap<";
  protected final String TEXT_1440 = ",Integer> ";
  protected final String TEXT_1441 = " = new HashMap<";
  protected final String TEXT_1442 = ",Integer>();" + NL + "    for (";
  ...
  protected final String TEXT_1448 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1449 = ".";
  protected final String TEXT_1450 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1457 = "();" + NL + "        if (!";
  protected final String TEXT_1458 = ".containsKey(";
  protected final String TEXT_1459 = "))" + NL + "        {";
  protected final String TEXT_1460 = NL + "          ";
  protected final String TEXT_1461 = ".put(";
  protected final String TEXT_1462 = ", new Integer(";
  protected final String TEXT_1463 = ".";
  protected final String TEXT_1464 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1465 = ".get(";
  protected final String TEXT_1466 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1467 = ")" + NL + "        {";
  protected final String TEXT_1468 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1469 = NL + "        ";
  protected final String TEXT_1470 = ".put(";
  protected final String TEXT_1471 = ", new Integer(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1476 = ".removeAll(";
  protected final String TEXT_1477 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1478 = " orphan : ";
  protected final String TEXT_1479 = ")" + NL + "    {";
  protected final String TEXT_1480 = NL + "      ";
  protected final String TEXT_1481 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1482 = NL + "    ";
  protected final String TEXT_1483 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1501 = NL + "  private void ";
  ...
  protected final String TEXT_1506 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1507 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1508 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1509 = ", ";
  protected final String TEXT_1510 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1511 = " to ";
  protected final String TEXT_1512 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1513 = NL + "  public boolean ";
  ...
  protected final String TEXT_1543 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1544 = NL + "    ArrayList<";
  protected final String TEXT_1545 = "> ";
  protected final String TEXT_1546 = " = new ArrayList<";
  ...
  protected final String TEXT_1551 = ".contains(";
  ...
  protected final String TEXT_1557 = ".length || ";
  protected final String TEXT_1558 = ".size() < ";
  protected final String TEXT_1559 = "())" + NL + "    {";
  protected final String TEXT_1560 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1561 = NL + "    ";
  protected final String TEXT_1562 = ".clear();";
  protected final String TEXT_1563 = NL + "    ";
  protected final String TEXT_1564 = ".addAll(";
  protected final String TEXT_1565 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1566 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1567 = NL + "  public boolean equals(Object obj)" + NL + "  {" + NL + "    if (obj == null) { return false; }" + NL + "    if (!getClass().equals(obj.getClass())) { return false; }" + NL;
  protected final String TEXT_1568 = NL + "    ";
  protected final String TEXT_1569 = " compareTo = (";
  protected final String TEXT_1570 = ")obj;" + NL + "  ";
  protected final String TEXT_1571 = NL + "    ";
  protected final String TEXT_1572 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1573 = NL + "    ";
  protected final String TEXT_1574 = NL;
  protected final String TEXT_1575 = NL + "    ";
  protected final String TEXT_1576 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1577 = NL + "  private void ";
  protected final String TEXT_1578 = "() throws InterruptedException" + NL + "  {";
  protected final String TEXT_1579 = NL + "    ";
  protected final String TEXT_1580 = NL + "  }" + NL;
  protected final String TEXT_1581 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1582 = NL + "    ";
  protected final String TEXT_1583 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1584 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {" + NL + "      try" + NL + "      {";
  protected final String TEXT_1585 = NL + "        ";
  protected final String TEXT_1586 = NL + "      }" + NL + "      catch (InterruptedException e)" + NL + "      {" + NL + "        e.printStackTrace();" + NL + "      }" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1587 = NL + "  private void ";
  protected final String TEXT_1588 = "()" + NL + "  {";
  protected final String TEXT_1589 = NL + "    ";
  protected final String TEXT_1590 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1591 = "\",";
  protected final String TEXT_1592 = ");" + NL + "  }" + NL + "" + NL + "  private void ";
  protected final String TEXT_1593 = "()" + NL + "  {";
  protected final String TEXT_1594 = NL + "    ";
  protected final String TEXT_1595 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1596 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1597 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1598 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void run ()" + NL + "    {";
  protected final String TEXT_1599 = NL + "      if (\"";
  protected final String TEXT_1600 = "\".equals(timeoutMethodName))" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1601 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1602 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1603 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1604 = NL + "    ";
  protected final String TEXT_1605 = " = null;";
  protected final String TEXT_1606 = NL + "    ";
  protected final String TEXT_1607 = ".clear();";
  ...
  protected final String TEXT_1613 = " = null;" + NL + "    if (";
  protected final String TEXT_1614 = " != null)" + NL + "    {";
  protected final String TEXT_1615 = NL + "      ";
  protected final String TEXT_1616 = ".delete();" + NL + "    }";
  protected final String TEXT_1617 = NL + "    if (";
  protected final String TEXT_1618 = " != null)" + NL + "    {";
  ...
  protected final String TEXT_1693 = ".clear();" + NL + "    for(";
  protected final String TEXT_1694 = " ";
  protected final String TEXT_1695 = " : ";
  protected final String TEXT_1696 = ")" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1702 = ".delete();" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1703 = NL + "        ";
  protected final String TEXT_1704 = ".";
  protected final String TEXT_1705 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1706 = NL + "    ArrayList<";
  protected final String TEXT_1707 = "> ";
  protected final String TEXT_1708 = " = new ArrayList<";
  ...
  protected final String TEXT_1718 = "(this);" + NL + "    }";
  protected final String TEXT_1719 = NL + "    for(";
  ...
  protected final String TEXT_1724 = ".delete();" + NL + "    }";
  ...
  protected final String TEXT_1732 = "  " + NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
