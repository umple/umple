...
public class JavaClassGenerator implements ILang 
{
  ...
  protected final String TEXT_298 = NL + "  private boolean ";
  protected final String TEXT_299 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_300 = ";" + NL + "  }" + NL;
  protected final String TEXT_301 = NL + "  ";
  protected final String TEXT_302 = " boolean ";
  protected final String TEXT_303 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;";
  protected final String TEXT_304 = NL + "    ";
  protected final String TEXT_305 = NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_306 = NL + "  public boolean ";
  protected final String TEXT_307 = "(";
  protected final String TEXT_308 = " ";
  protected final String TEXT_309 = ")" + NL + "  {";
  protected final String TEXT_310 = NL + "    ";
  protected final String TEXT_311 = " = ";
  protected final String TEXT_312 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_313 = NL + "  private void ";
  ...
  protected final String TEXT_320 = NL + "  private void ";
  ...
  protected final String TEXT_337 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  protected final String TEXT_338 = ")" + NL + "    {";
  protected final String TEXT_339 = NL + "      ";
  protected final String TEXT_340 = NL + "    }";
  protected final String TEXT_341 = NL + "  }" + NL;
  protected final String TEXT_342 = NL + "  public ";
  ...
  protected final String TEXT_360 = ".get(index);";
  protected final String TEXT_361 = NL + "    return ";
  protected final String TEXT_362 = ";" + NL + "  }" + NL + "" + NL + "  public List<";
  protected final String TEXT_363 = "> ";
  protected final String TEXT_364 = "()" + NL + "  {";
  protected final String TEXT_365 = NL + "    List<";
  protected final String TEXT_366 = "> ";
  protected final String TEXT_367 = " = Collections.unmodifiableList(";
  protected final String TEXT_368 = ");";
  protected final String TEXT_369 = NL + "    return ";
  protected final String TEXT_370 = ";" + NL + "  }" + NL + "" + NL + "  public int ";
  protected final String TEXT_371 = "()" + NL + "  {";
  protected final String TEXT_372 = NL + "    int number = ";
  protected final String TEXT_373 = ".size();";
  protected final String TEXT_374 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_375 = "()" + NL + "  {";
  protected final String TEXT_376 = NL + "    boolean has = ";
  protected final String TEXT_377 = ".size() > 0;";
  protected final String TEXT_378 = NL + "    return has;" + NL + "  }" + NL + "" + NL + "  public int ";
  protected final String TEXT_379 = "(";
  protected final String TEXT_380 = " ";
  protected final String TEXT_381 = ")" + NL + "  {";
  protected final String TEXT_382 = NL + "    int index = ";
  protected final String TEXT_383 = ".indexOf(";
  protected final String TEXT_384 = ");";
  protected final String TEXT_385 = NL + "    return index;" + NL + "  }" + NL;
  protected final String TEXT_386 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_387 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  ...
  protected final String TEXT_394 = NL + "    boolean isValid = ";
  ...
  protected final String TEXT_405 = NL + "    int required = ";
  protected final String TEXT_406 = ";";
  protected final String TEXT_407 = NL + "    return required;" + NL + "  }";
  ...
  protected final String TEXT_413 = NL + "    int minimum = ";
  protected final String TEXT_414 = ";";
  protected final String TEXT_415 = NL + "    return minimum;" + NL + "  }";
  ...
  protected final String TEXT_419 = NL + "  public static int ";
  protected final String TEXT_420 = "()" + NL + "  {";
  protected final String TEXT_421 = NL + "    int maximum = ";
  protected final String TEXT_422 = ";";
  protected final String TEXT_423 = NL + "    return maximum;" + NL + "  }";
  protected final String TEXT_424 = NL + "  public boolean ";
  protected final String TEXT_425 = "(";
  protected final String TEXT_426 = " ";
  protected final String TEXT_427 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_443 = NL + "  public boolean ";
  protected final String TEXT_444 = "(";
  protected final String TEXT_445 = " ";
  protected final String TEXT_446 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_447 = NL + "    if (!";
  protected final String TEXT_448 = ".contains(";
  protected final String TEXT_449 = "))" + NL + "    {";
  protected final String TEXT_450 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_451 = ".indexOf(";
  protected final String TEXT_452 = ");";
  protected final String TEXT_453 = NL + "    ";
  protected final String TEXT_454 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_455 = ".";
  protected final String TEXT_456 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_457 = ".";
  protected final String TEXT_458 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_459 = NL + "        ";
  protected final String TEXT_460 = ".add(oldIndex,";
  protected final String TEXT_461 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_462 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_463 = NL + "  public boolean ";
  protected final String TEXT_464 = "(";
  protected final String TEXT_465 = " ";
  protected final String TEXT_466 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_467 = NL + "    ";
  protected final String TEXT_468 = " = ";
  protected final String TEXT_469 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_470 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_471 = NL + "  public boolean ";
  protected final String TEXT_472 = "(";
  protected final String TEXT_473 = " ";
  protected final String TEXT_474 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_481 = NL + "  public boolean ";
  ...
  protected final String TEXT_516 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_517 = NL + "    if (";
  protected final String TEXT_518 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_519 = " to null, as ";
  protected final String TEXT_520 = " must always be associated to a ";
  ...
  protected final String TEXT_527 = " != null && !equals(";
  protected final String TEXT_528 = "))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_529 = ", the current ";
  protected final String TEXT_530 = " already has a ";
  protected final String TEXT_531 = ", which would be orphaned if it were re-assigned";
  ...
  protected final String TEXT_542 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_543 = " != null)" + NL + "    {";
  protected final String TEXT_544 = NL + "      ";
  protected final String TEXT_545 = ".";
  protected final String TEXT_546 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_547 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_548 = NL + "  public ";
  protected final String TEXT_549 = " ";
  protected final String TEXT_550 = "(";
  protected final String TEXT_551 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_552 = "(";
  protected final String TEXT_553 = ");" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_554 = "(";
  protected final String TEXT_555 = " ";
  protected final String TEXT_556 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_557 = NL + "    ";
  protected final String TEXT_558 = " ";
  protected final String TEXT_559 = " = ";
  protected final String TEXT_560 = ".";
  protected final String TEXT_561 = "();" + NL + "    boolean ";
  protected final String TEXT_562 = " = ";
  protected final String TEXT_563 = " != null && !this.equals(";
  protected final String TEXT_564 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_565 = " && ";
  protected final String TEXT_566 = ".";
  protected final String TEXT_567 = "() <= ";
  protected final String TEXT_568 = "())" + NL + "    {" + NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_569 = ")" + NL + "    {";
  protected final String TEXT_570 = NL + "      ";
  protected final String TEXT_571 = ".";
  protected final String TEXT_572 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_573 = NL + "      ";
  protected final String TEXT_574 = ".add(";
  protected final String TEXT_575 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_576 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_577 = "(";
  protected final String TEXT_578 = " ";
  protected final String TEXT_579 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_580 = NL + "    //Unable to remove ";
  protected final String TEXT_581 = ", as it must always have a ";
  protected final String TEXT_582 = NL + "    if (this.equals(";
  protected final String TEXT_583 = ".";
  protected final String TEXT_584 = "()))" + NL + "    {";
  protected final String TEXT_585 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_586 = " already at minimum (";
  ...
  protected final String TEXT_592 = ".remove(";
  protected final String TEXT_593 = ");" + NL + "    wasRemoved = true;";
  ...
  protected final String TEXT_600 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_601 = "(";
  protected final String TEXT_602 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_603 = "(";
  protected final String TEXT_604 = " ";
  protected final String TEXT_605 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_614 = "();" + NL + "    boolean ";
  ...
  protected final String TEXT_630 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_631 = "(";
  protected final String TEXT_632 = " ";
  protected final String TEXT_633 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_654 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_655 = "(";
  protected final String TEXT_656 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_657 = "(";
  protected final String TEXT_658 = " ";
  protected final String TEXT_659 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_668 = "();" + NL + "    boolean ";
  ...
  protected final String TEXT_675 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_676 = NL + "      ";
  protected final String TEXT_677 = ".add(";
  protected final String TEXT_678 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_679 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_680 = "(";
  protected final String TEXT_681 = " ";
  protected final String TEXT_682 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_683 = NL + "    //Unable to remove ";
  protected final String TEXT_684 = ", as it must always have a ";
  protected final String TEXT_685 = NL + "    if (!this.equals(";
  protected final String TEXT_686 = ".";
  protected final String TEXT_687 = "()))" + NL + "    {";
  protected final String TEXT_688 = NL + "      ";
  protected final String TEXT_689 = ".remove(";
  protected final String TEXT_690 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_691 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_692 = NL + "  public boolean ";
  protected final String TEXT_693 = "(";
  protected final String TEXT_694 = "... ";
  protected final String TEXT_695 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_696 = NL + "    ArrayList<";
  protected final String TEXT_697 = "> ";
  protected final String TEXT_698 = " = new ArrayList<";
  protected final String TEXT_699 = ">();" + NL + "    for (";
  protected final String TEXT_700 = " ";
  protected final String TEXT_701 = " : ";
  protected final String TEXT_702 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_703 = ".contains(";
  protected final String TEXT_704 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_705 = NL + "      ";
  protected final String TEXT_706 = ".add(";
  protected final String TEXT_707 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_708 = ".size() != ";
  protected final String TEXT_709 = ".length || ";
  protected final String TEXT_710 = ".size() > ";
  protected final String TEXT_711 = "())" + NL + "    {";
  protected final String TEXT_712 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_713 = "> ";
  protected final String TEXT_714 = " = new ArrayList<";
  protected final String TEXT_715 = ">(";
  protected final String TEXT_716 = ");";
  protected final String TEXT_717 = NL + "    ";
  protected final String TEXT_718 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_725 = ".contains(";
  ...
  protected final String TEXT_732 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_733 = " ";
  protected final String TEXT_734 = " : ";
  protected final String TEXT_735 = ")" + NL + "    {";
  protected final String TEXT_736 = NL + "      ";
  protected final String TEXT_737 = ".";
  protected final String TEXT_738 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_739 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_740 = NL + "  public ";
  protected final String TEXT_741 = " ";
  protected final String TEXT_742 = "(";
  protected final String TEXT_743 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_744 = "(";
  protected final String TEXT_745 = ");" + NL + "  }" + NL + "" + NL + "  public boolean ";
  ...
  protected final String TEXT_753 = "();" + NL + "    boolean ";
  protected final String TEXT_754 = " = ";
  protected final String TEXT_755 = " != null && !this.equals(";
  protected final String TEXT_756 = ");" + NL + "    if (";
  protected final String TEXT_757 = ")" + NL + "    {";
  protected final String TEXT_758 = NL + "      ";
  protected final String TEXT_759 = ".";
  protected final String TEXT_760 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_761 = NL + "      ";
  protected final String TEXT_762 = ".add(";
  protected final String TEXT_763 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_764 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_765 = "(";
  protected final String TEXT_766 = " ";
  protected final String TEXT_767 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_768 = NL + "    //Unable to remove ";
  protected final String TEXT_769 = ", as it must always have a ";
  protected final String TEXT_770 = NL + "    if (!this.equals(";
  protected final String TEXT_771 = ".";
  protected final String TEXT_772 = "()))" + NL + "    {";
  protected final String TEXT_773 = NL + "      ";
  protected final String TEXT_774 = ".remove(";
  protected final String TEXT_775 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_776 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_777 = NL + "  public boolean ";
  ...
  protected final String TEXT_788 = " = null;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_794 = "(null);" + NL + "      }" + NL + "      wasSet = true;";
  protected final String TEXT_795 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_805 = "(null);" + NL + "    }" + NL;
  ...
  protected final String TEXT_813 = "();" + NL + "" + NL + "    if (!equals(";
  ...
  protected final String TEXT_818 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_819 = NL + "  public boolean ";
  protected final String TEXT_820 = "(";
  protected final String TEXT_821 = " ";
  protected final String TEXT_822 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_823 = NL + "    if (!";
  protected final String TEXT_824 = ".contains(";
  protected final String TEXT_825 = "))" + NL + "    {";
  protected final String TEXT_826 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_827 = "() <= ";
  protected final String TEXT_828 = "())" + NL + "    {";
  protected final String TEXT_829 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_830 = ".indexOf(";
  protected final String TEXT_831 = ");";
  protected final String TEXT_832 = NL + "    ";
  protected final String TEXT_833 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_834 = ".";
  protected final String TEXT_835 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_836 = ".";
  protected final String TEXT_837 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_838 = NL + "        ";
  protected final String TEXT_839 = ".add(oldIndex,";
  protected final String TEXT_840 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_841 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_842 = NL + "  public boolean ";
  protected final String TEXT_843 = "(";
  protected final String TEXT_844 = " ";
  protected final String TEXT_845 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_846 = NL + "    if (!";
  protected final String TEXT_847 = ".contains(";
  protected final String TEXT_848 = "))" + NL + "    {";
  protected final String TEXT_849 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_850 = "() <= ";
  protected final String TEXT_851 = "())" + NL + "    {";
  protected final String TEXT_852 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_853 = ".indexOf(";
  protected final String TEXT_854 = ");";
  protected final String TEXT_855 = NL + "    ";
  protected final String TEXT_856 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_857 = ".";
  protected final String TEXT_858 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_859 = ".";
  protected final String TEXT_860 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_861 = NL + "        ";
  protected final String TEXT_862 = ".add(oldIndex,";
  ...
  protected final String TEXT_884 = ".equals(";
  protected final String TEXT_885 = "))" + NL + "    {";
  protected final String TEXT_886 = NL + "      ";
  protected final String TEXT_887 = ".";
  protected final String TEXT_888 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_889 = " != null)" + NL + "    {";
  protected final String TEXT_890 = NL + "      ";
  protected final String TEXT_891 = ".";
  protected final String TEXT_892 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_893 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_894 = NL + "  public boolean ";
  protected final String TEXT_895 = "(";
  protected final String TEXT_896 = " ";
  protected final String TEXT_897 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_926 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_927 = " already at maximum (";
  ...
  protected final String TEXT_958 = NL + "    //Must provide ";
  protected final String TEXT_959 = " to ";
  protected final String TEXT_960 = NL + "    if (";
  protected final String TEXT_961 = " == null)" + NL + "    {";
  protected final String TEXT_962 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_978 = "))" + NL + "    {" + NL + "      boolean didRemove = ";
  protected final String TEXT_979 = ".";
  protected final String TEXT_980 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_987 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_988 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_989 = NL + "  public boolean ";
  protected final String TEXT_990 = "(";
  protected final String TEXT_991 = " ";
  protected final String TEXT_992 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_1001 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1009 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1010 = NL + "      ";
  protected final String TEXT_1011 = ".add(";
  protected final String TEXT_1012 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1013 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1014 = "(";
  protected final String TEXT_1015 = " ";
  protected final String TEXT_1016 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1017 = NL + "    if (";
  protected final String TEXT_1018 = ".contains(";
  protected final String TEXT_1019 = "))" + NL + "    {";
  protected final String TEXT_1020 = NL + "      ";
  protected final String TEXT_1021 = ".remove(";
  protected final String TEXT_1022 = ");";
  protected final String TEXT_1023 = NL + "      ";
  protected final String TEXT_1024 = ".";
  protected final String TEXT_1025 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1065 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1073 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1074 = NL + "      ";
  protected final String TEXT_1075 = ".add(";
  protected final String TEXT_1076 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1077 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1078 = "(";
  protected final String TEXT_1079 = " ";
  protected final String TEXT_1080 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1081 = NL + "    if (";
  protected final String TEXT_1082 = ".contains(";
  protected final String TEXT_1083 = "))" + NL + "    {";
  protected final String TEXT_1084 = NL + "      ";
  protected final String TEXT_1085 = ".remove(";
  protected final String TEXT_1086 = ");";
  protected final String TEXT_1087 = NL + "      ";
  protected final String TEXT_1088 = ".";
  protected final String TEXT_1089 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1094 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1095 = NL + "    if (";
  protected final String TEXT_1096 = "() < ";
  protected final String TEXT_1097 = "())" + NL + "    {";
  protected final String TEXT_1098 = NL + "      ";
  protected final String TEXT_1099 = ".add(";
  protected final String TEXT_1100 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1101 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1102 = "(";
  protected final String TEXT_1103 = " ";
  protected final String TEXT_1104 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1105 = NL + "    if (!";
  protected final String TEXT_1106 = ".contains(";
  protected final String TEXT_1107 = "))" + NL + "    {";
  protected final String TEXT_1108 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1114 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1115 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1116 = NL + "  public boolean ";
  protected final String TEXT_1117 = "(";
  protected final String TEXT_1118 = " ";
  protected final String TEXT_1119 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1120 = NL + "    if (";
  protected final String TEXT_1121 = "() >= ";
  protected final String TEXT_1122 = "())" + NL + "    {";
  protected final String TEXT_1123 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1133 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1134 = " != null)" + NL + "    {";
  protected final String TEXT_1135 = NL + "      ";
  protected final String TEXT_1136 = ".";
  protected final String TEXT_1137 = ".remove(";
  ...
  protected final String TEXT_1144 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1145 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1146 = "(";
  protected final String TEXT_1147 = " ";
  protected final String TEXT_1148 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1149 = NL + "    if (";
  protected final String TEXT_1150 = ".contains(";
  ...
  protected final String TEXT_1159 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1165 = NL + "    ArrayList<";
  protected final String TEXT_1166 = "> ";
  protected final String TEXT_1167 = " = new ArrayList<";
  protected final String TEXT_1168 = ">();" + NL + "    for (";
  protected final String TEXT_1169 = " ";
  protected final String TEXT_1170 = " : ";
  protected final String TEXT_1171 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1172 = ".contains(";
  protected final String TEXT_1173 = "))" + NL + "      {";
  protected final String TEXT_1174 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1175 = ".";
  protected final String TEXT_1176 = "() != null && !this.equals(";
  protected final String TEXT_1177 = ".";
  protected final String TEXT_1178 = "()))" + NL + "      {";
  protected final String TEXT_1179 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1180 = NL + "      ";
  protected final String TEXT_1181 = ".add(";
  protected final String TEXT_1182 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1183 = ".size() != ";
  ...
  protected final String TEXT_1187 = ".removeAll(";
  protected final String TEXT_1188 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1189 = " orphan : ";
  protected final String TEXT_1190 = ")" + NL + "    {";
  protected final String TEXT_1191 = NL + "      ";
  protected final String TEXT_1192 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1193 = NL + "    ";
  protected final String TEXT_1194 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1203 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1204 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1205 = NL + "  private void ";
  protected final String TEXT_1206 = "(";
  protected final String TEXT_1207 = " ";
  protected final String TEXT_1208 = ", ";
  protected final String TEXT_1209 = " ";
  protected final String TEXT_1210 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1211 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1212 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1213 = ", ";
  protected final String TEXT_1214 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1215 = " to ";
  protected final String TEXT_1216 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1217 = NL + "  public boolean ";
  protected final String TEXT_1218 = "(";
  protected final String TEXT_1219 = " ";
  protected final String TEXT_1220 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1221 = NL + "    ";
  protected final String TEXT_1222 = ".add(";
  protected final String TEXT_1223 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1224 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1225 = "(";
  protected final String TEXT_1226 = " ";
  protected final String TEXT_1227 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_1233 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1245 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1246 = "(";
  protected final String TEXT_1247 = " ";
  protected final String TEXT_1248 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1249 = NL + "    if (";
  protected final String TEXT_1250 = ".contains(";
  protected final String TEXT_1251 = "))" + NL + "    {";
  protected final String TEXT_1252 = NL + "      ";
  protected final String TEXT_1253 = ".remove(";
  protected final String TEXT_1254 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1263 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1264 = "(";
  protected final String TEXT_1265 = " ";
  protected final String TEXT_1266 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1267 = NL + "    if (!";
  protected final String TEXT_1268 = ".contains(";
  protected final String TEXT_1269 = "))" + NL + "    {";
  protected final String TEXT_1270 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1275 = ".remove(";
  ...
  protected final String TEXT_1281 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1282 = NL + "    ArrayList<";
  protected final String TEXT_1283 = "> ";
  protected final String TEXT_1284 = " = new ArrayList<";
  protected final String TEXT_1285 = ">();" + NL + "    for (";
  protected final String TEXT_1286 = " ";
  protected final String TEXT_1287 = " : ";
  protected final String TEXT_1288 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1289 = ".contains(";
  protected final String TEXT_1290 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1291 = NL + "      ";
  protected final String TEXT_1292 = ".add(";
  protected final String TEXT_1293 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1294 = ".size() != ";
  protected final String TEXT_1295 = ".length || ";
  ...
  protected final String TEXT_1305 = NL + "  public boolean ";
  protected final String TEXT_1306 = "(";
  protected final String TEXT_1307 = "... ";
  protected final String TEXT_1308 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1309 = NL + "    ArrayList<";
  protected final String TEXT_1310 = "> ";
  protected final String TEXT_1311 = " = new ArrayList<";
  protected final String TEXT_1312 = ">();" + NL + "    for (";
  protected final String TEXT_1313 = " ";
  protected final String TEXT_1314 = " : ";
  protected final String TEXT_1315 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1316 = ".contains(";
  protected final String TEXT_1317 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1318 = NL + "      ";
  protected final String TEXT_1319 = ".add(";
  protected final String TEXT_1320 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1321 = ".size() != ";
  protected final String TEXT_1322 = ".length || ";
  ...
  protected final String TEXT_1327 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  ...
  protected final String TEXT_1333 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1343 = ".remove(";
  protected final String TEXT_1344 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1345 = NL + "        ";
  protected final String TEXT_1346 = ".";
  protected final String TEXT_1347 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1353 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1354 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1355 = NL + "  public boolean ";
  protected final String TEXT_1356 = "(";
  protected final String TEXT_1357 = "... ";
  protected final String TEXT_1358 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1359 = NL + "    ArrayList<";
  protected final String TEXT_1360 = "> ";
  protected final String TEXT_1361 = " = new ArrayList<";
  protected final String TEXT_1362 = ">();" + NL + "    for (";
  protected final String TEXT_1363 = " ";
  protected final String TEXT_1364 = " : ";
  protected final String TEXT_1365 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1366 = ".contains(";
  protected final String TEXT_1367 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1368 = NL + "      ";
  protected final String TEXT_1369 = ".add(";
  protected final String TEXT_1370 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1371 = ".size() != ";
  protected final String TEXT_1372 = ".length || ";
  protected final String TEXT_1373 = ".size() < ";
  protected final String TEXT_1374 = "())" + NL + "    {";
  protected final String TEXT_1375 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  ...
  protected final String TEXT_1406 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1407 = NL + "    ArrayList<";
  protected final String TEXT_1408 = "> ";
  protected final String TEXT_1409 = " = new ArrayList<";
  protected final String TEXT_1410 = ">();" + NL + "    for (";
  ...
  protected final String TEXT_1415 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1416 = NL + "      ";
  protected final String TEXT_1417 = ".add(";
  protected final String TEXT_1418 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1419 = ".size() != ";
  protected final String TEXT_1420 = ".length || ";
  ...
  protected final String TEXT_1425 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1426 = NL + "    ";
  protected final String TEXT_1427 = ".clear();";
  protected final String TEXT_1428 = NL + "    ";
  protected final String TEXT_1429 = ".addAll(";
  protected final String TEXT_1430 = ");" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1435 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1436 = NL + "    if (";
  protected final String TEXT_1437 = ".length < ";
  protected final String TEXT_1438 = "()";
  protected final String TEXT_1439 = ")" + NL + "    {";
  protected final String TEXT_1440 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_1441 = "> ";
  protected final String TEXT_1442 = " = new ArrayList<";
  protected final String TEXT_1443 = ">();" + NL + "    HashMap<";
  protected final String TEXT_1444 = ",Integer> ";
  protected final String TEXT_1445 = " = new HashMap<";
  protected final String TEXT_1446 = ",Integer>();" + NL + "    for (";
  ...
  protected final String TEXT_1452 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1453 = ".";
  protected final String TEXT_1454 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1462 = ".containsKey(";
  protected final String TEXT_1463 = "))" + NL + "        {";
  protected final String TEXT_1464 = NL + "          ";
  protected final String TEXT_1465 = ".put(";
  protected final String TEXT_1466 = ", new Integer(";
  protected final String TEXT_1467 = ".";
  protected final String TEXT_1468 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1469 = ".get(";
  protected final String TEXT_1470 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1471 = ")" + NL + "        {";
  protected final String TEXT_1472 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1473 = NL + "        ";
  protected final String TEXT_1474 = ".put(";
  protected final String TEXT_1475 = ", new Integer(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1480 = ".removeAll(";
  protected final String TEXT_1481 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1482 = " orphan : ";
  protected final String TEXT_1483 = ")" + NL + "    {";
  protected final String TEXT_1484 = NL + "      ";
  protected final String TEXT_1485 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1486 = NL + "    ";
  protected final String TEXT_1487 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1520 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1521 = NL + "    ArrayList<";
  protected final String TEXT_1522 = "> ";
  protected final String TEXT_1523 = " = new ArrayList<";
  protected final String TEXT_1524 = ">();" + NL + "    for (";
  protected final String TEXT_1525 = " ";
  protected final String TEXT_1526 = " : ";
  protected final String TEXT_1527 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1528 = ".contains(";
  protected final String TEXT_1529 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1530 = NL + "      ";
  protected final String TEXT_1531 = ".add(";
  protected final String TEXT_1532 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1533 = ".size() != ";
  protected final String TEXT_1534 = ".length || ";
  ...
  protected final String TEXT_1539 = ".clear();";
  protected final String TEXT_1540 = NL + "    ";
  protected final String TEXT_1541 = ".addAll(";
  protected final String TEXT_1542 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1543 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1544 = NL + "  public boolean ";
  protected final String TEXT_1545 = "(";
  protected final String TEXT_1546 = "... ";
  protected final String TEXT_1547 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1548 = NL + "    ArrayList<";
  protected final String TEXT_1549 = "> ";
  protected final String TEXT_1550 = " = new ArrayList<";
  ...
  protected final String TEXT_1556 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1557 = NL + "      ";
  protected final String TEXT_1558 = ".add(";
  protected final String TEXT_1559 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1560 = ".size() != ";
  protected final String TEXT_1561 = ".length || ";
  protected final String TEXT_1562 = ".size() < ";
  protected final String TEXT_1563 = "())" + NL + "    {";
  protected final String TEXT_1564 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1565 = NL + "    ";
  protected final String TEXT_1566 = ".clear();";
  protected final String TEXT_1567 = NL + "    ";
  protected final String TEXT_1568 = ".addAll(";
  protected final String TEXT_1569 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1570 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1571 = NL + "  public boolean equals(Object obj)" + NL + "  {" + NL + "    if (obj == null) { return false; }" + NL + "    if (!getClass().equals(obj.getClass())) { return false; }" + NL;
  protected final String TEXT_1572 = NL + "    ";
  protected final String TEXT_1573 = " compareTo = (";
  protected final String TEXT_1574 = ")obj;" + NL + "  ";
  protected final String TEXT_1575 = NL + "    ";
  protected final String TEXT_1576 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  ...
  protected final String TEXT_1594 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1595 = "\",";
  protected final String TEXT_1596 = ");" + NL + "  }" + NL + "" + NL + "  private void ";
  protected final String TEXT_1597 = "()" + NL + "  {";
  protected final String TEXT_1598 = NL + "    ";
  protected final String TEXT_1599 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1600 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1601 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1602 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void run ()" + NL + "    {";
  protected final String TEXT_1603 = NL + "      if (\"";
  protected final String TEXT_1604 = "\".equals(timeoutMethodName))" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1605 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1606 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1607 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1608 = NL + "    ";
  protected final String TEXT_1609 = " = null;";
  protected final String TEXT_1610 = NL + "    ";
  protected final String TEXT_1611 = ".clear();";
  ...
  protected final String TEXT_1617 = " = null;" + NL + "    if (";
  ...
  protected final String TEXT_1631 = " = null;" + NL + "    if (";
  ...
  protected final String TEXT_1690 = ".clear();";
  ...
  protected final String TEXT_1697 = ".clear();" + NL + "    for(";
  protected final String TEXT_1698 = " ";
  protected final String TEXT_1699 = " : ";
  protected final String TEXT_1700 = ")" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1706 = ".delete();" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1707 = NL + "        ";
  protected final String TEXT_1708 = ".";
  protected final String TEXT_1709 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1710 = NL + "    ArrayList<";
  protected final String TEXT_1711 = "> ";
  protected final String TEXT_1712 = " = new ArrayList<";
  protected final String TEXT_1713 = ">(";
  protected final String TEXT_1714 = ");";
  protected final String TEXT_1715 = NL + "    ";
  protected final String TEXT_1716 = ".clear();" + NL + "    for(";
