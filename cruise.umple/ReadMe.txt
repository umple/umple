...
Subdirectories:
    ...
    src-gen-jet
       * Code generated by Jet for the code generators, copied here by build scripts
       ...
       Code here should never be manually modified. Code here, however, must be updated whenever jet code
       is updated in umpleTo*/templates/*.jet Note also that files are also found in umpleTo*/src
