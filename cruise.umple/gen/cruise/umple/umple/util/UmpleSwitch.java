  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case UmplePackage.FUNCTION_DEFINITION:
      {
        ...
        if (result == null) result = caseassociationClassContent(functionDefinition);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case UmplePackage.JAVA_BLOCK:
      {
        javaBlock javaBlock = (javaBlock)theEObject;
        T result = casejavaBlock(javaBlock);
        if (result == null) result = caseblock(javaBlock);
        if (result == null) result = casestatement(javaBlock);
        if (result == null) result = caseblockStatement(javaBlock);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
