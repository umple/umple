 ...
 * <ul>
 *   <li>{@link cruise.umple.xtext.ext.java.functionDefinition#getJava <em>Java</em>}</li>
 * </ul>
 * </p>
 *
 * @see cruise.umple.xtext.ext.java.JavaPackage#getfunctionDefinition()
 * @model
 * @generated
 */
public interface functionDefinition extends EObject
{
   ...
   * @see cruise.umple.xtext.ext.java.JavaPackage#getfunctionDefinition_Java()
  ...
  /**
   * Sets the value of the '{@link cruise.umple.xtext.ext.java.functionDefinition#getJava <em>Java</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
