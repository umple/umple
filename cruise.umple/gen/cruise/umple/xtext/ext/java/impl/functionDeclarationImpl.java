 ...
 * <ul>
 *   <li>{@link cruise.umple.xtext.ext.java.impl.functionDeclarationImpl#getJava <em>Java</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class functionDeclarationImpl extends MinimalEObjectImpl.Container implements functionDeclaration
{
  ...
  {
    return JavaPackage.Literals.FUNCTION_DECLARATION;
  }
  ...
  public NotificationChain basicSetJava(javaFunctionDeclaration newJava, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.FUNCTION_DECLARATION__JAVA, oldJava, newJava);
  ...
  public void setJava(javaFunctionDeclaration newJava)
  {
    if (newJava != java)
    {
      ...
      if (java != null)
        msgs = ((InternalEObject)java).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.FUNCTION_DECLARATION__JAVA, null, msgs);
      if (newJava != null)
        msgs = ((InternalEObject)newJava).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.FUNCTION_DECLARATION__JAVA, null, msgs);
      msgs = basicSetJava(newJava, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.FUNCTION_DECLARATION__JAVA, newJava, newJava));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JavaPackage.FUNCTION_DECLARATION__JAVA:
