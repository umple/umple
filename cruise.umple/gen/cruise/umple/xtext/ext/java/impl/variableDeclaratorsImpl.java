 ...
 * <ul>
 *   <li>{@link cruise.umple.xtext.ext.java.impl.variableDeclaratorsImpl#getVd <em>Vd</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class variableDeclaratorsImpl extends MinimalEObjectImpl.Container implements variableDeclarators
{
  ...
  {
    return JavaPackage.Literals.VARIABLE_DECLARATORS;
  }
  ...
  public EList<variableDeclarator> getVd()
  {
    if (vd == null)
    {
      vd = new EObjectContainmentEList<variableDeclarator>(variableDeclarator.class, this, JavaPackage.VARIABLE_DECLARATORS__VD);
    }
    return vd;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JavaPackage.VARIABLE_DECLARATORS__VD:
