 ...
 * <ul>
 *   <li>{@link cruise.umple.xtext.ext.java.impl.additiveExpressionImpl#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link cruise.umple.xtext.ext.java.impl.additiveExpressionImpl#getExpressionRest <em>Expression Rest</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class additiveExpressionImpl extends MinimalEObjectImpl.Container implements additiveExpression
{
  ...
  {
    return JavaPackage.Literals.ADDITIVE_EXPRESSION;
  }
  ...
  public NotificationChain basicSetExpression1(multiplicativeExpression newExpression1, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.ADDITIVE_EXPRESSION__EXPRESSION1, oldExpression1, newExpression1);
  ...
  public void setExpression1(multiplicativeExpression newExpression1)
  {
    if (newExpression1 != expression1)
    {
      ...
      if (expression1 != null)
        msgs = ((InternalEObject)expression1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ADDITIVE_EXPRESSION__EXPRESSION1, null, msgs);
      if (newExpression1 != null)
        msgs = ((InternalEObject)newExpression1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ADDITIVE_EXPRESSION__EXPRESSION1, null, msgs);
      msgs = basicSetExpression1(newExpression1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.ADDITIVE_EXPRESSION__EXPRESSION1, newExpression1, newExpression1));
  }
  ...
  public EList<multiplicativeExpression> getExpressionRest()
  {
    ...
    {
      expressionRest = new EObjectContainmentEList<multiplicativeExpression>(multiplicativeExpression.class, this, JavaPackage.ADDITIVE_EXPRESSION__EXPRESSION_REST);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JavaPackage.ADDITIVE_EXPRESSION__EXPRESSION1:
        return basicSetExpression1(null, msgs);
      case JavaPackage.ADDITIVE_EXPRESSION__EXPRESSION_REST:
