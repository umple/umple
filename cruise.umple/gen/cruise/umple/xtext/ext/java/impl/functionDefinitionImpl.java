 ...
 * <ul>
 *   <li>{@link cruise.umple.xtext.ext.java.impl.functionDefinitionImpl#getJava <em>Java</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class functionDefinitionImpl extends MinimalEObjectImpl.Container implements functionDefinition
{
  ...
  {
    return JavaPackage.Literals.FUNCTION_DEFINITION;
  }
  ...
  public NotificationChain basicSetJava(javaFunctionDefinition newJava, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.FUNCTION_DEFINITION__JAVA, oldJava, newJava);
  ...
  public void setJava(javaFunctionDefinition newJava)
  {
    if (newJava != java)
    {
      ...
      if (java != null)
        msgs = ((InternalEObject)java).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.FUNCTION_DEFINITION__JAVA, null, msgs);
      if (newJava != null)
        msgs = ((InternalEObject)newJava).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.FUNCTION_DEFINITION__JAVA, null, msgs);
      msgs = basicSetJava(newJava, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.FUNCTION_DEFINITION__JAVA, newJava, newJava));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JavaPackage.FUNCTION_DEFINITION__JAVA:
