 ...
 * <ul>
 *   <li>{@link cruise.umple.xtext.ext.java.impl.blockImpl#getBlocks <em>Blocks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class blockImpl extends statementImpl implements block
{
  ...
  {
    return JavaPackage.Literals.BLOCK;
  }
  ...
  public EList<blockStatement> getBlocks()
  {
    if (blocks == null)
    {
      blocks = new EObjectContainmentEList<blockStatement>(blockStatement.class, this, JavaPackage.BLOCK__BLOCKS);
    }
    return blocks;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JavaPackage.BLOCK__BLOCKS:
