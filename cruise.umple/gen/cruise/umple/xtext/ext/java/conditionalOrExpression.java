 ...
 * <ul>
 *   <li>{@link cruise.umple.xtext.ext.java.conditionalOrExpression#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link cruise.umple.xtext.ext.java.conditionalOrExpression#getExpressionRest <em>Expression Rest</em>}</li>
 * </ul>
 * </p>
 *
 * @see cruise.umple.xtext.ext.java.JavaPackage#getconditionalOrExpression()
 * @model
 * @generated
 */
public interface conditionalOrExpression extends EObject
{
   ...
   * @see cruise.umple.xtext.ext.java.JavaPackage#getconditionalOrExpression_Expression1()
  ...
  /**
   * Sets the value of the '{@link cruise.umple.xtext.ext.java.conditionalOrExpression#getExpression1 <em>Expression1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link cruise.umple.xtext.ext.java.conditionalAndExpression}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see cruise.umple.xtext.ext.java.JavaPackage#getconditionalOrExpression_ExpressionRest()
   * @model containment="true"
   * @generated
   */
