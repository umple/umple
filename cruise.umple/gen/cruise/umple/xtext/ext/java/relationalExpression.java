 ...
 * <ul>
 *   <li>{@link cruise.umple.xtext.ext.java.relationalExpression#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link cruise.umple.xtext.ext.java.relationalExpression#getExpressionRest <em>Expression Rest</em>}</li>
 * </ul>
 * </p>
 *
 * @see cruise.umple.xtext.ext.java.JavaPackage#getrelationalExpression()
 * @model
 * @generated
 */
public interface relationalExpression extends EObject
{
   ...
   * @see cruise.umple.xtext.ext.java.JavaPackage#getrelationalExpression_Expression1()
  ...
  /**
   * Sets the value of the '{@link cruise.umple.xtext.ext.java.relationalExpression#getExpression1 <em>Expression1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link cruise.umple.xtext.ext.java.additiveExpression}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see cruise.umple.xtext.ext.java.JavaPackage#getrelationalExpression_ExpressionRest()
   * @model containment="true"
   * @generated
   */
