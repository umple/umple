 ...
 * <ul>
 *   <li>{@link cruise.umple.xtext.ext.java.conditionalExpression#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link cruise.umple.xtext.ext.java.conditionalExpression#getExpression2 <em>Expression2</em>}</li>
 *   <li>{@link cruise.umple.xtext.ext.java.conditionalExpression#getExpression3 <em>Expression3</em>}</li>
 * </ul>
 * </p>
 *
 * @see cruise.umple.xtext.ext.java.JavaPackage#getconditionalExpression()
 * @model
 * @generated
 */
public interface conditionalExpression extends EObject
{
   ...
   * @see cruise.umple.xtext.ext.java.JavaPackage#getconditionalExpression_Expression1()
  ...
  /**
   * Sets the value of the '{@link cruise.umple.xtext.ext.java.conditionalExpression#getExpression1 <em>Expression1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see cruise.umple.xtext.ext.java.JavaPackage#getconditionalExpression_Expression2()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link cruise.umple.xtext.ext.java.conditionalExpression#getExpression2 <em>Expression2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see cruise.umple.xtext.ext.java.JavaPackage#getconditionalExpression_Expression3()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link cruise.umple.xtext.ext.java.conditionalExpression#getExpression3 <em>Expression3</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
