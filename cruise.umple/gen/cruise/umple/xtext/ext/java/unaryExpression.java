 ...
 * <ul>
 *   <li>{@link cruise.umple.xtext.ext.java.unaryExpression#getExp1 <em>Exp1</em>}</li>
 *   <li>{@link cruise.umple.xtext.ext.java.unaryExpression#getExp2 <em>Exp2</em>}</li>
 * </ul>
 * </p>
 *
 * @see cruise.umple.xtext.ext.java.JavaPackage#getunaryExpression()
 * @model
 * @generated
 */
public interface unaryExpression extends unaryExpressionNotPlusMinus
{
   ...
   * @see cruise.umple.xtext.ext.java.JavaPackage#getunaryExpression_Exp1()
  ...
  /**
   * Sets the value of the '{@link cruise.umple.xtext.ext.java.unaryExpression#getExp1 <em>Exp1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see cruise.umple.xtext.ext.java.JavaPackage#getunaryExpression_Exp2()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link cruise.umple.xtext.ext.java.unaryExpression#getExp2 <em>Exp2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
