 ...
 * <ul>
 *   <li>{@link cruise.umple.umple.functionDeclaration#getJava <em>Java</em>}</li>
 * </ul>
 * </p>
 *
 * @see cruise.umple.umple.UmplePackage#getfunctionDeclaration()
 * @model
 * @generated
 */
public interface functionDeclaration extends EObject
{
   ...
   * @see cruise.umple.umple.UmplePackage#getfunctionDeclaration_Java()
  ...
  /**
   * Sets the value of the '{@link cruise.umple.umple.functionDeclaration#getJava <em>Java</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
