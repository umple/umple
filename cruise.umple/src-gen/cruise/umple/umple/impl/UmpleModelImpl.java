...
public class UmpleModelImpl extends MinimalEObjectImpl.Container implements UmpleModel
{
  ...
  /**
   * The cached value of the '{@link #getGenerate_() <em>Generate </em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getGenerate_()
   * @generated
   ...
   * @generated
   */
  public NotificationChain basicSetGenerate_(Generate newGenerate_, NotificationChain msgs)
  {
    Generate oldGenerate_ = generate_;
    generate_ = newGenerate_;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmplePackage.UMPLE_MODEL__GENERATE_, oldGenerate_, newGenerate_);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   * @generated
   */
  public void setGenerate_(Generate newGenerate_)
  {
    if (newGenerate_ != generate_)
    {
      NotificationChain msgs = null;
      if (generate_ != null)
        msgs = ((InternalEObject)generate_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmplePackage.UMPLE_MODEL__GENERATE_, null, msgs);
      if (newGenerate_ != null)
        msgs = ((InternalEObject)newGenerate_).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmplePackage.UMPLE_MODEL__GENERATE_, null, msgs);
      msgs = basicSetGenerate_(newGenerate_, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmplePackage.UMPLE_MODEL__GENERATE_, newGenerate_, newGenerate_));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case UmplePackage.UMPLE_MODEL__GENERATE_:
        return basicSetGenerate_(null, msgs);
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case UmplePackage.UMPLE_MODEL__GLOSSARY:
        ...
        return;
      case UmplePackage.UMPLE_MODEL__GENERATE_:
        setGenerate_((Generate)newValue);
        return;
      case UmplePackage.UMPLE_MODEL__TRACE_MECHANISM:
