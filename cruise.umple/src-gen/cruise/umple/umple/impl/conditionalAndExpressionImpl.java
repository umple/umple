 ...
 * <ul>
 *   <li>{@link cruise.umple.umple.impl.conditionalAndExpressionImpl#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link cruise.umple.umple.impl.conditionalAndExpressionImpl#getExpressionRest <em>Expression Rest</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class conditionalAndExpressionImpl extends MinimalEObjectImpl.Container implements conditionalAndExpression
{
  ...
  {
    return UmplePackage.Literals.CONDITIONAL_AND_EXPRESSION;
  }
  ...
  public NotificationChain basicSetExpression1(equalityExpression newExpression1, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmplePackage.CONDITIONAL_AND_EXPRESSION__EXPRESSION1, oldExpression1, newExpression1);
  ...
  public void setExpression1(equalityExpression newExpression1)
  {
    if (newExpression1 != expression1)
    {
      ...
      if (expression1 != null)
        msgs = ((InternalEObject)expression1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmplePackage.CONDITIONAL_AND_EXPRESSION__EXPRESSION1, null, msgs);
      if (newExpression1 != null)
        msgs = ((InternalEObject)newExpression1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmplePackage.CONDITIONAL_AND_EXPRESSION__EXPRESSION1, null, msgs);
      msgs = basicSetExpression1(newExpression1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmplePackage.CONDITIONAL_AND_EXPRESSION__EXPRESSION1, newExpression1, newExpression1));
  }
  ...
  public EList<equalityExpression> getExpressionRest()
  {
    ...
    {
      expressionRest = new EObjectContainmentEList<equalityExpression>(equalityExpression.class, this, UmplePackage.CONDITIONAL_AND_EXPRESSION__EXPRESSION_REST);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmplePackage.CONDITIONAL_AND_EXPRESSION__EXPRESSION1:
        return basicSetExpression1(null, msgs);
      case UmplePackage.CONDITIONAL_AND_EXPRESSION__EXPRESSION_REST:
