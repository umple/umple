 ...
 *   <li>{@link cruise.umple.umple.javaFunctionDeclaration#getReferenceType <em>Reference Type</em>}</li>
...
public interface javaFunctionDeclaration extends EObject
{
   ...
   * @see cruise.umple.umple.UmplePackage#getjavaFunctionDeclaration_ReferenceType()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link cruise.umple.umple.javaFunctionDeclaration#getReferenceType <em>Reference Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
