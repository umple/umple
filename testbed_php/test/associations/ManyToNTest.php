...
class ManyToNTest extends UnitTestCase
{
  ...
  {
  	$this->expectException(new Exception("Unable to create MentorQ, must have 2 students. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html"));
    $s = new StudentQ(99);
