...
class OptionalOneToMNTest extends UnitTestCase
{
  ...
  {
  	$this->expectException(new Exception("Unable to create MentorE, must have 2 to 5 students. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html"));
    $s = new StudentE();
    new MentorE(array($s));
  }
