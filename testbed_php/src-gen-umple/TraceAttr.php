...
class TraceAttr
{
  ...
  {
    $wasSet = false;
    ConsoleTracer::handle( gettimeofday(true).",".uniqid().",../../testbed/src/TestHarnessTracer.ump,14,TraceAttr,".spl_object_hash( $this ).",at_s,name,".$this->name.",".(""+$aName)null );
    $this->name = $aName;
    $wasSet = true;
    return $wasSet;
  }
  ...
  {
    $wasSet = false;
    ConsoleTracer::handle( gettimeofday(true).",".uniqid().",../../testbed/src/TestHarnessTracer.ump,17,TraceAttr,".spl_object_hash( $this ).",at_s,salary,".$this->salary.",".(""+$aSalary)null );
    $this->salary = $aSalary;
    $wasSet = true;
    return $wasSet;
  }
  ...
  public function setNumber1($aNumber1)
  {
    ...
    if ($numCond>100)
    {
      ConsoleTracer::handle( gettimeofday(true).",".uniqid().",../../testbed/src/TestHarnessTracer.ump,30,TraceAttr,".spl_object_hash( $this ).",at_s,number1,".$this->number1.",".(""+$aNumber1)null );
    }
    $this->number1 = $aNumber1;
    $wasSet = true;
    return $wasSet;
  ...
  public function setNumber2($aNumber2)
  {
    ...
    if ($numCond==20)
    {
      ConsoleTracer::handle( gettimeofday(true).",".uniqid().",../../testbed/src/TestHarnessTracer.ump,31,TraceAttr,".spl_object_hash( $this ).",at_s,number2,".$this->number2 );
    }
    $wasSet = true;
    return $wasSet;
  }
  ...
  public function setNumber3($aNumber3)
  {
    ...
    if ($traceFlag1)
    {
      ConsoleTracer::handle( gettimeofday(true).",".uniqid().",../../testbed/src/TestHarnessTracer.ump,32,TraceAttr,".spl_object_hash( $this ).",at_s,number3,".$this->number3 );
    }
    $wasSet = true;
    return $wasSet;
  }
  ...
  public function setNumber4($aNumber4)
  {
    ...
    if ($traceFlag2)
    {
      ConsoleTracer::handle( gettimeofday(true).",".uniqid().",../../testbed/src/TestHarnessTracer.ump,33,TraceAttr,".spl_object_hash( $this ).",at_s,number4,".$this->number4 );
    }
    $wasSet = true;
    return $wasSet;
  }
  ...
  public function setStr($aStr)
  {
    ...
    if ($traceFlag3<3)
    {
      ConsoleTracer::handle( gettimeofday(true).",".uniqid().",../../testbed/src/TestHarnessTracer.ump,34,TraceAttr,".spl_object_hash( $this ).",at_s,str,".$this->str.",".(""+$aStr)null );
      traceFlag3++;
    }
    $this->str = $aStr;
    $wasSet = true;
