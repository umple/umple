...
class ClassOptionalN
{
  ...
  public function __construct($allClassOtherclasses)
  {
    ...
    {
      throw new Exception("Unable to create ClassOptionalN, must have 2 or fewer classOtherclasses, no duplicates.");
    }
  }
  ...
  private function setClassOtherclasses($newClassOtherclasses)
  {
    ...
    if (count($verifiedClassOtherclasses) != count($newClassOtherclasses) || count($verifiedClassOtherclasses) > self::maximumNumberOfClassOtherclasses())
    {
      return $wasSet;
    }
