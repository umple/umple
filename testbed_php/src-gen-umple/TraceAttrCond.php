...
class TraceAttrCond
{
  ...
  public function setN1($aN1)
  {
    ...
    {
      ConsoleTracer::handle( gettimeofday(true).",".uniqid().",/home/kenan/Umple/umple/testbed_php/src/../../testbed/src/TestHarnessTracer.ump,53,TraceAttrCond,".spl_object_hash( $this ).",at_s,n1,".$this->n1.",".(""+$aN1)null );
      traceFlag4++;
    }
    $this->n1 = $aN1;
    $wasSet = true;
  ...
  public function setN2($aN2)
  {
    ...
    {
      ConsoleTracer::handle( gettimeofday(true).",".uniqid().",/home/kenan/Umple/umple/testbed_php/src/../../testbed/src/TestHarnessTracer.ump,54,TraceAttrCond,".spl_object_hash( $this ).",at_s,n2,".$this->n2 );
      traceFlag5++;
    }
    $wasSet = true;
    return $wasSet;
  ...
  public function setN3($aN3)
  {
    ...
    {
      ConsoleTracer::handle( gettimeofday(true).",".uniqid().",/home/kenan/Umple/umple/testbed_php/src/../../testbed/src/TestHarnessTracer.ump,55,TraceAttrCond,".spl_object_hash( $this ).",at_s,n3,".$this->n3 );
      traceFlag7++;
    }
    $wasSet = true;
    if ($n3>20)
  ...
  public function setN4($aN4)
  {
    ...
    {
      ConsoleTracer::handle( gettimeofday(true).",".uniqid().",/home/kenan/Umple/umple/testbed_php/src/../../testbed/src/TestHarnessTracer.ump,56,TraceAttrCond,".spl_object_hash( $this ).",at_s,n4,".$this->n4 );
      traceFlag9++;
    }
    $wasSet = true;
    if ($n4>10)
