...
class ClassNAssociation
{
  ...
  public function __construct($allOtherclasses)
  {
    ...
    {
      throw new Exception("Unable to create ClassNAssociation, must have 2 otherclasses");
    }
  }
  ...
  public static function requiredNumberOfOtherclasses()
  {
    return 2;
  }
  ...
  private function setOtherclasses($newOtherclasses)
  {
    ...
    if (count($verifiedOtherclasses) != count($newOtherclasses) || count($verifiedOtherclasses) != self::requiredNumberOfOtherclasses())
    {
      return $wasSet;
    }
