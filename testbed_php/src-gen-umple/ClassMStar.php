...
class ClassMStar
{
  ...
  public function __construct($allClassOtherclasses)
  {
    ...
    {
      throw new Exception("Unable to create ClassMStar, must have at least 2 classOtherclasses");
    }
  }
  ...
  private function setClassOtherclasses($newClassOtherclasses)
  {
    ...
    if (count($verifiedClassOtherclasses) != count($newClassOtherclasses) || count($verifiedClassOtherclasses) < self::minimumNumberOfClassOtherclasses())
    {
      return $wasSet;
    }
