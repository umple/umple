...
public class JavaClassGenerator implements ILang 
{
  ...
  protected final String TEXT_58 = "() != null)" + NL + "    {" + NL + "      throw new RuntimeException(\"Unable to create ";
  ...
  protected final String TEXT_72 = " due to ";
  ...
  protected final String TEXT_81 = ", must have ";
  ...
  protected final String TEXT_97 = NL + "  public static ";
  protected final String TEXT_98 = " getInstance()" + NL + "  {" + NL + "    if(theInstance == null)" + NL + "    {" + NL + "      theInstance = new ";
  protected final String TEXT_99 = "();" + NL + "    }" + NL + "    return theInstance;" + NL + "  }";
  protected final String TEXT_100 = NL + NL + "  public ";
  ...
  protected final String TEXT_120 = ">();" + NL + "    boolean ";
  protected final String TEXT_121 = " = ";
  protected final String TEXT_122 = "(";
  protected final String TEXT_123 = ");" + NL + "    if (!";
  protected final String TEXT_124 = ")" + NL + "    {" + NL + "      throw new RuntimeException(\"Unable to create ";
  protected final String TEXT_125 = ", must have ";
  ...
  protected final String TEXT_143 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_144 = NL + "  public boolean ";
  protected final String TEXT_145 = "(";
  protected final String TEXT_146 = " ";
  protected final String TEXT_147 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_148 = NL + "    ";
  protected final String TEXT_149 = " = ";
  protected final String TEXT_150 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_151 = NL + "    return wasSet;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_152 = "()" + NL + "  {" + NL + "    boolean wasReset = false;";
  protected final String TEXT_153 = NL + "    ";
  protected final String TEXT_154 = " = ";
  protected final String TEXT_155 = "();" + NL + "    wasReset = true;";
  protected final String TEXT_156 = NL + "    return wasReset;" + NL + "  }" + NL;
  protected final String TEXT_157 = NL + "  public boolean ";
  protected final String TEXT_158 = "(";
  protected final String TEXT_159 = " ";
  protected final String TEXT_160 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_161 = NL + "    wasAdded = ";
  protected final String TEXT_162 = ".add(";
  protected final String TEXT_163 = ");";
  protected final String TEXT_164 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_165 = "(";
  protected final String TEXT_166 = " ";
  protected final String TEXT_167 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_168 = NL + "    wasRemoved = ";
  protected final String TEXT_169 = ".remove(";
  protected final String TEXT_170 = ");";
  protected final String TEXT_171 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_172 = NL + "  public boolean ";
  protected final String TEXT_173 = "(";
  protected final String TEXT_174 = " ";
  protected final String TEXT_175 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_182 = "(int index)" + NL + "  {";
  protected final String TEXT_183 = NL + "    ";
  protected final String TEXT_184 = " ";
  protected final String TEXT_185 = " = ";
  protected final String TEXT_186 = ".get(index);";
  protected final String TEXT_187 = NL + "    return ";
  protected final String TEXT_188 = ";" + NL + "  }" + NL + "" + NL + "  public ";
  ...
  protected final String TEXT_198 = ";" + NL + "  }" + NL + "" + NL + "  public int ";
  protected final String TEXT_199 = "()" + NL + "  {";
  protected final String TEXT_200 = NL + "    int number = ";
  protected final String TEXT_201 = ".size();";
  protected final String TEXT_202 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_203 = "()" + NL + "  {";
  protected final String TEXT_204 = NL + "    boolean has = ";
  protected final String TEXT_205 = ".size() > 0;";
  protected final String TEXT_206 = NL + "    return has;" + NL + "  }" + NL + "" + NL + "  public int ";
  protected final String TEXT_207 = "(";
  protected final String TEXT_208 = " ";
  protected final String TEXT_209 = ")" + NL + "  {";
  protected final String TEXT_210 = NL + "    int index = ";
  protected final String TEXT_211 = ".indexOf(";
  protected final String TEXT_212 = ");";
  protected final String TEXT_213 = NL + "    return index;" + NL + "  }" + NL;
  ...
  protected final String TEXT_299 = "()" + NL + "  {" + NL + "    String answer = ";
  protected final String TEXT_300 = ".toString();";
  protected final String TEXT_301 = NL + "    return answer;" + NL + "  }" + NL;
  protected final String TEXT_302 = NL + "  public ";
  protected final String TEXT_303 = " ";
  protected final String TEXT_304 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_305 = ";" + NL + "  }" + NL;
  protected final String TEXT_306 = NL + "  ";
  protected final String TEXT_307 = " boolean ";
  protected final String TEXT_308 = "()" + NL + "  {" + NL + "    boolean wasEventProcessed = false;";
  protected final String TEXT_309 = NL + "    ";
  protected final String TEXT_310 = NL + "    return wasEventProcessed;" + NL + "  }" + NL;
  protected final String TEXT_311 = NL + "  public boolean ";
  protected final String TEXT_312 = "(";
  protected final String TEXT_313 = " ";
  protected final String TEXT_314 = ")" + NL + "  {";
  protected final String TEXT_315 = NL + "    ";
  protected final String TEXT_316 = " = ";
  protected final String TEXT_317 = ";" + NL + "    return true;" + NL + "  }" + NL;
  protected final String TEXT_318 = NL + "  private void ";
  protected final String TEXT_319 = "()" + NL + "  {";
  protected final String TEXT_320 = NL + "    switch(";
  protected final String TEXT_321 = ")" + NL + "    {";
  protected final String TEXT_322 = NL + "      ";
  protected final String TEXT_323 = NL + "    }";
  protected final String TEXT_324 = NL + "  }" + NL;
  protected final String TEXT_325 = NL + "  private void ";
  ...
  protected final String TEXT_342 = NL + NL + "    // entry actions and do activities" + NL + "    switch(";
  ...
  protected final String TEXT_361 = "(int index)" + NL + "  {";
  protected final String TEXT_362 = NL + "    ";
  protected final String TEXT_363 = " ";
  protected final String TEXT_364 = " = ";
  protected final String TEXT_365 = ".get(index);";
  protected final String TEXT_366 = NL + "    return ";
  protected final String TEXT_367 = ";" + NL + "  }" + NL;
  protected final String TEXT_368 = NL + "  public List<";
  protected final String TEXT_369 = "> ";
  protected final String TEXT_370 = "()" + NL + "  {";
  protected final String TEXT_371 = NL + "    List<";
  protected final String TEXT_372 = "> ";
  protected final String TEXT_373 = " = Collections.unmodifiableList(";
  protected final String TEXT_374 = ");";
  protected final String TEXT_375 = NL + "    return ";
  protected final String TEXT_376 = ";" + NL + "  }" + NL + "" + NL + "  public int ";
  protected final String TEXT_377 = "()" + NL + "  {";
  protected final String TEXT_378 = NL + "    int number = ";
  protected final String TEXT_379 = ".size();";
  protected final String TEXT_380 = NL + "    return number;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_381 = "()" + NL + "  {";
  protected final String TEXT_382 = NL + "    boolean has = ";
  protected final String TEXT_383 = ".size() > 0;";
  protected final String TEXT_384 = NL + "    return has;" + NL + "  }" + NL + "" + NL + "  public int ";
  protected final String TEXT_385 = "(";
  protected final String TEXT_386 = " ";
  protected final String TEXT_387 = ")" + NL + "  {";
  protected final String TEXT_388 = NL + "    int index = ";
  protected final String TEXT_389 = ".indexOf(";
  ...
  protected final String TEXT_395 = NL + "  public boolean ";
  protected final String TEXT_396 = "()" + NL + "  {";
  protected final String TEXT_397 = NL + "    boolean isValid = ";
  protected final String TEXT_398 = "() >= ";
  protected final String TEXT_399 = "();";
  protected final String TEXT_400 = NL + "    boolean isValid = ";
  protected final String TEXT_401 = "() >= ";
  protected final String TEXT_402 = "() && ";
  protected final String TEXT_403 = "() <= ";
  protected final String TEXT_404 = "();";
  protected final String TEXT_405 = NL + "    return isValid;" + NL + "  }";
  ...
  protected final String TEXT_411 = NL + "    int required = ";
  protected final String TEXT_412 = ";";
  protected final String TEXT_413 = NL + "    return required;" + NL + "  }";
  ...
  protected final String TEXT_419 = NL + "    int minimum = ";
  protected final String TEXT_420 = ";";
  protected final String TEXT_421 = NL + "    return minimum;" + NL + "  }";
  protected final String TEXT_422 = NL + "  public static int ";
  ...
  protected final String TEXT_427 = NL + "    int maximum = ";
  protected final String TEXT_428 = ";";
  protected final String TEXT_429 = NL + "    return maximum;" + NL + "  }";
  protected final String TEXT_430 = NL + "  public boolean ";
  protected final String TEXT_431 = "(";
  protected final String TEXT_432 = " ";
  protected final String TEXT_433 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_434 = NL + "    if (";
  protected final String TEXT_435 = "() >= ";
  protected final String TEXT_436 = "())" + NL + "    {";
  protected final String TEXT_437 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_438 = NL + "    ";
  protected final String TEXT_439 = ".add(";
  protected final String TEXT_440 = ");" + NL + "    if (";
  protected final String TEXT_441 = ".";
  protected final String TEXT_442 = "(this) != -1)" + NL + "    {" + NL + "      wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasAdded = ";
  protected final String TEXT_443 = ".";
  protected final String TEXT_444 = "(this);" + NL + "      if (!wasAdded)" + NL + "      {";
  protected final String TEXT_445 = NL + "        ";
  protected final String TEXT_446 = ".remove(";
  protected final String TEXT_447 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_448 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_449 = NL + "  public boolean ";
  protected final String TEXT_450 = "(";
  protected final String TEXT_451 = " ";
  protected final String TEXT_452 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_453 = NL + "    if (!";
  protected final String TEXT_454 = ".contains(";
  protected final String TEXT_455 = "))" + NL + "    {";
  protected final String TEXT_456 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_457 = ".indexOf(";
  protected final String TEXT_458 = ");";
  protected final String TEXT_459 = NL + "    ";
  protected final String TEXT_460 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_461 = ".";
  protected final String TEXT_462 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_463 = ".";
  protected final String TEXT_464 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_465 = NL + "        ";
  protected final String TEXT_466 = ".add(oldIndex,";
  protected final String TEXT_467 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_468 = NL + "    return wasRemoved;" + NL + "  }";
  protected final String TEXT_469 = NL + "  ";
  protected final String TEXT_470 = " boolean ";
  protected final String TEXT_471 = "(";
  protected final String TEXT_472 = " ";
  protected final String TEXT_473 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_474 = NL + "    ";
  protected final String TEXT_475 = " = ";
  protected final String TEXT_476 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_477 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_478 = NL + "  ";
  protected final String TEXT_479 = " boolean ";
  ...
  protected final String TEXT_487 = ";" + NL + "      wasSet = true;" + NL + "    }";
  protected final String TEXT_488 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_489 = NL + "  public boolean ";
  protected final String TEXT_490 = "(";
  protected final String TEXT_491 = " ";
  protected final String TEXT_492 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_493 = NL + "    if (";
  protected final String TEXT_494 = " != null && !";
  protected final String TEXT_495 = ".equals(";
  protected final String TEXT_496 = ") && equals(";
  protected final String TEXT_497 = ".";
  protected final String TEXT_498 = "()))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_499 = ", as existing ";
  protected final String TEXT_500 = " would become an orphan";
  ...
  protected final String TEXT_510 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  protected final String TEXT_511 = "))" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_519 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_520 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_521 = NL + "  public boolean ";
  protected final String TEXT_522 = "(";
  protected final String TEXT_523 = " ";
  protected final String TEXT_524 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_525 = NL + "    if (";
  protected final String TEXT_526 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_527 = " to null, as ";
  protected final String TEXT_528 = " must always be associated to a ";
  ...
  protected final String TEXT_535 = " != null && !equals(";
  protected final String TEXT_536 = "))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_537 = ", the current ";
  protected final String TEXT_538 = " already has a ";
  protected final String TEXT_539 = ", which would be orphaned if it were re-assigned";
  ...
  protected final String TEXT_550 = "(this);" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_561 = ");" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_562 = "(";
  protected final String TEXT_563 = " ";
  protected final String TEXT_564 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_565 = NL + "    ";
  protected final String TEXT_566 = " ";
  protected final String TEXT_567 = " = ";
  protected final String TEXT_568 = ".";
  protected final String TEXT_569 = "();" + NL + "    boolean ";
  protected final String TEXT_570 = " = ";
  protected final String TEXT_571 = " != null && !this.equals(";
  protected final String TEXT_572 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_573 = " && ";
  protected final String TEXT_574 = ".";
  protected final String TEXT_575 = "() <= ";
  protected final String TEXT_576 = "())" + NL + "    {" + NL + "      return wasAdded;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_577 = ")" + NL + "    {";
  protected final String TEXT_578 = NL + "      ";
  protected final String TEXT_579 = ".";
  protected final String TEXT_580 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_581 = NL + "      ";
  protected final String TEXT_582 = ".add(";
  protected final String TEXT_583 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_584 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_585 = "(";
  protected final String TEXT_586 = " ";
  protected final String TEXT_587 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_603 = NL + "  public ";
  protected final String TEXT_604 = " ";
  protected final String TEXT_605 = "(";
  protected final String TEXT_606 = ")" + NL + "  {" + NL + "    if (";
  protected final String TEXT_607 = "() >= ";
  protected final String TEXT_608 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_609 = "(";
  protected final String TEXT_610 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_611 = "(";
  protected final String TEXT_612 = " ";
  protected final String TEXT_613 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_622 = "();" + NL + "    boolean ";
  ...
  protected final String TEXT_638 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_639 = "(";
  protected final String TEXT_640 = " ";
  protected final String TEXT_641 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_657 = NL + "  public ";
  ...
  protected final String TEXT_664 = ");" + NL + "    }" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_665 = "(";
  protected final String TEXT_666 = " ";
  protected final String TEXT_667 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_668 = NL + "    if (";
  protected final String TEXT_669 = "() >= ";
  protected final String TEXT_670 = "())" + NL + "    {";
  protected final String TEXT_671 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_672 = NL + "    ";
  protected final String TEXT_673 = " ";
  protected final String TEXT_674 = " = ";
  protected final String TEXT_675 = ".";
  protected final String TEXT_676 = "();" + NL + "    boolean ";
  protected final String TEXT_677 = " = ";
  protected final String TEXT_678 = " != null && !this.equals(";
  protected final String TEXT_679 = ");" + NL + "    if (";
  protected final String TEXT_680 = ")" + NL + "    {";
  protected final String TEXT_681 = NL + "      ";
  protected final String TEXT_682 = ".";
  protected final String TEXT_683 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_684 = NL + "      ";
  protected final String TEXT_685 = ".add(";
  protected final String TEXT_686 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_687 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_688 = "(";
  protected final String TEXT_689 = " ";
  protected final String TEXT_690 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_691 = NL + "    //Unable to remove ";
  protected final String TEXT_692 = ", as it must always have a ";
  protected final String TEXT_693 = NL + "    if (!this.equals(";
  protected final String TEXT_694 = ".";
  protected final String TEXT_695 = "()))" + NL + "    {";
  protected final String TEXT_696 = NL + "      ";
  protected final String TEXT_697 = ".remove(";
  protected final String TEXT_698 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_699 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_700 = NL + "  public boolean ";
  protected final String TEXT_701 = "(";
  protected final String TEXT_702 = "... ";
  protected final String TEXT_703 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_704 = NL + "    ArrayList<";
  protected final String TEXT_705 = "> ";
  protected final String TEXT_706 = " = new ArrayList<";
  protected final String TEXT_707 = ">();" + NL + "    for (";
  protected final String TEXT_708 = " ";
  protected final String TEXT_709 = " : ";
  protected final String TEXT_710 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_711 = ".contains(";
  protected final String TEXT_712 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_713 = NL + "      ";
  protected final String TEXT_714 = ".add(";
  protected final String TEXT_715 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_716 = ".size() != ";
  protected final String TEXT_717 = ".length || ";
  protected final String TEXT_718 = ".size() > ";
  protected final String TEXT_719 = "())" + NL + "    {";
  protected final String TEXT_720 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_721 = "> ";
  protected final String TEXT_722 = " = new ArrayList<";
  protected final String TEXT_723 = ">(";
  protected final String TEXT_724 = ");";
  protected final String TEXT_725 = NL + "    ";
  protected final String TEXT_726 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_736 = ".remove(";
  protected final String TEXT_737 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_738 = NL + "        ";
  protected final String TEXT_739 = ".";
  protected final String TEXT_740 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_741 = " ";
  protected final String TEXT_742 = " : ";
  protected final String TEXT_743 = ")" + NL + "    {";
  protected final String TEXT_744 = NL + "      ";
  protected final String TEXT_745 = ".";
  protected final String TEXT_746 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_747 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_748 = NL + "  public ";
  protected final String TEXT_749 = " ";
  protected final String TEXT_750 = "(";
  protected final String TEXT_751 = ")" + NL + "  {" + NL + "    return new ";
  protected final String TEXT_752 = "(";
  protected final String TEXT_753 = ");" + NL + "  }" + NL + "" + NL + "  public boolean ";
  ...
  protected final String TEXT_768 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_769 = NL + "      ";
  protected final String TEXT_770 = ".add(";
  protected final String TEXT_771 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_772 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_773 = "(";
  protected final String TEXT_774 = " ";
  protected final String TEXT_775 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_776 = NL + "    //Unable to remove ";
  protected final String TEXT_777 = ", as it must always have a ";
  protected final String TEXT_778 = NL + "    if (!this.equals(";
  protected final String TEXT_779 = ".";
  protected final String TEXT_780 = "()))" + NL + "    {";
  protected final String TEXT_781 = NL + "      ";
  protected final String TEXT_782 = ".remove(";
  protected final String TEXT_783 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_784 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_785 = NL + "  public boolean ";
  protected final String TEXT_786 = "(";
  protected final String TEXT_787 = " ";
  protected final String TEXT_788 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_796 = " = null;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_821 = "();" + NL + "" + NL + "    if (!equals(";
  ...
  protected final String TEXT_827 = NL + "  public boolean ";
  protected final String TEXT_828 = "(";
  protected final String TEXT_829 = " ";
  protected final String TEXT_830 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_831 = NL + "    if (!";
  protected final String TEXT_832 = ".contains(";
  protected final String TEXT_833 = "))" + NL + "    {";
  protected final String TEXT_834 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_835 = "() <= ";
  protected final String TEXT_836 = "())" + NL + "    {";
  protected final String TEXT_837 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_838 = ".indexOf(";
  protected final String TEXT_839 = ");";
  protected final String TEXT_840 = NL + "    ";
  protected final String TEXT_841 = ".remove(oldIndex);" + NL + "    if (";
  ...
  protected final String TEXT_845 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_846 = NL + "        ";
  protected final String TEXT_847 = ".add(oldIndex,";
  ...
  protected final String TEXT_853 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_854 = NL + "    if (!";
  protected final String TEXT_855 = ".contains(";
  protected final String TEXT_856 = "))" + NL + "    {";
  protected final String TEXT_857 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_858 = "() <= ";
  protected final String TEXT_859 = "())" + NL + "    {";
  protected final String TEXT_860 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_861 = ".indexOf(";
  protected final String TEXT_862 = ");";
  protected final String TEXT_863 = NL + "    ";
  protected final String TEXT_864 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_865 = ".";
  protected final String TEXT_866 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_867 = ".";
  protected final String TEXT_868 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_869 = NL + "        ";
  protected final String TEXT_870 = ".add(oldIndex,";
  protected final String TEXT_871 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_872 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_873 = NL + "  public boolean ";
  protected final String TEXT_874 = "(";
  protected final String TEXT_875 = " ";
  protected final String TEXT_876 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_892 = ".equals(";
  protected final String TEXT_893 = "))" + NL + "    {";
  protected final String TEXT_894 = NL + "      ";
  protected final String TEXT_895 = ".";
  protected final String TEXT_896 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_897 = " != null)" + NL + "    {";
  protected final String TEXT_898 = NL + "      ";
  protected final String TEXT_899 = ".";
  protected final String TEXT_900 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_901 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_902 = NL + "  public boolean ";
  protected final String TEXT_903 = "(";
  protected final String TEXT_904 = " ";
  protected final String TEXT_905 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_924 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_925 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_926 = NL + "  public boolean ";
  protected final String TEXT_927 = "(";
  protected final String TEXT_928 = " ";
  protected final String TEXT_929 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_930 = NL + "    //Must provide ";
  protected final String TEXT_931 = " to ";
  protected final String TEXT_932 = NL + "    if (";
  protected final String TEXT_933 = " == null)" + NL + "    {";
  protected final String TEXT_934 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_935 = " already at maximum (";
  ...
  protected final String TEXT_951 = "))" + NL + "    {" + NL + "      boolean didRemove = ";
  protected final String TEXT_952 = ".";
  protected final String TEXT_953 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  protected final String TEXT_954 = NL + "        ";
  protected final String TEXT_955 = " = ";
  protected final String TEXT_956 = ";";
  protected final String TEXT_957 = NL + "        return wasSet;" + NL + "      }" + NL + "    }";
  protected final String TEXT_958 = NL + "    ";
  protected final String TEXT_959 = ".";
  protected final String TEXT_960 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_961 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_962 = NL + "  public boolean ";
  protected final String TEXT_963 = "(";
  protected final String TEXT_964 = " ";
  protected final String TEXT_965 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_966 = NL + "    //Must provide ";
  protected final String TEXT_967 = " to ";
  protected final String TEXT_968 = NL + "    if (";
  protected final String TEXT_969 = " == null)" + NL + "    {";
  protected final String TEXT_970 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_985 = ".equals(";
  protected final String TEXT_986 = "))" + NL + "    {" + NL + "      boolean didRemove = ";
  protected final String TEXT_987 = ".";
  protected final String TEXT_988 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_997 = NL + "  public boolean ";
  protected final String TEXT_998 = "(";
  protected final String TEXT_999 = " ";
  protected final String TEXT_1000 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_1009 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1017 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_1018 = NL + "      ";
  protected final String TEXT_1019 = ".add(";
  protected final String TEXT_1020 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1021 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1022 = "(";
  protected final String TEXT_1023 = " ";
  protected final String TEXT_1024 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1025 = NL + "    if (";
  protected final String TEXT_1026 = ".contains(";
  protected final String TEXT_1027 = "))" + NL + "    {";
  protected final String TEXT_1028 = NL + "      ";
  protected final String TEXT_1029 = ".remove(";
  protected final String TEXT_1030 = ");";
  protected final String TEXT_1031 = NL + "      ";
  protected final String TEXT_1032 = ".";
  protected final String TEXT_1033 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1034 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1035 = NL + "  public boolean ";
  protected final String TEXT_1036 = "(";
  protected final String TEXT_1037 = " ";
  protected final String TEXT_1038 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_1064 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1085 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1086 = "(";
  protected final String TEXT_1087 = " ";
  protected final String TEXT_1088 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_1098 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1099 = NL + "  public boolean ";
  protected final String TEXT_1100 = "(";
  protected final String TEXT_1101 = " ";
  protected final String TEXT_1102 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_1108 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  ...
  protected final String TEXT_1116 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1117 = "() <= ";
  protected final String TEXT_1118 = "())" + NL + "    {";
  protected final String TEXT_1119 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1131 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1141 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  ...
  protected final String TEXT_1152 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1153 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1154 = "(";
  protected final String TEXT_1155 = " ";
  protected final String TEXT_1156 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_1163 = ".remove(";
  protected final String TEXT_1164 = ");";
  protected final String TEXT_1165 = NL + "      ";
  protected final String TEXT_1166 = "(";
  protected final String TEXT_1167 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1173 = NL + "    ArrayList<";
  protected final String TEXT_1174 = "> ";
  protected final String TEXT_1175 = " = new ArrayList<";
  protected final String TEXT_1176 = ">();" + NL + "    for (";
  protected final String TEXT_1177 = " ";
  protected final String TEXT_1178 = " : ";
  protected final String TEXT_1179 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1180 = ".contains(";
  protected final String TEXT_1181 = "))" + NL + "      {";
  protected final String TEXT_1182 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1183 = ".";
  protected final String TEXT_1184 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1190 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1191 = ".size() != ";
  protected final String TEXT_1192 = "())" + NL + "    {";
  protected final String TEXT_1193 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1194 = NL + "    ";
  protected final String TEXT_1195 = ".removeAll(";
  protected final String TEXT_1196 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1197 = " orphan : ";
  protected final String TEXT_1198 = ")" + NL + "    {";
  protected final String TEXT_1199 = NL + "      ";
  protected final String TEXT_1200 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1201 = NL + "    ";
  protected final String TEXT_1202 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1211 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1212 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1213 = NL + "  private void ";
  protected final String TEXT_1214 = "(";
  protected final String TEXT_1215 = " ";
  protected final String TEXT_1216 = ", ";
  protected final String TEXT_1217 = " ";
  protected final String TEXT_1218 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1219 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1220 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1221 = ", ";
  protected final String TEXT_1222 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1223 = " to ";
  protected final String TEXT_1224 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1225 = NL + "  public boolean ";
  protected final String TEXT_1226 = "(";
  protected final String TEXT_1227 = " ";
  protected final String TEXT_1228 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1229 = NL + "    ";
  protected final String TEXT_1230 = ".add(";
  protected final String TEXT_1231 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1232 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1233 = "(";
  protected final String TEXT_1234 = " ";
  protected final String TEXT_1235 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_1240 = ".remove(";
  protected final String TEXT_1241 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1242 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1243 = NL + "  public boolean ";
  protected final String TEXT_1244 = "(";
  protected final String TEXT_1245 = " ";
  protected final String TEXT_1246 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_1251 = ".add(";
  protected final String TEXT_1252 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1253 = NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1254 = "(";
  protected final String TEXT_1255 = " ";
  protected final String TEXT_1256 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1257 = NL + "    if (";
  protected final String TEXT_1258 = ".contains(";
  protected final String TEXT_1259 = "))" + NL + "    {";
  protected final String TEXT_1260 = NL + "      ";
  protected final String TEXT_1261 = ".remove(";
  protected final String TEXT_1262 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1263 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1264 = NL + "  public boolean ";
  protected final String TEXT_1265 = "(";
  protected final String TEXT_1266 = " ";
  protected final String TEXT_1267 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1268 = NL + "    ";
  protected final String TEXT_1269 = ".add(";
  ...
  protected final String TEXT_1278 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1287 = " boolean ";
  protected final String TEXT_1288 = "(";
  protected final String TEXT_1289 = "... ";
  protected final String TEXT_1290 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1291 = NL + "    ArrayList<";
  ...
  protected final String TEXT_1297 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1298 = ".contains(";
  protected final String TEXT_1299 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1300 = NL + "      ";
  protected final String TEXT_1301 = ".add(";
  protected final String TEXT_1302 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1303 = ".size() != ";
  protected final String TEXT_1304 = ".length || ";
  protected final String TEXT_1305 = ".size() != ";
  protected final String TEXT_1306 = "())" + NL + "    {";
  protected final String TEXT_1307 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1308 = NL + "    ";
  protected final String TEXT_1309 = ".clear();";
  protected final String TEXT_1310 = NL + "    ";
  protected final String TEXT_1311 = ".addAll(";
  protected final String TEXT_1312 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1313 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1314 = NL + "  ";
  protected final String TEXT_1315 = " boolean ";
  protected final String TEXT_1316 = "(";
  protected final String TEXT_1317 = "... ";
  protected final String TEXT_1318 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_1327 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1328 = NL + "    return wasSet;" + NL + "  }";
  ...
  protected final String TEXT_1341 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1346 = ".length || ";
  protected final String TEXT_1347 = ".size() < ";
  protected final String TEXT_1348 = "() || ";
  protected final String TEXT_1349 = ".size() > ";
  protected final String TEXT_1350 = "())" + NL + "    {";
  protected final String TEXT_1351 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  ...
  protected final String TEXT_1357 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1367 = ".remove(";
  protected final String TEXT_1368 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1369 = NL + "        ";
  protected final String TEXT_1370 = ".";
  protected final String TEXT_1371 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1377 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1382 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1383 = NL + "    ArrayList<";
  protected final String TEXT_1384 = "> ";
  protected final String TEXT_1385 = " = new ArrayList<";
  ...
  protected final String TEXT_1399 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_1400 = "> ";
  protected final String TEXT_1401 = " = new ArrayList<";
  ...
  protected final String TEXT_1428 = " boolean ";
  protected final String TEXT_1429 = "(";
  protected final String TEXT_1430 = "... ";
  protected final String TEXT_1431 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1432 = NL + "    ArrayList<";
  protected final String TEXT_1433 = "> ";
  protected final String TEXT_1434 = " = new ArrayList<";
  ...
  protected final String TEXT_1454 = ".addAll(";
  protected final String TEXT_1455 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1456 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1457 = NL + "  public boolean ";
  protected final String TEXT_1458 = "(";
  protected final String TEXT_1459 = "... ";
  protected final String TEXT_1460 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_1465 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_1466 = "> ";
  protected final String TEXT_1467 = " = new ArrayList<";
  protected final String TEXT_1468 = ">();" + NL + "    HashMap<";
  protected final String TEXT_1469 = ",Integer> ";
  protected final String TEXT_1470 = " = new HashMap<";
  protected final String TEXT_1471 = ",Integer>();" + NL + "    for (";
  protected final String TEXT_1472 = " ";
  protected final String TEXT_1473 = " : ";
  protected final String TEXT_1474 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1475 = ".contains(";
  protected final String TEXT_1476 = "))" + NL + "      {";
  protected final String TEXT_1477 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1478 = ".";
  protected final String TEXT_1479 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1486 = "();" + NL + "        if (!";
  protected final String TEXT_1487 = ".containsKey(";
  protected final String TEXT_1488 = "))" + NL + "        {";
  protected final String TEXT_1489 = NL + "          ";
  protected final String TEXT_1490 = ".put(";
  protected final String TEXT_1491 = ", new Integer(";
  protected final String TEXT_1492 = ".";
  protected final String TEXT_1493 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1494 = ".get(";
  protected final String TEXT_1495 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  protected final String TEXT_1496 = ")" + NL + "        {";
  protected final String TEXT_1497 = NL + "          return wasSet;" + NL + "        }";
  protected final String TEXT_1498 = NL + "        ";
  protected final String TEXT_1499 = ".put(";
  protected final String TEXT_1500 = ", new Integer(nextCount));" + NL + "      }";
  ...
  protected final String TEXT_1505 = ".removeAll(";
  protected final String TEXT_1506 = ");" + NL + "" + NL + "    for (";
  protected final String TEXT_1507 = " orphan : ";
  protected final String TEXT_1508 = ")" + NL + "    {";
  protected final String TEXT_1509 = NL + "      ";
  protected final String TEXT_1510 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1511 = NL + "    ";
  protected final String TEXT_1512 = ".clear();" + NL + "    for (";
  protected final String TEXT_1513 = " ";
  protected final String TEXT_1514 = " : ";
  protected final String TEXT_1515 = ")" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1521 = ".remove(";
  ...
  protected final String TEXT_1528 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1529 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1530 = NL + "  private void ";
  ...
  protected final String TEXT_1535 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1536 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1537 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1538 = ", ";
  protected final String TEXT_1539 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1540 = " to ";
  protected final String TEXT_1541 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1542 = NL + "  ";
  protected final String TEXT_1543 = " boolean ";
  protected final String TEXT_1544 = "(";
  protected final String TEXT_1545 = "... ";
  protected final String TEXT_1546 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1547 = NL + "    ArrayList<";
  protected final String TEXT_1548 = "> ";
  protected final String TEXT_1549 = " = new ArrayList<";
  protected final String TEXT_1550 = ">();" + NL + "    for (";
  protected final String TEXT_1551 = " ";
  protected final String TEXT_1552 = " : ";
  protected final String TEXT_1553 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1554 = ".contains(";
  protected final String TEXT_1555 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1556 = NL + "      ";
  protected final String TEXT_1557 = ".add(";
  protected final String TEXT_1558 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1559 = ".size() != ";
  protected final String TEXT_1560 = ".length || ";
  protected final String TEXT_1561 = ".size() > ";
  protected final String TEXT_1562 = "())" + NL + "    {";
  protected final String TEXT_1563 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1564 = NL + "    ";
  protected final String TEXT_1565 = ".clear();";
  protected final String TEXT_1566 = NL + "    ";
  protected final String TEXT_1567 = ".addAll(";
  protected final String TEXT_1568 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1569 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1570 = NL + "  ";
  protected final String TEXT_1571 = " boolean ";
  protected final String TEXT_1572 = "(";
  protected final String TEXT_1573 = "... ";
  protected final String TEXT_1574 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1575 = NL + "    ArrayList<";
  protected final String TEXT_1576 = "> ";
  protected final String TEXT_1577 = " = new ArrayList<";
  protected final String TEXT_1578 = ">();" + NL + "    for (";
  protected final String TEXT_1579 = " ";
  protected final String TEXT_1580 = " : ";
  protected final String TEXT_1581 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1582 = ".contains(";
  protected final String TEXT_1583 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1584 = NL + "      ";
  protected final String TEXT_1585 = ".add(";
  protected final String TEXT_1586 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1587 = ".size() != ";
  protected final String TEXT_1588 = ".length || ";
  ...
  protected final String TEXT_1593 = ".clear();";
  protected final String TEXT_1594 = NL + "    ";
  protected final String TEXT_1595 = ".addAll(";
  protected final String TEXT_1596 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1597 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1598 = NL + "  public boolean equals(Object obj)" + NL + "  {" + NL + "    if (obj == null) { return false; }" + NL + "    if (!getClass().equals(obj.getClass())) { return false; }" + NL;
  protected final String TEXT_1599 = NL + "    ";
  protected final String TEXT_1600 = " compareTo = (";
  protected final String TEXT_1601 = ")obj;" + NL + "  ";
  protected final String TEXT_1602 = NL + "    ";
  protected final String TEXT_1603 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1604 = NL + "    ";
  protected final String TEXT_1605 = NL;
  protected final String TEXT_1606 = NL + "    ";
  protected final String TEXT_1607 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1608 = NL + "  private void ";
  protected final String TEXT_1609 = "()" + NL + "  {" + NL + "    try" + NL + "    {";
  protected final String TEXT_1610 = NL + "      ";
  protected final String TEXT_1611 = NL + "    }" + NL + "    catch (InterruptedException e)" + NL + "    {" + NL + "" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1612 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1613 = NL + "    ";
  protected final String TEXT_1614 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1615 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1616 = NL + "      ";
  protected final String TEXT_1617 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1618 = NL + "  private void ";
  protected final String TEXT_1619 = "()" + NL + "  {";
  protected final String TEXT_1620 = NL + "    ";
  protected final String TEXT_1621 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1622 = "\",";
  protected final String TEXT_1623 = ");" + NL + "  }" + NL + "" + NL + "  private void ";
  protected final String TEXT_1624 = "()" + NL + "  {";
  protected final String TEXT_1625 = NL + "    ";
  protected final String TEXT_1626 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1627 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1628 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  ...
  protected final String TEXT_1631 = "\".equals(timeoutMethodName))" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1632 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1633 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  ...
  protected final String TEXT_1638 = ".clear();";
  ...
  protected final String TEXT_1644 = " = null;" + NL + "    if (";
  protected final String TEXT_1645 = " != null)" + NL + "    {";
  protected final String TEXT_1646 = NL + "      ";
  protected final String TEXT_1647 = ".delete();" + NL + "    }";
  protected final String TEXT_1648 = NL + "    if (";
  protected final String TEXT_1649 = " != null)" + NL + "    {";
  ...
  protected final String TEXT_1658 = " = null;" + NL + "    if (";
  protected final String TEXT_1659 = " != null)" + NL + "    {";
  protected final String TEXT_1660 = NL + "      ";
  protected final String TEXT_1661 = ".";
  protected final String TEXT_1662 = "(null);" + NL + "    }";
  ...
  protected final String TEXT_1668 = " = null;" + NL + "    if (";
  protected final String TEXT_1669 = " != null)" + NL + "    {";
  protected final String TEXT_1670 = NL + "      ";
  protected final String TEXT_1671 = ".delete();" + NL + "    }";
  ...
  protected final String TEXT_1692 = ".delete();" + NL + "      }" + NL + "      else" + NL + "      {";
  ...
  protected final String TEXT_1700 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1701 = NL + "    ";
  protected final String TEXT_1702 = " ";
  protected final String TEXT_1703 = " = ";
  protected final String TEXT_1704 = ";" + NL + "    this.";
  protected final String TEXT_1705 = " = null;";
  protected final String TEXT_1706 = NL + "    ";
  protected final String TEXT_1707 = ".";
  protected final String TEXT_1708 = "(this);";
  protected final String TEXT_1709 = NL + "    for(";
  ...
  protected final String TEXT_1733 = ".delete();" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1734 = NL + "        ";
  protected final String TEXT_1735 = ".";
  protected final String TEXT_1736 = "(this);" + NL + "      }" + NL + "    }";
  ...
  protected final String TEXT_1749 = "(this);" + NL + "    }";
  protected final String TEXT_1750 = NL + "    for(int i=";
  protected final String TEXT_1751 = ".size(); i > 0; i--)" + NL + "    {";
  protected final String TEXT_1752 = NL + "      ";
  protected final String TEXT_1753 = " ";
  protected final String TEXT_1754 = " = ";
  protected final String TEXT_1755 = ".get(i - 1);";
  protected final String TEXT_1756 = NL + "      ";
  protected final String TEXT_1757 = ".delete();" + NL + "    }";
  protected final String TEXT_1758 = NL + "    for(";
  ...
  protected final String TEXT_1764 = "(null);" + NL + "    }";
  protected final String TEXT_1765 = "  " + NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
