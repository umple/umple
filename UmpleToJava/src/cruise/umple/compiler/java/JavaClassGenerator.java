...
public class JavaClassGenerator implements ILang 
{
  ...
  protected final String TEXT_1173 = NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_1183 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1193 = ".add(";
  protected final String TEXT_1194 = ");" + NL + "    }" + NL + "    wasAdded = true;";
  protected final String TEXT_1195 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_1196 = NL;
  protected final String TEXT_1197 = NL + "  public boolean ";
  protected final String TEXT_1198 = "(";
  protected final String TEXT_1199 = " ";
  protected final String TEXT_1200 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_1205 = ".remove(";
  protected final String TEXT_1206 = ");";
  protected final String TEXT_1207 = NL + "      ";
  protected final String TEXT_1208 = ".";
  protected final String TEXT_1209 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1214 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_1220 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1221 = NL + "    return wasAdded;" + NL + "  }";
  ...
  protected final String TEXT_1255 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1256 = " != null)" + NL + "    {";
  ...
  protected final String TEXT_1266 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1267 = NL + "    return wasAdded;" + NL + "  }";
  ...
  protected final String TEXT_1288 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1289 = NL + "    ArrayList<";
  protected final String TEXT_1290 = "> ";
  protected final String TEXT_1291 = " = new ArrayList<";
  protected final String TEXT_1292 = ">();" + NL + "    for (";
  protected final String TEXT_1293 = " ";
  protected final String TEXT_1294 = " : ";
  protected final String TEXT_1295 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1296 = ".contains(";
  protected final String TEXT_1297 = "))" + NL + "      {";
  protected final String TEXT_1298 = NL + "        return wasSet;" + NL + "      }" + NL + "      else if (";
  protected final String TEXT_1299 = ".";
  protected final String TEXT_1300 = "() != null && !this.equals(";
  protected final String TEXT_1301 = ".";
  protected final String TEXT_1302 = "()))" + NL + "      {";
  protected final String TEXT_1303 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1304 = NL + "      ";
  protected final String TEXT_1305 = ".add(";
  protected final String TEXT_1306 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1311 = ".removeAll(";
  protected final String TEXT_1312 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1313 = " orphan : ";
  protected final String TEXT_1314 = ")" + NL + "    {";
  protected final String TEXT_1315 = NL + "      ";
  protected final String TEXT_1316 = "(orphan, null);" + NL + "    }";
  protected final String TEXT_1317 = NL + "    ";
  protected final String TEXT_1318 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1324 = ", this);";
  ...
  protected final String TEXT_1329 = NL + "  private void ";
  ...
  protected final String TEXT_1334 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1335 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1336 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1337 = ", ";
  protected final String TEXT_1338 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1339 = " to ";
  protected final String TEXT_1340 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1341 = NL + "  public boolean ";
  protected final String TEXT_1342 = "(";
  protected final String TEXT_1343 = " ";
  protected final String TEXT_1344 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1345 = NL + "    ";
  protected final String TEXT_1346 = ".add(";
  protected final String TEXT_1347 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1348 = NL + "    return wasAdded;" + NL + "  }";
  ...
  protected final String TEXT_1353 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_1359 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1364 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_1370 = ");" + NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1371 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_1372 = NL;
  protected final String TEXT_1373 = NL + "  public boolean ";
  protected final String TEXT_1374 = "(";
  protected final String TEXT_1375 = " ";
  protected final String TEXT_1376 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  ...
  protected final String TEXT_1381 = ".remove(";
  ...
  protected final String TEXT_1389 = ".add(";
  protected final String TEXT_1390 = ");" + NL + "    wasAdded = true;";
  protected final String TEXT_1391 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_1392 = NL;
  protected final String TEXT_1393 = NL + "  public boolean ";
  ...
  protected final String TEXT_1400 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1401 = "() <= ";
  protected final String TEXT_1402 = "())" + NL + "    {";
  protected final String TEXT_1403 = NL + "      return wasRemoved;" + NL + "    }" + NL;
  protected final String TEXT_1404 = NL + "    ";
  protected final String TEXT_1405 = ".remove(";
  protected final String TEXT_1406 = ");" + NL + "    wasRemoved = true;";
  protected final String TEXT_1407 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1408 = NL + "  ";
  protected final String TEXT_1409 = " boolean ";
  protected final String TEXT_1410 = "(";
  protected final String TEXT_1411 = "... ";
  protected final String TEXT_1412 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1413 = NL + "    ArrayList<";
  protected final String TEXT_1414 = "> ";
  protected final String TEXT_1415 = " = new ArrayList<";
  protected final String TEXT_1416 = ">();" + NL + "    for (";
  protected final String TEXT_1417 = " ";
  protected final String TEXT_1418 = " : ";
  protected final String TEXT_1419 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1420 = ".contains(";
  protected final String TEXT_1421 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1422 = NL + "      ";
  protected final String TEXT_1423 = ".add(";
  protected final String TEXT_1424 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1425 = ".size() != ";
  protected final String TEXT_1426 = ".length || ";
  ...
  protected final String TEXT_1454 = ".length)" + NL + "    {";
  ...
  protected final String TEXT_1465 = ")" + NL + "  {" + NL + "    //" + NL + "    // This source of this source generation is association_SetOptionalOneToMandatoryMany.jet" + NL + "    // This set file assumes the generation of a maximumNumberOfXXX method does not exist because " + NL + "    // it's not required (No upper bound)" + NL + "    //   " + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_1473 = "(this))" + NL + "        {";
  protected final String TEXT_1474 = NL + "          ";
  protected final String TEXT_1475 = " = ";
  protected final String TEXT_1476 = ";" + NL + "          wasSet = true;" + NL + "        }" + NL + "      }" + NL + "    } " + NL + "    else if (";
  protected final String TEXT_1477 = " != null)" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1478 = " == null)" + NL + "      {" + NL + "        if (";
  ...
  protected final String TEXT_1489 = " == null" + NL + "          wasSet = true;" + NL + "        }" + NL + "      } " + NL + "      else" + NL + "      {" + NL + "        if (";
  ...
  protected final String TEXT_1502 = ";" + NL + "          wasSet = true;" + NL + "        }" + NL + "      }" + NL + "    }" + NL + "    if (wasSet)" + NL + "    {";
  protected final String TEXT_1503 = NL + "      ";
  protected final String TEXT_1504 = " = ";
  protected final String TEXT_1505 = ";" + NL + "    }" + NL + "    return wasSet;" + NL + "  }" + NL + "  ";
  protected final String TEXT_1506 = NL + "//  public boolean ";
  protected final String TEXT_1507 = "(";
  protected final String TEXT_1508 = " ";
  protected final String TEXT_1509 = ")" + NL + "//  {" + NL + "//    //" + NL + "//    // The source of the code generation is association_SetOptionalOneToMN.jet" + NL + "//    // (this) set file assumes the generation of a maximumNumberOfXXX " + NL + "//    //   method ";
  protected final String TEXT_1510 = NL + "//    // Currently this will not compile due to Issue351 - the template code is fine." + NL + "//    //" + NL + "//" + NL + "//    boolean wasSet = false;" + NL + "//    ";
  protected final String TEXT_1511 = " ";
  protected final String TEXT_1512 = " = ";
  protected final String TEXT_1513 = ";" + NL + "//  " + NL + "//    if (";
  ...
  protected final String TEXT_1517 = "(this))" + NL + "//          ";
  protected final String TEXT_1518 = " = ";
  protected final String TEXT_1519 = ";" + NL + "//          wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//    }" + NL + "//    else" + NL + "//    {" + NL + "//      if (";
  protected final String TEXT_1520 = " != null)" + NL + "//      {" + NL + "//        if (";
  protected final String TEXT_1521 = " == null)" + NL + "//        {" + NL + "//          if (";
  ...
  protected final String TEXT_1527 = "(this);" + NL + "//            ";
  ...
  protected final String TEXT_1540 = "(this);" + NL + "//          ";
  protected final String TEXT_1541 = ".";
  protected final String TEXT_1542 = "(this);" + NL + "//          ";
  protected final String TEXT_1543 = " = ";
  protected final String TEXT_1544 = ";" + NL + "//          wasSet = true;" + NL + "//        }" + NL + "//      }" + NL + "//    }" + NL + "//    " + NL + "//    if (wasSet)" + NL + "//    {" + NL + "//      ";
  protected final String TEXT_1545 = " = ";
  protected final String TEXT_1546 = ";" + NL + "//    }" + NL + "//    " + NL + "//    return wasSet;" + NL + "//  }";
  ...
  protected final String TEXT_1569 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  ...
  protected final String TEXT_1575 = ".clear();" + NL + "    for (";
  ...
  protected final String TEXT_1585 = ".remove(";
  protected final String TEXT_1586 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1587 = NL + "        ";
  protected final String TEXT_1588 = ".";
  protected final String TEXT_1589 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1595 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1596 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1597 = NL + "  public boolean ";
  protected final String TEXT_1598 = "(";
  protected final String TEXT_1599 = "... ";
  protected final String TEXT_1600 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1601 = NL + "    ArrayList<";
  protected final String TEXT_1602 = "> ";
  protected final String TEXT_1603 = " = new ArrayList<";
  protected final String TEXT_1604 = ">();" + NL + "    for (";
  protected final String TEXT_1605 = " ";
  protected final String TEXT_1606 = " : ";
  protected final String TEXT_1607 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1608 = ".contains(";
  protected final String TEXT_1609 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_1610 = NL + "      ";
  protected final String TEXT_1611 = ".add(";
  protected final String TEXT_1612 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1613 = ".size() != ";
  protected final String TEXT_1614 = ".length || ";
  protected final String TEXT_1615 = ".size() < ";
  protected final String TEXT_1616 = "())" + NL + "    {";
  protected final String TEXT_1617 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_1618 = "> ";
  protected final String TEXT_1619 = " = new ArrayList<";
  ...
  protected final String TEXT_1628 = ".add(";
  ...
  protected final String TEXT_1633 = ".remove(";
  protected final String TEXT_1634 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1635 = NL + "        ";
  protected final String TEXT_1636 = ".";
  protected final String TEXT_1637 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  ...
  protected final String TEXT_1643 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1644 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1645 = NL + "  ";
  protected final String TEXT_1646 = " boolean ";
  ...
  protected final String TEXT_1666 = ".size() > ";
  ...
  protected final String TEXT_1670 = ".clear();";
  protected final String TEXT_1671 = NL + "    ";
  protected final String TEXT_1672 = ".addAll(";
  protected final String TEXT_1673 = ");" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1683 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_1684 = "> ";
  protected final String TEXT_1685 = " = new ArrayList<";
  protected final String TEXT_1686 = ">();" + NL + "    HashMap<";
  protected final String TEXT_1687 = ",Integer> ";
  protected final String TEXT_1688 = " = new HashMap<";
  protected final String TEXT_1689 = ",Integer>();" + NL + "    for (";
  protected final String TEXT_1690 = " ";
  protected final String TEXT_1691 = " : ";
  protected final String TEXT_1692 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1693 = ".contains(";
  ...
  protected final String TEXT_1697 = "() != null && !this.equals(";
  ...
  protected final String TEXT_1705 = ".containsKey(";
  protected final String TEXT_1706 = "))" + NL + "        {";
  protected final String TEXT_1707 = NL + "          ";
  protected final String TEXT_1708 = ".put(";
  protected final String TEXT_1709 = ", new Integer(";
  protected final String TEXT_1710 = ".";
  protected final String TEXT_1711 = "()));" + NL + "        }" + NL + "        Integer currentCount = ";
  protected final String TEXT_1712 = ".get(";
  protected final String TEXT_1713 = ");" + NL + "        int nextCount = currentCount - 1;" + NL + "        if (nextCount < ";
  ...
  protected final String TEXT_1717 = ".put(";
  protected final String TEXT_1718 = ", new Integer(nextCount));" + NL + "      }";
  protected final String TEXT_1719 = NL + "      ";
  protected final String TEXT_1720 = ".add(";
  ...
  protected final String TEXT_1739 = ".remove(";
  ...
  protected final String TEXT_1748 = NL + "  private void ";
  ...
  protected final String TEXT_1753 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1754 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1755 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1756 = ", ";
  protected final String TEXT_1757 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1758 = " to ";
  protected final String TEXT_1759 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1760 = NL + "  ";
  protected final String TEXT_1761 = " boolean ";
  ...
  protected final String TEXT_1765 = NL + "    ArrayList<";
  protected final String TEXT_1766 = "> ";
  protected final String TEXT_1767 = " = new ArrayList<";
  ...
  protected final String TEXT_1773 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  ...
  protected final String TEXT_1778 = ".length || ";
  protected final String TEXT_1779 = ".size() > ";
  protected final String TEXT_1780 = "())" + NL + "    {";
  protected final String TEXT_1781 = NL + "      return wasSet;" + NL + "    }" + NL;
  protected final String TEXT_1782 = NL + "    ";
  protected final String TEXT_1783 = ".clear();";
  protected final String TEXT_1784 = NL + "    ";
  protected final String TEXT_1785 = ".addAll(";
  protected final String TEXT_1786 = ");" + NL + "    wasSet = true;";
  protected final String TEXT_1787 = NL + "    return wasSet;" + NL + "  }" + NL;
  ...
  protected final String TEXT_1817 = NL + "  public boolean ";
  protected final String TEXT_1818 = "(";
  protected final String TEXT_1819 = " ";
  protected final String TEXT_1820 = ", int index)" + NL + "  {  " + NL + "    boolean wasAdded = false;" + NL + "    if(";
  protected final String TEXT_1821 = "(";
  protected final String TEXT_1822 = "))" + NL + "    {" + NL + "      if(index < 0 ) { index = 0; }" + NL + "      if(index > ";
  protected final String TEXT_1823 = "()) { index = ";
  protected final String TEXT_1824 = "() - 1; }";
  protected final String TEXT_1825 = NL + "      ";
  protected final String TEXT_1826 = ".remove(";
  protected final String TEXT_1827 = ");";
  protected final String TEXT_1828 = NL + "      ";
  protected final String TEXT_1829 = ".add(index, ";
  protected final String TEXT_1830 = ");";
  protected final String TEXT_1831 = NL + "      wasAdded = true;" + NL + "    }" + NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_1832 = NL;
  protected final String TEXT_1833 = NL + "  public boolean ";
  protected final String TEXT_1834 = "(";
  protected final String TEXT_1835 = " ";
  protected final String TEXT_1836 = ", int index)" + NL + "  {" + NL + "    boolean wasAdded = false;" + NL + "    if(";
  protected final String TEXT_1837 = ".contains(";
  protected final String TEXT_1838 = "))" + NL + "    {" + NL + "      if(index < 0 ) { index = 0; }" + NL + "      if(index > ";
  protected final String TEXT_1839 = "()) { index = ";
  protected final String TEXT_1840 = "() - 1; }";
  protected final String TEXT_1841 = NL + "      ";
  protected final String TEXT_1842 = ".remove(";
  protected final String TEXT_1843 = ");";
  protected final String TEXT_1844 = NL + "      ";
  protected final String TEXT_1845 = ".add(index, ";
  protected final String TEXT_1846 = ");";
  protected final String TEXT_1847 = NL + "      wasAdded = true;" + NL + "    } " + NL + "    else " + NL + "    {" + NL + "      wasAdded = ";
  protected final String TEXT_1848 = "(";
  protected final String TEXT_1849 = ", index);";
  protected final String TEXT_1850 = NL + "    }" + NL + "    return wasAdded;" + NL + "  }" + NL;
  protected final String TEXT_1851 = NL + "  public boolean equals(Object obj)" + NL + "  {" + NL + "    if (obj == null) { return false; }" + NL + "    if (!getClass().equals(obj.getClass())) { return false; }" + NL;
  protected final String TEXT_1852 = NL + "    ";
  protected final String TEXT_1853 = " compareTo = (";
  protected final String TEXT_1854 = ")obj;" + NL + "  ";
  protected final String TEXT_1855 = NL + "    ";
  protected final String TEXT_1856 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1857 = NL + "    ";
  protected final String TEXT_1858 = NL;
  protected final String TEXT_1859 = NL + "    ";
  protected final String TEXT_1860 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1861 = NL + "  private void ";
  protected final String TEXT_1862 = "()" + NL + "  {" + NL + "    try" + NL + "    {";
  protected final String TEXT_1863 = NL + "      ";
  protected final String TEXT_1864 = NL + "      Thread.sleep(1);";
  protected final String TEXT_1865 = NL + "    }" + NL + "    catch (InterruptedException e)" + NL + "    {" + NL + "" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1866 = NL + "  private void ";
  protected final String TEXT_1867 = "()" + NL + "  {" + NL + "    try" + NL + "    {";
  protected final String TEXT_1868 = NL + "      ";
  protected final String TEXT_1869 = NL + "      Thread.sleep(1);";
  protected final String TEXT_1870 = NL + "    }" + NL + "    catch (InterruptedException e)" + NL + "    {" + NL + "" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1871 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1872 = NL + "    ";
  protected final String TEXT_1873 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1874 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1875 = NL + "      ";
  protected final String TEXT_1876 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1877 = NL + "  private void ";
  protected final String TEXT_1878 = "()" + NL + "  {";
  protected final String TEXT_1879 = NL + "    ";
  protected final String TEXT_1880 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1881 = "\",";
  protected final String TEXT_1882 = ");" + NL + "  }" + NL + "" + NL + "  private void ";
  protected final String TEXT_1883 = "()" + NL + "  {";
  protected final String TEXT_1884 = NL + "    ";
  protected final String TEXT_1885 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1886 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1887 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1888 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void run ()" + NL + "    {";
  protected final String TEXT_1889 = NL + "      if (\"";
  protected final String TEXT_1890 = "\".equals(timeoutMethodName))" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1891 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1892 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1893 = NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1903 = " = null;" + NL + "    if (";
  protected final String TEXT_1904 = " != null)" + NL + "    {";
  protected final String TEXT_1905 = NL + "      ";
  protected final String TEXT_1906 = ".delete();" + NL + "    }";
  protected final String TEXT_1907 = NL + "    if (";
  protected final String TEXT_1908 = " != null)" + NL + "    {";
  protected final String TEXT_1909 = NL + "      ";
  protected final String TEXT_1910 = ".";
  protected final String TEXT_1911 = "(null);" + NL + "    }";
  ...
  protected final String TEXT_1917 = " = null;" + NL + "    if (";
  ...
  protected final String TEXT_1941 = NL + "    if (";
  protected final String TEXT_1942 = " != null)" + NL + "    {";
  protected final String TEXT_1943 = NL + "      ";
  protected final String TEXT_1944 = ".delete();" + NL + "    }";
  protected final String TEXT_1945 = NL + "    if (";
  protected final String TEXT_1946 = " != null)" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1992 = ".delete();" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1993 = NL + "        ";
  protected final String TEXT_1994 = ".";
  protected final String TEXT_1995 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1996 = NL + "    ArrayList<";
  protected final String TEXT_1997 = "> ";
  protected final String TEXT_1998 = " = new ArrayList<";
  protected final String TEXT_1999 = ">(";
  protected final String TEXT_2000 = ");";
  protected final String TEXT_2001 = NL + "    ";
  protected final String TEXT_2002 = ".clear();" + NL + "    for(";
  ...
  protected final String TEXT_2008 = "(this);" + NL + "    }";
  protected final String TEXT_2009 = NL + "    for(int i=";
  protected final String TEXT_2010 = ".size(); i > 0; i--)" + NL + "    {";
  protected final String TEXT_2011 = NL + "      ";
  protected final String TEXT_2012 = " ";
  protected final String TEXT_2013 = " = ";
  protected final String TEXT_2014 = ".get(i - 1);";
  protected final String TEXT_2015 = NL + "      ";
  protected final String TEXT_2016 = ".delete();" + NL + "    }";
  protected final String TEXT_2017 = NL + "    for(";
