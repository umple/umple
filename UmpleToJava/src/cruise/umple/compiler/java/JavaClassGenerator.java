...
public class JavaClassGenerator implements ILang 
{
  ...
  protected final String TEXT_486 = "(int index)" + NL + "  {";
  protected final String TEXT_487 = NL + "    ";
  protected final String TEXT_488 = " ";
  protected final String TEXT_489 = " = ";
  protected final String TEXT_490 = ".get(index);";
  protected final String TEXT_491 = NL + "    return ";
  protected final String TEXT_492 = ";" + NL + "  }" + NL;
  protected final String TEXT_493 = NL + "  public List<";
  protected final String TEXT_494 = "> ";
  protected final String TEXT_495 = "()" + NL + "  {";
  protected final String TEXT_496 = NL + "    List<";
  protected final String TEXT_497 = "> ";
  protected final String TEXT_498 = " = Collections.unmodifiableList(";
  protected final String TEXT_499 = ");";
  protected final String TEXT_500 = NL + "    return ";
  protected final String TEXT_501 = ";" + NL + "  }";
  protected final String TEXT_502 = NL;
  protected final String TEXT_503 = NL + "  public int ";
  protected final String TEXT_504 = "()" + NL + "  {";
  protected final String TEXT_505 = NL + "    int number = ";
  protected final String TEXT_506 = ".size();";
  protected final String TEXT_507 = NL + "    return number;" + NL + "  }";
  protected final String TEXT_508 = NL;
  protected final String TEXT_509 = NL + "  public boolean ";
  protected final String TEXT_510 = "()" + NL + "  {";
  protected final String TEXT_511 = NL + "    boolean has = ";
  protected final String TEXT_512 = ".size() > 0;";
  protected final String TEXT_513 = NL + "    return has;" + NL + "  }";
  protected final String TEXT_514 = NL;
  protected final String TEXT_515 = NL + "  public int ";
  protected final String TEXT_516 = "(";
  protected final String TEXT_517 = " ";
  protected final String TEXT_518 = ")" + NL + "  {";
  protected final String TEXT_519 = NL + "    int index = ";
  protected final String TEXT_520 = ".indexOf(";
  protected final String TEXT_521 = ");";
  protected final String TEXT_522 = NL + "    return index;" + NL + "  }" + NL;
  protected final String TEXT_523 = "UNABLE TO UNDERSAND association variable (see association_Get_All.jet)";
  protected final String TEXT_524 = "//FIXME - FOUND UNKNOWN ASSOCIATION RELATIONSHIP ";
  protected final String TEXT_525 = " : ";
  protected final String TEXT_526 = NL + "  public boolean ";
  protected final String TEXT_527 = "()" + NL + "  {";
  protected final String TEXT_528 = NL + "    boolean isValid = ";
  protected final String TEXT_529 = "() >= ";
  protected final String TEXT_530 = "();";
  protected final String TEXT_531 = NL + "    boolean isValid = ";
  protected final String TEXT_532 = "() >= ";
  protected final String TEXT_533 = "() && ";
  protected final String TEXT_534 = "() <= ";
  protected final String TEXT_535 = "();";
  protected final String TEXT_536 = NL + "    return isValid;" + NL + "  }";
  protected final String TEXT_537 = NL + "  public static int ";
  protected final String TEXT_538 = "()" + NL + "  {" + NL + "    return ";
  protected final String TEXT_539 = ";" + NL + "  }";
  protected final String TEXT_540 = NL + "  public static int ";
  protected final String TEXT_541 = "()" + NL + "  {";
  protected final String TEXT_542 = NL + "    int required = ";
  protected final String TEXT_543 = ";";
  protected final String TEXT_544 = NL + "    return required;" + NL + "  }";
  ...
  protected final String TEXT_548 = NL + "  public static int ";
  protected final String TEXT_549 = "()" + NL + "  {";
  protected final String TEXT_550 = NL + "    int minimum = ";
  protected final String TEXT_551 = ";";
  protected final String TEXT_552 = NL + "    return minimum;" + NL + "  }";
  ...
  protected final String TEXT_556 = NL + "  public static int ";
  protected final String TEXT_557 = "()" + NL + "  {";
  protected final String TEXT_558 = NL + "    int maximum = ";
  protected final String TEXT_559 = ";";
  protected final String TEXT_560 = NL + "    return maximum;" + NL + "  }";
  ...
  protected final String TEXT_568 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_569 = NL + "    ";
  protected final String TEXT_570 = ".add(";
  protected final String TEXT_571 = ");";
  protected final String TEXT_572 = NL + "    if (";
  protected final String TEXT_573 = ".";
  protected final String TEXT_574 = "(this) != -1)" + NL + "    {" + NL + "      wasAdded = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasAdded = ";
  protected final String TEXT_575 = ".";
  protected final String TEXT_576 = "(this);" + NL + "      if (!wasAdded)" + NL + "      {";
  protected final String TEXT_577 = NL + "        ";
  protected final String TEXT_578 = ".remove(";
  protected final String TEXT_579 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_580 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_581 = NL + "  public boolean ";
  protected final String TEXT_582 = "(";
  protected final String TEXT_583 = " ";
  protected final String TEXT_584 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_585 = NL + "    if (!";
  protected final String TEXT_586 = ".contains(";
  protected final String TEXT_587 = "))" + NL + "    {";
  protected final String TEXT_588 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_589 = ".indexOf(";
  protected final String TEXT_590 = ");";
  protected final String TEXT_591 = NL + "    ";
  protected final String TEXT_592 = ".remove(oldIndex);" + NL + "    if (";
  protected final String TEXT_593 = ".";
  protected final String TEXT_594 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_595 = ".";
  protected final String TEXT_596 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_597 = NL + "        ";
  protected final String TEXT_598 = ".add(oldIndex,";
  ...
  protected final String TEXT_602 = " boolean ";
  protected final String TEXT_603 = "(";
  protected final String TEXT_604 = " ";
  protected final String TEXT_605 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_606 = NL + "    ";
  protected final String TEXT_607 = " = ";
  protected final String TEXT_608 = ";" + NL + "    wasSet = true;";
  protected final String TEXT_609 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_610 = NL + "  ";
  protected final String TEXT_611 = " boolean ";
  protected final String TEXT_612 = "(";
  protected final String TEXT_613 = " ";
  protected final String TEXT_614 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_615 = NL + "    if (";
  protected final String TEXT_616 = " != null)" + NL + "    {";
  protected final String TEXT_617 = NL + "      ";
  protected final String TEXT_618 = " = ";
  protected final String TEXT_619 = ";" + NL + "      wasSet = true;" + NL + "    }";
  protected final String TEXT_620 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_621 = NL + "  public boolean ";
  ...
  protected final String TEXT_630 = "()))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_631 = ", as existing ";
  protected final String TEXT_632 = " would become an orphan";
  protected final String TEXT_633 = NL + "      return wasSet;" + NL + "    }" + NL;
  ...
  protected final String TEXT_642 = "() : null;" + NL + "" + NL + "    if (!this.equals(";
  protected final String TEXT_643 = "))" + NL + "    {" + NL + "      if (";
  protected final String TEXT_644 = " != null)" + NL + "      {";
  protected final String TEXT_645 = NL + "        ";
  protected final String TEXT_646 = ".";
  protected final String TEXT_647 = " = null;" + NL + "      }" + NL + "      if (";
  protected final String TEXT_648 = " != null)" + NL + "      {";
  protected final String TEXT_649 = NL + "        ";
  protected final String TEXT_650 = ".";
  protected final String TEXT_651 = "(this);" + NL + "      }" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_652 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_653 = NL + "  public boolean ";
  protected final String TEXT_654 = "(";
  protected final String TEXT_655 = " ";
  protected final String TEXT_656 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_657 = NL + "    if (";
  protected final String TEXT_658 = " == null)" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_659 = " to null, as ";
  protected final String TEXT_660 = " must always be associated to a ";
  protected final String TEXT_661 = NL + "      return wasSet;" + NL + "    }" + NL + "    ";
  protected final String TEXT_662 = NL + "    ";
  protected final String TEXT_663 = " ";
  protected final String TEXT_664 = " = ";
  protected final String TEXT_665 = ".";
  protected final String TEXT_666 = "();" + NL + "    if (";
  protected final String TEXT_667 = " != null && !equals(";
  protected final String TEXT_668 = "))" + NL + "    {" + NL + "      //Unable to ";
  protected final String TEXT_669 = ", the current ";
  protected final String TEXT_670 = " already has a ";
  protected final String TEXT_671 = ", which would be orphaned if it were re-assigned";
  protected final String TEXT_672 = NL + "      return wasSet;" + NL + "    }" + NL + "    ";
  ...
  protected final String TEXT_682 = "(this);" + NL + "" + NL + "    if (";
  protected final String TEXT_683 = " != null)" + NL + "    {";
  protected final String TEXT_684 = NL + "      ";
  protected final String TEXT_685 = ".";
  protected final String TEXT_686 = "(null);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_687 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_688 = NL + "  public ";
  ...
  protected final String TEXT_703 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_704 = NL + "    ";
  protected final String TEXT_705 = " ";
  protected final String TEXT_706 = " = ";
  protected final String TEXT_707 = ".";
  protected final String TEXT_708 = "();" + NL + "    boolean ";
  protected final String TEXT_709 = " = ";
  protected final String TEXT_710 = " != null && !this.equals(";
  protected final String TEXT_711 = ");" + NL + "" + NL + "    if (";
  protected final String TEXT_712 = " && ";
  protected final String TEXT_713 = ".";
  protected final String TEXT_714 = "() <= ";
  protected final String TEXT_715 = "())" + NL + "    {" + NL + "      return wasAdded;" + NL + "    }";
  ...
  protected final String TEXT_721 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_722 = NL + "      ";
  protected final String TEXT_723 = ".add(";
  protected final String TEXT_724 = ");" + NL + "    }";
  protected final String TEXT_725 = NL + "    wasAdded = true;";
  protected final String TEXT_726 = NL + "    return wasAdded;" + NL + "  }";
  ...
  protected final String TEXT_737 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_738 = " already at minimum (";
  protected final String TEXT_739 = ")" + NL + "    if (";
  protected final String TEXT_740 = "() <= ";
  protected final String TEXT_741 = "())" + NL + "    {";
  protected final String TEXT_742 = NL + "      return wasRemoved;" + NL + "    }";
  protected final String TEXT_743 = NL;
  protected final String TEXT_744 = NL + "    ";
  protected final String TEXT_745 = ".remove(";
  protected final String TEXT_746 = ");";
  protected final String TEXT_747 = NL + "    wasRemoved = true;";
  protected final String TEXT_748 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_749 = NL + "  public ";
  protected final String TEXT_750 = " ";
  protected final String TEXT_751 = "(";
  protected final String TEXT_752 = ")" + NL + "  {" + NL + "    if (";
  protected final String TEXT_753 = "() >= ";
  protected final String TEXT_754 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_755 = "(";
  protected final String TEXT_756 = ");" + NL + "    }" + NL + "  }";
  protected final String TEXT_757 = NL;
  protected final String TEXT_758 = NL + "  public boolean ";
  ...
  protected final String TEXT_799 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_800 = " already at minimum (";
  protected final String TEXT_801 = ")" + NL + "    if (";
  protected final String TEXT_802 = "() <= ";
  protected final String TEXT_803 = "())" + NL + "    {";
  protected final String TEXT_804 = NL + "      return wasRemoved;" + NL + "    }";
  protected final String TEXT_805 = NL;
  protected final String TEXT_806 = NL + "    ";
  protected final String TEXT_807 = ".remove(";
  protected final String TEXT_808 = ");";
  protected final String TEXT_809 = NL + "    wasRemoved = true;";
  protected final String TEXT_810 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_811 = NL + "  public ";
  protected final String TEXT_812 = " ";
  protected final String TEXT_813 = "(";
  protected final String TEXT_814 = ")" + NL + "  {" + NL + "    if (";
  protected final String TEXT_815 = "() >= ";
  protected final String TEXT_816 = "())" + NL + "    {" + NL + "      return null;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      return new ";
  protected final String TEXT_817 = "(";
  protected final String TEXT_818 = ");" + NL + "    }" + NL + "  }";
  protected final String TEXT_819 = NL;
  protected final String TEXT_820 = NL + "  public boolean ";
  protected final String TEXT_821 = "(";
  protected final String TEXT_822 = " ";
  protected final String TEXT_823 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_824 = NL + "    if (";
  protected final String TEXT_825 = "() >= ";
  protected final String TEXT_826 = "())" + NL + "    {";
  protected final String TEXT_827 = NL + "      return wasAdded;" + NL + "    }" + NL;
  protected final String TEXT_828 = NL + "    ";
  protected final String TEXT_829 = " ";
  protected final String TEXT_830 = " = ";
  protected final String TEXT_831 = ".";
  protected final String TEXT_832 = "();" + NL + "    boolean ";
  protected final String TEXT_833 = " = ";
  protected final String TEXT_834 = " != null && !this.equals(";
  ...
  protected final String TEXT_844 = NL + "    wasAdded = true;";
  protected final String TEXT_845 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_846 = NL;
  protected final String TEXT_847 = NL + "  public boolean ";
  protected final String TEXT_848 = "(";
  protected final String TEXT_849 = " ";
  protected final String TEXT_850 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_851 = NL + "    //Unable to remove ";
  protected final String TEXT_852 = ", as it must always have a ";
  protected final String TEXT_853 = NL + "    if (!this.equals(";
  protected final String TEXT_854 = ".";
  protected final String TEXT_855 = "()))" + NL + "    {";
  protected final String TEXT_856 = NL + "      ";
  protected final String TEXT_857 = ".remove(";
  protected final String TEXT_858 = ");" + NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_864 = NL + "    ArrayList<";
  protected final String TEXT_865 = "> ";
  protected final String TEXT_866 = " = new ArrayList<";
  protected final String TEXT_867 = ">();" + NL + "    for (";
  protected final String TEXT_868 = " ";
  protected final String TEXT_869 = " : ";
  protected final String TEXT_870 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_871 = ".contains(";
  protected final String TEXT_872 = "))" + NL + "      {" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_873 = NL + "      ";
  protected final String TEXT_874 = ".add(";
  protected final String TEXT_875 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_876 = ".size() != ";
  protected final String TEXT_877 = ".length || ";
  protected final String TEXT_878 = ".size() > ";
  protected final String TEXT_879 = "())" + NL + "    {";
  protected final String TEXT_880 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    ArrayList<";
  protected final String TEXT_881 = "> ";
  protected final String TEXT_882 = " = new ArrayList<";
  protected final String TEXT_883 = ">(";
  protected final String TEXT_884 = ");";
  protected final String TEXT_885 = NL + "    ";
  protected final String TEXT_886 = ".clear();" + NL + "    for (";
  protected final String TEXT_887 = " ";
  protected final String TEXT_888 = " : ";
  protected final String TEXT_889 = ")" + NL + "    {";
  protected final String TEXT_890 = NL + "      ";
  protected final String TEXT_891 = ".add(";
  ...
  protected final String TEXT_896 = ".remove(";
  protected final String TEXT_897 = ");" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_898 = NL + "        ";
  protected final String TEXT_899 = ".";
  protected final String TEXT_900 = "(this);" + NL + "      }" + NL + "    }" + NL + "" + NL + "    for (";
  protected final String TEXT_901 = " ";
  protected final String TEXT_902 = " : ";
  protected final String TEXT_903 = ")" + NL + "    {";
  protected final String TEXT_904 = NL + "      ";
  protected final String TEXT_905 = ".";
  protected final String TEXT_906 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_907 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_908 = NL + "  public ";
  protected final String TEXT_909 = " ";
  protected final String TEXT_910 = "(";
  protected final String TEXT_911 = ")" + NL + "  {" + NL + "    return new ";
  ...
  protected final String TEXT_923 = "();" + NL + "    boolean ";
  protected final String TEXT_924 = " = ";
  protected final String TEXT_925 = " != null && !this.equals(";
  protected final String TEXT_926 = ");";
  protected final String TEXT_927 = NL + "    if (";
  protected final String TEXT_928 = ")" + NL + "    {";
  protected final String TEXT_929 = NL + "      ";
  protected final String TEXT_930 = ".";
  protected final String TEXT_931 = "(this);" + NL + "    }" + NL + "    else" + NL + "    {";
  protected final String TEXT_932 = NL + "      ";
  protected final String TEXT_933 = ".add(";
  protected final String TEXT_934 = ");" + NL + "    }";
  protected final String TEXT_935 = NL + "    wasAdded = true;";
  protected final String TEXT_936 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_937 = NL;
  protected final String TEXT_938 = NL + "  public boolean ";
  protected final String TEXT_939 = "(";
  protected final String TEXT_940 = " ";
  protected final String TEXT_941 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_942 = NL + "    //Unable to remove ";
  protected final String TEXT_943 = ", as it must always have a ";
  protected final String TEXT_944 = NL + "    if (!this.equals(";
  protected final String TEXT_945 = ".";
  protected final String TEXT_946 = "()))" + NL + "    {";
  protected final String TEXT_947 = NL + "      ";
  protected final String TEXT_948 = ".remove(";
  protected final String TEXT_949 = ");";
  protected final String TEXT_950 = NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_963 = " = null;" + NL + "      " + NL + "      if (";
  ...
  protected final String TEXT_969 = "(null);" + NL + "      }" + NL + "      wasSet = true;";
  ...
  protected final String TEXT_980 = "(null);" + NL + "    }" + NL;
  ...
  protected final String TEXT_988 = "();" + NL + "" + NL + "    if (!equals(";
  protected final String TEXT_989 = "))" + NL + "    {";
  protected final String TEXT_990 = NL + "      ";
  protected final String TEXT_991 = ".";
  protected final String TEXT_992 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_993 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_994 = NL + "  public boolean ";
  protected final String TEXT_995 = "(";
  protected final String TEXT_996 = " ";
  protected final String TEXT_997 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_998 = NL + "    if (!";
  protected final String TEXT_999 = ".contains(";
  protected final String TEXT_1000 = "))" + NL + "    {";
  protected final String TEXT_1001 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1002 = "() <= ";
  protected final String TEXT_1003 = "())" + NL + "    {";
  protected final String TEXT_1004 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_1005 = ".indexOf(";
  protected final String TEXT_1006 = ");";
  protected final String TEXT_1007 = NL + "    ";
  protected final String TEXT_1008 = ".remove(oldIndex);";
  protected final String TEXT_1009 = NL + "    if (";
  protected final String TEXT_1010 = ".";
  protected final String TEXT_1011 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_1012 = ".";
  protected final String TEXT_1013 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_1014 = NL + "        ";
  protected final String TEXT_1015 = ".add(oldIndex,";
  protected final String TEXT_1016 = ");" + NL + "      }" + NL + "    }";
  protected final String TEXT_1017 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1018 = NL + "  public boolean ";
  protected final String TEXT_1019 = "(";
  protected final String TEXT_1020 = " ";
  protected final String TEXT_1021 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1022 = NL + "    if (!";
  protected final String TEXT_1023 = ".contains(";
  protected final String TEXT_1024 = "))" + NL + "    {";
  protected final String TEXT_1025 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  protected final String TEXT_1026 = "() <= ";
  protected final String TEXT_1027 = "())" + NL + "    {";
  protected final String TEXT_1028 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    int oldIndex = ";
  protected final String TEXT_1029 = ".indexOf(";
  protected final String TEXT_1030 = ");";
  protected final String TEXT_1031 = NL + "    ";
  protected final String TEXT_1032 = ".remove(oldIndex);";
  protected final String TEXT_1033 = NL + "    if (";
  protected final String TEXT_1034 = ".";
  protected final String TEXT_1035 = "(this) == -1)" + NL + "    {" + NL + "      wasRemoved = true;" + NL + "    }" + NL + "    else" + NL + "    {" + NL + "      wasRemoved = ";
  protected final String TEXT_1036 = ".";
  protected final String TEXT_1037 = "(this);" + NL + "      if (!wasRemoved)" + NL + "      {";
  protected final String TEXT_1038 = NL + "        ";
  protected final String TEXT_1039 = ".add(oldIndex,";
  ...
  protected final String TEXT_1045 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_1061 = ".equals(";
  protected final String TEXT_1062 = "))" + NL + "    {";
  protected final String TEXT_1063 = NL + "      ";
  protected final String TEXT_1064 = ".";
  protected final String TEXT_1065 = "(this);" + NL + "    }" + NL + "    if (";
  protected final String TEXT_1066 = " != null)" + NL + "    {";
  protected final String TEXT_1067 = NL + "      ";
  protected final String TEXT_1068 = ".";
  protected final String TEXT_1069 = "(this);" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1070 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1071 = NL + "  public boolean ";
  protected final String TEXT_1072 = "(";
  protected final String TEXT_1073 = " ";
  protected final String TEXT_1074 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  ...
  protected final String TEXT_1086 = ".equals(";
  protected final String TEXT_1087 = "))" + NL + "    {";
  protected final String TEXT_1088 = NL + "      ";
  protected final String TEXT_1089 = ".";
  protected final String TEXT_1090 = "(this);" + NL + "    }";
  protected final String TEXT_1091 = NL + "    ";
  protected final String TEXT_1092 = ".";
  protected final String TEXT_1093 = "(this);" + NL + "    wasSet = true;";
  protected final String TEXT_1094 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1095 = NL + "  public boolean ";
  protected final String TEXT_1096 = "(";
  protected final String TEXT_1097 = " ";
  protected final String TEXT_1098 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1099 = NL + "    //Must provide ";
  protected final String TEXT_1100 = " to ";
  protected final String TEXT_1101 = NL + "    if (";
  protected final String TEXT_1102 = " == null)" + NL + "    {";
  protected final String TEXT_1103 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    //";
  protected final String TEXT_1104 = " already at maximum (";
  ...
  protected final String TEXT_1120 = "))" + NL + "    {" + NL + "      boolean didRemove = ";
  protected final String TEXT_1121 = ".";
  protected final String TEXT_1122 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1129 = "(this);" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1135 = NL + "    //Must provide ";
  protected final String TEXT_1136 = " to ";
  protected final String TEXT_1137 = NL + "    if (";
  protected final String TEXT_1138 = " == null)" + NL + "    {";
  protected final String TEXT_1139 = NL + "      return wasSet;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1154 = ".equals(";
  protected final String TEXT_1155 = "))" + NL + "    {" + NL + "      boolean didRemove = ";
  protected final String TEXT_1156 = ".";
  protected final String TEXT_1157 = "(this);" + NL + "      if (!didRemove)" + NL + "      {";
  ...
  protected final String TEXT_1164 = "(this);" + NL + "    wasSet = true;";
  ...
  protected final String TEXT_1176 = " == null)" + NL + "    {";
  protected final String TEXT_1177 = NL + "      ";
  protected final String TEXT_1178 = ".";
  protected final String TEXT_1179 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1187 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  ...
  protected final String TEXT_1192 = NL + "    return wasAdded;" + NL + "  }";
  ...
  protected final String TEXT_1238 = NL + "      return wasAdded;" + NL + "    }" + NL;
  ...
  protected final String TEXT_1245 = " == null)" + NL + "    {";
  protected final String TEXT_1246 = NL + "      ";
  protected final String TEXT_1247 = ".";
  protected final String TEXT_1248 = "(this);" + NL + "    }" + NL + "    else if (!this.equals(";
  ...
  protected final String TEXT_1256 = ");" + NL + "    }" + NL + "    else" + NL + "    {";
  ...
  protected final String TEXT_1261 = NL + "    return wasAdded;" + NL + "  }";
  ...
  protected final String TEXT_1275 = "(null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1276 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1277 = NL + "  public boolean ";
  protected final String TEXT_1278 = "(";
  protected final String TEXT_1279 = " ";
  protected final String TEXT_1280 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  ...
  protected final String TEXT_1297 = NL + "      return wasRemoved;" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1324 = NL + "      return wasAdded;" + NL + "    }" + NL + "    else if (";
  protected final String TEXT_1325 = " != null)" + NL + "    {";
  ...
  protected final String TEXT_1335 = ",this);" + NL + "    wasAdded = true;";
  protected final String TEXT_1336 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_1337 = NL;
  protected final String TEXT_1338 = NL + "  public boolean ";
  protected final String TEXT_1339 = "(";
  protected final String TEXT_1340 = " ";
  protected final String TEXT_1341 = ")" + NL + "  {" + NL + "    boolean wasRemoved = false;";
  protected final String TEXT_1342 = NL + "    if (";
  protected final String TEXT_1343 = ".contains(";
  ...
  protected final String TEXT_1348 = ".remove(";
  protected final String TEXT_1349 = ");";
  protected final String TEXT_1350 = NL + "      ";
  protected final String TEXT_1351 = "(";
  protected final String TEXT_1352 = ",null);" + NL + "      wasRemoved = true;" + NL + "    }";
  protected final String TEXT_1353 = NL + "    return wasRemoved;" + NL + "  }" + NL;
  protected final String TEXT_1354 = NL + "  public boolean ";
  protected final String TEXT_1355 = "(";
  protected final String TEXT_1356 = "... ";
  protected final String TEXT_1357 = ")" + NL + "  {" + NL + "    boolean wasSet = false;";
  protected final String TEXT_1358 = NL + "    ArrayList<";
  protected final String TEXT_1359 = "> ";
  protected final String TEXT_1360 = " = new ArrayList<";
  protected final String TEXT_1361 = ">();" + NL + "    for (";
  protected final String TEXT_1362 = " ";
  protected final String TEXT_1363 = " : ";
  protected final String TEXT_1364 = ")" + NL + "    {" + NL + "      if (";
  protected final String TEXT_1365 = ".contains(";
  ...
  protected final String TEXT_1369 = "() != null && !this.equals(";
  protected final String TEXT_1370 = ".";
  protected final String TEXT_1371 = "()))" + NL + "      {";
  protected final String TEXT_1372 = NL + "        return wasSet;" + NL + "      }";
  protected final String TEXT_1373 = NL + "      ";
  protected final String TEXT_1374 = ".add(";
  protected final String TEXT_1375 = ");" + NL + "    }" + NL + "" + NL + "    if (";
  ...
  protected final String TEXT_1380 = ".removeAll(";
  protected final String TEXT_1381 = ");" + NL + "    " + NL + "    for (";
  protected final String TEXT_1382 = " orphan : ";
  protected final String TEXT_1383 = ")" + NL + "    {";
  protected final String TEXT_1384 = NL + "      ";
  protected final String TEXT_1385 = "(orphan, null);" + NL + "    }";
  ...
  protected final String TEXT_1393 = ", this);";
  protected final String TEXT_1394 = NL + "      ";
  protected final String TEXT_1395 = ".add(";
  protected final String TEXT_1396 = ");" + NL + "    }" + NL + "    wasSet = true;";
  protected final String TEXT_1397 = NL + "    return wasSet;" + NL + "  }" + NL;
  protected final String TEXT_1398 = NL + "  private void ";
  ...
  protected final String TEXT_1403 = ")" + NL + "  {" + NL + "    try" + NL + "    {" + NL + "      java.lang.reflect.Field mentorField = ";
  protected final String TEXT_1404 = ".getClass().getDeclaredField(\"";
  protected final String TEXT_1405 = "\");" + NL + "      mentorField.setAccessible(true);" + NL + "      mentorField.set(";
  protected final String TEXT_1406 = ", ";
  protected final String TEXT_1407 = ");" + NL + "    }" + NL + "    catch (Exception e)" + NL + "    {" + NL + "      throw new RuntimeException(\"Issue internally setting ";
  protected final String TEXT_1408 = " to ";
  protected final String TEXT_1409 = "\", e);" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1417 = NL + "    wasAdded = true;";
  ...
  protected final String TEXT_1442 = NL + "      wasAdded = true;" + NL + "    }";
  protected final String TEXT_1443 = NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_1444 = NL;
  protected final String TEXT_1445 = NL + "  public boolean ";
  ...
  protected final String TEXT_1455 = NL + "      wasRemoved = true;" + NL + "    }";
  ...
  protected final String TEXT_1460 = ")" + NL + "  {" + NL + "    boolean wasAdded = false;";
  protected final String TEXT_1461 = NL + "    ";
  protected final String TEXT_1462 = ".add(";
  protected final String TEXT_1463 = ");";
  protected final String TEXT_1464 = NL + "    wasAdded = true;";
  protected final String TEXT_1465 = NL + "    return wasAdded;" + NL + "  }";
  ...
  protected final String TEXT_1907 = NL + "      wasAdded = true;" + NL + "    }" + NL + "    return wasAdded;" + NL + "  }";
  protected final String TEXT_1908 = NL;
  protected final String TEXT_1909 = NL + "  public boolean ";
  protected final String TEXT_1910 = "(";
  protected final String TEXT_1911 = " ";
  protected final String TEXT_1912 = ", int index)" + NL + "  {" + NL + "    boolean wasAdded = false;" + NL + "    if(";
  protected final String TEXT_1913 = ".contains(";
  protected final String TEXT_1914 = "))" + NL + "    {" + NL + "      if(index < 0 ) { index = 0; }" + NL + "      if(index > ";
  protected final String TEXT_1915 = "()) { index = ";
  protected final String TEXT_1916 = "() - 1; }";
  ...
  protected final String TEXT_1921 = ".add(index, ";
  protected final String TEXT_1922 = ");";
  protected final String TEXT_1923 = NL + "      wasAdded = true;" + NL + "    } " + NL + "    else " + NL + "    {";
  protected final String TEXT_1924 = NL + "      wasAdded = ";
  protected final String TEXT_1925 = "(";
  protected final String TEXT_1926 = ", index);";
  protected final String TEXT_1927 = NL + "    }" + NL + "    return wasAdded;" + NL + "  }" + NL;
  protected final String TEXT_1928 = NL + "  public boolean equals(Object obj)" + NL + "  {" + NL + "    if (obj == null) { return false; }" + NL + "    if (!getClass().equals(obj.getClass())) { return false; }" + NL;
  protected final String TEXT_1929 = NL + "    ";
  protected final String TEXT_1930 = " compareTo = (";
  protected final String TEXT_1931 = ")obj;" + NL + "  ";
  protected final String TEXT_1932 = NL + "    ";
  protected final String TEXT_1933 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1934 = NL + "    ";
  protected final String TEXT_1935 = NL;
  protected final String TEXT_1936 = NL + "    ";
  protected final String TEXT_1937 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1938 = NL + "  private void ";
  protected final String TEXT_1939 = "()" + NL + "  {" + NL + "    try" + NL + "    {";
  protected final String TEXT_1940 = NL + "      ";
  protected final String TEXT_1941 = NL + "      Thread.sleep(1);";
  protected final String TEXT_1942 = NL + "    }" + NL + "    catch (InterruptedException e)" + NL + "    {" + NL + "" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1948 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1949 = NL + "    ";
  protected final String TEXT_1950 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1951 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1952 = NL + "      ";
  protected final String TEXT_1953 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1954 = NL + "  private void ";
  protected final String TEXT_1955 = "()" + NL + "  {";
  protected final String TEXT_1956 = NL + "    ";
  protected final String TEXT_1957 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1958 = "\",";
  protected final String TEXT_1959 = ");" + NL + "  }" + NL + "" + NL + "  private void ";
  protected final String TEXT_1960 = "()" + NL + "  {";
  protected final String TEXT_1961 = NL + "    ";
  protected final String TEXT_1962 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1963 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1964 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1965 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void run ()" + NL + "    {";
