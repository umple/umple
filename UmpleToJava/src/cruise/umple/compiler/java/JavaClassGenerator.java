...
public class JavaClassGenerator implements ILang 
{
  ...
  protected final String TEXT_1716 = NL + "  @SuppressWarnings({ \"unchecked\", \"rawtypes\" })" + NL + "  public void sort(List toSort, final String thePriority)" + NL + "  {" + NL + "    if(toSort.size() > 0)" + NL + "    {" + NL + "      Collections.sort(toSort, new Comparator<Object>()" + NL + "      {" + NL + "        @Override" + NL + "        public int compare(Object arg0, Object arg1)" + NL + "        {" + NL + "          try" + NL + "          {" + NL + "            String methodName = \"get\" + thePriority.substring(0, 1).toUpperCase() + thePriority.substring(1);" + NL + "            return ((Comparable)arg0.getClass().getMethod(methodName).invoke(arg0)).compareTo((Comparable)arg1.getClass().getMethod(methodName).invoke(arg1));" + NL + "          }" + NL + "          catch (Exception e)" + NL + "          {" + NL + "            e.printStackTrace();" + NL + "          }" + NL + "          return 0;" + NL + "        }" + NL + "      });" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1717 = NL + "  public boolean ";
  protected final String TEXT_1718 = "(";
  protected final String TEXT_1719 = " ";
  protected final String TEXT_1720 = ", int index)" + NL + "  {  " + NL + "    boolean wasAdded = false;" + NL + "    if(";
  protected final String TEXT_1721 = "(";
  protected final String TEXT_1722 = "))" + NL + "    {" + NL + "      if(index < 0 ) { index = 0; }" + NL + "      if(index > ";
  protected final String TEXT_1723 = "()) { index = ";
  protected final String TEXT_1724 = "() - 1; }";
  protected final String TEXT_1725 = NL + "      ";
  protected final String TEXT_1726 = ".remove(";
  protected final String TEXT_1727 = ");";
  protected final String TEXT_1728 = NL + "      ";
  protected final String TEXT_1729 = ".add(index, ";
  protected final String TEXT_1730 = ");" + NL + "      wasAdded = true;" + NL + "    }" + NL + "    return wasAdded;" + NL + "  }" + NL + "" + NL + "  public boolean ";
  protected final String TEXT_1731 = "(";
  protected final String TEXT_1732 = " ";
  protected final String TEXT_1733 = ", int index)" + NL + "  {" + NL + "    boolean wasAdded = false;" + NL + "    if(";
  protected final String TEXT_1734 = ".contains(";
  protected final String TEXT_1735 = "))" + NL + "    {" + NL + "      if(index < 0 ) { index = 0; }" + NL + "      if(index > ";
  protected final String TEXT_1736 = "()) { index = ";
  protected final String TEXT_1737 = "() - 1; }";
  ...
  protected final String TEXT_1742 = ".add(index, ";
  protected final String TEXT_1743 = ");" + NL + "      wasAdded = true;" + NL + "    } " + NL + "    else " + NL + "    {" + NL + "      wasAdded = ";
  protected final String TEXT_1744 = "(";
  protected final String TEXT_1745 = ", index);" + NL + "    }" + NL + "    return wasAdded;" + NL + "  }" + NL;
  protected final String TEXT_1746 = NL + "  public boolean equals(Object obj)" + NL + "  {" + NL + "    if (obj == null) { return false; }" + NL + "    if (!getClass().equals(obj.getClass())) { return false; }" + NL;
  protected final String TEXT_1747 = NL + "    ";
  protected final String TEXT_1748 = " compareTo = (";
  protected final String TEXT_1749 = ")obj;" + NL + "  ";
  protected final String TEXT_1750 = NL + "    ";
  protected final String TEXT_1751 = NL + NL + "    return true;" + NL + "  }" + NL + "" + NL + "  public int hashCode()" + NL + "  {" + NL + "    if (cachedHashCode != -1)" + NL + "    {" + NL + "      return cachedHashCode;" + NL + "    }" + NL + "    cachedHashCode = 17;";
  protected final String TEXT_1752 = NL + "    ";
  protected final String TEXT_1753 = NL;
  protected final String TEXT_1754 = NL + "    ";
  protected final String TEXT_1755 = NL + "    return cachedHashCode;" + NL + "  }" + NL;
  protected final String TEXT_1756 = NL + "  private void ";
  protected final String TEXT_1757 = "()" + NL + "  {" + NL + "    try" + NL + "    {";
  protected final String TEXT_1758 = NL + "      ";
  protected final String TEXT_1759 = NL + "      Thread.sleep(1);";
  protected final String TEXT_1760 = NL + "    }" + NL + "    catch (InterruptedException e)" + NL + "    {" + NL + "" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1761 = NL + "  private static class DoActivityThread extends Thread" + NL + "  {";
  protected final String TEXT_1762 = NL + "    ";
  protected final String TEXT_1763 = " controller;" + NL + "    String doActivityMethodName;" + NL + "    " + NL + "    public DoActivityThread(";
  protected final String TEXT_1764 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {";
  protected final String TEXT_1765 = NL + "      ";
  protected final String TEXT_1766 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1767 = NL + "  private void ";
  protected final String TEXT_1768 = "()" + NL + "  {";
  protected final String TEXT_1769 = NL + "    ";
  protected final String TEXT_1770 = " = new TimedEventHandler(this,\"";
  protected final String TEXT_1771 = "\",";
  protected final String TEXT_1772 = ");" + NL + "  }" + NL + "" + NL + "  private void ";
  protected final String TEXT_1773 = "()" + NL + "  {";
  protected final String TEXT_1774 = NL + "    ";
  protected final String TEXT_1775 = ".stop();" + NL + "  }" + NL;
  protected final String TEXT_1776 = NL + "  public static class TimedEventHandler extends TimerTask  " + NL + "  {" + NL + "    private ";
  protected final String TEXT_1777 = " controller;" + NL + "    private String timeoutMethodName;" + NL + "    private double howLongInSeconds;" + NL + "    private Timer timer;" + NL + "    " + NL + "    public TimedEventHandler(";
  protected final String TEXT_1778 = " aController, String aTimeoutMethodName, double aHowLongInSeconds)" + NL + "    {" + NL + "      controller = aController;" + NL + "      timeoutMethodName = aTimeoutMethodName;" + NL + "      howLongInSeconds = aHowLongInSeconds;" + NL + "      timer = new Timer();" + NL + "      timer.schedule(this, (long)howLongInSeconds*1000);" + NL + "    }" + NL + "    " + NL + "    public void stop()" + NL + "    {" + NL + "      timer.cancel();" + NL + "    }" + NL + "    " + NL + "    public void run ()" + NL + "    {";
  protected final String TEXT_1779 = NL + "      if (\"";
  protected final String TEXT_1780 = "\".equals(timeoutMethodName))" + NL + "      {" + NL + "        boolean shouldRestart = !controller.";
  protected final String TEXT_1781 = "();" + NL + "        if (shouldRestart)" + NL + "        {" + NL + "          controller.";
  protected final String TEXT_1782 = "();" + NL + "        }" + NL + "        return;" + NL + "      }";
  protected final String TEXT_1783 = NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_1784 = NL + "    ";
  protected final String TEXT_1785 = " = null;";
  protected final String TEXT_1786 = NL + "    ";
  protected final String TEXT_1787 = ".clear();";
  ...
  protected final String TEXT_1793 = " = null;" + NL + "    if (";
  protected final String TEXT_1794 = " != null)" + NL + "    {";
  protected final String TEXT_1795 = NL + "      ";
  protected final String TEXT_1796 = ".delete();" + NL + "    }";
  ...
  protected final String TEXT_1807 = " = null;" + NL + "    if (";
  ...
  protected final String TEXT_1817 = " = null;" + NL + "    if (";
  protected final String TEXT_1818 = " != null)" + NL + "    {";
  protected final String TEXT_1819 = NL + "      ";
  protected final String TEXT_1820 = ".delete();" + NL + "    }";
  protected final String TEXT_1821 = NL + "    if (";
  protected final String TEXT_1822 = " != null)" + NL + "    {";
  protected final String TEXT_1823 = NL + "      ";
  protected final String TEXT_1824 = " ";
  protected final String TEXT_1825 = " = ";
  protected final String TEXT_1826 = ";" + NL + "      this.";
  protected final String TEXT_1827 = " = null;";
  protected final String TEXT_1828 = NL + "      ";
  protected final String TEXT_1829 = ".";
  protected final String TEXT_1830 = "(this);" + NL + "    }";
  protected final String TEXT_1831 = NL + "    if (";
  protected final String TEXT_1832 = " != null)" + NL + "    {";
  protected final String TEXT_1833 = NL + "      ";
  protected final String TEXT_1834 = ".delete();" + NL + "    }";
  protected final String TEXT_1835 = NL + "    if (";
  protected final String TEXT_1836 = " != null)" + NL + "    {" + NL + "      if (";
  ...
  protected final String TEXT_1864 = ",null);" + NL + "    }";
  protected final String TEXT_1865 = NL + "    ";
  protected final String TEXT_1866 = ".clear();";
  protected final String TEXT_1867 = NL + "    ArrayList<";
  protected final String TEXT_1868 = "> ";
  protected final String TEXT_1869 = " = new ArrayList<";
  protected final String TEXT_1870 = ">(";
  protected final String TEXT_1871 = ");";
  protected final String TEXT_1872 = NL + "    ";
  protected final String TEXT_1873 = ".clear();" + NL + "    for(";
  ...
  protected final String TEXT_1882 = ".delete();" + NL + "      }" + NL + "      else" + NL + "      {";
  protected final String TEXT_1883 = NL + "        ";
  protected final String TEXT_1884 = ".";
  protected final String TEXT_1885 = "(this);" + NL + "      }" + NL + "    }";
  protected final String TEXT_1886 = NL + "    ArrayList<";
  protected final String TEXT_1887 = "> ";
  protected final String TEXT_1888 = " = new ArrayList<";
  protected final String TEXT_1889 = ">(";
  protected final String TEXT_1890 = ");";
  protected final String TEXT_1891 = NL + "    ";
  protected final String TEXT_1892 = ".clear();" + NL + "    for(";
  ...
  protected final String TEXT_1898 = "(this);" + NL + "    }";
  protected final String TEXT_1899 = NL + "    for(int i=";
  protected final String TEXT_1900 = ".size(); i > 0; i--)" + NL + "    {";
  protected final String TEXT_1901 = NL + "      ";
  protected final String TEXT_1902 = " ";
  protected final String TEXT_1903 = " = ";
  protected final String TEXT_1904 = ".get(i - 1);";
  protected final String TEXT_1905 = NL + "      ";
  protected final String TEXT_1906 = ".delete();" + NL + "    }";
  protected final String TEXT_1907 = NL + "    for(";
  ...
  protected final String TEXT_1913 = "(null);" + NL + "    }";
  protected final String TEXT_1914 = "  " + NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
