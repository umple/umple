...
public class JavaClassGenerator implements ILang 
{
  ...
  protected final String TEXT_1579 = "() throws InterruptedException" + NL + "  {";
  ...
  protected final String TEXT_1585 = " aController,String aDoActivityMethodName)" + NL + "    {" + NL + "      controller = aController;" + NL + "      doActivityMethodName = aDoActivityMethodName;" + NL + "      start();" + NL + "    }" + NL + "    " + NL + "    public void run()" + NL + "    {" + NL + "      try" + NL + "      {";
  protected final String TEXT_1586 = NL + "        ";
  protected final String TEXT_1587 = NL + "      }" + NL + "      catch (InterruptedException e)" + NL + "      {" + NL + "        e.printStackTrace();" + NL + "      }" + NL + "    }" + NL + "  }" + NL;
  ...
  protected final String TEXT_1720 = NL + "    for(";
  ...
  protected final String TEXT_1725 = ".delete();" + NL + "    }";
  ...
  protected final String TEXT_1733 = "  " + NL + "  //------------------------" + NL + "  // DEVELOPER CODE - PROVIDED AS-IS" + NL + "  //------------------------" + NL + "  ";
