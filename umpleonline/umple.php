...
<body>
  <?php if($showChrome) { ?> 
    ...
    <a class="button2" style="padding-top:3px; padding-bottom: 0px;" href="http://dl.umple.org" target="dlpage" title="Go to the page that gives instructions on how to download Umple for use in Docker, or Eclipse or on the command line">Download</a>&nbsp;
    <a class="button2" style="padding-top:3px; padding-bottom: 0px;" href="https://alumni.uottawa.ca/donation-form?fid=bp71rD2pbt0%3d&fdesc=vj8yiR3kw2%2bPwQCmy1Z8CfKc0F1zufF0wBCY%2fxboCy4%2bHJZne7BoLhQuKHwuRN4R5bhBEciI1Gn5RbPGt1TgEQ%3d%3d" target="donatepage" title="Go to a University of Ottawa page that will enable you to donate to support Umple; even a few dollars will be much appreciated">Donate</a>&nbsp;
    ...
    <span style="font-size: 30%; white-space:nowrap;">
    <a class="button2" style="line-height: 1; padding-top:3px; padding-bottom: 0px;" href="<?php echo $manpage ?>" target="helppage" title="Open the Umple user manual in a separate tab" >User manual</a>&nbsp;
    <a class="button2" style="line-height: 1; padding-top:3px; padding-bottom: 0px;" href="http://questions.umple.org"
    ...
    <a class="button2" style="line-height: 1; padding-top:3px; padding-bottom: 0px;" href="https://github.com/umple/umple/issues/new" target="issuepage" title="Open a separate tab on the page where you can report an Umple bug or request an improvement">Report issue</a>&nbsp;
    </span>
        </p>
      </div>
    </div>
