 ...
 * <ul>
 *   <li>{@link cruise.umple.umple.SymmetricReflexiveAssociation#getRolename <em>Rolename</em>}</li>
 * </ul>
 * </p>
 *
 * @see cruise.umple.umple.UmplePackage#getSymmetricReflexiveAssociation()
 * @model
 * @generated
 */
public interface SymmetricReflexiveAssociation extends ClassContent, AssociationClassContent
{
   ...
   * @see cruise.umple.umple.UmplePackage#getSymmetricReflexiveAssociation_Rolename()
   * @model
   * @generated
   */
  String getRolename();
  ...
  /**
   * Sets the value of the '{@link cruise.umple.umple.SymmetricReflexiveAssociation#getRolename <em>Rolename</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
