 ...
 * <ul>
 *   <li>{@link cruise.umple.umple.impl.conditionalOrExpressionImpl#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link cruise.umple.umple.impl.conditionalOrExpressionImpl#getExpressionRest <em>Expression Rest</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class conditionalOrExpressionImpl extends MinimalEObjectImpl.Container implements conditionalOrExpression
{
  ...
  {
    return UmplePackage.Literals.CONDITIONAL_OR_EXPRESSION;
  }
  ...
  public NotificationChain basicSetExpression1(conditionalAndExpression newExpression1, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmplePackage.CONDITIONAL_OR_EXPRESSION__EXPRESSION1, oldExpression1, newExpression1);
  ...
  public void setExpression1(conditionalAndExpression newExpression1)
  {
    if (newExpression1 != expression1)
    {
      ...
      if (expression1 != null)
        msgs = ((InternalEObject)expression1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmplePackage.CONDITIONAL_OR_EXPRESSION__EXPRESSION1, null, msgs);
      if (newExpression1 != null)
        msgs = ((InternalEObject)newExpression1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmplePackage.CONDITIONAL_OR_EXPRESSION__EXPRESSION1, null, msgs);
      msgs = basicSetExpression1(newExpression1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmplePackage.CONDITIONAL_OR_EXPRESSION__EXPRESSION1, newExpression1, newExpression1));
  }
  ...
  public EList<conditionalAndExpression> getExpressionRest()
  {
    ...
    {
      expressionRest = new EObjectContainmentEList<conditionalAndExpression>(conditionalAndExpression.class, this, UmplePackage.CONDITIONAL_OR_EXPRESSION__EXPRESSION_REST);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmplePackage.CONDITIONAL_OR_EXPRESSION__EXPRESSION1:
        return basicSetExpression1(null, msgs);
      case UmplePackage.CONDITIONAL_OR_EXPRESSION__EXPRESSION_REST:
