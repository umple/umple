 ...
 * <ul>
 *   <li>{@link cruise.umple.umple.impl.Transition_Impl#getGuard_1 <em>Guard 1</em>}</li>
 *   <li>{@link cruise.umple.umple.impl.Transition_Impl#getEventDefinition_1 <em>Event Definition 1</em>}</li>
 *   <li>{@link cruise.umple.umple.impl.Transition_Impl#getAction_1 <em>Action 1</em>}</li>
 *   <li>{@link cruise.umple.umple.impl.Transition_Impl#getStateName_1 <em>State Name 1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Transition_Impl extends MinimalEObjectImpl.Container implements Transition_
{
  ...
  /**
   * The cached value of the '{@link #getEventDefinition_1() <em>Event Definition 1</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEventDefinition_1()
   * @generated
   * @ordered
   */
  ...
  public EList<Guard_> getGuard_1()
  {
    if (guard_1 == null)
    {
      guard_1 = new EObjectContainmentEList<Guard_>(Guard_.class, this, UmplePackage.TRANSITION___GUARD_1);
    }
    return guard_1;
  }
  ...
  {
    if (eventDefinition_1 == null)
    {
      eventDefinition_1 = new EObjectContainmentEList<EventDefinition_>(EventDefinition_.class, this, UmplePackage.TRANSITION___EVENT_DEFINITION_1);
    }
    return eventDefinition_1;
  }
  ...
  public EList<Action_> getAction_1()
  {
    if (action_1 == null)
    {
      action_1 = new EObjectContainmentEList<Action_>(Action_.class, this, UmplePackage.TRANSITION___ACTION_1);
    }
    return action_1;
  }
  ...
  public void setStateName_1(String newStateName_1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmplePackage.TRANSITION___STATE_NAME_1, oldStateName_1, stateName_1));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmplePackage.TRANSITION___GUARD_1:
        return ((InternalEList<?>)getGuard_1()).basicRemove(otherEnd, msgs);
      case UmplePackage.TRANSITION___EVENT_DEFINITION_1:
        return ((InternalEList<?>)getEventDefinition_1()).basicRemove(otherEnd, msgs);
      case UmplePackage.TRANSITION___ACTION_1:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case UmplePackage.TRANSITION___ACTION_1:
        return getAction_1();
      case UmplePackage.TRANSITION___STATE_NAME_1:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case UmplePackage.TRANSITION___EVENT_DEFINITION_1:
        ...
        getEventDefinition_1().addAll((Collection<? extends EventDefinition_>)newValue);
        return;
      case UmplePackage.TRANSITION___ACTION_1:
        getAction_1().clear();
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case UmplePackage.TRANSITION___EVENT_DEFINITION_1:
        return eventDefinition_1 != null && !eventDefinition_1.isEmpty();
      case UmplePackage.TRANSITION___ACTION_1:
