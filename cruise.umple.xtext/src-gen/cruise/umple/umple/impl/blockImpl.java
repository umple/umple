 ...
 * <ul>
 *   <li>{@link cruise.umple.umple.impl.blockImpl#getBlocks <em>Blocks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class blockImpl extends statementImpl implements block
{
  ...
  {
    return UmplePackage.Literals.BLOCK;
  }
  ...
  public EList<blockStatement> getBlocks()
  {
    if (blocks == null)
    {
      blocks = new EObjectContainmentEList<blockStatement>(blockStatement.class, this, UmplePackage.BLOCK__BLOCKS);
    }
    return blocks;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmplePackage.BLOCK__BLOCKS:
