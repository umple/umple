 ...
 * <ul>
 *   <li>{@link cruise.umple.umple.SingleAssociationEnd_#getMultiplicity_1 <em>Multiplicity 1</em>}</li>
 *   <li>{@link cruise.umple.umple.SingleAssociationEnd_#getType_1 <em>Type 1</em>}</li>
 *   <li>{@link cruise.umple.umple.SingleAssociationEnd_#getRoleName_1 <em>Role Name 1</em>}</li>
 * </ul>
 * </p>
 *
 * @see cruise.umple.umple.UmplePackage#getSingleAssociationEnd_()
 * @model
 * @generated
 */
public interface SingleAssociationEnd_ extends EObject
{
  /**
   ...
   * @see cruise.umple.umple.UmplePackage#getSingleAssociationEnd__Multiplicity_1()
   ...
   * @see cruise.umple.umple.UmplePackage#getSingleAssociationEnd__Type_1()
   * @model
   * @generated
   */
  String getType_1();
  ...
  /**
   * Sets the value of the '{@link cruise.umple.umple.SingleAssociationEnd_#getType_1 <em>Type 1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see cruise.umple.umple.UmplePackage#getSingleAssociationEnd__RoleName_1()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link cruise.umple.umple.SingleAssociationEnd_#getRoleName_1 <em>Role Name 1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
