 ...
 * <ul>
 *   <li>{@link cruise.umple.umple.equalityExpression#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link cruise.umple.umple.equalityExpression#getExpressionRest <em>Expression Rest</em>}</li>
 * </ul>
 * </p>
 *
 * @see cruise.umple.umple.UmplePackage#getequalityExpression()
 * @model
 * @generated
 */
public interface equalityExpression extends EObject
{
   ...
   * @see cruise.umple.umple.UmplePackage#getequalityExpression_Expression1()
  ...
  /**
   * Sets the value of the '{@link cruise.umple.umple.equalityExpression#getExpression1 <em>Expression1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link cruise.umple.umple.relationalExpression}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see cruise.umple.umple.UmplePackage#getequalityExpression_ExpressionRest()
   * @model containment="true"
   * @generated
   */
