 ...
 * <ul>
 *   <li>{@link cruise.umple.umple.Postcondition_#getName_1 <em>Name 1</em>}</li>
 *   <li>{@link cruise.umple.umple.Postcondition_#getConstraint_1 <em>Constraint 1</em>}</li>
 * </ul>
 * </p>
 *
 * @see cruise.umple.umple.UmplePackage#getPostcondition_()
 * @model
 * @generated
 */
public interface Postcondition_ extends EObject
{
  /**
   ...
   * @see cruise.umple.umple.UmplePackage#getPostcondition__Name_1()
   * @model
   * @generated
   */
  String getName_1();
  ...
  /**
   * Sets the value of the '{@link cruise.umple.umple.Postcondition_#getName_1 <em>Name 1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see cruise.umple.umple.UmplePackage#getPostcondition__Constraint_1()
