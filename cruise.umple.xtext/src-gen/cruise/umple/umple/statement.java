 ...
 *   <li>{@link cruise.umple.umple.statement#getTryBlock <em>Try Block</em>}</li>
 *   <li>{@link cruise.umple.umple.statement#getCatchBlock <em>Catch Block</em>}</li>
 * </ul>
 * </p>
 *
...
public interface statement extends blockStatement
{
   ...
   * @see cruise.umple.umple.UmplePackage#getstatement_TryBlock()
   * @model containment="true"
   * @generated
   */
  block getTryBlock();
  ...
  /**
   * Sets the value of the '{@link cruise.umple.umple.statement#getTryBlock <em>Try Block</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see cruise.umple.umple.UmplePackage#getstatement_CatchBlock()
   * @model containment="true"
   * @generated
   */
  block getCatchBlock();
  ...
  /**
   * Sets the value of the '{@link cruise.umple.umple.statement#getCatchBlock <em>Catch Block</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
