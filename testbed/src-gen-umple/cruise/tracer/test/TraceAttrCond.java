...
public class TraceAttrCond
{
  ...
  public boolean setN1(int aN1)
  {
    ...
    {
      ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/home/kenan/Umple/umple/testbed/src/TestHarnessTracer.ump,53,TraceAttrCond,"+System.identityHashCode(this)+",at_s,n1,"+n1+","+(""+aN1).toString().replace("\n","").replace(",",";") );
      traceFlag4++;
    }
    n1 = aN1;
    wasSet = true;
  ...
  public boolean setN2(int aN2)
  {
    ...
    {
      ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/home/kenan/Umple/umple/testbed/src/TestHarnessTracer.ump,54,TraceAttrCond,"+System.identityHashCode(this)+",at_s,n2,"+n2 );
      traceFlag5++;
    }
    wasSet = true;
    return wasSet;
  ...
  public boolean setN3(int aN3)
  {
    ...
    {
      ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/home/kenan/Umple/umple/testbed/src/TestHarnessTracer.ump,55,TraceAttrCond,"+System.identityHashCode(this)+",at_s,n3,"+n3 );
      traceFlag7++;
    }
    wasSet = true;
    if (n3>20)
  ...
  public boolean setN4(double aN4)
  {
    ...
    {
      ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/home/kenan/Umple/umple/testbed/src/TestHarnessTracer.ump,56,TraceAttrCond,"+System.identityHashCode(this)+",at_s,n4,"+n4 );
      traceFlag9++;
    }
    wasSet = true;
    if (n4>10)
