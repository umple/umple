...
public class TraceAttrCond
{
  ...
  public boolean setN1(int aN1)
  {
    ...
    {
      ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/home/tejota/Documents/Umple/umple-read-only/testbed/src/TestHarnessTracer.ump,53,TraceAttrCond,"+System.identityHashCode(this)+",at_s,n1,"+n1+","+aN1 );
      traceFlag4++;
    }
    n1 = aN1;
    wasSet = true;
