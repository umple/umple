...
public class TraceAttr
{
  ...
  public boolean setName(String aName)
  {
    ...
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/Users/tcl/nobackup-tmp/CheckoutForUmplePatchTest3/umple/testbed/src/TestHarnessTracer.ump,14,TraceAttr,"+System.identityHashCode(this)+",at_s,name,"+name+","+aName );
    name = aName;
    wasSet = true;
    return wasSet;
  }
  ...
  {
    boolean wasSet = false;
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/Users/tcl/nobackup-tmp/CheckoutForUmplePatchTest3/umple/testbed/src/TestHarnessTracer.ump,17,TraceAttr,"+System.identityHashCode(this)+",at_s,salary,"+salary+","+aSalary );
    salary = aSalary;
    wasSet = true;
    return wasSet;
  }
  ...
  public boolean addId(Integer aId)
  {
    ...
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/Users/tcl/nobackup-tmp/CheckoutForUmplePatchTest3/umple/testbed/src/TestHarnessTracer.ump,15,TraceAttr,"+System.identityHashCode(this)+",at_a,id,"+id+","+aId );
    wasAdded = id.add(aId);
    return wasAdded;
  }
  ...
  public boolean removeId(Integer aId)
  {
    ...
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/Users/tcl/nobackup-tmp/CheckoutForUmplePatchTest3/umple/testbed/src/TestHarnessTracer.ump,15,TraceAttr,"+System.identityHashCode(this)+",at_r,id,"+id+","+aId );
  ...
  public boolean setNumber1(int aNumber1)
  {
    ...
    if (numCond>100)
    {
      ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/Users/tcl/nobackup-tmp/CheckoutForUmplePatchTest3/umple/testbed/src/TestHarnessTracer.ump,30,TraceAttr,"+System.identityHashCode(this)+",at_s,number1,"+number1+","+aNumber1 );
    }
    number1 = aNumber1;
    wasSet = true;
    return wasSet;
  ...
  public boolean setStr(String aStr)
  {
    ...
    if (traceFlag3<3)
    {
      ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/Users/tcl/nobackup-tmp/CheckoutForUmplePatchTest3/umple/testbed/src/TestHarnessTracer.ump,34,TraceAttr,"+System.identityHashCode(this)+",at_s,str,"+str+","+aStr );
      traceFlag3++;
    }
    str = aStr;
    wasSet = true;
