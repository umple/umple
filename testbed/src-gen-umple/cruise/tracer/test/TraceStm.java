...
public class TraceStm
{
  ...
  public boolean ev1()
  {
    ...
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/Users/tcl/nobackup-tmp/CheckoutForUmplePatchTest3/umple/testbed/src/TestHarnessTracer.ump,92,TraceStm,"+System.identityHashCode(this)+",sm_t,Open,ev1,Close" );
      ...
      case Close:
        exitStatus();
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",/Users/tcl/nobackup-tmp/CheckoutForUmplePatchTest3/umple/testbed/src/TestHarnessTracer.ump,94,TraceStm,"+System.identityHashCode(this)+",sm_t,Close,ev1,Open" );
        setStatus(Status.Open);
        wasEventProcessed = true;
        break;
      default:
