...
import cruise.tracer.test.*;


public class ConsoleTracerStateMachinesTest extends ConsoleTracerTemplateTest
{
	PrintStream defaultPS;

	@Test
	public void traceStateMachineConsole()
	{
		PrintStream ps = new PrintStream(System.err){
			int index=0;

			String[] StmTraceExpected = {"Time",
					//=== GarageDoorA
